...
export function saveRecentRoomToLocal(roomId) {
  const rooms = getRecentRoomsFromLocal();
  const newRoom = {
    id: roomId,
    timestamp: Date.now(),
  };
...
export function getRecentRoomsFromLocal() {
  try {
...
export function clearRecentRoomsFromLocal() {
