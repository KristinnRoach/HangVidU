...
| `src/stores/`       | Solid reactive mirrors over storage/realtime (`contactsStore`, `filesStore`, `conversationStore`, …).                                           | `stores`, `auth`, `shared`, `lib`, `storage`, `realtime`, `infra`, `feature`    |
