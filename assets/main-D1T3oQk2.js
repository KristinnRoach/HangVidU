 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class MI{constructor(e,n,i){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=i,this.auth_=null,this.auth_=i.getImmediate({optional:!0}),this.auth_||i.onInit(s=>this.auth_=s)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(ve("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,i)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,i):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Fe(e)}}class Gr{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}Gr.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cf;class ye{static set __childrenNodeConstructor(e){cf=e}static get __childrenNodeConstructor(){return cf}constructor(e,n=ye.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=n,this.lazyHash_=null,_(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),fm(this.priorityNode_)}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new ye(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:ye.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return M(e)?this:D(e)===".priority"?this.priorityNode_:ye.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,n){return null}updateImmediateChild(e,n){return e===".priority"?this.updatePriority(n):n.isEmpty()&&e!==".priority"?this:ye.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,n).updatePriority(this.priorityNode_)}updateChild(e,n){const i=D(e);return i===null?n:n.isEmpty()&&i!==".priority"?this:(_(i!==".priority"||Cn(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(i,ye.__childrenNodeConstructor.EMPTY_NODE.updateChild(K(e),n)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,n){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+hm(this.priorityNode_.val())+":");const n=typeof this.value_;e+=n+":",n==="number"?e+=Wg(this.value_):e+=this.value_,this.lazyHash_=Vg(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===ye.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof ye.__childrenNodeConstructor?-1:(_(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const n=typeof e.value_,i=typeof this.value_,s=ye.VALUE_TYPE_ORDER.indexOf(n),r=ye.VALUE_TYPE_ORDER.indexOf(i);return _(s>=0,"Unknown leaf type: "+n),_(r>=0,"Unknown leaf type: "+i),s===r?i==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:r-s}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const n=e;return this.value_===n.value_&&this.priorityNode_.equals(n.priorityNode_)}else return!1}}ye.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dk{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n={...e};return this.last_&&Ce(this.last_,(i,s)=>{n[i]=n[i]-s}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ul=new Map,c_={activated:!1,tokenObservers:[]},kA={initialized:!1,enabled:!1};function me(t){return ul.get(t)||{...c_}}function RA(t,e){return ul.set(t,e),ul.get(t)}function wa(){return kA}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qA={error:"UNKNOWN_ERROR"};function zA(t){return Qo.encodeString(JSON.stringify(t),!1)}async function dl(t,e=!1,n=!1){const i=t.app;Ou(i);const s=me(i);let r=s.token,o;if(r&&!Ci(r)&&(s.token=void 0,r=void 0),!r){const l=await s.cachedTokenPromise;l&&(Ci(l)?r=l:await ac(i,void 0))}if(!e&&r&&Ci(r))return{token:r.token};let a=!1;if(Mu())try{s.exchangeTokenPromise||(s.exchangeTokenPromise=Du(d_(i,await xu()),t.heartbeatServiceProvider).finally(()=>{s.exchangeTokenPromise=void 0}),a=!0);const l=await s.exchangeTokenPromise;return await ac(i,l),s.token=l,{token:l.token}}catch(l){return l.code==="appCheck/throttled"||l.code==="appCheck/initial-throttle"?hn.warn(l.message):n&&hn.error(l),cc(l)}try{s.exchangeTokenPromise||(s.exchangeTokenPromise=s.provider.getToken().finally(()=>{s.exchangeTokenPromise=void 0}),a=!0),r=await me(i).exchangeTokenPromise}catch(l){l.code==="appCheck/throttled"||l.code==="appCheck/initial-throttle"?hn.warn(l.message):n&&hn.error(l),o=l}let c;return r?o?Ci(r)?c={token:r.token,internalError:o}:c=cc(o):(c={token:r.token},s.token=r,await ac(i,r)):c=cc(o),a&&w_(i,c),c}async function GA(t){const e=t.app;Ou(e);const{provider:n}=me(e);if(Mu()){const i=await xu(),{token:s}=await Du(d_(e,i),t.heartbeatServiceProvider);return{token:s}}else{const{token:i}=await n.getToken();return{token:i}}}function __(t,e,n,i){const{app:s}=t,r=me(s),o={next:n,error:i,type:e};if(r.tokenObservers=[...r.tokenObservers,o],r.token&&Ci(r.token)){const a=r.token;Promise.resolve().then(()=>{n({token:a.token}),Af(t)}).catch(()=>{})}r.cachedTokenPromise.then(()=>Af(t))}function y_(t,e){const n=me(t),i=n.tokenObservers.filter(s=>s.next!==e);i.length===0&&n.tokenRefresher&&n.tokenRefresher.isRunning()&&n.tokenRefresher.stop(),n.tokenObservers=i}function Af(t){const{app:e}=t,n=me(e);let i=n.tokenRefresher;i||(i=KA(t),n.tokenRefresher=i),!i.isRunning()&&n.isTokenAutoRefreshEnabled&&i.start()}function KA(t){const{app:e}=t;return new LA(async()=>{const n=me(e);let i;if(n.token?i=await dl(t,!0):i=await dl(t),i.error)throw i.error;if(i.internalError)throw i.internalError},()=>!0,()=>{const n=me(e);if(n.token){let i=n.token.issuedAtTimeMillis+(n.token.expireTimeMillis-n.token.issuedAtTimeMillis)*.5+3e5;const s=n.token.expireTimeMillis-300*1e3;return i=Math.min(i,s),Math.max(0,i-Date.now())}else return 0},kf.RETRIAL_MIN_WAIT,kf.RETRIAL_MAX_WAIT)}function w_(t,e){const n=me(t).tokenObservers;for(const i of n)try{i.type==="EXTERNAL"&&e.error!=null?i.error(e.error):i.next(e)}catch{}}function Ci(t){return t.expireTimeMillis-Date.now()>0}function cc(t){return{token:zA(qA),error:t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class YA{constructor(e,n){this.app=e,this.heartbeatServiceProvider=n}_delete(){const{tokenObservers:e}=me(this.app);for(const n of e)y_(this.app,n.next);return Promise.resolve()}}function JA(t,e){return new YA(t,e)}function XA(t){return{getToken:e=>dl(t,e),getLimitedUseToken:()=>GA(t),addTokenListener:e=>__(t,"INTERNAL",e),removeTokenListener:e=>y_(t.app,e)}}const QA="@firebase/app-check",ZA="0.11.0",eN="https://www.google.com/recaptcha/enterprise.js";function tN(t,e){const n=new Be,i=me(t);i.reCAPTCHAState={initialized:n};const s=nN(t),r=Rf(!0);return r?Nf(t,e,r,s,n):rN(()=>{const o=Rf(!0);if(!o)throw new Error("no recaptcha");Nf(t,e,o,s,n)}),n.promise}function Nf(t,e,n,i,s){n.ready(()=>{sN(t,e,n,i),s.resolve(n)})}function nN(t){const e=`fire_app_check_${t.name}`,n=document.createElement("div");return n.id=e,n.style.display="none",document.body.appendChild(n),e}async function iN(t){Ou(t);const n=await me(t).reCAPTCHAState.initialized.promise;return new Promise((i,s)=>{const r=me(t).reCAPTCHAState;n.ready(()=>{i(n.execute(r.widgetId,{action:"fire_app_check"}))})})}function sN(t,e,n,i){const s=n.render(i,{sitekey:e,size:"invisible",callback:()=>{me(t).reCAPTCHAState.succeeded=!0},"error-callback":()=>{me(t).reCAPTCHAState.succeeded=!1}}),r=me(t);r.reCAPTCHAState={...r.reCAPTCHAState,widgetId:s}}function rN(t){const e=document.createElement("script");e.src=eN,e.onload=t,document.head.appendChild(e)}class Fu{constructor(e){this._siteKey=e,this._throttleData=null}async getToken(){aN(this._throttleData);const e=await iN(this._app).catch(i=>{throw Ve.create("recaptcha-error")});if(!me(this._app).reCAPTCHAState?.succeeded)throw Ve.create("recaptcha-error");let n;try{n=await Du(MA(this._app,e),this._heartbeatServiceProvider)}catch(i){throw i.code?.includes("fetch-status-error")?(this._throttleData=oN(Number(i.customData?.httpStatus),this._throttleData),Ve.create("initial-throttle",{time:u_(this._throttleData.allowRequestsAfter-Date.now()),httpStatus:this._throttleData.httpStatus})):i}return this._throttleData=null,n}initialize(e){this._app=e,this._heartbeatServiceProvider=Nn(e,"heartbeat"),tN(e,this._siteKey).catch(()=>{})}isEqual(e){return e instanceof Fu?this._siteKey===e._siteKey:!1}}function oN(t,e){if(t===404||t===403)return{backoffCount:1,allowRequestsAfter:Date.now()+PA,httpStatus:t};{const n=e?e.backoffCount:0,i=dS(n,1e3,2);return{backoffCount:n+1,allowRequestsAfter:Date.now()+i,httpStatus:t}}}function aN(t){if(t&&Date.now()-t.allowRequestsAfter<=0)throw Ve.create("throttled",{time:u_(t.allowRequestsAfter-Date.now()),httpStatus:t.httpStatus})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ew=1e4,tw=`w:${Ed}`,nw="FIS_v2",TO="https://firebaseinstallations.googleapis.com/v1",SO=3600*1e3,IO="installations",kO="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function LO({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const i=sw(t),s=aw(t),r=e.getImmediate({optional:!0});if(r){const l=await r.getHeartbeatsHeader();l&&s.append("x-firebase-client",l)}const o={fid:n,authVersion:nw,appId:t.appId,sdkVersion:tw},a={method:"POST",headers:s,body:JSON.stringify(o)},c=await cw(()=>fetch(i,a));if(c.ok){const l=await c.json();return{fid:l.fid||n,registrationStatus:2,refreshToken:l.refreshToken,authToken:rw(l.authToken)}}else throw await ow("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DO=/^[cdef][\w-]{21}$/,Al="";function MO(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const n=xO(t);return DO.test(n)?n:Al}catch{return Al}}function xO(t){return OO(t).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uw=new Map;function dw(t,e){const n=Oa(t);hw(n,e),FO(n,e)}function hw(t,e){const n=uw.get(t);if(n)for(const i of n)i(e)}function FO(t,e){const n=UO();n&&n.postMessage({key:t,fid:e}),$O()}let Wn=null;function UO(){return!Wn&&"BroadcastChannel"in self&&(Wn=new BroadcastChannel("[Firebase] FID Change"),Wn.onmessage=t=>{hw(t.data.key,t.data.fid)}),Wn}function $O(){uw.size===0&&Wn&&(Wn.close(),Wn=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Td(t){let e;const n=await Da(t.appConfig,i=>{const s=VO(i),r=jO(t,s);return e=r.registrationPromise,r.installationEntry});return n.fid===Al?{installationEntry:await e}:{installationEntry:n,registrationPromise:e}}function VO(t){const e=t||{fid:MO(),registrationStatus:0};return pw(e)}function jO(t,e){if(e.registrationStatus===0){if(!navigator.onLine){const s=Promise.reject(li.create("app-offline"));return{installationEntry:e,registrationPromise:s}}const n={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},i=WO(t,n);return{installationEntry:n,registrationPromise:i}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:qO(t)}:{installationEntry:e}}async function WO(t,e){try{const n=await LO(t,e);return Bo(t.appConfig,n)}catch(n){throw iw(n)&&n.customData.serverCode===409?await fw(t.appConfig):await Bo(t.appConfig,{fid:e.fid,registrationStatus:0}),n}}async function qO(t){let e=await lp(t.appConfig);for(;e.registrationStatus===1;)await lw(100),e=await lp(t.appConfig);if(e.registrationStatus===0){const{installationEntry:n,registrationPromise:i}=await Td(t);return i||n}return e}function lp(t){return Da(t,e=>{if(!e)throw li.create("installation-not-found");return pw(e)})}function pw(t){return zO(t)?{fid:t.fid,registrationStatus:0}:t}function zO(t){return t.registrationStatus===1&&t.registrationTime+ew<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function GO({appConfig:t,heartbeatServiceProvider:e},n){const i=KO(t,n),s=AO(t,n),r=e.getImmediate({optional:!0});if(r){const l=await r.getHeartbeatsHeader();l&&s.append("x-firebase-client",l)}const o={installation:{sdkVersion:tw,appId:t.appId}},a={method:"POST",headers:s,body:JSON.stringify(o)},c=await cw(()=>fetch(i,a));if(c.ok){const l=await c.json();return rw(l)}else throw await ow("Generate Auth Token",c)}function KO(t,{fid:e}){return`${sw(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sd(t,e=!1){let n;const i=await Da(t.appConfig,r=>{if(!gw(r))throw li.create("not-registered");const o=r.authToken;if(!e&&XO(o))return r;if(o.requestStatus===1)return n=YO(t,e),r;{if(!navigator.onLine)throw li.create("app-offline");const a=ZO(r);return n=JO(t,a),a}});return n?await n:i.authToken}async function YO(t,e){let n=await up(t.appConfig);for(;n.authToken.requestStatus===1;)await lw(100),n=await up(t.appConfig);const i=n.authToken;return i.requestStatus===0?Sd(t,e):i}function up(t){return Da(t,e=>{if(!gw(e))throw li.create("not-registered");const n=e.authToken;return eD(n)?{...e,authToken:{requestStatus:0}}:e})}async function JO(t,e){try{const n=await GO(t,e),i={...e,authToken:n};return await Bo(t.appConfig,i),n}catch(n){if(iw(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await fw(t.appConfig);else{const i={...e,authToken:{requestStatus:0}};await Bo(t.appConfig,i)}throw n}}function gw(t){return t!==void 0&&t.registrationStatus===2}function XO(t){return t.requestStatus===2&&!QO(t)}function QO(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+SO}function ZO(t){const e={requestStatus:1,requestTime:Date.now()};return{...t,authToken:e}}function eD(t){return t.requestStatus===1&&t.requestTime+ew<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tD(t){const e=t,{installationEntry:n,registrationPromise:i}=await Td(e);return i?i.catch(console.error):Sd(e).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nD(t,e=!1){const n=t;return await iD(n),(await Sd(n,e)).token}async function iD(t){const{registrationPromise:e}=await Td(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sD(t){if(!t||!t.options)throw vc("App Configuration");if(!t.name)throw vc("App Name");const e=["projectId","apiKey","appId"];for(const n of e)if(!t.options[n])throw vc(n);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}function vc(t){return li.create("missing-app-config-values",{valueName:t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mw="installations",rD="installations-internal",oD=t=>{const e=t.getProvider("app").getImmediate(),n=sD(e),i=Nn(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},aD=t=>{const e=t.getProvider("app").getImmediate(),n=Nn(e,mw).getImmediate();return{getId:()=>tD(n),getToken:s=>nD(n,s)}};function cD(){tt(new Ke(mw,oD,"PUBLIC")),tt(new Ke(rD,aD,"PRIVATE"))}cD();ze(Zy,Ed);ze(Zy,Ed,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lD="/firebase-messaging-sw.js",uD="/firebase-cloud-messaging-push-scope",_w="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",dD="https://fcmregistrations.googleapis.com/v1",yw="google.c.a.c_id",hD="google.c.a.c_l",fD="google.c.a.ts",pD="google.c.a.e",dp=1e4;var hp;(function(t){t[t.DATA_MESSAGE=1]="DATA_MESSAGE",t[t.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(hp||(hp={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lt(t){const e=new Uint8Array(t);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function gD(t){const e="=".repeat((4-t.length%4)%4),n=(t+e).replace(/\-/g,"+").replace(/_/g,"/"),i=atob(n),s=new Uint8Array(i.length);for(let r=0;r<i.length;++r)s[r]=i.charCodeAt(r);return s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bc="fcm_token_details_db",mD=5,fp="fcm_token_object_Store";async function _D(t){if("databases"in indexedDB&&!(await indexedDB.databases()).map(r=>r.name).includes(bc))return null;let e=null;return(await na(bc,mD,{upgrade:async(i,s,r,o)=>{if(s<2||!i.objectStoreNames.contains(fp))return;const a=o.objectStore(fp),c=await a.index("fcmSenderId").get(t);if(await a.clear(),!!c){if(s===2){const l=c;if(!l.auth||!l.p256dh||!l.endpoint)return;e={token:l.fcmToken,createTime:l.createTime??Date.now(),subscriptionOptions:{auth:l.auth,p256dh:l.p256dh,endpoint:l.endpoint,swScope:l.swScope,vapidKey:typeof l.vapidKey=="string"?l.vapidKey:Lt(l.vapidKey)}}}else if(s===3){const l=c;e={token:l.fcmToken,createTime:l.createTime,subscriptionOptions:{auth:Lt(l.auth),p256dh:Lt(l.p256dh),endpoint:l.endpoint,swScope:l.swScope,vapidKey:Lt(l.vapidKey)}}}else if(s===4){const l=c;e={token:l.fcmToken,createTime:l.createTime,subscriptionOptions:{auth:Lt(l.auth),p256dh:Lt(l.p256dh),endpoint:l.endpoint,swScope:l.swScope,vapidKey:Lt(l.vapidKey)}}}}}})).close(),await Xa(bc),await Xa("fcm_vapid_details_db"),await Xa("undefined"),yD(e)?e:null}function yD(t){if(!t||!t.subscriptionOptions)return!1;const{subscriptionOptions:e}=t;return typeof t.createTime=="number"&&t.createTime>0&&typeof t.token=="string"&&t.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const SD=10080*60*1e3;async function ID(t){const e=await AD(t.swRegistration,t.vapidKey),n={vapidKey:t.vapidKey,swScope:t.swRegistration.scope,endpoint:e.endpoint,auth:Lt(e.getKey("auth")),p256dh:Lt(e.getKey("p256dh"))},i=await ww(t.firebaseDependencies);if(i){if(ND(i.subscriptionOptions,n))return Date.now()>=i.createTime+SD?RD(t,{token:i.token,createTime:Date.now(),subscriptionOptions:n}):i.token;try{await vw(t.firebaseDependencies,i.token)}catch(s){console.warn(s)}return pp(t.firebaseDependencies,n)}else return pp(t.firebaseDependencies,n)}async function kD(t){const e=await ww(t.firebaseDependencies);e&&(await vw(t.firebaseDependencies,e.token),await bD(t.firebaseDependencies));const n=await t.swRegistration.pushManager.getSubscription();return n?n.unsubscribe():!0}async function RD(t,e){try{const n=await TD(t.firebaseDependencies,e),i={...e,token:n,createTime:Date.now()};return await kd(t.firebaseDependencies,i),n}catch(n){throw n}}async function pp(t,e){const i={token:await CD(t,e),createTime:Date.now(),subscriptionOptions:e};return await kd(t,i),i.token}async function AD(t,e){const n=await t.pushManager.getSubscription();return n||t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:gD(e)})}function ND(t,e){const n=e.vapidKey===t.vapidKey,i=e.endpoint===t.endpoint,s=e.auth===t.auth,r=e.p256dh===t.p256dh;return n&&i&&s&&r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DD(t){return typeof t=="object"&&!!t&&yw in t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ew(t){try{t.swRegistration=await navigator.serviceWorker.register(lD,{scope:uD}),t.swRegistration.update().catch(()=>{}),await FD(t.swRegistration)}catch(e){throw Re.create("failed-service-worker-registration",{browserErrorMessage:e?.message})}}async function FD(t){return new Promise((e,n)=>{const i=setTimeout(()=>n(new Error(`Service worker not registered after ${dp} ms`)),dp),s=t.installing||t.waiting;t.active?(clearTimeout(i),e()):s?s.onstatechange=r=>{r.target?.state==="activated"&&(s.onstatechange=null,clearTimeout(i),e())}:(clearTimeout(i),n(new Error("No incoming service worker found.")))})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function UD(t,e){if(!e&&!t.swRegistration&&await Ew(t),!(!e&&t.swRegistration)){if(!(e instanceof ServiceWorkerRegistration))throw Re.create("invalid-sw-registration");t.swRegistration=e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $D(t,e){e?t.vapidKey=e:t.vapidKey||(t.vapidKey=_w)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cw(t,e){if(!navigator)throw Re.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw Re.create("permission-blocked");return await $D(t,e?.vapidKey),await UD(t,e?.serviceWorkerRegistration),ID(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function BD(t,e,n){const i=HD(e);(await t.firebaseDependencies.analyticsProvider.get()).logEvent(i,{message_id:n[yw],message_name:n[hD],message_time:n[fD],message_device_time:Math.floor(Date.now()/1e3)})}function HD(t){switch(t){case lr.NOTIFICATION_CLICKED:return"notification_open";case lr.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function VD(t,e){const n=e.data;if(!n.isFirebaseMessaging)return;t.onMessageHandler&&n.messageType===lr.PUSH_RECEIVED&&(typeof t.onMessageHandler=="function"?t.onMessageHandler(gp(n)):t.onMessageHandler.next(gp(n)));const i=n.data;DD(i)&&i[pD]==="1"&&await BD(t,n.messageType,i)}const mp="@firebase/messaging",_p="0.12.23";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jD=t=>{const e=new xD(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>VD(e,n)),e},WD=t=>{const e=t.getProvider("messaging").getImmediate();return{getToken:i=>Cw(e,i)}};function qD(){tt(new Ke("messaging",jD,"PUBLIC")),tt(new Ke("messaging-internal",WD,"PRIVATE")),ze(mp,_p),ze(mp,_p,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zD(){try{await Lg()}catch{return!1}return typeof window<"u"&&Zo()&&JT()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function GD(t){if(!navigator)throw Re.create("only-available-in-window");return t.swRegistration||await Ew(t),kD(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function KD(t,e){if(!navigator)throw Re.create("only-available-in-window");return t.onMessageHandler=e,()=>{t.onMessageHandler=null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function YD(t=ia()){return zD().then(e=>{if(!e)throw Re.create("unsupported-browser")},e=>{throw Re.create("indexed-db-unsupported")}),Nn(se(t),"messaging").getImmediate()}async function JD(t,e){return t=se(t),Cw(t,e)}function yp(t){return t=se(t),GD(t)}function XD(t,e){return t=se(t),KD(t,e)}qD();class Tw{constructor(){this.messaging=null,this.currentToken=null,this.vapidKey=fN,this.isInitialized=!1,this.messageCallbacks=new Set,this.tokenRefreshCallbacks=new Set}async initialize(){if(this.isInitialized)return!0;try{return!("serviceWorker"in navigator)||!("Notification"in window)?(console.warn("[FCMTransport] FCM not supported in this environment"),!1):this.vapidKey?(this.messaging=YD(va),XD(this.messaging,e=>{console.log("[FCMTransport] Foreground message received:",e),this.messageCallbacks.forEach(n=>{try{n(e)}catch(i){console.error("[FCMTransport] Error in message callback:",i)}})}),this.isInitialized=!0,console.log("[FCMTransport] Initialized successfully"),!0):(console.warn("[FCMTransport] VAPID key not configured"),!1)}catch(e){return console.error("[FCMTransport] Initialization failed:",e),!1}}async getToken(){if(!this.isInitialized&&(console.log("[FCMTransport] Not initialized, initializing now..."),!await this.initialize()))return console.error("[FCMTransport] Initialization failed, cannot get token"),null;try{console.log("[FCMTransport] Requesting FCM token..."),console.log("[FCMTransport] VAPID key present:",!!this.vapidKey),console.log("[FCMTransport] Messaging instance:",!!this.messaging);const e=await JD(this.messaging,{vapidKey:this.vapidKey});return e?(this.currentToken=e,console.log("[FCMTransport] Token obtained successfully"),console.log("[FCMTransport] Token (truncated):",e.substring(0,20)+"..."),await this.storeUserToken(e),e):(console.warn("[FCMTransport] No registration token available"),console.warn("[FCMTransport] This usually means:"),console.warn("[FCMTransport]   1. Service worker is not registered"),console.warn("[FCMTransport]   2. Notification permission not granted"),console.warn("[FCMTransport]   3. VAPID key is incorrect"),null)}catch(e){return console.error("[FCMTransport] Failed to get token:",e),console.error("[FCMTransport] Error name:",e.name),console.error("[FCMTransport] Error code:",e.code),console.error("[FCMTransport] Error message:",e.message),e.code==="messaging/unsupported-browser"?console.error("[FCMTransport] Browser does not support FCM"):e.code==="messaging/permission-blocked"?console.error("[FCMTransport] Notification permission is blocked"):e.code==="messaging/failed-service-worker-registration"&&(console.error("[FCMTransport] Service worker registration failed"),console.error("[FCMTransport] Make sure service worker is registered before calling getToken()")),null}}async refreshToken(){if(console.log("[FCMTransport] Refreshing token..."),this.currentToken)try{await yp(this.messaging),await this.removeUserToken(this.currentToken)}catch(n){console.warn("[FCMTransport] Failed to delete old token:",n)}this.currentToken=null;const e=await this.getToken();return e&&this.tokenRefreshCallbacks.forEach(n=>{try{n(e)}catch(i){console.error("[FCMTransport] Error in token refresh callback:",i)}}),e}async deleteToken(){if(!this.messaging||!this.currentToken)return!0;try{return await yp(this.messaging),await this.removeUserToken(this.currentToken),this.currentToken=null,console.log("[FCMTransport] Token deleted successfully"),!0}catch(e){return console.error("[FCMTransport] Failed to delete token:",e),!1}}async storeUserToken(e){const n=N();if(!n){console.warn("[FCMTransport] Cannot store token: user not logged in");return}try{const i=b(E,`users/${n}/fcmTokens/${this.getTokenId(e)}`),s={token:e,deviceInfo:{platform:this.getPlatform(),timestamp:Date.now()},createdAt:Date.now(),lastUsed:Date.now()};await Q(i,s),console.log("[FCMTransport] Token stored in RTDB")}catch(i){console.error("[FCMTransport] Failed to store token in RTDB:",i)}}async removeUserToken(e){const n=N();if(n)try{const i=b(E,`users/${n}/fcmTokens/${this.getTokenId(e)}`);await Ye(i),console.log("[FCMTransport] Token removed from RTDB")}catch(i){console.error("[FCMTransport] Failed to remove token from RTDB:",i)}}async getUserTokens(e){try{const n=b(E,`users/${e}/fcmTokens`),i=await Ie(n);if(i.exists()){const s=i.val();return Object.values(s)}return[]}catch(n){return console.error("[FCMTransport] Failed to get user tokens:",n),[]}}async sendCallNotification(e,n){const{roomId:i,callerId:s,callerName:r}=n,o={type:"call",roomId:i,callerId:s,callerName:r,timestamp:Date.now().toString()},a="/HangVidU/",c={notification:{title:`Incoming call from ${r}`,body:"Tap to answer or decline",icon:`${a}icons/play-arrows-v1/icon-192.png`,badge:`${a}icons/play-arrows-v1/icon-192.png`},data:o};return this.sendNotification(e,c)}async sendMissedCallNotification(e,n){const{roomId:i,callerId:s,callerName:r}=n,o={type:"missed_call",roomId:i,callerId:s,callerName:r,timestamp:Date.now().toString()},a="/HangVidU/",c={notification:{title:`Missed call from ${r}`,body:"Tap to call back",icon:`${a}icons/play-arrows-v1/icon-192.png`,badge:`${a}icons/play-arrows-v1/icon-192.png`},data:o};return this.sendNotification(e,c)}async sendMessageNotification(e,n){const{senderId:i,senderName:s,messageText:r}=n,o=typeof r=="string"?r:String(r||""),a=o.length>50?o.substring(0,47)+"...":o,c={type:"message",senderId:i,senderName:s,messagePreview:a,timestamp:Date.now().toString()},l="/HangVidU/",u={notification:{title:`New message from ${s}`,body:a,icon:`${l}icons/play-arrows-v1/icon-192.png`,badge:`${l}icons/play-arrows-v1/icon-192.png`},data:c};return this.sendNotification(e,u)}async sendNotification(e,n){try{{let o=null;try{const{getLoggedInUserToken:l}=await pe(async()=>{const{getLoggedInUserToken:u}=await Promise.resolve().then(()=>ed);return{getLoggedInUserToken:u}},void 0);o=await l()}catch(l){console.warn("[FCMTransport] Failed to get auth token:",l)}const a={"Content-Type":"application/json"};o&&(a.Authorization=`Bearer ${o}`);const c=await fetch("https://europe-west1-vidu-aae11.cloudfunctions.net/sendCallNotification",{method:"POST",headers:a,body:JSON.stringify({targetUserId:e,callData:n.data})});if(c.ok){const l=await c.json();return console.log(`[FCMTransport] FCM notification sent to ${e}:`,l),!0}else return console.error("[FCMTransport] FCM function failed:",c.status),!1}const i=b(E,`notifications/${e}`),s=Qs(i).key,r={id:s,payload:n,createdAt:Date.now(),delivered:!1};return await Q(b(E,`notifications/${e}/${s}`),r),console.log(`[FCMTransport] Notification queued for user ${e} (dev mode)`),!0}catch(i){return console.error("[FCMTransport] Failed to send notification:",i),!1}}onMessage(e){return this.messageCallbacks.add(e),()=>this.messageCallbacks.delete(e)}onTokenRefresh(e){return this.tokenRefreshCallbacks.add(e),()=>this.tokenRefreshCallbacks.delete(e)}getTokenId(e){return btoa(e).replace(/[^a-zA-Z0-9]/g,"").substring(0,20)}getPlatform(){const e=navigator.userAgent;return/iPhone|iPad|iPod/.test(e)?"ios":/Android/.test(e)?"android":/Macintosh/.test(e)?"macos":/Windows/.test(e)?"windows":"unknown"}static isSupported(){return"serviceWorker"in navigator&&"Notification"in window}}const QD=Object.freeze(Object.defineProperty({__proto__:null,FCMTransport:Tw},Symbol.toStringTag,{value:"Module"}));class ZD{constructor(e=null,n={}){this.transport=e||new Tw,this.isEnabled=!1,this.permissionState="default",this.options={enableCallNotifications:!0,enableMessageNotifications:!0,privacyMode:!1,autoHideSuccessMs:6e3,...n},this.activeNotifications=new Map,this.permissionCallbacks=new Set,this.notificationCallbacks=new Set}async initialize(){try{return await this.transport.initialize()?(this.permissionState=this.getPermissionState(),this.transport.onMessage(n=>{this.handleForegroundMessage(n)}),console.log("[PushNotificationController] Initialized successfully"),!0):(console.warn("[PushNotificationController] Transport initialization failed"),!1)}catch(e){return console.error("[PushNotificationController] Initialization failed:",e),!1}}async requestPermission(e={}){const{title:n="Enable notifications",explain:i="Get notified of incoming calls and messages even when the app is closed.",onGranted:s=null,onDenied:r=null,onDismissed:o=null}=e;if(!this.isNotificationSupported())return console.warn("[PushNotificationController] Notifications not supported"),{state:"denied",reason:"unsupported"};this.detectBrowser();const a=Notification.permission;if(this.permissionState=a,a==="granted")return await this.enable(),s?.(),{state:"granted"};if(a==="denied")return r?.("already-denied"),{state:"denied",reason:"already-denied"};let c;try{c=await Notification.requestPermission()}catch(l){console.error("[PushNotificationController] Permission request failed:",l),c=Notification.permission}return this.permissionState=c,c==="granted"?(await this.enable(),s?.(),{state:"granted"}):a==="default"&&c==="denied"?(r?.("silent-block"),{state:"denied",reason:"silent-block"}):c==="default"?(o?.(),{state:"dismissed"}):(r?.(),{state:"denied"})}async enable(){if(this.permissionState!=="granted")return console.warn("[PushNotificationController] Cannot enable: permission not granted"),!1;try{return await this.transport.getToken()?(this.isEnabled=!0,console.log("[PushNotificationController] Notifications enabled"),this.permissionCallbacks.forEach(n=>{try{n("enabled")}catch(i){console.error("[PushNotificationController] Error in permission callback:",i)}}),!0):(console.warn("[PushNotificationController] Failed to get FCM token"),!1)}catch(e){return console.error("[PushNotificationController] Failed to enable notifications:",e),!1}}async disable(){try{return await this.transport.deleteToken(),this.isEnabled=!1,this.activeNotifications.clear(),console.log("[PushNotificationController] Notifications disabled"),this.permissionCallbacks.forEach(e=>{try{e("disabled")}catch(n){console.error("[PushNotificationController] Error in permission callback:",n)}}),!0}catch(e){return console.error("[PushNotificationController] Failed to disable notifications:",e),!1}}async sendCallNotification(e,n){if(!this.options.enableCallNotifications)return console.log("[PushNotificationController] Call notifications disabled"),!1;try{const i=await this.transport.sendCallNotification(e,n);if(i){const s=`call_${n.roomId}_${Date.now()}`;this.activeNotifications.set(s,{type:"call",roomId:n.roomId,targetUserId:e,timestamp:Date.now()}),console.log(`[PushNotificationController] Call notification sent to ${e}`)}return i}catch(i){return console.error("[PushNotificationController] Failed to send call notification:",i),!1}}async sendMissedCallNotification(e,n){if(!this.options.enableCallNotifications)return console.log("[PushNotificationController] Call notifications disabled (missed call masked)"),!1;try{const i=await this.transport.sendMissedCallNotification(e,n);return i&&console.log(`[PushNotificationController] Missed call notification sent to ${e}`),i}catch(i){return console.error("[PushNotificationController] Failed to send missed call notification:",i),!1}}async sendMessageNotification(e,n){if(!this.options.enableMessageNotifications)return console.log("[PushNotificationController] Message notifications disabled"),!1;if(!this.shouldSendNotification())return console.log("[PushNotificationController] Not sending message notification (app in foreground)"),!1;try{const i=await this.transport.sendMessageNotification(e,n);if(i){const s=`message_${e}_${Date.now()}`;this.activeNotifications.set(s,{type:"message",senderId:n.senderId,targetUserId:e,timestamp:Date.now()}),console.log(`[PushNotificationController] Message notification sent to ${e}`)}return i}catch(i){return console.error("[PushNotificationController] Failed to send message notification:",i),!1}}async dismissCallNotifications(e){try{const n=[];for(const[i,s]of this.activeNotifications)s.type==="call"&&s.roomId===e&&n.push(i);n.forEach(i=>this.activeNotifications.delete(i)),n.length>0&&console.log(`[PushNotificationController] Dismissed ${n.length} call notifications for room ${e}`)}catch(n){console.error("[PushNotificationController] Failed to dismiss call notifications:",n)}}async dismissMessageNotifications(e){try{const n=[];for(const[i,s]of this.activeNotifications)s.type==="message"&&s.senderId===e&&n.push(i);n.forEach(i=>this.activeNotifications.delete(i)),n.length>0&&console.log(`[PushNotificationController] Dismissed ${n.length} message notifications from ${e}`)}catch(n){console.error("[PushNotificationController] Failed to dismiss message notifications:",n)}}async cleanupOldNotifications(){const e=Date.now(),n=1440*60*1e3,i=[];for(const[s,r]of this.activeNotifications)e-r.timestamp>n&&i.push(s);i.forEach(s=>this.activeNotifications.delete(s)),i.length>0&&console.log(`[PushNotificationController] Cleaned up ${i.length} old notifications`)}handleForegroundMessage(e){console.log("[PushNotificationController] Foreground message received:",e);const n=e?.data?.senderId||e?.data?.callerId,i=N();if(n&&i&&n===i){console.log("[PushNotificationController] Ignoring self-notification");return}this.notificationCallbacks.forEach(s=>{try{s(e)}catch(r){console.error("[PushNotificationController] Error in notification callback:",r)}})}shouldSendNotification(){return document.hidden||!document.hasFocus()}getPermissionState(){return this.isNotificationSupported()?Notification.permission:"unsupported"}isNotificationEnabled(){return this.isEnabled&&this.permissionState==="granted"}isNotificationSupported(){return"Notification"in window&&"serviceWorker"in navigator}updateOptions(e){this.options={...this.options,...e},console.log("[PushNotificationController] Options updated:",this.options)}onPermissionChange(e){return this.permissionCallbacks.add(e),()=>this.permissionCallbacks.delete(e)}onNotification(e){return this.notificationCallbacks.add(e),()=>this.notificationCallbacks.delete(e)}detectBrowser(){if(navigator.userAgentData&&navigator.userAgentData.brands){const n=navigator.userAgentData.brands.map(i=>i.brand);if(n.some(i=>i.includes("Microsoft Edge")))return"Edge";if(n.some(i=>i.includes("Google Chrome")))return"Chrome";if(n.some(i=>i.includes("Chromium")))return"Chromium"}const e=navigator.userAgent;return e.includes("Edg/")?"Edge":e.includes("Chrome/")?"Chrome":e.includes("Safari/")&&!e.includes("Chrome")?"Safari":e.includes("Firefox/")?"Firefox":"Your browser"}async formatCallNotification(e){const{roomId:n,callerId:i,callerName:s}=e;let r=s||i||"Unknown caller";if(!s)try{const{resolveCallerName:o}=await pe(async()=>{const{resolveCallerName:a}=await Promise.resolve().then(()=>Nl);return{resolveCallerName:a}},void 0);r=await o(n,i)}catch(o){console.warn("[PushNotificationController] Failed to resolve caller name:",o)}return this.options.privacyMode&&(r="Someone"),{...e,callerName:r}}async formatMessageNotification(e){const{senderId:n,senderName:i,messageText:s}=e;let r=i,o=s;try{const{getContacts:a}=await pe(async()=>{const{getContacts:l}=await Promise.resolve().then(()=>Nl);return{getContacts:l}},void 0),c=await a();c&&c[n]&&(r=c[n].name||i)}catch(a){console.warn("[PushNotificationController] Failed to resolve sender name:",a),r=i||n||"Unknown sender"}return this.options.privacyMode?(r="Someone",o="New message"):o&&o.length>50&&(o=o.substring(0,47)+"..."),{...e,senderName:r,messageText:o}}}const ce=new ZD;function eM(){v(he),v(be),v(xe),v(Ze)}function tM(t){t.on("memberJoined",By),t.on("cleanup",()=>{Jn(),Hy()})}let Fi=null;function Pd(t,e={}){return new Promise(n=>{const i=document.createElement("dialog");i.innerHTML=`
  ...
  `,rM(i,t),oM(n),await aM(i,n,e),N()&&Promise.all(n.map(async s=>{if(!(await Ie(b(E,`users/${s}/presence`))).exists()){const o=i.querySelector(`.contact-entry:has([data-contact-id="${s}"])`);o&&o.remove()}})).catch(s=>console.warn("[CONTACTS] Background presence check failed:",s))}function rM(t,e){t.querySelectorAll(".contact-message-btn").forEach(n=>{n.onclick=i=>{i.stopPropagation();const s=n.getAttribute("data-contact-id"),r=n.getAttribute("data-contact-name");s&&Ma(s,r)}}),t.querySelectorAll(".contact-name").forEach(n=>{n.onclick=async()=>{let i=n.getAttribute("data-room-id");const s=n.getAttribute("data-contact-name"),r=n.getAttribute("data-contact-id");if(!i&&r){const o=N();if(o)try{i=ir(o,r),console.log("[CONTACTS] Generated deterministic room ID:",i),await Ho(r,s,i),n.setAttribute("data-room-id",i)}catch(a){console.error("[CONTACTS] Failed to generate or save room ID:",a);return}}if(i&&(hi(i),await Ar(i,{forceInitiator:!0}).catch(a=>(console.warn("Failed to call contact:",a),!1)))){await vy(i,s);try{const a=Gt(),c=a?.displayName||a?.email||N();await ce.sendCallNotification(r,{roomId:i,callerId:N(),callerName:c}),console.log("[CONTACTS] Call notification sent to:",s)}catch(a){console.warn("[CONTACTS] Failed to send call notification:",a)}}}}),t.querySelectorAll(".contact-delete-btn").forEach(n=>{n.onclick=async()=>{const i=n.getAttribute("data-contact-id");!i||!window.confirm("Delete this contact?")||(await cM(i),await kt(e))}}),t.querySelectorAll(".contact-edit-btn").forEach(n=>{n.onclick=async()=>{const i=n.getAttribute("data-contact-id");if(!i)return;const r=(await Jt())[i];if(!r)return;const o=prompt("Enter new name for this contact:",r.contactName);o&&o.trim()&&o.trim()!==r.contactName&&(await Ho(i,o.trim(),r.roomId),await kt(e))}})}function Ma(t,e,n=!1){if(!N()){alert("Please sign in to send messages");return}if(yn.getSession(t)){Ne.showMessagesToggle(),n&&!Ne.isMessagesUIOpen()&&Ne.toggleMessages();return}yn.getAllSessions().forEach(a=>{a.close()}),Ne.clearMessages(),Ne.setSession(null);const r=yn.openSession(t,{onMessage:(a,c,l)=>{if(c._reactionUpdate){const d={};if(c.reactions)for(const[h,f]of Object.entries(c.reactions))d[h]=Object.keys(f);Ne.updateMessageReactions(c.messageId,d);return}const u={};if(c.reactions)for(const[d,h]of Object.entries(c.reactions))u[d]=Object.keys(h);if(l)Ne.appendChatMessage(a,{isSentByMe:!0,messageId:c.messageId,reactions:u});else{const d=!c.read;Ne.receiveMessage(a,{isUnread:d,messageId:c.messageId,reactions:u})}}});r.contactName=e,r.toggle=Ti.get(t),Ne.setSession(r),Ne.showMessagesToggle(),n&&!Ne.isMessagesUIOpen()&&Ne.toggleMessages(),r.markAsRead().catch(a=>{console.warn("Failed to mark messages as read:",a)});const o=Ti.get(t);o&&o.clearBadge()}function oM(t){Tc.forEach(({ref:e,callback:n})=>{Tt(e,"value",n)}),Tc.clear(),N()&&t.forEach(e=>{const n=b(E,`users/${e}/presence`),i=document.querySelector(`.presence-indicator[data-contact-id="${e}"]`);if(!i)return;const s=r=>{const a=r.val()?.state==="online";i.style.backgroundColor=a?"#00d26a":"#444",i.title=a?"Online":"Offline"};Lu(n,s),Tc.set(e,{ref:n,callback:s})})}let vs=!1,vi=null;async function aM(t,e,n){if(!N())return;const i=10;let s=0;for(;vs&&s<i;)await new Promise(r=>setTimeout(r,100)),s++;if(vs){console.debug("[CONTACTS] Toggle replacement still in progress after waiting, skipping");return}vs=!0,vi&&clearTimeout(vi),vi=setTimeout(()=>{console.warn("[CONTACTS] Toggle replacement timeout - forcing flag reset"),vs=!1},5e3);try{Ti.forEach(o=>{o.cleanup()}),Ti.clear(),Sc.forEach(o=>{o()}),Sc.clear();const r=N();for(const o of e){const a=n[o],c=t.querySelector(`.contact-msg-toggle-container[data-contact-id="${o}"]`);if(!c){console.warn(`[CONTACTS] No toggle container found for contact ${o}`);continue}const l=Yy({parent:c,onToggle:()=>Ma(o,a.contactName,!0),icon:"💬",initialUnreadCount:0});if(!l){console.error(`[CONTACTS] Failed to create toggle for contact ${o}`);continue}Ti.set(o,l);const u=yn.listenToUnreadCount(o,d=>{l.setUnreadCount(d)});Sc.set(o,u)}Promise.all(e.map(o=>yn.getUnreadCount(o).then(a=>{const c=Ti.get(o);c&&c.setUnreadCount(a)}).catch(a=>console.warn(`[CONTACTS] Failed to get unread count for ${o}:`,a))))}finally{vi&&(clearTimeout(vi),vi=null),vs=!1}}async function cM(t){const e=N();if(e){try{await Ye(b(E,`users/${e}/contacts/${t}`))}catch(n){console.warn("Failed to delete contact from RTDB",n)}return}try{const n=localStorage.getItem("contacts")||"{}",i=JSON.parse(n);i[t]&&(delete i[t],localStorage.setItem("contacts",JSON.stringify(i)))}catch(n){console.warn("Failed to delete contact from localStorage",n)}}const Nl=Object.freeze(Object.defineProperty({__proto__:null,getContactByRoomId:sM,getContacts:Jt,openContactMessages:Ma,renderContactsList:kt,resolveCallerName:Sw,saveContact:Iw},Symbol.toStringTag,{value:"Module"}));let Ic=null,ln=null,ee=null,X=null,vp=!1,$r=!1,St=[],Pl="",Pe=-1,Ll=[];const lM="AIzaSyBPUjW7ac277WIYTbN4M8dUomK39qRQjhA",uM="https://www.googleapis.com/youtube/v3";async function dM(){if(vp||$r)return!1;$r=!0;const{initializeYouTubeElements:t}=await pe(async()=>{const{initializeYouTubeElements:o}=await Promise.resolve().then(()=>Y0);return{initializeYouTubeElements:o}},void 0),e=await t();if(Ic=e.searchContainer,ln=e.searchBtn,ee=e.searchQuery,X=e.searchResults,!Ic||!ln||!ee||!X)return console.error("YouTube search elements not found in DOM"),$r=!1,!1;const n=o=>/^https?:\/\//i.test(o),i=o=>{(X?.querySelectorAll(".search-result-item")||[]).forEach((c,l)=>{l===o?(c.classList.add("focused"),c.scrollIntoView({block:"nearest"})):c.classList.remove("focused")}),Pe=o??-1};ln.onclick=async()=>{const o=ee.value.trim();if(Mo(ee)){U(ee),ee.focus();return}if(!o){Zr(),v(ee);return}if(Cp()&&o===Pl)Ol(St);else if(!n(o))await bp(o);else{await ar({url:o,title:o,channel:"",thumbnail:"",id:o}),v(X),ee.value="",v(ee),Pe=-1;return}},Ic.addEventListener("keydown",async o=>{const a=X.querySelectorAll(".search-result-item");if(a.length>0&&(o.key==="ArrowDown"||o.key==="ArrowUp")){if(o.key==="ArrowDown"){let c=Pe+1;c>=a.length&&(c=0),i(c)}else if(o.key==="ArrowUp"){let c=Pe-1;c<0&&(c=Pe===-1?0:a.length-1),i(c)}return}if(o.key==="Enter"){if(a.length>0&&Pe>=0){a[Pe].click(),v(ee),v(X),Pe=-1;return}const c=ee.value.trim();if(c)if(Cp()&&c===Pl)Ol(St);else if(!n(c))await bp(c);else{await ar({url:c,title:c,channel:"",thumbnail:"",id:c}),v(X),Pe=-1,ee.value="",v(ee);return}}else o.key==="Escape"&&(fM()?Zr():ee.value?ee.value="":v(ee))}),ee.addEventListener("input",()=>{ee.value.trim()===""&&Zr(),Pe=-1});const s=cr(ee,()=>v(ee),{ignore:[ln],esc:!1});Ll.push(s);const r=cr(X,()=>v(X),{ignore:[ln],esc:!1});return Ll.push(r),$r=!1,vp=!0,!0}async function bp(t){if(!ln||!X){console.error("Search elements not initialized");return}St=[],Pl=t,ln.disabled=!0,X.innerHTML='<div class="search-loading">Searching YouTube...</div>',U(X);try{const e=await fetch(`${uM}/search?part=snippet&maxResults=10&q=${encodeURIComponent(t)}&type=video&key=${lM}`);if(!e.ok)throw e.status===403?new Error("YouTube API quota exceeded. Please try again later."):e.status===400?new Error("Invalid API key or request."):new Error(`YouTube API error: ${e.status}`);const n=await e.json();if(!n.items||n.items.length===0){Ep("No videos found"),St=[];return}St=n.items.map(i=>({id:i.id.videoId,title:i.snippet.title,thumbnail:i.snippet.thumbnails.medium.url,channel:i.snippet.channelTitle,url:`https://www.youtube.com/watch?v=${i.id.videoId}`})),Ol(St)}catch(e){console.error("YouTube search failed:",e),Ep(e.message||"Search failed. Please try again.")}finally{ln.disabled=!1}}function Ol(t){if(!X){console.error("Search results element not initialized");return}if(!t||t.length===0){X.innerHTML='<div class="search-no-results">No results found</div>',St=[],Pe=-1;return}X.innerHTML="",t.forEach(n=>{const i=document.createElement("div");i.className="search-result-item",i.innerHTML=`
    ...
    `,className:"notification invite-notification",handlers:{handleAccept:async l=>{const u=l.target;u.disabled=!0,u.textContent="Accepting...";try{n&&await n()}catch(d){console.error("[INVITE NOTIFICATION] Accept failed:",d),u.disabled=!1,u.textContent="Accept"}},handleDecline:async l=>{const u=l.target;u.disabled=!0,u.textContent="Declining...";try{i&&await i()}catch(d){console.error("[INVITE NOTIFICATION] Decline failed:",d),u.disabled=!1,u.textContent="Decline"}}}})}function Br(t){const e=document.createElement("div");return e.textContent=t||"",e.innerHTML}let bs=null;function mM(t,e=20){if(!t||t.length<=e)return t;const i=t.split(" ")[0];return i.length<=e?i:i.slice(0,e-3)+"..."}const _M=(t,e=null)=>{if(bs)return bs;if(!t)return console.error("Auth UI: Parent element is required"),null;let n=null,i=null,s=10;typeof e=="number"&&(s=e);const r=Qu();return bs=La({initialProps:{isLoggedIn:r,userName:"Guest User",userPhotoURL:"",userPhotoDisplay:"none",userInfoDisplay:"none",avatarDisplay:"none",signingInDisplay:"none",loginBtnMarginRightPx:s,loginBtnDisplay:r?"none":"inline-block",logoutBtnDisplay:r?"inline-block":"none"},template:`
...
`);let $;h.length===1?$=`mailto:${h[0].email}?subject=${T}&body=${P}`:$=`mailto:?bcc=${h.map(A=>A.email).join(",")}&subject=${T}&body=${P}`,window.location.href=$}}function Es(t){const e=document.createElement("div");return e.textContent=t||"",e.innerHTML.replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function SM(){const t=document.querySelector("link[rel~='icon']");return t?t.href:"/favicon.ico"}class IM{constructor(){this.originalTitle=document.title,this.originalFavicon=SM(),this.titleFlashInterval=null,this.isFlashing=!1,this.wakeLock=null,this.setupVisibilityListener()}setupVisibilityListener(){document.addEventListener("visibilitychange",()=>{!document.hidden&&this.isFlashing&&this.stopTitleFlashing()})}startCallIndicators(e){console.log(`[CallIndicators] Starting call indicators for: ${e}`),this.startTitleFlashing(e),this.setFavicon("/HangVidU/icons/phone-ringing.svg"),this.setBadge(1),this.requestWakeLock()}stopCallIndicators(){console.log("[CallIndicators] Stopping call indicators"),this.stopTitleFlashing(),this.restoreFavicon(),this.clearBadge(),this.releaseWakeLock()}startTitleFlashing(e){this.stopTitleFlashing();let n=!0;this.isFlashing=!0,document.title=`📞 Call from ${e}!`,this.titleFlashInterval=setInterval(()=>{this.isFlashing&&(document.title=n?`📞 Call from ${e}!`:this.originalTitle,n=!n)},1e3)}stopTitleFlashing(){this.titleFlashInterval&&(clearInterval(this.titleFlashInterval),this.titleFlashInterval=null),this.isFlashing=!1,document.title=this.originalTitle}setFavicon(e){const n=document.querySelector("link[rel~='icon']");n&&(n.href=e,console.log(`[CallIndicators] Favicon changed to: ${e}`))}restoreFavicon(){this.setFavicon(this.originalFavicon)}setBadge(e){"setAppBadge"in navigator&&navigator.setAppBadge(e).then(()=>{console.log(`[CallIndicators] Badge set to: ${e}`)}).catch(n=>{console.warn("[CallIndicators] Badge not supported:",n)})}clearBadge(){"clearAppBadge"in navigator&&navigator.clearAppBadge().then(()=>{console.log("[CallIndicators] Badge cleared")}).catch(e=>{console.warn("[CallIndicators] Badge clear failed:",e)})}async requestWakeLock(){if("wakeLock"in navigator)try{this.wakeLock=await navigator.wakeLock.request("screen"),console.log("[CallIndicators] Wake lock active"),this.wakeLock.addEventListener("release",()=>{console.log("[CallIndicators] Wake lock released"),this.wakeLock=null},{once:!0})}catch(e){console.warn("[CallIndicators] Wake lock failed:",e)}}releaseWakeLock(){if(this.wakeLock){const e=this.wakeLock;this.wakeLock=null,e.release().then(()=>{console.log("[CallIndicators] Wake lock released manually")}).catch(n=>{console.warn("[CallIndicators] Wake lock release failed:",n)})}}}const kc=new IM;let Ip=!1;function kM(t,e){const n=document.createElement("dialog");n.className="copy-link-dialog";const i=document.createElement("div");i.className="copy-link-dialog__content";const s=document.createElement("h2");s.className="copy-link-dialog__title",s.textContent=e.title,i.appendChild(s);const r=document.createElement("div");r.className="copy-link-dialog__input-container";const o=document.createElement("input");o.type="text",o.className="copy-link-dialog__input",o.value=t,o.readOnly=!0,o.setAttribute("aria-label","Link to copy"),r.appendChild(o),i.appendChild(r);const a=document.createElement("div");a.className="copy-link-dialog__buttons";const c=document.createElement("button");c.className="copy-link-dialog__button copy-link-dialog__button--primary",c.textContent=e.buttonText,c.autofocus=!0;const l=document.createElement("button");l.className="copy-link-dialog__button copy-link-dialog__button--secondary",l.textContent=e.cancelText,a.appendChild(c),a.appendChild(l),i.appendChild(a);const u=document.createElement("p");return u.className="copy-link-dialog__feedback",u.setAttribute("aria-live","polite"),i.appendChild(u),n.appendChild(i),{dialog:n,input:o,copyButton:c,cancelButton:l,feedback:u}}function RM(t,e={}){const n={title:"Share this link",buttonText:"Copy",cancelText:"Cancel",successMessage:"✓ Copied to clipboard!",errorMessage:"Failed to copy. Click the link to select it manually.",autoClose:!0,autoCloseDelay:1200,onCopy:null,onError:null,onCancel:null,onClose:null,...e};AM();const{dialog:i,input:s,copyButton:r,cancelButton:o,feedback:a}=kM(t,n);NM(i);let c=!1;const l=async()=>{await PM(t,s)?(c=!0,a.textContent=n.successMessage,a.classList.remove("copy-link-dialog__feedback--error"),n.onCopy&&n.onCopy(t),n.autoClose&&setTimeout(()=>{i.close()},n.autoCloseDelay)):(a.textContent=n.errorMessage,a.classList.add("copy-link-dialog__feedback--error"),s.readOnly=!1,s.addEventListener("click",()=>{s.select()}),n.onError&&n.onError())};return r.addEventListener("click",l),o.addEventListener("click",()=>{n.onCancel&&n.onCancel(),i.close()}),i.addEventListener("keydown",u=>{u.key==="Enter"&&!u.shiftKey&&!u.ctrlKey&&!u.altKey&&!u.metaKey&&(u.preventDefault(),l())}),i.addEventListener("close",()=>{!c&&n.onCancel&&n.onCancel(),n.onClose&&n.onClose(),setTimeout(()=>{i.remove()},300)}),document.body.appendChild(i),i.showModal(),i}function AM(){if(Ip)return;const t=document.createElement("style");t.textContent=`
  ...
  `,document.head.appendChild(t),Ip=!0}function NM(t){t.showModal||(t.showModal=function(){this.setAttribute("open",""),this.style.display="block",this.style.position="fixed",this.style.top="50%",this.style.left="50%",this.style.transform="translate(-50%, -50%)";const e=getComputedStyle(document.documentElement).getPropertyValue("--z-ui-overlay").trim();this.style.zIndex=e||"1000"},t.close=function(){this.removeAttribute("open"),this.style.display="none"})}async function PM(t,e=null){if(navigator.clipboard&&navigator.clipboard.writeText)try{return await navigator.clipboard.writeText(t),!0}catch(n){return console.warn("Clipboard API failed, using fallback:",n),!1}if(!e)return!1;try{return e.select(),e.setSelectionRange(0,99999),document.execCommand("copy")}catch(n){return console.error("Fallback copy failed:",n),!1}}function LM(){const t=window.matchMedia&&window.matchMedia("(display-mode: standalone)").matches||navigator.standalone===!0,e=/iphone|ipad|ipod/i.test(navigator.userAgent||"");if(!t||!e||!window.location.hostname.includes("github.io"))return;const i="https://vidu-aae11.web.app",s=i.replace(/\/$/,"");let r;try{r=new URL(s).hostname}catch(l){console.error("[PWA Redirect] Invalid VITE_APP_HOSTING_URL:",i,l);return}if(window.location.hostname===r)return;const o="/HangVidU/";let a=window.location.pathname;a.startsWith(o)?a="/"+a.slice(o.length):a==="/HangVidU"&&(a="/");let c;try{c=new URL(a+window.location.search+window.location.hash,s).toString()}catch(l){console.error("[PWA Redirect] Failed to construct target URL:",l);return}console.log("[PWA Redirect] iOS standalone PWA on gh-pages → redirecting to Firebase Hosting:",c),window.location.replace(c)}LM();g0(!0);w().disable();let Ld=[];async function OM(){eM();const t=Ey(),n=["localVideoEl","remoteVideoEl","localBoxEl","remoteBoxEl","chatControls","lobbyDiv","titleAuthBar"].filter(i=>!t[i]);if(n.length>0)return console.error("Critical elements missing:",n),!1;try{dM(),xM(),await uy;const i=_M(Ra);i&&Ld.push(i.dispose);const s=document.querySelector(".top-right-menu");if(s){const r=pM({parent:s,hideWhenAllRead:!0});rt.setToggle(r)}try{await ce.initialize()?console.log("[MAIN] FCM notifications initialized successfully"):console.warn("[MAIN] FCM notifications failed to initialize")}catch(r){console.error("[MAIN] FCM initialization error:",r)}return window.pushNotificationController=ce,window.notificationController=ce,window.getLoggedInUserId=N,!0}catch(i){return console.error("Initialization error:",i,i&&i.stack),!1}}let Dl=!1;function kw(){Dl=!1}async function Rw(){Dl||(Dl=!0,await pO(Je),dO({getLocalStream:Pa,getLocalVideo:()=>Je,getRemoteVideo:()=>de,getPeerConnection:()=>Ee.getState().pc,setLocalStream:xo,micBtn:hs,cameraBtn:fs,switchCameraBtn:ds,mutePartnerBtn:ft,fullscreenPartnerBtn:Aa,remotePipBtn:kn}),Je&&(Je.addEventListener("enterpictureinpicture",()=>be&&v(be)),Je.addEventListener("leavepictureinpicture",()=>{be&&!(ci()&&My())&&U(be)})))}function Aw(t){(t?.name==="NotAllowedError"||t?.name==="PermissionDeniedError")&&alert('Camera/microphone access is required for video calls. Please click "Allow" when prompted, or check your browser settings.'),kw()}function eo(t=null){return{localStream:Pa(),localVideoEl:Je,remoteVideoEl:de,mutePartnerBtn:ft,setupRemoteStream:gO,setupWatchSync:oL,targetRoomId:t}}function to(t,e=!1){return t.success?(e&&t.roomLink&&RM(t.roomLink,{onCopy:()=>V("Link ready! Share with your partner."),onCancel:()=>V("Link ready! Use the copy button to use it, or create a new one.")}),!0):!1}async function Ar(t,{forceInitiator:e=!1}={}){try{await Rw()}catch(r){return console.error("Failed to initialize local media stream:",r),Aw(r),!1}const n=Date.now();if(e){w().logRoomCreation(t,!0,{creationTime:n,listenerAttachTime:n,timeDiff:0},{trigger:"force_initiator",reason:"calling_saved_contact"});const r=await Ee.createCall(eo(t));return to(r,!1)}let i=await ae.checkRoomStatus(t);if(i.exists&&!i.hasMembers){let o=0;for(;o<3&&!i.hasMembers;)await new Promise(a=>setTimeout(a,250*(o+1))),i=await ae.checkRoomStatus(t),o++}if(!i.exists||!i.hasMembers){w().logRoomCreation(t,!0,{creationTime:n,listenerAttachTime:n,timeDiff:0},{trigger:"room_empty_or_nonexistent",roomExists:i.exists,memberCount:i.memberCount||0});const r=await Ee.createCall(eo(t));return to(r,!0)}w().log("ROOM","JOINING_EXISTING",{roomId:t,memberCount:i.memberCount,roomExists:i.exists});const s=await Ee.answerCall({roomId:t,...eo()});return to(s,!1)}const We=new Set,Nw=new Map;function Rc(t){t&&(Er(t),We.delete(t),Nw.delete(t),w().log("LISTENER","INCOMING_CLEANUP",{roomId:t,remainingListeners:We.size}))}function DM(){V(`[LISTENER] Removing all incoming listeners (${We.size} rooms)`);const t=Array.from(We);t.forEach(e=>{Er(e)}),We.clear(),Nw.clear(),w().log("LISTENER","ALL_INCOMING_CLEANUP",{roomsCleared:t.length})}async function MM(t){const e=Date.now(),n=e+1440*60*1e3,i=N();if(i){const s=ba(i,t);await Q(s,{roomId:t,savedAt:e,expiresAt:n});return}try{const s=localStorage.getItem("recentCalls")||"{}",r=JSON.parse(s);r[t]={roomId:t,savedAt:e,expiresAt:n},localStorage.setItem("recentCalls",JSON.stringify(r))}catch(s){console.warn("Failed to save recent call to localStorage",s)}}async function Ac(t){const e=N();if(e){try{await Ye(ba(e,t))}catch(n){console.warn("Failed to remove recent call from RTDB",n)}return}try{const n=localStorage.getItem("recentCalls")||"{}",i=JSON.parse(n);i[t]&&(delete i[t],localStorage.setItem("recentCalls",JSON.stringify(i)))}catch(n){console.warn("Failed to remove recent call from localStorage",n)}}function hi(t){t&&(We.has(t)&&(We.delete(t),Er(t)),V(`[LISTENER] Attaching listener for room: ${t} (total: ${We.size+1})`),We.add(t),w().logListenerAttachment(t,"member_join",We.size,{action:"incoming_call_listener_attached"}),ae.onMemberJoined(t,async e=>{const n=e.key,i=e.val?e.val():null,s=fe();if(n&&n!==s){w().logMemberJoinEvent(t,n,i||{},{detectedBy:"incoming_call_listener",currentUserId:s});const r=i&&typeof i.joinedAt=="number"?i.joinedAt:null,o=2e4;let a=!1,c="none",l=0;if(r&&(l=Date.now()-r,a=l<o,c="joinedAt"),!a){const $=await yy(n,t),y=await wy(t);a=$||y,c=$?"outgoingState":y?"roomCreatedAt":"failed"}const u={isFresh:a,method:c,age:l,reason:a?"call_is_fresh":"call_is_stale"};if(w().logIncomingCallEvent(n,t,u,{memberData:i,joinedAt:r,CALL_FRESH_MS:o}),!a){w().logNotificationDecision("REJECT","stale_call",t,{age:l,validationMethod:c,joiningUserId:n});return}let d;try{d=await ae.getRoomData(t)}catch{return}if(!d||typeof d!="object")return;const h=!!d.offer,f=!!d.answer,p=d.createdBy;if(!h||f||p===s)return;const g=Ee.getState();if(!!g.pc&&g.pc.connectionState==="connected"){w().logNotificationDecision("REJECT","already_in_call",t,{joiningUserId:n,currentCallState:g.pc?.connectionState});return}w().logNotificationDecision("SHOW","fresh_call_detected",t,{joiningUserId:n,freshnessResult:u});const T=await Sw(t,n);Yn.playIncoming(),kc.startCallIndicators(T);let P=!1;try{P=await Pd(`Incoming call from ${T}.

Accept?`)}finally{Yn.stop(),kc.stopCallIndicators()}if(P)Rc(t),ce.isNotificationEnabled()&&await ce.dismissCallNotifications(t),w().logNotificationDecision("ACCEPT","user_accepted",t,{joiningUserId:n}),Ar(t).catch($=>{console.warn("Failed to answer incoming call:",$),w().logFirebaseOperation("join_room_on_accept",!1,$,{roomId:t,joiningUserId:n})});else{ce.isNotificationEnabled()&&await ce.dismissCallNotifications(t),w().logNotificationDecision("REJECT","user_rejected",t,{joiningUserId:n});try{await ae.rejectCall(t,fe(),"user_rejected")}catch($){console.warn("Failed to signal rejection via RTDB:",$)}await Ac(t).catch($=>{console.warn("Failed to remove recent call on rejection:",$)})}}}),ae.onCallCancelled(t,async e=>{if(e&&typeof e.val=="function"&&e.val()){Yn.stop(),kc.stopCallIndicators(),ce.isNotificationEnabled()&&await ce.dismissCallNotifications(t).catch(()=>{});try{const{dismissActiveConfirmDialog:i}=await pe(async()=>{const{dismissActiveConfirmDialog:s}=await Promise.resolve().then(()=>iM);return{dismissActiveConfirmDialog:s}},void 0);typeof i=="function"&&i()}catch{}await Ac(t).catch(()=>{}),Rc(t)}}),ae.onMemberLeft(t,async e=>{const n=e.key,i=fe();if(!(!n||n===i))try{(await ae.checkRoomStatus(t)).hasMembers||(await Ac(t),Rc(t),V(`Removed saved recent call and listeners for room ${t} because it is now empty`))}catch(s){console.warn("Failed to evaluate room status on member leave",s)}}))}async function kp(){const t=Date.now();w().log("LISTENER","STARTUP_BEGIN",{timestamp:t,currentListenerCount:We.size});try{if(typeof window<"u"){const{getCurrentUserAsync:n}=await pe(async()=>{const{getCurrentUserAsync:i}=await Promise.resolve().then(()=>ed);return{getCurrentUserAsync:i}},void 0);await n()}}catch{}const e=N();if(w().log("LISTENER","AUTH_STATE_DETERMINED",{isLoggedIn:!!e,userId:e||"guest"}),e){const n=C_(e);try{const i=await Ie(n),s=i.exists()?i.val():null,r=new Set;if(s)for(const[o,a]of Object.entries(s)){if(!a||a.expiresAt&&a.expiresAt<Date.now()){await Ye(ba(e,o)).catch(()=>{});continue}r.add(o)}try{const o=await Jt();Object.entries(o||{}).forEach(([a,c])=>{if(c?.roomId)r.add(c.roomId);else if(a&&e)try{const l=ir(e,a);r.add(l)}catch{}})}catch{}r.forEach(o=>hi(o)),w().log("LISTENER","STARTUP_COMPLETE",{storage:"rtdb",roomsToListen:Array.from(r),totalListeners:We.size,duration:Date.now()-t})}catch(i){console.warn("Failed to read recent calls from RTDB",i),w().logFirebaseOperation("read_recent_calls",!1,i,{storage:"rtdb",userId:e})}return}try{const n=localStorage.getItem("recentCalls")||"{}",i=JSON.parse(n),s={},r=new Set;for(const[o,a]of Object.entries(i||{}))!a||a.expiresAt&&a.expiresAt<Date.now()||(s[o]=a,r.add(o));try{const o=await Jt(),a=fe();Object.entries(o||{}).forEach(([c,l])=>{if(l?.roomId)r.add(l.roomId);else if(c&&a)try{const u=ir(a,c);r.add(u)}catch{}})}catch{}r.forEach(o=>hi(o)),localStorage.setItem("recentCalls",JSON.stringify(s)),w().log("LISTENER","STARTUP_COMPLETE",{storage:"localStorage",roomsToListen:Array.from(r),totalListeners:We.size,duration:Date.now()-t,expiredRoomsRemoved:Object.keys(i||{}).length-r.size})}catch(n){console.warn("Failed to read recent calls from localStorage",n),w().logFirebaseOperation("read_recent_calls",!1,n,{storage:"localStorage"})}}function Hr(){return B&&xe&&!xe.classList.contains("hidden")&&B.src&&B.src.trim()!==""}let Rp=!1;function xM(){if(Rp)return;const t=()=>{const e=document.activeElement;return e&&(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)};document.addEventListener("keydown",e=>{t()||(e.key==="w"||e.key==="W")&&(console.log("=== W KEY PRESSED ==="),console.log("lastWatched:",bt()),console.log("isYTVisible():",fc()),console.log("isSharedVideoVisible():",Hr()),console.log("isWatchModeActive():",ci()),bt()==="yt"?fc()?(Fo(),xs()):(Oy(),$o()):(bt()==="url"||bt()==="file")&&(Hr()?(v(xe),xs()):(U(xe),$o()))),e.key==="Escape"&&ci()&&(bt()==="yt"&&fc()?(Rr(),Fo()):(bt()==="url"&&Hr()||bt()==="file"&&Hr())&&(B.pause(),v(xe)),xs())}),Rp=!0}const Pw=async()=>{try{await Rw();const t=await Ee.createCall(eo());to(t,!0)}catch(t){console.error("Failed to start call:",t),Aw(t)}};je.onclick=Pw;Pn.onclick=Pw;Li&&(navigator.clipboard&&navigator.clipboard.readText?Li.onclick=async()=>{try{const t=await navigator.clipboard.readText(),e=FM(t);if(!e){alert("No valid room link found in clipboard.");return}await Ar(e)}catch(t){t.name==="NotAllowedError"?alert("Clipboard access denied. Please allow clipboard access or paste the link manually."):(console.error("Paste & Join failed:",t),alert("Failed to read clipboard. Please try again."))}}:(Li.style.display="none",console.warn("Paste & Join button hidden: Clipboard API not available in this context (requires HTTPS).")));rr&&(rr.onclick=async()=>{await TM()});ai&&(ai.onclick=()=>{bt()==="yt"?(Rr(),Fo()):(bt()==="url"||bt()==="file")&&(B.pause(),B.src.startsWith("blob:")&&URL.revokeObjectURL(B.src),v(xe)),xs()});ht.onclick=async()=>{console.debug("Hanging up..."),await Ee.hangUp({emitCancel:!0,reason:"user_hung_up"})};function FM(t){let e=t.trim();if(!e)return"";try{const n=new URL(e,window.location.origin),i=n.searchParams.get("room");if(i)return i;const s=n.hash.match(/room=([^&]+)/);return s?decodeURIComponent(s[1]):n.pathname.replace(/^\//,"")||e}catch{return e}}async function UM(){const e=new URLSearchParams(window.location.search).get("room");if(!e)return!1;const n=await Ar(e);return n||(ka(),Hy()),n}const Ml=[];let Cs=!1;async function no(){if(Cs||Ml.length===0)return;Cs=!0;const{fromUserId:t,inviteData:e}=Ml.shift();try{const n=gM({fromUserId:t,inviteData:e,onAccept:async()=>{try{await Xy(t,e),console.log("[INVITATIONS] Contact added:",e.fromName),await kt(Ge).catch(()=>{}),bd(`✅ ${e.fromName} added to contacts!`),rt.remove(`invite-${t}`)}catch(i){console.error("[INVITATIONS] Failed to accept invite:",i),wO("Failed to add contact. Please try again.")}finally{Cs=!1,no()}},onDecline:async()=>{try{await _O(t),console.log("[INVITATIONS] Invite declined"),rt.remove(`invite-${t}`)}catch(i){console.error("[INVITATIONS] Failed to decline invite:",i)}finally{Cs=!1,no()}}});rt.add(`invite-${t}`,n),rt.isListVisible()||rt.showList()}catch(n){console.error("[INVITATIONS] Failed to process invite:",n),Cs=!1,no()}}function Ap(){mO((t,e)=>{Ml.push({fromUserId:t,inviteData:e}),no()}),yO(async(t,e)=>{console.log("[INVITATIONS] Your invite was accepted by:",e.acceptedByName),await kt(Ge).catch(()=>{}),bd(`✅ ${e.acceptedByName} is now in your contacts!`)})}window.onload=async()=>{if(await CO(),!await OM()){je&&(je.disabled=!0,je.title="Initialization failed. Please reload the page or check your camera/microphone permissions."),console.error("Initialization failed. Call functionality disabled. Please reload the page."),alert(`Hangvidu could not initialize properly.

Please check your camera/microphone permissions and reload the page.`);return}tM(Ee),await kp().catch(s=>console.warn("Failed to start saved-room listeners",s)),kt(Ge).catch(s=>{console.warn("Failed to render contacts list:",s)});let e=null;const n=Zu(async({isLoggedIn:s,user:r})=>{try{const o=e===null,a=e===!0&&!s,c=e===!1&&s;if(e=s,await kt(Ge),a)V("[AUTH] User logged out - cleaning up messaging and listeners"),Ne.reset(),yn.closeAllSessions(),ce.isNotificationEnabled()&&await ce.disable().catch(l=>{console.warn("[AUTH] Failed to disable notifications on logout:",l)}),DM(),Rl();else if(c)if(V("[AUTH] User logged in - re-attaching incoming listeners"),await cp().catch(l=>console.warn("[REFERRAL] Failed to process referral on login:",l)),await kt(Ge).catch(()=>{}),await kp().catch(l=>console.warn("Failed to re-attach saved-room listeners on login",l)),Ap(),!N())console.log("[AUTH] Skipping notification setup: no user logged in");else{const u=ce.getPermissionState();if(u==="granted"){console.log("[AUTH] Enabling notifications for logged-in user");try{await ce.enable(),console.log("[AUTH] Notifications enabled successfully")}catch(d){console.error("[AUTH] Failed to enable notifications on login:",d)}}else u==="default"?(console.log("[AUTH] Requesting notification permission"),await ce.requestPermission()):console.log("[AUTH] Notification permission denied or unsupported")}else if(o&&s){V("[AUTH] Initial load with logged-in user"),await cp().catch(l=>console.warn("[REFERRAL] Failed to process referral on initial load:",l)),Ap();{const l=ce.getPermissionState();l==="granted"?await ce.enable().catch(u=>console.warn("[AUTH] Failed to enable notifications:",u)):l==="default"&&(console.log("[AUTH] Requesting notification permission"),await ce.requestPermission())}}}catch(o){console.warn("Failed to handle auth change:",o)}});Ld.push(()=>{try{typeof n=="function"&&n()}catch{}}),await UM()};window.addEventListener("beforeunload",async t=>{const e=Ee.getState();if(e.pc&&e.pc.connectionState==="connected")return t.preventDefault(),t.returnValue="You are in an active call. Are you sure you want to leave?",t.returnValue;await $M()});Ee.on("memberJoined",({memberId:t,roomId:e})=>{console.debug("CallController memberJoined event",{memberId:t,roomId:e}),Ee.setPartnerId(t),Ne.showMessagesToggle(),Ma(t,t),id().catch(n=>console.warn("Failed to clear calling state:",n)),MM(e).catch(n=>console.warn("Failed to save recent call:",n))});Ee.on("memberLeft",({memberId:t})=>{console.info("Partner has left the call")});Ee.on("cleanup",async({roomId:t,partnerId:e,reason:n,role:i,wasConnected:s})=>{if(i==="initiator"&&!e&&!s&&t){console.log("[MAIN] Potential missed call detected for room:",t);try{const{getContactByRoomId:a,callContact:c}=await pe(async()=>{const{getContactByRoomId:u,callContact:d}=await Promise.resolve().then(()=>Nl);return{getContactByRoomId:u,callContact:d}},void 0),l=await a(t);if(l&&l.contactId){const{getCurrentUser:u}=await pe(async()=>{const{getCurrentUser:m}=await Promise.resolve().then(()=>ed);return{getCurrentUser:m}},void 0),h=u()?.displayName||"Friend";console.log(`[MAIN] Sending missed call push notification to ${l.contactName} (${l.contactId})`),await ce.sendMissedCallNotification(l.contactId,{roomId:t,callerId:fe(),callerName:h});const{createMissedCallNotification:f}=await pe(async()=>{const{createMissedCallNotification:m}=await import("./missed-call-notification-DVOVWIXp.js");return{createMissedCallNotification:m}},[]),p=`missed-call-${l.contactId}-${Date.now()}`,g=f({callerId:l.contactId,callerName:l.contactName,roomId:t,onCallBack:async()=>{await c(l.contactId,l.contactName),rt.remove(p)},onDismiss:()=>{rt.remove(p)}});rt.add(p,g),console.log("[MAIN] In-app missed call notification added")}else console.log("[MAIN] No saved contact found for room, skipping missed call notification")}catch(a){console.warn("[MAIN] Failed to handle missed call:",a)}}t&&ce.isNotificationEnabled()&&ce.dismissCallNotifications(t).catch(a=>{console.warn("[MAIN] Failed to dismiss call notifications:",a)});const o=Ee.getState();o.messagesUI&&typeof o.messagesUI.cleanup=="function"&&(o.messagesUI.cleanup(),o.messagesUI=null),Ay(),ka(),t&&hi(t),e&&t&&setTimeout(()=>{Iw(e,t,Ge).catch(a=>{console.warn("Failed to save contact after cleanup:",a)})},500)});async function $M(){await Ee.hangUp({emitCancel:!0,reason:"page_unload"}),hO(),v_(),document.pictureInPictureElement&&document.exitPictureInPicture().catch(e=>console.error(e));const t=Ee.getState();t.messagesUI&&t.messagesUI.cleanup&&t.messagesUI.cleanup(),window.history.replaceState({},document.title,window.location.pathname),B.src="",Py(),Je&&Je.srcObject&&(Je.srcObject=null),de&&de.srcObject&&(de.srcObject=null),xs(),rL("none"),fd(),hM(),ka(),Ly(!1),Ld.forEach(e=>e())}const BM=Object.freeze(Object.defineProperty({__proto__:null,joinOrCreateRoomWithId:Ar,listenForIncomingOnRoom:hi,resetLocalStreamInitFlag:kw},Symbol.toStringTag,{value:"Module"}));export{La as a,Qy as c,V as d,v as h,p0 as i,U as s};
