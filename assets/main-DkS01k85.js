(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(r){if(r.ep)return;r.ep=!0;const i=n(r);fetch(r.href,i)}})();const R_="modulepreload",A_=function(t){return"/HangVidU/"+t},yu={},lt=function(e,n,s){let r=Promise.resolve();if(n&&n.length>0){let c=function(l){return Promise.all(l.map(u=>Promise.resolve(u).then(d=>({status:"fulfilled",value:d}),d=>({status:"rejected",reason:d}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),a=o?.nonce||o?.getAttribute("nonce");r=c(n.map(l=>{if(l=A_(l),l in yu)return;yu[l]=!0;const u=l.endsWith(".css"),d=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const h=document.createElement("link");if(h.rel=u?"stylesheet":R_,u||(h.as="script"),h.crossOrigin="",h.href=l,a&&h.setAttribute("nonce",a),document.head.appendChild(h),u)return new Promise((f,p)=>{h.addEventListener("load",f),h.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return r.then(o=>{for(const a of o||[])a.status==="rejected"&&i(a.reason);return e().catch(i)})},I=typeof __SENTRY_DEBUG__>"u"||__SENTRY_DEBUG__,V=globalThis,wn="10.26.0";function io(){return oo(V),V}function oo(t){const e=t.__SENTRY__=t.__SENTRY__||{};return e.version=e.version||wn,e[wn]=e[wn]||{}}function Cs(t,e,n=V){const s=n.__SENTRY__=n.__SENTRY__||{},r=s[wn]=s[wn]||{};return r[t]||(r[t]=e())}const N_=["debug","info","warn","error","log","assert","trace"],P_="Sentry Logger ",bi={};function Ss(t){if(!("console"in V))return t();const e=V.console,n={},s=Object.keys(bi);s.forEach(r=>{const i=bi[r];n[r]=e[r],e[r]=i});try{return t()}finally{s.forEach(r=>{e[r]=n[r]})}}function L_(){Nc().enabled=!0}function O_(){Nc().enabled=!1}function Xh(){return Nc().enabled}function D_(...t){Ac("log",...t)}function x_(...t){Ac("warn",...t)}function M_(...t){Ac("error",...t)}function Ac(t,...e){I&&Xh()&&Ss(()=>{V.console[t](`${P_}[${t}]:`,...e)})}function Nc(){return I?Cs("loggerSettings",()=>({enabled:!1})):{enabled:!1}}const b={enable:L_,disable:O_,isEnabled:Xh,log:D_,warn:x_,error:M_},Qh=50,Tn="?",vu=/\(error: (.*)\)/,wu=/captureMessage|captureException/;function Zh(...t){const e=t.sort((n,s)=>n[0]-s[0]).map(n=>n[1]);return(n,s=0,r=0)=>{const i=[],o=n.split(`
`);for(let a=s;a<o.length;a++){let c=o[a];c.length>1024&&(c=c.slice(0,1024));const l=vu.test(c)?c.replace(vu,"$1"):c;if(!l.match(/\S*Error: /)){for(const u of e){const d=u(l);if(d){i.push(d);break}}if(i.length>=Qh+r)break}}return U_(i.slice(r))}}function F_(t){return Array.isArray(t)?Zh(...t):t}function U_(t){if(!t.length)return[];const e=Array.from(t);return/sentryWrapped/.test(Kr(e).function||"")&&e.pop(),e.reverse(),wu.test(Kr(e).function||"")&&(e.pop(),wu.test(Kr(e).function||"")&&e.pop()),e.slice(0,Qh).map(n=>({...n,filename:n.filename||Kr(e).filename,function:n.function||Tn}))}function Kr(t){return t[t.length-1]||{}}const zo="<anonymous>";function Xt(t){try{return!t||typeof t!="function"?zo:t.name||zo}catch{return zo}}function Eu(t){const e=t.exception;if(e){const n=[];try{return e.values.forEach(s=>{s.stacktrace.frames&&n.push(...s.stacktrace.frames)}),n}catch{return}}}function ef(t){return"__v_isVNode"in t&&t.__v_isVNode?"[VueVNode]":"[VueViewModel]"}const li={},bu={};function $n(t,e){li[t]=li[t]||[],li[t].push(e)}function Bn(t,e){if(!bu[t]){bu[t]=!0;try{e()}catch(n){I&&b.error(`Error while instrumenting ${t}`,n)}}}function Qe(t,e){const n=t&&li[t];if(n)for(const s of n)try{s(e)}catch(r){I&&b.error(`Error while triggering instrumentation handler.
Type: ${t}
Name: ${Xt(s)}
Error:`,r)}}let Go=null;function $_(t){const e="error";$n(e,t),Bn(e,B_)}function B_(){Go=V.onerror,V.onerror=function(t,e,n,s,r){return Qe("error",{column:s,error:r,line:n,msg:t,url:e}),Go?Go.apply(this,arguments):!1},V.onerror.__SENTRY_INSTRUMENTED__=!0}let Yo=null;function H_(t){const e="unhandledrejection";$n(e,t),Bn(e,W_)}function W_(){Yo=V.onunhandledrejection,V.onunhandledrejection=function(t){return Qe("unhandledrejection",t),Yo?Yo.apply(this,arguments):!0},V.onunhandledrejection.__SENTRY_INSTRUMENTED__=!0}const tf=Object.prototype.toString;function Pc(t){switch(tf.call(t)){case"[object Error]":case"[object Exception]":case"[object DOMException]":case"[object WebAssembly.Exception]":return!0;default:return Qt(t,Error)}}function Ts(t,e){return tf.call(t)===`[object ${e}]`}function nf(t){return Ts(t,"ErrorEvent")}function Cu(t){return Ts(t,"DOMError")}function V_(t){return Ts(t,"DOMException")}function bt(t){return Ts(t,"String")}function Lc(t){return typeof t=="object"&&t!==null&&"__sentry_template_string__"in t&&"__sentry_template_values__"in t}function ao(t){return t===null||Lc(t)||typeof t!="object"&&typeof t!="function"}function ur(t){return Ts(t,"Object")}function co(t){return typeof Event<"u"&&Qt(t,Event)}function j_(t){return typeof Element<"u"&&Qt(t,Element)}function q_(t){return Ts(t,"RegExp")}function Nr(t){return!!(t?.then&&typeof t.then=="function")}function z_(t){return ur(t)&&"nativeEvent"in t&&"preventDefault"in t&&"stopPropagation"in t}function Qt(t,e){try{return t instanceof e}catch{return!1}}function sf(t){return!!(typeof t=="object"&&t!==null&&(t.__isVue||t._isVue||t.__v_isVNode))}function G_(t){return typeof Request<"u"&&Qt(t,Request)}const Oc=V,Y_=80;function rf(t,e={}){if(!t)return"<unknown>";try{let n=t;const s=5,r=[];let i=0,o=0;const a=" > ",c=a.length;let l;const u=Array.isArray(e)?e:e.keyAttrs,d=!Array.isArray(e)&&e.maxStringLength||Y_;for(;n&&i++<s&&(l=K_(n,u),!(l==="html"||i>1&&o+r.length*c+l.length>=d));)r.push(l),o+=l.length,n=n.parentNode;return r.reverse().join(a)}catch{return"<unknown>"}}function K_(t,e){const n=t,s=[];if(!n?.tagName)return"";if(Oc.HTMLElement&&n instanceof HTMLElement&&n.dataset){if(n.dataset.sentryComponent)return n.dataset.sentryComponent;if(n.dataset.sentryElement)return n.dataset.sentryElement}s.push(n.tagName.toLowerCase());const r=e?.length?e.filter(o=>n.getAttribute(o)).map(o=>[o,n.getAttribute(o)]):null;if(r?.length)r.forEach(o=>{s.push(`[${o[0]}="${o[1]}"]`)});else{n.id&&s.push(`#${n.id}`);const o=n.className;if(o&&bt(o)){const a=o.split(/\s+/);for(const c of a)s.push(`.${c}`)}}const i=["aria-label","type","name","title","alt"];for(const o of i){const a=n.getAttribute(o);a&&s.push(`[${o}="${a}"]`)}return s.join("")}function Dc(){try{return Oc.document.location.href}catch{return""}}function J_(t){if(!Oc.HTMLElement)return null;let e=t;const n=5;for(let s=0;s<n;s++){if(!e)return null;if(e instanceof HTMLElement){if(e.dataset.sentryComponent)return e.dataset.sentryComponent;if(e.dataset.sentryElement)return e.dataset.sentryElement}e=e.parentNode}return null}function De(t,e,n){if(!(e in t))return;const s=t[e];if(typeof s!="function")return;const r=n(s);typeof r=="function"&&of(r,s);try{t[e]=r}catch{I&&b.log(`Failed to replace method "${e}" in object`,t)}}function In(t,e,n){try{Object.defineProperty(t,e,{value:n,writable:!0,configurable:!0})}catch{I&&b.log(`Failed to add non-enumerable property "${e}" to object`,t)}}function of(t,e){try{const n=e.prototype||{};t.prototype=e.prototype=n,In(t,"__sentry_original__",e)}catch{}}function xc(t){return t.__sentry_original__}function af(t){if(Pc(t))return{message:t.message,name:t.name,stack:t.stack,...Tu(t)};if(co(t)){const e={type:t.type,target:Su(t.target),currentTarget:Su(t.currentTarget),...Tu(t)};return typeof CustomEvent<"u"&&Qt(t,CustomEvent)&&(e.detail=t.detail),e}else return t}function Su(t){try{return j_(t)?rf(t):Object.prototype.toString.call(t)}catch{return"<unknown>"}}function Tu(t){if(typeof t=="object"&&t!==null){const e={};for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e}else return{}}function X_(t){const e=Object.keys(af(t));return e.sort(),e[0]?e.join(", "):"[object has no keys]"}function cf(t,e=0){return typeof t!="string"||e===0||t.length<=e?t:`${t.slice(0,e)}...`}function Iu(t,e){if(!Array.isArray(t))return"";const n=[];for(let s=0;s<t.length;s++){const r=t[s];try{sf(r)?n.push(ef(r)):n.push(String(r))}catch{n.push("[value cannot be serialized]")}}return n.join(e)}function ui(t,e,n=!1){return bt(t)?q_(e)?e.test(t):bt(e)?n?t===e:t.includes(e):!1:!1}function lo(t,e=[],n=!1){return e.some(s=>ui(t,s,n))}function Q_(){const t=V;return t.crypto||t.msCrypto}let Ko;function Z_(){return Math.random()*16}function $e(t=Q_()){try{if(t?.randomUUID)return t.randomUUID().replace(/-/g,"")}catch{}return Ko||(Ko="10000000100040008000"+1e11),Ko.replace(/[018]/g,e=>(e^(Z_()&15)>>e/4).toString(16))}function lf(t){return t.exception?.values?.[0]}function mn(t){const{message:e,event_id:n}=t;if(e)return e;const s=lf(t);return s?s.type&&s.value?`${s.type}: ${s.value}`:s.type||s.value||n||"<unknown>":n||"<unknown>"}function Ra(t,e,n){const s=t.exception=t.exception||{},r=s.values=s.values||[],i=r[0]=r[0]||{};i.value||(i.value=e||""),i.type||(i.type="Error")}function ls(t,e){const n=lf(t);if(!n)return;const s={type:"generic",handled:!0},r=n.mechanism;if(n.mechanism={...s,...r,...e},e&&"data"in e){const i={...r?.data,...e.data};n.mechanism.data=i}}function ku(t){if(ey(t))return!0;try{In(t,"__sentry_captured__",!0)}catch{}return!1}function ey(t){try{return t.__sentry_captured__}catch{}}const uf=1e3;function Pr(){return Date.now()/uf}function ty(){const{performance:t}=V;if(!t?.now||!t.timeOrigin)return Pr;const e=t.timeOrigin;return()=>(e+t.now())/uf}let Ru;function Ct(){return(Ru??(Ru=ty()))()}function ny(t){const e=Ct(),n={sid:$e(),init:!0,timestamp:e,started:e,duration:0,status:"ok",errors:0,ignoreDuration:!1,toJSON:()=>ry(n)};return t&&us(n,t),n}function us(t,e={}){if(e.user&&(!t.ipAddress&&e.user.ip_address&&(t.ipAddress=e.user.ip_address),!t.did&&!e.did&&(t.did=e.user.id||e.user.email||e.user.username)),t.timestamp=e.timestamp||Ct(),e.abnormal_mechanism&&(t.abnormal_mechanism=e.abnormal_mechanism),e.ignoreDuration&&(t.ignoreDuration=e.ignoreDuration),e.sid&&(t.sid=e.sid.length===32?e.sid:$e()),e.init!==void 0&&(t.init=e.init),!t.did&&e.did&&(t.did=`${e.did}`),typeof e.started=="number"&&(t.started=e.started),t.ignoreDuration)t.duration=void 0;else if(typeof e.duration=="number")t.duration=e.duration;else{const n=t.timestamp-t.started;t.duration=n>=0?n:0}e.release&&(t.release=e.release),e.environment&&(t.environment=e.environment),!t.ipAddress&&e.ipAddress&&(t.ipAddress=e.ipAddress),!t.userAgent&&e.userAgent&&(t.userAgent=e.userAgent),typeof e.errors=="number"&&(t.errors=e.errors),e.status&&(t.status=e.status)}function sy(t,e){let n={};t.status==="ok"&&(n={status:"exited"}),us(t,n)}function ry(t){return{sid:`${t.sid}`,init:t.init,started:new Date(t.started*1e3).toISOString(),timestamp:new Date(t.timestamp*1e3).toISOString(),status:t.status,errors:t.errors,did:typeof t.did=="number"||typeof t.did=="string"?`${t.did}`:void 0,duration:t.duration,abnormal_mechanism:t.abnormal_mechanism,attrs:{release:t.release,environment:t.environment,ip_address:t.ipAddress,user_agent:t.userAgent}}}function Lr(t,e,n=2){if(!e||typeof e!="object"||n<=0)return e;if(t&&Object.keys(e).length===0)return t;const s={...t};for(const r in e)Object.prototype.hasOwnProperty.call(e,r)&&(s[r]=Lr(s[r],e[r],n-1));return s}function Au(){return $e()}function df(){return $e().substring(16)}const Aa="_sentrySpan";function Nu(t,e){e?In(t,Aa,e):delete t[Aa]}function Pu(t){return t[Aa]}const iy=100;class kt{constructor(){this._notifyingListeners=!1,this._scopeListeners=[],this._eventProcessors=[],this._breadcrumbs=[],this._attachments=[],this._user={},this._tags={},this._extra={},this._contexts={},this._sdkProcessingMetadata={},this._propagationContext={traceId:Au(),sampleRand:Math.random()}}clone(){const e=new kt;return e._breadcrumbs=[...this._breadcrumbs],e._tags={...this._tags},e._extra={...this._extra},e._contexts={...this._contexts},this._contexts.flags&&(e._contexts.flags={values:[...this._contexts.flags.values]}),e._user=this._user,e._level=this._level,e._session=this._session,e._transactionName=this._transactionName,e._fingerprint=this._fingerprint,e._eventProcessors=[...this._eventProcessors],e._attachments=[...this._attachments],e._sdkProcessingMetadata={...this._sdkProcessingMetadata},e._propagationContext={...this._propagationContext},e._client=this._client,e._lastEventId=this._lastEventId,Nu(e,Pu(this)),e}setClient(e){this._client=e}setLastEventId(e){this._lastEventId=e}getClient(){return this._client}lastEventId(){return this._lastEventId}addScopeListener(e){this._scopeListeners.push(e)}addEventProcessor(e){return this._eventProcessors.push(e),this}setUser(e){return this._user=e||{email:void 0,id:void 0,ip_address:void 0,username:void 0},this._session&&us(this._session,{user:e}),this._notifyScopeListeners(),this}getUser(){return this._user}setTags(e){return this._tags={...this._tags,...e},this._notifyScopeListeners(),this}setTag(e,n){return this.setTags({[e]:n})}setExtras(e){return this._extra={...this._extra,...e},this._notifyScopeListeners(),this}setExtra(e,n){return this._extra={...this._extra,[e]:n},this._notifyScopeListeners(),this}setFingerprint(e){return this._fingerprint=e,this._notifyScopeListeners(),this}setLevel(e){return this._level=e,this._notifyScopeListeners(),this}setTransactionName(e){return this._transactionName=e,this._notifyScopeListeners(),this}setContext(e,n){return n===null?delete this._contexts[e]:this._contexts[e]=n,this._notifyScopeListeners(),this}setSession(e){return e?this._session=e:delete this._session,this._notifyScopeListeners(),this}getSession(){return this._session}update(e){if(!e)return this;const n=typeof e=="function"?e(this):e,s=n instanceof kt?n.getScopeData():ur(n)?e:void 0,{tags:r,extra:i,user:o,contexts:a,level:c,fingerprint:l=[],propagationContext:u}=s||{};return this._tags={...this._tags,...r},this._extra={...this._extra,...i},this._contexts={...this._contexts,...a},o&&Object.keys(o).length&&(this._user=o),c&&(this._level=c),l.length&&(this._fingerprint=l),u&&(this._propagationContext=u),this}clear(){return this._breadcrumbs=[],this._tags={},this._extra={},this._user={},this._contexts={},this._level=void 0,this._transactionName=void 0,this._fingerprint=void 0,this._session=void 0,Nu(this,void 0),this._attachments=[],this.setPropagationContext({traceId:Au(),sampleRand:Math.random()}),this._notifyScopeListeners(),this}addBreadcrumb(e,n){const s=typeof n=="number"?n:iy;if(s<=0)return this;const r={timestamp:Pr(),...e,message:e.message?cf(e.message,2048):e.message};return this._breadcrumbs.push(r),this._breadcrumbs.length>s&&(this._breadcrumbs=this._breadcrumbs.slice(-s),this._client?.recordDroppedEvent("buffer_overflow","log_item")),this._notifyScopeListeners(),this}getLastBreadcrumb(){return this._breadcrumbs[this._breadcrumbs.length-1]}clearBreadcrumbs(){return this._breadcrumbs=[],this._notifyScopeListeners(),this}addAttachment(e){return this._attachments.push(e),this}clearAttachments(){return this._attachments=[],this}getScopeData(){return{breadcrumbs:this._breadcrumbs,attachments:this._attachments,contexts:this._contexts,tags:this._tags,extra:this._extra,user:this._user,level:this._level,fingerprint:this._fingerprint||[],eventProcessors:this._eventProcessors,propagationContext:this._propagationContext,sdkProcessingMetadata:this._sdkProcessingMetadata,transactionName:this._transactionName,span:Pu(this)}}setSDKProcessingMetadata(e){return this._sdkProcessingMetadata=Lr(this._sdkProcessingMetadata,e,2),this}setPropagationContext(e){return this._propagationContext=e,this}getPropagationContext(){return this._propagationContext}captureException(e,n){const s=n?.event_id||$e();if(!this._client)return I&&b.warn("No client configured on scope - will not capture exception!"),s;const r=new Error("Sentry syntheticException");return this._client.captureException(e,{originalException:e,syntheticException:r,...n,event_id:s},this),s}captureMessage(e,n,s){const r=s?.event_id||$e();if(!this._client)return I&&b.warn("No client configured on scope - will not capture message!"),r;const i=s?.syntheticException??new Error(e);return this._client.captureMessage(e,n,{originalException:e,syntheticException:i,...s,event_id:r},this),r}captureEvent(e,n){const s=n?.event_id||$e();return this._client?(this._client.captureEvent(e,{...n,event_id:s},this),s):(I&&b.warn("No client configured on scope - will not capture event!"),s)}_notifyScopeListeners(){this._notifyingListeners||(this._notifyingListeners=!0,this._scopeListeners.forEach(e=>{e(this)}),this._notifyingListeners=!1)}}function oy(){return Cs("defaultCurrentScope",()=>new kt)}function ay(){return Cs("defaultIsolationScope",()=>new kt)}class cy{constructor(e,n){let s;e?s=e:s=new kt;let r;n?r=n:r=new kt,this._stack=[{scope:s}],this._isolationScope=r}withScope(e){const n=this._pushScope();let s;try{s=e(n)}catch(r){throw this._popScope(),r}return Nr(s)?s.then(r=>(this._popScope(),r),r=>{throw this._popScope(),r}):(this._popScope(),s)}getClient(){return this.getStackTop().client}getScope(){return this.getStackTop().scope}getIsolationScope(){return this._isolationScope}getStackTop(){return this._stack[this._stack.length-1]}_pushScope(){const e=this.getScope().clone();return this._stack.push({client:this.getClient(),scope:e}),e}_popScope(){return this._stack.length<=1?!1:!!this._stack.pop()}}function ds(){const t=io(),e=oo(t);return e.stack=e.stack||new cy(oy(),ay())}function ly(t){return ds().withScope(t)}function uy(t,e){const n=ds();return n.withScope(()=>(n.getStackTop().scope=t,e(t)))}function Lu(t){return ds().withScope(()=>t(ds().getIsolationScope()))}function dy(){return{withIsolationScope:Lu,withScope:ly,withSetScope:uy,withSetIsolationScope:(t,e)=>Lu(e),getCurrentScope:()=>ds().getScope(),getIsolationScope:()=>ds().getIsolationScope()}}function Mc(t){const e=oo(t);return e.acs?e.acs:dy()}function on(){const t=io();return Mc(t).getCurrentScope()}function Or(){const t=io();return Mc(t).getIsolationScope()}function hy(){return Cs("globalScope",()=>new kt)}function fy(...t){const e=io(),n=Mc(e);if(t.length===2){const[s,r]=t;return s?n.withSetScope(s,r):n.withScope(r)}return n.withScope(t[0])}function Ae(){return on().getClient()}function py(t){const e=t.getPropagationContext(),{traceId:n,parentSpanId:s,propagationSpanId:r}=e,i={trace_id:n,span_id:r||df()};return s&&(i.parent_span_id=s),i}const gy="sentry.source",my="sentry.sample_rate",_y="sentry.previous_trace_sample_rate",yy="sentry.op",vy="sentry.origin",hf="sentry.profile_id",ff="sentry.exclusive_time",wy=0,Ey=1,by="_sentryScope",Cy="_sentryIsolationScope";function Sy(t){if(t){if(typeof t=="object"&&"deref"in t&&typeof t.deref=="function")try{return t.deref()}catch{return}return t}}function pf(t){const e=t;return{scope:e[by],isolationScope:Sy(e[Cy])}}const Ty="sentry-",Iy=/^sentry-/;function ky(t){const e=Ry(t);if(!e)return;const n=Object.entries(e).reduce((s,[r,i])=>{if(r.match(Iy)){const o=r.slice(Ty.length);s[o]=i}return s},{});if(Object.keys(n).length>0)return n}function Ry(t){if(!(!t||!bt(t)&&!Array.isArray(t)))return Array.isArray(t)?t.reduce((e,n)=>{const s=Ou(n);return Object.entries(s).forEach(([r,i])=>{e[r]=i}),e},{}):Ou(t)}function Ou(t){return t.split(",").map(e=>{const n=e.indexOf("=");if(n===-1)return[];const s=e.slice(0,n),r=e.slice(n+1);return[s,r].map(i=>{try{return decodeURIComponent(i.trim())}catch{return}})}).reduce((e,[n,s])=>(n&&s&&(e[n]=s),e),{})}const Ay=/^o(\d+)\./,Ny=/^(?:(\w+):)\/\/(?:(\w+)(?::(\w+)?)?@)([\w.-]+)(?::(\d+))?\/(.+)/;function Py(t){return t==="http"||t==="https"}function Dr(t,e=!1){const{host:n,path:s,pass:r,port:i,projectId:o,protocol:a,publicKey:c}=t;return`${a}://${c}${e&&r?`:${r}`:""}@${n}${i?`:${i}`:""}/${s&&`${s}/`}${o}`}function Ly(t){const e=Ny.exec(t);if(!e){Ss(()=>{console.error(`Invalid Sentry Dsn: ${t}`)});return}const[n,s,r="",i="",o="",a=""]=e.slice(1);let c="",l=a;const u=l.split("/");if(u.length>1&&(c=u.slice(0,-1).join("/"),l=u.pop()),l){const d=l.match(/^\d+/);d&&(l=d[0])}return gf({host:i,pass:r,path:c,projectId:l,port:o,protocol:n,publicKey:s})}function gf(t){return{protocol:t.protocol,publicKey:t.publicKey||"",pass:t.pass||"",host:t.host,port:t.port||"",path:t.path||"",projectId:t.projectId}}function Oy(t){if(!I)return!0;const{port:e,projectId:n,protocol:s}=t;return["protocol","publicKey","host","projectId"].find(o=>t[o]?!1:(b.error(`Invalid Sentry Dsn: ${o} missing`),!0))?!1:n.match(/^\d+$/)?Py(s)?e&&isNaN(parseInt(e,10))?(b.error(`Invalid Sentry Dsn: Invalid port ${e}`),!1):!0:(b.error(`Invalid Sentry Dsn: Invalid protocol ${s}`),!1):(b.error(`Invalid Sentry Dsn: Invalid projectId ${n}`),!1)}function Dy(t){return t.match(Ay)?.[1]}function xy(t){const e=t.getOptions(),{host:n}=t.getDsn()||{};let s;return e.orgId?s=String(e.orgId):n&&(s=Dy(n)),s}function My(t){const e=typeof t=="string"?Ly(t):gf(t);if(!(!e||!Oy(e)))return e}function Fy(t){if(typeof t=="boolean")return Number(t);const e=typeof t=="string"?parseFloat(t):t;if(!(typeof e!="number"||isNaN(e)||e<0||e>1))return e}const mf=1;let Du=!1;function Uy(t){const{spanId:e,traceId:n,isRemote:s}=t.spanContext(),r=s?e:Fc(t).parent_span_id,i=pf(t).scope,o=s?i?.getPropagationContext().propagationSpanId||df():e;return{parent_span_id:r,span_id:o,trace_id:n}}function $y(t){if(t&&t.length>0)return t.map(({context:{spanId:e,traceId:n,traceFlags:s,...r},attributes:i})=>({span_id:e,trace_id:n,sampled:s===mf,attributes:i,...r}))}function xu(t){return typeof t=="number"?Mu(t):Array.isArray(t)?t[0]+t[1]/1e9:t instanceof Date?Mu(t.getTime()):Ct()}function Mu(t){return t>9999999999?t/1e3:t}function Fc(t){if(Hy(t))return t.getSpanJSON();const{spanId:e,traceId:n}=t.spanContext();if(By(t)){const{attributes:s,startTime:r,name:i,endTime:o,status:a,links:c}=t,l="parentSpanId"in t?t.parentSpanId:"parentSpanContext"in t?t.parentSpanContext?.spanId:void 0;return{span_id:e,trace_id:n,data:s,description:i,parent_span_id:l,start_timestamp:xu(r),timestamp:xu(o)||void 0,status:Vy(a),op:s[yy],origin:s[vy],links:$y(c)}}return{span_id:e,trace_id:n,start_timestamp:0,data:{}}}function By(t){const e=t;return!!e.attributes&&!!e.startTime&&!!e.name&&!!e.endTime&&!!e.status}function Hy(t){return typeof t.getSpanJSON=="function"}function Wy(t){const{traceFlags:e}=t.spanContext();return e===mf}function Vy(t){if(!(!t||t.code===wy))return t.code===Ey?"ok":t.message||"internal_error"}const jy="_sentryRootSpan";function _f(t){return t[jy]||t}function Fu(){Du||(Ss(()=>{console.warn("[Sentry] Returning null from `beforeSendSpan` is disallowed. To drop certain spans, configure the respective integrations directly or use `ignoreSpans`.")}),Du=!0)}function qy(t){if(typeof __SENTRY_TRACING__=="boolean"&&!__SENTRY_TRACING__)return!1;const e=Ae()?.getOptions();return!!e&&(e.tracesSampleRate!=null||!!e.tracesSampler)}function Uu(t){b.log(`Ignoring span ${t.op} - ${t.description} because it matches \`ignoreSpans\`.`)}function $u(t,e){if(!e?.length||!t.description)return!1;for(const n of e){if(Gy(n)){if(ui(t.description,n))return I&&Uu(t),!0;continue}if(!n.name&&!n.op)continue;const s=n.name?ui(t.description,n.name):!0,r=n.op?t.op&&ui(t.op,n.op):!0;if(s&&r)return I&&Uu(t),!0}return!1}function zy(t,e){const n=e.parent_span_id,s=e.span_id;if(n)for(const r of t)r.parent_span_id===s&&(r.parent_span_id=n)}function Gy(t){return typeof t=="string"||t instanceof RegExp}const Uc="production",Yy="_frozenDsc";function yf(t,e){const n=e.getOptions(),{publicKey:s}=e.getDsn()||{},r={environment:n.environment||Uc,release:n.release,public_key:s,trace_id:t,org_id:xy(e)};return e.emit("createDsc",r),r}function Ky(t,e){const n=e.getPropagationContext();return n.dsc||yf(n.traceId,t)}function Jy(t){const e=Ae();if(!e)return{};const n=_f(t),s=Fc(n),r=s.data,i=n.spanContext().traceState,o=i?.get("sentry.sample_rate")??r[my]??r[_y];function a(p){return(typeof o=="number"||typeof o=="string")&&(p.sample_rate=`${o}`),p}const c=n[Yy];if(c)return a(c);const l=i?.get("sentry.dsc"),u=l&&ky(l);if(u)return a(u);const d=yf(t.spanContext().traceId,e),h=r[gy],f=s.description;return h!=="url"&&f&&(d.transaction=f),qy()&&(d.sampled=String(Wy(n)),d.sample_rand=i?.get("sentry.sample_rand")??pf(n).scope?.getPropagationContext().sampleRand.toString()),a(d),e.emit("createDsc",d,n),d}function gt(t,e=100,n=1/0){try{return Na("",t,e,n)}catch(s){return{ERROR:`**non-serializable** (${s})`}}}function vf(t,e=3,n=100*1024){const s=gt(t,e);return ev(s)>n?vf(t,e-1,n):s}function Na(t,e,n=1/0,s=1/0,r=tv()){const[i,o]=r;if(e==null||["boolean","string"].includes(typeof e)||typeof e=="number"&&Number.isFinite(e))return e;const a=Xy(t,e);if(!a.startsWith("[object "))return a;if(e.__sentry_skip_normalization__)return e;const c=typeof e.__sentry_override_normalization_depth__=="number"?e.__sentry_override_normalization_depth__:n;if(c===0)return a.replace("object ","");if(i(e))return"[Circular ~]";const l=e;if(l&&typeof l.toJSON=="function")try{const f=l.toJSON();return Na("",f,c-1,s,r)}catch{}const u=Array.isArray(e)?[]:{};let d=0;const h=af(e);for(const f in h){if(!Object.prototype.hasOwnProperty.call(h,f))continue;if(d>=s){u[f]="[MaxProperties ~]";break}const p=h[f];u[f]=Na(f,p,c-1,s,r),d++}return o(e),u}function Xy(t,e){try{if(t==="domain"&&e&&typeof e=="object"&&e._events)return"[Domain]";if(t==="domainEmitter")return"[DomainEmitter]";if(typeof global<"u"&&e===global)return"[Global]";if(typeof window<"u"&&e===window)return"[Window]";if(typeof document<"u"&&e===document)return"[Document]";if(sf(e))return ef(e);if(z_(e))return"[SyntheticEvent]";if(typeof e=="number"&&!Number.isFinite(e))return`[${e}]`;if(typeof e=="function")return`[Function: ${Xt(e)}]`;if(typeof e=="symbol")return`[${String(e)}]`;if(typeof e=="bigint")return`[BigInt: ${String(e)}]`;const n=Qy(e);return/^HTML(\w*)Element$/.test(n)?`[HTMLElement: ${n}]`:`[object ${n}]`}catch(n){return`**non-serializable** (${n})`}}function Qy(t){const e=Object.getPrototypeOf(t);return e?.constructor?e.constructor.name:"null prototype"}function Zy(t){return~-encodeURI(t).split(/%..|./).length}function ev(t){return Zy(JSON.stringify(t))}function tv(){const t=new WeakSet;function e(s){return t.has(s)?!0:(t.add(s),!1)}function n(s){t.delete(s)}return[e,n]}function Is(t,e=[]){return[t,e]}function nv(t,e){const[n,s]=t;return[n,[...s,e]]}function Bu(t,e){const n=t[1];for(const s of n){const r=s[0].type;if(e(s,r))return!0}return!1}function Pa(t){const e=oo(V);return e.encodePolyfill?e.encodePolyfill(t):new TextEncoder().encode(t)}function sv(t){const[e,n]=t;let s=JSON.stringify(e);function r(i){typeof s=="string"?s=typeof i=="string"?s+i:[Pa(s),i]:s.push(typeof i=="string"?Pa(i):i)}for(const i of n){const[o,a]=i;if(r(`
${JSON.stringify(o)}
`),typeof a=="string"||a instanceof Uint8Array)r(a);else{let c;try{c=JSON.stringify(a)}catch{c=JSON.stringify(gt(a))}r(c)}}return typeof s=="string"?s:rv(s)}function rv(t){const e=t.reduce((r,i)=>r+i.length,0),n=new Uint8Array(e);let s=0;for(const r of t)n.set(r,s),s+=r.length;return n}function iv(t){const e=typeof t.data=="string"?Pa(t.data):t.data;return[{type:"attachment",length:e.length,filename:t.filename,content_type:t.contentType,attachment_type:t.attachmentType},e]}const ov={session:"session",sessions:"session",attachment:"attachment",transaction:"transaction",event:"error",client_report:"internal",user_report:"default",profile:"profile",profile_chunk:"profile",replay_event:"replay",replay_recording:"replay",check_in:"monitor",feedback:"feedback",span:"span",raw_security:"security",log:"log_item",metric:"metric",trace_metric:"metric"};function Hu(t){return ov[t]}function wf(t){if(!t?.sdk)return;const{name:e,version:n}=t.sdk;return{name:e,version:n}}function av(t,e,n,s){const r=t.sdkProcessingMetadata?.dynamicSamplingContext;return{event_id:t.event_id,sent_at:new Date().toISOString(),...e&&{sdk:e},...!!n&&s&&{dsn:Dr(s)},...r&&{trace:r}}}function cv(t,e){if(!e)return t;const n=t.sdk||{};return t.sdk={...n,name:n.name||e.name,version:n.version||e.version,integrations:[...t.sdk?.integrations||[],...e.integrations||[]],packages:[...t.sdk?.packages||[],...e.packages||[]],settings:t.sdk?.settings||e.settings?{...t.sdk?.settings,...e.settings}:void 0},t}function lv(t,e,n,s){const r=wf(n),i={sent_at:new Date().toISOString(),...r&&{sdk:r},...!!s&&e&&{dsn:Dr(e)}},o="aggregates"in t?[{type:"sessions"},t]:[{type:"session"},t.toJSON()];return Is(i,[o])}function uv(t,e,n,s){const r=wf(n),i=t.type&&t.type!=="replay_event"?t.type:"event";cv(t,n?.sdk);const o=av(t,r,s,e);return delete t.sdkProcessingMetadata,Is(o,[[{type:i},t]])}const Jo=0,Wu=1,Vu=2;function uo(t){return new dr(e=>{e(t)})}function $c(t){return new dr((e,n)=>{n(t)})}class dr{constructor(e){this._state=Jo,this._handlers=[],this._runExecutor(e)}then(e,n){return new dr((s,r)=>{this._handlers.push([!1,i=>{if(!e)s(i);else try{s(e(i))}catch(o){r(o)}},i=>{if(!n)r(i);else try{s(n(i))}catch(o){r(o)}}]),this._executeHandlers()})}catch(e){return this.then(n=>n,e)}finally(e){return new dr((n,s)=>{let r,i;return this.then(o=>{i=!1,r=o,e&&e()},o=>{i=!0,r=o,e&&e()}).then(()=>{if(i){s(r);return}n(r)})})}_executeHandlers(){if(this._state===Jo)return;const e=this._handlers.slice();this._handlers=[],e.forEach(n=>{n[0]||(this._state===Wu&&n[1](this._value),this._state===Vu&&n[2](this._value),n[0]=!0)})}_runExecutor(e){const n=(i,o)=>{if(this._state===Jo){if(Nr(o)){o.then(s,r);return}this._state=i,this._value=o,this._executeHandlers()}},s=i=>{n(Wu,i)},r=i=>{n(Vu,i)};try{e(s,r)}catch(i){r(i)}}}function dv(t,e,n,s=0){try{const r=La(e,n,t,s);return Nr(r)?r:uo(r)}catch(r){return $c(r)}}function La(t,e,n,s){const r=n[s];if(!t||!r)return t;const i=r({...t},e);return I&&i===null&&b.log(`Event processor "${r.id||"?"}" dropped event`),Nr(i)?i.then(o=>La(o,e,n,s+1)):La(i,e,n,s+1)}function hv(t,e){const{fingerprint:n,span:s,breadcrumbs:r,sdkProcessingMetadata:i}=e;fv(t,e),s&&mv(t,s),_v(t,n),pv(t,r),gv(t,i)}function ju(t,e){const{extra:n,tags:s,user:r,contexts:i,level:o,sdkProcessingMetadata:a,breadcrumbs:c,fingerprint:l,eventProcessors:u,attachments:d,propagationContext:h,transactionName:f,span:p}=e;Jr(t,"extra",n),Jr(t,"tags",s),Jr(t,"user",r),Jr(t,"contexts",i),t.sdkProcessingMetadata=Lr(t.sdkProcessingMetadata,a,2),o&&(t.level=o),f&&(t.transactionName=f),p&&(t.span=p),c.length&&(t.breadcrumbs=[...t.breadcrumbs,...c]),l.length&&(t.fingerprint=[...t.fingerprint,...l]),u.length&&(t.eventProcessors=[...t.eventProcessors,...u]),d.length&&(t.attachments=[...t.attachments,...d]),t.propagationContext={...t.propagationContext,...h}}function Jr(t,e,n){t[e]=Lr(t[e],n,1)}function fv(t,e){const{extra:n,tags:s,user:r,contexts:i,level:o,transactionName:a}=e;Object.keys(n).length&&(t.extra={...n,...t.extra}),Object.keys(s).length&&(t.tags={...s,...t.tags}),Object.keys(r).length&&(t.user={...r,...t.user}),Object.keys(i).length&&(t.contexts={...i,...t.contexts}),o&&(t.level=o),a&&t.type!=="transaction"&&(t.transaction=a)}function pv(t,e){const n=[...t.breadcrumbs||[],...e];t.breadcrumbs=n.length?n:void 0}function gv(t,e){t.sdkProcessingMetadata={...t.sdkProcessingMetadata,...e}}function mv(t,e){t.contexts={trace:Uy(e),...t.contexts},t.sdkProcessingMetadata={dynamicSamplingContext:Jy(e),...t.sdkProcessingMetadata};const n=_f(e),s=Fc(n).description;s&&!t.transaction&&t.type==="transaction"&&(t.transaction=s)}function _v(t,e){t.fingerprint=t.fingerprint?Array.isArray(t.fingerprint)?t.fingerprint:[t.fingerprint]:[],e&&(t.fingerprint=t.fingerprint.concat(e)),t.fingerprint.length||delete t.fingerprint}let un,qu,zu,Dt;function yv(t){const e=V._sentryDebugIds,n=V._debugIds;if(!e&&!n)return{};const s=e?Object.keys(e):[],r=n?Object.keys(n):[];if(Dt&&s.length===qu&&r.length===zu)return Dt;qu=s.length,zu=r.length,Dt={},un||(un={});const i=(o,a)=>{for(const c of o){const l=a[c],u=un?.[c];if(u&&Dt&&l)Dt[u[0]]=l,un&&(un[c]=[u[0],l]);else if(l){const d=t(c);for(let h=d.length-1;h>=0;h--){const p=d[h]?.filename;if(p&&Dt&&un){Dt[p]=l,un[c]=[p,l];break}}}}};return e&&i(s,e),n&&i(r,n),Dt}function vv(t,e,n,s,r,i){const{normalizeDepth:o=3,normalizeMaxBreadth:a=1e3}=t,c={...e,event_id:e.event_id||n.event_id||$e(),timestamp:e.timestamp||Pr()},l=n.integrations||t.integrations.map(m=>m.name);wv(c,t),Cv(c,l),r&&r.emit("applyFrameMetadata",e),e.type===void 0&&Ev(c,t.stackParser);const u=Tv(s,n.captureContext);n.mechanism&&ls(c,n.mechanism);const d=r?r.getEventProcessors():[],h=hy().getScopeData();if(i){const m=i.getScopeData();ju(h,m)}if(u){const m=u.getScopeData();ju(h,m)}const f=[...n.attachments||[],...h.attachments];f.length&&(n.attachments=f),hv(c,h);const p=[...d,...h.eventProcessors];return dv(p,c,n).then(m=>(m&&bv(m),typeof o=="number"&&o>0?Sv(m,o,a):m))}function wv(t,e){const{environment:n,release:s,dist:r,maxValueLength:i}=e;t.environment=t.environment||n||Uc,!t.release&&s&&(t.release=s),!t.dist&&r&&(t.dist=r);const o=t.request;o?.url&&(o.url=i?cf(o.url,i):o.url)}function Ev(t,e){const n=yv(e);t.exception?.values?.forEach(s=>{s.stacktrace?.frames?.forEach(r=>{r.filename&&(r.debug_id=n[r.filename])})})}function bv(t){const e={};if(t.exception?.values?.forEach(s=>{s.stacktrace?.frames?.forEach(r=>{r.debug_id&&(r.abs_path?e[r.abs_path]=r.debug_id:r.filename&&(e[r.filename]=r.debug_id),delete r.debug_id)})}),Object.keys(e).length===0)return;t.debug_meta=t.debug_meta||{},t.debug_meta.images=t.debug_meta.images||[];const n=t.debug_meta.images;Object.entries(e).forEach(([s,r])=>{n.push({type:"sourcemap",code_file:s,debug_id:r})})}function Cv(t,e){e.length>0&&(t.sdk=t.sdk||{},t.sdk.integrations=[...t.sdk.integrations||[],...e])}function Sv(t,e,n){if(!t)return null;const s={...t,...t.breadcrumbs&&{breadcrumbs:t.breadcrumbs.map(r=>({...r,...r.data&&{data:gt(r.data,e,n)}}))},...t.user&&{user:gt(t.user,e,n)},...t.contexts&&{contexts:gt(t.contexts,e,n)},...t.extra&&{extra:gt(t.extra,e,n)}};return t.contexts?.trace&&s.contexts&&(s.contexts.trace=t.contexts.trace,t.contexts.trace.data&&(s.contexts.trace.data=gt(t.contexts.trace.data,e,n))),t.spans&&(s.spans=t.spans.map(r=>({...r,...r.data&&{data:gt(r.data,e,n)}}))),t.contexts?.flags&&s.contexts&&(s.contexts.flags=gt(t.contexts.flags,3,n)),s}function Tv(t,e){if(!e)return t;const n=t?t.clone():new kt;return n.update(e),n}function Iv(t,e){return on().captureException(t,void 0)}function Ef(t,e){return on().captureEvent(t,e)}function Gu(t){const e=Or(),n=on(),{userAgent:s}=V.navigator||{},r=ny({user:n.getUser()||e.getUser(),...s&&{userAgent:s},...t}),i=e.getSession();return i?.status==="ok"&&us(i,{status:"exited"}),bf(),e.setSession(r),r}function bf(){const t=Or(),n=on().getSession()||t.getSession();n&&sy(n),Cf(),t.setSession()}function Cf(){const t=Or(),e=Ae(),n=t.getSession();n&&e&&e.captureSession(n)}function Yu(t=!1){if(t){bf();return}Cf()}const kv="7";function Rv(t){const e=t.protocol?`${t.protocol}:`:"",n=t.port?`:${t.port}`:"";return`${e}//${t.host}${n}${t.path?`/${t.path}`:""}/api/`}function Av(t){return`${Rv(t)}${t.projectId}/envelope/`}function Nv(t,e){const n={sentry_version:kv};return t.publicKey&&(n.sentry_key=t.publicKey),e&&(n.sentry_client=`${e.name}/${e.version}`),new URLSearchParams(n).toString()}function Pv(t,e,n){return e||`${Av(t)}?${Nv(t,n)}`}const Ku=[];function Lv(t){const e={};return t.forEach(n=>{const{name:s}=n,r=e[s];r&&!r.isDefaultInstance&&n.isDefaultInstance||(e[s]=n)}),Object.values(e)}function Ov(t){const e=t.defaultIntegrations||[],n=t.integrations;e.forEach(r=>{r.isDefaultInstance=!0});let s;if(Array.isArray(n))s=[...e,...n];else if(typeof n=="function"){const r=n(e);s=Array.isArray(r)?r:[r]}else s=e;return Lv(s)}function Dv(t,e){const n={};return e.forEach(s=>{s&&Sf(t,s,n)}),n}function Ju(t,e){for(const n of e)n?.afterAllSetup&&n.afterAllSetup(t)}function Sf(t,e,n){if(n[e.name]){I&&b.log(`Integration skipped because it was already installed: ${e.name}`);return}if(n[e.name]=e,!Ku.includes(e.name)&&typeof e.setupOnce=="function"&&(e.setupOnce(),Ku.push(e.name)),e.setup&&typeof e.setup=="function"&&e.setup(t),typeof e.preprocessEvent=="function"){const s=e.preprocessEvent.bind(e);t.on("preprocessEvent",(r,i)=>s(r,i,t))}if(typeof e.processEvent=="function"){const s=e.processEvent.bind(e),r=Object.assign((i,o)=>s(i,o,t),{id:e.name});t.addEventProcessor(r)}I&&b.log(`Integration installed: ${e.name}`)}function xv(t){return[{type:"log",item_count:t.length,content_type:"application/vnd.sentry.items.log+json"},{items:t}]}function Mv(t,e,n,s){const r={};return e?.sdk&&(r.sdk={name:e.sdk.name,version:e.sdk.version}),n&&s&&(r.dsn=Dr(s)),Is(r,[xv(t)])}function Tf(t,e){const n=e??Fv(t)??[];if(n.length===0)return;const s=t.getOptions(),r=Mv(n,s._metadata,s.tunnel,t.getDsn());If().set(t,[]),t.emit("flushLogs"),t.sendEnvelope(r)}function Fv(t){return If().get(t)}function If(){return Cs("clientToLogBufferMap",()=>new WeakMap)}function Uv(t){return[{type:"trace_metric",item_count:t.length,content_type:"application/vnd.sentry.items.trace-metric+json"},{items:t}]}function $v(t,e,n,s){const r={};return e?.sdk&&(r.sdk={name:e.sdk.name,version:e.sdk.version}),n&&s&&(r.dsn=Dr(s)),Is(r,[Uv(t)])}function kf(t,e){const n=e??Bv(t)??[];if(n.length===0)return;const s=t.getOptions(),r=$v(n,s._metadata,s.tunnel,t.getDsn());Rf().set(t,[]),t.emit("flushMetrics"),t.sendEnvelope(r)}function Bv(t){return Rf().get(t)}function Rf(){return Cs("clientToMetricBufferMap",()=>new WeakMap)}function Hv(t,e,n){const s=[{type:"client_report"},{timestamp:Pr(),discarded_events:t}];return Is(e?{dsn:e}:{},[s])}function Af(t){const e=[];t.message&&e.push(t.message);try{const n=t.exception.values[t.exception.values.length-1];n?.value&&(e.push(n.value),n.type&&e.push(`${n.type}: ${n.value}`))}catch{}return e}function Wv(t){const{trace_id:e,parent_span_id:n,span_id:s,status:r,origin:i,data:o,op:a}=t.contexts?.trace??{};return{data:o??{},description:t.transaction,op:a,parent_span_id:n,span_id:s??"",start_timestamp:t.start_timestamp??0,status:r,timestamp:t.timestamp,trace_id:e??"",origin:i,profile_id:o?.[hf],exclusive_time:o?.[ff],measurements:t.measurements,is_segment:!0}}function Vv(t){return{type:"transaction",timestamp:t.timestamp,start_timestamp:t.start_timestamp,transaction:t.description,contexts:{trace:{trace_id:t.trace_id,span_id:t.span_id,parent_span_id:t.parent_span_id,op:t.op,status:t.status,origin:t.origin,data:{...t.data,...t.profile_id&&{[hf]:t.profile_id},...t.exclusive_time&&{[ff]:t.exclusive_time}}}},measurements:t.measurements}}const Xu="Not capturing exception because it's already been captured.",Qu="Discarded session because of missing or non-string release",Nf=Symbol.for("SentryInternalError"),Pf=Symbol.for("SentryDoNotSendEventError"),jv=5e3;function di(t){return{message:t,[Nf]:!0}}function Xo(t){return{message:t,[Pf]:!0}}function Zu(t){return!!t&&typeof t=="object"&&Nf in t}function ed(t){return!!t&&typeof t=="object"&&Pf in t}function td(t,e,n,s,r){let i=0,o,a=!1;t.on(n,()=>{i=0,clearTimeout(o),a=!1}),t.on(e,c=>{i+=s(c),i>=8e5?r(t):a||(a=!0,o=setTimeout(()=>{r(t)},jv))}),t.on("flush",()=>{r(t)})}class qv{constructor(e){if(this._options=e,this._integrations={},this._numProcessing=0,this._outcomes={},this._hooks={},this._eventProcessors=[],e.dsn?this._dsn=My(e.dsn):I&&b.warn("No DSN provided, client will not send events."),this._dsn){const s=Pv(this._dsn,e.tunnel,e._metadata?e._metadata.sdk:void 0);this._transport=e.transport({tunnel:this._options.tunnel,recordDroppedEvent:this.recordDroppedEvent.bind(this),...e.transportOptions,url:s})}this._options.enableLogs&&td(this,"afterCaptureLog","flushLogs",Kv,Tf),(this._options.enableMetrics??this._options._experiments?.enableMetrics??!0)&&td(this,"afterCaptureMetric","flushMetrics",Yv,kf)}captureException(e,n,s){const r=$e();if(ku(e))return I&&b.log(Xu),r;const i={event_id:r,...n};return this._process(this.eventFromException(e,i).then(o=>this._captureEvent(o,i,s))),i.event_id}captureMessage(e,n,s,r){const i={event_id:$e(),...s},o=Lc(e)?e:String(e),a=ao(e)?this.eventFromMessage(o,n,i):this.eventFromException(e,i);return this._process(a.then(c=>this._captureEvent(c,i,r))),i.event_id}captureEvent(e,n,s){const r=$e();if(n?.originalException&&ku(n.originalException))return I&&b.log(Xu),r;const i={event_id:r,...n},o=e.sdkProcessingMetadata||{},a=o.capturedSpanScope,c=o.capturedSpanIsolationScope;return this._process(this._captureEvent(e,i,a||s,c)),i.event_id}captureSession(e){this.sendSession(e),us(e,{init:!1})}getDsn(){return this._dsn}getOptions(){return this._options}getSdkMetadata(){return this._options._metadata}getTransport(){return this._transport}async flush(e){const n=this._transport;if(!n)return!0;this.emit("flush");const s=await this._isClientDoneProcessing(e),r=await n.flush(e);return s&&r}async close(e){const n=await this.flush(e);return this.getOptions().enabled=!1,this.emit("close"),n}getEventProcessors(){return this._eventProcessors}addEventProcessor(e){this._eventProcessors.push(e)}init(){(this._isEnabled()||this._options.integrations.some(({name:e})=>e.startsWith("Spotlight")))&&this._setupIntegrations()}getIntegrationByName(e){return this._integrations[e]}addIntegration(e){const n=this._integrations[e.name];Sf(this,e,this._integrations),n||Ju(this,[e])}sendEvent(e,n={}){this.emit("beforeSendEvent",e,n);let s=uv(e,this._dsn,this._options._metadata,this._options.tunnel);for(const r of n.attachments||[])s=nv(s,iv(r));this.sendEnvelope(s).then(r=>this.emit("afterSendEvent",e,r))}sendSession(e){const{release:n,environment:s=Uc}=this._options;if("aggregates"in e){const i=e.attrs||{};if(!i.release&&!n){I&&b.warn(Qu);return}i.release=i.release||n,i.environment=i.environment||s,e.attrs=i}else{if(!e.release&&!n){I&&b.warn(Qu);return}e.release=e.release||n,e.environment=e.environment||s}this.emit("beforeSendSession",e);const r=lv(e,this._dsn,this._options._metadata,this._options.tunnel);this.sendEnvelope(r)}recordDroppedEvent(e,n,s=1){if(this._options.sendClientReports){const r=`${e}:${n}`;I&&b.log(`Recording outcome: "${r}"${s>1?` (${s} times)`:""}`),this._outcomes[r]=(this._outcomes[r]||0)+s}}on(e,n){const s=this._hooks[e]=this._hooks[e]||new Set,r=(...i)=>n(...i);return s.add(r),()=>{s.delete(r)}}emit(e,...n){const s=this._hooks[e];s&&s.forEach(r=>r(...n))}async sendEnvelope(e){if(this.emit("beforeEnvelope",e),this._isEnabled()&&this._transport)try{return await this._transport.send(e)}catch(n){return I&&b.error("Error while sending envelope:",n),{}}return I&&b.error("Transport disabled"),{}}_setupIntegrations(){const{integrations:e}=this._options;this._integrations=Dv(this,e),Ju(this,e)}_updateSessionFromEvent(e,n){let s=n.level==="fatal",r=!1;const i=n.exception?.values;if(i){r=!0,s=!1;for(const c of i)if(c.mechanism?.handled===!1){s=!0;break}}const o=e.status==="ok";(o&&e.errors===0||o&&s)&&(us(e,{...s&&{status:"crashed"},errors:e.errors||Number(r||s)}),this.captureSession(e))}async _isClientDoneProcessing(e){let n=0;for(;!e||n<e;){if(await new Promise(s=>setTimeout(s,1)),!this._numProcessing)return!0;n++}return!1}_isEnabled(){return this.getOptions().enabled!==!1&&this._transport!==void 0}_prepareEvent(e,n,s,r){const i=this.getOptions(),o=Object.keys(this._integrations);return!n.integrations&&o?.length&&(n.integrations=o),this.emit("preprocessEvent",e,n),e.type||r.setLastEventId(e.event_id||n.event_id),vv(i,e,n,s,this,r).then(a=>{if(a===null)return a;this.emit("postprocessEvent",a,n),a.contexts={trace:py(s),...a.contexts};const c=Ky(this,s);return a.sdkProcessingMetadata={dynamicSamplingContext:c,...a.sdkProcessingMetadata},a})}_captureEvent(e,n={},s=on(),r=Or()){return I&&Oa(e)&&b.log(`Captured error event \`${Af(e)[0]||"<unknown>"}\``),this._processEvent(e,n,s,r).then(i=>i.event_id,i=>{I&&(ed(i)?b.log(i.message):Zu(i)?b.warn(i.message):b.warn(i))})}_processEvent(e,n,s,r){const i=this.getOptions(),{sampleRate:o}=i,a=Lf(e),c=Oa(e),l=e.type||"error",u=`before send for type \`${l}\``,d=typeof o>"u"?void 0:Fy(o);if(c&&typeof d=="number"&&Math.random()>d)return this.recordDroppedEvent("sample_rate","error"),$c(Xo(`Discarding event because it's not included in the random sample (sampling rate = ${o})`));const h=l==="replay_event"?"replay":l;return this._prepareEvent(e,n,s,r).then(f=>{if(f===null)throw this.recordDroppedEvent("event_processor",h),Xo("An event processor returned `null`, will not send event.");if(n.data&&n.data.__sentry__===!0)return f;const _=Gv(this,i,f,n);return zv(_,u)}).then(f=>{if(f===null){if(this.recordDroppedEvent("before_send",h),a){const A=1+(e.spans||[]).length;this.recordDroppedEvent("before_send","span",A)}throw Xo(`${u} returned \`null\`, will not send event.`)}const p=s.getSession()||r.getSession();if(c&&p&&this._updateSessionFromEvent(p,f),a){const m=f.sdkProcessingMetadata?.spanCountBeforeProcessing||0,A=f.spans?f.spans.length:0,x=m-A;x>0&&this.recordDroppedEvent("before_send","span",x)}const _=f.transaction_info;if(a&&_&&f.transaction!==e.transaction){const m="custom";f.transaction_info={..._,source:m}}return this.sendEvent(f,n),f}).then(null,f=>{throw ed(f)||Zu(f)?f:(this.captureException(f,{mechanism:{handled:!1,type:"internal"},data:{__sentry__:!0},originalException:f}),di(`Event processing pipeline threw an error, original event will not be sent. Details have been sent as a new event.
Reason: ${f}`))})}_process(e){this._numProcessing++,e.then(n=>(this._numProcessing--,n),n=>(this._numProcessing--,n))}_clearOutcomes(){const e=this._outcomes;return this._outcomes={},Object.entries(e).map(([n,s])=>{const[r,i]=n.split(":");return{reason:r,category:i,quantity:s}})}_flushOutcomes(){I&&b.log("Flushing outcomes...");const e=this._clearOutcomes();if(e.length===0){I&&b.log("No outcomes to send");return}if(!this._dsn){I&&b.log("No dsn provided, will not send outcomes");return}I&&b.log("Sending outcomes:",e);const n=Hv(e,this._options.tunnel&&Dr(this._dsn));this.sendEnvelope(n)}}function zv(t,e){const n=`${e} must return \`null\` or a valid event.`;if(Nr(t))return t.then(s=>{if(!ur(s)&&s!==null)throw di(n);return s},s=>{throw di(`${e} rejected with ${s}`)});if(!ur(t)&&t!==null)throw di(n);return t}function Gv(t,e,n,s){const{beforeSend:r,beforeSendTransaction:i,beforeSendSpan:o,ignoreSpans:a}=e;let c=n;if(Oa(c)&&r)return r(c,s);if(Lf(c)){if(o||a){const l=Wv(c);if(a?.length&&$u(l,a))return null;if(o){const u=o(l);u?c=Lr(n,Vv(u)):Fu()}if(c.spans){const u=[],d=c.spans;for(const f of d){if(a?.length&&$u(f,a)){zy(d,f);continue}if(o){const p=o(f);p?u.push(p):(Fu(),u.push(f))}else u.push(f)}const h=c.spans.length-u.length;h&&t.recordDroppedEvent("before_send","span",h),c.spans=u}}if(i){if(c.spans){const l=c.spans.length;c.sdkProcessingMetadata={...n.sdkProcessingMetadata,spanCountBeforeProcessing:l}}return i(c,s)}}return c}function Oa(t){return t.type===void 0}function Lf(t){return t.type==="transaction"}function Yv(t){let e=0;return t.name&&(e+=t.name.length*2),e+=8,e+Of(t.attributes)}function Kv(t){let e=0;return t.message&&(e+=t.message.length*2),e+Of(t.attributes)}function Of(t){if(!t)return 0;let e=0;return Object.values(t).forEach(n=>{Array.isArray(n)?e+=n.length*nd(n[0]):ao(n)?e+=nd(n):e+=100}),e}function nd(t){return typeof t=="string"?t.length*2:typeof t=="number"?8:typeof t=="boolean"?4:0}function Jv(t,e){e.debug===!0&&(I?b.enable():Ss(()=>{console.warn("[Sentry] Cannot initialize SDK with `debug` option using a non-debug bundle.")})),on().update(e.initialScope);const s=new t(e);return Xv(s),s.init(),s}function Xv(t){on().setClient(t)}const Df=Symbol.for("SentryBufferFullError");function xf(t=100){const e=new Set;function n(){return e.size<t}function s(o){e.delete(o)}function r(o){if(!n())return $c(Df);const a=o();return e.add(a),a.then(()=>s(a),()=>s(a)),a}function i(o){if(!e.size)return uo(!0);const a=Promise.allSettled(Array.from(e)).then(()=>!0);if(!o)return a;const c=[a,new Promise(l=>setTimeout(()=>l(!1),o))];return Promise.race(c)}return{get $(){return Array.from(e)},add:r,drain:i}}const Qv=60*1e3;function Zv(t,e=Date.now()){const n=parseInt(`${t}`,10);if(!isNaN(n))return n*1e3;const s=Date.parse(`${t}`);return isNaN(s)?Qv:s-e}function ew(t,e){return t[e]||t.all||0}function tw(t,e,n=Date.now()){return ew(t,e)>n}function nw(t,{statusCode:e,headers:n},s=Date.now()){const r={...t},i=n?.["x-sentry-rate-limits"],o=n?.["retry-after"];if(i)for(const a of i.trim().split(",")){const[c,l,,,u]=a.split(":",5),d=parseInt(c,10),h=(isNaN(d)?60:d)*1e3;if(!l)r.all=s+h;else for(const f of l.split(";"))f==="metric_bucket"?(!u||u.split(";").includes("custom"))&&(r[f]=s+h):r[f]=s+h}else o?r.all=s+Zv(o,s):e===429&&(r.all=s+60*1e3);return r}const sw=64;function rw(t,e,n=xf(t.bufferSize||sw)){let s={};const r=o=>n.drain(o);function i(o){const a=[];if(Bu(o,(d,h)=>{const f=Hu(h);tw(s,f)?t.recordDroppedEvent("ratelimit_backoff",f):a.push(d)}),a.length===0)return Promise.resolve({});const c=Is(o[0],a),l=d=>{Bu(c,(h,f)=>{t.recordDroppedEvent(d,Hu(f))})},u=()=>e({body:sv(c)}).then(d=>(d.statusCode!==void 0&&(d.statusCode<200||d.statusCode>=300)&&I&&b.warn(`Sentry responded with status code ${d.statusCode} to sent event.`),s=nw(s,d),d),d=>{throw l("network_error"),I&&b.error("Encountered error running transport request:",d),d});return n.add(u).then(d=>d,d=>{if(d===Df)return I&&b.error("Skipped sending event because buffer is full."),l("queue_overflow"),Promise.resolve({});throw d})}return{send:i,flush:r}}function Qo(t){if(!t)return{};const e=t.match(/^(([^:/?#]+):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?$/);if(!e)return{};const n=e[6]||"",s=e[8]||"";return{host:e[4],path:e[5],protocol:e[2],search:n,hash:s,relative:e[5]+n+s}}function iw(t){"aggregates"in t?t.attrs?.ip_address===void 0&&(t.attrs={...t.attrs,ip_address:"{{auto}}"}):t.ipAddress===void 0&&(t.ipAddress="{{auto}}")}function ow(t,e,n=[e],s="npm"){const r=t._metadata||{};r.sdk||(r.sdk={name:`sentry.javascript.${e}`,packages:n.map(i=>({name:`${s}:@sentry/${i}`,version:wn})),version:wn}),t._metadata=r}const aw=100;function kn(t,e){const n=Ae(),s=Or();if(!n)return;const{beforeBreadcrumb:r=null,maxBreadcrumbs:i=aw}=n.getOptions();if(i<=0)return;const a={timestamp:Pr(),...t},c=r?Ss(()=>r(a,e)):a;c!==null&&(n.emit&&n.emit("beforeAddBreadcrumb",c,e),s.addBreadcrumb(c,i))}let sd;const cw="FunctionToString",rd=new WeakMap,lw=(()=>({name:cw,setupOnce(){sd=Function.prototype.toString;try{Function.prototype.toString=function(...t){const e=xc(this),n=rd.has(Ae())&&e!==void 0?e:this;return sd.apply(n,t)}}catch{}},setup(t){rd.set(t,!0)}})),uw=lw,dw=[/^Script error\.?$/,/^Javascript error: Script error\.? on line 0$/,/^ResizeObserver loop completed with undelivered notifications.$/,/^Cannot redefine property: googletag$/,/^Can't find variable: gmo$/,/^undefined is not an object \(evaluating 'a\.[A-Z]'\)$/,`can't redefine non-configurable property "solana"`,"vv().getRestrictions is not a function. (In 'vv().getRestrictions(1,a)', 'vv().getRestrictions' is undefined)","Can't find variable: _AutofillCallbackHandler",/^Non-Error promise rejection captured with value: Object Not Found Matching Id:\d+, MethodName:simulateEvent, ParamCount:\d+$/,/^Java exception was raised during method invocation$/],hw="EventFilters",fw=(t={})=>{let e;return{name:hw,setup(n){const s=n.getOptions();e=id(t,s)},processEvent(n,s,r){if(!e){const i=r.getOptions();e=id(t,i)}return gw(n,e)?null:n}}},pw=((t={})=>({...fw(t),name:"InboundFilters"}));function id(t={},e={}){return{allowUrls:[...t.allowUrls||[],...e.allowUrls||[]],denyUrls:[...t.denyUrls||[],...e.denyUrls||[]],ignoreErrors:[...t.ignoreErrors||[],...e.ignoreErrors||[],...t.disableErrorDefaults?[]:dw],ignoreTransactions:[...t.ignoreTransactions||[],...e.ignoreTransactions||[]]}}function gw(t,e){if(t.type){if(t.type==="transaction"&&_w(t,e.ignoreTransactions))return I&&b.warn(`Event dropped due to being matched by \`ignoreTransactions\` option.
...
Event: ${mn(t)}.
Url: ${Ci(t)}`),!0;if(!vw(t,e.allowUrls))return I&&b.warn(`Event dropped due to not being matched by \`allowUrls\` option.
Event: ${mn(t)}.
Url: ${Ci(t)}`),!0}return!1}function mw(t,e){return e?.length?Af(t).some(n=>lo(n,e)):!1}function _w(t,e){if(!e?.length)return!1;const n=t.transaction;return n?lo(n,e):!1}function yw(t,e){if(!e?.length)return!1;const n=Ci(t);return n?lo(n,e):!1}function vw(t,e){if(!e?.length)return!0;const n=Ci(t);return n?lo(n,e):!0}function ww(t=[]){for(let e=t.length-1;e>=0;e--){const n=t[e];if(n&&n.filename!=="<anonymous>"&&n.filename!=="[native code]")return n.filename||null}return null}function Ci(t){try{const n=[...t.exception?.values??[]].reverse().find(s=>s.mechanism?.parent_id===void 0&&s.stacktrace?.frames?.length)?.stacktrace?.frames;return n?ww(n):null}catch{return I&&b.error(`Cannot extract url for event ${mn(t)}`),null}}function Ew(t){return t.exception?.values?.length?!t.message&&!t.exception.values.some(e=>e.stacktrace||e.type&&e.type!=="Error"||e.value):!1}function bw(t,e,n,s,r,i){if(!r.exception?.values||!i||!Qt(i.originalException,Error))return;const o=r.exception.values.length>0?r.exception.values[r.exception.values.length-1]:void 0;o&&(r.exception.values=Da(t,e,s,i.originalException,n,r.exception.values,o,0))}function Da(t,e,n,s,r,i,o,a){if(i.length>=n+1)return i;let c=[...i];if(Qt(s[r],Error)){od(o,a);const l=t(e,s[r]),u=c.length;ad(l,r,u,a),c=Da(t,e,n,s[r],r,[l,...c],l,u)}return Array.isArray(s.errors)&&s.errors.forEach((l,u)=>{if(Qt(l,Error)){od(o,a);const d=t(e,l),h=c.length;ad(d,`errors[${u}]`,h,a),c=Da(t,e,n,l,r,[d,...c],d,h)}}),c}function od(t,e){t.mechanism={handled:!0,type:"auto.core.linked_errors",...t.mechanism,...t.type==="AggregateError"&&{is_exception_group:!0},exception_id:e}}function ad(t,e,n,s){t.mechanism={handled:!0,...t.mechanism,type:"chained",source:e,exception_id:n,parent_id:s}}function Cw(t){const e="console";$n(e,t),Bn(e,Sw)}function Sw(){"console"in V&&N_.forEach(function(t){t in V.console&&De(V.console,t,function(e){return bi[t]=e,function(...n){Qe("console",{args:n,level:t}),bi[t]?.apply(V.console,n)}})})}function Tw(t){return t==="warn"?"warning":["fatal","error","warning","log","info","debug"].includes(t)?t:"log"}const Iw="Dedupe",kw=(()=>{let t;return{name:Iw,processEvent(e){if(e.type)return e;try{if(Aw(e,t))return I&&b.warn("Event dropped due to being a duplicate of previously captured event."),null}catch{}return t=e}}}),Rw=kw;function Aw(t,e){return e?!!(Nw(t,e)||Pw(t,e)):!1}function Nw(t,e){const n=t.message,s=e.message;return!(!n&&!s||n&&!s||!n&&s||n!==s||!Ff(t,e)||!Mf(t,e))}function Pw(t,e){const n=cd(e),s=cd(t);return!(!n||!s||n.type!==s.type||n.value!==s.value||!Ff(t,e)||!Mf(t,e))}function Mf(t,e){let n=Eu(t),s=Eu(e);if(!n&&!s)return!0;if(n&&!s||!n&&s||(n=n,s=s,s.length!==n.length))return!1;for(let r=0;r<s.length;r++){const i=s[r],o=n[r];if(i.filename!==o.filename||i.lineno!==o.lineno||i.colno!==o.colno||i.function!==o.function)return!1}return!0}function Ff(t,e){let n=t.fingerprint,s=e.fingerprint;if(!n&&!s)return!0;if(n&&!s||!n&&s)return!1;n=n,s=s;try{return n.join("")===s.join("")}catch{return!1}}function cd(t){return t.exception?.values?.[0]}function Uf(t){if(t!==void 0)return t>=400&&t<500?"warning":t>=500?"error":void 0}const hr=V;function Lw(){return"history"in hr&&!!hr.history}function Ow(){if(!("fetch"in hr))return!1;try{return new Headers,new Request("data:,"),new Response,!0}catch{return!1}}function xa(t){return t&&/^function\s+\w+\(\)\s+\{\s+\[native code\]\s+\}$/.test(t.toString())}function Dw(){if(typeof EdgeRuntime=="string")return!0;if(!Ow())return!1;if(xa(hr.fetch))return!0;let t=!1;const e=hr.document;if(e&&typeof e.createElement=="function")try{const n=e.createElement("iframe");n.hidden=!0,e.head.appendChild(n),n.contentWindow?.fetch&&(t=xa(n.contentWindow.fetch)),e.head.removeChild(n)}catch(n){I&&b.warn("Could not create sandbox iframe for pure fetch check, bailing to window.fetch: ",n)}return t}function xw(t,e){const n="fetch";$n(n,t),Bn(n,()=>Mw(void 0,e))}function Mw(t,e=!1){e&&!Dw()||De(V,"fetch",function(n){return function(...s){const r=new Error,{method:i,url:o}=Fw(s),a={args:s,fetchData:{method:i,url:o},startTimestamp:Ct()*1e3,virtualError:r,headers:Uw(s)};return Qe("fetch",{...a}),n.apply(V,s).then(async c=>(Qe("fetch",{...a,endTimestamp:Ct()*1e3,response:c}),c),c=>{if(Qe("fetch",{...a,endTimestamp:Ct()*1e3,error:c}),Pc(c)&&c.stack===void 0&&(c.stack=r.stack,In(c,"framesToPop",1)),c instanceof TypeError&&(c.message==="Failed to fetch"||c.message==="Load failed"||c.message==="NetworkError when attempting to fetch resource."))try{const l=new URL(a.fetchData.url);c.message=`${c.message} (${l.host})`}catch{}throw c})}})}function Ma(t,e){return!!t&&typeof t=="object"&&!!t[e]}function ld(t){return typeof t=="string"?t:t?Ma(t,"url")?t.url:t.toString?t.toString():"":""}function Fw(t){if(t.length===0)return{method:"GET",url:""};if(t.length===2){const[n,s]=t;return{url:ld(n),method:Ma(s,"method")?String(s.method).toUpperCase():"GET"}}const e=t[0];return{url:ld(e),method:Ma(e,"method")?String(e.method).toUpperCase():"GET"}}function Uw(t){const[e,n]=t;try{if(typeof n=="object"&&n!==null&&"headers"in n&&n.headers)return new Headers(n.headers);if(G_(e))return new Headers(e.headers)}catch{}}function $w(){return"npm"}const te=V;let Fa=0;function $f(){return Fa>0}function Bw(){Fa++,setTimeout(()=>{Fa--})}function hs(t,e={}){function n(r){return typeof r=="function"}if(!n(t))return t;try{const r=t.__sentry_wrapped__;if(r)return typeof r=="function"?r:t;if(xc(t))return t}catch{return t}const s=function(...r){try{const i=r.map(o=>hs(o,e));return t.apply(this,i)}catch(i){throw Bw(),fy(o=>{o.addEventProcessor(a=>(e.mechanism&&(Ra(a,void 0),ls(a,e.mechanism)),a.extra={...a.extra,arguments:r},a)),Iv(i)}),i}};try{for(const r in t)Object.prototype.hasOwnProperty.call(t,r)&&(s[r]=t[r])}catch{}of(s,t),In(t,"__sentry_wrapped__",s);try{Object.getOwnPropertyDescriptor(s,"name").configurable&&Object.defineProperty(s,"name",{get(){return t.name}})}catch{}return s}function Hw(){const t=Dc(),{referrer:e}=te.document||{},{userAgent:n}=te.navigator||{},s={...e&&{Referer:e},...n&&{"User-Agent":n}};return{url:t,headers:s}}function Bc(t,e){const n=Hc(t,e),s={type:zw(e),value:Gw(e)};return n.length&&(s.stacktrace={frames:n}),s.type===void 0&&s.value===""&&(s.value="Unrecoverable error caught"),s}function Ww(t,e,n,s){const i=Ae()?.getOptions().normalizeDepth,o=Qw(e),a={__serialized__:vf(e,i)};if(o)return{exception:{values:[Bc(t,o)]},extra:a};const c={exception:{values:[{type:co(e)?e.constructor.name:s?"UnhandledRejection":"Error",value:Jw(e,{isUnhandledRejection:s})}]},extra:a};if(n){const l=Hc(t,n);l.length&&(c.exception.values[0].stacktrace={frames:l})}return c}function Zo(t,e){return{exception:{values:[Bc(t,e)]}}}function Hc(t,e){const n=e.stacktrace||e.stack||"",s=jw(e),r=qw(e);try{return t(n,s,r)}catch{}return[]}const Vw=/Minified React error #\d+;/i;function jw(t){return t&&Vw.test(t.message)?1:0}function qw(t){return typeof t.framesToPop=="number"?t.framesToPop:0}function Bf(t){return typeof WebAssembly<"u"&&typeof WebAssembly.Exception<"u"?t instanceof WebAssembly.Exception:!1}function zw(t){const e=t?.name;return!e&&Bf(t)?t.message&&Array.isArray(t.message)&&t.message.length==2?t.message[0]:"WebAssembly.Exception":e}function Gw(t){const e=t?.message;return Bf(t)?Array.isArray(t.message)&&t.message.length==2?t.message[1]:"wasm exception":e?e.error&&typeof e.error.message=="string"?e.error.message:e:"No error message"}function Yw(t,e,n,s){const r=n?.syntheticException||void 0,i=Wc(t,e,r,s);return ls(i),i.level="error",n?.event_id&&(i.event_id=n.event_id),uo(i)}function Kw(t,e,n="info",s,r){const i=s?.syntheticException||void 0,o=Ua(t,e,i,r);return o.level=n,s?.event_id&&(o.event_id=s.event_id),uo(o)}function Wc(t,e,n,s,r){let i;if(nf(e)&&e.error)return Zo(t,e.error);if(Cu(e)||V_(e)){const o=e;if("stack"in e)i=Zo(t,e);else{const a=o.name||(Cu(o)?"DOMError":"DOMException"),c=o.message?`${a}: ${o.message}`:a;i=Ua(t,c,n,s),Ra(i,c)}return"code"in o&&(i.tags={...i.tags,"DOMException.code":`${o.code}`}),i}return Pc(e)?Zo(t,e):ur(e)||co(e)?(i=Ww(t,e,n,r),ls(i,{synthetic:!0}),i):(i=Ua(t,e,n,s),Ra(i,`${e}`),ls(i,{synthetic:!0}),i)}function Ua(t,e,n,s){const r={};if(s&&n){const i=Hc(t,n);i.length&&(r.exception={values:[{value:e,stacktrace:{frames:i}}]}),ls(r,{synthetic:!0})}if(Lc(e)){const{__sentry_template_string__:i,__sentry_template_values__:o}=e;return r.logentry={message:i,params:o},r}return r.message=e,r}function Jw(t,{isUnhandledRejection:e}){const n=X_(t),s=e?"promise rejection":"exception";return nf(t)?`Event \`ErrorEvent\` captured as ${s} with message \`${t.message}\``:co(t)?`Event \`${Xw(t)}\` (type=${t.type}) captured as ${s}`:`Object captured as ${s} with keys: ${n}`}function Xw(t){try{const e=Object.getPrototypeOf(t);return e?e.constructor.name:void 0}catch{}}function Qw(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e)){const n=t[e];if(n instanceof Error)return n}}class Zw extends qv{constructor(e){const n=eE(e),s=te.SENTRY_SDK_SOURCE||$w();ow(n,"browser",["browser"],s),n._metadata?.sdk&&(n._metadata.sdk.settings={infer_ip:n.sendDefaultPii?"auto":"never",...n._metadata.sdk.settings}),super(n);const{sendDefaultPii:r,sendClientReports:i,enableLogs:o,_experiments:a,enableMetrics:c}=this._options,l=c??a?.enableMetrics??!0;te.document&&(i||o||l)&&te.document.addEventListener("visibilitychange",()=>{te.document.visibilityState==="hidden"&&(i&&this._flushOutcomes(),o&&Tf(this),l&&kf(this))}),r&&this.on("beforeSendSession",iw)}eventFromException(e,n){return Yw(this._options.stackParser,e,n,this._options.attachStacktrace)}eventFromMessage(e,n="info",s){return Kw(this._options.stackParser,e,n,s,this._options.attachStacktrace)}_prepareEvent(e,n,s,r){return e.platform=e.platform||"javascript",super._prepareEvent(e,n,s,r)}}function eE(t){return{release:typeof __SENTRY_RELEASE__=="string"?__SENTRY_RELEASE__:te.SENTRY_RELEASE?.id,sendClientReports:!0,parentSpanIsAlwaysRootSpan:!0,...t}}const tE=typeof __SENTRY_DEBUG__>"u"||__SENTRY_DEBUG__,Se=V,nE=1e3;let ud,$a,Ba;function sE(t){$n("dom",t),Bn("dom",rE)}function rE(){if(!Se.document)return;const t=Qe.bind(null,"dom"),e=dd(t,!0);Se.document.addEventListener("click",e,!1),Se.document.addEventListener("keypress",e,!1),["EventTarget","Node"].forEach(n=>{const r=Se[n]?.prototype;r?.hasOwnProperty?.("addEventListener")&&(De(r,"addEventListener",function(i){return function(o,a,c){if(o==="click"||o=="keypress")try{const l=this.__sentry_instrumentation_handlers__=this.__sentry_instrumentation_handlers__||{},u=l[o]=l[o]||{refCount:0};if(!u.handler){const d=dd(t);u.handler=d,i.call(this,o,d,c)}u.refCount++}catch{}return i.call(this,o,a,c)}}),De(r,"removeEventListener",function(i){return function(o,a,c){if(o==="click"||o=="keypress")try{const l=this.__sentry_instrumentation_handlers__||{},u=l[o];u&&(u.refCount--,u.refCount<=0&&(i.call(this,o,u.handler,c),u.handler=void 0,delete l[o]),Object.keys(l).length===0&&delete this.__sentry_instrumentation_handlers__)}catch{}return i.call(this,o,a,c)}}))})}function iE(t){if(t.type!==$a)return!1;try{if(!t.target||t.target._sentryId!==Ba)return!1}catch{}return!0}function oE(t,e){return t!=="keypress"?!1:e?.tagName?!(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable):!0}function dd(t,e=!1){return n=>{if(!n||n._sentryCaptured)return;const s=aE(n);if(oE(n.type,s))return;In(n,"_sentryCaptured",!0),s&&!s._sentryId&&In(s,"_sentryId",$e());const r=n.type==="keypress"?"input":n.type;iE(n)||(t({event:n,name:r,global:e}),$a=n.type,Ba=s?s._sentryId:void 0),clearTimeout(ud),ud=Se.setTimeout(()=>{Ba=void 0,$a=void 0},nE)}}function aE(t){try{return t.target}catch{return null}}let Xr;function Hf(t){const e="history";$n(e,t),Bn(e,cE)}function cE(){if(Se.addEventListener("popstate",()=>{const e=Se.location.href,n=Xr;if(Xr=e,n===e)return;Qe("history",{from:n,to:e})}),!Lw())return;function t(e){return function(...n){const s=n.length>2?n[2]:void 0;if(s){const r=Xr,i=lE(String(s));if(Xr=i,r===i)return e.apply(this,n);Qe("history",{from:r,to:i})}return e.apply(this,n)}}De(Se.history,"pushState",t),De(Se.history,"replaceState",t)}function lE(t){try{return new URL(t,Se.location.origin).toString()}catch{return t}}const hi={};function uE(t){const e=hi[t];if(e)return e;let n=Se[t];if(xa(n))return hi[t]=n.bind(Se);const s=Se.document;if(s&&typeof s.createElement=="function")try{const r=s.createElement("iframe");r.hidden=!0,s.head.appendChild(r);const i=r.contentWindow;i?.[t]&&(n=i[t]),s.head.removeChild(r)}catch(r){tE&&b.warn(`Could not create sandbox iframe for ${t} check, bailing to window.${t}: `,r)}return n&&(hi[t]=n.bind(Se))}function dE(t){hi[t]=void 0}const Ys="__sentry_xhr_v3__";function hE(t){$n("xhr",t),Bn("xhr",fE)}function fE(){if(!Se.XMLHttpRequest)return;const t=XMLHttpRequest.prototype;t.open=new Proxy(t.open,{apply(e,n,s){const r=new Error,i=Ct()*1e3,o=bt(s[0])?s[0].toUpperCase():void 0,a=pE(s[1]);if(!o||!a)return e.apply(n,s);n[Ys]={method:o,url:a,request_headers:{}},o==="POST"&&a.match(/sentry_key/)&&(n.__sentry_own_request__=!0);const c=()=>{const l=n[Ys];if(l&&n.readyState===4){try{l.status_code=n.status}catch{}const u={endTimestamp:Ct()*1e3,startTimestamp:i,xhr:n,virtualError:r};Qe("xhr",u)}};return"onreadystatechange"in n&&typeof n.onreadystatechange=="function"?n.onreadystatechange=new Proxy(n.onreadystatechange,{apply(l,u,d){return c(),l.apply(u,d)}}):n.addEventListener("readystatechange",c),n.setRequestHeader=new Proxy(n.setRequestHeader,{apply(l,u,d){const[h,f]=d,p=u[Ys];return p&&bt(h)&&bt(f)&&(p.request_headers[h.toLowerCase()]=f),l.apply(u,d)}}),e.apply(n,s)}}),t.send=new Proxy(t.send,{apply(e,n,s){const r=n[Ys];if(!r)return e.apply(n,s);s[0]!==void 0&&(r.body=s[0]);const i={startTimestamp:Ct()*1e3,xhr:n};return Qe("xhr",i),e.apply(n,s)}})}function pE(t){if(bt(t))return t;try{return t.toString()}catch{}}const gE=40;function mE(t,e=uE("fetch")){let n=0,s=0;async function r(i){const o=i.body.length;n+=o,s++;const a={body:i.body,method:"POST",referrerPolicy:"strict-origin",headers:t.headers,keepalive:n<=6e4&&s<15,...t.fetchOptions};try{const c=await e(t.url,a);return{statusCode:c.status,headers:{"x-sentry-rate-limits":c.headers.get("X-Sentry-Rate-Limits"),"retry-after":c.headers.get("Retry-After")}}}catch(c){throw dE("fetch"),c}finally{n-=o,s--}}return rw(t,r,xf(t.bufferSize||gE))}const _E=30,yE=50;function Ha(t,e,n,s){const r={filename:t,function:e==="<anonymous>"?Tn:e,in_app:!0};return n!==void 0&&(r.lineno=n),s!==void 0&&(r.colno=s),r}const vE=/^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,wE=/^\s*at (?:(.+?\)(?: \[.+\])?|.*?) ?\((?:address at )?)?(?:async )?((?:<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,EE=/\((\S*)(?::(\d+))(?::(\d+))\)/,bE=/at (.+?) ?\(data:(.+?),/,CE=t=>{const e=t.match(bE);if(e)return{filename:`<data:${e[2]}>`,function:e[1]};const n=vE.exec(t);if(n){const[,r,i,o]=n;return Ha(r,Tn,+i,+o)}const s=wE.exec(t);if(s){if(s[2]&&s[2].indexOf("eval")===0){const a=EE.exec(s[2]);a&&(s[2]=a[1],s[3]=a[2],s[4]=a[3])}const[i,o]=Wf(s[1]||Tn,s[2]);return Ha(o,i,s[3]?+s[3]:void 0,s[4]?+s[4]:void 0)}},SE=[_E,CE],TE=/^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i,IE=/(\S+) line (\d+)(?: > eval line \d+)* > eval/i,kE=t=>{const e=TE.exec(t);if(e){if(e[3]&&e[3].indexOf(" > eval")>-1){const i=IE.exec(e[3]);i&&(e[1]=e[1]||"eval",e[3]=i[1],e[4]=i[2],e[5]="")}let s=e[3],r=e[1]||Tn;return[r,s]=Wf(r,s),Ha(s,r,e[4]?+e[4]:void 0,e[5]?+e[5]:void 0)}},RE=[yE,kE],AE=[SE,RE],NE=Zh(...AE),Wf=(t,e)=>{const n=t.indexOf("safari-extension")!==-1,s=t.indexOf("safari-web-extension")!==-1;return n||s?[t.indexOf("@")!==-1?t.split("@")[0]:Tn,n?`safari-extension:${e}`:`safari-web-extension:${e}`]:[t,e]},ho=typeof __SENTRY_DEBUG__>"u"||__SENTRY_DEBUG__,Qr=1024,PE="Breadcrumbs",LE=((t={})=>{const e={console:!0,dom:!0,fetch:!0,history:!0,sentry:!0,xhr:!0,...t};return{name:PE,setup(n){e.console&&Cw(ME(n)),e.dom&&sE(xE(n,e.dom)),e.xhr&&hE(FE(n)),e.fetch&&xw(UE(n)),e.history&&Hf($E(n)),e.sentry&&n.on("beforeSendEvent",DE(n))}}}),OE=LE;function DE(t){return function(n){Ae()===t&&kn({category:`sentry.${n.type==="transaction"?"transaction":"event"}`,event_id:n.event_id,level:n.level,message:mn(n)},{event:n})}}function xE(t,e){return function(s){if(Ae()!==t)return;let r,i,o=typeof e=="object"?e.serializeAttribute:void 0,a=typeof e=="object"&&typeof e.maxStringLength=="number"?e.maxStringLength:void 0;a&&a>Qr&&(ho&&b.warn(`\`dom.maxStringLength\` cannot exceed ${Qr}, but a value of ${a} was configured. Sentry will use ${Qr} instead.`),a=Qr),typeof o=="string"&&(o=[o]);try{const l=s.event,u=BE(l)?l.target:l;r=rf(u,{keyAttrs:o,maxStringLength:a}),i=J_(u)}catch{r="<unknown>"}if(r.length===0)return;const c={category:`ui.${s.name}`,message:r};i&&(c.data={"ui.component_name":i}),kn(c,{event:s.event,name:s.name,global:s.global})}}function ME(t){return function(n){if(Ae()!==t)return;const s={category:"console",data:{arguments:n.args,logger:"console"},level:Tw(n.level),message:Iu(n.args," ")};if(n.level==="assert")if(n.args[0]===!1)s.message=`Assertion failed: ${Iu(n.args.slice(1)," ")||"console.assert"}`,s.data.arguments=n.args.slice(1);else return;kn(s,{input:n.args,level:n.level})}}function FE(t){return function(n){if(Ae()!==t)return;const{startTimestamp:s,endTimestamp:r}=n,i=n.xhr[Ys];if(!s||!r||!i)return;const{method:o,url:a,status_code:c,body:l}=i,u={method:o,url:a,status_code:c},d={xhr:n.xhr,input:l,startTimestamp:s,endTimestamp:r},h={category:"xhr",data:u,type:"http",level:Uf(c)};t.emit("beforeOutgoingRequestBreadcrumb",h,d),kn(h,d)}}function UE(t){return function(n){if(Ae()!==t)return;const{startTimestamp:s,endTimestamp:r}=n;if(r&&!(n.fetchData.url.match(/sentry_key/)&&n.fetchData.method==="POST"))if(n.fetchData.method,n.fetchData.url,n.error){const i=n.fetchData,o={data:n.error,input:n.args,startTimestamp:s,endTimestamp:r},a={category:"fetch",data:i,level:"error",type:"http"};t.emit("beforeOutgoingRequestBreadcrumb",a,o),kn(a,o)}else{const i=n.response,o={...n.fetchData,status_code:i?.status};n.fetchData.request_body_size,n.fetchData.response_body_size,i?.status;const a={input:n.args,response:i,startTimestamp:s,endTimestamp:r},c={category:"fetch",data:o,type:"http",level:Uf(o.status_code)};t.emit("beforeOutgoingRequestBreadcrumb",c,a),kn(c,a)}}}function $E(t){return function(n){if(Ae()!==t)return;let s=n.from,r=n.to;const i=Qo(te.location.href);let o=s?Qo(s):void 0;const a=Qo(r);o?.path||(o=i),i.protocol===a.protocol&&i.host===a.host&&(r=a.relative),i.protocol===o.protocol&&i.host===o.host&&(s=o.relative),kn({category:"navigation",data:{from:s,to:r}})}}function BE(t){return!!t&&!!t.target}const HE=["EventTarget","Window","Node","ApplicationCache","AudioTrackList","BroadcastChannel","ChannelMergerNode","CryptoOperation","EventSource","FileReader","HTMLUnknownElement","IDBDatabase","IDBRequest","IDBTransaction","KeyOperation","MediaController","MessagePort","ModalWindow","Notification","SVGElementInstance","Screen","SharedWorker","TextTrack","TextTrackCue","TextTrackList","WebSocket","WebSocketWorker","Worker","XMLHttpRequest","XMLHttpRequestEventTarget","XMLHttpRequestUpload"],WE="BrowserApiErrors",VE=((t={})=>{const e={XMLHttpRequest:!0,eventTarget:!0,requestAnimationFrame:!0,setInterval:!0,setTimeout:!0,unregisterOriginalCallbacks:!1,...t};return{name:WE,setupOnce(){e.setTimeout&&De(te,"setTimeout",hd),e.setInterval&&De(te,"setInterval",hd),e.requestAnimationFrame&&De(te,"requestAnimationFrame",qE),e.XMLHttpRequest&&"XMLHttpRequest"in te&&De(XMLHttpRequest.prototype,"send",zE);const n=e.eventTarget;n&&(Array.isArray(n)?n:HE).forEach(r=>GE(r,e))}}}),jE=VE;function hd(t){return function(...e){const n=e[0];return e[0]=hs(n,{mechanism:{handled:!1,type:`auto.browser.browserapierrors.${Xt(t)}`}}),t.apply(this,e)}}function qE(t){return function(e){return t.apply(this,[hs(e,{mechanism:{data:{handler:Xt(t)},handled:!1,type:"auto.browser.browserapierrors.requestAnimationFrame"}})])}}function zE(t){return function(...e){const n=this;return["onload","onerror","onprogress","onreadystatechange"].forEach(r=>{r in n&&typeof n[r]=="function"&&De(n,r,function(i){const o={mechanism:{data:{handler:Xt(i)},handled:!1,type:`auto.browser.browserapierrors.xhr.${r}`}},a=xc(i);return a&&(o.mechanism.data.handler=Xt(a)),hs(i,o)})}),t.apply(this,e)}}function GE(t,e){const s=te[t]?.prototype;s?.hasOwnProperty?.("addEventListener")&&(De(s,"addEventListener",function(r){return function(i,o,a){try{YE(o)&&(o.handleEvent=hs(o.handleEvent,{mechanism:{data:{handler:Xt(o),target:t},handled:!1,type:"auto.browser.browserapierrors.handleEvent"}}))}catch{}return e.unregisterOriginalCallbacks&&KE(this,i,o),r.apply(this,[i,hs(o,{mechanism:{data:{handler:Xt(o),target:t},handled:!1,type:"auto.browser.browserapierrors.addEventListener"}}),a])}}),De(s,"removeEventListener",function(r){return function(i,o,a){try{const c=o.__sentry_wrapped__;c&&r.call(this,i,c,a)}catch{}return r.call(this,i,o,a)}}))}function YE(t){return typeof t.handleEvent=="function"}function KE(t,e,n){t&&typeof t=="object"&&"removeEventListener"in t&&typeof t.removeEventListener=="function"&&t.removeEventListener(e,n)}const JE=()=>({name:"BrowserSession",setupOnce(){if(typeof te.document>"u"){ho&&b.warn("Using the `browserSessionIntegration` in non-browser environments is not supported.");return}Gu({ignoreDuration:!0}),Yu(),Hf(({from:t,to:e})=>{t!==void 0&&t!==e&&(Gu({ignoreDuration:!0}),Yu())})}}),XE="GlobalHandlers",QE=((t={})=>{const e={onerror:!0,onunhandledrejection:!0,...t};return{name:XE,setupOnce(){Error.stackTraceLimit=50},setup(n){e.onerror&&(eb(n),fd("onerror")),e.onunhandledrejection&&(tb(n),fd("onunhandledrejection"))}}}),ZE=QE;function eb(t){$_(e=>{const{stackParser:n,attachStacktrace:s}=Vf();if(Ae()!==t||$f())return;const{msg:r,url:i,line:o,column:a,error:c}=e,l=rb(Wc(n,c||r,void 0,s,!1),i,o,a);l.level="error",Ef(l,{originalException:c,mechanism:{handled:!1,type:"auto.browser.global_handlers.onerror"}})})}function tb(t){H_(e=>{const{stackParser:n,attachStacktrace:s}=Vf();if(Ae()!==t||$f())return;const r=nb(e),i=ao(r)?sb(r):Wc(n,r,void 0,s,!0);i.level="error",Ef(i,{originalException:r,mechanism:{handled:!1,type:"auto.browser.global_handlers.onunhandledrejection"}})})}function nb(t){if(ao(t))return t;try{if("reason"in t)return t.reason;if("detail"in t&&"reason"in t.detail)return t.detail.reason}catch{}return t}function sb(t){return{exception:{values:[{type:"UnhandledRejection",value:`Non-Error promise rejection captured with value: ${String(t)}`}]}}}function rb(t,e,n,s){const r=t.exception=t.exception||{},i=r.values=r.values||[],o=i[0]=i[0]||{},a=o.stacktrace=o.stacktrace||{},c=a.frames=a.frames||[],l=s,u=n,d=ib(e)??Dc();return c.length===0&&c.push({colno:l,filename:d,function:Tn,in_app:!0,lineno:u}),t}function fd(t){ho&&b.log(`Global Handler attached: ${t}`)}function Vf(){return Ae()?.getOptions()||{stackParser:()=>[],attachStacktrace:!1}}function ib(t){if(!(!bt(t)||t.length===0)){if(t.startsWith("data:")){const e=t.match(/^data:([^;]+)/),n=e?e[1]:"text/javascript",s=t.includes("base64,");return`<data:${n}${s?",base64":""}>`}return t}}const ob=()=>({name:"HttpContext",preprocessEvent(t){if(!te.navigator&&!te.location&&!te.document)return;const e=Hw(),n={...e.headers,...t.request?.headers};t.request={...e,...t.request,headers:n}}}),ab="cause",cb=5,lb="LinkedErrors",ub=((t={})=>{const e=t.limit||cb,n=t.key||ab;return{name:lb,preprocessEvent(s,r,i){const o=i.getOptions();bw(Bc,o.stackParser,n,e,s,r)}}}),db=ub;function hb(){return fb()?(ho&&Ss(()=>{console.error("[Sentry] You cannot use Sentry.init() in a browser extension, see: https://docs.sentry.io/platforms/javascript/best-practices/browser-extensions/")}),!0):!1}function fb(){if(typeof te.window>"u")return!1;const t=te;if(t.nw||!(t.chrome||t.browser)?.runtime?.id)return!1;const n=Dc(),s=["chrome-extension","moz-extension","ms-browser-extension","safari-web-extension"];return!(te===te.top&&s.some(i=>n.startsWith(`${i}://`)))}function pb(t){return[pw(),uw(),jE(),OE(),ZE(),db(),Rw(),ob(),JE()]}function gb(t={}){const e=!t.skipBrowserExtensionCheck&&hb();let n=t.defaultIntegrations==null?pb():t.defaultIntegrations;const s={...t,enabled:e?!1:t.enabled,stackParser:F_(t.stackParser||NE),integrations:Ov({integrations:t.integrations,defaultIntegrations:n}),transport:t.transport||mE};return Jv(Zw,s)}const mb="https://adc1b5518c6a55273a1398d1b8b9cd3e@o4510415124496384.ingest.de.sentry.io/4510415129083984";gb({dsn:mb,sendDefaultPii:!0});/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g=function(t,e){if(!t)throw ks(e)},ks=function(t){return new Error("Firebase Database ("+jf.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wb(t){return Gf(void 0,t)}function Gf(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const n=e;return new Date(n.getTime());case Object:t===void 0&&(t={});break;case Array:t=[];break;default:return e}for(const n in e)!e.hasOwnProperty(n)||!Eb(n)||(t[n]=Gf(t[n],e[n]));return t}function Eb(t){return t!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bb=()=>Yf().__FIREBASE_DEFAULTS__,Cb=()=>{if(typeof process>"u"||typeof pd>"u")return;const t=pd.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},Sb=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&Ti(t[1]);return e&&JSON.parse(e)},Vc=()=>{try{return _b()||bb()||Cb()||Sb()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},Kf=t=>Vc()?.emulatorHosts?.[t],Tb=t=>{const e=Kf(t);if(!e)return;const n=e.lastIndexOf(":");if(n<=0||n+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const s=parseInt(e.substring(n+1),10);return e[0]==="["?[e.substring(1,n-1),s]:[e.substring(0,n),s]},Jf=()=>Vc()?.config,Xf=t=>Vc()?.[`_${t}`];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rs(t){try{return(t.startsWith("http://")||t.startsWith("https://")?new URL(t).hostname:t).endsWith(".cloudworkstations.dev")}catch{return!1}}async function Qf(t){return(await fetch(t,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Re(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function jc(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Re())}function Ab(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Nb(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function ep(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Pb(){const t=Re();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function Lb(){return jf.NODE_ADMIN===!0}function qc(){try{return typeof indexedDB=="object"}catch{return!1}}function Ob(){return new Promise((t,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(s);r.onsuccess=()=>{r.result.close(),n||self.indexedDB.deleteDatabase(s),t(!0)},r.onupgradeneeded=()=>{n=!1},r.onerror=()=>{e(r.error?.message||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Db="FirebaseError";class an extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=Db,Object.setPrototypeOf(this,an.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,As.prototype.create)}}class As{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},r=`${this.service}/${e}`,i=this.errors[e],o=i?xb(i,s):"Error",a=`${this.serviceName}: ${o} (${r}).`;return new an(r,a,s)}}function xb(t,e){return t.replace(Mb,(n,s)=>{const r=e[s];return r!=null?String(r):`<${s}?>`})}const Mb=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fr(t){return JSON.parse(t)}function oe(t){return JSON.stringify(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tp=function(t){let e={},n={},s={},r="";try{const i=t.split(".");e=fr(Ti(i[0])||""),n=fr(Ti(i[1])||""),r=i[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:r}},Fb=function(t){const e=tp(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},Ub=function(t){const e=tp(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var W;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(W||(W={}));const Zb={debug:W.DEBUG,verbose:W.VERBOSE,info:W.INFO,warn:W.WARN,error:W.ERROR,silent:W.SILENT},eC=W.INFO,tC={[W.DEBUG]:"log",[W.VERBOSE]:"log",[W.INFO]:"info",[W.WARN]:"warn",[W.ERROR]:"error"},nC=(t,e,...n)=>{if(e<t.logLevel)return;const s=new Date().toISOString(),r=tC[e];if(r)console[r](`[${s}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class go{constructor(e){this.name=e,this._logLevel=eC,this._logHandler=nC,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in W))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Zb[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,W.DEBUG,...e),this._logHandler(this,W.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,W.VERBOSE,...e),this._logHandler(this,W.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,W.INFO,...e),this._logHandler(this,W.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,W.WARN,...e),this._logHandler(this,W.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,W.ERROR,...e),this._logHandler(this,W.ERROR,...e)}}const sC=(t,e)=>e.some(n=>t instanceof n);let _d,yd;function rC(){return _d||(_d=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function iC(){return yd||(yd=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const np=new WeakMap,Wa=new WeakMap,sp=new WeakMap,ta=new WeakMap,zc=new WeakMap;function oC(t){const e=new Promise((n,s)=>{const r=()=>{t.removeEventListener("success",i),t.removeEventListener("error",o)},i=()=>{n(qt(t.result)),r()},o=()=>{s(t.error),r()};t.addEventListener("success",i),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&np.set(n,t)}).catch(()=>{}),zc.set(e,t),e}function aC(t){if(Wa.has(t))return;const e=new Promise((n,s)=>{const r=()=>{t.removeEventListener("complete",i),t.removeEventListener("error",o),t.removeEventListener("abort",o)},i=()=>{n(),r()},o=()=>{s(t.error||new DOMException("AbortError","AbortError")),r()};t.addEventListener("complete",i),t.addEventListener("error",o),t.addEventListener("abort",o)});Wa.set(t,e)}let Va={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return Wa.get(t);if(e==="objectStoreNames")return t.objectStoreNames||sp.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return qt(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function cC(t){Va=t(Va)}function lC(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const s=t.call(na(this),e,...n);return sp.set(s,e.sort?e.sort():[e]),qt(s)}:iC().includes(t)?function(...e){return t.apply(na(this),e),qt(np.get(this))}:function(...e){return qt(t.apply(na(this),e))}}function uC(t){return typeof t=="function"?lC(t):(t instanceof IDBTransaction&&aC(t),sC(t,rC())?new Proxy(t,Va):t)}function qt(t){if(t instanceof IDBRequest)return oC(t);if(ta.has(t))return ta.get(t);const e=uC(t);return e!==t&&(ta.set(t,e),zc.set(e,t)),e}const na=t=>zc.get(t);function dC(t,e,{blocked:n,upgrade:s,blocking:r,terminated:i}={}){const o=indexedDB.open(t,e),a=qt(o);return s&&o.addEventListener("upgradeneeded",c=>{s(qt(o.result),c.oldVersion,c.newVersion,qt(o.transaction),c)}),n&&o.addEventListener("blocked",c=>n(c.oldVersion,c.newVersion,c)),a.then(c=>{i&&c.addEventListener("close",()=>i()),r&&c.addEventListener("versionchange",l=>r(l.oldVersion,l.newVersion,l))}).catch(()=>{}),a}const hC=["get","getKey","getAll","getAllKeys","count"],fC=["put","add","delete","clear"],sa=new Map;function vd(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(sa.get(e))return sa.get(e);const n=e.replace(/FromIndex$/,""),s=e!==n,r=fC.includes(n);if(!(n in(s?IDBIndex:IDBObjectStore).prototype)||!(r||hC.includes(n)))return;const i=async function(o,...a){const c=this.transaction(o,r?"readwrite":"readonly");let l=c.store;return s&&(l=l.index(a.shift())),(await Promise.all([l[n](...a),r&&c.done]))[0]};return sa.set(e,i),i}cC(t=>({...t,get:(e,n,s)=>vd(e,n)||t.get(e,n,s),has:(e,n)=>!!vd(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pC{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(gC(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function gC(t){return t.getComponent()?.type==="VERSION"}const ja="@firebase/app",wd="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qa="[DEFAULT]",VC={[ja]:"fire-core",[mC]:"fire-core-compat",[yC]:"fire-analytics",[_C]:"fire-analytics-compat",[wC]:"fire-app-check",[vC]:"fire-app-check-compat",[EC]:"fire-auth",[bC]:"fire-auth-compat",[CC]:"fire-rtdb",[SC]:"fire-data-connect",[TC]:"fire-rtdb-compat",[IC]:"fire-fn",[kC]:"fire-fn-compat",[RC]:"fire-iid",[AC]:"fire-iid-compat",[NC]:"fire-fcm",[PC]:"fire-fcm-compat",[LC]:"fire-perf",[OC]:"fire-perf-compat",[DC]:"fire-rc",[xC]:"fire-rc-compat",[MC]:"fire-gcs",[FC]:"fire-gcs-compat",[UC]:"fire-fst",[BC]:"fire-fst-compat",[$C]:"fire-vertex","fire-js":"fire-js",[HC]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ps=WC;function rp(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s={name:qa,automaticDataCollectionEnabled:!0,...e},r=s.name;if(typeof r!="string"||!r)throw zt.create("bad-app-name",{appName:String(r)});if(n||(n=Jf()),!n)throw zt.create("no-options");const i=Ri.get(r);if(i){if(Rn(n,i.options)&&Rn(s,i.config))return i;throw zt.create("duplicate-app",{appName:r})}const o=new Qb(r);for(const c of za.values())o.addComponent(c);const a=new zC(n,s,o);return Ri.set(r,a),a}function Gc(t=qa){const e=Ri.get(t);if(!e&&t===qa&&Jf())return rp();if(!e)throw zt.create("no-app",{appName:t});return e}function St(t,e,n){let s=VC[t]??t;n&&(s+=`-${n}`);const r=s.match(/\s|\//),i=e.match(/\s|\//);if(r||i){const o=[`Unable to register library "${s}" with version "${e}":`];r&&o.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&i&&o.push("and"),i&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),At.warn(o.join(" "));return}Zt(new Rt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const GC="firebase-heartbeat-database",YC=1,pr="firebase-heartbeat-store";let ra=null;function ip(){return ra||(ra=dC(GC,YC,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(pr)}catch(n){console.warn(n)}}}}).catch(t=>{throw zt.create("idb-open",{originalErrorMessage:t.message})})),ra}async function KC(t){try{const n=(await ip()).transaction(pr),s=await n.objectStore(pr).get(op(t));return await n.done,s}catch(e){if(e instanceof an)At.warn(e.message);else{const n=zt.create("idb-get",{originalErrorMessage:e?.message});At.warn(n.message)}}}async function bd(t,e){try{const s=(await ip()).transaction(pr,"readwrite");await s.objectStore(pr).put(e,op(t)),await s.done}catch(n){if(n instanceof an)At.warn(n.message);else{const s=zt.create("idb-set",{originalErrorMessage:n?.message});At.warn(s.message)}}}function op(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JC=1024,XC=30;class QC{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new eS(n),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){try{const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=Cd();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(r=>r.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:n}),this._heartbeatsCache.heartbeats.length>XC){const r=tS(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){At.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Cd(),{heartbeatsToSend:n,unsentEntries:s}=ZC(this._heartbeatsCache.heartbeats),r=Si(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(e){return At.warn(e),""}}}function Cd(){return new Date().toISOString().substring(0,10)}function ZC(t,e=JC){const n=[];let s=t.slice();for(const r of t){const i=n.find(o=>o.agent===r.agent);if(i){if(i.dates.push(r.date),Sd(n)>e){i.dates.pop();break}}else if(n.push({agent:r.agent,dates:[r.date]}),Sd(n)>e){n.pop();break}s=s.slice(1)}return{heartbeatsToSend:n,unsentEntries:s}}class eS{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return qc()?Ob().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await KC(this.app);return n?.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return bd(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return bd(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function Sd(t){return Si(JSON.stringify({version:2,heartbeats:t})).length}function tS(t){if(t.length===0)return-1;let e=0,n=t[0].date;for(let s=1;s<t.length;s++)t[s].date<n&&(n=t[s].date,e=s);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nS(t){Zt(new Rt("platform-logger",e=>new pC(e),"PRIVATE")),Zt(new Rt("heartbeat",e=>new QC(e),"PRIVATE")),St(ja,wd,t),St(ja,wd,"esm2020"),St("fire-js","")}nS("");var Td={};const Id="@firebase/database",kd="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lp=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new sS(e)}}catch{}return new rS},yn=lp("localStorage"),iS=lp("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ia={},oa={};function Jc(t){const e=t.toString();return ia[e]||(ia[e]=new ES),ia[e]}function bS(t,e){const n=t.toString();return oa[n]||(oa[n]=e()),oa[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class CS{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,n){this.closeAfterResponse=e,this.onClose=n,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,n){for(this.pendingResponses[e]=n;this.pendingResponses[this.currentResponseNum];){const s=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let r=0;r<s.length;++r)s[r]&&Ls(()=>{this.onMessage_(s[r])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nd="start",SS="close",TS="pLPCommand",IS="pRTLPCB",Sp="id",Tp="pw",Ip="ser",kS="cb",RS="seg",AS="ts",NS="d",PS="dframe",kp=1870,Rp=30,LS=kp-Rp,OS=25e3,DS=3e4;class Gn{constructor(e,n,s,r,i,o,a){this.connId=e,this.repoInfo=n,this.applicationId=s,this.appCheckToken=r,this.authToken=i,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=Fr(e),this.stats_=Jc(n),this.urlFn=c=>(this.appCheckToken&&(c[Ya]=this.appCheckToken),Cp(n,Ep,c))}open(e,n){this.curSegmentNum=0,this.onDisconnect_=n,this.myPacketOrderer=new CS(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(DS)),lS(()=>{if(this.isClosed_)return;this.scriptTagHolder=new Xc((...i)=>{const[o,a,c,l,u]=i;if(this.incrementIncomingBytes_(i),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===Nd)this.id=a,this.password=c;else if(o===SS)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...i)=>{const[o,a]=i;this.incrementIncomingBytes_(i),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const s={};s[Nd]="t",s[Ip]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(s[kS]=this.scriptTagHolder.uniqueCallbackIdentifier),s[fp]=Kc,this.transportSessionId&&(s[pp]=this.transportSessionId),this.lastSessionId&&(s[yp]=this.lastSessionId),this.applicationId&&(s[vp]=this.applicationId),this.appCheckToken&&(s[Ya]=this.appCheckToken),typeof location<"u"&&location.hostname&&_p.test(location.hostname)&&(s[gp]=mp);const r=this.urlFn(s);this.log_("Connecting via long-poll to "+r),this.scriptTagHolder.addTag(r,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){Gn.forceAllow_=!0}static forceDisallow(){Gn.forceDisallow_=!0}static isAvailable(){return Gn.forceAllow_?!0:!Gn.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!dS()&&!hS()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const n=oe(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const s=zf(n),r=dp(s,LS);for(let i=0;i<r.length;i++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,r.length,r[i]),this.curSegmentNum++}addDisconnectPingFrame(e,n){this.myDisconnFrame=document.createElement("iframe");const s={};s[PS]="t",s[Sp]=e,s[Tp]=n,this.myDisconnFrame.src=this.urlFn(s),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const n=oe(e).length;this.bytesReceived+=n,this.stats_.incrementCounter("bytes_received",n)}}class Xc{constructor(e,n,s,r){this.onDisconnect=s,this.urlFn=r,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=oS(),window[TS+this.uniqueCallbackIdentifier]=e,window[IS+this.uniqueCallbackIdentifier]=n,this.myIFrame=Xc.createIFrame_();let i="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(i='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+i+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){he("frame writing exception"),a.stack&&he(a.stack),he(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||he("No IE domain setting required")}catch{const s=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+s+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,n){for(this.myID=e,this.myPW=n,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Sp]=this.myID,e[Tp]=this.myPW,e[Ip]=this.currentSerial;let n=this.urlFn(e),s="",r=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Rp+s.length<=kp;){const o=this.pendingSegs.shift();s=s+"&"+RS+r+"="+o.seg+"&"+AS+r+"="+o.ts+"&"+NS+r+"="+o.d,r++}return n=n+s,this.addLongPollTag_(n,this.currentSerial),!0}else return!1}enqueueSegment(e,n,s){this.pendingSegs.push({seg:e,ts:n,d:s}),this.alive&&this.newRequest_()}addLongPollTag_(e,n){this.outstandingRequests.add(n);const s=()=>{this.outstandingRequests.delete(n),this.newRequest_()},r=setTimeout(s,Math.floor(OS)),i=()=>{clearTimeout(r),s()};this.addTag(e,i)}addTag(e,n){setTimeout(()=>{try{if(!this.sendNewPolls)return;const s=this.myIFrame.doc.createElement("script");s.type="text/javascript",s.async=!0,s.src=e,s.onload=s.onreadystatechange=function(){const r=s.readyState;(!r||r==="loaded"||r==="complete")&&(s.onload=s.onreadystatechange=null,s.parentNode&&s.parentNode.removeChild(s),n())},s.onerror=()=>{he("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(s)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gr{static get ALL_TRANSPORTS(){return[Gn,Ye]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const n=Ye&&Ye.isAvailable();let s=n&&!Ye.previouslyFailed();if(e.webSocketOnly&&(n||ke("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),s=!0),s)this.transports_=[Ye];else{const r=this.transports_=[];for(const i of gr.ALL_TRANSPORTS)i&&i.isAvailable()&&r.push(i);gr.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}gr.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FS=6e4,US=5e3,$S=10*1024,BS=100*1024,aa="t",Pd="d",HS="s",Ld="r",WS="e",Od="o",Dd="a",xd="n",Md="p",VS="h";class jS{constructor(e,n,s,r,i,o,a,c,l,u){this.id=e,this.repoInfo_=n,this.applicationId_=s,this.appCheckToken_=r,this.authToken_=i,this.onMessage_=o,this.onReady_=a,this.onDisconnect_=c,this.onKill_=l,this.lastSessionId=u,this.connectionCount=0,this.pendingDataMessages=[],this.state_=0,this.log_=Fr("c:"+this.id+":"),this.transportManager_=new gr(n),this.log_("Connection created"),this.start_()}start_(){const e=this.transportManager_.initialTransport();this.conn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,null,this.lastSessionId),this.primaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const n=this.connReceiver_(this.conn_),s=this.disconnReceiver_(this.conn_);this.tx_=this.conn_,this.rx_=this.conn_,this.secondaryConn_=null,this.isHealthy_=!1,setTimeout(()=>{this.conn_&&this.conn_.open(n,s)},Math.floor(0));const r=e.healthyTimeout||0;r>0&&(this.healthyTimeout_=Qs(()=>{this.healthyTimeout_=null,this.isHealthy_||(this.conn_&&this.conn_.bytesReceived>BS?(this.log_("Connection exceeded healthy timeout but has received "+this.conn_.bytesReceived+" bytes.  Marking connection healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()):this.conn_&&this.conn_.bytesSent>$S?this.log_("Connection exceeded healthy timeout but has sent "+this.conn_.bytesSent+" bytes.  Leaving connection alive."):(this.log_("Closing unhealthy connection after timeout."),this.close()))},Math.floor(r)))}nextTransportId_(){return"c:"+this.id+":"+this.connectionCount++}disconnReceiver_(e){return n=>{e===this.conn_?this.onConnectionLost_(n):e===this.secondaryConn_?(this.log_("Secondary connection lost."),this.onSecondaryConnectionLost_()):this.log_("closing an old connection")}}connReceiver_(e){return n=>{this.state_!==2&&(e===this.rx_?this.onPrimaryMessageReceived_(n):e===this.secondaryConn_?this.onSecondaryMessageReceived_(n):this.log_("message on old connection"))}}sendRequest(e){const n={t:"d",d:e};this.sendData_(n)}tryCleanupConnection(){this.tx_===this.secondaryConn_&&this.rx_===this.secondaryConn_&&(this.log_("cleaning up and promoting a connection: "+this.secondaryConn_.connId),this.conn_=this.secondaryConn_,this.secondaryConn_=null)}onSecondaryControl_(e){if(aa in e){const n=e[aa];n===Dd?this.upgradeIfSecondaryHealthy_():n===Ld?(this.log_("Got a reset on secondary, closing it"),this.secondaryConn_.close(),(this.tx_===this.secondaryConn_||this.rx_===this.secondaryConn_)&&this.close()):n===Od&&(this.log_("got pong on secondary."),this.secondaryResponsesRequired_--,this.upgradeIfSecondaryHealthy_())}}onSecondaryMessageReceived_(e){const n=Hs("t",e),s=Hs("d",e);if(n==="c")this.onSecondaryControl_(s);else if(n==="d")this.pendingDataMessages.push(s);else throw new Error("Unknown protocol layer: "+n)}upgradeIfSecondaryHealthy_(){this.secondaryResponsesRequired_<=0?(this.log_("Secondary connection is healthy."),this.isHealthy_=!0,this.secondaryConn_.markConnectionHealthy(),this.proceedWithUpgrade_()):(this.log_("sending ping on secondary."),this.secondaryConn_.send({t:"c",d:{t:Md,d:{}}}))}proceedWithUpgrade_(){this.secondaryConn_.start(),this.log_("sending client ack on secondary"),this.secondaryConn_.send({t:"c",d:{t:Dd,d:{}}}),this.log_("Ending transmission on primary"),this.conn_.send({t:"c",d:{t:xd,d:{}}}),this.tx_=this.secondaryConn_,this.tryCleanupConnection()}onPrimaryMessageReceived_(e){const n=Hs("t",e),s=Hs("d",e);n==="c"?this.onControl_(s):n==="d"&&this.onDataMessage_(s)}onDataMessage_(e){this.onPrimaryResponse_(),this.onMessage_(e)}onPrimaryResponse_(){this.isHealthy_||(this.primaryResponsesRequired_--,this.primaryResponsesRequired_<=0&&(this.log_("Primary connection is healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()))}onControl_(e){const n=Hs(aa,e);if(Pd in e){const s=e[Pd];if(n===VS){const r={...s};this.repoInfo_.isUsingEmulator&&(r.h=this.repoInfo_.host),this.onHandshake_(r)}else if(n===xd){this.log_("recvd end transmission on primary"),this.rx_=this.secondaryConn_;for(let r=0;r<this.pendingDataMessages.length;++r)this.onDataMessage_(this.pendingDataMessages[r]);this.pendingDataMessages=[],this.tryCleanupConnection()}else n===HS?this.onConnectionShutdown_(s):n===Ld?this.onReset_(s):n===WS?Ga("Server Error: "+s):n===Od?(this.log_("got pong on primary."),this.onPrimaryResponse_(),this.sendPingOnPrimaryIfNecessary_()):Ga("Unknown control packet command: "+n)}}onHandshake_(e){const n=e.ts,s=e.v,r=e.h;this.sessionId=e.s,this.repoInfo_.host=r,this.state_===0&&(this.conn_.start(),this.onConnectionEstablished_(this.conn_,n),Kc!==s&&ke("Protocol version mismatch detected"),this.tryStartUpgrade_())}tryStartUpgrade_(){const e=this.transportManager_.upgradeTransport();e&&this.startUpgrade_(e)}startUpgrade_(e){this.secondaryConn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,this.sessionId),this.secondaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const n=this.connReceiver_(this.secondaryConn_),s=this.disconnReceiver_(this.secondaryConn_);this.secondaryConn_.open(n,s),Qs(()=>{this.secondaryConn_&&(this.log_("Timed out trying to upgrade."),this.secondaryConn_.close())},Math.floor(FS))}onReset_(e){this.log_("Reset packet received.  New host: "+e),this.repoInfo_.host=e,this.state_===1?this.close():(this.closeConnections_(),this.start_())}onConnectionEstablished_(e,n){this.log_("Realtime connection established."),this.conn_=e,this.state_=1,this.onReady_&&(this.onReady_(n,this.sessionId),this.onReady_=null),this.primaryResponsesRequired_===0?(this.log_("Primary connection is healthy."),this.isHealthy_=!0):Qs(()=>{this.sendPingOnPrimaryIfNecessary_()},Math.floor(US))}sendPingOnPrimaryIfNecessary_(){!this.isHealthy_&&this.state_===1&&(this.log_("sending ping on primary."),this.sendData_({t:"c",d:{t:Md,d:{}}}))}onSecondaryConnectionLost_(){const e=this.secondaryConn_;this.secondaryConn_=null,(this.tx_===e||this.rx_===e)&&this.close()}onConnectionLost_(e){this.conn_=null,!e&&this.state_===0?(this.log_("Realtime connection failed."),this.repoInfo_.isCacheableHost()&&(yn.remove("host:"+this.repoInfo_.host),this.repoInfo_.internalHost=this.repoInfo_.host)):this.state_===1&&this.log_("Realtime connection lost."),this.close()}onConnectionShutdown_(e){this.log_("Connection shutdown command received. Shutting down..."),this.onKill_&&(this.onKill_(e),this.onKill_=null),this.onDisconnect_=null,this.close()}sendData_(e){if(this.state_!==1)throw"Connection is not connected";this.tx_.send(e)}close(){this.state_!==2&&(this.log_("Closing realtime connection."),this.state_=2,this.closeConnections_(),this.onDisconnect_&&(this.onDisconnect_(),this.onDisconnect_=null))}closeConnections_(){this.log_("Shutting down all connections"),this.conn_&&(this.conn_.close(),this.conn_=null),this.secondaryConn_&&(this.secondaryConn_.close(),this.secondaryConn_=null),this.healthyTimeout_&&(clearTimeout(this.healthyTimeout_),this.healthyTimeout_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fd=32,Ud=768;class H{constructor(e,n){if(n===void 0){this.pieces_=e.split("/");let s=0;for(let r=0;r<this.pieces_.length;r++)this.pieces_[r].length>0&&(this.pieces_[s]=this.pieces_[r],s++);this.pieces_.length=s,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=n}toString(){let e="";for(let n=this.pieceNum_;n<this.pieces_.length;n++)this.pieces_[n]!==""&&(e+="/"+this.pieces_[n]);return e||"/"}}function F(){return new H("")}function N(t){return t.pieceNum_>=t.pieces_.length?null:t.pieces_[t.pieceNum_]}function en(t){return t.pieces_.length-t.pieceNum_}function j(t){let e=t.pieceNum_;return e<t.pieces_.length&&e++,new H(t.pieces_,e)}function Qc(t){return t.pieceNum_<t.pieces_.length?t.pieces_[t.pieces_.length-1]:null}function qS(t){let e="";for(let n=t.pieceNum_;n<t.pieces_.length;n++)t.pieces_[n]!==""&&(e+="/"+encodeURIComponent(String(t.pieces_[n])));return e||"/"}function mr(t,e=0){return t.pieces_.slice(t.pieceNum_+e)}function Pp(t){if(t.pieceNum_>=t.pieces_.length)return null;const e=[];for(let n=t.pieceNum_;n<t.pieces_.length-1;n++)e.push(t.pieces_[n]);return new H(e,0)}function X(t,e){const n=[];for(let s=t.pieceNum_;s<t.pieces_.length;s++)n.push(t.pieces_[s]);if(e instanceof H)for(let s=e.pieceNum_;s<e.pieces_.length;s++)n.push(e.pieces_[s]);else{const s=e.split("/");for(let r=0;r<s.length;r++)s[r].length>0&&n.push(s[r])}return new H(n,0)}function L(t){return t.pieceNum_>=t.pieces_.length}function Te(t,e){const n=N(t),s=N(e);if(n===null)return e;if(n===s)return Te(j(t),j(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+t+")")}function zS(t,e){const n=mr(t,0),s=mr(e,0);for(let r=0;r<n.length&&r<s.length;r++){const i=Hn(n[r],s[r]);if(i!==0)return i}return n.length===s.length?0:n.length<s.length?-1:1}function Zc(t,e){if(en(t)!==en(e))return!1;for(let n=t.pieceNum_,s=e.pieceNum_;n<=t.pieces_.length;n++,s++)if(t.pieces_[n]!==e.pieces_[s])return!1;return!0}function Ue(t,e){let n=t.pieceNum_,s=e.pieceNum_;if(en(t)>en(e))return!1;for(;n<t.pieces_.length;){if(t.pieces_[n]!==e.pieces_[s])return!1;++n,++s}return!0}class GS{constructor(e,n){this.errorPrefix_=n,this.parts_=mr(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let s=0;s<this.parts_.length;s++)this.byteLength_+=po(this.parts_[s]);Lp(this)}}function YS(t,e){t.parts_.length>0&&(t.byteLength_+=1),t.parts_.push(e),t.byteLength_+=po(e),Lp(t)}function KS(t){const e=t.parts_.pop();t.byteLength_-=po(e),t.parts_.length>0&&(t.byteLength_-=1)}function Lp(t){if(t.byteLength_>Ud)throw new Error(t.errorPrefix_+"has a key path longer than "+Ud+" bytes ("+t.byteLength_+").");if(t.parts_.length>Fd)throw new Error(t.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Fd+") or object contains a cycle "+gn(t))}function gn(t){return t.parts_.length===0?"":"in property '"+t.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _o{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const s=new O(gs,e),r=new O(gs,n);return this.compare(s,r)!==0}minPost(){return O.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tT(t,e){return Hn(t.name,e.name)}function tl(t,e){return Hn(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ka;function nT(t){Ka=t}const Dp=function(t){return typeof t=="number"?"number:"+hp(t):"string:"+t},xp=function(t){if(t.isLeafNode()){const e=t.val();g(typeof e=="string"||typeof e=="number"||typeof e=="object"&&pt(e,".sv"),"Priority must be a string or number.")}else g(t===Ka||t.isEmpty(),"priority of unexpected type.");g(t===Ka||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ca;const jn={};class _t{static get Default(){return g(jn&&Q,"ChildrenNode.ts has not been loaded"),ca=ca||new _t({".priority":jn},{".priority":Q}),ca}constructor(e,n){this.indexes_=e,this.indexSet_=n}get(e){const n=fs(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof Pe?n:null}hasIndex(e){return pt(this.indexSet_,e.toString())}addIndex(e,n){g(e!==Xn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let r=!1;const i=n.getIterator(O.Wrap);let o=i.getNext();for(;o;)r=r||e.isDefinedOn(o.node),s.push(o),o=i.getNext();let a;r?a=Pi(s,e.getCompare()):a=jn;const c=e.toString(),l={...this.indexSet_};l[c]=e;const u={...this.indexes_};return u[c]=a,new _t(u,l)}addToIndexes(e,n){const s=ki(this.indexes_,(r,i)=>{const o=fs(this.indexSet_,i);if(g(o,"Missing index implementation for "+i),r===jn)if(o.isDefinedOn(e.node)){const a=[],c=n.getIterator(O.Wrap);let l=c.getNext();for(;l;)l.name!==e.name&&a.push(l),l=c.getNext();return a.push(e),Pi(a,o.getCompare())}else return jn;else{const a=n.get(e.name);let c=r;return a&&(c=c.remove(new O(e.name,a))),c.insert(e,e.node)}});return new _t(s,this.indexSet_)}removeFromIndexes(e,n){const s=ki(this.indexes_,r=>{if(r===jn)return r;{const i=n.get(e.name);return i?r.remove(new O(e.name,i)):r}});return new _t(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uT extends _o{constructor(e){super(),this.indexPath_=e,g(!L(e)&&N(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,n){const s=this.extractChild(e.node),r=this.extractChild(n.node),i=s.compareTo(r);return i===0?Hn(e.name,n.name):i}makePost(e,n){const s=Z(e),r=E.EMPTY_NODE.updateChild(this.indexPath_,s);return new O(n,r)}maxPost(){const e=E.EMPTY_NODE.updateChild(this.indexPath_,Ur);return new O(An,e)}toString(){return mr(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dT extends _o{compare(e,n){const s=e.node.compareTo(n.node);return s===0?Hn(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return O.MIN}maxPost(){return O.MAX}makePost(e,n){const s=Z(e);return new O(n,s)}toString(){return".value"}}const hT=new dT;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Up(t){return{type:"value",snapshotNode:t}}function ms(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function _r(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function yr(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function fT(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nl{constructor(e){this.index_=e}updateChild(e,n,s,r,i,o){g(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(n);return a.getChild(r).equals(s.getChild(r))&&a.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(n)?o.trackChildChange(_r(n,a)):g(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(ms(n,s)):o.trackChildChange(yr(n,s,a))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(n,s).withIndex(this.index_)}updateFullNode(e,n,s){return s!=null&&(e.isLeafNode()||e.forEachChild(Q,(r,i)=>{n.hasChild(r)||s.trackChildChange(_r(r,i))}),n.isLeafNode()||n.forEachChild(Q,(r,i)=>{if(e.hasChild(r)){const o=e.getImmediateChild(r);o.equals(i)||s.trackChildChange(yr(r,i,o))}else s.trackChildChange(ms(r,i))})),n.withIndex(this.index_)}updatePriority(e,n){return e.isEmpty()?E.EMPTY_NODE:e.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oi(){return{value:null,children:new Map}}function Os(t,e,n){if(L(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=N(e);t.children.has(s)||t.children.set(s,Oi());const r=t.children.get(s);e=j(e),Os(r,e,n)}}function Ja(t,e){if(L(e))return t.value=null,t.children.clear(),!0;if(t.value!==null){if(t.value.isLeafNode())return!1;{const n=t.value;return t.value=null,n.forEachChild(Q,(s,r)=>{Os(t,new H(s),r)}),Ja(t,e)}}else if(t.children.size>0){const n=N(e);return e=j(e),t.children.has(n)&&Ja(t.children.get(n),e)&&t.children.delete(n),t.children.size===0}else return!0}function Xa(t,e,n){t.value!==null?n(e,t.value):_T(t,(s,r)=>{const i=new H(e.toString()+"/"+s);Xa(r,i,n)})}function _T(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jd=10*1e3,vT=30*1e3,wT=300*1e3;class ET{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new yT(e);const s=jd+(vT-jd)*Math.random();Qs(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;pe(e,(r,i)=>{i>0&&pt(this.statsToReport_,r)&&(n[r]=i,s=!0)}),s&&this.server_.reportStats(n),Qs(this.reportStats_.bind(this),Math.floor(Math.random()*2*wT))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ke;(function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(Ke||(Ke={}));function sl(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function rl(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function il(t){return{fromUser:!1,fromServer:!0,queryId:t,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Di{constructor(e,n,s){this.path=e,this.affectedTree=n,this.revert=s,this.type=Ke.ACK_USER_WRITE,this.source=sl()}operationForChild(e){if(L(this.path)){if(this.affectedTree.value!=null)return g(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new H(e));return new Di(F(),n,this.revert)}}else return g(N(this.path)===e,"operationForChild called for unrelated child."),new Di(j(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wr{constructor(e,n){this.source=e,this.path=n,this.type=Ke.LISTEN_COMPLETE}operationForChild(e){return L(this.path)?new wr(this.source,F()):new wr(this.source,j(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _s{constructor(e,n,s){this.source=e,this.path=n,this.children=s,this.type=Ke.MERGE}operationForChild(e){if(L(this.path)){const n=this.children.subtree(new H(e));return n.isEmpty()?null:n.value?new Nn(this.source,F(),n.value):new _s(this.source,F(),n)}else return g(N(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new _s(this.source,j(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bT{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function CT(t,e,n,s){const r=[],i=[];return e.forEach(o=>{o.type==="child_changed"&&t.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&i.push(fT(o.childName,o.snapshotNode))}),js(t,r,"child_removed",e,s,n),js(t,r,"child_added",e,s,n),js(t,r,"child_moved",i,s,n),js(t,r,"child_changed",e,s,n),js(t,r,"value",e,s,n),r}function js(t,e,n,s,r,i){const o=s.filter(a=>a.type===n);o.sort((a,c)=>TT(t,a,c)),o.forEach(a=>{const c=ST(t,a,i);r.forEach(l=>{l.respondsTo(a.type)&&e.push(l.createEvent(c,t.query_))})})}function ST(t,e,n){return e.type==="value"||e.type==="child_removed"||(e.prevName=n.getPredecessorChildName(e.childName,e.snapshotNode,t.index_)),e}function TT(t,e,n){if(e.childName==null||n.childName==null)throw ks("Should only compare child_ events.");const s=new O(e.childName,e.snapshotNode),r=new O(n.childName,n.snapshotNode);return t.index_.compare(s,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vo(t,e){return{eventCache:t,serverCache:e}}function Zs(t,e,n,s){return vo(new tn(e,n,s),t.serverCache)}function $p(t,e,n,s){return vo(t.eventCache,new tn(e,n,s))}function xi(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function Pn(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ze{constructor(e){this.writeTree_=e}static empty(){return new Ze(new G(null))}}function er(t,e,n){if(L(e))return new Ze(new G(n));{const s=t.writeTree_.findRootMostValueAndPath(e);if(s!=null){const r=s.path;let i=s.value;const o=Te(r,e);return i=i.updateChild(o,n),new Ze(t.writeTree_.set(r,i))}else{const r=new G(n),i=t.writeTree_.setTree(e,r);return new Ze(i)}}}function Qa(t,e,n){let s=t;return pe(n,(r,i)=>{s=er(s,X(e,r),i)}),s}function qd(t,e){if(L(e))return Ze.empty();{const n=t.writeTree_.setTree(e,new G(null));return new Ze(n)}}function Za(t,e){return Wn(t,e)!=null}function Wn(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(Te(n.path,e)):null}function zd(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(Q,(s,r)=>{e.push(new O(s,r))}):t.writeTree_.children.inorderTraversal((s,r)=>{r.value!=null&&e.push(new O(s,r.value))}),e}function Gt(t,e){if(L(e))return t;{const n=Wn(t,e);return n!=null?new Ze(new G(n)):new Ze(t.writeTree_.subtree(e))}}function ec(t){return t.writeTree_.isEmpty()}function ys(t,e){return Bp(F(),t.writeTree_,e)}function Bp(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let s=null;return e.children.inorderTraversal((r,i)=>{r===".priority"?(g(i.value!==null,"Priority writes must always be leaf nodes"),s=i.value):n=Bp(X(t,r),i,n)}),!n.getChild(t).isEmpty()&&s!==null&&(n=n.updateChild(X(t,".priority"),s)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wo(t,e){return jp(e,t)}function kT(t,e,n,s,r){g(s>t.lastWriteId,"Stacking an older write on top of newer ones"),r===void 0&&(r=!0),t.allWrites.push({path:e,snap:n,writeId:s,visible:r}),r&&(t.visibleWrites=er(t.visibleWrites,e,n)),t.lastWriteId=s}function RT(t,e,n,s){g(s>t.lastWriteId,"Stacking an older merge on top of newer ones"),t.allWrites.push({path:e,children:n,writeId:s,visible:!0}),t.visibleWrites=Qa(t.visibleWrites,e,n),t.lastWriteId=s}function AT(t,e){for(let n=0;n<t.allWrites.length;n++){const s=t.allWrites[n];if(s.writeId===e)return s}return null}function NT(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);g(n>=0,"removeWrite called with nonexistent writeId.");const s=t.allWrites[n];t.allWrites.splice(n,1);let r=s.visible,i=!1,o=t.allWrites.length-1;for(;r&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&PT(a,s.path)?r=!1:Ue(s.path,a.path)&&(i=!0)),o--}if(r){if(i)return LT(t),!0;if(s.snap)t.visibleWrites=qd(t.visibleWrites,s.path);else{const a=s.children;pe(a,c=>{t.visibleWrites=qd(t.visibleWrites,X(s.path,c))})}return!0}else return!1}function PT(t,e){if(t.snap)return Ue(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Ue(X(t.path,n),e))return!0;return!1}function LT(t){t.visibleWrites=Hp(t.allWrites,OT,F()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function OT(t){return t.visible}function Hp(t,e,n){let s=Ze.empty();for(let r=0;r<t.length;++r){const i=t[r];if(e(i)){const o=i.path;let a;if(i.snap)Ue(n,o)?(a=Te(n,o),s=er(s,a,i.snap)):Ue(o,n)&&(a=Te(o,n),s=er(s,F(),i.snap.getChild(a)));else if(i.children){if(Ue(n,o))a=Te(n,o),s=Qa(s,a,i.children);else if(Ue(o,n))if(a=Te(o,n),L(a))s=Qa(s,F(),i.children);else{const c=fs(i.children,N(a));if(c){const l=c.getChild(j(a));s=er(s,F(),l)}}}else throw ks("WriteRecord should have .snap or .children")}}return s}function Wp(t,e,n,s,r){if(!s&&!r){const i=Wn(t.visibleWrites,e);if(i!=null)return i;{const o=Gt(t.visibleWrites,e);if(ec(o))return n;if(n==null&&!Za(o,F()))return null;{const a=n||E.EMPTY_NODE;return ys(o,a)}}}else{const i=Gt(t.visibleWrites,e);if(!r&&ec(i))return n;if(!r&&n==null&&!Za(i,F()))return null;{const o=function(l){return(l.visible||r)&&(!s||!~s.indexOf(l.writeId))&&(Ue(l.path,e)||Ue(e,l.path))},a=Hp(t.allWrites,o,e),c=n||E.EMPTY_NODE;return ys(a,c)}}}function DT(t,e,n){let s=E.EMPTY_NODE;const r=Wn(t.visibleWrites,e);if(r)return r.isLeafNode()||r.forEachChild(Q,(i,o)=>{s=s.updateImmediateChild(i,o)}),s;if(n){const i=Gt(t.visibleWrites,e);return n.forEachChild(Q,(o,a)=>{const c=ys(Gt(i,new H(o)),a);s=s.updateImmediateChild(o,c)}),zd(i).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const i=Gt(t.visibleWrites,e);return zd(i).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function xT(t,e,n,s,r){g(s||r,"Either existingEventSnap or existingServerSnap must exist");const i=X(e,n);if(Za(t.visibleWrites,i))return null;{const o=Gt(t.visibleWrites,i);return ec(o)?r.getChild(n):ys(o,r.getChild(n))}}function MT(t,e,n,s){const r=X(e,n),i=Wn(t.visibleWrites,r);if(i!=null)return i;if(s.isCompleteForChild(n)){const o=Gt(t.visibleWrites,r);return ys(o,s.getNode().getImmediateChild(n))}else return null}function FT(t,e){return Wn(t.visibleWrites,e)}function UT(t,e,n,s,r,i,o){let a;const c=Gt(t.visibleWrites,e),l=Wn(c,F());if(l!=null)a=l;else if(n!=null)a=ys(c,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],d=o.getCompare(),h=i?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let f=h.getNext();for(;f&&u.length<r;)d(f,s)!==0&&u.push(f),f=h.getNext();return u}else return[]}function $T(){return{visibleWrites:Ze.empty(),allWrites:[],lastWriteId:-1}}function Mi(t,e,n,s){return Wp(t.writeTree,t.treePath,e,n,s)}function ol(t,e){return DT(t.writeTree,t.treePath,e)}function Gd(t,e,n,s){return xT(t.writeTree,t.treePath,e,n,s)}function Fi(t,e){return FT(t.writeTree,X(t.treePath,e))}function BT(t,e,n,s,r,i){return UT(t.writeTree,t.treePath,e,n,s,r,i)}function al(t,e,n){return MT(t.writeTree,t.treePath,e,n)}function Vp(t,e){return jp(X(t.treePath,e),t.writeTree)}function jp(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HT{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,s=e.childName;g(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),g(s!==".priority","Only non-priority child changes can be tracked.");const r=this.changeMap.get(s);if(r){const i=r.type;if(n==="child_added"&&i==="child_removed")this.changeMap.set(s,yr(s,e.snapshotNode,r.snapshotNode));else if(n==="child_removed"&&i==="child_added")this.changeMap.delete(s);else if(n==="child_removed"&&i==="child_changed")this.changeMap.set(s,_r(s,r.oldSnap));else if(n==="child_changed"&&i==="child_added")this.changeMap.set(s,ms(s,e.snapshotNode));else if(n==="child_changed"&&i==="child_changed")this.changeMap.set(s,yr(s,e.snapshotNode,r.oldSnap));else throw ks("Illegal combination of changes: "+e+" occurred after "+r)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class WT{getCompleteChild(e){return null}getChildAfterChild(e,n,s){return null}}const qp=new WT;class cl{constructor(e,n,s=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=s}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new tn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return al(this.writes_,e,s)}}getChildAfterChild(e,n,s){const r=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Pn(this.viewCache_),i=BT(this.writes_,r,n,1,s,e);return i.length===0?null:i[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $i;class Yp{constructor(){this.views=new Map}}function sI(t){g(!$i,"__referenceConstructor has already been defined"),$i=t}function rI(){return g($i,"Reference.ts has not been loaded"),$i}function iI(t){return t.views.size===0}function ll(t,e,n,s){const r=e.source.queryId;if(r!==null){const i=t.views.get(r);return g(i!=null,"SyncTree gave us an op for an invalid query."),Qd(i,e,n,s)}else{let i=[];for(const o of t.views.values())i=i.concat(Qd(o,e,n,s));return i}}function Kp(t,e,n,s,r){const i=e._queryIdentifier,o=t.views.get(i);if(!o){let a=Mi(n,r?s:null),c=!1;a?c=!0:s instanceof E?(a=ol(n,s),c=!1):(a=E.EMPTY_NODE,c=!1);const l=vo(new tn(a,c,!1),new tn(s,r,!1));return new XT(e,l)}return o}function oI(t,e,n,s,r,i){const o=Kp(t,e,s,r,i);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),tI(o,n),nI(o,n)}function aI(t,e,n,s){const r=e._queryIdentifier,i=[];let o=[];const a=nn(t);if(r==="default")for(const[c,l]of t.views.entries())o=o.concat(Xd(l,n,s)),Jd(l)&&(t.views.delete(c),l.query._queryParams.loadsAllData()||i.push(l.query));else{const c=t.views.get(r);c&&(o=o.concat(Xd(c,n,s)),Jd(c)&&(t.views.delete(r),c.query._queryParams.loadsAllData()||i.push(c.query)))}return a&&!nn(t)&&i.push(new(rI())(e._repo,e._path)),{removed:i,events:o}}function Jp(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function Yt(t,e){let n=null;for(const s of t.views.values())n=n||eI(s,e);return n}function Xp(t,e){if(e._queryParams.loadsAllData())return Eo(t);{const s=e._queryIdentifier;return t.views.get(s)}}function Qp(t,e){return Xp(t,e)!=null}function nn(t){return Eo(t)!=null}function Eo(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Bi;function cI(t){g(!Bi,"__referenceConstructor has already been defined"),Bi=t}function lI(){return g(Bi,"Reference.ts has not been loaded"),Bi}let uI=1;class Zd{constructor(e){this.listenProvider_=e,this.syncPointTree_=new G(null),this.pendingWriteTree_=$T(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Zp(t,e,n,s,r){return kT(t.pendingWriteTree_,e,n,s,r),r?Ds(t,new Nn(sl(),e,n)):[]}function dI(t,e,n,s){RT(t.pendingWriteTree_,e,n,s);const r=G.fromObject(n);return Ds(t,new _s(sl(),e,r))}function Bt(t,e,n=!1){const s=AT(t.pendingWriteTree_,e);if(NT(t.pendingWriteTree_,e)){let i=new G(null);return s.snap!=null?i=i.set(F(),!0):pe(s.children,o=>{i=i.set(new H(o),!0)}),Ds(t,new Di(s.path,i,n))}else return[]}function $r(t,e,n){return Ds(t,new Nn(rl(),e,n))}function hI(t,e,n){const s=G.fromObject(n);return Ds(t,new _s(rl(),e,s))}function fI(t,e){return Ds(t,new wr(rl(),e))}function pI(t,e,n){const s=dl(t,n);if(s){const r=hl(s),i=r.path,o=r.queryId,a=Te(i,e),c=new wr(il(o),a);return fl(t,i,c)}else return[]}function Hi(t,e,n,s,r=!1){const i=e._path,o=t.syncPointTree_.get(i);let a=[];if(o&&(e._queryIdentifier==="default"||Qp(o,e))){const c=aI(o,e,n,s);iI(o)&&(t.syncPointTree_=t.syncPointTree_.remove(i));const l=c.removed;if(a=c.events,!r){const u=l.findIndex(h=>h._queryParams.loadsAllData())!==-1,d=t.syncPointTree_.findOnPath(i,(h,f)=>nn(f));if(u&&!d){const h=t.syncPointTree_.subtree(i);if(!h.isEmpty()){const f=_I(h);for(let p=0;p<f.length;++p){const _=f[p],m=_.query,A=sg(t,_);t.listenProvider_.startListening(tr(m),Er(t,m),A.hashFn,A.onComplete)}}}!d&&l.length>0&&!s&&(u?t.listenProvider_.stopListening(tr(e),null):l.forEach(h=>{const f=t.queryToTagMap.get(bo(h));t.listenProvider_.stopListening(tr(h),f)}))}yI(t,l)}return a}function eg(t,e,n,s){const r=dl(t,s);if(r!=null){const i=hl(r),o=i.path,a=i.queryId,c=Te(o,e),l=new Nn(il(a),c,n);return fl(t,o,l)}else return[]}function gI(t,e,n,s){const r=dl(t,s);if(r){const i=hl(r),o=i.path,a=i.queryId,c=Te(o,e),l=G.fromObject(n),u=new _s(il(a),c,l);return fl(t,o,u)}else return[]}function sc(t,e,n,s=!1){const r=e._path;let i=null,o=!1;t.syncPointTree_.foreachOnPath(r,(h,f)=>{const p=Te(h,r);i=i||Yt(f,p),o=o||nn(f)});let a=t.syncPointTree_.get(r);a?(o=o||nn(a),i=i||Yt(a,F())):(a=new Yp,t.syncPointTree_=t.syncPointTree_.set(r,a));let c;i!=null?c=!0:(c=!1,i=E.EMPTY_NODE,t.syncPointTree_.subtree(r).foreachChild((f,p)=>{const _=Yt(p,F());_&&(i=i.updateImmediateChild(f,_))}));const l=Qp(a,e);if(!l&&!e._queryParams.loadsAllData()){const h=bo(e);g(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const f=vI();t.queryToTagMap.set(h,f),t.tagToQueryMap.set(f,h)}const u=wo(t.pendingWriteTree_,r);let d=oI(a,e,n,u,i,c);if(!l&&!o&&!s){const h=Xp(a,e);d=d.concat(wI(t,e,h))}return d}function ul(t,e,n){const r=t.pendingWriteTree_,i=t.syncPointTree_.findOnPath(e,(o,a)=>{const c=Te(o,e),l=Yt(a,c);if(l)return l});return Wp(r,e,i,n,!0)}function mI(t,e){const n=e._path;let s=null;t.syncPointTree_.foreachOnPath(n,(l,u)=>{const d=Te(l,n);s=s||Yt(u,d)});let r=t.syncPointTree_.get(n);r?s=s||Yt(r,F()):(r=new Yp,t.syncPointTree_=t.syncPointTree_.set(n,r));const i=s!=null,o=i?new tn(s,!0,!1):null,a=wo(t.pendingWriteTree_,e._path),c=Kp(r,e,a,i?o.getNode():E.EMPTY_NODE,i);return ZT(c)}function Ds(t,e){return tg(e,t.syncPointTree_,null,wo(t.pendingWriteTree_,F()))}function tg(t,e,n,s){if(L(t.path))return ng(t,e,n,s);{const r=e.get(F());n==null&&r!=null&&(n=Yt(r,F()));let i=[];const o=N(t.path),a=t.operationForChild(o),c=e.children.get(o);if(c&&a){const l=n?n.getImmediateChild(o):null,u=Vp(s,o);i=i.concat(tg(a,c,l,u))}return r&&(i=i.concat(ll(r,t,s,n))),i}}function ng(t,e,n,s){const r=e.get(F());n==null&&r!=null&&(n=Yt(r,F()));let i=[];return e.children.inorderTraversal((o,a)=>{const c=n?n.getImmediateChild(o):null,l=Vp(s,o),u=t.operationForChild(o);u&&(i=i.concat(ng(u,a,c,l)))}),r&&(i=i.concat(ll(r,t,s,n))),i}function sg(t,e){const n=e.query,s=Er(t,n);return{hashFn:()=>(QT(e)||E.EMPTY_NODE).hash(),onComplete:r=>{if(r==="ok")return s?pI(t,n._path,s):fI(t,n._path);{const i=fS(r,n);return Hi(t,n,null,i)}}}}function Er(t,e){const n=bo(e);return t.queryToTagMap.get(n)}function bo(t){return t._path.toString()+"$"+t._queryIdentifier}function dl(t,e){return t.tagToQueryMap.get(e)}function hl(t){const e=t.indexOf("$");return g(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new H(t.substr(0,e))}}function fl(t,e,n){const s=t.syncPointTree_.get(e);g(s,"Missing sync point for query tag that we're tracking");const r=wo(t.pendingWriteTree_,e);return ll(s,n,r,null)}function _I(t){return t.fold((e,n,s)=>{if(n&&nn(n))return[Eo(n)];{let r=[];return n&&(r=Jp(n)),pe(s,(i,o)=>{r=r.concat(o)}),r}})}function tr(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(lI())(t._repo,t._path):t}function yI(t,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const r=bo(s),i=t.queryToTagMap.get(r);t.queryToTagMap.delete(r),t.tagToQueryMap.delete(i)}}}function vI(){return uI++}function wI(t,e,n){const s=e._path,r=Er(t,e),i=sg(t,n),o=t.listenProvider_.startListening(tr(e),r,i.hashFn,i.onComplete),a=t.syncPointTree_.subtree(s);if(r)g(!nn(a.value),"If we're adding a query, it shouldn't be shadowed");else{const c=a.fold((l,u,d)=>{if(!L(l)&&u&&nn(u))return[Eo(u).query];{let h=[];return u&&(h=h.concat(Jp(u).map(f=>f.query))),pe(d,(f,p)=>{h=h.concat(p)}),h}});for(let l=0;l<c.length;++l){const u=c[l];t.listenProvider_.stopListening(tr(u),Er(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _l{constructor(e="",n=null,s={children:{},childCount:0}){this.name=e,this.parent=n,this.node=s}}function yl(t,e){let n=e instanceof H?e:new H(e),s=t,r=N(n);for(;r!==null;){const i=fs(s.node.children,r)||{children:{},childCount:0};s=new _l(r,s,i),n=j(n),r=N(n)}return s}function xs(t){return t.node.value}function og(t,e){t.node.value=e,rc(t)}function ag(t){return t.node.childCount>0}function SI(t){return xs(t)===void 0&&!ag(t)}function Co(t,e){pe(t.node.children,(n,s)=>{e(new _l(n,t,s))})}function cg(t,e,n,s){n&&e(t),Co(t,r=>{cg(r,e,!0)})}function TI(t,e,n){let s=t.parent;for(;s!==null;){if(e(s))return!0;s=s.parent}return!1}function Br(t){return new H(t.parent===null?t.name:Br(t.parent)+"/"+t.name)}function rc(t){t.parent!==null&&II(t.parent,t.name,t)}function II(t,e,n){const s=SI(n),r=pt(t.node.children,e);s&&r?(delete t.node.children[e],t.node.childCount--,rc(t)):!s&&!r&&(t.node.children[e]=n.node,t.node.childCount++,rc(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kI=/[\[\].#$\/\u0000-\u001F\u007F]/,RI=/[\[\].#$\u0000-\u001F\u007F]/,ua=10*1024*1024,vl=function(t){return typeof t=="string"&&t.length!==0&&!kI.test(t)},lg=function(t){return typeof t=="string"&&t.length!==0&&!RI.test(t)},AI=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),lg(t)},ug=function(t){return t===null||typeof t=="string"||typeof t=="number"&&!mo(t)||t&&typeof t=="object"&&pt(t,".sv")},Wi=function(t,e,n,s){s&&e===void 0||So(ps(t,"value"),e,n)},So=function(t,e,n){const s=n instanceof H?new GS(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+gn(s));if(typeof e=="function")throw new Error(t+"contains a function "+gn(s)+" with contents = "+e.toString());if(mo(e))throw new Error(t+"contains "+e.toString()+" "+gn(s));if(typeof e=="string"&&e.length>ua/3&&po(e)>ua)throw new Error(t+"contains a string greater than "+ua+" utf8 bytes "+gn(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let r=!1,i=!1;if(pe(e,(o,a)=>{if(o===".value")r=!0;else if(o!==".priority"&&o!==".sv"&&(i=!0,!vl(o)))throw new Error(t+" contains an invalid key ("+o+") "+gn(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);YS(s,o),So(t,a,s),KS(s)}),r&&i)throw new Error(t+' contains ".value" child '+gn(s)+" in addition to actual children.")}},NI=function(t,e){let n,s;for(n=0;n<e.length;n++){s=e[n];const i=mr(s);for(let o=0;o<i.length;o++)if(!(i[o]===".priority"&&o===i.length-1)){if(!vl(i[o]))throw new Error(t+"contains an invalid key ("+i[o]+") in path "+s.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(zS);let r=null;for(n=0;n<e.length;n++){if(s=e[n],r!==null&&Ue(r,s))throw new Error(t+"contains a path "+r.toString()+" that is ancestor of another path "+s.toString());r=s}},dg=function(t,e,n,s){const r=ps(t,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(r+" must be an object containing the children to replace.");const i=[];pe(e,(o,a)=>{const c=new H(o);if(So(r,a,X(n,c)),Qc(c)===".priority"&&!ug(a))throw new Error(r+"contains an invalid value for '"+c.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");i.push(c)}),NI(r,i)},PI=function(t,e,n){if(mo(e))throw new Error(ps(t,"priority")+"is "+e.toString()+", but must be a valid Firebase priority (a string, finite number, server value, or null).");if(!ug(e))throw new Error(ps(t,"priority")+"must be a valid Firebase priority (a string, finite number, server value, or null).")},wl=function(t,e,n,s){if(!lg(n))throw new Error(ps(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},LI=function(t,e,n,s){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),wl(t,e,n)},Ht=function(t,e){if(N(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},OI=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!vl(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!AI(n))throw new Error(ps(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DI{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function To(t,e){let n=null;for(let s=0;s<e.length;s++){const r=e[s],i=r.getPath();n!==null&&!Zc(i,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:i}),n.events.push(r)}n&&t.eventLists_.push(n)}function hg(t,e,n){To(t,n),fg(t,s=>Zc(s,e))}function We(t,e,n){To(t,n),fg(t,s=>Ue(s,e)||Ue(e,s))}function fg(t,e){t.recursionDepth_++;let n=!0;for(let s=0;s<t.eventLists_.length;s++){const r=t.eventLists_[s];if(r){const i=r.path;e(i)?(xI(t.eventLists_[s]),t.eventLists_[s]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function xI(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const s=n.getEventRunner();Xs&&he("event: "+n.toString()),Ls(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const MI="repo_interrupt",FI=25;class UI{constructor(e,n,s,r){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new DI,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Oi(),this.transactionQueueTree_=new _l,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function $I(t,e,n){if(t.stats_=Jc(t.repoInfo_),t.forceRestClient_||_S())t.server_=new Li(t.repoInfo_,(s,r,i,o)=>{th(t,s,r,i,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>nh(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{oe(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}t.persistentConnection_=new Tt(t.repoInfo_,e,(s,r,i,o)=>{th(t,s,r,i,o)},s=>{nh(t,s)},s=>{BI(t,s)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(s=>{t.server_.refreshAuthToken(s)}),t.appCheckProvider_.addTokenChangeListener(s=>{t.server_.refreshAppCheckToken(s.token)}),t.statsReporter_=bS(t.repoInfo_,()=>new ET(t.stats_,t.server_)),t.infoData_=new mT,t.infoSyncTree_=new Zd({startListening:(s,r,i,o)=>{let a=[];const c=t.infoData_.getNode(s._path);return c.isEmpty()||(a=$r(t.infoSyncTree_,s._path,c),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),El(t,"connected",!1),t.serverSyncTree_=new Zd({startListening:(s,r,i,o)=>(t.server_.listen(s,i,r,(a,c)=>{const l=o(a,c);We(t.eventQueue_,s._path,l)}),[]),stopListening:(s,r)=>{t.server_.unlisten(s,r)}})}function pg(t){const n=t.infoData_.getNode(new H(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Io(t){return EI({timestamp:pg(t)})}function th(t,e,n,s,r){t.dataUpdateCount++;const i=new H(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(r)if(s){const c=ki(n,l=>Z(l));o=gI(t.serverSyncTree_,i,c,r)}else{const c=Z(n);o=eg(t.serverSyncTree_,i,c,r)}else if(s){const c=ki(n,l=>Z(l));o=hI(t.serverSyncTree_,i,c)}else{const c=Z(n);o=$r(t.serverSyncTree_,i,c)}let a=i;o.length>0&&(a=vs(t,i)),We(t.eventQueue_,a,o)}function nh(t,e){El(t,"connected",e),e===!1&&jI(t)}function BI(t,e){pe(e,(n,s)=>{El(t,n,s)})}function El(t,e,n){const s=new H("/.info/"+e),r=Z(n);t.infoData_.updateSnapshot(s,r);const i=$r(t.infoSyncTree_,s,r);We(t.eventQueue_,s,i)}function bl(t){return t.nextWriteId_++}function HI(t,e,n){const s=mI(t.serverSyncTree_,e);return s!=null?Promise.resolve(s):t.server_.get(e).then(r=>{const i=Z(r).withIndex(e._queryParams.getIndex());sc(t.serverSyncTree_,e,n,!0);let o;if(e._queryParams.loadsAllData())o=$r(t.serverSyncTree_,e._path,i);else{const a=Er(t.serverSyncTree_,e);o=eg(t.serverSyncTree_,e._path,i,a)}return We(t.eventQueue_,e._path,o),Hi(t.serverSyncTree_,e,n,null,!0),i},r=>(Hr(t,"get for query "+oe(e)+" failed: "+r),Promise.reject(new Error(r))))}function WI(t,e,n,s,r){Hr(t,"set",{path:e.toString(),value:n,priority:s});const i=Io(t),o=Z(n,s),a=ul(t.serverSyncTree_,e),c=ig(o,a,i),l=bl(t),u=Zp(t.serverSyncTree_,e,c,l,!0);To(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(h,f)=>{const p=h==="ok";p||ke("set at "+e+" failed: "+h);const _=Bt(t.serverSyncTree_,l,!p);We(t.eventQueue_,e,_),sn(t,r,h,f)});const d=Sl(t,e);vs(t,d),We(t.eventQueue_,d,[])}function VI(t,e,n,s){Hr(t,"update",{path:e.toString(),value:n});let r=!0;const i=Io(t),o={};if(pe(n,(a,c)=>{r=!1,o[a]=rg(X(e,a),Z(c),t.serverSyncTree_,i)}),r)he("update() called with empty data.  Don't do anything."),sn(t,s,"ok",void 0);else{const a=bl(t),c=dI(t.serverSyncTree_,e,o,a);To(t.eventQueue_,c),t.server_.merge(e.toString(),n,(l,u)=>{const d=l==="ok";d||ke("update at "+e+" failed: "+l);const h=Bt(t.serverSyncTree_,a,!d),f=h.length>0?vs(t,e):e;We(t.eventQueue_,f,h),sn(t,s,l,u)}),pe(n,l=>{const u=Sl(t,X(e,l));vs(t,u)}),We(t.eventQueue_,e,[])}}function jI(t){Hr(t,"onDisconnectEvents");const e=Io(t),n=Oi();Xa(t.onDisconnect_,F(),(r,i)=>{const o=rg(r,i,t.serverSyncTree_,e);Os(n,r,o)});let s=[];Xa(n,F(),(r,i)=>{s=s.concat($r(t.serverSyncTree_,r,i));const o=Sl(t,r);vs(t,o)}),t.onDisconnect_=Oi(),We(t.eventQueue_,F(),s)}function qI(t,e,n){t.server_.onDisconnectCancel(e.toString(),(s,r)=>{s==="ok"&&Ja(t.onDisconnect_,e),sn(t,n,s,r)})}function sh(t,e,n,s){const r=Z(n);t.server_.onDisconnectPut(e.toString(),r.val(!0),(i,o)=>{i==="ok"&&Os(t.onDisconnect_,e,r),sn(t,s,i,o)})}function zI(t,e,n,s,r){const i=Z(n,s);t.server_.onDisconnectPut(e.toString(),i.val(!0),(o,a)=>{o==="ok"&&Os(t.onDisconnect_,e,i),sn(t,r,o,a)})}function GI(t,e,n,s){if(Ii(n)){he("onDisconnect().update() called with empty data.  Don't do anything."),sn(t,s,"ok",void 0);return}t.server_.onDisconnectMerge(e.toString(),n,(r,i)=>{r==="ok"&&pe(n,(o,a)=>{const c=Z(a);Os(t.onDisconnect_,X(e,o),c)}),sn(t,s,r,i)})}function YI(t,e,n){let s;N(e._path)===".info"?s=sc(t.infoSyncTree_,e,n):s=sc(t.serverSyncTree_,e,n),hg(t.eventQueue_,e._path,s)}function gg(t,e,n){let s;N(e._path)===".info"?s=Hi(t.infoSyncTree_,e,n):s=Hi(t.serverSyncTree_,e,n),hg(t.eventQueue_,e._path,s)}function KI(t){t.persistentConnection_&&t.persistentConnection_.interrupt(MI)}function Hr(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),he(n,...e)}function sn(t,e,n,s){e&&Ls(()=>{if(n==="ok")e(null);else{const r=(n||"error").toUpperCase();let i=r;s&&(i+=": "+s);const o=new Error(i);o.code=r,e(o)}})}function mg(t,e,n){return ul(t.serverSyncTree_,e,n)||E.EMPTY_NODE}function Cl(t,e=t.transactionQueueTree_){if(e||ko(t,e),xs(e)){const n=yg(t,e);g(n.length>0,"Sending zero length transaction queue"),n.every(r=>r.status===0)&&JI(t,Br(e),n)}else ag(e)&&Co(e,n=>{Cl(t,n)})}function JI(t,e,n){const s=n.map(l=>l.currentWriteId),r=mg(t,e,s);let i=r;const o=r.hash();for(let l=0;l<n.length;l++){const u=n[l];g(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const d=Te(e,u.path);i=i.updateChild(d,u.currentOutputSnapshotRaw)}const a=i.val(!0),c=e;t.server_.put(c.toString(),a,l=>{Hr(t,"transaction put response",{path:c.toString(),status:l});let u=[];if(l==="ok"){const d=[];for(let h=0;h<n.length;h++)n[h].status=2,u=u.concat(Bt(t.serverSyncTree_,n[h].currentWriteId)),n[h].onComplete&&d.push(()=>n[h].onComplete(null,!0,n[h].currentOutputSnapshotResolved)),n[h].unwatcher();ko(t,yl(t.transactionQueueTree_,e)),Cl(t,t.transactionQueueTree_),We(t.eventQueue_,e,u);for(let h=0;h<d.length;h++)Ls(d[h])}else{if(l==="datastale")for(let d=0;d<n.length;d++)n[d].status===3?n[d].status=4:n[d].status=0;else{ke("transaction at "+c.toString()+" failed: "+l);for(let d=0;d<n.length;d++)n[d].status=4,n[d].abortReason=l}vs(t,e)}},o)}function vs(t,e){const n=_g(t,e),s=Br(n),r=yg(t,n);return XI(t,r,s),s}function XI(t,e,n){if(e.length===0)return;const s=[];let r=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const c=e[a],l=Te(n,c.path);let u=!1,d;if(g(l!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)u=!0,d=c.abortReason,r=r.concat(Bt(t.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=FI)u=!0,d="maxretry",r=r.concat(Bt(t.serverSyncTree_,c.currentWriteId,!0));else{const h=mg(t,c.path,o);c.currentInputSnapshot=h;const f=e[a].update(h.val());if(f!==void 0){So("transaction failed: Data returned ",f,c.path);let p=Z(f);typeof f=="object"&&f!=null&&pt(f,".priority")||(p=p.updatePriority(h.getPriority()));const m=c.currentWriteId,A=Io(t),x=ig(p,h,A);c.currentOutputSnapshotRaw=p,c.currentOutputSnapshotResolved=x,c.currentWriteId=bl(t),o.splice(o.indexOf(m),1),r=r.concat(Zp(t.serverSyncTree_,c.path,x,c.currentWriteId,c.applyLocally)),r=r.concat(Bt(t.serverSyncTree_,m,!0))}else u=!0,d="nodata",r=r.concat(Bt(t.serverSyncTree_,c.currentWriteId,!0))}We(t.eventQueue_,n,r),r=[],u&&(e[a].status=2,(function(h){setTimeout(h,Math.floor(0))})(e[a].unwatcher),e[a].onComplete&&(d==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(d),!1,null))))}ko(t,t.transactionQueueTree_);for(let a=0;a<s.length;a++)Ls(s[a]);Cl(t,t.transactionQueueTree_)}function _g(t,e){let n,s=t.transactionQueueTree_;for(n=N(e);n!==null&&xs(s)===void 0;)s=yl(s,n),e=j(e),n=N(e);return s}function yg(t,e){const n=[];return vg(t,e,n),n.sort((s,r)=>s.order-r.order),n}function vg(t,e,n){const s=xs(e);if(s)for(let r=0;r<s.length;r++)n.push(s[r]);Co(e,r=>{vg(t,r,n)})}function ko(t,e){const n=xs(e);if(n){let s=0;for(let r=0;r<n.length;r++)n[r].status!==2&&(n[s]=n[r],s++);n.length=s,og(e,n.length>0?n:void 0)}Co(e,s=>{ko(t,s)})}function Sl(t,e){const n=Br(_g(t,e)),s=yl(t.transactionQueueTree_,e);return TI(s,r=>{da(t,r)}),da(t,s),cg(s,r=>{da(t,r)}),n}function da(t,e){const n=xs(e);if(n){const s=[];let r=[],i=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(g(i===o-1,"All SENT items should be at beginning of queue."),i=o,n[o].status=3,n[o].abortReason="set"):(g(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),r=r.concat(Bt(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&s.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));i===-1?og(e,void 0):n.length=i+1,We(t.eventQueue_,Br(e),r);for(let o=0;o<s.length;o++)Ls(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bg{constructor(e,n){this._repo=e,this._path=n}cancel(){const e=new Ne;return qI(this._repo,this._path,e.wrapCallback(()=>{})),e.promise}remove(){Ht("OnDisconnect.remove",this._path);const e=new Ne;return sh(this._repo,this._path,null,e.wrapCallback(()=>{})),e.promise}set(e){Ht("OnDisconnect.set",this._path),Wi("OnDisconnect.set",e,this._path,!1);const n=new Ne;return sh(this._repo,this._path,e,n.wrapCallback(()=>{})),n.promise}setWithPriority(e,n){Ht("OnDisconnect.setWithPriority",this._path),Wi("OnDisconnect.setWithPriority",e,this._path,!1),PI("OnDisconnect.setWithPriority",n);const s=new Ne;return zI(this._repo,this._path,e,n,s.wrapCallback(()=>{})),s.promise}update(e){Ht("OnDisconnect.update",this._path),dg("OnDisconnect.update",e,this._path);const n=new Ne;return GI(this._repo,this._path,e,n.wrapCallback(()=>{})),n.promise}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ro{constructor(e,n,s,r){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=r}get key(){return L(this._path)?null:Qc(this._path)}get ref(){return new it(this._repo,this._path)}get _queryIdentifier(){const e=Vd(this._queryParams),n=Yc(e);return n==="{}"?"default":n}get _queryObject(){return Vd(this._queryParams)}isEqual(e){if(e=ge(e),!(e instanceof Ro))return!1;const n=this._repo===e._repo,s=Zc(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return n&&s&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+qS(this._path)}}class it extends Ro{constructor(e,n){super(e,n,new yo,!1)}get parent(){const e=Pp(this._path);return e===null?null:new it(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Ln{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new H(e),s=On(this.ref,e);return new Ln(this._node.getChild(n),s,Q)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,r)=>e(new Ln(r,On(this.ref,s),Q)))}hasChild(e){const n=new H(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function k(t,e){return t=ge(t),t._checkNotDeleted("ref"),e!==void 0?On(t._root,e):t._root}function On(t,e){return t=ge(t),N(t._path)===null?LI("child","path",e):wl("child","path",e),new it(t._repo,X(t._path,e))}function Cg(t){return t=ge(t),new bg(t._repo,t._path)}function Vi(t,e){t=ge(t),Ht("push",t._path),Wi("push",e,t._path,!0);const n=pg(t._repo),s=tk(n),r=On(t,s),i=On(t,s);let o;return o=Promise.resolve(i),r.then=o.then.bind(o),r.catch=o.then.bind(o,void 0),r}function Ve(t){return Ht("remove",t._path),re(t,null)}function re(t,e){t=ge(t),Ht("set",t._path),Wi("set",e,t._path,!1);const n=new Ne;return WI(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function En(t,e){dg("update",e,t._path);const n=new Ne;return VI(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function et(t){t=ge(t);const e=new Tl(()=>{}),n=new Wr(e);return HI(t._repo,t,n).then(s=>new Ln(s,new it(t._repo,t._path),t._queryParams.getIndex()))}class Wr{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const s=n._queryParams.getIndex();return new wg("value",this,new Ln(e.snapshotNode,new it(n._repo,n._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Eg(this,e,n):null}matches(e){return e instanceof Wr?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class Ao{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Eg(this,e,n):null}createEvent(e,n){g(e.childName!=null,"Child events should have a childName.");const s=On(new it(n._repo,n._path),e.childName),r=n._queryParams.getIndex();return new wg(e.type,this,new Ln(e.snapshotNode,s,r),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Ao?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function No(t,e,n,s,r){const i=new Tl(n,void 0),o=e==="value"?new Wr(i):new Ao(e,i);return YI(t._repo,t,o),()=>gg(t._repo,t,o)}function Il(t,e,n,s){return No(t,"value",e)}function ws(t,e,n,s){return No(t,"child_added",e)}function Sg(t,e,n,s){return No(t,"child_changed",e)}function Tg(t,e,n,s){return No(t,"child_removed",e)}function It(t,e,n){let s=null;const r=n?new Tl(n):null;e==="value"?s=new Wr(r):e&&(s=new Ao(e,r)),gg(t._repo,t,s)}sI(it);cI(it);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nk="FIREBASE_DATABASE_EMULATOR_HOST",ic={};let sk=!1;function rk(t,e,n,s){const r=e.lastIndexOf(":"),i=e.substring(0,r),o=Rs(i);t.repoInfo_=new bp(e,o,t.repoInfo_.namespace,t.repoInfo_.webSocketOnly,t.repoInfo_.nodeAdmin,t.repoInfo_.persistenceKey,t.repoInfo_.includeNamespaceInQueryParams,!0,n),s&&(t.authTokenProvider_=s)}function Ig(t,e,n,s,r){let i=s||t.options.databaseURL;i===void 0&&(t.options.projectId||Nt("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),he("Using default host for project ",t.options.projectId),i=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=rh(i,r),a=o.repoInfo,c;typeof process<"u"&&Td&&(c=Td[nk]),c?(i=`http://${c}?ns=${a.namespace}`,o=rh(i,r),a=o.repoInfo):o.repoInfo.secure;const l=new vS(t.name,t.options,e);OI("Invalid Firebase Database URL",o),L(o.path)||Nt("Database URL must point to the root of a Firebase Database (not including a child path).");const u=ok(a,t,l,new yS(t,n));return new kg(u,t)}function ik(t,e){const n=ic[e];(!n||n[t.key]!==t)&&Nt(`Database ${e}(${t.repoInfo_}) has already been deleted.`),KI(t),delete n[t.key]}function ok(t,e,n,s){let r=ic[e.name];r||(r={},ic[e.name]=r);let i=r[t.toURLString()];return i&&Nt("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),i=new UI(t,sk,n,s),r[t.toURLString()]=i,i}class kg{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||($I(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new it(this._repo,F())),this._rootInternal}_delete(){return this._rootInternal!==null&&(ik(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&Nt("Cannot call "+e+" on a deleted database.")}}function Rg(t=Gc(),e){const n=xr(t,"database").getImmediate({identifier:e});if(!n._instanceStarted){const s=Tb("database");s&&Ag(n,...s)}return n}function Ag(t,e,n,s={}){t=ge(t),t._checkNotDeleted("useEmulator");const r=`${e}:${n}`,i=t._repoInternal;if(t._instanceStarted){if(r===t._repoInternal.repoInfo_.host&&Rn(s,i.repoInfo_.emulatorOptions))return;Nt("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(i.repoInfo_.nodeAdmin)s.mockUserToken&&Nt('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new fi(fi.OWNER);else if(s.mockUserToken){const a=typeof s.mockUserToken=="string"?s.mockUserToken:Ib(s.mockUserToken,t.app.options.projectId);o=new fi(a)}Rs(e)&&(Qf(e),Zf("Database",!0)),rk(i,r,s,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ak(t){cp(Ps),Zt(new Rt("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),i=e.getProvider("app-check-internal");return Ig(s,r,i,n)},"PUBLIC").setMultipleInstances(!0)),St(Id,kd,t),St(Id,kd,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ck={".sv":"timestamp"};function bn(){return ck}Tt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Tt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};ak();const lk=Object.freeze(Object.defineProperty({__proto__:null,DataSnapshot:Ln,Database:kg,OnDisconnect:bg,_QueryImpl:Ro,_QueryParams:yo,_ReferenceImpl:it,_repoManagerDatabaseFromApp:Ig,_setSDKVersion:cp,_validatePathString:wl,_validateWritablePath:Ht,child:On,connectDatabaseEmulator:Ag,get:et,getDatabase:Rg,off:It,onChildAdded:ws,onChildChanged:Sg,onChildRemoved:Tg,onDisconnect:Cg,onValue:Il,push:Vi,ref:k,remove:Ve,serverTimestamp:bn,set:re,update:En},Symbol.toStringTag,{value:"Module"}));var uk="firebase",dk="12.4.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oc=new Map,Ng={activated:!1,tokenObservers:[]},hk={initialized:!1,enabled:!1};function ae(t){return oc.get(t)||{...Ng}}function fk(t,e){return oc.set(t,e),oc.get(t)}function Po(){return hk}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pg="https://content-firebaseappcheck.googleapis.com/v1",pk="exchangeRecaptchaEnterpriseToken",gk="exchangeDebugToken",oh={RETRIAL_MIN_WAIT:30*1e3,RETRIAL_MAX_WAIT:960*1e3},mk=1440*60*1e3;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ek="firebase-app-check-database",bk=1,br="firebase-app-check-store",Dg="debug-token";let ni=null;function xg(){return ni||(ni=new Promise((t,e)=>{try{const n=indexedDB.open(Ek,bk);n.onsuccess=s=>{t(s.target.result)},n.onerror=s=>{e(Le.create("storage-open",{originalErrorMessage:s.target.error?.message}))},n.onupgradeneeded=s=>{const r=s.target.result;switch(s.oldVersion){case 0:r.createObjectStore(br,{keyPath:"compositeKey"})}}}catch(n){e(Le.create("storage-open",{originalErrorMessage:n?.message}))}}),ni)}function Ck(t){return Fg(Ug(t))}function Sk(t,e){return Mg(Ug(t),e)}function Tk(t){return Mg(Dg,t)}function Ik(){return Fg(Dg)}async function Mg(t,e){const s=(await xg()).transaction(br,"readwrite"),i=s.objectStore(br).put({compositeKey:t,value:e});return new Promise((o,a)=>{i.onsuccess=c=>{o()},s.onerror=c=>{a(Le.create("storage-set",{originalErrorMessage:c.target.error?.message}))}})}async function Fg(t){const n=(await xg()).transaction(br,"readonly"),r=n.objectStore(br).get(t);return new Promise((i,o)=>{r.onsuccess=a=>{const c=a.target.result;i(c?c.value:void 0)},n.onerror=a=>{o(Le.create("storage-get",{originalErrorMessage:a.target.error?.message}))}})}function Ug(t){return`${t.options.appId}-${t.name}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Al(){return Po().enabled}async function Nl(){const t=Po();if(t.enabled&&t.token)return t.token.promise;throw Error(`
        ...
        `)}function Ak(){const t=Yf(),e=Po();if(e.initialized=!0,typeof t.FIREBASE_APPCHECK_DEBUG_TOKEN!="string"&&t.FIREBASE_APPCHECK_DEBUG_TOKEN!==!0)return;e.enabled=!0;const n=new Ne;e.token=n,typeof t.FIREBASE_APPCHECK_DEBUG_TOKEN=="string"?n.resolve(t.FIREBASE_APPCHECK_DEBUG_TOKEN):n.resolve(Rk())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nk={error:"UNKNOWN_ERROR"};function Pk(t){return fo.encodeString(JSON.stringify(t),!1)}async function ac(t,e=!1,n=!1){const s=t.app;kl(s);const r=ae(s);let i=r.token,o;if(i&&!Yn(i)&&(r.token=void 0,i=void 0),!i){const l=await r.cachedTokenPromise;l&&(Yn(l)?i=l:await ha(s,void 0))}if(!e&&i&&Yn(i))return{token:i.token};let a=!1;if(Al())try{r.exchangeTokenPromise||(r.exchangeTokenPromise=Rl(Og(s,await Nl()),t.heartbeatServiceProvider).finally(()=>{r.exchangeTokenPromise=void 0}),a=!0);const l=await r.exchangeTokenPromise;return await ha(s,l),r.token=l,{token:l.token}}catch(l){return l.code==="appCheck/throttled"||l.code==="appCheck/initial-throttle"?Wt.warn(l.message):n&&Wt.error(l),fa(l)}try{r.exchangeTokenPromise||(r.exchangeTokenPromise=r.provider.getToken().finally(()=>{r.exchangeTokenPromise=void 0}),a=!0),i=await ae(s).exchangeTokenPromise}catch(l){l.code==="appCheck/throttled"||l.code==="appCheck/initial-throttle"?Wt.warn(l.message):n&&Wt.error(l),o=l}let c;return i?o?Yn(i)?c={token:i.token,internalError:o}:c=fa(o):(c={token:i.token},r.token=i,await ha(s,i)):c=fa(o),a&&Hg(s,c),c}async function Lk(t){const e=t.app;kl(e);const{provider:n}=ae(e);if(Al()){const s=await Nl(),{token:r}=await Rl(Og(e,s),t.heartbeatServiceProvider);return{token:r}}else{const{token:s}=await n.getToken();return{token:s}}}function $g(t,e,n,s){const{app:r}=t,i=ae(r),o={next:n,error:s,type:e};if(i.tokenObservers=[...i.tokenObservers,o],i.token&&Yn(i.token)){const a=i.token;Promise.resolve().then(()=>{n({token:a.token}),ch(t)}).catch(()=>{})}i.cachedTokenPromise.then(()=>ch(t))}function Bg(t,e){const n=ae(t),s=n.tokenObservers.filter(r=>r.next!==e);s.length===0&&n.tokenRefresher&&n.tokenRefresher.isRunning()&&n.tokenRefresher.stop(),n.tokenObservers=s}function ch(t){const{app:e}=t,n=ae(e);let s=n.tokenRefresher;s||(s=Ok(t),n.tokenRefresher=s),!s.isRunning()&&n.isTokenAutoRefreshEnabled&&s.start()}function Ok(t){const{app:e}=t;return new _k(async()=>{const n=ae(e);let s;if(n.token?s=await ac(t,!0):s=await ac(t),s.error)throw s.error;if(s.internalError)throw s.internalError},()=>!0,()=>{const n=ae(e);if(n.token){let s=n.token.issuedAtTimeMillis+(n.token.expireTimeMillis-n.token.issuedAtTimeMillis)*.5+3e5;const r=n.token.expireTimeMillis-300*1e3;return s=Math.min(s,r),Math.max(0,s-Date.now())}else return 0},oh.RETRIAL_MIN_WAIT,oh.RETRIAL_MAX_WAIT)}function Hg(t,e){const n=ae(t).tokenObservers;for(const s of n)try{s.type==="EXTERNAL"&&e.error!=null?s.error(e.error):s.next(e)}catch{}}function Yn(t){return t.expireTimeMillis-Date.now()>0}function fa(t){return{token:Pk(Nk),error:t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dk{constructor(e,n){this.app=e,this.heartbeatServiceProvider=n}_delete(){const{tokenObservers:e}=ae(this.app);for(const n of e)Bg(this.app,n.next);return Promise.resolve()}}function xk(t,e){return new Dk(t,e)}function Mk(t){return{getToken:e=>ac(t,e),getLimitedUseToken:()=>Lk(t),addTokenListener:e=>$g(t,"INTERNAL",e),removeTokenListener:e=>Bg(t.app,e)}}const Fk="@firebase/app-check",Uk="0.11.0",$k="https://www.google.com/recaptcha/enterprise.js";function Bk(t,e){const n=new Ne,s=ae(t);s.reCAPTCHAState={initialized:n};const r=Hk(t),i=ah(!0);return i?lh(t,e,i,r,n):jk(()=>{const o=ah(!0);if(!o)throw new Error("no recaptcha");lh(t,e,o,r,n)}),n.promise}function lh(t,e,n,s,r){n.ready(()=>{Vk(t,e,n,s),r.resolve(n)})}function Hk(t){const e=`fire_app_check_${t.name}`,n=document.createElement("div");return n.id=e,n.style.display="none",document.body.appendChild(n),e}async function Wk(t){kl(t);const n=await ae(t).reCAPTCHAState.initialized.promise;return new Promise((s,r)=>{const i=ae(t).reCAPTCHAState;n.ready(()=>{s(n.execute(i.widgetId,{action:"fire_app_check"}))})})}function Vk(t,e,n,s){const r=n.render(s,{sitekey:e,size:"invisible",callback:()=>{ae(t).reCAPTCHAState.succeeded=!0},"error-callback":()=>{ae(t).reCAPTCHAState.succeeded=!1}}),i=ae(t);i.reCAPTCHAState={...i.reCAPTCHAState,widgetId:r}}function jk(t){const e=document.createElement("script");e.src=$k,e.onload=t,document.head.appendChild(e)}class Pl{constructor(e){this._siteKey=e,this._throttleData=null}async getToken(){zk(this._throttleData);const e=await Wk(this._app).catch(s=>{throw Le.create("recaptcha-error")});if(!ae(this._app).reCAPTCHAState?.succeeded)throw Le.create("recaptcha-error");let n;try{n=await Rl(wk(this._app,e),this._heartbeatServiceProvider)}catch(s){throw s.code?.includes("fetch-status-error")?(this._throttleData=qk(Number(s.customData?.httpStatus),this._throttleData),Le.create("initial-throttle",{time:Lg(this._throttleData.allowRequestsAfter-Date.now()),httpStatus:this._throttleData.httpStatus})):s}return this._throttleData=null,n}initialize(e){this._app=e,this._heartbeatServiceProvider=xr(e,"heartbeat"),Bk(e,this._siteKey).catch(()=>{})}isEqual(e){return e instanceof Pl?this._siteKey===e._siteKey:!1}}function qk(t,e){if(t===404||t===403)return{backoffCount:1,allowRequestsAfter:Date.now()+mk,httpStatus:t};{const n=e?e.backoffCount:0,s=Yb(n,1e3,2);return{backoffCount:n+1,allowRequestsAfter:Date.now()+s,httpStatus:t}}}function zk(t){if(t&&Date.now()-t.allowRequestsAfter<=0)throw Le.create("throttled",{time:Lg(t.allowRequestsAfter-Date.now()),httpStatus:t.httpStatus})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gk(t=Gc(),e){t=ge(t);const n=xr(t,"app-check");if(Po().initialized||Ak(),Al()&&Nl().then(r=>console.log(`App Check debug token: ${r}. You will need to add it to your app's App Check settings in the Firebase console for it to work.`)),n.isInitialized()){const r=n.getImmediate(),i=n.getOptions();if(i.isTokenAutoRefreshEnabled===e.isTokenAutoRefreshEnabled&&i.provider.isEqual(e.provider))return r;throw Le.create("already-initialized",{appName:t.name})}const s=n.initialize({options:e});return Yk(t,e.provider,e.isTokenAutoRefreshEnabled),ae(t).isTokenAutoRefreshEnabled&&$g(s,"INTERNAL",()=>{}),s}function Yk(t,e,n=!1){const s=fk(t,{...Ng});s.activated=!0,s.provider=e,s.cachedTokenPromise=kk(t).then(r=>(r&&Yn(r)&&(s.token=r,Hg(t,{token:r.token})),r)),s.isTokenAutoRefreshEnabled=n&&t.automaticDataCollectionEnabled,!t.automaticDataCollectionEnabled&&n&&Wt.warn("`isTokenAutoRefreshEnabled` is true but `automaticDataCollectionEnabled` was set to false during `initializeApp()`. This blocks automatic token refresh."),s.provider.initialize(t)}const Kk="app-check",uh="app-check-internal";function Jk(){Zt(new Rt(Kk,t=>{const e=t.getProvider("app").getImmediate(),n=t.getProvider("heartbeat");return xk(e,n)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,e,n)=>{t.getProvider(uh).initialize()})),Zt(new Rt(uh,t=>{const e=t.getProvider("app-check").getImmediate();return Mk(e)},"PUBLIC").setInstantiationMode("EXPLICIT")),St(Fk,Uk)}Jk();const Xk={apiKey:"AIzaSyA-fvCaKCjyEFX__YAVr1oPGdVsUEhFehA",authDomain:"vidu-aae11.web.app",projectId:"vidu-aae11",databaseURL:"https://vidu-aae11-default-rtdb.europe-west1.firebasedatabase.app",storageBucket:"vidu-aae11.firebasestorage.app",messagingSenderId:"765724787439",appId:"1:765724787439:web:61a3b5dd538149564c911a",measurementId:"G-EGJ53HLGY4"},Ll=rp(Xk),dh="6LdBIBgsAAAAAB4zIcXaZI-FD4kt21TWs9Zx9_fp";let cc;if(dh.trim()!=="")cc=new Pl(dh),console.info("[Firebase App Check: PROD] Initializing with ReCAPTCHA Enterprise (invisible mode).");else throw console.error("[Firebase App Check: PROD] VITE_RECAPTCHA_ENTERPRISE_SITE_KEY is missing or empty. App Check will NOT be initialized, leaving Firebase services unprotected!"),new Error("Firebase App Check configuration missing in production.");if(cc)try{Gk(Ll,{provider:cc,isTokenAutoRefreshEnabled:!0})}catch(t){console.error("[Firebase App Check] initializeAppCheck call failed:",t)}const R=Rg(Ll),Je=[];function _n(t,e,n,s=null,r=null,i=null){e==="value"?Il(t,n):e==="child_added"?ws(t,n):e==="child_removed"?Tg(t,n):console.warn(`Unknown listener type: ${e}`),Je.push({ref:t,type:e,callback:n,roomId:s,userId:r,category:i})}function Qk(){Je.forEach(({ref:t,type:e,callback:n})=>{try{It(t,e,n)}catch(s){console.warn("Failed to remove firebase rtdb listener",s)}}),Je.length=0}function Lo(t){if(!t)return;Je.filter(s=>s.roomId===t).forEach(({ref:s,type:r,callback:i})=>{try{It(s,r,i)}catch(o){console.warn(`Failed to remove listener for room ${t}`,o)}});const n=Je.filter(s=>s.roomId!==t);Je.length=0,Je.push(...n)}function Zk(t,e){if(!t||!e)return;const n=i=>i.userId===t&&i.roomId===e;Je.filter(n).forEach(({ref:i,type:o,callback:a})=>{try{It(i,o,a)}catch(c){console.warn(`Failed to remove listener for user ${t} in room ${e}`,c)}});const r=Je.filter(i=>!n(i));Je.length=0,Je.push(...r)}function nr(t,e,n=null){_n(t,"value",e,n)}const dn=t=>k(R,`rooms/${t}`),si=t=>k(R,`rooms/${t}/members`),hh=(t,e)=>k(R,`rooms/${t}/members/${e}`),eR=t=>k(R,`rooms/${t}/cancellation`),Oo=t=>k(R,`rooms/${t}/watch`),Do=t=>k(R,`rooms/${t}/watch/fileRequest`),tR=t=>k(R,`users/${t}/recentCalls`),Ol=(t,e)=>k(R,`users/${t}/recentCalls/${e}`),Dl=t=>k(R,`users/${t}/outgoingCall`),Wg=t=>k(R,`rooms/${t}/offerCandidates`),Vg=t=>k(R,`rooms/${t}/answerCandidates`);function jg(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const nR=jg,qg=new As("auth","Firebase",jg());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ji=new go("@firebase/auth");function sR(t,...e){ji.logLevel<=W.WARN&&ji.warn(`Auth (${Ps}): ${t}`,...e)}function pi(t,...e){ji.logLevel<=W.ERROR&&ji.error(`Auth (${Ps}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ft(t,...e){throw Ml(t,...e)}function tt(t,...e){return Ml(t,...e)}function xl(t,e,n){const s={...nR(),[e]:n};return new As("auth","Firebase",s).create(e,{appName:t.name})}function Cn(t){return xl(t,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function rR(t,e,n){const s=n;if(!(e instanceof s))throw s.name!==e.constructor.name&&ft(t,"argument-error"),xl(t,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function Ml(t,...e){if(typeof t!="string"){const n=e[0],s=[...e.slice(1)];return s[0]&&(s[0].appName=t.name),t._errorFactory.create(n,...s)}return qg.create(t,...e)}function C(t,e,...n){if(!t)throw Ml(e,...n)}function yt(t){const e="INTERNAL ASSERTION FAILED: "+t;throw pi(e),new Error(e)}function Pt(t,e){t||yt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lc(){return typeof self<"u"&&self.location?.href||""}function iR(){return fh()==="http:"||fh()==="https:"}function fh(){return typeof self<"u"&&self.location?.protocol||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vr{constructor(e,n){this.shortDelay=e,this.longDelay=n,Pt(n>e,"Short delay should be less than long delay!"),this.isMobile=jc()||ep()}get(){return oR()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lR=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],uR=new Vr(3e4,6e4);function Ul(t,e){return t.tenantId&&!e.tenantId?{...e,tenantId:t.tenantId}:e}async function Ms(t,e,n,s,r={}){return Gg(t,r,async()=>{let i={},o={};s&&(e==="GET"?o=s:i={body:JSON.stringify(s)});const a=Ns({key:t.config.apiKey,...o}).slice(1),c=await t._getAdditionalHeaders();c["Content-Type"]="application/json",t.languageCode&&(c["X-Firebase-Locale"]=t.languageCode);const l={method:e,headers:c,...i};return Ab()||(l.referrerPolicy="no-referrer"),t.emulatorConfig&&Rs(t.emulatorConfig.host)&&(l.credentials="include"),zg.fetch()(await Yg(t,t.config.apiHost,n,a),l)})}async function Gg(t,e,n){t._canInitEmulator=!1;const s={...cR,...e};try{const r=new hR(t),i=await Promise.race([n(),r.promise]);r.clearNetworkTimeout();const o=await i.json();if("needConfirmation"in o)throw ri(t,"account-exists-with-different-credential",o);if(i.ok&&!("errorMessage"in o))return o;{const a=i.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw ri(t,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw ri(t,"email-already-in-use",o);if(c==="USER_DISABLED")throw ri(t,"user-disabled",o);const u=s[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw xl(t,u,l);ft(t,u)}}catch(r){if(r instanceof an)throw r;ft(t,"network-request-failed",{message:String(r)})}}async function dR(t,e,n,s,r={}){const i=await Ms(t,e,n,s,r);return"mfaPendingCredential"in i&&ft(t,"multi-factor-auth-required",{_serverResponse:i}),i}async function Yg(t,e,n,s){const r=`${e}${n}?${s}`,i=t,o=i.config.emulator?Fl(t.config,r):`${t.config.apiScheme}://${r}`;return lR.includes(n)&&(await i._persistenceManagerAvailable,i._getPersistenceType()==="COOKIE")?i._getPersistence()._getFinalTarget(o).toString():o}class hR{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(tt(this.auth,"network-request-failed")),uR.get())})}}function ri(t,e,n){const s={appName:t.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const r=tt(t,e,s);return r.customData._tokenResponse=n,r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fR(t,e){return Ms(t,"POST","/v1/accounts:delete",e)}async function qi(t,e){return Ms(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cr(t,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof an&&gR(s)&&t.auth.currentUser===t&&await t.auth.signOut(),s}}function gR({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zi(t){const e=t.auth,n=await t.getIdToken(),s=await Cr(t,qi(e,{idToken:n}));C(s?.users.length,e,"internal-error");const r=s.users[0];t._notifyReloadListener(r);const i=r.providerUserInfo?.length?Kg(r.providerUserInfo):[],o=yR(t.providerData,i),a=t.isAnonymous,c=!(t.email&&r.passwordHash)&&!o?.length,l=a?c:!1,u={uid:r.localId,displayName:r.displayName||null,photoURL:r.photoUrl||null,email:r.email||null,emailVerified:r.emailVerified||!1,phoneNumber:r.phoneNumber||null,tenantId:r.tenantId||null,providerData:o,metadata:new uc(r.createdAt,r.lastLoginAt),isAnonymous:l};Object.assign(t,u)}async function _R(t){const e=ge(t);await zi(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function yR(t,e){return[...t.filter(s=>!e.some(r=>r.providerId===s.providerId)),...e]}function Kg(t){return t.map(({providerId:e,...n})=>({providerId:e,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vR(t,e){const n=await Gg(t,{},async()=>{const s=Ns({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:i}=t.config,o=await Yg(t,r,"/v1/token",`key=${i}`),a=await t._getAdditionalHeaders();a["Content-Type"]="application/x-www-form-urlencoded";const c={method:"POST",headers:a,body:s};return t.emulatorConfig&&Rs(t.emulatorConfig.host)&&(c.credentials="include"),zg.fetch()(o,c)});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function wR(t,e){return Ms(t,"POST","/v2/accounts:revokeToken",Ul(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gi(t,e,n){return`firebase:${t}:${e}:${n}`}class Zn{constructor(e,n,s){this.persistence=e,this.auth=n,this.userKey=s;const{config:r,name:i}=this.auth;this.fullUserKey=gi(this.userKey,r.apiKey,i),this.fullPersistenceKey=gi("persistence",r.apiKey,i),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const n=await qi(this.auth,{idToken:e}).catch(()=>{});return n?Xe._fromGetAccountInfoResponse(this.auth,n,e):null}return Xe._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,s="authUser"){if(!n.length)return new Zn(vt(dc),e,s);const r=(await Promise.all(n.map(async l=>{if(await l._isAvailable())return l}))).filter(l=>l);let i=r[0]||vt(dc);const o=gi(s,e.config.apiKey,e.name);let a=null;for(const l of n)try{const u=await l._get(o);if(u){let d;if(typeof u=="string"){const h=await qi(e,{idToken:u}).catch(()=>{});if(!h)break;d=await Xe._fromGetAccountInfoResponse(e,h,u)}else d=Xe._fromJSON(e,u);l!==i&&(a=d),i=l;break}}catch{}const c=r.filter(l=>l._shouldAllowMigration);return!i._shouldAllowMigration||!c.length?new Zn(i,e,s):(i=c[0],a&&await i._set(o,a.toJSON()),await Promise.all(n.map(async l=>{if(l!==i)try{await l._remove(o)}catch{}})),new Zn(i,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mh(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(em(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Xg(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(nm(e))return"Blackberry";if(sm(e))return"Webos";if(Qg(e))return"Safari";if((e.includes("chrome/")||Zg(e))&&!e.includes("edge/"))return"Chrome";if(tm(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=t.match(n);if(s?.length===2)return s[1]}return"Other"}function Xg(t=Re()){return/firefox\//i.test(t)}function Qg(t=Re()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Zg(t=Re()){return/crios\//i.test(t)}function em(t=Re()){return/iemobile/i.test(t)}function tm(t=Re()){return/android/i.test(t)}function nm(t=Re()){return/blackberry/i.test(t)}function sm(t=Re()){return/webos/i.test(t)}function Bl(t=Re()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function ER(t=Re()){return Bl(t)&&!!window.navigator?.standalone}function bR(){return Pb()&&document.documentMode===10}function rm(t=Re()){return Bl(t)||tm(t)||sm(t)||nm(t)||/windows phone/i.test(t)||em(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function im(t,e=[]){let n;switch(t){case"Browser":n=mh(Re());break;case"Worker":n=`${mh(Re())}-${t}`;break;default:n=t}const s=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Ps}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function SR(t,e={}){return Ms(t,"GET","/v2/passwordPolicy",Ul(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Hl={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function RR(t){Hl=t}function AR(t){return Hl.loadJS(t)}function NR(){return Hl.gapiScript}function PR(t){return`__${t}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function LR(t,e){const n=xr(t,"auth");if(n.isInitialized()){const r=n.getImmediate(),i=n.getOptions();if(Rn(i,e??{}))return r;ft(r,"already-initialized")}return n.initialize({options:e})}function OR(t,e){const n=e?.persistence||[],s=(Array.isArray(n)?n:[n]).map(vt);e?.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(s,e?.popupRedirectResolver)}function DR(t,e,n){const s=Fs(t);C(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const r=!1,i=om(e),{host:o,port:a}=xR(e),c=a===null?"":`:${a}`,l={url:`${i}//${o}${c}/`},u=Object.freeze({host:o,port:a,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:r})});if(!s._canInitEmulator){C(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),C(Rn(l,s.config.emulator)&&Rn(u,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=l,s.emulatorConfig=u,s.settings.appVerificationDisabledForTesting=!0,Rs(o)?(Qf(`${i}//${o}${c}`),Zf("Auth",!0)):MR()}function om(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function xR(t){const e=om(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const s=n[2].split("@").pop()||"",r=/^(\[[^\]]+\])(:|$)/.exec(s);if(r){const i=r[1];return{host:i,port:yh(s.substr(i.length+1))}}else{const[i,o]=s.split(":");return{host:i,port:yh(o)}}}function yh(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function MR(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function es(t,e){return dR(t,"POST","/v1/accounts:signInWithIdp",Ul(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Es{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,n,s,r=!1){const i=await Xe._fromIdTokenResponse(e,s,r),o=vh(s);return new Es({user:i,providerId:o,_tokenResponse:s,operationType:n})}static async _forOperation(e,n,s){await e._updateTokensIfNecessary(s,!0);const r=vh(s);return new Es({user:e,providerId:r,_tokenResponse:s,operationType:n})}}function vh(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $R(t,e,n=!1){const{auth:s}=t;if(Ge(s.app))return Promise.reject(Cn(s));const r="reauthenticate";try{const i=await Cr(t,cm(s,r,e,t),n);C(i.idToken,s,"internal-error");const o=$l(i.idToken);C(o,s,"internal-error");const{sub:a}=o;return C(t.uid===a,s,"user-mismatch"),Es._forOperation(t,r,i)}catch(i){throw i?.code==="auth/user-not-found"&&ft(s,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lm(t,e,n=!1){if(Ge(t.app))return Promise.reject(Cn(t));const s="signIn",r=await cm(t,s,e),i=await Es._fromIdTokenResponse(t,s,r);return n||await t._updateCurrentUser(i.user),i}async function BR(t,e){return lm(Fs(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ga(t,e){return ge(t).setPersistence(e)}function HR(t,e,n,s){return ge(t).onIdTokenChanged(e,n,s)}function WR(t,e,n){return ge(t).beforeAuthStateChanged(e,n)}function um(t,e,n,s){return ge(t).onAuthStateChanged(e,n,s)}function VR(t){return ge(t).signOut()}const Yi="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mm(){return typeof ht().WorkerGlobalScope<"u"&&typeof ht().importScripts=="function"}async function KR(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function JR(){return navigator?.serviceWorker?.controller||null}function XR(){return mm()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jl extends am{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return es(e,this._buildIdpRequest())}_linkToIdToken(e,n){return es(e,this._buildIdpRequest(n))}_getReauthenticationResolver(e){return es(e,this._buildIdpRequest())}_buildIdpRequest(e){const n={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(n.idToken=e),n}}function sA(t){return lm(t.auth,new jl(t),t.bypassAuthState)}function rA(t){const{auth:e,user:n}=t;return C(n,e,"internal-error"),$R(n,new jl(t),t.bypassAuthState)}async function iA(t){const{auth:e,user:n}=t;return C(n,e,"internal-error"),UR(n,new jl(t),t.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bm{constructor(e,n,s,r,i=!1){this.auth=e,this.resolver=s,this.user=r,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:s,postBody:r,tenantId:i,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:s,tenantId:i||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return sA;case"linkViaPopup":case"linkViaRedirect":return iA;case"reauthViaPopup":case"reauthViaRedirect":return rA;default:ft(this.auth,"internal-error")}}resolve(e){Pt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Pt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cA="pendingRedirect",mi=new Map;class lA extends bm{constructor(e,n,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,s),this.eventId=null}async execute(){let e=mi.get(this.auth._key());if(!e){try{const s=await uA(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(n){e=()=>Promise.reject(n)}mi.set(this.auth._key(),e)}return this.bypassAuthState||mi.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function uA(t,e){const n=fA(e),s=hA(t);if(!await s._isAvailable())return!1;const r=await s._get(n)==="true";return await s._remove(n),r}function dA(t,e){mi.set(t._key(),e)}function hA(t){return vt(t._redirectPersistence)}function fA(t){return gi(cA,t.config.apiKey,t.name)}async function pA(t,e){return await Fs(t)._initializationPromise,Cm(t,e,!1)}async function Cm(t,e,n=!1){if(Ge(t.app))return Promise.reject(Cn(t));const s=Fs(t),r=Em(s,e),o=await new lA(s,r,n).execute();return o&&!n&&(delete o.user._redirectEventId,await s._persistUserIfCurrent(o.user),await s._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gA=600*1e3;class mA{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let n=!1;return this.consumers.forEach(s=>{this.isEventForConsumer(e,s)&&(n=!0,this.sendToConsumer(e,s),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!_A(e)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=e,n=!0)),n}sendToConsumer(e,n){if(e.error&&!Sm(e)){const s=e.error.code?.split("auth/")[1]||"internal-error";n.onError(tt(this.auth,s))}else n.onAuthEvent(e)}isEventForConsumer(e,n){const s=n.eventId===null||!!e.eventId&&e.eventId===n.eventId;return n.filter.includes(e.type)&&s}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=gA&&this.cachedEventUids.clear(),this.cachedEventUids.has(bh(e))}saveEventToCache(e){this.cachedEventUids.add(bh(e)),this.lastProcessedEventTime=Date.now()}}function bh(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter(e=>e).join("-")}function Sm({type:t,error:e}){return t==="unknown"&&e?.code==="auth/no-auth-event"}function _A(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Sm(t);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yA(t,e={}){return Ms(t,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const CA=new Vr(3e4,6e4);function Ch(){const t=ht().___jsl;if(t?.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function SA(t){return new Promise((e,n)=>{function s(){Ch(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Ch(),n(tt(t,"network-request-failed"))},timeout:CA.get()})}if(ht().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(ht().gapi?.load)s();else{const r=PR("iframefcb");return ht()[r]=()=>{gapi.load?s():n(tt(t,"network-request-failed"))},AR(`${NR()}?onload=${r}`).catch(i=>n(i))}}).catch(e=>{throw _i=null,e})}let _i=null;function TA(t){return _i=_i||SA(t),_i}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const IA=new Vr(5e3,15e3),kA="__/auth/iframe",RA="emulator/auth/iframe",AA={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},NA=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function PA(t){const e=t.config;C(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Fl(e,RA):`https://${t.config.authDomain}/${kA}`,s={apiKey:e.apiKey,appName:t.name,v:Ps},r=NA.get(t.config.apiHost);r&&(s.eid=r);const i=t._getFrameworks();return i.length&&(s.fw=i.join(",")),`${n}?${Ns(s).slice(1)}`}async function LA(t){const e=await TA(t),n=ht().gapi;return C(n,t,"internal-error"),e.open({where:document.body,url:PA(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:AA,dontclear:!0},s=>new Promise(async(r,i)=>{await s.restyle({setHideOnLeave:!1});const o=tt(t,"network-request-failed"),a=ht().setTimeout(()=>{i(o)},IA.get());function c(){ht().clearTimeout(a),r(s)}s.ping(c).then(c,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OA={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},DA=500,xA=600,MA="_blank",FA="http://localhost";class Sh{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function UA(t,e,n,s=DA,r=xA){const i=Math.max((window.screen.availHeight-r)/2,0).toString(),o=Math.max((window.screen.availWidth-s)/2,0).toString();let a="";const c={...OA,width:s.toString(),height:r.toString(),top:i,left:o},l=Re().toLowerCase();n&&(a=Zg(l)?MA:n),Xg(l)&&(e=e||FA,c.scrollbars="yes");const u=Object.entries(c).reduce((h,[f,p])=>`${h}${f}=${p},`,"");if(ER(l)&&a!=="_self")return $A(e||"",a),new Sh(null);const d=window.open(e||"",a,u);C(d,t,"popup-blocked");try{d.focus()}catch{}return new Sh(d)}function $A(t,e){const n=document.createElement("a");n.href=t,n.target=e;const s=document.createEvent("MouseEvent");s.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BA="__/auth/handler",HA="emulator/auth/handler",WA=encodeURIComponent("fac");async function Th(t,e,n,s,r,i){C(t.config.authDomain,t,"auth-domain-config-required"),C(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:s,v:Ps,eventId:r};if(e instanceof Wl){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",Ii(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,d]of Object.entries({}))o[u]=d}if(e instanceof jr){const u=e.getScopes().filter(d=>d!=="");u.length>0&&(o.scopes=u.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const c=await t._getAppCheckToken(),l=c?`#${WA}=${encodeURIComponent(c)}`:"";return`${VA(t)}?${Ns(a).slice(1)}${l}`}function VA({config:t}){return t.emulator?Fl(t,HA):`https://${t.authDomain}/${BA}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ma="webStorageSupport";class jA{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=gm,this._completeRedirectFn=Cm,this._overrideRedirectResult=dA}async _openPopup(e,n,s,r){Pt(this.eventManagers[e._key()]?.manager,"_initialize() not called before _openPopup()");const i=await Th(e,n,s,lc(),r);return UA(e,i,Vl())}async _openRedirect(e,n,s,r){await this._originValidation(e);const i=await Th(e,n,s,lc(),r);return YR(i),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:r,promise:i}=this.eventManagers[n];return r?Promise.resolve(r):(Pt(i,"If manager is not set, promise should be"),i)}const s=this.initAndGetManager(e);return this.eventManagers[n]={promise:s},s.catch(()=>{delete this.eventManagers[n]}),s}async initAndGetManager(e){const n=await LA(e),s=new mA(e);return n.register("authEvent",r=>(C(r?.authEvent,e,"invalid-auth-event"),{status:s.onEvent(r.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=n,s}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(ma,{type:ma},r=>{const i=r?.[0]?.[ma];i!==void 0&&n(!!i),ft(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=EA(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return rm()||Qg()||Bl()}}const qA=jA;var Ih="@firebase/auth",kh="1.11.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function GA(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function YA(t){Zt(new Rt("auth",(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=s.options;C(o&&!o.includes(":"),"invalid-api-key",{appName:s.name});const c={apiKey:o,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:im(t)},l=new kR(s,r,i,c);return OR(l,n),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,s)=>{e.getProvider("auth-internal").initialize()})),Zt(new Rt("auth-internal",e=>{const n=Fs(e.getProvider("auth").getImmediate());return(s=>new zA(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),St(Ih,kh,GA(t)),St(Ih,kh,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`)}`);return}alert(`Sign-in failed: ${n}`)}let qs=null;const fN=()=>Math.random().toString(36).substring(2,15),pc="guestUser",pN=2880*60*1e3;function gN(){try{const t=typeof localStorage<"u"?localStorage.getItem(pc):null;if(!t)return null;const e=JSON.parse(t);if(!e||typeof e!="object"||!e.id)return null;if(e.expiresAt&&Date.now()>e.expiresAt){try{localStorage.removeItem(pc)}catch{}return null}return e}catch{return null}}function mN(t,e=pN){const n=Date.now(),s={id:t,createdAt:n,expiresAt:n+e};try{typeof localStorage<"u"&&localStorage.setItem(pc,JSON.stringify(s))}catch{}return s}function _e(){const t=q();if(t)return t;if(!qs){const e=gN();e&&e.id?qs=e.id:(qs=fN(),mN(qs))}return qs}function xn(){return xe.currentUser}function ql(){return xe.currentUser!==null}function q(){return xe.currentUser?.uid??null}function _N(){return new Promise(t=>{const e=um(xe,n=>{e(),t(n)})})}function zl(t,{truncate:e=7}={}){return um(xe,n=>{const s=!!n,r=n?.displayName||"Guest User",i=typeof r=="string"&&r.length>e?r.slice(0,e)+"...":r;s&&(oN().catch(o=>{console.warn("Failed to initialize presence:",o)}),cN(n).catch(o=>{console.warn("Failed to register user in directory:",o)}));try{t({user:n,isLoggedIn:s,userName:i})}catch{}})}const Om=async()=>{const t=new ut;t.setCustomParameters({prompt:"select_account"});const{isIOSStandalone:e}=Lm();try{if(e&&Pm){$("[AUTH] Using Safari external fallback"),Sr(!1),dN();return}$("[AUTH] Starting popup sign-in flow...");const n=await aA(xe,t);return $("[AUTH] Popup sign-in successful:",n.user.email),Sr(!1),n}catch(n){hN(n)}};async function Dm(){try{await aN(),await VR(xe),console.info("User signed out"),setTimeout(()=>Im(),1500)}catch(t){throw Am("Sign out",t),t}}const yN="765724787439-21p8n3e2tsfq2qk4oriq7ipp7m4o50ad.apps.googleusercontent.com";function xm(){return new Promise((t,e)=>{if(typeof google>"u"||!google.accounts?.oauth2){e(new Error("Google Identity Services not loaded"));return}const n=xn();console.log("[AUTH] Requesting contacts access via GIS Token Model..."),google.accounts.oauth2.initTokenClient({client_id:yN,scope:"https://www.googleapis.com/auth/contacts.readonly https://www.googleapis.com/auth/contacts.other.readonly",hint:n?.email||void 0,callback:r=>{if(r.error){console.error("[AUTH] Token request error:",r.error),r.error==="access_denied"?e(new Error("Authorization cancelled")):e(new Error(r.error_description||r.error));return}if(!r.access_token){e(new Error("No access token received"));return}console.log("[AUTH] Contacts access granted"),t(r.access_token)},error_callback:r=>{console.error("[AUTH] Token client error:",r),r.type==="popup_closed"?e(new Error("Authorization cancelled")):e(new Error(r.message||"Authorization failed"))}}).requestAccessToken()})}const vN=Object.freeze(Object.defineProperty({__proto__:null,auth:xe,authReady:Nm,getCurrentUser:xn,getCurrentUserAsync:_N,getLoggedInUserId:q,getUserId:_e,isLoggedIn:ql,onAuthChange:zl,requestContactsAccess:xm,setSafariExternalOpenArmed:Sr,signInWithAccountSelection:Om,signOutUser:Dm},Symbol.toStringTag,{value:"Module"})),wN=t=>String(t).replace(/[&<>"'`=\/]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","`":"&#x60;","=":"&#x3D;","/":"&#x2F;"})[n]),EN=(t,e)=>t.replace(/\$\{([^}]+)\}/g,(n,s)=>{const r=s.trim(),i=r.split(".").reduce((a,c)=>a?.[c],e);return i==null?"":r.endsWith("Html")?String(i):wN(String(i))}),bN=(t,e={})=>{const n=document.createElement("template");return n.innerHTML=EN(t,e),n.content.cloneNode(!0)},CN=(t,e)=>{const n=[];let s=e;for(;s&&s!==t;){const r=s.parentElement;if(!r)break;const i=Array.prototype.indexOf.call(r.children,s);n.push(i),s=r}return n.reverse()},SN=(t,e)=>e.reduce((n,s)=>n&&n.children?n.children[s]:null,t),TN=t=>Array.from(t.querySelectorAll("input, textarea, select")).map(e=>({name:e.name,id:e.id,path:CN(t,e),value:e.value,checked:e.checked,selectionStart:e.selectionStart,selectionEnd:e.selectionEnd,wasFocused:document.activeElement===e})),IN=t=>typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(String(t)):String(t).replace(/[^_a-zA-Z0-9-]/g,e=>"\\"+e),kN=(t,e)=>{e.forEach(n=>{let s=null;if(n.name){const r=t.querySelectorAll("input[name], textarea[name], select[name]");for(const i of r)if(i.getAttribute("name")===n.name){s=i;break}}else if(n.id)try{s=t.querySelector("#"+IN(n.id))}catch{s=t.querySelector(`#${n.id}`)}else n.path&&(s=SN(t,n.path));if(s){if(s.value=n.value,n.checked!==void 0&&(s.checked=n.checked),n.selectionStart!=null&&s.setSelectionRange)try{s.setSelectionRange(n.selectionStart,n.selectionEnd)}catch{}if(n.wasFocused)try{s.focus()}catch{}}})},RN=t=>Array.from(t.querySelectorAll("video, audio")).map(e=>({src:e.currentSrc||e.src,currentTime:e.currentTime,paused:e.paused,volume:e.volume,playbackRate:e.playbackRate,muted:e.muted})),AN=(t,e)=>{const n=t.querySelectorAll("video, audio");for(const s of n)if(s.currentSrc===e||s.src===e)return s;return null},NN=(t,e)=>{e.forEach(n=>{if(!n.src)return;const s=AN(t,n.src);s&&(s.currentTime=n.currentTime,s.volume=n.volume,s.playbackRate=n.playbackRate,s.muted=n.muted,n.paused||s.play().catch(()=>{}))})},PN=()=>document.readyState!=="loading",Gl=({initialProps:t={},template:e="",handlers:n={},parent:s=null,containerTag:r="div",className:i="",onMount:o=null,onCleanup:a=null,autoAppend:c=!0,preserveInputState:l=!0}={})=>{if(!PN())return console.error("createComponent: DOM must be ready before creating components."),null;const u=document.createElement(r);i&&(u.className=i);let d={...t};const h=new Set,f=/\$\{([^}]+)\}/g;let p;for(;(p=f.exec(e))!==null;){const w=p[1].trim().split(".")[0];h.add(w)}const _=[],m=[],A={},x=()=>{let w=[],ce=[];l&&(w=TN(u),ce=RN(u)),u.textContent="";const ze=bN(e,d);u.appendChild(ze),Object.keys(n).forEach(Me=>{const be=u.querySelectorAll(`[onclick="${Me}"]`),Vn=n[Me];be.forEach(Yr=>{Yr.removeAttribute("onclick"),typeof Vn=="function"&&Yr.addEventListener("click",Vn)})}),l&&(kN(u,w),NN(u,ce)),_.forEach(Me=>Me({...d}))},B=w=>{if(!Array.isArray(w)||w.length===0)return;const ce={props:{...d},changedKeys:w};m.forEach(ze=>ze(ce))};for(const w of Object.keys(t))A[w]=[],Object.defineProperty(u,w,{get(){return d[w]},set(ce){d[w]!==ce&&(d[w]=ce,h.has(w)&&x(),A[w].forEach(ze=>ze(ce)),B([w]))},configurable:!0,enumerable:!0});if(u.update=w=>{let ce=!1,ze=!1;const Me=[];for(const be in w)w[be]!==d[be]&&(d[be]=w[be],h.has(be)&&(ze=!0),A[be]&&A[be].forEach(Vn=>Vn(w[be])),ce=!0,Me.push(be));ce&&ze&&x(),Me.length>0&&B(Me)},u.onRender=w=>{typeof w=="function"&&_.push(w)},u.onAnyPropUpdated=w=>{typeof w=="function"&&m.push(w)},u.onPropUpdated=(w,ce)=>{typeof ce=="function"&&A[w]&&A[w].push(ce)},u.dispose=()=>{a&&(Array.isArray(a)?a.forEach(w=>{typeof w=="function"&&w()}):typeof a=="function"&&a()),_.length=0,m.length=0;for(const w in A)A[w].length=0;u.remove()},x(),c&&s&&!s.contains(u)&&s.appendChild(u),typeof o=="function")try{o(u)}catch(w){tN("[createComponent]: Error in onMount handler of component",w)}return u};let zs=null;const LN=(t,e=null)=>{if(zs)return zs;if(!t)return console.error("Auth UI: Parent element is required"),null;let n=null,s=null,r=10;typeof e=="number"&&(r=e);const i=ql();return zs=Gl({initialProps:{isLoggedIn:i,userName:"Guest User",signingInDisplay:"none",loginBtnMarginRightPx:r},template:`
    ...
    `,handlers:{handleLogin:Om,handleLogout:Dm},onMount:o=>{const a=c=>{const l=o.querySelector("#goog-login-btn"),u=o.querySelector("#goog-logout-btn");l&&u&&(l.disabled=c,u.disabled=!c)};a(i),n=zl(({isLoggedIn:c,userName:l})=>{$("[AuthComponent] Auth state changed:",{isLoggedIn:c,userName:l}),a(c),o.update({isLoggedIn:c,userName:l,signingInDisplay:"none"})}),s=rN(c=>{$("[AuthComponent] One Tap status:",c),c==="signing_in"?o.update({signingInDisplay:"inline-block"}):o.update({signingInDisplay:"none"})})},onCleanup:()=>{n&&(n(),n=null),s&&(s(),s=null),zs=null},className:"auth-component",parent:t}),zs},Yl=t=>t?!0:(console.warn("Element not found. el.id: =>",t?.id??"(no id)","el: =>",t),console.trace(),!1),Ji=t=>{if(Yl(t))return t.classList.contains("hidden")},D=t=>{Yl(t)&&t.classList.contains("hidden")&&t.classList.remove("hidden")},v=t=>{Yl(t)&&!t.classList.contains("hidden")&&t.classList.add("hidden")},Mm=t=>t.classList.contains("small-frame"),Tr=t=>{if(t&&!Mm(t)){t.classList.add("small-frame");const e=document.createElement("div");e.classList.add("small-frame-toggle-div");const n=document.createElement("span");n.classList.add("small-frame-toggle-icon"),n.textContent="❮",e.appendChild(n),t.appendChild(e),e.addEventListener("click",()=>{t.classList.contains("closed")?(t.classList.remove("closed"),e.classList.remove("closed"),n.classList.remove("closed")):(t.classList.add("closed"),e.classList.add("closed"),n.classList.add("closed"))})}},Kt=t=>{if(Mm(t)){t.classList.remove("small-frame"),t.classList.remove("closed");const e=t.querySelector(".small-frame-toggle-div");e&&e.remove()}};function Kl(t){return document.pictureInPictureElement===t}function Fo(t="room"){const e=new URL(window.location);e.searchParams.delete(t),window.history.replaceState({},"",e)}const z=t=>{const e=document.getElementById(t);return e||(console.warn(`Element with id: ${t} not found.`),null)};let je=null,cn=null,Uo=null,Jl=null,Fe=null,fe=null,ne=null,se=null,M=null,Ie=null,Be=null,qe=null,nt=null,Us=null,Fm=null,st=null,$o=null,rn=null,$s=null,Bs=null,Mn=null,Xl=null,Ql=null,Zl=null,eu=null,ts=null,Ir=null;function Ah(){je=z("lobby"),cn=z("lobby-call-btn"),Uo=z("title-auth-bar"),Jl=z("videos"),Fe=z("local-video-el"),fe=z("local-video-box"),ne=z("remote-video-el"),se=z("remote-video-box"),M=z("shared-video-el"),Ie=z("shared-video-box"),Be=z("chat-controls"),qe=z("call-btn"),nt=z("hang-up-btn"),Us=z("switch-camera-btn"),st=z("mute-btn"),$o=z("fullscreen-partner-btn"),rn=z("remote-pip-btn"),$s=z("mic-btn"),Bs=z("camera-btn"),Mn=z("exit-watch-mode-btn"),Xl=z("app-pip-btn"),Ql=z("app-title-h1"),Zl=z("app-title-a"),eu=z("app-title-span"),ts=z("paste-join-btn"),Ir=z("add-contact-btn")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ah):Ah();const Um=()=>({lobbyDiv:je,lobbyCallBtn:cn,titleAuthBar:Uo,videosWrapper:Jl,localVideoEl:Fe,localBoxEl:fe,remoteVideoEl:ne,remoteBoxEl:se,sharedVideoEl:M,sharedBoxEl:Ie,chatControls:Be,callBtn:qe,hangUpBtn:nt,switchCameraBtn:Us,installBtn:Fm,mutePartnerBtn:st,fullscreenPartnerBtn:$o,remotePipBtn:rn,micBtn:$s,cameraBtn:Bs,exitWatchModeBtn:Mn,appPipBtn:Xl,appTitleH1:Ql,appTitleA:Zl,appTitleSpan:eu,pasteJoinBtn:ts,addContactBtn:Ir});function $m(t,e=3,n=100){return new Promise(s=>{let r=0;const i=()=>{const o=document.getElementById(t);if(o){s(o);return}if(r++,r>=e){console.warn(`Element ${t} not found after ${e} attempts`),s(null);return}setTimeout(i,n)};i()})}async function Bm(t,e=3,n=100){const s={},r=t.map(async i=>{const o=await $m(i,e,n);return s[i]=o,o});return await Promise.all(r),s}async function ON(){const t=await Bm(["searchBtn","searchQuery","searchResults"],5,200),e=document.querySelector(".search-section");t.searchContainer=e;const n=Object.entries(t).filter(([s,r])=>!r).map(([s])=>s);return n.length>0&&console.warn("Some YouTube elements not found:",n),t}const DN=Object.freeze(Object.defineProperty({__proto__:null,get addContactBtn(){return Ir},get appPipBtn(){return Xl},get appTitleA(){return Zl},get appTitleH1(){return Ql},get appTitleSpan(){return eu},get callBtn(){return qe},get cameraBtn(){return Bs},get chatControls(){return Be},get exitWatchModeBtn(){return Mn},get fullscreenPartnerBtn(){return $o},getElements:Um,get hangUpBtn(){return nt},initializeYouTubeElements:ON,installBtn:Fm,get lobbyCallBtn(){return cn},get lobbyDiv(){return je},get localBoxEl(){return fe},get localVideoEl(){return Fe},get micBtn(){return $s},get mutePartnerBtn(){return st},get pasteJoinBtn(){return ts},get remoteBoxEl(){return se},get remotePipBtn(){return rn},get remoteVideoEl(){return ne},robustElementAccess:$m,get sharedBoxEl(){return Ie},get sharedVideoEl(){return M},get switchCameraBtn(){return Us},get titleAuthBar(){return Uo},get videosWrapper(){return Jl},waitForElements:Bm},Symbol.toStringTag,{value:"Module"})),Nh="yt-video-box",gc="yt-player-root";let J=null,Ot=!1;const ir=()=>J,xN=()=>Ot,Hm=t=>Ot=t,ns=()=>{const t=document.getElementById(Nh);if(!t)throw new Error(`Container #${Nh} not found`);return t};function MN(){return new Promise(t=>{window.YT&&window.YT.Player?t():window.onYouTubeIframeAPIReady=()=>{t()}})}function Wm(){const t=ns();if(!document.getElementById(gc)){const e=document.createElement("div");e.id=gc,t.appendChild(e)}D(t)}function Xi(){const t=ns();v(t)}function _a(){const t=ns();return t&&!t.classList.contains("hidden")}function mc(t){return t?t.includes("youtube.com")||t.includes("youtu.be"):!1}function Vm(t){if(!t)return null;const e=[/(?:youtube\.com\/watch\?v=)([\w-]+)/,/(?:youtu\.be\/)([\w-]+)/,/(?:youtube\.com\/embed\/)([\w-]+)/,/(?:youtube\.com\/shorts\/)([\w-]+)/];for(const n of e){const s=t.match(n);if(s&&s[1])return s[1]}return null}async function FN({url:t,onReady:e,onStateChange:n}){const s=Vm(t);if(!s)throw new Error("Invalid YouTube URL");if(await MN(),J){try{J.destroy()}catch(o){console.warn("Error destroying previous YouTube player:",o)}J=null}const r=(o=!0)=>{const a=ns(),c=J.getIframe();if(c&&a){try{a.tabIndex=-1,a.focus({preventScroll:!0})}catch{if(document.activeElement===c)try{c.blur()}catch{}}if(o){const l=u=>{if(u.code==="Space"){const d=ns(),h=J.getIframe();if(document.activeElement===h||document.activeElement===d)return;u.preventDefault(),console.debug("Space pressed, refocusing iframe"),J.getPlayerState()!==window.YT.PlayerState.PLAYING?nu():zr()}};document.addEventListener("keydown",l,{once:!0})}}},i=()=>{const o=ns(),a=J.getIframe();if(o&&a&&document.activeElement!==a)try{a.focus()}catch{}};return Wm(),new Promise((o,a)=>{try{J=new window.YT.Player(gc,{videoId:s,playerVars:{autoplay:1,mute:0,controls:1,fs:1,rel:0,modestbranding:1,disablekb:0,origin:window.location.origin},events:{onReady:c=>{Ot=!0,e&&e(c),o(J)},onStateChange:c=>{c.data===window.YT.PlayerState.ENDED&&r(!1),c.data===window.YT.PlayerState.PAUSED&&r(),c.data===window.YT.PlayerState.PLAYING&&i(),n&&n(c)},onError:c=>{console.error("YouTube player error:",c.data),a(new Error(`YouTube error: ${c.data}`))}}})}catch(c){a(c)}})}function tu(){if(J){try{Xi(),J.destroy()}catch(t){console.warn("Error destroying YouTube player:",t)}J=null,Ot=!1}}function nu(){J&&Ot&&J.playVideo()}function zr(){J&&Ot&&J.pauseVideo()}function UN(t){J&&Ot&&J.seekTo(t,!0)}function Qi(){return J&&Ot?J.getCurrentTime():0}function su(){return J&&Ot?J.getPlayerState():-1}const Vt={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5};let ye=null,Lt=null,jm=!1,rt="none",or=null,He=null;const Fn=()=>jm,qm=t=>jm=t,at=()=>rt,$N=t=>{["yt","url","file","none"].includes(t)?rt=t:console.warn("Invalid lastWatched platform:",t)};let jt=!1,ar=null,ss=0,ya=!1;async function rs(t){if(!ye)return;console.debug("Updating watch sync state, roomId:",ye);const e=Oo(ye);try{await En(e,{...t,updatedBy:Lt})}catch(n){console.error("Failed to update watch state:",n)}}function BN(t,e,n){if(!t)return;ye=t,Lt=n;const s=Oo(t),r=Do(t);nr(s,jN,t),nr(r,VN,t),XN()}function ru(t){return typeof t=="string"&&t.startsWith("blob:")}async function HN(t,e){if(!ye||!Lt)return!1;const n=Do(ye);try{return await re(n,{fileName:t,requestedBy:Lt,timestamp:Date.now()}),He&&clearTimeout(He),He=setTimeout(()=>{_c()},300*1e3),!0}catch(s){return console.error("Failed to create watch request:",s),!1}}async function WN(t){if(!ye)return!1;const e=Do(ye);try{await Ve(e)}catch(n){console.warn("Failed to remove watch request:",n)}return He&&(clearTimeout(He),He=null),await kr(t)}async function _c(){if(!ye)return;He&&(clearTimeout(He),He=null);const t=Do(ye);try{await Ve(t)}catch(e){console.warn("Failed to cancel watch request:",e)}}function VN(t){const e=t.val();if(!e){He&&(clearTimeout(He),He=null);return}e.requestedBy!==Lt&&window.onFileWatchRequestReceived&&window.onFileWatchRequestReceived(e.fileName)}function jN(t){const e=t.val();e&&e.updatedBy!==Lt&&(Date.now()-ss<500||(e.url&&e.url!==or&&!ru(e.url)&&qN(e.url),e.isYouTube?zN(e):JN(e)))}function qN(t){or=t,mc(t)?(v(Ie),zm(t),rt="yt"):(tu(),D(Ie),M.src=t,rt="url"),eo()}function zN(t){!ir()||!xN()||(GN(t),YN(t))}function GN(t){const e=su(),n=e===Vt.PLAYING;if([Vt.BUFFERING,Vt.UNSTARTED].includes(e)){KN();return}jt||(t.playing&&!n?(nu(),rt="yt"):!t.playing&&n&&(zr(),rt="yt"))}function YN(t){if(t.currentTime===void 0)return;const e=Qi();Math.abs(e-t.currentTime)>.3&&!jt&&(UN(t.currentTime),setTimeout(()=>{t.playing?nu():zr(),rt="yt"},500))}function KN(){jt=!0,clearTimeout(ar),ar=setTimeout(async()=>{jt=!1;const t=su()===Vt.PLAYING;await rs({playing:t,currentTime:Qi()})},700)}function JN(t){ss=Date.now(),t.playing!==void 0&&(t.playing&&M.paused?M.play().catch(e=>console.warn("Play failed:",e)):!t.playing&&!M.paused&&M.pause()),t.currentTime!==void 0&&Math.abs(M.currentTime-t.currentTime)>1&&(M.currentTime=t.currentTime,t.playing?M.play().catch(n=>console.warn("Play failed:",n)):M.pause())}function XN(){const t=()=>{rt!=="file"&&(rt="url")};M.addEventListener("play",async()=>{!ir()&&ye&&(ss=Date.now(),await rs({playing:!0,currentTime:M.currentTime,isYouTube:!1})),t()}),M.addEventListener("pause",async()=>{M.seeking||(!ir()&&ye&&(ss=Date.now(),console.log("[SYNC DEBUG] Local pause event:",{currentTime:M.currentTime}),await rs({playing:!1,currentTime:M.currentTime,isYouTube:!1})),t())}),M.addEventListener("playing",()=>{ya=!0}),M.addEventListener("pause",()=>{M.seeking||(ya=!1)},!0),M.addEventListener("seeked",async()=>{!ir()&&ye&&(ss=Date.now(),await rs({currentTime:M.currentTime,playing:ya,isYouTube:!1})),t()})}async function QN(t){if(!t)return!1;ss=Date.now();const e=ru(t);if(mc(t)){if(v(Ie),!await zm(t))return!1;rt="yt"}else tu(),D(Ie),M.src=t,rt=e?"file":"url";if(ye){const n=Oo(ye);e?await re(n,{playing:!1,currentTime:0,isYouTube:!1,updatedBy:Lt}):re(n,{url:t,playing:!1,currentTime:0,isYouTube:mc(t),updatedBy:Lt})}return eo(),!0}async function kr(t){let e;if(t instanceof File){if(!t.type.startsWith("video/"))return console.warn("Invalid file type:",t.type),!1;e=URL.createObjectURL(t)}else if(typeof t=="string")e=t;else if(t?.url)e=t.url;else return console.warn("Invalid video source:",t),!1;or=e;const n=await QN(e);return n||ru(or)&&t instanceof File&&(URL.revokeObjectURL(e),or=null),n}async function zm(t){if(!Vm(t))return console.error("Invalid YouTube URL:",t),!1;try{return await FN({url:t,onReady:n=>{if(Hm(!0),ye){const s=Oo(ye);re(s,{url:t,playing:!1,currentTime:0,isYouTube:!0,updatedBy:Lt})}},onStateChange:async n=>{if(!ir())return;const r=n.data===Vt.PLAYING,i=n.data===Vt.PAUSED;if(n.data===Vt.BUFFERING){jt=!0,ar&&clearTimeout(ar),ar=setTimeout(async()=>{jt=!1;const c=su()===Vt.PLAYING;await rs({playing:c,currentTime:Qi()})},700);return}i&&jt||!jt&&(r||i)&&await rs({playing:r,currentTime:Qi()})}}),!0}catch(n){return console.error("Failed to load YouTube video:",n),!1}}function ZN(t,{inactivityMs:e=3e3,listenTarget:n=document,onShow:s=null,onHide:r=null,hideOnEsc:i=!1,excludeEvents:o=["keydown"]}={}){if(!t)return()=>{};let a=null;const l=["pointermove","pointerdown","pointerup","touchstart","touchmove","mousemove","mousedown","keydown"].filter(m=>!Array.isArray(o)||!o.includes(m));function u(){D(t);try{typeof s=="function"&&s()}catch(m){console.warn("showHideOnInactivity onShow callback error:",m)}a&&clearTimeout(a),a=setTimeout(()=>{v(t);try{typeof r=="function"&&r()}catch(m){console.warn("showHideOnInactivity onHide callback error:",m)}a=null},e)}l.forEach(m=>n.addEventListener(m,u,{passive:!0}));function d(){if(document.hidden){a&&(clearTimeout(a),a=null);try{v(t)}catch(m){console.warn("showHideOnInactivity onHide (visibilitychange) callback error:",m)}}else u()}document.addEventListener("visibilitychange",d);function h(m){if(!m.relatedTarget){a&&(clearTimeout(a),a=null),v(t);try{typeof r=="function"&&r()}catch(A){console.warn("showHideOnInactivity onHide (visibilitychange) callback error:",A)}}}n.addEventListener("mouseout",h);function f(m){if(i&&(m.key==="Escape"||m.key==="Esc")){a&&(clearTimeout(a),a=null),v(t);try{typeof r=="function"&&r()}catch(A){console.warn("showHideOnInactivity onHide (esc) callback error:",A)}}}document.addEventListener("keydown",f);function p(){a||u()}n.addEventListener("touchend",p,{passive:!0}),v(t);function _(){l.forEach(m=>n.removeEventListener(m,u)),document.removeEventListener("visibilitychange",d),n.removeEventListener("mouseout",h),n.removeEventListener("touchend",p),document.removeEventListener("keydown",f),a&&(clearTimeout(a),a=null)}return _}let wt=null,Et=null,Gm="user";function yc(){return Gm}function Ym(t){Gm=t}function Bo(){return wt instanceof MediaStream}function iu(){return!wt||!(wt instanceof MediaStream)?(console.error("Invalid remote MediaStream accessed:",wt),null):wt}function Km(t){wt=t}function Jm(){wt&&(wt.getTracks().forEach(t=>t.stop()),wt=null)}function Xm(){return Et instanceof MediaStream}function Ho(){return!Et||!(Et instanceof MediaStream)?(console.error("Invalid local MediaStream accessed:",Et),console.error("Call createLocalStream() before accessing local stream."),null):Et}function Zi(t){Et=t}function Qm(){Et&&(Et.getTracks().forEach(t=>t.stop()),Et=null)}const eP=Object.freeze(Object.defineProperty({__proto__:null,cleanupLocalStream:Qm,cleanupRemoteStream:Jm,getFacingMode:yc,getLocalStream:Ho,getRemoteStream:iu,hasLocalStream:Xm,hasRemoteStream:Bo,setFacingMode:Ym,setLocalStream:Zi,setRemoteStream:Km},Symbol.toStringTag,{value:"Module"}));let is=!1,ii=!1,Ph=null,Lh=null,cr=null;const vc=()=>is,ou=()=>{if(!is){if(!ne||!Bo()||ne.paused||ne.readyState<2){ii||(ii=!0,ne.addEventListener("playing",()=>{ii=!1,ou()},{once:!0}));return}if(ii=!1,is=!0,D(se),D(fe),Tr(fe),v(je),v(cn),qe.disabled=!0,qe.classList.add("disabled"),nt.disabled=!1,nt.classList.remove("disabled"),st.disabled=!1,st.classList.remove("disabled"),rn.disabled=!1,rn.classList.remove("disabled"),cr||(cr=ZN(Be,{inactivityMs:2500,hideOnEsc:!0})),!Ph){const t=()=>{is&&(Fn()?Tr(se):Kt(se),D(se))};ne.addEventListener("leavepictureinpicture",t),Ph=()=>ne.removeEventListener("leavepictureinpicture",t)}if(!Lh){const t=()=>v(se);ne.addEventListener("enterpictureinpicture",t),Lh=()=>ne.removeEventListener("enterpictureinpicture",t)}}},Zm=()=>{is&&(is=!1,Kl(ne)&&document.exitPictureInPicture().catch(()=>{}),Kt(fe),v(fe),Kt(se),v(se),qe.disabled=!1,qe.classList.remove("disabled"),nt.disabled=!0,nt.classList.add("disabled"),st.disabled=!0,st.classList.add("disabled"),rn.disabled=!0,rn.classList.add("disabled"),cr&&(cr(),cr=null),Fn()||(D(cn),D(je),D(Be)))},e_=()=>{if(!Bo())return!1;const t=iu();return t&&t.getVideoTracks().length>0&&t.getVideoTracks()[0].enabled&&t.getVideoTracks()[0].readyState==="live"};function tP(){return"pictureInPictureEnabled"in document&&typeof document.pictureInPictureEnabled=="boolean"&&document.pictureInPictureEnabled}function eo(){Fn()||(qm(!0),v(je),v(cn),Be.classList.remove("bottom"),Be.classList.add("watch-mode"),vc()?(v(qe),D(nt)):(v(nt),v($s),v(st),D(qe)),v(Bs),v(Us),D(Mn),D(Be),vc()&&(v(fe),Kt(fe),v(se),Kl(ne)?Kt(se):tP()?ne.requestPictureInPicture().then(()=>{Kt(se)}).catch(t=>{console.warn("Failed to enter Picture-in-Picture:",t),Tr(se),D(se)}):(Tr(se),D(se))))}function lr(){Fn()&&(v(Mn),D(qe),D(nt),D($s),D(st),D(Bs),D(Us),Be.classList.remove("watch-mode"),Be.classList.add("bottom"),D(Be),e_()&&(Kl(ne)&&document.exitPictureInPicture().catch(t=>{console.error("Failed to exit Picture-in-Picture:",t)}),Kt(se),D(se)),vc()?(Tr(fe),D(fe)):(D(je),D(cn),Kt(fe),v(fe)),qm(!1))}class os{constructor(){this.logs=[],this.isEnabled=!0,this.maxLogs=1e3,this.sessionId=this.generateSessionId()}log(e,n,s={}){if(!this.isEnabled)return;const r={timestamp:performance.now(),sessionId:this.sessionId,category:e,event:n,data:{...s},id:this.generateLogId()};this.logs.push(r),this.logs.length>this.maxLogs&&(this.logs=this.logs.slice(-this.maxLogs)),typeof window<"u"&&window.location?.hostname==="localhost"&&console.log(`[DIAG] ${e}:${n}`,s)}logListenerAttachment(e,n,s,r={}){this.log("LISTENER","ATTACHED",{roomId:e,listenerType:n,currentCount:s,...r})}logListenerCleanup(e,n,s={}){this.log("LISTENER","CLEANUP",{removedCount:e.length,preservedCount:n.length,removedRoomIds:e,preservedRoomIds:n,...s})}logDuplicateListener(e,n,s={}){this.log("LISTENER","DUPLICATE_PREVENTED",{roomId:e,listenerType:n,...s})}logIncomingCallEvent(e,n,s,r={}){this.log("INCOMING_CALL","DETECTED",{callerId:e,roomId:n,isFresh:s.isFresh,validationMethod:s.method,age:s.age,reason:s.reason,...r})}logNotificationDecision(e,n,s,r={}){this.log("INCOMING_CALL","NOTIFICATION_DECISION",{decision:e,reason:n,roomId:s,...r})}logCallingUILifecycle(e,n,s={}){this.log("CALLING_UI",e,{roomId:n,...s})}logFirebaseOperation(e,n,s=null,r={}){this.log("FIREBASE","OPERATION",{operation:e,success:n,error:s?{message:s.message,code:s.code,stack:s.stack}:null,...r})}logFirebaseConnectionState(e,n={}){this.log("FIREBASE","CONNECTION_STATE",{state:e,...n})}logRoomCreation(e,n,s,r={}){this.log("ROOM","CREATED",{roomId:e,isInitiator:n,creationTime:s.creationTime,listenerAttachTime:s.listenerAttachTime,timeDiff:s.listenerAttachTime-s.creationTime,...r})}logMemberJoinEvent(e,n,s,r={}){this.log("ROOM","MEMBER_JOINED",{roomId:e,memberId:n,joinedAt:s.joinedAt,role:s.role,...r})}logContactSave(e,n,s={}){this.log("CONTACT","SAVED",{contactId:e,roomId:n,...s})}logContactCall(e,n,s,r={}){this.log("CONTACT","CALL_INITIATED",{contactId:e,roomId:n,forceInitiator:s,...r})}logFreshnessValidation(e,n,s,r={}){this.log("FRESHNESS","VALIDATION",{roomId:e,method:n,result:{isFresh:s.isFresh,age:s.age,threshold:s.threshold,reason:s.reason},...r})}logRaceCondition(e,n,s,r={}){this.log("RACE_CONDITION",e,{roomId:n,events:s,...r})}getLogs(e={}){let n=[...this.logs];return e.category&&(n=n.filter(s=>s.category===e.category)),e.event&&(n=n.filter(s=>s.event===e.event)),e.roomId&&(n=n.filter(s=>s.data.roomId===e.roomId)),e.since&&(n=n.filter(s=>s.timestamp>=e.since)),e.until&&(n=n.filter(s=>s.timestamp<=e.until)),n}getCallFlowTrace(e){return this.getLogs({roomId:e}).sort((n,s)=>n.timestamp-s.timestamp)}getListenerDiagnostics(e=null){const n=this.getLogs({category:"LISTENER"});return e?n.filter(s=>s.data.roomId===e):n}getFailureAnalysis(){const e=this.logs.filter(n=>n.category==="FIREBASE"&&n.data.success===!1||n.category==="INCOMING_CALL"&&n.data.decision==="REJECT"||n.category==="LISTENER"&&n.event==="DUPLICATE_PREVENTED");return{totalFailures:e.length,firebaseFailures:e.filter(n=>n.category==="FIREBASE").length,rejectedCalls:e.filter(n=>n.category==="INCOMING_CALL"&&n.data.decision==="REJECT").length,duplicateListeners:e.filter(n=>n.event==="DUPLICATE_PREVENTED").length,failures:e}}exportDiagnostics(){return{sessionId:this.sessionId,exportTime:Date.now(),logCount:this.logs.length,logs:[...this.logs],summary:this.getFailureAnalysis()}}exportLogsAsJSON(){return JSON.stringify(this.exportDiagnostics(),null,2)}downloadLogs(e=null){e||(e=`diagnostic-logs-${this.sessionId}-${Date.now()}.json`);const n=this.exportLogsAsJSON(),s=new Blob([n],{type:"application/json"}),r=document.createElement("a");r.href=URL.createObjectURL(s),r.download=e,r.click(),URL.revokeObjectURL(r.href)}getLogsInTimeRange(e,n){return this.logs.filter(s=>s.timestamp>=e&&s.timestamp<=n)}getLogsSince(e){return this.logs.filter(n=>n.timestamp>=e)}clearOldLogs(e=1440*60*1e3){const n=Date.now()-e;this.logs=this.logs.filter(s=>s.timestamp>=n)}clearLogs(){this.logs=[]}persistLogs(){try{const e=`diagnostic-logs-${this.sessionId}`;return localStorage.setItem(e,this.exportLogsAsJSON()),e}catch(e){return console.warn("Failed to persist logs to localStorage:",e),null}}loadPersistedLogs(e){try{const n=localStorage.getItem(e);if(n){const s=JSON.parse(n);if(s.logs&&Array.isArray(s.logs)){const r=new Set(this.logs.map(o=>o.id)),i=s.logs.filter(o=>!r.has(o.id));return this.logs=[...this.logs,...i].sort((o,a)=>o.timestamp-a.timestamp),i.length}}return 0}catch(n){return console.warn("Failed to load persisted logs:",n),0}}static getPersistedLogKeys(){const e=[];for(let n=0;n<localStorage.length;n++){const s=localStorage.key(n);s&&s.startsWith("diagnostic-logs-")&&e.push(s)}return e}static cleanupPersistedLogs(e=1440*60*1e3){const n=Date.now()-e;os.getPersistedLogKeys().forEach(r=>{try{const i=localStorage.getItem(r);if(i){const o=JSON.parse(i);o.exportTime&&o.exportTime<n&&localStorage.removeItem(r)}}catch{localStorage.removeItem(r)}})}enable(){this.isEnabled=!0}disable(){this.isEnabled=!1}generateSessionId(){return`session_${performance.now()}_${Math.random().toString(36).substr(2,9)}`}generateLogId(){return`log_${performance.now()}_${Math.random().toString(36).substr(2,9)}`}formatTimestamp(e){return new Date(e).toISOString()}startTiming(e){const n=`timing_${e}_${Date.now()}`;return this.log("TIMING","START",{operation:e,timingId:n}),n}endTiming(e,n={}){const s=this.logs.find(r=>r.category==="TIMING"&&r.event==="START"&&r.data.timingId===e);if(s){const r=Date.now()-s.timestamp;return this.log("TIMING","END",{timingId:e,duration:r,operation:s.data.operation,...n}),r}return null}}let va=null;function y(){return va||(va=new os),va}typeof window<"u"&&(window.diagnosticLogger={getInstance:()=>y(),exportLogs:()=>{const e=y().exportLogsAsJSON();return console.log("Diagnostic logs exported:"),console.log(e),e},downloadLogs:t=>{y().downloadLogs(t),console.log("Diagnostic logs downloaded")},getRoomLogs:t=>{const n=y().getCallFlowTrace(t);return console.log(`Logs for room ${t}:`,n),n},getFailures:()=>{const e=y().getFailureAnalysis();return console.log("Failure analysis:",e),e},getListenerDiagnostics:t=>{const n=y().getListenerDiagnostics(t);return console.log("Listener diagnostics:",n),n},getLogsSince:t=>{const n=y().getLogsSince(t);return console.log(`Logs since ${new Date(t).toISOString()}:`,n),n},getLogsInRange:(t,e)=>{const s=y().getLogsInTimeRange(t,e);return console.log(`Logs from ${new Date(t).toISOString()} to ${new Date(e).toISOString()}:`,s),s},persistLogs:()=>{const e=y().persistLogs();return console.log(`Logs persisted with key: ${e}`),e},loadPersistedLogs:t=>{const n=y().loadPersistedLogs(t);return console.log(`Loaded ${n} persisted logs`),n},getPersistedKeys:()=>{const t=os.getPersistedLogKeys();return console.log("Persisted log keys:",t),t},clearLogs:()=>{y().clearLogs(),console.log("Diagnostic logs cleared")},enable:()=>{y().enable(),console.log("Diagnostic logging enabled")},disable:()=>{y().disable(),console.log("Diagnostic logging disabled")},getSessionInfo:()=>{const t=y(),e={sessionId:t.sessionId,logCount:t.logs.length,isEnabled:t.isEnabled,maxLogs:t.maxLogs};return console.log("Session info:",e),e},help:()=>{console.log(`
...
- diagnosticLogger.getLogsSince(Date.now() - 60000) // Last minute
  ...
  `,document.head.appendChild(t),zh=!0}function w0(t){t.showModal||(t.showModal=function(){this.setAttribute("open",""),this.style.display="block",this.style.position="fixed",this.style.top="50%",this.style.left="50%",this.style.transform="translate(-50%, -50%)";const e=getComputedStyle(document.documentElement).getPropertyValue("--z-ui-overlay").trim();this.style.zIndex=e||"1000"},t.close=function(){this.removeAttribute("open"),this.style.display="none"})}async function E0(t,e=null){if(navigator.clipboard&&navigator.clipboard.writeText)try{return await navigator.clipboard.writeText(t),!0}catch(n){return console.warn("Clipboard API failed, using fallback:",n),!1}if(!e)return!1;try{return e.select(),e.setSelectionRange(0,99999),document.execCommand("copy")}catch(n){return console.error("Fallback copy failed:",n),!1}}function b0(){const t=window.matchMedia&&window.matchMedia("(display-mode: standalone)").matches||navigator.standalone===!0,e=/iphone|ipad|ipod/i.test(navigator.userAgent||"");if(!t||!e||!window.location.hostname.includes("github.io"))return;const s="https://vidu-aae11.web.app",r=s.replace(/\/$/,"");let i;try{i=new URL(r).hostname}catch(l){console.error("[PWA Redirect] Invalid VITE_APP_HOSTING_URL:",s,l);return}if(window.location.hostname===i)return;const o="/HangVidU/";let a=window.location.pathname;a.startsWith(o)?a="/"+a.slice(o.length):a==="/HangVidU"&&(a="/");let c;try{c=new URL(a+window.location.search+window.location.hash,r).toString()}catch(l){console.error("[PWA Redirect] Failed to construct target URL:",l);return}console.log("[PWA Redirect] iOS standalone PWA on gh-pages → redirecting to Firebase Hosting:",c),window.location.replace(c)}eN(!0);y().disable();let pu=[];async function C0(){S0();const t=Um(),n=["localVideoEl","remoteVideoEl","localBoxEl","remoteBoxEl","chatControls","lobbyDiv","titleAuthBar"].filter(s=>!t[s]);if(n.length>0)return console.error("Critical elements missing:",n),!1;try{{const{setupPWA:i}=await lt(async()=>{const{setupPWA:o}=await import("./PWA-Bmwb-oTZ.js");return{setupPWA:o}},[]);await i()}c0(),k0(),await Nm;const s=LN(Uo);s&&pu.push(s.dispose);const r=document.querySelector(".top-right-menu");if(r){const i=d0({parent:r,hideWhenAllRead:!0});f0.setToggle(i)}return!0}catch(s){return console.error("Initialization error:",s),!1}}let kc=!1;function p_(){kc=!1}async function g_(){kc||(kc=!0,await g0(Fe),r0({getLocalStream:Ho,getLocalVideo:()=>Fe,getRemoteVideo:()=>ne,getPeerConnection:()=>ve.getState().pc,setLocalStream:Zi,micBtn:$s,cameraBtn:Bs,switchCameraBtn:Us,mutePartnerBtn:st,fullscreenPartnerBtn:$o,remotePipBtn:rn}),Fe&&(Fe.addEventListener("enterpictureinpicture",()=>fe&&v(fe)),Fe.addEventListener("leavepictureinpicture",()=>{fe&&!(Fn()&&e_())&&D(fe)})))}function S0(){v(se),v(fe),v(Ie),v(Be)}function m_(t){(t?.name==="NotAllowedError"||t?.name==="PermissionDeniedError")&&alert('Camera/microphone access is required for video calls. Please click "Allow" when prompted, or check your browser settings.'),p_()}function wi(t=null){return{localStream:Ho(),localVideoEl:Fe,remoteVideoEl:ne,mutePartnerBtn:st,setupRemoteStream:m0,setupWatchSync:BN,targetRoomId:t}}function Ei(t,e=!1){return t.success?(e&&t.roomLink&&y0(t.roomLink,{onCopy:()=>$("Link ready! Share with your partner."),onCancel:()=>$("Link ready! Use the copy button to use it, or create a new one.")}),!0):!1}async function Gr(t,{forceInitiator:e=!1}={}){try{await g_()}catch(i){return console.error("Failed to initialize local media stream:",i),m_(i),!1}const n=Date.now();if(e){y().logRoomCreation(t,!0,{creationTime:n,listenerAttachTime:n,timeDiff:0},{trigger:"force_initiator",reason:"calling_saved_contact"});const i=await ve.createCall(wi(t));return Ei(i,!1)}let s=await ee.checkRoomStatus(t);if(s.exists&&!s.hasMembers){let o=0;for(;o<3&&!s.hasMembers;)await new Promise(a=>setTimeout(a,250*(o+1))),s=await ee.checkRoomStatus(t),o++}if(!s.exists||!s.hasMembers){y().logRoomCreation(t,!0,{creationTime:n,listenerAttachTime:n,timeDiff:0},{trigger:"room_empty_or_nonexistent",roomExists:s.exists,memberCount:s.memberCount||0});const i=await ve.createCall(wi(t));return Ei(i,!0)}y().log("ROOM","JOINING_EXISTING",{roomId:t,memberCount:s.memberCount,roomExists:s.exists});const r=await ve.answerCall({roomId:t,...wi()});return Ei(r,!1)}const Oe=new Set,__=new Map;function Gh(t){t&&(Lo(t),Oe.delete(t),__.delete(t),y().log("LISTENER","INCOMING_CLEANUP",{roomId:t,remainingListeners:Oe.size}))}function T0(){$(`[LISTENER] Removing all incoming listeners (${Oe.size} rooms)`);const t=Array.from(Oe);t.forEach(e=>{Lo(e)}),Oe.clear(),__.clear(),y().log("LISTENER","ALL_INCOMING_CLEANUP",{roomsCleared:t.length})}async function I0(t){const e=Date.now(),n=e+1440*60*1e3,s=q();if(s){const r=Ol(s,t);await re(r,{roomId:t,savedAt:e,expiresAt:n});return}try{const r=localStorage.getItem("recentCalls")||"{}",i=JSON.parse(r);i[t]={roomId:t,savedAt:e,expiresAt:n},localStorage.setItem("recentCalls",JSON.stringify(i))}catch(r){console.warn("Failed to save recent call to localStorage",r)}}async function Ia(t){const e=q();if(e){try{await Ve(Ol(e,t))}catch(n){console.warn("Failed to remove recent call from RTDB",n)}return}try{const n=localStorage.getItem("recentCalls")||"{}",s=JSON.parse(n);s[t]&&(delete s[t],localStorage.setItem("recentCalls",JSON.stringify(s)))}catch(n){console.warn("Failed to remove recent call from localStorage",n)}}function bs(t){t&&(Oe.has(t)&&(Oe.delete(t),Lo(t)),$(`[LISTENER] Attaching listener for room: ${t} (total: ${Oe.size+1})`),Oe.add(t),y().logListenerAttachment(t,"member_join",Oe.size,{action:"incoming_call_listener_attached"}),ee.onMemberJoined(t,async e=>{const n=e.key,s=e.val?e.val():null,r=_e();if(n&&n!==r){y().logMemberJoinEvent(t,n,s||{},{detectedBy:"incoming_call_listener",currentUserId:r});const i=s&&typeof s.joinedAt=="number"?s.joinedAt:null,o=2e4;let a=!1,c="none",l=0;if(i&&(l=Date.now()-i,a=l<o,c="joinedAt"),!a){const B=await t_(n,t),w=await n_(t);a=B||w,c=B?"outgoingState":w?"roomCreatedAt":"failed"}const u={isFresh:a,method:c,age:l,reason:a?"call_is_fresh":"call_is_stale"};if(y().logIncomingCallEvent(n,t,u,{memberData:s,joinedAt:i,CALL_FRESH_MS:o}),!a){y().logNotificationDecision("REJECT","stale_call",t,{age:l,validationMethod:c,joiningUserId:n});return}let d;try{d=await ee.getRoomData(t)}catch{return}if(!d||typeof d!="object")return;const h=!!d.offer,f=!!d.answer,p=d.createdBy;if(!h||f||p===r)return;const _=ve.getState();if(!!_.pc&&_.pc.connectionState==="connected"){y().logNotificationDecision("REJECT","already_in_call",t,{joiningUserId:n,currentCallState:_.pc?.connectionState});return}y().logNotificationDecision("SHOW","fresh_call_detected",t,{joiningUserId:n,freshnessResult:u});const A=await _P(t,n);as.playIncoming(),Fh.startCallIndicators(A);let x=!1;try{x=await Wo(`Incoming call from ${A}.

Accept?`)}finally{as.stop(),Fh.stopCallIndicators()}if(x)Gh(t),y().logNotificationDecision("ACCEPT","user_accepted",t,{joiningUserId:n}),Gr(t).catch(B=>{console.warn("Failed to answer incoming call:",B),y().logFirebaseOperation("join_room_on_accept",!1,B,{roomId:t,joiningUserId:n})});else{y().logNotificationDecision("REJECT","user_rejected",t,{joiningUserId:n});try{await ee.rejectCall(t,_e(),"user_rejected")}catch(B){console.warn("Failed to signal rejection via RTDB:",B)}await Ia(t).catch(B=>{console.warn("Failed to remove recent call on rejection:",B)})}}}),ee.onCallCancelled(t,async e=>{if(e&&typeof e.val=="function"&&e.val()){try{const{dismissActiveConfirmDialog:s}=await lt(async()=>{const{dismissActiveConfirmDialog:r}=await Promise.resolve().then(()=>lP);return{dismissActiveConfirmDialog:r}},void 0);typeof s=="function"&&s()}catch{}await Ia(t).catch(()=>{})}}),ee.onMemberLeft(t,async e=>{const n=e.key,s=_e();if(!(!n||n===s))try{(await ee.checkRoomStatus(t)).hasMembers||(await Ia(t),Gh(t),$(`Removed saved recent call and listeners for room ${t} because it is now empty`))}catch(r){console.warn("Failed to evaluate room status on member leave",r)}}))}async function Yh(){const t=Date.now();y().log("LISTENER","STARTUP_BEGIN",{timestamp:t,currentListenerCount:Oe.size});try{if(typeof window<"u"){const{getCurrentUserAsync:n}=await lt(async()=>{const{getCurrentUserAsync:s}=await Promise.resolve().then(()=>vN);return{getCurrentUserAsync:s}},void 0);await n()}}catch{}const e=q();if(y().log("LISTENER","AUTH_STATE_DETERMINED",{isLoggedIn:!!e,userId:e||"guest"}),e){const n=tR(e);try{const s=await et(n),r=s.exists()?s.val():null,i=new Set;if(r)for(const[o,a]of Object.entries(r)){if(!a||a.expiresAt&&a.expiresAt<Date.now()){await Ve(Ol(e,o)).catch(()=>{});continue}i.add(o)}try{const o=await Rr();Object.entries(o||{}).forEach(([a,c])=>{if(c?.roomId)i.add(c.roomId);else if(a&&e)try{const l=ro(e,a);i.add(l)}catch{}})}catch{}i.forEach(o=>bs(o)),y().log("LISTENER","STARTUP_COMPLETE",{storage:"rtdb",roomsToListen:Array.from(i),totalListeners:Oe.size,duration:Date.now()-t})}catch(s){console.warn("Failed to read recent calls from RTDB",s),y().logFirebaseOperation("read_recent_calls",!1,s,{storage:"rtdb",userId:e})}return}try{const n=localStorage.getItem("recentCalls")||"{}",s=JSON.parse(n),r={},i=new Set;for(const[o,a]of Object.entries(s||{}))!a||a.expiresAt&&a.expiresAt<Date.now()||(r[o]=a,i.add(o));try{const o=await Rr(),a=_e();Object.entries(o||{}).forEach(([c,l])=>{if(l?.roomId)i.add(l.roomId);else if(c&&a)try{const u=ro(a,c);i.add(u)}catch{}})}catch{}i.forEach(o=>bs(o)),localStorage.setItem("recentCalls",JSON.stringify(r)),y().log("LISTENER","STARTUP_COMPLETE",{storage:"localStorage",roomsToListen:Array.from(i),totalListeners:Oe.size,duration:Date.now()-t,expiredRoomsRemoved:Object.keys(s||{}).length-i.size})}catch(n){console.warn("Failed to read recent calls from localStorage",n),y().logFirebaseOperation("read_recent_calls",!1,n,{storage:"localStorage"})}}function ci(){return M&&Ie&&!Ie.classList.contains("hidden")&&M.src&&M.src.trim()!==""}let Kh=!1;function k0(){if(Kh)return;const t=()=>{const e=document.activeElement;return e&&(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)};document.addEventListener("keydown",e=>{t()||(e.key==="w"||e.key==="W")&&(console.log("=== W KEY PRESSED ==="),console.log("lastWatched:",at()),console.log("isYTVisible():",_a()),console.log("isSharedVideoVisible():",ci()),console.log("isWatchModeActive():",Fn()),at()==="yt"?_a()?(Xi(),lr()):(Wm(),eo()):(at()==="url"||at()==="file")&&(ci()?(v(Ie),lr()):(D(Ie),eo()))),e.key==="Escape"&&Fn()&&(at()==="yt"&&_a()?(zr(),Xi()):(at()==="url"&&ci()||at()==="file"&&ci())&&(M.pause(),v(Ie)),lr())}),Kh=!0}const y_=async()=>{try{await g_();const t=await ve.createCall(wi());Ei(t,!0)}catch(t){console.error("Failed to start call:",t),m_(t)}};qe.onclick=y_;cn.onclick=y_;ts&&(navigator.clipboard&&navigator.clipboard.readText?ts.onclick=async()=>{try{const t=await navigator.clipboard.readText(),e=R0(t);if(!e){alert("No valid room link found in clipboard.");return}await Gr(e)}catch(t){t.name==="NotAllowedError"?alert("Clipboard access denied. Please allow clipboard access or paste the link manually."):(console.error("Paste & Join failed:",t),alert("Failed to read clipboard. Please try again."))}}:(ts.style.display="none",console.warn("Paste & Join button hidden: Clipboard API not available in this context (requires HTTPS).")));Ir&&(Ir.onclick=async()=>{await NP()});Mn&&(Mn.onclick=()=>{at()==="yt"?(zr(),Xi()):(at()==="url"||at()==="file")&&(M.pause(),M.src.startsWith("blob:")&&URL.revokeObjectURL(M.src),v(Ie)),lr()});nt.onclick=async()=>{console.debug("Hanging up..."),await ve.hangUp({emitCancel:!0,reason:"user_hung_up"})};function R0(t){let e=t.trim();if(!e)return"";try{const n=new URL(e,window.location.origin),s=n.searchParams.get("room");if(s)return s;const r=n.hash.match(/room=([^&]+)/);return r?decodeURIComponent(r[1]):n.pathname.replace(/^\//,"")||e}catch{return e}}async function A0(){const e=new URLSearchParams(window.location.search).get("room");if(!e)return!1;const n=await Gr(e);return n||(Fo(),Zm()),n}const Rc=[];let ka=!1;async function v_(){if(ka||Rc.length===0)return;ka=!0;const{fromUserId:t,inviteData:e}=Rc.shift();try{if(await Wo(`${e.fromName||"Someone"} wants to connect.

Accept contact invitation?`))try{await SP(t,e),console.log("[INVITATIONS] Contact added:",e.fromName),await Un(je).catch(()=>{}),alert(`Added ${e.fromName} to your contacts!`)}catch(s){console.error("[INVITATIONS] Failed to accept invite:",s),alert("Failed to add contact. Please try again.")}else try{await TP(t),console.log("[INVITATIONS] Invite declined")}catch(s){console.error("[INVITATIONS] Failed to decline invite:",s)}}finally{ka=!1,v_()}}function Jh(){CP((t,e)=>{Rc.push({fromUserId:t,inviteData:e}),v_()}),IP(async(t,e)=>{console.log("[INVITATIONS] Your invite was accepted by:",e.acceptedByName),await Un(je).catch(()=>{}),alert(`${e.acceptedByName} accepted your invitation!`)})}b0();window.onload=async()=>{if(!await C0()){qe.disabled=!0,console.error("Initialization failed. Cannot start chat.");return}await Yh().catch(r=>console.warn("Failed to start saved-room listeners",r)),Un(je).catch(r=>{console.warn("Failed to render contacts list:",r)});let e=null;const n=zl(async({isLoggedIn:r,user:i})=>{try{const o=e===null,a=e===!0&&!r,c=e===!1&&r;e=r,await Un(je),a?($("[AUTH] User logged out - cleaning up messaging and listeners"),Ce.reset(),Jt.closeAllSessions(),T0(),Ec()):c?($("[AUTH] User logged in - re-attaching incoming listeners"),await Yh().catch(l=>console.warn("Failed to re-attach saved-room listeners on login",l)),Jh()):o&&r&&($("[AUTH] Initial load with logged-in user"),Jh())}catch(o){console.warn("Failed to handle auth change:",o)}});pu.push(()=>{try{typeof n=="function"&&n()}catch{}}),await A0()};window.addEventListener("beforeunload",async t=>{const e=ve.getState();if(e.pc&&e.pc.connectionState==="connected")return t.preventDefault(),t.returnValue="You are in an active call. Are you sure you want to leave?",t.returnValue;await N0()});ve.on("memberJoined",({memberId:t,roomId:e})=>{console.debug("CallController memberJoined event",{memberId:t,roomId:e}),ve.setPartnerId(t),Ce.showMessagesToggle(),cu(t,t),ou(),au().catch(n=>console.warn("Failed to clear calling state:",n)),I0(e).catch(n=>console.warn("Failed to save recent call:",n))});ve.on("memberLeft",({memberId:t})=>{console.info("Partner has left the call")});ve.on("cleanup",({roomId:t,partnerId:e,reason:n})=>{Sn(),Jm(),Zm(),Fo();const s=ve.getState();s.messagesUI&&typeof s.messagesUI.cleanup=="function"&&(s.messagesUI.cleanup(),s.messagesUI=null),e&&t&&setTimeout(()=>{yP(e,t,je).catch(r=>{console.warn("Failed to save contact after cleanup:",r)})},500)});async function N0(){await ve.hangUp({emitCancel:!0,reason:"page_unload"}),i0(),Qk(),document.pictureInPictureElement&&document.exitPictureInPicture().catch(e=>console.error(e));const t=ve.getState();t.messagesUI&&t.messagesUI.cleanup&&t.messagesUI.cleanup(),window.history.replaceState({},document.title,window.location.pathname),M.src="",Qm(),Fe&&Fe.srcObject&&(Fe.srcObject=null),ne&&ne.srcObject&&(ne.srcObject=null),lr(),Fo(),$N("none"),tu(),Hm(!1),l0(),pu.forEach(e=>e())}const P0=Object.freeze(Object.defineProperty({__proto__:null,joinOrCreateRoomWithId:Gr,listenForIncomingOnRoom:bs,resetLocalStreamInitFlag:p_},Symbol.toStringTag,{value:"Module"}));export{lt as _,Gl as c,$ as d,v as h,L0 as i,f0 as n,D as s};
