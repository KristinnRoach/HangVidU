const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/virtual_pwa-register-B3dX5AvG.js","assets/main-C_f1ECH2.js","assets/main-nkgRg9bR.css"])))=>i.map(i=>d[i]);
import{n as a,c as n,_ as o}from"./main-C_f1ECH2.js";const i="pwa-update";function r(e){if(a.has(i))return a.notifications.get(i);const t=n({template:`
