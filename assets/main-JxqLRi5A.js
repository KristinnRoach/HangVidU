(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();const ow="modulepreload",aw=function(t){return"/HangVidU/"+t},cd={},Pe=function(e,n,i){let s=Promise.resolve();if(n&&n.length>0){let c=function(l){return Promise.all(l.map(u=>Promise.resolve(u).then(d=>({status:"fulfilled",value:d}),d=>({status:"rejected",reason:d}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),a=o?.nonce||o?.getAttribute("nonce");s=c(n.map(l=>{if(l=aw(l),l in cd)return;cd[l]=!0;const u=l.endsWith(".css"),d=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const h=document.createElement("link");if(h.rel=u?"stylesheet":ow,u||(h.as="script"),h.crossOrigin="",h.href=l,a&&h.setAttribute("nonce",a),document.head.appendChild(h),u)return new Promise((f,p)=>{h.addEventListener("load",f),h.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return s.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return e().catch(r)})},k=typeof __SENTRY_DEBUG__>"u"||__SENTRY_DEBUG__,V=globalThis,On="10.34.0";function Co(){return To(V),V}function To(t){const e=t.__SENTRY__=t.__SENTRY__||{};return e.version=e.version||On,e[On]=e[On]||{}}function Fi(t,e,n=V){const i=n.__SENTRY__=n.__SENTRY__||{},s=i[On]=i[On]||{};return s[t]||(s[t]=e())}const cw=["debug","info","warn","error","log","assert","trace"],lw="Sentry Logger ",Ur={};function Ui(t){if(!("console"in V))return t();const e=V.console,n={},i=Object.keys(Ur);i.forEach(s=>{const r=Ur[s];n[s]=e[s],e[s]=r});try{return t()}finally{i.forEach(s=>{e[s]=n[s]})}}function uw(){dl().enabled=!0}function dw(){dl().enabled=!1}function Zf(){return dl().enabled}function hw(...t){ul("log",...t)}function fw(...t){ul("warn",...t)}function pw(...t){ul("error",...t)}function ul(t,...e){k&&Zf()&&Ui(()=>{V.console[t](`${lw}[${t}]:`,...e)})}function dl(){return k?Fi("loggerSettings",()=>({enabled:!1})):{enabled:!1}}const E={enable:uw,disable:dw,isEnabled:Zf,log:hw,warn:fw,error:pw},ep=50,Fn="?",ld=/\(error: (.*)\)/,ud=/captureMessage|captureException/;function tp(...t){const e=t.sort((n,i)=>n[0]-i[0]).map(n=>n[1]);return(n,i=0,s=0)=>{const r=[],o=n.split(`
`);for(let a=i;a<o.length;a++){let c=o[a];c.length>1024&&(c=c.slice(0,1024));const l=ld.test(c)?c.replace(ld,"$1"):c;if(!l.match(/\S*Error: /)){for(const u of e){const d=u(l);if(d){r.push(d);break}}if(r.length>=ep+s)break}}return mw(r.slice(s))}}function gw(t){return Array.isArray(t)?tp(...t):t}function mw(t){if(!t.length)return[];const e=Array.from(t);return/sentryWrapped/.test(dr(e).function||"")&&e.pop(),e.reverse(),ud.test(dr(e).function||"")&&(e.pop(),ud.test(dr(e).function||"")&&e.pop()),e.slice(0,ep).map(n=>({...n,filename:n.filename||dr(e).filename,function:n.function||Fn}))}function dr(t){return t[t.length-1]||{}}const ya="<anonymous>";function on(t){try{return!t||typeof t!="function"?ya:t.name||ya}catch{return ya}}function dd(t){const e=t.exception;if(e){const n=[];try{return e.values.forEach(i=>{i.stacktrace.frames&&n.push(...i.stacktrace.frames)}),n}catch{return}}}function np(t){return"__v_isVNode"in t&&t.__v_isVNode?"[VueVNode]":"[VueViewModel]"}const Tr={},hd={};function Zn(t,e){Tr[t]=Tr[t]||[],Tr[t].push(e)}function ei(t,e){if(!hd[t]){hd[t]=!0;try{e()}catch(n){k&&E.error(`Error while instrumenting ${t}`,n)}}}function rt(t,e){const n=t&&Tr[t];if(n)for(const i of n)try{i(e)}catch(s){k&&E.error(`Error while triggering instrumentation handler.
Type: ${t}
Name: ${on(i)}
Error:`,s)}}let wa=null;function _w(t){const e="error";Zn(e,t),ei(e,yw)}function yw(){wa=V.onerror,V.onerror=function(t,e,n,i,s){return rt("error",{column:i,error:s,line:n,msg:t,url:e}),wa?wa.apply(this,arguments):!1},V.onerror.__SENTRY_INSTRUMENTED__=!0}let va=null;function ww(t){const e="unhandledrejection";Zn(e,t),ei(e,vw)}function vw(){va=V.onunhandledrejection,V.onunhandledrejection=function(t){return rt("unhandledrejection",t),va?va.apply(this,arguments):!0},V.onunhandledrejection.__SENTRY_INSTRUMENTED__=!0}const ip=Object.prototype.toString;function So(t){switch(ip.call(t)){case"[object Error]":case"[object Exception]":case"[object DOMException]":case"[object WebAssembly.Exception]":return!0;default:return an(t,Error)}}function $i(t,e){return ip.call(t)===`[object ${e}]`}function sp(t){return $i(t,"ErrorEvent")}function fd(t){return $i(t,"DOMError")}function bw(t){return $i(t,"DOMException")}function At(t){return $i(t,"String")}function hl(t){return typeof t=="object"&&t!==null&&"__sentry_template_string__"in t&&"__sentry_template_values__"in t}function Io(t){return t===null||hl(t)||typeof t!="object"&&typeof t!="function"}function Is(t){return $i(t,"Object")}function ko(t){return typeof Event<"u"&&an(t,Event)}function Ew(t){return typeof Element<"u"&&an(t,Element)}function Cw(t){return $i(t,"RegExp")}function Gs(t){return!!(t?.then&&typeof t.then=="function")}function Tw(t){return Is(t)&&"nativeEvent"in t&&"preventDefault"in t&&"stopPropagation"in t}function an(t,e){try{return t instanceof e}catch{return!1}}function rp(t){return!!(typeof t=="object"&&t!==null&&(t.__isVue||t._isVue||t.__v_isVNode))}function op(t){return typeof Request<"u"&&an(t,Request)}const fl=V,Sw=80;function ap(t,e={}){if(!t)return"<unknown>";try{let n=t;const i=5,s=[];let r=0,o=0;const a=" > ",c=a.length;let l;const u=Array.isArray(e)?e:e.keyAttrs,d=!Array.isArray(e)&&e.maxStringLength||Sw;for(;n&&r++<i&&(l=Iw(n,u),!(l==="html"||r>1&&o+s.length*c+l.length>=d));)s.push(l),o+=l.length,n=n.parentNode;return s.reverse().join(a)}catch{return"<unknown>"}}function Iw(t,e){const n=t,i=[];if(!n?.tagName)return"";if(fl.HTMLElement&&n instanceof HTMLElement&&n.dataset){if(n.dataset.sentryComponent)return n.dataset.sentryComponent;if(n.dataset.sentryElement)return n.dataset.sentryElement}i.push(n.tagName.toLowerCase());const s=e?.length?e.filter(o=>n.getAttribute(o)).map(o=>[o,n.getAttribute(o)]):null;if(s?.length)s.forEach(o=>{i.push(`[${o[0]}="${o[1]}"]`)});else{n.id&&i.push(`#${n.id}`);const o=n.className;if(o&&At(o)){const a=o.split(/\s+/);for(const c of a)i.push(`.${c}`)}}const r=["aria-label","type","name","title","alt"];for(const o of r){const a=n.getAttribute(o);a&&i.push(`[${o}="${a}"]`)}return i.join("")}function pl(){try{return fl.document.location.href}catch{return""}}function kw(t){if(!fl.HTMLElement)return null;let e=t;const n=5;for(let i=0;i<n;i++){if(!e)return null;if(e instanceof HTMLElement){if(e.dataset.sentryComponent)return e.dataset.sentryComponent;if(e.dataset.sentryElement)return e.dataset.sentryElement}e=e.parentNode}return null}function Ue(t,e,n){if(!(e in t))return;const i=t[e];if(typeof i!="function")return;const s=n(i);typeof s=="function"&&cp(s,i);try{t[e]=s}catch{k&&E.log(`Failed to replace method "${e}" in object`,t)}}function cn(t,e,n){try{Object.defineProperty(t,e,{value:n,writable:!0,configurable:!0})}catch{k&&E.log(`Failed to add non-enumerable property "${e}" to object`,t)}}function cp(t,e){try{const n=e.prototype||{};t.prototype=e.prototype=n,cn(t,"__sentry_original__",e)}catch{}}function gl(t){return t.__sentry_original__}function lp(t){if(So(t))return{message:t.message,name:t.name,stack:t.stack,...gd(t)};if(ko(t)){const e={type:t.type,target:pd(t.target),currentTarget:pd(t.currentTarget),...gd(t)};return typeof CustomEvent<"u"&&an(t,CustomEvent)&&(e.detail=t.detail),e}else return t}function pd(t){try{return Ew(t)?ap(t):Object.prototype.toString.call(t)}catch{return"<unknown>"}}function gd(t){if(typeof t=="object"&&t!==null){const e={};for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e}else return{}}function Aw(t){const e=Object.keys(lp(t));return e.sort(),e[0]?e.join(", "):"[object has no keys]"}let ii;function Ao(t){if(ii!==void 0)return ii?ii(t):t();const e=Symbol.for("__SENTRY_SAFE_RANDOM_ID_WRAPPER__"),n=V;return e in n&&typeof n[e]=="function"?(ii=n[e],ii(t)):(ii=null,t())}function $r(){return Ao(()=>Math.random())}function Ro(){return Ao(()=>Date.now())}function oc(t,e=0){return typeof t!="string"||e===0||t.length<=e?t:`${t.slice(0,e)}...`}function md(t,e){if(!Array.isArray(t))return"";const n=[];for(let i=0;i<t.length;i++){const s=t[i];try{rp(s)?n.push(np(s)):n.push(String(s))}catch{n.push("[value cannot be serialized]")}}return n.join(e)}function Sr(t,e,n=!1){return At(t)?Cw(e)?e.test(t):At(e)?n?t===e:t.includes(e):!1:!1}function No(t,e=[],n=!1){return e.some(i=>Sr(t,i,n))}function Rw(){const t=V;return t.crypto||t.msCrypto}let ba;function Nw(){return $r()*16}function ze(t=Rw()){try{if(t?.randomUUID)return Ao(()=>t.randomUUID()).replace(/-/g,"")}catch{}return ba||(ba="10000000100040008000"+1e11),ba.replace(/[018]/g,e=>(e^(Nw()&15)>>e/4).toString(16))}function up(t){return t.exception?.values?.[0]}function kn(t){const{message:e,event_id:n}=t;if(e)return e;const i=up(t);return i?i.type&&i.value?`${i.type}: ${i.value}`:i.type||i.value||n||"<unknown>":n||"<unknown>"}function ac(t,e,n){const i=t.exception=t.exception||{},s=i.values=i.values||[],r=s[0]=s[0]||{};r.value||(r.value=e||""),r.type||(r.type="Error")}function Ci(t,e){const n=up(t);if(!n)return;const i={type:"generic",handled:!0},s=n.mechanism;if(n.mechanism={...i,...s,...e},e&&"data"in e){const r={...s?.data,...e.data};n.mechanism.data=r}}function _d(t){if(Pw(t))return!0;try{cn(t,"__sentry_captured__",!0)}catch{}return!1}function Pw(t){try{return t.__sentry_captured__}catch{}}const dp=1e3;function Ks(){return Ro()/dp}function Ow(){const{performance:t}=V;if(!t?.now||!t.timeOrigin)return Ks;const e=t.timeOrigin;return()=>(e+Ao(()=>t.now()))/dp}let yd;function Rt(){return(yd??(yd=Ow()))()}function Lw(t){const e=Rt(),n={sid:ze(),init:!0,timestamp:e,started:e,duration:0,status:"ok",errors:0,ignoreDuration:!1,toJSON:()=>Mw(n)};return t&&Ti(n,t),n}function Ti(t,e={}){if(e.user&&(!t.ipAddress&&e.user.ip_address&&(t.ipAddress=e.user.ip_address),!t.did&&!e.did&&(t.did=e.user.id||e.user.email||e.user.username)),t.timestamp=e.timestamp||Rt(),e.abnormal_mechanism&&(t.abnormal_mechanism=e.abnormal_mechanism),e.ignoreDuration&&(t.ignoreDuration=e.ignoreDuration),e.sid&&(t.sid=e.sid.length===32?e.sid:ze()),e.init!==void 0&&(t.init=e.init),!t.did&&e.did&&(t.did=`${e.did}`),typeof e.started=="number"&&(t.started=e.started),t.ignoreDuration)t.duration=void 0;else if(typeof e.duration=="number")t.duration=e.duration;else{const n=t.timestamp-t.started;t.duration=n>=0?n:0}e.release&&(t.release=e.release),e.environment&&(t.environment=e.environment),!t.ipAddress&&e.ipAddress&&(t.ipAddress=e.ipAddress),!t.userAgent&&e.userAgent&&(t.userAgent=e.userAgent),typeof e.errors=="number"&&(t.errors=e.errors),e.status&&(t.status=e.status)}function Dw(t,e){let n={};t.status==="ok"&&(n={status:"exited"}),Ti(t,n)}function Mw(t){return{sid:`${t.sid}`,init:t.init,started:new Date(t.started*1e3).toISOString(),timestamp:new Date(t.timestamp*1e3).toISOString(),status:t.status,errors:t.errors,did:typeof t.did=="number"||typeof t.did=="string"?`${t.did}`:void 0,duration:t.duration,abnormal_mechanism:t.abnormal_mechanism,attrs:{release:t.release,environment:t.environment,ip_address:t.ipAddress,user_agent:t.userAgent}}}function Ys(t,e,n=2){if(!e||typeof e!="object"||n<=0)return e;if(t&&Object.keys(e).length===0)return t;const i={...t};for(const s in e)Object.prototype.hasOwnProperty.call(e,s)&&(i[s]=Ys(i[s],e[s],n-1));return i}function wd(){return ze()}function hp(){return ze().substring(16)}const cc="_sentrySpan";function vd(t,e){e?cn(t,cc,e):delete t[cc]}function bd(t){return t[cc]}const xw=100;class Lt{constructor(){this._notifyingListeners=!1,this._scopeListeners=[],this._eventProcessors=[],this._breadcrumbs=[],this._attachments=[],this._user={},this._tags={},this._attributes={},this._extra={},this._contexts={},this._sdkProcessingMetadata={},this._propagationContext={traceId:wd(),sampleRand:$r()}}clone(){const e=new Lt;return e._breadcrumbs=[...this._breadcrumbs],e._tags={...this._tags},e._attributes={...this._attributes},e._extra={...this._extra},e._contexts={...this._contexts},this._contexts.flags&&(e._contexts.flags={values:[...this._contexts.flags.values]}),e._user=this._user,e._level=this._level,e._session=this._session,e._transactionName=this._transactionName,e._fingerprint=this._fingerprint,e._eventProcessors=[...this._eventProcessors],e._attachments=[...this._attachments],e._sdkProcessingMetadata={...this._sdkProcessingMetadata},e._propagationContext={...this._propagationContext},e._client=this._client,e._lastEventId=this._lastEventId,vd(e,bd(this)),e}setClient(e){this._client=e}setLastEventId(e){this._lastEventId=e}getClient(){return this._client}lastEventId(){return this._lastEventId}addScopeListener(e){this._scopeListeners.push(e)}addEventProcessor(e){return this._eventProcessors.push(e),this}setUser(e){return this._user=e||{email:void 0,id:void 0,ip_address:void 0,username:void 0},this._session&&Ti(this._session,{user:e}),this._notifyScopeListeners(),this}getUser(){return this._user}setTags(e){return this._tags={...this._tags,...e},this._notifyScopeListeners(),this}setTag(e,n){return this.setTags({[e]:n})}setAttributes(e){return this._attributes={...this._attributes,...e},this._notifyScopeListeners(),this}setAttribute(e,n){return this.setAttributes({[e]:n})}removeAttribute(e){return e in this._attributes&&(delete this._attributes[e],this._notifyScopeListeners()),this}setExtras(e){return this._extra={...this._extra,...e},this._notifyScopeListeners(),this}setExtra(e,n){return this._extra={...this._extra,[e]:n},this._notifyScopeListeners(),this}setFingerprint(e){return this._fingerprint=e,this._notifyScopeListeners(),this}setLevel(e){return this._level=e,this._notifyScopeListeners(),this}setTransactionName(e){return this._transactionName=e,this._notifyScopeListeners(),this}setContext(e,n){return n===null?delete this._contexts[e]:this._contexts[e]=n,this._notifyScopeListeners(),this}setSession(e){return e?this._session=e:delete this._session,this._notifyScopeListeners(),this}getSession(){return this._session}update(e){if(!e)return this;const n=typeof e=="function"?e(this):e,i=n instanceof Lt?n.getScopeData():Is(n)?e:void 0,{tags:s,attributes:r,extra:o,user:a,contexts:c,level:l,fingerprint:u=[],propagationContext:d}=i||{};return this._tags={...this._tags,...s},this._attributes={...this._attributes,...r},this._extra={...this._extra,...o},this._contexts={...this._contexts,...c},a&&Object.keys(a).length&&(this._user=a),l&&(this._level=l),u.length&&(this._fingerprint=u),d&&(this._propagationContext=d),this}clear(){return this._breadcrumbs=[],this._tags={},this._attributes={},this._extra={},this._user={},this._contexts={},this._level=void 0,this._transactionName=void 0,this._fingerprint=void 0,this._session=void 0,vd(this,void 0),this._attachments=[],this.setPropagationContext({traceId:wd(),sampleRand:$r()}),this._notifyScopeListeners(),this}addBreadcrumb(e,n){const i=typeof n=="number"?n:xw;if(i<=0)return this;const s={timestamp:Ks(),...e,message:e.message?oc(e.message,2048):e.message};return this._breadcrumbs.push(s),this._breadcrumbs.length>i&&(this._breadcrumbs=this._breadcrumbs.slice(-i),this._client?.recordDroppedEvent("buffer_overflow","log_item")),this._notifyScopeListeners(),this}getLastBreadcrumb(){return this._breadcrumbs[this._breadcrumbs.length-1]}clearBreadcrumbs(){return this._breadcrumbs=[],this._notifyScopeListeners(),this}addAttachment(e){return this._attachments.push(e),this}clearAttachments(){return this._attachments=[],this}getScopeData(){return{breadcrumbs:this._breadcrumbs,attachments:this._attachments,contexts:this._contexts,tags:this._tags,attributes:this._attributes,extra:this._extra,user:this._user,level:this._level,fingerprint:this._fingerprint||[],eventProcessors:this._eventProcessors,propagationContext:this._propagationContext,sdkProcessingMetadata:this._sdkProcessingMetadata,transactionName:this._transactionName,span:bd(this)}}setSDKProcessingMetadata(e){return this._sdkProcessingMetadata=Ys(this._sdkProcessingMetadata,e,2),this}setPropagationContext(e){return this._propagationContext=e,this}getPropagationContext(){return this._propagationContext}captureException(e,n){const i=n?.event_id||ze();if(!this._client)return k&&E.warn("No client configured on scope - will not capture exception!"),i;const s=new Error("Sentry syntheticException");return this._client.captureException(e,{originalException:e,syntheticException:s,...n,event_id:i},this),i}captureMessage(e,n,i){const s=i?.event_id||ze();if(!this._client)return k&&E.warn("No client configured on scope - will not capture message!"),s;const r=i?.syntheticException??new Error(e);return this._client.captureMessage(e,n,{originalException:e,syntheticException:r,...i,event_id:s},this),s}captureEvent(e,n){const i=n?.event_id||ze();return this._client?(this._client.captureEvent(e,{...n,event_id:i},this),i):(k&&E.warn("No client configured on scope - will not capture event!"),i)}_notifyScopeListeners(){this._notifyingListeners||(this._notifyingListeners=!0,this._scopeListeners.forEach(e=>{e(this)}),this._notifyingListeners=!1)}}function Fw(){return Fi("defaultCurrentScope",()=>new Lt)}function Uw(){return Fi("defaultIsolationScope",()=>new Lt)}class $w{constructor(e,n){let i;e?i=e:i=new Lt;let s;n?s=n:s=new Lt,this._stack=[{scope:i}],this._isolationScope=s}withScope(e){const n=this._pushScope();let i;try{i=e(n)}catch(s){throw this._popScope(),s}return Gs(i)?i.then(s=>(this._popScope(),s),s=>{throw this._popScope(),s}):(this._popScope(),i)}getClient(){return this.getStackTop().client}getScope(){return this.getStackTop().scope}getIsolationScope(){return this._isolationScope}getStackTop(){return this._stack[this._stack.length-1]}_pushScope(){const e=this.getScope().clone();return this._stack.push({client:this.getClient(),scope:e}),e}_popScope(){return this._stack.length<=1?!1:!!this._stack.pop()}}function Si(){const t=Co(),e=To(t);return e.stack=e.stack||new $w(Fw(),Uw())}function Bw(t){return Si().withScope(t)}function Hw(t,e){const n=Si();return n.withScope(()=>(n.getStackTop().scope=t,e(t)))}function Ed(t){return Si().withScope(()=>t(Si().getIsolationScope()))}function Vw(){return{withIsolationScope:Ed,withScope:Bw,withSetScope:Hw,withSetIsolationScope:(t,e)=>Ed(e),getCurrentScope:()=>Si().getScope(),getIsolationScope:()=>Si().getIsolationScope()}}function ml(t){const e=To(t);return e.acs?e.acs:Vw()}function gn(){const t=Co();return ml(t).getCurrentScope()}function Js(){const t=Co();return ml(t).getIsolationScope()}function Ww(){return Fi("globalScope",()=>new Lt)}function jw(...t){const e=Co(),n=ml(e);if(t.length===2){const[i,s]=t;return i?n.withSetScope(i,s):n.withScope(s)}return n.withScope(t[0])}function Ce(){return gn().getClient()}function qw(t){const e=t.getPropagationContext(),{traceId:n,parentSpanId:i,propagationSpanId:s}=e,r={trace_id:n,span_id:s||hp()};return i&&(r.parent_span_id=i),r}const zw="sentry.source",Gw="sentry.sample_rate",Kw="sentry.previous_trace_sample_rate",Yw="sentry.op",Jw="sentry.origin",fp="sentry.profile_id",pp="sentry.exclusive_time",Xw=0,Qw=1,Zw="_sentryScope",ev="_sentryIsolationScope";function tv(t){if(t){if(typeof t=="object"&&"deref"in t&&typeof t.deref=="function")try{return t.deref()}catch{return}return t}}function gp(t){const e=t;return{scope:e[Zw],isolationScope:tv(e[ev])}}const nv="sentry-",iv=/^sentry-/;function sv(t){const e=rv(t);if(!e)return;const n=Object.entries(e).reduce((i,[s,r])=>{if(s.match(iv)){const o=s.slice(nv.length);i[o]=r}return i},{});if(Object.keys(n).length>0)return n}function rv(t){if(!(!t||!At(t)&&!Array.isArray(t)))return Array.isArray(t)?t.reduce((e,n)=>{const i=Cd(n);return Object.entries(i).forEach(([s,r])=>{e[s]=r}),e},{}):Cd(t)}function Cd(t){return t.split(",").map(e=>{const n=e.indexOf("=");if(n===-1)return[];const i=e.slice(0,n),s=e.slice(n+1);return[i,s].map(r=>{try{return decodeURIComponent(r.trim())}catch{return}})}).reduce((e,[n,i])=>(n&&i&&(e[n]=i),e),{})}const ov=/^o(\d+)\./,av=/^(?:(\w+):)\/\/(?:(\w+)(?::(\w+)?)?@)((?:\[[:.%\w]+\]|[\w.-]+))(?::(\d+))?\/(.+)/;function cv(t){return t==="http"||t==="https"}function Xs(t,e=!1){const{host:n,path:i,pass:s,port:r,projectId:o,protocol:a,publicKey:c}=t;return`${a}://${c}${e&&s?`:${s}`:""}@${n}${r?`:${r}`:""}/${i&&`${i}/`}${o}`}function lv(t){const e=av.exec(t);if(!e){Ui(()=>{console.error(`Invalid Sentry Dsn: ${t}`)});return}const[n,i,s="",r="",o="",a=""]=e.slice(1);let c="",l=a;const u=l.split("/");if(u.length>1&&(c=u.slice(0,-1).join("/"),l=u.pop()),l){const d=l.match(/^\d+/);d&&(l=d[0])}return mp({host:r,pass:s,path:c,projectId:l,port:o,protocol:n,publicKey:i})}function mp(t){return{protocol:t.protocol,publicKey:t.publicKey||"",pass:t.pass||"",host:t.host,port:t.port||"",path:t.path||"",projectId:t.projectId}}function uv(t){if(!k)return!0;const{port:e,projectId:n,protocol:i}=t;return["protocol","publicKey","host","projectId"].find(o=>t[o]?!1:(E.error(`Invalid Sentry Dsn: ${o} missing`),!0))?!1:n.match(/^\d+$/)?cv(i)?e&&isNaN(parseInt(e,10))?(E.error(`Invalid Sentry Dsn: Invalid port ${e}`),!1):!0:(E.error(`Invalid Sentry Dsn: Invalid protocol ${i}`),!1):(E.error(`Invalid Sentry Dsn: Invalid projectId ${n}`),!1)}function dv(t){return t.match(ov)?.[1]}function hv(t){const e=t.getOptions(),{host:n}=t.getDsn()||{};let i;return e.orgId?i=String(e.orgId):n&&(i=dv(n)),i}function fv(t){const e=typeof t=="string"?lv(t):mp(t);if(!(!e||!uv(e)))return e}function pv(t){if(typeof t=="boolean")return Number(t);const e=typeof t=="string"?parseFloat(t):t;if(!(typeof e!="number"||isNaN(e)||e<0||e>1))return e}const _p=1;let Td=!1;function gv(t){const{spanId:e,traceId:n,isRemote:i}=t.spanContext(),s=i?e:_l(t).parent_span_id,r=gp(t).scope,o=i?r?.getPropagationContext().propagationSpanId||hp():e;return{parent_span_id:s,span_id:o,trace_id:n}}function mv(t){if(t&&t.length>0)return t.map(({context:{spanId:e,traceId:n,traceFlags:i,...s},attributes:r})=>({span_id:e,trace_id:n,sampled:i===_p,attributes:r,...s}))}function Sd(t){return typeof t=="number"?Id(t):Array.isArray(t)?t[0]+t[1]/1e9:t instanceof Date?Id(t.getTime()):Rt()}function Id(t){return t>9999999999?t/1e3:t}function _l(t){if(yv(t))return t.getSpanJSON();const{spanId:e,traceId:n}=t.spanContext();if(_v(t)){const{attributes:i,startTime:s,name:r,endTime:o,status:a,links:c}=t,l="parentSpanId"in t?t.parentSpanId:"parentSpanContext"in t?t.parentSpanContext?.spanId:void 0;return{span_id:e,trace_id:n,data:i,description:r,parent_span_id:l,start_timestamp:Sd(s),timestamp:Sd(o)||void 0,status:vv(a),op:i[Yw],origin:i[Jw],links:mv(c)}}return{span_id:e,trace_id:n,start_timestamp:0,data:{}}}function _v(t){const e=t;return!!e.attributes&&!!e.startTime&&!!e.name&&!!e.endTime&&!!e.status}function yv(t){return typeof t.getSpanJSON=="function"}function wv(t){const{traceFlags:e}=t.spanContext();return e===_p}function vv(t){if(!(!t||t.code===Xw))return t.code===Qw?"ok":t.message||"internal_error"}const bv="_sentryRootSpan";function yp(t){return t[bv]||t}function kd(){Td||(Ui(()=>{console.warn("[Sentry] Returning null from `beforeSendSpan` is disallowed. To drop certain spans, configure the respective integrations directly or use `ignoreSpans`.")}),Td=!0)}function Ev(t){if(typeof __SENTRY_TRACING__=="boolean"&&!__SENTRY_TRACING__)return!1;const e=Ce()?.getOptions();return!!e&&(e.tracesSampleRate!=null||!!e.tracesSampler)}function Ad(t){E.log(`Ignoring span ${t.op} - ${t.description} because it matches \`ignoreSpans\`.`)}function Rd(t,e){if(!e?.length||!t.description)return!1;for(const n of e){if(Tv(n)){if(Sr(t.description,n))return k&&Ad(t),!0;continue}if(!n.name&&!n.op)continue;const i=n.name?Sr(t.description,n.name):!0,s=n.op?t.op&&Sr(t.op,n.op):!0;if(i&&s)return k&&Ad(t),!0}return!1}function Cv(t,e){const n=e.parent_span_id,i=e.span_id;if(n)for(const s of t)s.parent_span_id===i&&(s.parent_span_id=n)}function Tv(t){return typeof t=="string"||t instanceof RegExp}const yl="production",Sv="_frozenDsc";function wp(t,e){const n=e.getOptions(),{publicKey:i}=e.getDsn()||{},s={environment:n.environment||yl,release:n.release,public_key:i,trace_id:t,org_id:hv(e)};return e.emit("createDsc",s),s}function Iv(t,e){const n=e.getPropagationContext();return n.dsc||wp(n.traceId,t)}function kv(t){const e=Ce();if(!e)return{};const n=yp(t),i=_l(n),s=i.data,r=n.spanContext().traceState,o=r?.get("sentry.sample_rate")??s[Gw]??s[Kw];function a(p){return(typeof o=="number"||typeof o=="string")&&(p.sample_rate=`${o}`),p}const c=n[Sv];if(c)return a(c);const l=r?.get("sentry.dsc"),u=l&&sv(l);if(u)return a(u);const d=wp(t.spanContext().traceId,e),h=s[zw],f=i.description;return h!=="url"&&f&&(d.transaction=f),Ev()&&(d.sampled=String(wv(n)),d.sample_rand=r?.get("sentry.sample_rand")??gp(n).scope?.getPropagationContext().sampleRand.toString()),a(d),e.emit("createDsc",d,n),d}function vt(t,e=100,n=1/0){try{return lc("",t,e,n)}catch(i){return{ERROR:`**non-serializable** (${i})`}}}function vp(t,e=3,n=100*1024){const i=vt(t,e);return Pv(i)>n?vp(t,e-1,n):i}function lc(t,e,n=1/0,i=1/0,s=Ov()){const[r,o]=s;if(e==null||["boolean","string"].includes(typeof e)||typeof e=="number"&&Number.isFinite(e))return e;const a=Av(t,e);if(!a.startsWith("[object "))return a;if(e.__sentry_skip_normalization__)return e;const c=typeof e.__sentry_override_normalization_depth__=="number"?e.__sentry_override_normalization_depth__:n;if(c===0)return a.replace("object ","");if(r(e))return"[Circular ~]";const l=e;if(l&&typeof l.toJSON=="function")try{const f=l.toJSON();return lc("",f,c-1,i,s)}catch{}const u=Array.isArray(e)?[]:{};let d=0;const h=lp(e);for(const f in h){if(!Object.prototype.hasOwnProperty.call(h,f))continue;if(d>=i){u[f]="[MaxProperties ~]";break}const p=h[f];u[f]=lc(f,p,c-1,i,s),d++}return o(e),u}function Av(t,e){try{if(t==="domain"&&e&&typeof e=="object"&&e._events)return"[Domain]";if(t==="domainEmitter")return"[DomainEmitter]";if(typeof global<"u"&&e===global)return"[Global]";if(typeof window<"u"&&e===window)return"[Window]";if(typeof document<"u"&&e===document)return"[Document]";if(rp(e))return np(e);if(Tw(e))return"[SyntheticEvent]";if(typeof e=="number"&&!Number.isFinite(e))return`[${e}]`;if(typeof e=="function")return`[Function: ${on(e)}]`;if(typeof e=="symbol")return`[${String(e)}]`;if(typeof e=="bigint")return`[BigInt: ${String(e)}]`;const n=Rv(e);return/^HTML(\w*)Element$/.test(n)?`[HTMLElement: ${n}]`:`[object ${n}]`}catch(n){return`**non-serializable** (${n})`}}function Rv(t){const e=Object.getPrototypeOf(t);return e?.constructor?e.constructor.name:"null prototype"}function Nv(t){return~-encodeURI(t).split(/%..|./).length}function Pv(t){return Nv(JSON.stringify(t))}function Ov(){const t=new WeakSet;function e(i){return t.has(i)?!0:(t.add(i),!1)}function n(i){t.delete(i)}return[e,n]}function Bi(t,e=[]){return[t,e]}function Lv(t,e){const[n,i]=t;return[n,[...i,e]]}function uc(t,e){const n=t[1];for(const i of n){const s=i[0].type;if(e(i,s))return!0}return!1}function Dv(t,e){return uc(t,(n,i)=>e.includes(i))}function dc(t){const e=To(V);return e.encodePolyfill?e.encodePolyfill(t):new TextEncoder().encode(t)}function Mv(t){const[e,n]=t;let i=JSON.stringify(e);function s(r){typeof i=="string"?i=typeof r=="string"?i+r:[dc(i),r]:i.push(typeof r=="string"?dc(r):r)}for(const r of n){const[o,a]=r;if(s(`
${JSON.stringify(o)}
`),typeof a=="string"||a instanceof Uint8Array)s(a);else{let c;try{c=JSON.stringify(a)}catch{c=JSON.stringify(vt(a))}s(c)}}return typeof i=="string"?i:xv(i)}function xv(t){const e=t.reduce((s,r)=>s+r.length,0),n=new Uint8Array(e);let i=0;for(const s of t)n.set(s,i),i+=s.length;return n}function Fv(t){const e=typeof t.data=="string"?dc(t.data):t.data;return[{type:"attachment",length:e.length,filename:t.filename,content_type:t.contentType,attachment_type:t.attachmentType},e]}const Uv={session:"session",sessions:"session",attachment:"attachment",transaction:"transaction",event:"error",client_report:"internal",user_report:"default",profile:"profile",profile_chunk:"profile",replay_event:"replay",replay_recording:"replay",check_in:"monitor",feedback:"feedback",span:"span",raw_security:"security",log:"log_item",metric:"metric",trace_metric:"metric"};function Nd(t){return Uv[t]}function bp(t){if(!t?.sdk)return;const{name:e,version:n}=t.sdk;return{name:e,version:n}}function $v(t,e,n,i){const s=t.sdkProcessingMetadata?.dynamicSamplingContext;return{event_id:t.event_id,sent_at:new Date().toISOString(),...e&&{sdk:e},...!!n&&i&&{dsn:Xs(i)},...s&&{trace:s}}}function Bv(t,e){if(!e)return t;const n=t.sdk||{};return t.sdk={...n,name:n.name||e.name,version:n.version||e.version,integrations:[...t.sdk?.integrations||[],...e.integrations||[]],packages:[...t.sdk?.packages||[],...e.packages||[]],settings:t.sdk?.settings||e.settings?{...t.sdk?.settings,...e.settings}:void 0},t}function Hv(t,e,n,i){const s=bp(n),r={sent_at:new Date().toISOString(),...s&&{sdk:s},...!!i&&e&&{dsn:Xs(e)}},o="aggregates"in t?[{type:"sessions"},t]:[{type:"session"},t.toJSON()];return Bi(r,[o])}function Vv(t,e,n,i){const s=bp(n),r=t.type&&t.type!=="replay_event"?t.type:"event";Bv(t,n?.sdk);const o=$v(t,s,i,e);return delete t.sdkProcessingMetadata,Bi(o,[[{type:r},t]])}const Ea=0,Pd=1,Od=2;function Po(t){return new ks(e=>{e(t)})}function wl(t){return new ks((e,n)=>{n(t)})}class ks{constructor(e){this._state=Ea,this._handlers=[],this._runExecutor(e)}then(e,n){return new ks((i,s)=>{this._handlers.push([!1,r=>{if(!e)i(r);else try{i(e(r))}catch(o){s(o)}},r=>{if(!n)s(r);else try{i(n(r))}catch(o){s(o)}}]),this._executeHandlers()})}catch(e){return this.then(n=>n,e)}finally(e){return new ks((n,i)=>{let s,r;return this.then(o=>{r=!1,s=o,e&&e()},o=>{r=!0,s=o,e&&e()}).then(()=>{if(r){i(s);return}n(s)})})}_executeHandlers(){if(this._state===Ea)return;const e=this._handlers.slice();this._handlers=[],e.forEach(n=>{n[0]||(this._state===Pd&&n[1](this._value),this._state===Od&&n[2](this._value),n[0]=!0)})}_runExecutor(e){const n=(r,o)=>{if(this._state===Ea){if(Gs(o)){o.then(i,s);return}this._state=r,this._value=o,this._executeHandlers()}},i=r=>{n(Pd,r)},s=r=>{n(Od,r)};try{e(i,s)}catch(r){s(r)}}}function Wv(t,e,n,i=0){try{const s=hc(e,n,t,i);return Gs(s)?s:Po(s)}catch(s){return wl(s)}}function hc(t,e,n,i){const s=n[i];if(!t||!s)return t;const r=s({...t},e);return k&&r===null&&E.log(`Event processor "${s.id||"?"}" dropped event`),Gs(r)?r.then(o=>hc(o,e,n,i+1)):hc(r,e,n,i+1)}let bn,Ld,Dd,Wt;function jv(t){const e=V._sentryDebugIds,n=V._debugIds;if(!e&&!n)return{};const i=e?Object.keys(e):[],s=n?Object.keys(n):[];if(Wt&&i.length===Ld&&s.length===Dd)return Wt;Ld=i.length,Dd=s.length,Wt={},bn||(bn={});const r=(o,a)=>{for(const c of o){const l=a[c],u=bn?.[c];if(u&&Wt&&l)Wt[u[0]]=l,bn&&(bn[c]=[u[0],l]);else if(l){const d=t(c);for(let h=d.length-1;h>=0;h--){const p=d[h]?.filename;if(p&&Wt&&bn){Wt[p]=l,bn[c]=[p,l];break}}}}};return e&&r(i,e),n&&r(s,n),Wt}function qv(t,e){const{fingerprint:n,span:i,breadcrumbs:s,sdkProcessingMetadata:r}=e;Gv(t,e),i&&Jv(t,i),Xv(t,n),Kv(t,s),Yv(t,r)}function Md(t,e){const{extra:n,tags:i,attributes:s,user:r,contexts:o,level:a,sdkProcessingMetadata:c,breadcrumbs:l,fingerprint:u,eventProcessors:d,attachments:h,propagationContext:f,transactionName:p,span:_}=e;ns(t,"extra",n),ns(t,"tags",i),ns(t,"attributes",s),ns(t,"user",r),ns(t,"contexts",o),t.sdkProcessingMetadata=Ys(t.sdkProcessingMetadata,c,2),a&&(t.level=a),p&&(t.transactionName=p),_&&(t.span=_),l.length&&(t.breadcrumbs=[...t.breadcrumbs,...l]),u.length&&(t.fingerprint=[...t.fingerprint,...u]),d.length&&(t.eventProcessors=[...t.eventProcessors,...d]),h.length&&(t.attachments=[...t.attachments,...h]),t.propagationContext={...t.propagationContext,...f}}function ns(t,e,n){t[e]=Ys(t[e],n,1)}function zv(t,e){const n=Ww().getScopeData();return t&&Md(n,t.getScopeData()),e&&Md(n,e.getScopeData()),n}function Gv(t,e){const{extra:n,tags:i,user:s,contexts:r,level:o,transactionName:a}=e;Object.keys(n).length&&(t.extra={...n,...t.extra}),Object.keys(i).length&&(t.tags={...i,...t.tags}),Object.keys(s).length&&(t.user={...s,...t.user}),Object.keys(r).length&&(t.contexts={...r,...t.contexts}),o&&(t.level=o),a&&t.type!=="transaction"&&(t.transaction=a)}function Kv(t,e){const n=[...t.breadcrumbs||[],...e];t.breadcrumbs=n.length?n:void 0}function Yv(t,e){t.sdkProcessingMetadata={...t.sdkProcessingMetadata,...e}}function Jv(t,e){t.contexts={trace:gv(e),...t.contexts},t.sdkProcessingMetadata={dynamicSamplingContext:kv(e),...t.sdkProcessingMetadata};const n=yp(e),i=_l(n).description;i&&!t.transaction&&t.type==="transaction"&&(t.transaction=i)}function Xv(t,e){t.fingerprint=t.fingerprint?Array.isArray(t.fingerprint)?t.fingerprint:[t.fingerprint]:[],e&&(t.fingerprint=t.fingerprint.concat(e)),t.fingerprint.length||delete t.fingerprint}function Qv(t,e,n,i,s,r){const{normalizeDepth:o=3,normalizeMaxBreadth:a=1e3}=t,c={...e,event_id:e.event_id||n.event_id||ze(),timestamp:e.timestamp||Ks()},l=n.integrations||t.integrations.map(m=>m.name);Zv(c,t),nb(c,l),s&&s.emit("applyFrameMetadata",e),e.type===void 0&&eb(c,t.stackParser);const u=sb(i,n.captureContext);n.mechanism&&Ci(c,n.mechanism);const d=s?s.getEventProcessors():[],h=zv(r,u),f=[...n.attachments||[],...h.attachments];f.length&&(n.attachments=f),qv(c,h);const p=[...d,...h.eventProcessors];return Wv(p,c,n).then(m=>(m&&tb(m),typeof o=="number"&&o>0?ib(m,o,a):m))}function Zv(t,e){const{environment:n,release:i,dist:s,maxValueLength:r}=e;t.environment=t.environment||n||yl,!t.release&&i&&(t.release=i),!t.dist&&s&&(t.dist=s);const o=t.request;o?.url&&r&&(o.url=oc(o.url,r)),r&&t.exception?.values?.forEach(a=>{a.value&&(a.value=oc(a.value,r))})}function eb(t,e){const n=jv(e);t.exception?.values?.forEach(i=>{i.stacktrace?.frames?.forEach(s=>{s.filename&&(s.debug_id=n[s.filename])})})}function tb(t){const e={};if(t.exception?.values?.forEach(i=>{i.stacktrace?.frames?.forEach(s=>{s.debug_id&&(s.abs_path?e[s.abs_path]=s.debug_id:s.filename&&(e[s.filename]=s.debug_id),delete s.debug_id)})}),Object.keys(e).length===0)return;t.debug_meta=t.debug_meta||{},t.debug_meta.images=t.debug_meta.images||[];const n=t.debug_meta.images;Object.entries(e).forEach(([i,s])=>{n.push({type:"sourcemap",code_file:i,debug_id:s})})}function nb(t,e){e.length>0&&(t.sdk=t.sdk||{},t.sdk.integrations=[...t.sdk.integrations||[],...e])}function ib(t,e,n){if(!t)return null;const i={...t,...t.breadcrumbs&&{breadcrumbs:t.breadcrumbs.map(s=>({...s,...s.data&&{data:vt(s.data,e,n)}}))},...t.user&&{user:vt(t.user,e,n)},...t.contexts&&{contexts:vt(t.contexts,e,n)},...t.extra&&{extra:vt(t.extra,e,n)}};return t.contexts?.trace&&i.contexts&&(i.contexts.trace=t.contexts.trace,t.contexts.trace.data&&(i.contexts.trace.data=vt(t.contexts.trace.data,e,n))),t.spans&&(i.spans=t.spans.map(s=>({...s,...s.data&&{data:vt(s.data,e,n)}}))),t.contexts?.flags&&i.contexts&&(i.contexts.flags=vt(t.contexts.flags,3,n)),i}function sb(t,e){if(!e)return t;const n=t?t.clone():new Lt;return n.update(e),n}function rb(t,e){return gn().captureException(t,void 0)}function Ep(t,e){return gn().captureEvent(t,e)}function xd(t){const e=Js(),n=gn(),{userAgent:i}=V.navigator||{},s=Lw({user:n.getUser()||e.getUser(),...i&&{userAgent:i},...t}),r=e.getSession();return r?.status==="ok"&&Ti(r,{status:"exited"}),Cp(),e.setSession(s),s}function Cp(){const t=Js(),n=gn().getSession()||t.getSession();n&&Dw(n),Tp(),t.setSession()}function Tp(){const t=Js(),e=Ce(),n=t.getSession();n&&e&&e.captureSession(n)}function Fd(t=!1){if(t){Cp();return}Tp()}const ob="7";function ab(t){const e=t.protocol?`${t.protocol}:`:"",n=t.port?`:${t.port}`:"";return`${e}//${t.host}${n}${t.path?`/${t.path}`:""}/api/`}function cb(t){return`${ab(t)}${t.projectId}/envelope/`}function lb(t,e){const n={sentry_version:ob};return t.publicKey&&(n.sentry_key=t.publicKey),e&&(n.sentry_client=`${e.name}/${e.version}`),new URLSearchParams(n).toString()}function ub(t,e,n){return e||`${cb(t)}?${lb(t,n)}`}const Ud=[];function db(t){const e={};return t.forEach(n=>{const{name:i}=n,s=e[i];s&&!s.isDefaultInstance&&n.isDefaultInstance||(e[i]=n)}),Object.values(e)}function hb(t){const e=t.defaultIntegrations||[],n=t.integrations;e.forEach(s=>{s.isDefaultInstance=!0});let i;if(Array.isArray(n))i=[...e,...n];else if(typeof n=="function"){const s=n(e);i=Array.isArray(s)?s:[s]}else i=e;return db(i)}function fb(t,e){const n={};return e.forEach(i=>{i&&Sp(t,i,n)}),n}function $d(t,e){for(const n of e)n?.afterAllSetup&&n.afterAllSetup(t)}function Sp(t,e,n){if(n[e.name]){k&&E.log(`Integration skipped because it was already installed: ${e.name}`);return}if(n[e.name]=e,!Ud.includes(e.name)&&typeof e.setupOnce=="function"&&(e.setupOnce(),Ud.push(e.name)),e.setup&&typeof e.setup=="function"&&e.setup(t),typeof e.preprocessEvent=="function"){const i=e.preprocessEvent.bind(e);t.on("preprocessEvent",(s,r)=>i(s,r,t))}if(typeof e.processEvent=="function"){const i=e.processEvent.bind(e),s=Object.assign((r,o)=>i(r,o,t),{id:e.name});t.addEventProcessor(s)}k&&E.log(`Integration installed: ${e.name}`)}function pb(t){return[{type:"log",item_count:t.length,content_type:"application/vnd.sentry.items.log+json"},{items:t}]}function gb(t,e,n,i){const s={};return e?.sdk&&(s.sdk={name:e.sdk.name,version:e.sdk.version}),n&&i&&(s.dsn=Xs(i)),Bi(s,[pb(t)])}function Ip(t,e){const n=e??mb(t)??[];if(n.length===0)return;const i=t.getOptions(),s=gb(n,i._metadata,i.tunnel,t.getDsn());kp().set(t,[]),t.emit("flushLogs"),t.sendEnvelope(s)}function mb(t){return kp().get(t)}function kp(){return Fi("clientToLogBufferMap",()=>new WeakMap)}function _b(t){return[{type:"trace_metric",item_count:t.length,content_type:"application/vnd.sentry.items.trace-metric+json"},{items:t}]}function yb(t,e,n,i){const s={};return e?.sdk&&(s.sdk={name:e.sdk.name,version:e.sdk.version}),n&&i&&(s.dsn=Xs(i)),Bi(s,[_b(t)])}function Ap(t,e){const n=e??wb(t)??[];if(n.length===0)return;const i=t.getOptions(),s=yb(n,i._metadata,i.tunnel,t.getDsn());Rp().set(t,[]),t.emit("flushMetrics"),t.sendEnvelope(s)}function wb(t){return Rp().get(t)}function Rp(){return Fi("clientToMetricBufferMap",()=>new WeakMap)}const vl=Symbol.for("SentryBufferFullError");function bl(t=100){const e=new Set;function n(){return e.size<t}function i(o){e.delete(o)}function s(o){if(!n())return wl(vl);const a=o();return e.add(a),a.then(()=>i(a),()=>i(a)),a}function r(o){if(!e.size)return Po(!0);const a=Promise.allSettled(Array.from(e)).then(()=>!0);if(!o)return a;const c=[a,new Promise(l=>setTimeout(()=>l(!1),o))];return Promise.race(c)}return{get $(){return Array.from(e)},add:s,drain:r}}const vb=60*1e3;function bb(t,e=Ro()){const n=parseInt(`${t}`,10);if(!isNaN(n))return n*1e3;const i=Date.parse(`${t}`);return isNaN(i)?vb:i-e}function Eb(t,e){return t[e]||t.all||0}function Cb(t,e,n=Ro()){return Eb(t,e)>n}function Tb(t,{statusCode:e,headers:n},i=Ro()){const s={...t},r=n?.["x-sentry-rate-limits"],o=n?.["retry-after"];if(r)for(const a of r.trim().split(",")){const[c,l,,,u]=a.split(":",5),d=parseInt(c,10),h=(isNaN(d)?60:d)*1e3;if(!l)s.all=i+h;else for(const f of l.split(";"))f==="metric_bucket"?(!u||u.split(";").includes("custom"))&&(s[f]=i+h):s[f]=i+h}else o?s.all=i+bb(o,i):e===429&&(s.all=i+60*1e3);return s}const Np=64;function Sb(t,e,n=bl(t.bufferSize||Np)){let i={};const s=o=>n.drain(o);function r(o){const a=[];if(uc(o,(d,h)=>{const f=Nd(h);Cb(i,f)?t.recordDroppedEvent("ratelimit_backoff",f):a.push(d)}),a.length===0)return Promise.resolve({});const c=Bi(o[0],a),l=d=>{if(Dv(c,["client_report"])){k&&E.warn(`Dropping client report. Will not send outcomes (reason: ${d}).`);return}uc(c,(h,f)=>{t.recordDroppedEvent(d,Nd(f))})},u=()=>e({body:Mv(c)}).then(d=>(d.statusCode!==void 0&&(d.statusCode<200||d.statusCode>=300)&&k&&E.warn(`Sentry responded with status code ${d.statusCode} to sent event.`),i=Tb(i,d),d),d=>{throw l("network_error"),k&&E.error("Encountered error running transport request:",d),d});return n.add(u).then(d=>d,d=>{if(d===vl)return k&&E.error("Skipped sending event because buffer is full."),l("queue_overflow"),Promise.resolve({});throw d})}return{send:r,flush:s}}function Ib(t,e,n){const i=[{type:"client_report"},{timestamp:Ks(),discarded_events:t}];return Bi(e?{dsn:e}:{},[i])}function Pp(t){const e=[];t.message&&e.push(t.message);try{const n=t.exception.values[t.exception.values.length-1];n?.value&&(e.push(n.value),n.type&&e.push(`${n.type}: ${n.value}`))}catch{}return e}function kb(t){const{trace_id:e,parent_span_id:n,span_id:i,status:s,origin:r,data:o,op:a}=t.contexts?.trace??{};return{data:o??{},description:t.transaction,op:a,parent_span_id:n,span_id:i??"",start_timestamp:t.start_timestamp??0,status:s,timestamp:t.timestamp,trace_id:e??"",origin:r,profile_id:o?.[fp],exclusive_time:o?.[pp],measurements:t.measurements,is_segment:!0}}function Ab(t){return{type:"transaction",timestamp:t.timestamp,start_timestamp:t.start_timestamp,transaction:t.description,contexts:{trace:{trace_id:t.trace_id,span_id:t.span_id,parent_span_id:t.parent_span_id,op:t.op,status:t.status,origin:t.origin,data:{...t.data,...t.profile_id&&{[fp]:t.profile_id},...t.exclusive_time&&{[pp]:t.exclusive_time}}}},measurements:t.measurements}}const Bd="Not capturing exception because it's already been captured.",Hd="Discarded session because of missing or non-string release",Op=Symbol.for("SentryInternalError"),Lp=Symbol.for("SentryDoNotSendEventError"),Rb=5e3;function Ir(t){return{message:t,[Op]:!0}}function Ca(t){return{message:t,[Lp]:!0}}function Vd(t){return!!t&&typeof t=="object"&&Op in t}function Wd(t){return!!t&&typeof t=="object"&&Lp in t}function jd(t,e,n,i,s){let r=0,o,a=!1;t.on(n,()=>{r=0,clearTimeout(o),a=!1}),t.on(e,c=>{r+=i(c),r>=8e5?s(t):a||(a=!0,o=setTimeout(()=>{s(t)},Rb))}),t.on("flush",()=>{s(t)})}class Nb{constructor(e){if(this._options=e,this._integrations={},this._numProcessing=0,this._outcomes={},this._hooks={},this._eventProcessors=[],this._promiseBuffer=bl(e.transportOptions?.bufferSize??Np),e.dsn?this._dsn=fv(e.dsn):k&&E.warn("No DSN provided, client will not send events."),this._dsn){const i=ub(this._dsn,e.tunnel,e._metadata?e._metadata.sdk:void 0);this._transport=e.transport({tunnel:this._options.tunnel,recordDroppedEvent:this.recordDroppedEvent.bind(this),...e.transportOptions,url:i})}this._options.enableLogs=this._options.enableLogs??this._options._experiments?.enableLogs,this._options.enableLogs&&jd(this,"afterCaptureLog","flushLogs",Db,Ip),(this._options.enableMetrics??this._options._experiments?.enableMetrics??!0)&&jd(this,"afterCaptureMetric","flushMetrics",Lb,Ap)}captureException(e,n,i){const s=ze();if(_d(e))return k&&E.log(Bd),s;const r={event_id:s,...n};return this._process(()=>this.eventFromException(e,r).then(o=>this._captureEvent(o,r,i)).then(o=>o),"error"),r.event_id}captureMessage(e,n,i,s){const r={event_id:ze(),...i},o=hl(e)?e:String(e),a=Io(e),c=a?this.eventFromMessage(o,n,r):this.eventFromException(e,r);return this._process(()=>c.then(l=>this._captureEvent(l,r,s)),a?"unknown":"error"),r.event_id}captureEvent(e,n,i){const s=ze();if(n?.originalException&&_d(n.originalException))return k&&E.log(Bd),s;const r={event_id:s,...n},o=e.sdkProcessingMetadata||{},a=o.capturedSpanScope,c=o.capturedSpanIsolationScope,l=qd(e.type);return this._process(()=>this._captureEvent(e,r,a||i,c),l),r.event_id}captureSession(e){this.sendSession(e),Ti(e,{init:!1})}getDsn(){return this._dsn}getOptions(){return this._options}getSdkMetadata(){return this._options._metadata}getTransport(){return this._transport}async flush(e){const n=this._transport;if(!n)return!0;this.emit("flush");const i=await this._isClientDoneProcessing(e),s=await n.flush(e);return i&&s}async close(e){const n=await this.flush(e);return this.getOptions().enabled=!1,this.emit("close"),n}getEventProcessors(){return this._eventProcessors}addEventProcessor(e){this._eventProcessors.push(e)}init(){(this._isEnabled()||this._options.integrations.some(({name:e})=>e.startsWith("Spotlight")))&&this._setupIntegrations()}getIntegrationByName(e){return this._integrations[e]}addIntegration(e){const n=this._integrations[e.name];Sp(this,e,this._integrations),n||$d(this,[e])}sendEvent(e,n={}){this.emit("beforeSendEvent",e,n);let i=Vv(e,this._dsn,this._options._metadata,this._options.tunnel);for(const s of n.attachments||[])i=Lv(i,Fv(s));this.sendEnvelope(i).then(s=>this.emit("afterSendEvent",e,s))}sendSession(e){const{release:n,environment:i=yl}=this._options;if("aggregates"in e){const r=e.attrs||{};if(!r.release&&!n){k&&E.warn(Hd);return}r.release=r.release||n,r.environment=r.environment||i,e.attrs=r}else{if(!e.release&&!n){k&&E.warn(Hd);return}e.release=e.release||n,e.environment=e.environment||i}this.emit("beforeSendSession",e);const s=Hv(e,this._dsn,this._options._metadata,this._options.tunnel);this.sendEnvelope(s)}recordDroppedEvent(e,n,i=1){if(this._options.sendClientReports){const s=`${e}:${n}`;k&&E.log(`Recording outcome: "${s}"${i>1?` (${i} times)`:""}`),this._outcomes[s]=(this._outcomes[s]||0)+i}}on(e,n){const i=this._hooks[e]=this._hooks[e]||new Set,s=(...r)=>n(...r);return i.add(s),()=>{i.delete(s)}}emit(e,...n){const i=this._hooks[e];i&&i.forEach(s=>s(...n))}async sendEnvelope(e){if(this.emit("beforeEnvelope",e),this._isEnabled()&&this._transport)try{return await this._transport.send(e)}catch(n){return k&&E.error("Error while sending envelope:",n),{}}return k&&E.error("Transport disabled"),{}}_setupIntegrations(){const{integrations:e}=this._options;this._integrations=fb(this,e),$d(this,e)}_updateSessionFromEvent(e,n){let i=n.level==="fatal",s=!1;const r=n.exception?.values;if(r){s=!0,i=!1;for(const c of r)if(c.mechanism?.handled===!1){i=!0;break}}const o=e.status==="ok";(o&&e.errors===0||o&&i)&&(Ti(e,{...i&&{status:"crashed"},errors:e.errors||Number(s||i)}),this.captureSession(e))}async _isClientDoneProcessing(e){let n=0;for(;!e||n<e;){if(await new Promise(i=>setTimeout(i,1)),!this._numProcessing)return!0;n++}return!1}_isEnabled(){return this.getOptions().enabled!==!1&&this._transport!==void 0}_prepareEvent(e,n,i,s){const r=this.getOptions(),o=Object.keys(this._integrations);return!n.integrations&&o?.length&&(n.integrations=o),this.emit("preprocessEvent",e,n),e.type||s.setLastEventId(e.event_id||n.event_id),Qv(r,e,n,i,this,s).then(a=>{if(a===null)return a;this.emit("postprocessEvent",a,n),a.contexts={trace:qw(i),...a.contexts};const c=Iv(this,i);return a.sdkProcessingMetadata={dynamicSamplingContext:c,...a.sdkProcessingMetadata},a})}_captureEvent(e,n={},i=gn(),s=Js()){return k&&fc(e)&&E.log(`Captured error event \`${Pp(e)[0]||"<unknown>"}\``),this._processEvent(e,n,i,s).then(r=>r.event_id,r=>{k&&(Wd(r)?E.log(r.message):Vd(r)?E.warn(r.message):E.warn(r))})}_processEvent(e,n,i,s){const r=this.getOptions(),{sampleRate:o}=r,a=Dp(e),c=fc(e),u=`before send for type \`${e.type||"error"}\``,d=typeof o>"u"?void 0:pv(o);if(c&&typeof d=="number"&&$r()>d)return this.recordDroppedEvent("sample_rate","error"),wl(Ca(`Discarding event because it's not included in the random sample (sampling rate = ${o})`));const h=qd(e.type);return this._prepareEvent(e,n,i,s).then(f=>{if(f===null)throw this.recordDroppedEvent("event_processor",h),Ca("An event processor returned `null`, will not send event.");if(n.data&&n.data.__sentry__===!0)return f;const _=Ob(this,r,f,n);return Pb(_,u)}).then(f=>{if(f===null){if(this.recordDroppedEvent("before_send",h),a){const R=1+(e.spans||[]).length;this.recordDroppedEvent("before_send","span",R)}throw Ca(`${u} returned \`null\`, will not send event.`)}const p=i.getSession()||s.getSession();if(c&&p&&this._updateSessionFromEvent(p,f),a){const m=f.sdkProcessingMetadata?.spanCountBeforeProcessing||0,R=f.spans?f.spans.length:0,B=m-R;B>0&&this.recordDroppedEvent("before_send","span",B)}const _=f.transaction_info;if(a&&_&&f.transaction!==e.transaction){const m="custom";f.transaction_info={..._,source:m}}return this.sendEvent(f,n),f}).then(null,f=>{throw Wd(f)||Vd(f)?f:(this.captureException(f,{mechanism:{handled:!1,type:"internal"},data:{__sentry__:!0},originalException:f}),Ir(`Event processing pipeline threw an error, original event will not be sent. Details have been sent as a new event.
Reason: ${f}`))})}_process(e,n){this._numProcessing++,this._promiseBuffer.add(e).then(i=>(this._numProcessing--,i),i=>(this._numProcessing--,i===vl&&this.recordDroppedEvent("queue_overflow",n),i))}_clearOutcomes(){const e=this._outcomes;return this._outcomes={},Object.entries(e).map(([n,i])=>{const[s,r]=n.split(":");return{reason:s,category:r,quantity:i}})}_flushOutcomes(){k&&E.log("Flushing outcomes...");const e=this._clearOutcomes();if(e.length===0){k&&E.log("No outcomes to send");return}if(!this._dsn){k&&E.log("No dsn provided, will not send outcomes");return}k&&E.log("Sending outcomes:",e);const n=Ib(e,this._options.tunnel&&Xs(this._dsn));this.sendEnvelope(n)}}function qd(t){return t==="replay_event"?"replay":t||"error"}function Pb(t,e){const n=`${e} must return \`null\` or a valid event.`;if(Gs(t))return t.then(i=>{if(!Is(i)&&i!==null)throw Ir(n);return i},i=>{throw Ir(`${e} rejected with ${i}`)});if(!Is(t)&&t!==null)throw Ir(n);return t}function Ob(t,e,n,i){const{beforeSend:s,beforeSendTransaction:r,beforeSendSpan:o,ignoreSpans:a}=e;let c=n;if(fc(c)&&s)return s(c,i);if(Dp(c)){if(o||a){const l=kb(c);if(a?.length&&Rd(l,a))return null;if(o){const u=o(l);u?c=Ys(n,Ab(u)):kd()}if(c.spans){const u=[],d=c.spans;for(const f of d){if(a?.length&&Rd(f,a)){Cv(d,f);continue}if(o){const p=o(f);p?u.push(p):(kd(),u.push(f))}else u.push(f)}const h=c.spans.length-u.length;h&&t.recordDroppedEvent("before_send","span",h),c.spans=u}}if(r){if(c.spans){const l=c.spans.length;c.sdkProcessingMetadata={...n.sdkProcessingMetadata,spanCountBeforeProcessing:l}}return r(c,i)}}return c}function fc(t){return t.type===void 0}function Dp(t){return t.type==="transaction"}function Lb(t){let e=0;return t.name&&(e+=t.name.length*2),e+=8,e+Mp(t.attributes)}function Db(t){let e=0;return t.message&&(e+=t.message.length*2),e+Mp(t.attributes)}function Mp(t){if(!t)return 0;let e=0;return Object.values(t).forEach(n=>{Array.isArray(n)?e+=n.length*zd(n[0]):Io(n)?e+=zd(n):e+=100}),e}function zd(t){return typeof t=="string"?t.length*2:typeof t=="number"?8:typeof t=="boolean"?4:0}function Mb(t){return So(t)&&"__sentry_fetch_url_host__"in t&&typeof t.__sentry_fetch_url_host__=="string"}function Gd(t){return Mb(t)?`${t.message} (${t.__sentry_fetch_url_host__})`:t.message}function xb(t,e){e.debug===!0&&(k?E.enable():Ui(()=>{console.warn("[Sentry] Cannot initialize SDK with `debug` option using a non-debug bundle.")})),gn().update(e.initialScope);const i=new t(e);return Fb(i),i.init(),i}function Fb(t){gn().setClient(t)}function Ta(t){if(!t)return{};const e=t.match(/^(([^:/?#]+):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?$/);if(!e)return{};const n=e[6]||"",i=e[8]||"";return{host:e[4],path:e[5],protocol:e[2],search:n,hash:i,relative:e[5]+n+i}}function Ub(t){"aggregates"in t?t.attrs?.ip_address===void 0&&(t.attrs={...t.attrs,ip_address:"{{auto}}"}):t.ipAddress===void 0&&(t.ipAddress="{{auto}}")}function $b(t,e,n=[e],i="npm"){const s=t._metadata||{};s.sdk||(s.sdk={name:`sentry.javascript.${e}`,packages:n.map(r=>({name:`${i}:@sentry/${r}`,version:On})),version:On}),t._metadata=s}const Bb=100;function Un(t,e){const n=Ce(),i=Js();if(!n)return;const{beforeBreadcrumb:s=null,maxBreadcrumbs:r=Bb}=n.getOptions();if(r<=0)return;const a={timestamp:Ks(),...t},c=s?Ui(()=>s(a,e)):a;c!==null&&(n.emit&&n.emit("beforeAddBreadcrumb",c,e),i.addBreadcrumb(c,r))}let Kd;const Hb="FunctionToString",Yd=new WeakMap,Vb=(()=>({name:Hb,setupOnce(){Kd=Function.prototype.toString;try{Function.prototype.toString=function(...t){const e=gl(this),n=Yd.has(Ce())&&e!==void 0?e:this;return Kd.apply(n,t)}}catch{}},setup(t){Yd.set(t,!0)}})),Wb=Vb,jb=[/^Script error\.?$/,/^Javascript error: Script error\.? on line 0$/,/^ResizeObserver loop completed with undelivered notifications.$/,/^Cannot redefine property: googletag$/,/^Can't find variable: gmo$/,/^undefined is not an object \(evaluating 'a\.[A-Z]'\)$/,`can't redefine non-configurable property "solana"`,"vv().getRestrictions is not a function. (In 'vv().getRestrictions(1,a)', 'vv().getRestrictions' is undefined)","Can't find variable: _AutofillCallbackHandler",/^Non-Error promise rejection captured with value: Object Not Found Matching Id:\d+, MethodName:simulateEvent, ParamCount:\d+$/,/^Java exception was raised during method invocation$/],qb="EventFilters",zb=(t={})=>{let e;return{name:qb,setup(n){const i=n.getOptions();e=Jd(t,i)},processEvent(n,i,s){if(!e){const r=s.getOptions();e=Jd(t,r)}return Kb(n,e)?null:n}}},Gb=((t={})=>({...zb(t),name:"InboundFilters"}));function Jd(t={},e={}){return{allowUrls:[...t.allowUrls||[],...e.allowUrls||[]],denyUrls:[...t.denyUrls||[],...e.denyUrls||[]],ignoreErrors:[...t.ignoreErrors||[],...e.ignoreErrors||[],...t.disableErrorDefaults?[]:jb],ignoreTransactions:[...t.ignoreTransactions||[],...e.ignoreTransactions||[]]}}function Kb(t,e){if(t.type){if(t.type==="transaction"&&Jb(t,e.ignoreTransactions))return k&&E.warn(`Event dropped due to being matched by \`ignoreTransactions\` option.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZC(t){return Gp(void 0,t)}function Gp(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const n=e;return new Date(n.getTime());case Object:t===void 0&&(t={});break;case Array:t=[];break;default:return e}for(const n in e)!e.hasOwnProperty(n)||!eT(n)||(t[n]=Gp(t[n],e[n]));return t}function eT(t){return t!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tT=()=>Kp().__FIREBASE_DEFAULTS__,nT=()=>{if(typeof process>"u"||typeof rh>"u")return;const t=rh.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},iT=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&Vr(t[1]);return e&&JSON.parse(e)},Sl=()=>{try{return JC()||tT()||nT()||iT()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},Yp=t=>Sl()?.emulatorHosts?.[t],sT=t=>{const e=Yp(t);if(!e)return;const n=e.lastIndexOf(":");if(n<=0||n+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const i=parseInt(e.substring(n+1),10);return e[0]==="["?[e.substring(1,n-1),i]:[e.substring(0,n),i]},Jp=()=>Sl()?.config,Xp=t=>Sl()?.[`_${t}`];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vi(t){try{return(t.startsWith("http://")||t.startsWith("https://")?new URL(t).hostname:t).endsWith(".cloudworkstations.dev")}catch{return!1}}async function Qp(t){return(await fetch(t,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ne(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Il(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Ne())}function cT(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function lT(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function eg(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function uT(){const t=Ne();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function dT(){return jp.NODE_ADMIN===!0}function Do(){try{return typeof indexedDB=="object"}catch{return!1}}function tg(){return new Promise((t,e)=>{try{let n=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(i),t(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{e(s.error?.message||"")}}catch(n){e(n)}})}function hT(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ng=function(t){let e={},n={},i={},s="";try{const r=t.split(".");e=Rs(Vr(r[0])||""),n=Rs(Vr(r[1])||""),s=r[2],i=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:i,signature:s}},mT=function(t){const e=ng(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},_T=function(t){const e=ng(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zT{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(GT(n)){const i=n.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(n=>n).join(" ")}}function GT(t){return t.getComponent()?.type==="VERSION"}const Cc="@firebase/app",dh="0.14.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ji=vS;function rg(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i={name:Tc,automaticDataCollectionEnabled:!0,...e},s=i.name;if(typeof s!="string"||!s)throw en.create("bad-app-name",{appName:String(s)});if(n||(n=Jp()),!n)throw en.create("no-options");const r=qr.get(s);if(r){if($n(n,r.options)&&$n(i,r.config))return r;throw en.create("duplicate-app",{appName:s})}const o=new PT(s);for(const c of Sc.values())o.addComponent(c);const a=new TS(n,i,o);return qr.set(s,a),a}function Uo(t=Tc){const e=qr.get(t);if(!e&&t===Tc&&Jp())return rg();if(!e)throw en.create("no-app",{appName:t});return e}function Be(t,e,n){let i=bS[t]??t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),r=e.match(/\s|\//);if(s||r){const o=[`Unable to register library "${i}" with version "${e}":`];s&&o.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&r&&o.push("and"),r&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Dt.warn(o.join(" "));return}Je(new He(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const SS="firebase-heartbeat-database",IS=1,Ns="firebase-heartbeat-store";let Pa=null;function og(){return Pa||(Pa=Fo(SS,IS,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Ns)}catch(n){console.warn(n)}}}}).catch(t=>{throw en.create("idb-open",{originalErrorMessage:t.message})})),Pa}async function kS(t){try{const n=(await og()).transaction(Ns),i=await n.objectStore(Ns).get(ag(t));return await n.done,i}catch(e){if(e instanceof $t)Dt.warn(e.message);else{const n=en.create("idb-get",{originalErrorMessage:e?.message});Dt.warn(n.message)}}}async function fh(t,e){try{const i=(await og()).transaction(Ns,"readwrite");await i.objectStore(Ns).put(e,ag(t)),await i.done}catch(n){if(n instanceof $t)Dt.warn(n.message);else{const i=en.create("idb-set",{originalErrorMessage:n?.message});Dt.warn(i.message)}}}function ag(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AS=1024,RS=30;class NS{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new OS(n),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){try{const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=ph();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(s=>s.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:n}),this._heartbeatsCache.heartbeats.length>RS){const s=LS(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(s,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){Dt.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=ph(),{heartbeatsToSend:n,unsentEntries:i}=PS(this._heartbeatsCache.heartbeats),s=Hr(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(e){return Dt.warn(e),""}}}function ph(){return new Date().toISOString().substring(0,10)}function PS(t,e=AS){const n=[];let i=t.slice();for(const s of t){const r=n.find(o=>o.agent===s.agent);if(r){if(r.dates.push(s.date),gh(n)>e){r.dates.pop();break}}else if(n.push({agent:s.agent,dates:[s.date]}),gh(n)>e){n.pop();break}i=i.slice(1)}return{heartbeatsToSend:n,unsentEntries:i}}class OS{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Do()?tg().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await kS(this.app);return n?.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return fh(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return fh(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function gh(t){return Hr(JSON.stringify({version:2,heartbeats:t})).length}function LS(t){if(t.length===0)return-1;let e=0,n=t[0].date;for(let i=1;i<t.length;i++)t[i].date<n&&(n=t[i].date,e=i);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DS(t){Je(new He("platform-logger",e=>new zT(e),"PRIVATE")),Je(new He("heartbeat",e=>new NS(e),"PRIVATE")),Be(Cc,dh,t),Be(Cc,dh,"esm2020"),Be("fire-js","")}DS("");var mh={};const _h="@firebase/database",yh="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ug=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new MS(e)}}catch{}return new xS},Rn=ug("localStorage"),FS=ug("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rl="5",pg="v",gg="s",mg="r",_g="f",yg=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,wg="ls",vg="p",kc="ac",bg="websocket",Eg="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ps{static get ALL_TRANSPORTS(){return[ai,tt]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const n=tt&&tt.isAvailable();let i=n&&!tt.previouslyFailed();if(e.webSocketOnly&&(n||Re("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),i=!0),i)this.transports_=[tt];else{const s=this.transports_=[];for(const r of Ps.ALL_TRANSPORTS)r&&r.isAvailable()&&s.push(r);Ps.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}Ps.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gr extends Pg{static getInstance(){return new Gr}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Il()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return g(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ah=32,Rh=768;class W{constructor(e,n){if(n===void 0){this.pieces_=e.split("/");let i=0;for(let s=0;s<this.pieces_.length;s++)this.pieces_[s].length>0&&(this.pieces_[i]=this.pieces_[s],i++);this.pieces_.length=i,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=n}toString(){let e="";for(let n=this.pieceNum_;n<this.pieces_.length;n++)this.pieces_[n]!==""&&(e+="/"+this.pieces_[n]);return e||"/"}}function U(){return new W("")}function P(t){return t.pieceNum_>=t.pieces_.length?null:t.pieces_[t.pieceNum_]}function ln(t){return t.pieces_.length-t.pieceNum_}function z(t){let e=t.pieceNum_;return e<t.pieces_.length&&e++,new W(t.pieces_,e)}function Ol(t){return t.pieceNum_<t.pieces_.length?t.pieces_[t.pieces_.length-1]:null}function CI(t){let e="";for(let n=t.pieceNum_;n<t.pieces_.length;n++)t.pieces_[n]!==""&&(e+="/"+encodeURIComponent(String(t.pieces_[n])));return e||"/"}function Os(t,e=0){return t.pieces_.slice(t.pieceNum_+e)}function Og(t){if(t.pieceNum_>=t.pieces_.length)return null;const e=[];for(let n=t.pieceNum_;n<t.pieces_.length-1;n++)e.push(t.pieces_[n]);return new W(e,0)}function X(t,e){const n=[];for(let i=t.pieceNum_;i<t.pieces_.length;i++)n.push(t.pieces_[i]);if(e instanceof W)for(let i=e.pieceNum_;i<e.pieces_.length;i++)n.push(e.pieces_[i]);else{const i=e.split("/");for(let s=0;s<i.length;s++)i[s].length>0&&n.push(i[s])}return new W(n,0)}function O(t){return t.pieceNum_>=t.pieces_.length}function ke(t,e){const n=P(t),i=P(e);if(n===null)return e;if(n===i)return ke(z(t),z(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+t+")")}function TI(t,e){const n=Os(t,0),i=Os(e,0);for(let s=0;s<n.length&&s<i.length;s++){const r=ti(n[s],i[s]);if(r!==0)return r}return n.length===i.length?0:n.length<i.length?-1:1}function Ll(t,e){if(ln(t)!==ln(e))return!1;for(let n=t.pieceNum_,i=e.pieceNum_;n<=t.pieces_.length;n++,i++)if(t.pieces_[n]!==e.pieces_[i])return!1;return!0}function qe(t,e){let n=t.pieceNum_,i=e.pieceNum_;if(ln(t)>ln(e))return!1;for(;n<t.pieces_.length;){if(t.pieces_[n]!==e.pieces_[i])return!1;++n,++i}return!0}class SI{constructor(e,n){this.errorPrefix_=n,this.parts_=Os(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let i=0;i<this.parts_.length;i++)this.byteLength_+=Mo(this.parts_[i]);Lg(this)}}function II(t,e){t.parts_.length>0&&(t.byteLength_+=1),t.parts_.push(e),t.byteLength_+=Mo(e),Lg(t)}function kI(t){const e=t.parts_.pop();t.byteLength_-=Mo(e),t.parts_.length>0&&(t.byteLength_-=1)}function Lg(t){if(t.byteLength_>Rh)throw new Error(t.errorPrefix_+"has a key path longer than "+Rh+" bytes ("+t.byteLength_+").");if(t.parts_.length>Ah)throw new Error(t.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Ah+") or object contains a cycle "+In(t))}function In(t){return t.parts_.length===0?"":"in property '"+t.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ac;function DI(t){Ac=t}const Mg=function(t){return typeof t=="number"?"number:"+fg(t):"string:"+t},xg=function(t){if(t.isLeafNode()){const e=t.val();g(typeof e=="string"||typeof e=="number"||typeof e=="object"&&wt(e,".sv"),"Priority must be a string or number.")}else g(t===Ac||t.isEmpty(),"priority of unexpected type.");g(t===Ac||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fg,Ug;function MI(t){Fg=t}function xI(t){Ug=t}class FI extends Bo{compare(e,n){const i=e.node.getPriority(),s=n.node.getPriority(),r=i.compareTo(s);return r===0?ti(e.name,n.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return L.MIN}maxPost(){return new L(Bn,new he("[PRIORITY-POST]",Ug))}makePost(e,n){const i=Fg(e);return new L(n,new he("[PRIORITY-POST]",i))}toString(){return".priority"}}const Q=new FI;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mh=10*1e3,XI=30*1e3,QI=300*1e3;class ZI{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new JI(e);const i=Mh+(XI-Mh)*Math.random();ps(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),n={};let i=!1;ye(e,(s,r)=>{r>0&&wt(this.statsToReport_,s)&&(n[s]=r,i=!0)}),i&&this.server_.reportStats(n),ps(this.reportStats_.bind(this),Math.floor(Math.random()*2*QI))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vo(t,e){return{eventCache:t,serverCache:e}}function gs(t,e,n,i){return Vo(new un(e,n,i),t.serverCache)}function Bg(t,e,n,i){return Vo(t.eventCache,new un(e,n,i))}function Qr(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function Vn(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wo(t,e){return qg(e,t)}function rk(t,e,n,i,s){g(i>t.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),t.allWrites.push({path:e,snap:n,writeId:i,visible:s}),s&&(t.visibleWrites=ms(t.visibleWrites,e,n)),t.lastWriteId=i}function ok(t,e,n,i){g(i>t.lastWriteId,"Stacking an older merge on top of newer ones"),t.allWrites.push({path:e,children:n,writeId:i,visible:!0}),t.visibleWrites=Pc(t.visibleWrites,e,n),t.lastWriteId=i}function ak(t,e){for(let n=0;n<t.allWrites.length;n++){const i=t.allWrites[n];if(i.writeId===e)return i}return null}function ck(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);g(n>=0,"removeWrite called with nonexistent writeId.");const i=t.allWrites[n];t.allWrites.splice(n,1);let s=i.visible,r=!1,o=t.allWrites.length-1;for(;s&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&lk(a,i.path)?s=!1:qe(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return uk(t),!0;if(i.snap)t.visibleWrites=xh(t.visibleWrites,i.path);else{const a=i.children;ye(a,c=>{t.visibleWrites=xh(t.visibleWrites,X(i.path,c))})}return!0}else return!1}function lk(t,e){if(t.snap)return qe(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&qe(X(t.path,n),e))return!0;return!1}function uk(t){t.visibleWrites=Vg(t.allWrites,dk,U()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function dk(t){return t.visible}function Vg(t,e,n){let i=ot.empty();for(let s=0;s<t.length;++s){const r=t[s];if(e(r)){const o=r.path;let a;if(r.snap)qe(n,o)?(a=ke(n,o),i=ms(i,a,r.snap)):qe(o,n)&&(a=ke(o,n),i=ms(i,U(),r.snap.getChild(a)));else if(r.children){if(qe(n,o))a=ke(n,o),i=Pc(i,a,r.children);else if(qe(o,n))if(a=ke(o,n),O(a))i=Pc(i,U(),r.children);else{const c=ki(r.children,P(a));if(c){const l=c.getChild(z(a));i=ms(i,U(),l)}}}else throw Hi("WriteRecord should have .snap or .children")}}return i}function Wg(t,e,n,i,s){if(!i&&!s){const r=ni(t.visibleWrites,e);if(r!=null)return r;{const o=tn(t.visibleWrites,e);if(Lc(o))return n;if(n==null&&!Oc(o,U()))return null;{const a=n||v.EMPTY_NODE;return Oi(o,a)}}}else{const r=tn(t.visibleWrites,e);if(!s&&Lc(r))return n;if(!s&&n==null&&!Oc(r,U()))return null;{const o=function(l){return(l.visible||s)&&(!i||!~i.indexOf(l.writeId))&&(qe(l.path,e)||qe(e,l.path))},a=Vg(t.allWrites,o,e),c=n||v.EMPTY_NODE;return Oi(a,c)}}}function hk(t,e,n){let i=v.EMPTY_NODE;const s=ni(t.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(Q,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(n){const r=tn(t.visibleWrites,e);return n.forEachChild(Q,(o,a)=>{const c=Oi(tn(r,new W(o)),a);i=i.updateImmediateChild(o,c)}),Fh(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=tn(t.visibleWrites,e);return Fh(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function fk(t,e,n,i,s){g(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=X(e,n);if(Oc(t.visibleWrites,r))return null;{const o=tn(t.visibleWrites,r);return Lc(o)?s.getChild(n):Oi(o,s.getChild(n))}}function pk(t,e,n,i){const s=X(e,n),r=ni(t.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(n)){const o=tn(t.visibleWrites,s);return Oi(o,i.getNode().getImmediateChild(n))}else return null}function gk(t,e){return ni(t.visibleWrites,e)}function mk(t,e,n,i,s,r,o){let a;const c=tn(t.visibleWrites,e),l=ni(c,U());if(l!=null)a=l;else if(n!=null)a=Oi(c,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],d=o.getCompare(),h=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let f=h.getNext();for(;f&&u.length<s;)d(f,i)!==0&&u.push(f),f=h.getNext();return u}else return[]}function _k(){return{visibleWrites:ot.empty(),allWrites:[],lastWriteId:-1}}function Zr(t,e,n,i){return Wg(t.writeTree,t.treePath,e,n,i)}function Bl(t,e){return hk(t.writeTree,t.treePath,e)}function Uh(t,e,n,i){return fk(t.writeTree,t.treePath,e,n,i)}function eo(t,e){return gk(t.writeTree,X(t.treePath,e))}function yk(t,e,n,i,s,r){return mk(t.writeTree,t.treePath,e,n,i,s,r)}function Hl(t,e,n){return pk(t.writeTree,t.treePath,e,n)}function jg(t,e){return qg(X(t.treePath,e),t.writeTree)}function qg(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let no;class Yg{constructor(){this.views=new Map}}function Mk(t){g(!no,"__referenceConstructor has already been defined"),no=t}function xk(){return g(no,"Reference.ts has not been loaded"),no}function Fk(t){return t.views.size===0}function Wl(t,e,n,i){const s=e.source.queryId;if(s!==null){const r=t.views.get(s);return g(r!=null,"SyncTree gave us an op for an invalid query."),Wh(r,e,n,i)}else{let r=[];for(const o of t.views.values())r=r.concat(Wh(o,e,n,i));return r}}function Jg(t,e,n,i,s){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let a=Zr(n,s?i:null),c=!1;a?c=!0:i instanceof v?(a=Bl(n,i),c=!1):(a=v.EMPTY_NODE,c=!1);const l=Vo(new un(a,c,!1),new un(i,s,!1));return new Rk(e,l)}return o}function Uk(t,e,n,i,s,r){const o=Jg(t,e,i,s,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),Lk(o,n),Dk(o,n)}function $k(t,e,n,i){const s=e._queryIdentifier,r=[];let o=[];const a=dn(t);if(s==="default")for(const[c,l]of t.views.entries())o=o.concat(Vh(l,n,i)),Hh(l)&&(t.views.delete(c),l.query._queryParams.loadsAllData()||r.push(l.query));else{const c=t.views.get(s);c&&(o=o.concat(Vh(c,n,i)),Hh(c)&&(t.views.delete(s),c.query._queryParams.loadsAllData()||r.push(c.query)))}return a&&!dn(t)&&r.push(new(xk())(e._repo,e._path)),{removed:r,events:o}}function Xg(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function nn(t,e){let n=null;for(const i of t.views.values())n=n||Ok(i,e);return n}function Qg(t,e){if(e._queryParams.loadsAllData())return jo(t);{const i=e._queryIdentifier;return t.views.get(i)}}function Zg(t,e){return Qg(t,e)!=null}function dn(t){return jo(t)!=null}function jo(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let io;function Bk(t){g(!io,"__referenceConstructor has already been defined"),io=t}function Hk(){return g(io,"Reference.ts has not been loaded"),io}let Vk=1;class jh{constructor(e){this.listenProvider_=e,this.syncPointTree_=new G(null),this.pendingWriteTree_=_k(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function em(t,e,n,i,s){return rk(t.pendingWriteTree_,e,n,i,s),s?Gi(t,new Hn(Fl(),e,n)):[]}function Wk(t,e,n,i){ok(t.pendingWriteTree_,e,n,i);const s=G.fromObject(n);return Gi(t,new Pi(Fl(),e,s))}function Yt(t,e,n=!1){const i=ak(t.pendingWriteTree_,e);if(ck(t.pendingWriteTree_,e)){let r=new G(null);return i.snap!=null?r=r.set(U(),!0):ye(i.children,o=>{r=r.set(new W(o),!0)}),Gi(t,new Xr(i.path,r,n))}else return[]}function tr(t,e,n){return Gi(t,new Hn(Ul(),e,n))}function jk(t,e,n){const i=G.fromObject(n);return Gi(t,new Pi(Ul(),e,i))}function qk(t,e){return Gi(t,new xs(Ul(),e))}function zk(t,e,n){const i=ql(t,n);if(i){const s=zl(i),r=s.path,o=s.queryId,a=ke(r,e),c=new xs($l(o),a);return Gl(t,r,c)}else return[]}function so(t,e,n,i,s=!1){const r=e._path,o=t.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||Zg(o,e))){const c=$k(o,e,n,i);Fk(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const l=c.removed;if(a=c.events,!s){const u=l.findIndex(h=>h._queryParams.loadsAllData())!==-1,d=t.syncPointTree_.findOnPath(r,(h,f)=>dn(f));if(u&&!d){const h=t.syncPointTree_.subtree(r);if(!h.isEmpty()){const f=Yk(h);for(let p=0;p<f.length;++p){const _=f[p],m=_.query,R=sm(t,_);t.listenProvider_.startListening(_s(m),Fs(t,m),R.hashFn,R.onComplete)}}}!d&&l.length>0&&!i&&(u?t.listenProvider_.stopListening(_s(e),null):l.forEach(h=>{const f=t.queryToTagMap.get(qo(h));t.listenProvider_.stopListening(_s(h),f)}))}Jk(t,l)}return a}function tm(t,e,n,i){const s=ql(t,i);if(s!=null){const r=zl(s),o=r.path,a=r.queryId,c=ke(o,e),l=new Hn($l(a),c,n);return Gl(t,o,l)}else return[]}function Gk(t,e,n,i){const s=ql(t,i);if(s){const r=zl(s),o=r.path,a=r.queryId,c=ke(o,e),l=G.fromObject(n),u=new Pi($l(a),c,l);return Gl(t,o,u)}else return[]}function xc(t,e,n,i=!1){const s=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(s,(h,f)=>{const p=ke(h,s);r=r||nn(f,p),o=o||dn(f)});let a=t.syncPointTree_.get(s);a?(o=o||dn(a),r=r||nn(a,U())):(a=new Yg,t.syncPointTree_=t.syncPointTree_.set(s,a));let c;r!=null?c=!0:(c=!1,r=v.EMPTY_NODE,t.syncPointTree_.subtree(s).foreachChild((f,p)=>{const _=nn(p,U());_&&(r=r.updateImmediateChild(f,_))}));const l=Zg(a,e);if(!l&&!e._queryParams.loadsAllData()){const h=qo(e);g(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const f=Xk();t.queryToTagMap.set(h,f),t.tagToQueryMap.set(f,h)}const u=Wo(t.pendingWriteTree_,s);let d=Uk(a,e,n,u,r,c);if(!l&&!o&&!i){const h=Qg(a,e);d=d.concat(Qk(t,e,h))}return d}function jl(t,e,n){const s=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,a)=>{const c=ke(o,e),l=nn(a,c);if(l)return l});return Wg(s,e,r,n,!0)}function Kk(t,e){const n=e._path;let i=null;t.syncPointTree_.foreachOnPath(n,(l,u)=>{const d=ke(l,n);i=i||nn(u,d)});let s=t.syncPointTree_.get(n);s?i=i||nn(s,U()):(s=new Yg,t.syncPointTree_=t.syncPointTree_.set(n,s));const r=i!=null,o=r?new un(i,!0,!1):null,a=Wo(t.pendingWriteTree_,e._path),c=Jg(s,e,a,r?o.getNode():v.EMPTY_NODE,r);return Pk(c)}function Gi(t,e){return nm(e,t.syncPointTree_,null,Wo(t.pendingWriteTree_,U()))}function nm(t,e,n,i){if(O(t.path))return im(t,e,n,i);{const s=e.get(U());n==null&&s!=null&&(n=nn(s,U()));let r=[];const o=P(t.path),a=t.operationForChild(o),c=e.children.get(o);if(c&&a){const l=n?n.getImmediateChild(o):null,u=jg(i,o);r=r.concat(nm(a,c,l,u))}return s&&(r=r.concat(Wl(s,t,i,n))),r}}function im(t,e,n,i){const s=e.get(U());n==null&&s!=null&&(n=nn(s,U()));let r=[];return e.children.inorderTraversal((o,a)=>{const c=n?n.getImmediateChild(o):null,l=jg(i,o),u=t.operationForChild(o);u&&(r=r.concat(im(u,a,c,l)))}),s&&(r=r.concat(Wl(s,t,i,n))),r}function sm(t,e){const n=e.query,i=Fs(t,n);return{hashFn:()=>(Nk(e)||v.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?zk(t,n._path,i):qk(t,n._path);{const r=qS(s,n);return so(t,n,null,r)}}}}function Fs(t,e){const n=qo(e);return t.queryToTagMap.get(n)}function qo(t){return t._path.toString()+"$"+t._queryIdentifier}function ql(t,e){return t.tagToQueryMap.get(e)}function zl(t){const e=t.indexOf("$");return g(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new W(t.substr(0,e))}}function Gl(t,e,n){const i=t.syncPointTree_.get(e);g(i,"Missing sync point for query tag that we're tracking");const s=Wo(t.pendingWriteTree_,e);return Wl(i,n,s,null)}function Yk(t){return t.fold((e,n,i)=>{if(n&&dn(n))return[jo(n)];{let s=[];return n&&(s=Xg(n)),ye(i,(r,o)=>{s=s.concat(o)}),s}})}function _s(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(Hk())(t._repo,t._path):t}function Jk(t,e){for(let n=0;n<e.length;++n){const i=e[n];if(!i._queryParams.loadsAllData()){const s=qo(i),r=t.queryToTagMap.get(s);t.queryToTagMap.delete(s),t.tagToQueryMap.delete(r)}}}function Xk(){return Vk++}function Qk(t,e,n){const i=e._path,s=Fs(t,e),r=sm(t,n),o=t.listenProvider_.startListening(_s(e),s,r.hashFn,r.onComplete),a=t.syncPointTree_.subtree(i);if(s)g(!dn(a.value),"If we're adding a query, it shouldn't be shadowed");else{const c=a.fold((l,u,d)=>{if(!O(l)&&u&&dn(u))return[jo(u).query];{let h=[];return u&&(h=h.concat(Xg(u).map(f=>f.query))),ye(d,(f,p)=>{h=h.concat(p)}),h}});for(let l=0;l<c.length;++l){const u=c[l];t.listenProvider_.stopListening(_s(u),Fs(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pA="repo_interrupt",gA=25;class mA{constructor(e,n,i,s){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new hA,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Jr(),this.transactionQueueTree_=new Xl,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function _A(t,e,n){if(t.stats_=Nl(t.repoInfo_),t.forceRestClient_||YS())t.server_=new Yr(t.repoInfo_,(i,s,r,o)=>{zh(t,i,s,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Gh(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ce(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}t.persistentConnection_=new Pt(t.repoInfo_,e,(i,s,r,o)=>{zh(t,i,s,r,o)},i=>{Gh(t,i)},i=>{yA(t,i)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(i=>{t.server_.refreshAuthToken(i)}),t.appCheckProvider_.addTokenChangeListener(i=>{t.server_.refreshAppCheckToken(i.token)}),t.statsReporter_=eI(t.repoInfo_,()=>new ZI(t.stats_,t.server_)),t.infoData_=new KI,t.infoSyncTree_=new jh({startListening:(i,s,r,o)=>{let a=[];const c=t.infoData_.getNode(i._path);return c.isEmpty()||(a=tr(t.infoSyncTree_,i._path,c),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),tu(t,"connected",!1),t.serverSyncTree_=new jh({startListening:(i,s,r,o)=>(t.server_.listen(i,r,s,(a,c)=>{const l=o(a,c);Xe(t.eventQueue_,i._path,l)}),[]),stopListening:(i,s)=>{t.server_.unlisten(i,s)}})}function gm(t){const n=t.infoData_.getNode(new W(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Yo(t){return Zk({timestamp:gm(t)})}function zh(t,e,n,i,s){t.dataUpdateCount++;const r=new W(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(s)if(i){const c=jr(n,l=>Z(l));o=Gk(t.serverSyncTree_,r,c,s)}else{const c=Z(n);o=tm(t.serverSyncTree_,r,c,s)}else if(i){const c=jr(n,l=>Z(l));o=jk(t.serverSyncTree_,r,c)}else{const c=Z(n);o=tr(t.serverSyncTree_,r,c)}let a=r;o.length>0&&(a=Li(t,r)),Xe(t.eventQueue_,a,o)}function Gh(t,e){tu(t,"connected",e),e===!1&&EA(t)}function yA(t,e){ye(e,(n,i)=>{tu(t,n,i)})}function tu(t,e,n){const i=new W("/.info/"+e),s=Z(n);t.infoData_.updateSnapshot(i,s);const r=tr(t.infoSyncTree_,i,s);Xe(t.eventQueue_,i,r)}function nu(t){return t.nextWriteId_++}function wA(t,e,n){const i=Kk(t.serverSyncTree_,e);return i!=null?Promise.resolve(i):t.server_.get(e).then(s=>{const r=Z(s).withIndex(e._queryParams.getIndex());xc(t.serverSyncTree_,e,n,!0);let o;if(e._queryParams.loadsAllData())o=tr(t.serverSyncTree_,e._path,r);else{const a=Fs(t.serverSyncTree_,e);o=tm(t.serverSyncTree_,e._path,r,a)}return Xe(t.eventQueue_,e._path,o),so(t.serverSyncTree_,e,n,null,!0),r},s=>(ir(t,"get for query "+ce(e)+" failed: "+s),Promise.reject(new Error(s))))}function vA(t,e,n,i,s){ir(t,"set",{path:e.toString(),value:n,priority:i});const r=Yo(t),o=Z(n,i),a=jl(t.serverSyncTree_,e),c=om(o,a,r),l=nu(t),u=em(t.serverSyncTree_,e,c,l,!0);Ko(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(h,f)=>{const p=h==="ok";p||Re("set at "+e+" failed: "+h);const _=Yt(t.serverSyncTree_,l,!p);Xe(t.eventQueue_,e,_),hn(t,s,h,f)});const d=su(t,e);Li(t,d),Xe(t.eventQueue_,d,[])}function bA(t,e,n,i){ir(t,"update",{path:e.toString(),value:n});let s=!0;const r=Yo(t),o={};if(ye(n,(a,c)=>{s=!1,o[a]=rm(X(e,a),Z(c),t.serverSyncTree_,r)}),s)pe("update() called with empty data.  Don't do anything."),hn(t,i,"ok",void 0);else{const a=nu(t),c=Wk(t.serverSyncTree_,e,o,a);Ko(t.eventQueue_,c),t.server_.merge(e.toString(),n,(l,u)=>{const d=l==="ok";d||Re("update at "+e+" failed: "+l);const h=Yt(t.serverSyncTree_,a,!d),f=h.length>0?Li(t,e):e;Xe(t.eventQueue_,f,h),hn(t,i,l,u)}),ye(n,l=>{const u=su(t,X(e,l));Li(t,u)}),Xe(t.eventQueue_,e,[])}}function EA(t){ir(t,"onDisconnectEvents");const e=Yo(t),n=Jr();Nc(t.onDisconnect_,U(),(s,r)=>{const o=rm(s,r,t.serverSyncTree_,e);zi(n,s,o)});let i=[];Nc(n,U(),(s,r)=>{i=i.concat(tr(t.serverSyncTree_,s,r));const o=su(t,s);Li(t,o)}),t.onDisconnect_=Jr(),Xe(t.eventQueue_,U(),i)}function CA(t,e,n){t.server_.onDisconnectCancel(e.toString(),(i,s)=>{i==="ok"&&Rc(t.onDisconnect_,e),hn(t,n,i,s)})}function Kh(t,e,n,i){const s=Z(n);t.server_.onDisconnectPut(e.toString(),s.val(!0),(r,o)=>{r==="ok"&&zi(t.onDisconnect_,e,s),hn(t,i,r,o)})}function TA(t,e,n,i,s){const r=Z(n,i);t.server_.onDisconnectPut(e.toString(),r.val(!0),(o,a)=>{o==="ok"&&zi(t.onDisconnect_,e,r),hn(t,s,o,a)})}function SA(t,e,n,i){if(Wr(n)){pe("onDisconnect().update() called with empty data.  Don't do anything."),hn(t,i,"ok",void 0);return}t.server_.onDisconnectMerge(e.toString(),n,(s,r)=>{s==="ok"&&ye(n,(o,a)=>{const c=Z(a);zi(t.onDisconnect_,X(e,o),c)}),hn(t,i,s,r)})}function IA(t,e,n){let i;P(e._path)===".info"?i=xc(t.infoSyncTree_,e,n):i=xc(t.serverSyncTree_,e,n),fm(t.eventQueue_,e._path,i)}function mm(t,e,n){let i;P(e._path)===".info"?i=so(t.infoSyncTree_,e,n):i=so(t.serverSyncTree_,e,n),fm(t.eventQueue_,e._path,i)}function kA(t){t.persistentConnection_&&t.persistentConnection_.interrupt(pA)}function ir(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),pe(n,...e)}function hn(t,e,n,i){e&&qi(()=>{if(n==="ok")e(null);else{const s=(n||"error").toUpperCase();let r=s;i&&(r+=": "+i);const o=new Error(r);o.code=s,e(o)}})}function _m(t,e,n){return jl(t.serverSyncTree_,e,n)||v.EMPTY_NODE}function iu(t,e=t.transactionQueueTree_){if(e||Jo(t,e),Ki(e)){const n=wm(t,e);g(n.length>0,"Sending zero length transaction queue"),n.every(s=>s.status===0)&&AA(t,nr(e),n)}else cm(e)&&zo(e,n=>{iu(t,n)})}function AA(t,e,n){const i=n.map(l=>l.currentWriteId),s=_m(t,e,i);let r=s;const o=s.hash();for(let l=0;l<n.length;l++){const u=n[l];g(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const d=ke(e,u.path);r=r.updateChild(d,u.currentOutputSnapshotRaw)}const a=r.val(!0),c=e;t.server_.put(c.toString(),a,l=>{ir(t,"transaction put response",{path:c.toString(),status:l});let u=[];if(l==="ok"){const d=[];for(let h=0;h<n.length;h++)n[h].status=2,u=u.concat(Yt(t.serverSyncTree_,n[h].currentWriteId)),n[h].onComplete&&d.push(()=>n[h].onComplete(null,!0,n[h].currentOutputSnapshotResolved)),n[h].unwatcher();Jo(t,Ql(t.transactionQueueTree_,e)),iu(t,t.transactionQueueTree_),Xe(t.eventQueue_,e,u);for(let h=0;h<d.length;h++)qi(d[h])}else{if(l==="datastale")for(let d=0;d<n.length;d++)n[d].status===3?n[d].status=4:n[d].status=0;else{Re("transaction at "+c.toString()+" failed: "+l);for(let d=0;d<n.length;d++)n[d].status=4,n[d].abortReason=l}Li(t,e)}},o)}function Li(t,e){const n=ym(t,e),i=nr(n),s=wm(t,n);return RA(t,s,i),i}function RA(t,e,n){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const c=e[a],l=ke(n,c.path);let u=!1,d;if(g(l!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)u=!0,d=c.abortReason,s=s.concat(Yt(t.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=gA)u=!0,d="maxretry",s=s.concat(Yt(t.serverSyncTree_,c.currentWriteId,!0));else{const h=_m(t,c.path,o);c.currentInputSnapshot=h;const f=e[a].update(h.val());if(f!==void 0){Go("transaction failed: Data returned ",f,c.path);let p=Z(f);typeof f=="object"&&f!=null&&wt(f,".priority")||(p=p.updatePriority(h.getPriority()));const m=c.currentWriteId,R=Yo(t),B=om(p,h,R);c.currentOutputSnapshotRaw=p,c.currentOutputSnapshotResolved=B,c.currentWriteId=nu(t),o.splice(o.indexOf(m),1),s=s.concat(em(t.serverSyncTree_,c.path,B,c.currentWriteId,c.applyLocally)),s=s.concat(Yt(t.serverSyncTree_,m,!0))}else u=!0,d="nodata",s=s.concat(Yt(t.serverSyncTree_,c.currentWriteId,!0))}Xe(t.eventQueue_,n,s),s=[],u&&(e[a].status=2,(function(h){setTimeout(h,Math.floor(0))})(e[a].unwatcher),e[a].onComplete&&(d==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(d),!1,null))))}Jo(t,t.transactionQueueTree_);for(let a=0;a<i.length;a++)qi(i[a]);iu(t,t.transactionQueueTree_)}function ym(t,e){let n,i=t.transactionQueueTree_;for(n=P(e);n!==null&&Ki(i)===void 0;)i=Ql(i,n),e=z(e),n=P(e);return i}function wm(t,e){const n=[];return vm(t,e,n),n.sort((i,s)=>i.order-s.order),n}function vm(t,e,n){const i=Ki(e);if(i)for(let s=0;s<i.length;s++)n.push(i[s]);zo(e,s=>{vm(t,s,n)})}function Jo(t,e){const n=Ki(e);if(n){let i=0;for(let s=0;s<n.length;s++)n[s].status!==2&&(n[i]=n[s],i++);n.length=i,am(e,n.length>0?n:void 0)}zo(e,i=>{Jo(t,i)})}function su(t,e){const n=nr(ym(t,e)),i=Ql(t.transactionQueueTree_,e);return iA(i,s=>{Ua(t,s)}),Ua(t,i),lm(i,s=>{Ua(t,s)}),n}function Ua(t,e){const n=Ki(e);if(n){const i=[];let s=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(g(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(g(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),s=s.concat(Yt(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&i.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?am(e,void 0):n.length=r+1,Xe(t.eventQueue_,nr(e),s);for(let o=0;o<i.length;o++)qi(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function NA(t){let e="";const n=t.split("/");for(let i=0;i<n.length;i++)if(n[i].length>0){let s=n[i];try{s=decodeURIComponent(s.replace(/\+/g," "))}catch{}e+="/"+s}return e}function PA(t){const e={};t.charAt(0)==="?"&&(t=t.substring(1));for(const n of t.split("&")){if(n.length===0)continue;const i=n.split("=");i.length===2?e[decodeURIComponent(i[0])]=decodeURIComponent(i[1]):Re(`Invalid query segment '${n}' in query '${t}'`)}return e}const Yh=function(t,e){const n=OA(t),i=n.namespace;n.domain==="firebase.com"&&Mt(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!i||i==="undefined")&&n.domain!=="localhost"&&Mt("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||BS();const s=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new Cg(n.host,n.secure,i,s,e,"",i!==n.subdomain),path:new W(n.pathString)}},OA=function(t){let e="",n="",i="",s="",r="",o=!0,a="https",c=443;if(typeof t=="string"){let l=t.indexOf("//");l>=0&&(a=t.substring(0,l-1),t=t.substring(l+2));let u=t.indexOf("/");u===-1&&(u=t.length);let d=t.indexOf("?");d===-1&&(d=t.length),e=t.substring(0,Math.min(u,d)),u<d&&(s=NA(t.substring(u,d)));const h=PA(t.substring(Math.min(t.length,d)));l=e.indexOf(":"),l>=0?(o=a==="https"||a==="wss",c=parseInt(e.substring(l+1),10)):l=e.length;const f=e.slice(0,l);if(f.toLowerCase()==="localhost")n="localhost";else if(f.split(".").length<=2)n=f;else{const p=e.indexOf(".");i=e.substring(0,p).toLowerCase(),n=e.substring(p+1),r=i}"ns"in h&&(r=h.ns)}return{host:e,port:c,domain:n,subdomain:i,secure:o,scheme:a,pathString:s,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jh="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",LA=(function(){let t=0;const e=[];return function(n){const i=n===t;t=n;let s;const r=new Array(8);for(s=7;s>=0;s--)r[s]=Jh.charAt(n%64),n=Math.floor(n/64);g(n===0,"Cannot push at time == 0");let o=r.join("");if(i){for(s=11;s>=0&&e[s]===63;s--)e[s]=0;e[s]++}else for(s=0;s<12;s++)e[s]=Math.floor(Math.random()*64);for(s=0;s<12;s++)o+=Jh.charAt(e[s]);return g(o.length===20,"nextPushId: Length should be 20."),o}})();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cm{constructor(e,n){this._repo=e,this._path=n}cancel(){const e=new Oe;return CA(this._repo,this._path,e.wrapCallback(()=>{})),e.promise}remove(){Jt("OnDisconnect.remove",this._path);const e=new Oe;return Kh(this._repo,this._path,null,e.wrapCallback(()=>{})),e.promise}set(e){Jt("OnDisconnect.set",this._path),ro("OnDisconnect.set",e,this._path,!1);const n=new Oe;return Kh(this._repo,this._path,e,n.wrapCallback(()=>{})),n.promise}setWithPriority(e,n){Jt("OnDisconnect.setWithPriority",this._path),ro("OnDisconnect.setWithPriority",e,this._path,!1),lA("OnDisconnect.setWithPriority",n);const i=new Oe;return TA(this._repo,this._path,e,n,i.wrapCallback(()=>{})),i.promise}update(e){Jt("OnDisconnect.update",this._path),hm("OnDisconnect.update",e,this._path);const n=new Oe;return SA(this._repo,this._path,e,n.wrapCallback(()=>{})),n.promise}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xo{constructor(e,n,i,s){this._repo=e,this._path=n,this._queryParams=i,this._orderByCalled=s}get key(){return O(this._path)?null:Ol(this._path)}get ref(){return new dt(this._repo,this._path)}get _queryIdentifier(){const e=Dh(this._queryParams),n=Al(e);return n==="{}"?"default":n}get _queryObject(){return Dh(this._queryParams)}isEqual(e){if(e=ne(e),!(e instanceof Xo))return!1;const n=this._repo===e._repo,i=Ll(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return n&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+CI(this._path)}}class dt extends Xo{constructor(e,n){super(e,n,new Ho,!1)}get parent(){const e=Og(this._path);return e===null?null:new dt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Wn{constructor(e,n,i){this._node=e,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new W(e),i=jn(this.ref,e);return new Wn(this._node.getChild(n),i,Q)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new Wn(s,jn(this.ref,i),Q)))}hasChild(e){const n=new W(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function S(t,e){return t=ne(t),t._checkNotDeleted("ref"),e!==void 0?jn(t._root,e):t._root}function jn(t,e){return t=ne(t),P(t._path)===null?uA("child","path",e):eu("child","path",e),new dt(t._repo,X(t._path,e))}function Tm(t){return t=ne(t),new Cm(t._repo,t._path)}function Us(t,e){t=ne(t),Jt("push",t._path),ro("push",e,t._path,!0);const n=gm(t._repo),i=LA(n),s=jn(t,i),r=jn(t,i);let o;return o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function Ve(t){return Jt("remove",t._path),te(t,null)}function te(t,e){t=ne(t),Jt("set",t._path),ro("set",e,t._path,!1);const n=new Oe;return vA(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function Ln(t,e){hm("update",e,t._path);const n=new Oe;return bA(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function Ge(t){t=ne(t);const e=new ru(()=>{}),n=new sr(e);return wA(t._repo,t,n).then(i=>new Wn(i,new dt(t._repo,t._path),t._queryParams.getIndex()))}class sr{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const i=n._queryParams.getIndex();return new bm("value",this,new Wn(e.snapshotNode,new dt(n._repo,n._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Em(this,e,n):null}matches(e){return e instanceof sr?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class Qo{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Em(this,e,n):null}createEvent(e,n){g(e.childName!=null,"Child events should have a childName.");const i=jn(new dt(n._repo,n._path),e.childName),s=n._queryParams.getIndex();return new bm(e.type,this,new Wn(e.snapshotNode,i,s),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Qo?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function Zo(t,e,n,i,s){const r=new ru(n,void 0),o=e==="value"?new sr(r):new Qo(e,r);return IA(t._repo,t,o),()=>mm(t._repo,t,o)}function ou(t,e,n,i){return Zo(t,"value",e)}function Di(t,e,n,i){return Zo(t,"child_added",e)}function Sm(t,e,n,i){return Zo(t,"child_changed",e)}function Im(t,e,n,i){return Zo(t,"child_removed",e)}function Ot(t,e,n){let i=null;const s=n?new ru(n):null;e==="value"?i=new sr(s):e&&(i=new Qo(e,s)),mm(t._repo,t,i)}Mk(dt);Bk(dt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DA="FIREBASE_DATABASE_EMULATOR_HOST",Uc={};let MA=!1;function xA(t,e,n,i){const s=e.lastIndexOf(":"),r=e.substring(0,s),o=Vi(r);t.repoInfo_=new Cg(e,o,t.repoInfo_.namespace,t.repoInfo_.webSocketOnly,t.repoInfo_.nodeAdmin,t.repoInfo_.persistenceKey,t.repoInfo_.includeNamespaceInQueryParams,!0,n),i&&(t.authTokenProvider_=i)}function km(t,e,n,i,s){let r=i||t.options.databaseURL;r===void 0&&(t.options.projectId||Mt("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),pe("Using default host for project ",t.options.projectId),r=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=Yh(r,s),a=o.repoInfo,c;typeof process<"u"&&mh&&(c=mh[DA]),c?(r=`http://${c}?ns=${a.namespace}`,o=Yh(r,s),a=o.repoInfo):o.repoInfo.secure;const l=new XS(t.name,t.options,e);dA("Invalid Firebase Database URL",o),O(o.path)||Mt("Database URL must point to the root of a Firebase Database (not including a child path).");const u=UA(a,t,l,new JS(t,n));return new Am(u,t)}function FA(t,e){const n=Uc[e];(!n||n[t.key]!==t)&&Mt(`Database ${e}(${t.repoInfo_}) has already been deleted.`),kA(t),delete n[t.key]}function UA(t,e,n,i){let s=Uc[e.name];s||(s={},Uc[e.name]=s);let r=s[t.toURLString()];return r&&Mt("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new mA(t,MA,n,i),s[t.toURLString()]=r,r}class Am{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(_A(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new dt(this._repo,U())),this._rootInternal}_delete(){return this._rootInternal!==null&&(FA(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&Mt("Cannot call "+e+" on a deleted database.")}}function Rm(t=Uo(),e){const n=_n(t,"database").getImmediate({identifier:e});if(!n._instanceStarted){const i=sT("database");i&&Nm(n,...i)}return n}function Nm(t,e,n,i={}){t=ne(t),t._checkNotDeleted("useEmulator");const s=`${e}:${n}`,r=t._repoInternal;if(t._instanceStarted){if(s===t._repoInternal.repoInfo_.host&&$n(i,r.repoInfo_.emulatorOptions))return;Mt("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)i.mockUserToken&&Mt('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Rr(Rr.OWNER);else if(i.mockUserToken){const a=typeof i.mockUserToken=="string"?i.mockUserToken:rT(i.mockUserToken,t.app.options.projectId);o=new Rr(a)}Vi(e)&&(Qp(e),Zp("Database",!0)),xA(r,s,i,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $A(t){lg(ji),Je(new He("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return km(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),Be(_h,yh,t),Be(_h,yh,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BA={".sv":"timestamp"};function Dn(){return BA}Pt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Pt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};$A();const HA=Object.freeze(Object.defineProperty({__proto__:null,DataSnapshot:Wn,Database:Am,OnDisconnect:Cm,_QueryImpl:Xo,_QueryParams:Ho,_ReferenceImpl:dt,_repoManagerDatabaseFromApp:km,_setSDKVersion:lg,_validatePathString:eu,_validateWritablePath:Jt,child:jn,connectDatabaseEmulator:Nm,get:Ge,getDatabase:Rm,off:Ot,onChildAdded:Di,onChildChanged:Sm,onChildRemoved:Im,onDisconnect:Tm,onValue:ou,push:Us,ref:S,remove:Ve,serverTimestamp:Dn,set:te,update:Ln},Symbol.toStringTag,{value:"Module"}));var VA="firebase",WA="12.8.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $c=new Map,Pm={activated:!1,tokenObservers:[]},jA={initialized:!1,enabled:!1};function le(t){return $c.get(t)||{...Pm}}function qA(t,e){return $c.set(t,e),$c.get(t)}function ea(){return jA}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Om="https://content-firebaseappcheck.googleapis.com/v1",zA="exchangeRecaptchaEnterpriseToken",GA="exchangeDebugToken",Xh={RETRIAL_MIN_WAIT:30*1e3,RETRIAL_MAX_WAIT:960*1e3},KA=1440*60*1e3;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function lu(){return ea().enabled}async function uu(){const t=ea();if(t.enabled&&t.token)return t.token.promise;throw Error(`
        ...
        `)}function aR(){const t=Kp(),e=ea();if(e.initialized=!0,typeof t.FIREBASE_APPCHECK_DEBUG_TOKEN!="string"&&t.FIREBASE_APPCHECK_DEBUG_TOKEN!==!0)return;e.enabled=!0;const n=new Oe;e.token=n,typeof t.FIREBASE_APPCHECK_DEBUG_TOKEN=="string"?n.resolve(t.FIREBASE_APPCHECK_DEBUG_TOKEN):n.resolve(oR())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cR={error:"UNKNOWN_ERROR"};function lR(t){return Lo.encodeString(JSON.stringify(t),!1)}async function Bc(t,e=!1,n=!1){const i=t.app;au(i);const s=le(i);let r=s.token,o;if(r&&!ci(r)&&(s.token=void 0,r=void 0),!r){const l=await s.cachedTokenPromise;l&&(ci(l)?r=l:await $a(i,void 0))}if(!e&&r&&ci(r))return{token:r.token};let a=!1;if(lu())try{s.exchangeTokenPromise||(s.exchangeTokenPromise=cu(Dm(i,await uu()),t.heartbeatServiceProvider).finally(()=>{s.exchangeTokenPromise=void 0}),a=!0);const l=await s.exchangeTokenPromise;return await $a(i,l),s.token=l,{token:l.token}}catch(l){return l.code==="appCheck/throttled"||l.code==="appCheck/initial-throttle"?Xt.warn(l.message):n&&Xt.error(l),Ba(l)}try{s.exchangeTokenPromise||(s.exchangeTokenPromise=s.provider.getToken().finally(()=>{s.exchangeTokenPromise=void 0}),a=!0),r=await le(i).exchangeTokenPromise}catch(l){l.code==="appCheck/throttled"||l.code==="appCheck/initial-throttle"?Xt.warn(l.message):n&&Xt.error(l),o=l}let c;return r?o?ci(r)?c={token:r.token,internalError:o}:c=Ba(o):(c={token:r.token},s.token=r,await $a(i,r)):c=Ba(o),a&&Vm(i,c),c}async function uR(t){const e=t.app;au(e);const{provider:n}=le(e);if(lu()){const i=await uu(),{token:s}=await cu(Dm(e,i),t.heartbeatServiceProvider);return{token:s}}else{const{token:i}=await n.getToken();return{token:i}}}function Bm(t,e,n,i){const{app:s}=t,r=le(s),o={next:n,error:i,type:e};if(r.tokenObservers=[...r.tokenObservers,o],r.token&&ci(r.token)){const a=r.token;Promise.resolve().then(()=>{n({token:a.token}),Zh(t)}).catch(()=>{})}r.cachedTokenPromise.then(()=>Zh(t))}function Hm(t,e){const n=le(t),i=n.tokenObservers.filter(s=>s.next!==e);i.length===0&&n.tokenRefresher&&n.tokenRefresher.isRunning()&&n.tokenRefresher.stop(),n.tokenObservers=i}function Zh(t){const{app:e}=t,n=le(e);let i=n.tokenRefresher;i||(i=dR(t),n.tokenRefresher=i),!i.isRunning()&&n.isTokenAutoRefreshEnabled&&i.start()}function dR(t){const{app:e}=t;return new YA(async()=>{const n=le(e);let i;if(n.token?i=await Bc(t,!0):i=await Bc(t),i.error)throw i.error;if(i.internalError)throw i.internalError},()=>!0,()=>{const n=le(e);if(n.token){let i=n.token.issuedAtTimeMillis+(n.token.expireTimeMillis-n.token.issuedAtTimeMillis)*.5+3e5;const s=n.token.expireTimeMillis-300*1e3;return i=Math.min(i,s),Math.max(0,i-Date.now())}else return 0},Xh.RETRIAL_MIN_WAIT,Xh.RETRIAL_MAX_WAIT)}function Vm(t,e){const n=le(t).tokenObservers;for(const i of n)try{i.type==="EXTERNAL"&&e.error!=null?i.error(e.error):i.next(e)}catch{}}function ci(t){return t.expireTimeMillis-Date.now()>0}function Ba(t){return{token:lR(cR),error:t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function SR(t=Uo(),e){t=ne(t);const n=_n(t,"app-check");if(ea().initialized||aR(),lu()&&uu().then(s=>console.log(`App Check debug token: ${s}. You will need to add it to your app's App Check settings in the Firebase console for it to work.`)),n.isInitialized()){const s=n.getImmediate(),r=n.getOptions();if(r.isTokenAutoRefreshEnabled===e.isTokenAutoRefreshEnabled&&r.provider.isEqual(e.provider))return s;throw De.create("already-initialized",{appName:t.name})}const i=n.initialize({options:e});return IR(t,e.provider,e.isTokenAutoRefreshEnabled),le(t).isTokenAutoRefreshEnabled&&Bm(i,"INTERNAL",()=>{}),i}function IR(t,e,n=!1){const i=qA(t,{...Pm});i.activated=!0,i.provider=e,i.cachedTokenPromise=rR(t).then(s=>(s&&ci(s)&&(i.token=s,Vm(t,{token:s.token})),s)),i.isTokenAutoRefreshEnabled=n&&t.automaticDataCollectionEnabled,!t.automaticDataCollectionEnabled&&n&&Xt.warn("`isTokenAutoRefreshEnabled` is true but `automaticDataCollectionEnabled` was set to false during `initializeApp()`. This blocks automatic token refresh."),i.provider.initialize(t)}const kR="app-check",tf="app-check-internal";function AR(){Je(new He(kR,t=>{const e=t.getProvider("app").getImmediate(),n=t.getProvider("heartbeat");return fR(e,n)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,e,n)=>{t.getProvider(tf).initialize()})),Je(new He(tf,t=>{const e=t.getProvider("app-check").getImmediate();return pR(e)},"PUBLIC").setInstantiationMode("EXPLICIT")),Be(gR,mR)}AR();const RR={apiKey:"AIzaSyA-fvCaKCjyEFX__YAVr1oPGdVsUEhFehA",authDomain:"vidu-aae11.web.app",projectId:"vidu-aae11",databaseURL:"https://vidu-aae11-default-rtdb.europe-west1.firebasedatabase.app",storageBucket:"vidu-aae11.firebasestorage.app",messagingSenderId:"765724787439",appId:"1:765724787439:web:61a3b5dd538149564c911a",measurementId:"G-EGJ53HLGY4"},ta=rg(RR),NR="BIk-HpbCt3Vn7GtQtnFfv0h-hvj_2moy04xGYbmXoqH-AsfQVtiTyxl-QZG1plpYHUysu3yaK7jm1wE0OC6Byys",nf="6LdBIBgsAAAAAB4zIcXaZI-FD4kt21TWs9Zx9_fp";let Hc;if(nf.trim()!=="")Hc=new du(nf),console.info("[Firebase App Check: PROD] Initializing with ReCAPTCHA Enterprise (invisible mode).");else throw console.error("[Firebase App Check: PROD] VITE_RECAPTCHA_ENTERPRISE_SITE_KEY is missing or empty. App Check will NOT be initialized, leaving Firebase services unprotected!"),new Error("Firebase App Check configuration missing in production.");if(Hc)try{SR(ta,{provider:Hc,isTokenAutoRefreshEnabled:!0})}catch(t){console.error("[Firebase App Check] initializeAppCheck call failed:",t)}const I=Rm(ta),it=[];function An(t,e,n,i=null,s=null,r=null){e==="value"?ou(t,n):e==="child_added"?Di(t,n):e==="child_removed"?Im(t,n):console.warn(`Unknown listener type: ${e}`),it.push({ref:t,type:e,callback:n,roomId:i,userId:s,category:r})}function PR(){it.forEach(({ref:t,type:e,callback:n})=>{try{Ot(t,e,n)}catch(i){console.warn("Failed to remove firebase rtdb listener",i)}}),it.length=0}function na(t){if(!t)return;it.filter(i=>i.roomId===t).forEach(({ref:i,type:s,callback:r})=>{try{Ot(i,s,r)}catch(o){console.warn(`Failed to remove listener for room ${t}`,o)}});const n=it.filter(i=>i.roomId!==t);it.length=0,it.push(...n)}function OR(t,e){if(!t||!e)return;const n=r=>r.userId===t&&r.roomId===e;it.filter(n).forEach(({ref:r,type:o,callback:a})=>{try{Ot(r,o,a)}catch(c){console.warn(`Failed to remove listener for user ${t} in room ${e}`,c)}});const s=it.filter(r=>!n(r));it.length=0,it.push(...s)}function ys(t,e,n=null){An(t,"value",e,n)}const En=t=>S(I,`rooms/${t}`),yr=t=>S(I,`rooms/${t}/members`),sf=(t,e)=>S(I,`rooms/${t}/members/${e}`),LR=t=>S(I,`rooms/${t}/cancellation`),ia=t=>S(I,`rooms/${t}/watch`),sa=t=>S(I,`rooms/${t}/watch/fileRequest`),DR=t=>S(I,`users/${t}/recentCalls`),hu=(t,e)=>S(I,`users/${t}/recentCalls/${e}`),fu=t=>S(I,`users/${t}/outgoingCall`),Wm=t=>S(I,`rooms/${t}/offerCandidates`),jm=t=>S(I,`rooms/${t}/answerCandidates`);function qm(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const MR=qm,zm=new mn("auth","Firebase",qm());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vc(){return typeof self<"u"&&self.location?.href||""}function UR(){return rf()==="http:"||rf()==="https:"}function rf(){return typeof self<"u"&&self.location?.protocol||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rr{constructor(e,n){this.shortDelay=e,this.longDelay=n,xt(n>e,"Short delay should be less than long delay!"),this.isMobile=Il()||eg()}get(){return $R()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function QR(t,e){const n=await Km(t,{},async()=>{const i=Wi({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=t.config,o=await Ym(t,s,"/v1/token",`key=${r}`),a=await t._getAdditionalHeaders();a["Content-Type"]="application/x-www-form-urlencoded";const c={method:"POST",headers:a,body:i};return t.emulatorConfig&&Vi(t.emulatorConfig.host)&&(c.credentials="include"),Gm.fetch()(o,c)});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function ZR(t,e){return Yi(t,"POST","/v2/accounts:revokeToken",_u(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const af=new Map;function St(t){xt(t instanceof Function,"Expected a class definition");let e=af.get(t);return e?(xt(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,af.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cf(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(t_(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Qm(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(i_(e))return"Blackberry";if(s_(e))return"Webos";if(Zm(e))return"Safari";if((e.includes("chrome/")||e_(e))&&!e.includes("edge/"))return"Chrome";if(n_(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(n);if(i?.length===2)return i[1]}return"Other"}function Qm(t=Ne()){return/firefox\//i.test(t)}function Zm(t=Ne()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function e_(t=Ne()){return/crios\//i.test(t)}function t_(t=Ne()){return/iemobile/i.test(t)}function n_(t=Ne()){return/android/i.test(t)}function i_(t=Ne()){return/blackberry/i.test(t)}function s_(t=Ne()){return/webos/i.test(t)}function wu(t=Ne()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function eN(t=Ne()){return wu(t)&&!!window.navigator?.standalone}function tN(){return uT()&&document.documentMode===10}function r_(t=Ne()){return wu(t)||n_(t)||s_(t)||i_(t)||/windows phone/i.test(t)||t_(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function o_(t,e=[]){let n;switch(t){case"Browser":n=cf(Ne());break;case"Worker":n=`${cf(Ne())}-${t}`;break;default:n=t}const i=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${ji}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dN(t,e){const n=_n(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),r=n.getOptions();if($n(r,e??{}))return s;yt(s,"already-initialized")}return n.initialize({options:e})}function hN(t,e){const n=e?.persistence||[],i=(Array.isArray(n)?n:[n]).map(St);e?.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(i,e?.popupRedirectResolver)}function fN(t,e,n){const i=Ji(t);T(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const s=!1,r=a_(e),{host:o,port:a}=pN(e),c=a===null?"":`:${a}`,l={url:`${r}//${o}${c}/`},u=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!i._canInitEmulator){T(i.config.emulator&&i.emulatorConfig,i,"emulator-config-failed"),T($n(l,i.config.emulator)&&$n(u,i.emulatorConfig),i,"emulator-config-failed");return}i.config.emulator=l,i.emulatorConfig=u,i.settings.appVerificationDisabledForTesting=!0,Vi(o)?(Qp(`${r}//${o}${c}`),Zp("Auth",!0)):gN()}function a_(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function pN(t){const e=a_(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const i=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(i);if(s){const r=s[1];return{host:r,port:uf(i.substr(r.length+1))}}else{const[r,o]=i.split(":");return{host:r,port:uf(o)}}}function uf(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function gN(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mi{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,n,i,s=!1){const r=await st._fromIdTokenResponse(e,i,s),o=df(i);return new Mi({user:r,providerId:o,_tokenResponse:i,operationType:n})}static async _forOperation(e,n,i){await e._updateTokensIfNecessary(i,!0);const s=df(i);return new Mi({user:e,providerId:s,_tokenResponse:i,operationType:n})}}function df(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function u_(t,e,n=!1){if(et(t.app))return Promise.reject(Mn(t));const i="signIn",s=await l_(t,i,e),r=await Mi._fromIdTokenResponse(t,i,s);return n||await t._updateCurrentUser(r.user),r}async function wN(t,e){return u_(Ji(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Va(t,e){return ne(t).setPersistence(e)}function vN(t,e,n,i){return ne(t).onIdTokenChanged(e,n,i)}function bN(t,e,n){return ne(t).beforeAuthStateChanged(e,n)}function d_(t,e,n,i){return ne(t).onAuthStateChanged(e,n,i)}function EN(t){return ne(t).signOut()}const uo="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function __(){return typeof _t().WorkerGlobalScope<"u"&&typeof _t().importScripts=="function"}async function AN(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function RN(){return navigator?.serviceWorker?.controller||null}function NN(){return __()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class C_{constructor(e,n,i,s,r=!1){this.auth=e,this.resolver=i,this.user=s,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:i,postBody:s,tenantId:r,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:i,tenantId:r||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return xN;case"linkViaPopup":case"linkViaRedirect":return UN;case"reauthViaPopup":case"reauthViaRedirect":return FN;default:yt(this.auth,"internal-error")}}resolve(e){xt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){xt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HN="pendingRedirect",Or=new Map;class VN extends C_{constructor(e,n,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,i),this.eventId=null}async execute(){let e=Or.get(this.auth._key());if(!e){try{const i=await WN(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(n){e=()=>Promise.reject(n)}Or.set(this.auth._key(),e)}return this.bypassAuthState||Or.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function WN(t,e){const n=zN(e),i=qN(t);if(!await i._isAvailable())return!1;const s=await i._get(n)==="true";return await i._remove(n),s}function jN(t,e){Or.set(t._key(),e)}function qN(t){return St(t._redirectPersistence)}function zN(t){return Pr(HN,t.config.apiKey,t.name)}async function GN(t,e){return await Ji(t)._initializationPromise,T_(t,e,!1)}async function T_(t,e,n=!1){if(et(t.app))return Promise.reject(Mn(t));const i=Ji(t),s=E_(i,e),o=await new VN(i,s,n).execute();return o&&!n&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KN=600*1e3;class YN{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let n=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(n=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!JN(e)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=e,n=!0)),n}sendToConsumer(e,n){if(e.error&&!S_(e)){const i=e.error.code?.split("auth/")[1]||"internal-error";n.onError(at(this.auth,i))}else n.onAuthEvent(e)}isEventForConsumer(e,n){const i=n.eventId===null||!!e.eventId&&e.eventId===n.eventId;return n.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=KN&&this.cachedEventUids.clear(),this.cachedEventUids.has(pf(e))}saveEventToCache(e){this.cachedEventUids.add(pf(e)),this.lastProcessedEventTime=Date.now()}}function pf(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter(e=>e).join("-")}function S_({type:t,error:e}){return t==="unknown"&&e?.code==="auth/no-auth-event"}function JN(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return S_(t);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nP=new rr(3e4,6e4);function gf(){const t=_t().___jsl;if(t?.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function iP(t){return new Promise((e,n)=>{function i(){gf(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{gf(),n(at(t,"network-request-failed"))},timeout:nP.get()})}if(_t().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(_t().gapi?.load)i();else{const s=uN("iframefcb");return _t()[s]=()=>{gapi.load?i():n(at(t,"network-request-failed"))},cN(`${lN()}?onload=${s}`).catch(r=>n(r))}}).catch(e=>{throw Lr=null,e})}let Lr=null;function sP(t){return Lr=Lr||iP(t),Lr}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hP={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},fP=500,pP=600,gP="_blank",mP="http://localhost";class mf{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function _P(t,e,n,i=fP,s=pP){const r=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const c={...hP,width:i.toString(),height:s.toString(),top:r,left:o},l=Ne().toLowerCase();n&&(a=e_(l)?gP:n),Qm(l)&&(e=e||mP,c.scrollbars="yes");const u=Object.entries(c).reduce((h,[f,p])=>`${h}${f}=${p},`,"");if(eN(l)&&a!=="_self")return yP(e||"",a),new mf(null);const d=window.open(e||"",a,u);T(d,t,"popup-blocked");try{d.focus()}catch{}return new mf(d)}function yP(t,e){const n=document.createElement("a");n.href=t,n.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function IP(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function kP(t){Je(new He("auth",(e,{options:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=i.options;T(o&&!o.includes(":"),"invalid-api-key",{appName:i.name});const c={apiKey:o,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:o_(t)},l=new oN(i,s,r,c);return hN(l,n),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,i)=>{e.getProvider("auth-internal").initialize()})),Je(new He("auth-internal",e=>{const n=Ji(e.getProvider("auth").getImmediate());return(i=>new SP(i))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Be(yf,wf,IP(t)),Be(yf,wf,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AP=300,RP=Xp("authIdTokenMaxAge")||AP;let vf=null;const NP=t=>async e=>{const n=e&&await e.getIdTokenResult(),i=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(i&&i>RP)return;const s=n?.token;vf!==s&&(vf=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function PP(t=Uo()){const e=_n(t,"auth");if(e.isInitialized())return e.getImmediate();const n=dN(t,{popupRedirectResolver:TP,persistence:[b_,p_,m_]}),i=Xp("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const r=new URL(i,location.origin);if(location.origin===r.origin){const o=NP(r.toString());bN(n,o,()=>o(n.currentUser)),vN(n,a=>o(a))}}const s=Yp("auth");return s&&fN(n,`http://${s}`),n}function OP(){return document.getElementsByTagName("head")?.[0]??document}aN({loadJS(t){return new Promise((e,n)=>{const i=document.createElement("script");i.setAttribute("src",t),i.onload=e,i.onerror=s=>{const r=at("internal-error");r.customData=s,n(r)},i.type="text/javascript",i.charset="UTF-8",OP().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});kP("Browser");const qD=()=>!1,LP=t=>{try{t&&localStorage.setItem("debug:console","1")}catch{}},$=(...t)=>{},DP=(...t)=>{localStorage.getItem("debug:console")},MP="765724787439-21p8n3e2tsfq2qk4oriq7ipp7m4o50ad.apps.googleusercontent.com",vs=new Set;function xP(){const t=console.error;console.error=(...e)=>{const n=e.join(" ");n.includes("FedCM")&&n.includes("AbortError")&&n.includes("signal is aborted without reason")||e.length===1&&typeof e[0]=="string"&&e[0].trim()==="The request has been aborted."||t.apply(console,e)}}function FP(t){return $("[ONE TAP] Callback registered, total callbacks:",vs.size+1),vs.add(t),()=>vs.delete(t)}function oi(t){$("[ONE TAP] Notifying status:",t,"to",vs.size,"callbacks"),vs.forEach(e=>{try{e(t)}catch{}})}function I_(){if(typeof google>"u"||!google.accounts?.id){setTimeout(()=>I_(),100);return}xP(),google.accounts.id.initialize({client_id:MP,callback:UP,auto_select:!1,cancel_on_tap_outside:!1,context:"signin",use_fedcm_for_prompt:!0,itp_support:!0})}function k_(){if(Tu()){oi("not_needed");return}window.google?.accounts?.id&&(oi("prompting"),window.google.accounts.id.prompt(t=>{const e=t.getMomentType();e==="skipped"?oi("skipped"):e==="dismissed"?oi("dismissed"):e==="display"&&oi("displayed")}))}async function UP(t){try{$("[ONE TAP] Received credential, signing in with Firebase..."),oi("signing_in");const e=gt.credential(t.credential),n=await wN($e,e);$("[ONE TAP] ✅ Successfully signed in:",n.user.email),Hs(!1)}catch(e){const n=e?.code||"unknown",i=e?.message||String(e);alert(n==="auth/account-exists-with-different-credential"?"An account already exists with the same email but different sign-in credentials.":`One Tap sign-in failed: ${i}`)}}let zc=!1;async function $P(){const t=H();if(!t||zc)return;const e=S(I,`users/${t}/presence`);try{await te(e,{state:"online",lastChanged:Dn()}),await Tm(e).set({state:"offline",lastSeen:Dn(),lastChanged:Dn()}),zc=!0,console.log("Presence initialized for user:",t)}catch(n){console.error("Failed to initialize presence:",n)}}async function BP(){const t=H();if(!t)return;const e=S(I,`users/${t}/presence`);try{await te(e,{state:"offline",lastSeen:Dn(),lastChanged:Dn()}),zc=!1}catch(n){console.error("Failed to set offline:",n)}}function A_(t){if(!t||typeof t!="string")throw new Error("Invalid email: must be a non-empty string");const e=t.toLowerCase().trim();return btoa(unescape(encodeURIComponent(e))).replace(/\//g,"-")}async function HP(t){if(!t||!t.uid||!t.email)throw new Error("Invalid user: must have uid and email");const e=A_(t.email),n=S(I,`usersByEmail/${e}`),i={uid:t.uid,displayName:t.displayName||"Anonymous",photoURL:t.photoURL||null,registeredAt:Date.now()};try{await te(n,i),console.log("[USER DISCOVERY] Registered user in directory:",t.email)}catch(s){throw console.error("[USER DISCOVERY] Failed to register user:",s),s}}async function R_(t){if(!t||typeof t!="string")return null;try{const e=A_(t),n=S(I,`usersByEmail/${e}`),i=await Ge(n);return i.exists()?i.val():null}catch(e){return console.error("[USER DISCOVERY] Failed to find user by email:",e),null}}async function VP(t){if(!Array.isArray(t))throw new Error("Invalid emails: must be an array");const e={},n=t.map(async i=>{const s=await R_(i);e[i]=s});return await Promise.all(n),e}const $e=PP(ta),WP=typeof import.meta<"u"&&!0;function N_(t,e,n={}){const i=typeof window<"u"?window.location.origin:"n/a";WP?console.error(`[AUTH] ${t}:`,{code:e?.code||"unknown",message:e?.message||String(e),origin:i,...n}):console.error(`[AUTH] ${t}:`,e,n,{origin:i})}const P_=(async()=>{try{await Va($e,b_)}catch{try{await Va($e,p_)}catch{await Va($e,jc)}}try{(await GN($e))?.user&&$("[AUTH] ✅ Sign-in completed (via Safari fallback)")}catch(t){$("[AUTH] No redirect result:",t.code)}setTimeout(()=>{I_(),k_()},500)})();let O_=!1;function Hs(t){O_=t}function jP(){try{const t=document.createElement("a");t.href=window.location.href,t.target="_blank",t.rel="noopener noreferrer external",document.body.appendChild(t),t.click(),document.body.removeChild(t)}catch{}}function L_(){const t=typeof window<"u"&&window.matchMedia?.("(display-mode: standalone)").matches,e=typeof navigator<"u"&&navigator.standalone===!0,n=t||e,i=/iphone|ipad|ipod/i.test(navigator.userAgent||"");return{isStandalonePWA:n,isIOS:i,isIOSStandalone:n&&i}}function qP(t){const e=t?.code||"unknown",n=t?.message||String(t);if(e==="auth/popup-closed-by-user"||e==="auth/cancelled-popup-request"){console.log("Sign-in cancelled by user");return}const{isIOSStandalone:i}=L_();if((e==="auth/network-request-failed"||e==="auth/popup-blocked")&&i){console.warn(`[AUTH] ${e} inside iOS standalone PWA. Arming Safari fallback.`),Hs(!0),alert(`Sign-in is blocked in the installed app on iOS.
...
- diagnosticLogger.getLogsSince(Date.now() - 60000) // Last minute
  ...
  `;const l=document.createElement("button");l.textContent="Cancel",l.style.cssText=`
    ...
    font-size: 16px;
    font-weight: 500;
  `;const u=async()=>{i.logCallingUILifecycle("CANCEL",t,{contactName:e,reason:"user_cancelled",duration:Date.now()-s});try{await Promise.all([go(),ee.cancelCall(t,ge(),"caller_cancelled"),ee.leaveRoom(ge(),t)])}catch(d){i.log("ROOM","CALLER_CANCELLED_CLEANUP_FAIL",{roomId:t,error:String(d)})}gi.stop(),xn()};l.onclick=u,o.appendChild(a),o.appendChild(c),o.appendChild(l),r.appendChild(o),document.body.appendChild(r),r.dataset.roomId=t,Et=r,gi.playOutgoing(),ds=setTimeout(async()=>{i.logCallingUILifecycle("TIMEOUT",t,{contactName:e,reason:"auto_timeout",duration:Date.now()-s,timeoutMs:po});try{await Promise.all([go(),ee.cancelCall(t,ge(),"auto_timeout"),ee.leaveRoom(ge(),t)])}catch(d){i.log("ROOM","CALLER_TIMEOUT_CLEANUP_FAIL",{roomId:t,error:String(d)})}gi.stop(),xn()},po)}function xn(){if(gi.stop(),Ft.view==="calling"&&Ft.setView("lobby"),Et){const t=Et.dataset?.roomId||"unknown";y().logCallingUILifecycle("HIDE",t,{reason:"hide_called",hadTimeout:!!ds,timestamp:Date.now()})}ds&&(clearTimeout(ds),ds=null),Et&&(Et.remove(),Et=null)}async function Au(){if(Et){const t=Et.dataset?.roomId||"unknown";y().logCallingUILifecycle("ANSWERED",t,{reason:"call_answered",timestamp:Date.now()})}await go(),xn()}async function o0(t="user_rejected"){const e=y(),n=Et?.dataset?.roomId||"unknown";e.logCallingUILifecycle("REJECTED",n,{reason:t,timestamp:Date.now()}),await go(),xn()}const a0=Object.freeze(Object.defineProperty({__proto__:null,hideCallingUI:xn,isOutgoingCallFresh:U_,isRoomCallFresh:$_,onCallAnswered:Au,onCallRejected:o0,showCallingUI:B_},Symbol.toStringTag,{value:"Module"})),q=t=>{const e=document.getElementById(t);return e||(console.warn(`Element with id: ${t} not found.`),null)};let Qe=null,yn=null,ca=null,Ru=null,je=null,me=null,se=null,re=null,x=null,Ae=null,Ke=null,Me=null,ct=null,Xi=null,H_=null,lt=null,la=null,fn=null,Qi=null,Zi=null,Gn=null,Nu=null,Pu=null,Ou=null,Lu=null,_i=null,Ws=null,Du=null;function Tf(){Qe=q("lobby"),yn=q("lobby-call-btn"),ca=q("title-auth-bar"),Ru=q("videos"),je=q("local-video-el"),me=q("local-video-box"),se=q("remote-video-el"),re=q("remote-video-box"),x=q("shared-video-el"),Ae=q("shared-video-box"),Ke=q("chat-controls"),Me=q("call-btn"),ct=q("hang-up-btn"),Xi=q("switch-camera-btn"),lt=q("mute-btn"),la=q("fullscreen-partner-btn"),fn=q("remote-pip-btn"),Qi=q("mic-btn"),Zi=q("camera-btn"),Gn=q("exit-watch-mode-btn"),Nu=q("app-pip-btn"),Pu=q("app-title-h1"),Ou=q("app-title-a"),Lu=q("app-title-span"),_i=q("paste-join-btn"),Ws=q("add-contact-btn"),Du=q("test-notifications-btn")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Tf):Tf();const V_=()=>({lobbyDiv:Qe,lobbyCallBtn:yn,titleAuthBar:ca,videosWrapper:Ru,localVideoEl:je,localBoxEl:me,remoteVideoEl:se,remoteBoxEl:re,sharedVideoEl:x,sharedBoxEl:Ae,chatControls:Ke,callBtn:Me,hangUpBtn:ct,switchCameraBtn:Xi,installBtn:H_,mutePartnerBtn:lt,fullscreenPartnerBtn:la,remotePipBtn:fn,micBtn:Qi,cameraBtn:Zi,exitWatchModeBtn:Gn,appPipBtn:Nu,appTitleH1:Pu,appTitleA:Ou,appTitleSpan:Lu,pasteJoinBtn:_i,addContactBtn:Ws,testNotificationsBtn:Du});function W_(t,e=3,n=100){return new Promise(i=>{let s=0;const r=()=>{const o=document.getElementById(t);if(o){i(o);return}if(s++,s>=e){console.warn(`Element ${t} not found after ${e} attempts`),i(null);return}setTimeout(r,n)};r()})}async function j_(t,e=3,n=100){const i={},s=t.map(async r=>{const o=await W_(r,e,n);return i[r]=o,o});return await Promise.all(s),i}async function c0(){const t=await j_(["searchBtn","searchQuery","searchResults"],5,200),e=document.querySelector(".search-section");t.searchContainer=e;const n=Object.entries(t).filter(([i,s])=>!s).map(([i])=>i);return n.length>0&&console.warn("Some YouTube elements not found:",n),t}const l0=Object.freeze(Object.defineProperty({__proto__:null,get addContactBtn(){return Ws},get appPipBtn(){return Nu},get appTitleA(){return Ou},get appTitleH1(){return Pu},get appTitleSpan(){return Lu},get callBtn(){return Me},get cameraBtn(){return Zi},get chatControls(){return Ke},get exitWatchModeBtn(){return Gn},get fullscreenPartnerBtn(){return la},getElements:V_,get hangUpBtn(){return ct},initializeYouTubeElements:c0,installBtn:H_,get lobbyCallBtn(){return yn},get lobbyDiv(){return Qe},get localBoxEl(){return me},get localVideoEl(){return je},get micBtn(){return Qi},get mutePartnerBtn(){return lt},get pasteJoinBtn(){return _i},get remoteBoxEl(){return re},get remotePipBtn(){return fn},get remoteVideoEl(){return se},robustElementAccess:W_,get sharedBoxEl(){return Ae},get sharedVideoEl(){return x},get switchCameraBtn(){return Xi},get testNotificationsBtn(){return Du},get titleAuthBar(){return ca},get videosWrapper(){return Ru},waitForElements:j_},Symbol.toStringTag,{value:"Module"})),Mu=t=>t?!0:(console.warn("Element not found. el.id: =>",t?.id??"(no id)","el: =>",t),console.trace(),!1),mo=t=>{if(Mu(t))return t.classList.contains("hidden")},M=t=>{Mu(t)&&t.classList.contains("hidden")&&t.classList.remove("hidden")},w=t=>{Mu(t)&&!t.classList.contains("hidden")&&t.classList.add("hidden")},q_=t=>t.classList.contains("small-frame"),js=t=>{if(t&&!q_(t)){t.classList.add("small-frame");const e=document.createElement("div");e.classList.add("small-frame-toggle-div");const n=document.createElement("span");n.classList.add("small-frame-toggle-icon"),n.textContent="❮",e.appendChild(n),t.appendChild(e),e.addEventListener("click",()=>{t.classList.contains("closed")?(t.classList.remove("closed"),e.classList.remove("closed"),n.classList.remove("closed")):(t.classList.add("closed"),e.classList.add("closed"),n.classList.add("closed"))})}},rn=t=>{if(q_(t)){t.classList.remove("small-frame"),t.classList.remove("closed");const e=t.querySelector(".small-frame-toggle-div");e&&e.remove()}};function xu(t){return document.pictureInPictureElement===t}function u0(t,{inactivityMs:e=3e3,listenTarget:n=document,onShow:i=null,onHide:s=null,hideOnEsc:r=!1,excludeEvents:o=["keydown"]}={}){if(!t)return()=>{};let a=null;const l=["pointermove","pointerdown","pointerup","touchstart","touchmove","mousemove","mousedown","keydown"].filter(m=>!Array.isArray(o)||!o.includes(m));function u(){M(t);try{typeof i=="function"&&i()}catch(m){console.warn("showHideOnInactivity onShow callback error:",m)}a&&clearTimeout(a),a=setTimeout(()=>{w(t);try{typeof s=="function"&&s()}catch(m){console.warn("showHideOnInactivity onHide callback error:",m)}a=null},e)}l.forEach(m=>n.addEventListener(m,u,{passive:!0}));function d(){if(document.hidden){a&&(clearTimeout(a),a=null);try{w(t)}catch(m){console.warn("showHideOnInactivity onHide (visibilitychange) callback error:",m)}}else u()}document.addEventListener("visibilitychange",d);function h(m){if(!m.relatedTarget){a&&(clearTimeout(a),a=null),w(t);try{typeof s=="function"&&s()}catch(R){console.warn("showHideOnInactivity onHide (visibilitychange) callback error:",R)}}}n.addEventListener("mouseout",h);function f(m){if(r&&(m.key==="Escape"||m.key==="Esc")){a&&(clearTimeout(a),a=null),w(t);try{typeof s=="function"&&s()}catch(R){console.warn("showHideOnInactivity onHide (esc) callback error:",R)}}}document.addEventListener("keydown",f);function p(){a||u()}n.addEventListener("touchend",p,{passive:!0}),w(t);function _(){l.forEach(m=>n.removeEventListener(m,u)),document.removeEventListener("visibilitychange",d),n.removeEventListener("mouseout",h),n.removeEventListener("touchend",p),document.removeEventListener("keydown",f),a&&(clearTimeout(a),a=null)}return _}let It=null,kt=null,z_="user";function Kc(){return z_}function G_(t){z_=t}function ua(){return It instanceof MediaStream}function Fu(){return!It||!(It instanceof MediaStream)?(console.error("Invalid remote MediaStream accessed:",It),null):It}function K_(t){It=t}function Y_(){It&&(It.getTracks().forEach(t=>t.stop()),It=null)}function J_(){return kt instanceof MediaStream}function da(){return!kt||!(kt instanceof MediaStream)?(console.error("Invalid local MediaStream accessed:",kt),console.error("Call createLocalStream() before accessing local stream."),null):kt}function _o(t){kt=t}function X_(){kt&&(kt.getTracks().forEach(t=>t.stop()),kt=null)}const d0=Object.freeze(Object.defineProperty({__proto__:null,cleanupLocalStream:X_,cleanupRemoteStream:Y_,getFacingMode:Kc,getLocalStream:da,getRemoteStream:Fu,hasLocalStream:J_,hasRemoteStream:ua,setFacingMode:G_,setLocalStream:_o,setRemoteStream:K_},Symbol.toStringTag,{value:"Module"})),Sf="yt-video-box",Yc="yt-player-root";let J=null,Bt=!1;const bs=()=>J,h0=()=>Bt,Q_=t=>Bt=t,yi=()=>{const t=document.getElementById(Sf);if(!t)throw new Error(`Container #${Sf} not found`);return t};function f0(){return new Promise(t=>{window.YT&&window.YT.Player?t():window.onYouTubeIframeAPIReady=()=>{t()}})}function Z_(){const t=yi();if(!document.getElementById(Yc)){const e=document.createElement("div");e.id=Yc,t.appendChild(e)}M(t)}function yo(){const t=yi();w(t)}function qa(){const t=yi();return t&&!t.classList.contains("hidden")}function Jc(t){return t?t.includes("youtube.com")||t.includes("youtu.be"):!1}function ey(t){if(!t)return null;const e=[/(?:youtube\.com\/watch\?v=)([\w-]+)/,/(?:youtu\.be\/)([\w-]+)/,/(?:youtube\.com\/embed\/)([\w-]+)/,/(?:youtube\.com\/shorts\/)([\w-]+)/];for(const n of e){const i=t.match(n);if(i&&i[1])return i[1]}return null}async function p0({url:t,onReady:e,onStateChange:n}){const i=ey(t);if(!i)throw new Error("Invalid YouTube URL");if(await f0(),J){try{J.destroy()}catch(o){console.warn("Error destroying previous YouTube player:",o)}J=null}const s=(o=!0)=>{const a=yi(),c=J.getIframe();if(c&&a){try{a.tabIndex=-1,a.focus({preventScroll:!0})}catch{if(document.activeElement===c)try{c.blur()}catch{}}if(o){const l=u=>{if(u.code==="Space"){const d=yi(),h=J.getIframe();if(document.activeElement===h||document.activeElement===d)return;u.preventDefault(),console.debug("Space pressed, refocusing iframe"),J.getPlayerState()!==window.YT.PlayerState.PLAYING?$u():cr()}};document.addEventListener("keydown",l,{once:!0})}}},r=()=>{const o=yi(),a=J.getIframe();if(o&&a&&document.activeElement!==a)try{a.focus()}catch{}};return Z_(),new Promise((o,a)=>{try{J=new window.YT.Player(Yc,{videoId:i,playerVars:{autoplay:1,mute:0,controls:1,fs:1,rel:0,modestbranding:1,disablekb:0,origin:window.location.origin},events:{onReady:c=>{Bt=!0,e&&e(c),o(J)},onStateChange:c=>{c.data===window.YT.PlayerState.ENDED&&s(!1),c.data===window.YT.PlayerState.PAUSED&&s(),c.data===window.YT.PlayerState.PLAYING&&r(),n&&n(c)},onError:c=>{console.error("YouTube player error:",c.data),a(new Error(`YouTube error: ${c.data}`))}}})}catch(c){a(c)}})}function Uu(){if(J){try{yo(),J.destroy()}catch(t){console.warn("Error destroying YouTube player:",t)}J=null,Bt=!1}}function $u(){J&&Bt&&J.playVideo()}function cr(){J&&Bt&&J.pauseVideo()}function g0(t){J&&Bt&&J.seekTo(t,!0)}function wo(){return J&&Bt?J.getCurrentTime():0}function Bu(){return J&&Bt?J.getPlayerState():-1}const Qt={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},ty=()=>{if(!ua())return!1;const t=Fu();return t&&t.getVideoTracks().length>0&&t.getVideoTracks()[0].enabled&&t.getVideoTracks()[0].readyState==="live"};function m0(){return"pictureInPictureEnabled"in document&&typeof document.pictureInPictureEnabled=="boolean"&&document.pictureInPictureEnabled}function _0(){Kn()||(iy(!0),w(Qe),w(yn),Ke.classList.remove("bottom"),Ke.classList.add("watch-mode"),Qc()?(w(Me),M(ct)):(w(ct),w(Qi),w(lt),M(Me)),w(Zi),w(Xi),M(Gn),M(Ke),Qc()&&(w(me),rn(me),w(re),xu(se)?rn(re):m0()?se.requestPictureInPicture().then(()=>{rn(re)}).catch(t=>{console.warn("Failed to enter Picture-in-Picture:",t),js(re),M(re)}):(js(re),M(re))))}function y0(){Kn()&&(w(Gn),M(Me),M(ct),M(Qi),M(lt),M(Zi),M(Xi),Ke.classList.remove("watch-mode"),Ke.classList.add("bottom"),M(Ke),ty()&&(xu(se)&&document.exitPictureInPicture().catch(t=>{console.error("Failed to exit Picture-in-Picture:",t)}),rn(re),M(re)),Qc()?(js(me),M(me)):(M(Qe),M(yn),rn(me),w(me)),iy(!1))}function vo(){Ft.setMainContent("ytVideo"),_0()}function Es(){Ft.setMainContent("remoteStream"),y0()}let we=null,Ut=null,ny=!1,ut="none",Cs=null,Ye=null;const Kn=()=>ny,iy=t=>ny=t,ft=()=>ut,w0=t=>{["yt","url","file","none"].includes(t)?ut=t:console.warn("Invalid lastWatched platform:",t)};let Zt=!1,Ts=null,wi=0,za=!1;async function vi(t){if(!we)return;console.debug("Updating watch sync state, roomId:",we);const e=ia(we);try{await Ln(e,{...t,updatedBy:Ut})}catch(n){console.error("Failed to update watch state:",n)}}function v0(t,e,n){if(!t)return;we=t,Ut=n;const i=ia(t),s=sa(t);ys(i,T0,t),ys(s,C0,t),P0()}function Hu(t){return typeof t=="string"&&t.startsWith("blob:")}async function b0(t,e){if(!we||!Ut)return!1;const n=sa(we);try{return await te(n,{fileName:t,requestedBy:Ut,timestamp:Date.now()}),Ye&&clearTimeout(Ye),Ye=setTimeout(()=>{Xc()},300*1e3),!0}catch(i){return console.error("Failed to create watch request:",i),!1}}async function E0(t){if(!we)return!1;const e=sa(we);try{await Ve(e)}catch(n){console.warn("Failed to remove watch request:",n)}return Ye&&(clearTimeout(Ye),Ye=null),await qs(t)}async function Xc(){if(!we)return;Ye&&(clearTimeout(Ye),Ye=null);const t=sa(we);try{await Ve(t)}catch(e){console.warn("Failed to cancel watch request:",e)}}function C0(t){const e=t.val();if(!e){Ye&&(clearTimeout(Ye),Ye=null);return}e.requestedBy!==Ut&&window.onFileWatchRequestReceived&&window.onFileWatchRequestReceived(e.fileName)}function T0(t){const e=t.val();e&&e.updatedBy!==Ut&&(Date.now()-wi<500||(e.url&&e.url!==Cs&&!Hu(e.url)&&S0(e.url),e.isYouTube?I0(e):N0(e)))}function S0(t){Cs=t,Jc(t)?(w(Ae),sy(t),ut="yt"):(Uu(),M(Ae),x.src=t,ut="url"),vo()}function I0(t){!bs()||!h0()||(k0(t),A0(t))}function k0(t){const e=Bu(),n=e===Qt.PLAYING;if([Qt.BUFFERING,Qt.UNSTARTED].includes(e)){R0();return}Zt||(t.playing&&!n?($u(),ut="yt"):!t.playing&&n&&(cr(),ut="yt"))}function A0(t){if(t.currentTime===void 0)return;const e=wo();Math.abs(e-t.currentTime)>.3&&!Zt&&(g0(t.currentTime),setTimeout(()=>{t.playing?$u():cr(),ut="yt"},500))}function R0(){Zt=!0,clearTimeout(Ts),Ts=setTimeout(async()=>{Zt=!1;const t=Bu()===Qt.PLAYING;await vi({playing:t,currentTime:wo()})},700)}function N0(t){wi=Date.now(),t.playing!==void 0&&(t.playing&&x.paused?x.play().catch(e=>console.warn("Play failed:",e)):!t.playing&&!x.paused&&x.pause()),t.currentTime!==void 0&&Math.abs(x.currentTime-t.currentTime)>1&&(x.currentTime=t.currentTime,t.playing?x.play().catch(n=>console.warn("Play failed:",n)):x.pause())}function P0(){const t=()=>{ut!=="file"&&(ut="url")};x.addEventListener("play",async()=>{!bs()&&we&&(wi=Date.now(),await vi({playing:!0,currentTime:x.currentTime,isYouTube:!1})),t()}),x.addEventListener("pause",async()=>{x.seeking||(!bs()&&we&&(wi=Date.now(),console.log("[SYNC DEBUG] Local pause event:",{currentTime:x.currentTime}),await vi({playing:!1,currentTime:x.currentTime,isYouTube:!1})),t())}),x.addEventListener("playing",()=>{za=!0}),x.addEventListener("pause",()=>{x.seeking||(za=!1)},!0),x.addEventListener("seeked",async()=>{!bs()&&we&&(wi=Date.now(),await vi({currentTime:x.currentTime,playing:za,isYouTube:!1})),t()})}async function O0(t){if(!t)return!1;wi=Date.now();const e=Hu(t);if(Jc(t)){if(w(Ae),!await sy(t))return!1;ut="yt"}else Uu(),M(Ae),x.src=t,ut=e?"file":"url";if(we){const n=ia(we);e?await te(n,{playing:!1,currentTime:0,isYouTube:!1,updatedBy:Ut}):te(n,{url:t,playing:!1,currentTime:0,isYouTube:Jc(t),updatedBy:Ut})}return vo(),!0}async function qs(t){let e;if(t instanceof File){if(!t.type.startsWith("video/"))return console.warn("Invalid file type:",t.type),!1;e=URL.createObjectURL(t)}else if(typeof t=="string")e=t;else if(t?.url)e=t.url;else return console.warn("Invalid video source:",t),!1;Cs=e;const n=await O0(e);return n||Hu(Cs)&&t instanceof File&&(URL.revokeObjectURL(e),Cs=null),n}async function sy(t){if(!ey(t))return console.error("Invalid YouTube URL:",t),!1;try{return await p0({url:t,onReady:n=>{if(Q_(!0),we){const i=ia(we);te(i,{url:t,playing:!1,currentTime:0,isYouTube:!0,updatedBy:Ut})}},onStateChange:async n=>{if(!bs())return;const s=n.data===Qt.PLAYING,r=n.data===Qt.PAUSED;if(n.data===Qt.BUFFERING){Zt=!0,Ts&&clearTimeout(Ts),Ts=setTimeout(async()=>{Zt=!1;const c=Bu()===Qt.PLAYING;await vi({playing:c,currentTime:wo()})},700);return}r&&Zt||!Zt&&(s||r)&&await vi({playing:s,currentTime:wo()})}}),!0}catch(n){return console.error("Failed to load YouTube video:",n),!1}}let bi=!1,vr=!1,If=null,kf=null,Ss=null;const Qc=()=>bi,ry=()=>{if(!bi){if(!se||!ua()||se.paused||se.readyState<2){vr||(vr=!0,se.addEventListener("playing",()=>{vr=!1,ry()},{once:!0}));return}if(vr=!1,bi=!0,M(re),M(me),js(me),w(Qe),w(yn),Me.disabled=!0,Me.classList.add("disabled"),ct.disabled=!1,ct.classList.remove("disabled"),lt.disabled=!1,lt.classList.remove("disabled"),fn.disabled=!1,fn.classList.remove("disabled"),Ss||(Ss=u0(Ke,{inactivityMs:2500,hideOnEsc:!0})),!If){const t=()=>{bi&&(Kn()?js(re):rn(re),M(re))};se.addEventListener("leavepictureinpicture",t),If=()=>se.removeEventListener("leavepictureinpicture",t)}if(!kf){const t=()=>w(re);se.addEventListener("enterpictureinpicture",t),kf=()=>se.removeEventListener("enterpictureinpicture",t)}}},L0=()=>{bi&&(bi=!1,xu(se)&&document.exitPictureInPicture().catch(()=>{}),rn(me),w(me),rn(re),w(re),Me.disabled=!1,Me.classList.remove("disabled"),ct.disabled=!0,ct.classList.add("disabled"),lt.disabled=!0,lt.classList.add("disabled"),fn.disabled=!0,fn.classList.add("disabled"),Ss&&(Ss(),Ss=null),Kn()||(M(yn),M(Qe),M(Ke)))};function oy(){Ft.setView("connected"),ry()}function ay(){Ft.setView("lobby"),L0()}let ht=null,Af=null;function cy(t){Af=t,t.onconnectionstatechange=()=>{$("onconnectionstatechange:",t.connectionState),t.connectionState==="connected"?(oy(),Au().catch(e=>console.warn("Failed to clear calling state on connect:",e)),ht&&(clearTimeout(ht),ht=null)):t.connectionState==="disconnected"?(ht&&clearTimeout(ht),ht=setTimeout(()=>{t===Af&&t.connectionState==="disconnected"&&_e.cleanupCall({reason:"connection_lost"}),ht=null},3e3)):t.connectionState==="failed"&&(aa(),ht&&(clearTimeout(ht),ht=null),_e.cleanupCall({reason:"connection_failed"}))},t.addEventListener("iceconnectionstatechange",e=>{$("ICE iceconnectionstatechange:",t.iceConnectionState),t.iceConnectionState==="failed"&&(console.warn("ICE connection failed, restarting ICE..."),t.restartIce())})}const Vu={iceServers:[{urls:"stun:stun.l.google.com:19302"}]},Ga=new WeakMap;function ly(t,e,n){Ga.has(t)||Ga.set(t,{});const i=Ga.get(t),s=e==="offer"?"lastOffer":"lastAnswer";return i[s]===n?!0:(i[s]=n,!1)}function uy(t,e){return t?e==="offer"?t.signalingState==="stable":t.signalingState==="have-local-offer"||t.signalingState==="stable":!1}function Wu(t,e){e.getTracks().forEach(n=>{t.addTrack(n,e)})}async function dy(t){const e=await t.createOffer();return await t.setLocalDescription(e),e}async function hy(t){const e=await t.createAnswer();return await t.setLocalDescription(e),e}async function fy(t,e,n){if(ly(t,e.type,e.sdp))return console.debug(`Ignoring duplicate ${e.type} - already processed`),!1;if(!uy(t,e.type))return console.warn(`Ignoring ${e.type} - unexpected signaling state:`,t.signalingState),!1;try{return await t.setRemoteDescription(new RTCSessionDescription(e)),n(t),console.debug(`Remote description set (${e.type})`),!0}catch(i){return console.error(`Failed to set remote description (${e.type}):`,i),!1}}function py(){return Math.random().toString(36).substring(2,9)}const D0=Object.freeze(Object.defineProperty({__proto__:null,addLocalTracks:Wu,createAnswer:hy,createOffer:dy,generateRoomId:py,isDuplicateSdp:ly,isValidSignalingState:uy,rtcConfig:Vu,setRemoteDescription:fy},Symbol.toStringTag,{value:"Module"}));async function M0({localStream:t,remoteVideoEl:e,mutePartnerBtn:n,setupRemoteStream:i,setupWatchSync:s,targetRoomId:r=null}){if(!t)return{success:!1};const o=new RTCPeerConnection(Vu),a="initiator",c=r||py(),l=ge();Wu(o,t);const u=o.createDataChannel("files");if(!i(o,e,n))return console.error("Error setting up remote stream"),o.close(),{success:!1};Iu(o,a,c),cy(o);const h=await dy(o);await ee.createNewRoom(h,l,c),s(c,a,l);const f=`${window.location.origin}${window.location.pathname}?room=${c}`;return{success:!0,pc:o,roomId:c,roomLink:f,dataChannel:u,role:a}}async function x0({roomId:t,localStream:e,remoteVideoEl:n,mutePartnerBtn:i,setupRemoteStream:s,setupWatchSync:r,onMessagesUIReady:o=null}){if(!e)return{success:!1};if(!t)return{success:!1};const a=await ee.checkRoomStatus(t);if(!a.exists)return{success:!1};if(!a.hasMembers)return{success:!1};let c;try{c=await ee.getRoomData(t)}catch(m){return $("Error: "+m.message),{success:!1}}const l=c.offer;if(!l)return{success:!1};const u=new RTCPeerConnection(Vu),d="joiner",h=ge();Wu(u,e);let f=null;if(u.ondatachannel=m=>{f=m.channel,$("[Call Flow] DataChannel received by joiner",{label:f.label})},!s(u,n,i))return console.error("Error setting up remote stream for joiner"),u.close(),{success:!1};Iu(u,d,t),cy(u),await fy(u,l,ku);const _=await hy(u);try{await ee.saveAnswer(t,_)}catch(m){return console.error("Failed to save answer to Firebase:",m),u.close(),{success:!1}}return r(t,d,h),await ee.joinRoom(t,h),{success:!0,pc:u,roomId:t,dataChannel:f,role:d}}class F0{async sendFile(e,n){throw new Error("FileTransport.sendFile() must be implemented by subclass")}onFileReceived(e){throw new Error("FileTransport.onFileReceived() must be implemented by subclass")}onReceiveProgress(e){throw new Error("FileTransport.onReceiveProgress() must be implemented by subclass")}isReady(){throw new Error("FileTransport.isReady() must be implemented by subclass")}cleanup(){throw new Error("FileTransport.cleanup() must be implemented by subclass")}}const U0={FILE_CONFIG:{NETWORK_CHUNK_SIZE:65536}};async function $0(t){if(t instanceof ArrayBuffer)return t;if(t instanceof Blob)try{return await t.arrayBuffer()}catch(e){return console.error("[ChunkProcessor] Blob conversion failed:",e),null}else if(t instanceof Uint8Array||ArrayBuffer.isView(t))try{const e=t instanceof Uint8Array?t:new Uint8Array(t.buffer,t.byteOffset,t.byteLength),n=new ArrayBuffer(e.length);return new Uint8Array(n).set(e),n}catch(e){return console.error("[ChunkProcessor] TypedArray conversion failed:",e),null}else return console.error("[ChunkProcessor] Unknown data type:",Object.prototype.toString.call(t)),null}function B0(t){try{if(t.byteLength<4)return console.error("[ChunkProcessor] Invalid embedded packet - too small:",t.byteLength),null;const i=new DataView(t).getUint32(0,!0),s=4+i;if(t.byteLength<s)return console.error("[ChunkProcessor] Incomplete embedded packet - expected:",s,"got:",t.byteLength),null;const r=new Uint8Array(t,4,i),o=new TextDecoder().decode(r),a=JSON.parse(o),c=4+i,l=t.slice(c);return{chunkMeta:a,chunkData:l}}catch(e){return console.error("[ChunkProcessor] Failed to parse embedded packet:",e),null}}const H0=1024;function V0(t,e,n){let i=0,s=0;const r=[];t.forEach((c,l)=>{c instanceof ArrayBuffer?(s++,i+=c.byteLength):r.push(l)});const o=e-i;return{isComplete:s===n&&Math.abs(o)<=H0,validChunks:s,totalSize:i,missingChunks:r,sizeDifference:o}}const Ka=U0.FILE_CONFIG.NETWORK_CHUNK_SIZE,Rf=9e3*1024*1024;class W0{constructor(e){this.dataChannel=e,this.receivedChunks=new Map,this.fileMetadata=new Map,this.onFileError=null,this.onReceiveProgress=null}async sendFile(e,n){if(e.size>Rf)throw new Error(`File too large (max ${Rf/(1024*1024)} MB)`);if(this.dataChannel.readyState!=="open")throw new Error("DataChannel not ready");const i=`${e.name}-${e.size}-${Date.now()}`,s=Math.ceil(e.size/Ka);this.dataChannel.send(JSON.stringify({type:"FILE_META",fileId:i,name:e.name,size:e.size,mimeType:e.type,totalChunks:s}));for(let r=0;r<s;r++){const o=r*Ka,a=Math.min(o+Ka,e.size),c=await e.slice(o,a).arrayBuffer(),l={type:"FILE_CHUNK",fileId:i,chunkIndex:r,totalChunks:s},u=new TextEncoder().encode(JSON.stringify(l)),d=new ArrayBuffer(4+u.length+c.byteLength),h=new Uint8Array(d);for(new DataView(d).setUint32(0,u.length,!0),h.set(u,4),h.set(new Uint8Array(c),4+u.length),this.dataChannel.send(d),n&&n((r+1)/s);this.dataChannel.bufferedAmount>256*1024;)await new Promise(p=>setTimeout(p,10))}}async handleMessage(e){if(typeof e=="string"){const n=JSON.parse(e);n.type==="FILE_META"&&(this.fileMetadata.set(n.fileId,n),this.receivedChunks.set(n.fileId,[]),this.onFileMetaReceived?.(n))}else{const n=await $0(e);if(!n){console.error("[FileTransfer] Failed to convert binary data to ArrayBuffer");return}const i=B0(n);if(!i){console.error("[FileTransfer] Failed to parse embedded chunk packet");return}const{chunkMeta:s,chunkData:r}=i,o=this.receivedChunks.get(s.fileId);if(!o){console.error("[FileTransfer] Received chunk for unknown file:",s.fileId);return}if(o[s.chunkIndex]=r,this.onReceiveProgress){const a=o.filter(c=>c).length;this.onReceiveProgress(a/s.totalChunks)}o.filter(a=>a).length===s.totalChunks&&this.assembleFile(s.fileId)}}assembleFile(e){const n=this.fileMetadata.get(e),i=this.receivedChunks.get(e),s=V0(i,n.size,n.totalChunks);if(!s.isComplete){console.error("[FileTransfer] File assembly failed:",{fileId:e,fileName:n.name,...s}),this.onFileError&&this.onFileError({fileName:n.name,reason:"incomplete",details:s});return}const r=new Blob(i,{type:n.mimeType}),o=new File([r],n.name,{type:n.mimeType});this.onFileReceived?.(o),this.receivedChunks.delete(e),this.fileMetadata.delete(e)}}class j0 extends F0{constructor(e){if(super(),!e)throw new Error("DataChannelFileTransport requires a DataChannel");this.dataChannel=e,this.fileTransfer=new W0(e),this._setupMessageHandling()}_setupMessageHandling(){this.dataChannel.onmessage=e=>{if(typeof e.data=="string")try{const n=JSON.parse(e.data);if(n.type==="FILE_META"||n.type==="FILE_CHUNK"){this.fileTransfer.handleMessage(e.data);return}}catch{}else this.fileTransfer.handleMessage(e.data)}}async sendFile(e,n){if(!this.isReady())throw new Error("DataChannel not ready");return this.fileTransfer.sendFile(e,n)}onFileReceived(e){if(typeof e!="function")throw new Error("onFileReceived callback must be a function");this.fileTransfer.onFileReceived=e}onReceiveProgress(e){if(typeof e!="function")throw new Error("onReceiveProgress callback must be a function");this.fileTransfer.onReceiveProgress=e}isReady(){return this.dataChannel&&this.dataChannel.readyState==="open"}cleanup(){this.dataChannel&&(this.dataChannel.onmessage=null),this.fileTransfer&&(this.fileTransfer.onFileReceived=null,this.fileTransfer.onFileMetaReceived=null),this.dataChannel=null,this.fileTransfer=null}}function bo(t,e,n={}){if(!t||typeof e!="function")throw new Error("closeOnClickOutside: valid element and onClose callback required");const{ignore:i=[],esc:s=!0,events:r=["mousedown","touchstart"]}=n,o=Array.isArray(i)?i.filter(Boolean):[],a=l=>{try{const u=l.target;if(t.contains(u))return;for(const d of o)if(d&&d.contains&&d.contains(u)||d===u)return;e(l)}catch(u){console.error("closeOnClickOutside handler error:",u)}},c=l=>{s&&l.key==="Escape"&&e(l)};return r.forEach(l=>document.addEventListener(l,a,{passive:!0})),s&&document.addEventListener("keydown",c),function(){r.forEach(u=>document.removeEventListener(u,a,{passive:!0})),s&&document.removeEventListener("keydown",c)}}const q0=t=>String(t).replace(/[&<>"'`=\/]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","`":"&#x60;","=":"&#x3D;","/":"&#x2F;"})[n]),z0=(t,e)=>t.replace(/\$\{([^}]+)\}/g,(n,i)=>{const s=i.trim(),r=s.split(".").reduce((a,c)=>a?.[c],e);return r==null?"":s.endsWith("Html")?String(r):q0(String(r))}),G0=(t,e={})=>{const n=document.createElement("template");return n.innerHTML=z0(t,e),n.content.cloneNode(!0)},K0=(t,e)=>{const n=[];let i=e;for(;i&&i!==t;){const s=i.parentElement;if(!s)break;const r=Array.prototype.indexOf.call(s.children,i);n.push(r),i=s}return n.reverse()},Y0=(t,e)=>e.reduce((n,i)=>n&&n.children?n.children[i]:null,t),J0=t=>Array.from(t.querySelectorAll("input, textarea, select")).map(e=>({name:e.name,id:e.id,path:K0(t,e),value:e.value,checked:e.checked,selectionStart:e.selectionStart,selectionEnd:e.selectionEnd,wasFocused:document.activeElement===e})),X0=t=>typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(String(t)):String(t).replace(/[^_a-zA-Z0-9-]/g,e=>"\\"+e),Q0=(t,e)=>{e.forEach(n=>{let i=null;if(n.name){const s=t.querySelectorAll("input[name], textarea[name], select[name]");for(const r of s)if(r.getAttribute("name")===n.name){i=r;break}}else if(n.id)try{i=t.querySelector("#"+X0(n.id))}catch{i=t.querySelector(`#${n.id}`)}else n.path&&(i=Y0(t,n.path));if(i){if(i.value=n.value,n.checked!==void 0&&(i.checked=n.checked),n.selectionStart!=null&&i.setSelectionRange)try{i.setSelectionRange(n.selectionStart,n.selectionEnd)}catch{}if(n.wasFocused)try{i.focus()}catch{}}})},Z0=t=>Array.from(t.querySelectorAll("video, audio")).map(e=>({src:e.currentSrc||e.src,currentTime:e.currentTime,paused:e.paused,volume:e.volume,playbackRate:e.playbackRate,muted:e.muted})),eO=(t,e)=>{const n=t.querySelectorAll("video, audio");for(const i of n)if(i.currentSrc===e||i.src===e)return i;return null},tO=(t,e)=>{e.forEach(n=>{if(!n.src)return;const i=eO(t,n.src);i&&(i.currentTime=n.currentTime,i.volume=n.volume,i.playbackRate=n.playbackRate,i.muted=n.muted,n.paused||i.play().catch(()=>{}))})},nO=()=>document.readyState!=="loading",ju=({initialProps:t={},template:e="",handlers:n={},parent:i=null,containerTag:s="div",className:r="",onMount:o=null,onCleanup:a=null,autoAppend:c=!0,preserveInputState:l=!0}={})=>{if(!nO())return console.error("createComponent: DOM must be ready before creating components."),null;const u=document.createElement(s);r&&(u.className=r);let d={...t};const h=new Set,f=/\$\{([^}]+)\}/g;let p;for(;(p=f.exec(e))!==null;){const b=p[1].trim().split(".")[0];h.add(b)}const _=[],m=[],R={},B=()=>{let b=[],oe=[];l&&(b=J0(u),oe=Z0(u)),u.textContent="";const We=G0(e,d);u.appendChild(We),Object.keys(n).forEach(Ze=>{const Te=u.querySelectorAll(`[onclick="${Ze}"]`),Ht=n[Ze];Te.forEach(ur=>{ur.removeAttribute("onclick"),typeof Ht=="function"&&ur.addEventListener("click",Ht)})}),l&&(Q0(u,b),tO(u,oe)),_.forEach(Ze=>Ze({...d}))},N=b=>{if(!Array.isArray(b)||b.length===0)return;const oe={props:{...d},changedKeys:b};m.forEach(We=>We(oe))};for(const b of Object.keys(t))R[b]=[],Object.defineProperty(u,b,{get(){return d[b]},set(oe){d[b]!==oe&&(d[b]=oe,h.has(b)&&B(),R[b].forEach(We=>We(oe)),N([b]))},configurable:!0,enumerable:!0});if(u.update=b=>{let oe=!1,We=!1;const Ze=[];for(const Te in b)b[Te]!==d[Te]&&(d[Te]=b[Te],h.has(Te)&&(We=!0),R[Te]&&R[Te].forEach(Ht=>Ht(b[Te])),oe=!0,Ze.push(Te));oe&&We&&B(),Ze.length>0&&N(Ze)},u.onRender=b=>{typeof b=="function"&&_.push(b)},u.onAnyPropUpdated=b=>{typeof b=="function"&&m.push(b)},u.onPropUpdated=(b,oe)=>{typeof oe=="function"&&R[b]&&R[b].push(oe)},u.dispose=()=>{a&&(Array.isArray(a)?a.forEach(b=>{typeof b=="function"&&b()}):typeof a=="function"&&a()),_.length=0,m.length=0;for(const b in R)R[b].length=0;u.remove()},B(),c&&i&&!i.contains(u)&&i.appendChild(u),typeof o=="function")try{o(u)}catch(b){DP("[createComponent]: Error in onMount handler of component",b)}return u};function gy({parent:t,onToggle:e,icon:n="💬",initialUnreadCount:i=0,id:s=null,startHidden:r=!1}={}){if(!t)return console.error("createMessageToggle: parent element is required"),null;if(typeof e!="function")return console.error("createMessageToggle: onToggle callback is required"),null;const o=ju({initialProps:{unreadCount:i},template:`
  ...
  `,document.body.appendChild(t);const e=t.querySelector("#messages-box"),n=t.querySelector("#messages"),i=t.querySelector("#messages-form"),s=t.querySelector("#messages-input");"virtualKeyboard"in navigator&&(navigator.virtualKeyboard.overlaysContent=!0);const r=CSS.supports?.("field-sizing","content");let o=null;if(s&&s.tagName==="TEXTAREA"&&!r){const a=()=>{s.style.height="auto",s.style.height=`${s.scrollHeight}px`};s.addEventListener("input",a,{passive:!0}),o=()=>{s.style.height=""},requestAnimationFrame(a)}return{messagesBoxContainer:t,messagesBox:e,messagesMessages:n,messagesForm:i,messagesInput:s,resetInputHeight:o}}const oO=CSS.supports?.("position-anchor: --msg-toggle")&&CSS.supports?.("right: anchor(right)")&&CSS.supports?.("bottom: anchor(top)");function aO(t){const e=t.getBoundingClientRect();return e.top>=0&&e.left>=0&&e.bottom<=window.innerHeight&&e.right<=window.innerWidth}function cO(){let t=!1,e=null,n=null,i=!1,s=new Map;const r=document.querySelector(".top-bar .top-right-menu")||document.querySelector(".top-right-menu"),o=gy({parent:r,onToggle:()=>ma(),icon:"💬",initialUnreadCount:0,id:"main-messages-toggle-btn",startHidden:!0});if(!o)return console.error("Messages UI: failed to initialize message toggle; aborting messages UI initialization."),null;const a=o.element,{messagesBoxContainer:c,messagesBox:l,messagesMessages:u,messagesForm:d,messagesInput:h,resetInputHeight:f}=rO();if(!a||!l||!u||!d||!h)return console.error("Messages UI elements not found."),null;const p=document.getElementById("attach-file-btn"),_=document.getElementById("file-input"),m=d.querySelector('button[type="submit"]');w(p),p.addEventListener("click",()=>{_.click()}),_.addEventListener("change",async C=>{const A=C.target.files[0];if(!A||!n){n||console.warn("[MessagesUI] FileTransfer not initialized");return}const D=m.textContent;m.textContent="Sending...";try{await n.sendFile(A,F=>{m.textContent=`${Math.round(F*100)}%`}),A.type.startsWith("video/")&&s.set(A.name,A),be(`📎 Sent: ${A.name}`,{isSentByMe:!0})}catch(F){console.error("[MessagesUI] File send failed:",F),be("❌ Failed to send file")}finally{m.textContent=D,_.value=""}});async function R(C){return new Promise(A=>{const D=document.createElement("div");D.className="file-action-overlay",D.style.cssText=`
      ...
      `,D.appendChild(F),document.body.appendChild(D);const ue=F.querySelector("#watch-request-filename");ue.textContent=C;const de=F.querySelector("#decline-watch-btn"),ae=F.querySelector("#accept-watch-btn");de.addEventListener("mouseenter",()=>{de.style.background="var(--bg-hover, #333)"}),de.addEventListener("mouseleave",()=>{de.style.background="var(--bg-secondary, #2a2a2a)"}),ae.addEventListener("mouseenter",()=>{ae.style.opacity="0.9"}),ae.addEventListener("mouseleave",()=>{ae.style.opacity="1"}),de.addEventListener("click",()=>{D.remove(),A(!1)}),ae.addEventListener("click",()=>{D.remove(),A(!0)}),D.addEventListener("click",Vt=>{Vt.target===D&&(D.remove(),A(!1))})})}window.onFileWatchRequestReceived=async C=>{const A=s.get(C);if(!A){be(`❌ File not available to watch together: ${C}`),await Xc();return}be(`🎬 Partner wants to watch: ${C}`),await B(C)?(be("✅ Joining watch together..."),await E0(A)||be("❌ Failed to load video")):(be("❌ Declined watch together request"),await Xc())};function N(){if(!a||!l||l.classList.contains("hidden"))return;const C=a.getBoundingClientRect(),A=l.getBoundingClientRect(),D=8;let F=C.top-A.height-D;F<8&&(F=C.bottom+D);let ue=C.left+C.width/2-A.width/2;const de=window.innerWidth-A.width-8;ue<8&&(ue=8),ue>de&&(ue=de),l.style.top=`${Math.round(F)}px`,l.style.left=`${Math.round(ue)}px`}function b(){t||(t=!0,window.addEventListener("resize",N,{passive:!0}),window.addEventListener("scroll",N,{passive:!0}),window.addEventListener("orientationchange",N,{passive:!0}))}function oe(){t&&(t=!1,window.removeEventListener("resize",N),window.removeEventListener("scroll",N),window.removeEventListener("orientationchange",N))}let We=null;const Ze=new MutationObserver(C=>{C.forEach(A=>{A.type==="attributes"&&A.attributeName==="class"&&(l.classList.contains("hidden")||(o.clearBadge(),e?.toggle&&e.toggle.clearBadge()))})});Ze.observe(l,{attributes:!0});function Te(){return!l.classList.contains("hidden")}function Ht(){return document.activeElement===h}function ur(){Ht()||h.focus()}function Xy(){Ht()&&h.blur()}function ma(){l.classList.toggle("hidden"),Te()?(Nf()||h.focus(),oO?requestAnimationFrame(()=>{aO(l)||(N(),b())}):(N(),b()),id()):(document.activeElement===h&&h.blur(),oe(),l.style.top="",l.style.left="",l.style.bottom="",l.style.right="")}Nf()||(We=bo(l,()=>{w(l),oe(),l.style.top="",l.style.left="",l.style.bottom="",l.style.right=""},{ignore:[o.element],esc:!0}));function Qy(){M(o.element)}function nd(){w(o.element)}function be(C,A={}){const{isSentByMe:D,senderDisplay:F,fileDownload:ue}=A,de=F??(D===!0?"Me":""),ae=document.createElement("p");D===!0?ae.classList.add("message-local"):D===!1&&ae.classList.add("message-remote");const Vt=document.createElement("span");Vt.className="sender-avatar"+(D===!0?" sender-avatar--me":""),Vt.textContent=de,Vt.setAttribute("aria-hidden","true");const es=document.createElement("span");if(es.className="message-text",!F&&typeof D>"u"&&ae.classList.add("message-system"),ue){const{fileName:ts,url:od}=ue,ad=C.split(ts)[0];ad&&es.appendChild(document.createTextNode(ad));const vn=document.createElement("a");vn.textContent=ts,vn.href=od,vn.download=ts,vn.style.cursor="pointer",vn.style.textDecoration="underline",vn.addEventListener("click",()=>{setTimeout(()=>URL.revokeObjectURL(od),100)}),es.appendChild(vn)}else{const ts=sO(C);es.appendChild(ts)}ue&&ae.classList.add("message-system"),ae.appendChild(Vt),ae.appendChild(es),u.appendChild(ae),id()}let wn=null;function id(){u&&(wn!==null&&cancelAnimationFrame(wn),wn=requestAnimationFrame(()=>{u.scrollTop=u.scrollHeight,wn=null}))}function Zy(C,{isUnread:A=!0,senderDisplay:D="U"}={}){if(be(C,{isSentByMe:!1,senderDisplay:D}),mo(l)&&A){const F=o.element.unreadCount||0;o.setUnreadCount(F+1)}}function sd(){const C=h.value.trim();C&&(e?(e.send(C),h.value="",f&&f()):console.warn("[MessagesUI] No active session to send message"))}d.addEventListener("submit",C=>{C.preventDefault(),sd()}),h.addEventListener("keydown",C=>{C.key==="Enter"&&!C.shiftKey&&(C.preventDefault(),sd())});const ew=()=>{const C=document.activeElement;return C&&(C.tagName==="INPUT"||C.tagName==="TEXTAREA"||C.isContentEditable)},rd=C=>{(C.key==="m"||C.key==="M")&&!Te()&&!ew()&&(C.preventDefault(),ma())};document.addEventListener("keydown",rd);function _a(){wn!==null&&(cancelAnimationFrame(wn),wn=null),u.innerHTML="",u.scrollTop=0}function tw(C){e!==null&&e!==C&&_a(),e=C}function nw(){return e}function iw(C){n=C,n?(M(p),n.onFileReceived=async A=>{const D=URL.createObjectURL(A);if(A.type.startsWith("video/"))if(await R(A.name)==="watch"){if(be(`📹 Received video: ${A.name}`,{isSentByMe:!1}),be("🎬 Requesting partner to join watch together..."),!await qs(A)){be("❌ Failed to load video");return}const de=await b0(A.name);be(de?"⏳ Waiting for partner to join...":"❌ Failed to send watch request")}else{const ue=document.createElement("a");ue.href=D,ue.download=A.name,ue.click(),setTimeout(()=>URL.revokeObjectURL(D),1e3),be(`📎 Downloaded: ${A.name}`)}else be(`📎 Received: ${A.name}`,{isSentByMe:!1,fileDownload:{fileName:A.name,url:D}});if(mo(l)){const F=o.element.unreadCount||0;o.setUnreadCount(F+1)}i&&(m.textContent="Send",i=!1)},n.onReceiveProgress=A=>{i=!0,m.textContent=`${Math.round(A*100)}%`}):w(p)}function sw(){_a(),e=null,n=null,i=!1,nd(),w(l),o.clearBadge(),h.value="",f&&f(),m&&(m.textContent="Send"),w(p),l.style.top="",l.style.left="",l.style.bottom="",l.style.right="",oe()}function rw(){if(o&&o.cleanup(),oe(),typeof We=="function")try{We()}catch(C){console.error("Error removing messages box outside click handler:",C)}Ze.disconnect(),document.removeEventListener("keydown",rd),c&&c.parentNode&&c.parentNode.removeChild(c)}return{appendChatMessage:be,receiveMessage:Zy,isMessagesUIOpen:Te,toggleMessages:ma,showMessagesToggle:Qy,hideMessagesToggle:nd,isMessageInputFocused:Ht,focusMessageInput:ur,unfocusMessageInput:Xy,setSession:tw,getCurrentSession:nw,clearMessages:_a,setFileTransfer:iw,reset:sw,cleanup:rw}}const Se=cO();class lO{constructor(){this.listeners=new Map}on(e,n){this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(n)}off(e,n){this.listeners.has(e)&&this.listeners.get(e).delete(n)}emit(e,n){if(this.listeners.has(e))for(const i of Array.from(this.listeners.get(e)))try{i(n)}catch(s){console.warn("CallController listener error",s)}}}class uO{constructor(){this.emitter=new lO,this.resetState()}resetState(){this.state="idle",this.roomId=null,this.roomLink=null,this.role=null,this.partnerId=null,this.pc=null,this.dataChannel=null,this.messagesUI=null,this.localVideoEl=null,this.remoteVideoEl=null,this.isHangingUp=!1,this.isCleaningUp=!1,this.listeners=new Map,this.wasConnected=!1}getState(){return{state:this.state,roomId:this.roomId,roomLink:this.roomLink,role:this.role,partnerId:this.partnerId,hasPc:!!this.pc,isHangingUp:this.isHangingUp,isCleaningUp:this.isCleaningUp}}on(e,n){this.emitter.on(e,n)}off(e,n){this.emitter.off(e,n)}setPartnerId(e){this.partnerId=e}setupCancellationListener(e){if(!e)return;const n=S(I,`rooms/${e}/cancellation`);let i=!1;const s=async r=>{const o=r.val();if(o&&!i){i=!0;try{this.remoteVideoEl&&(this.remoteVideoEl.srcObject=null)}catch(a){console.warn("Failed to clear remote video after cancellation",a)}try{this.pc&&this.pc.close()}catch{}try{await this.cleanupCall({reason:o.reason||"remote_cancelled"})}catch(a){console.warn("Failed to trigger CallController cleanup",a)}}};ys(n,s,e),this.listeners.has("cancellation")||this.listeners.set("cancellation",[]),this.listeners.get("cancellation").push({ref:n,callback:s,roomId:e})}setupAnswerListener(e,n,i){if(!e||!n)return;const s=S(I,`rooms/${e}/answer`),r=async o=>{const a=o.val();if(a){const{setRemoteDescription:c}=await Pe(async()=>{const{setRemoteDescription:l}=await Promise.resolve().then(()=>D0);return{setRemoteDescription:l}},void 0);await c(n,a,i)}};ys(s,r,e),this.listeners.has("answer")||this.listeners.set("answer",[]),this.listeners.get("answer").push({ref:s,callback:r,roomId:e})}setupRejectionListener(e){if(!e)return;const n=S(I,`rooms/${e}/rejection`);let i=!1;const s=async r=>{const o=r.val();if(o&&!i&&(i=!0,this.pc?.connectionState!=="connected")){try{const{onCallRejected:a}=await Pe(async()=>{const{onCallRejected:c}=await Promise.resolve().then(()=>a0);return{onCallRejected:c}},void 0);await a(o.reason||"user_rejected")}catch{}try{await ee.leaveRoom(ge(),e)}catch{}try{this.pc&&this.pc.close()}catch{}}};ys(n,s,e),this.listeners.has("rejection")||this.listeners.set("rejection",[]),this.listeners.get("rejection").push({ref:n,callback:s,roomId:e})}setupMemberJoinedListener(e){if(!e)return;const n=ge(),i=s=>{s.key!==n&&(this.setPartnerId(s.key),this.emitter.emit("memberJoined",{memberId:s.key,roomId:e}))};ee.onMemberJoined(e,i),this.listeners.has("member-joined")||this.listeners.set("member-joined",[]),this.listeners.get("member-joined").push({callback:i,roomId:e})}setupMemberLeftListener(e){if(!e)return;const n=ge(),i=s=>{s.key!==n&&this.pc?.connectionState==="connected"&&this.emitter.emit("memberLeft",{memberId:s.key,roomId:e})};ee.onMemberLeft(e,i),this.listeners.has("member-left")||this.listeners.set("member-left",[]),this.listeners.get("member-left").push({callback:i,roomId:e})}removeTrackedListeners(){try{for(const[e,n]of this.listeners.entries())for(const i of n)try{i.ref&&Ot(i.ref,"value",i.callback)}catch(s){console.warn(`Failed to remove ${e} listener`,s)}}catch(e){console.warn("Failed to remove tracked listeners",e)}finally{this.listeners.clear()}if(this.roomId)try{na(this.roomId)}catch(e){console.warn("Failed to remove RTDB listeners for room",e)}}async createCall(e={}){this.state="creating";try{e.localVideoEl&&(this.localVideoEl=e.localVideoEl),e.remoteVideoEl&&(this.remoteVideoEl=e.remoteVideoEl);const n=await M0(e);if(!n||!n.success)return this.state="idle",this.emitter.emit("error",{phase:"createCall",detail:n}),this.emitCallFailed("createCall",n),n;this.pc=n.pc,this.roomId=n.roomId,this.roomLink=n.roomLink||null,this.role=n.role||"initiator",this.dataChannel=n.dataChannel||null,this.messagesUI=n.messagesUI||null,this.state="waiting",this.pc&&typeof this.pc.addEventListener=="function"&&this.pc.addEventListener("connectionstatechange",()=>{this.pc.connectionState==="connected"&&(this.wasConnected=!0,this.state!=="connected"&&(this.state="connected"))}),this.dataChannel&&this.setupFileTransport(this.dataChannel);const{drainIceCandidateQueue:i}=await Pe(async()=>{const{drainIceCandidateQueue:s}=await Promise.resolve().then(()=>i0);return{drainIceCandidateQueue:s}},void 0);return this.setupAnswerListener(this.roomId,this.pc,i),this.setupCancellationListener(this.roomId),this.setupRejectionListener(this.roomId),this.setupMemberJoinedListener(this.roomId),this.setupMemberLeftListener(this.roomId),this.emitter.emit("created",{roomId:this.roomId,roomLink:this.roomLink,role:this.role}),n}catch(n){throw this.state="idle",this.emitter.emit("error",{phase:"createCall",error:n}),this.emitCallFailed("createCall",n),n}}async answerCall(e={}){this.state="joining";try{e.localVideoEl&&(this.localVideoEl=e.localVideoEl),e.remoteVideoEl&&(this.remoteVideoEl=e.remoteVideoEl);const i=await x0({...e,onMessagesUIReady:s=>{this.messagesUI=s}});return!i||!i.success?(this.state="idle",this.emitter.emit("error",{phase:"answerCall",detail:i}),this.emitCallFailed("answerCall",i),i):(this.pc=i.pc,this.roomId=i.roomId,this.role=i.role||"joiner",this.dataChannel=i.dataChannel||null,!this.messagesUI&&i.messagesUI&&(this.messagesUI=i.messagesUI),this.state="connected",this.wasConnected=!0,this.dataChannel?this.setupFileTransport(this.dataChannel):this.role==="joiner"&&this.pc&&(this.pc.ondatachannel=s=>{this.dataChannel=s.channel,this.setupFileTransport(this.dataChannel)}),this.setupCancellationListener(this.roomId),this.setupMemberJoinedListener(this.roomId),this.setupMemberLeftListener(this.roomId),this.emitter.emit("answered",{roomId:this.roomId,role:this.role}),i)}catch(n){throw this.state="idle",this.emitter.emit("error",{phase:"answerCall",error:n}),this.emitCallFailed("answerCall",n),n}}setupFileTransport(e){if(!e)return;const n=()=>{try{const i=new j0(e);sn.setFileTransport(i),Se.setFileTransfer(i.fileTransfer),$("[CallController] File transport initialized")}catch(i){console.error("[CallController] Failed to setup file transport:",i)}};e.readyState==="open"?n():e.addEventListener("open",n,{once:!0})}async hangUp({emitCancel:e=!0,reason:n="user_hung_up"}={}){if(!this.isHangingUp){this.isHangingUp=!0;try{if(e&&this.roomId)try{await ee.cancelCall(this.roomId,ge(),n)}catch(i){console.warn("CallController: cancelCall failed (non-fatal)",i)}await this.cleanupCall({reason:n}),this.emitter.emit("hangup",{roomId:this.roomId,reason:n})}catch(i){throw this.emitter.emit("error",{phase:"hangUp",error:i}),i}finally{this.isHangingUp=!1}}}isRemoteHangup(e){return e?["remote","cancelled","partner_disconnected","connection_failed"].some(i=>e.includes(i)):!1}emitCallFailed(e,n){this.emitter.emit("callFailed",{phase:e,error:n?.message||n?.error||n||"Unknown error"})}async cleanupCall({reason:e}={}){if(!this.isCleaningUp){this.isCleaningUp=!0;try{const n=this.roomId,i=this.partnerId,s=this.role,r=this.wasConnected;this.removeTrackedListeners();try{await ee.leaveRoom(ge(),this.roomId)}catch{}try{if(this.pc){try{this.pc.close()}catch{}this.pc=null}}catch{}try{this.remoteVideoEl&&(this.remoteVideoEl.srcObject=null)}catch(o){console.warn("CallController: failed to clear remote video",o)}try{this.localVideoEl&&(this.localVideoEl.srcObject=null)}catch(o){console.warn("CallController: failed to clear local video",o)}try{const{cleanupLocalStream:o}=await Pe(async()=>{const{cleanupLocalStream:a}=await Promise.resolve().then(()=>d0);return{cleanupLocalStream:a}},void 0);o()}catch(o){console.warn("CallController: failed to cleanup local stream",o)}try{const{resetLocalStreamInitFlag:o}=await Pe(async()=>{const{resetLocalStreamInitFlag:a}=await Promise.resolve().then(()=>jD);return{resetLocalStreamInitFlag:a}},void 0);o()}catch{}this.isRemoteHangup(e)&&this.emitter.emit("remoteHangup",{roomId:n,partnerId:i,reason:e});try{sn.clearFileTransport(),Se.setFileTransfer(null)}catch(o){console.warn("CallController: failed to cleanup file transport",o)}if(this.messagesUI&&this.messagesUI.cleanup)try{this.messagesUI.cleanup()}catch(o){console.warn("CallController: failed to cleanup messages UI",o)}this.resetState(),this.emitter.emit("cleanup",{roomId:n,role:s,wasConnected:r,partnerId:i,reason:e})}catch(n){throw this.emitter.emit("error",{phase:"cleanupCall",error:n}),n}finally{this.isCleaningUp=!1}}}}const _e=new uO,Zc={default:{echoCancellation:!0,noiseSuppression:!0,autoGainControl:!0},withVoiceIsolationIfSupported:{echoCancellation:!0,noiseSuppression:!0,autoGainControl:!0,voiceIsolation:!0,restrictOwnAudio:!0,googHighpassFilter:!0,googTypingNoiseDetection:!0,highpassFilter:!0,typingNoiseDetection:!0}};function my(){const t=navigator.mediaDevices.getSupportedConstraints();return["voiceIsolation","highpassFilter","typingNoiseDetection"].every(i=>t[i])?Zc.withVoiceIsolationIfSupported:Zc.default}const dO=()=>Zc.default,hO={desktop:{landscape:{width:{ideal:1920},height:{ideal:1080},frameRate:{min:10,ideal:30},aspectRatio:{ideal:16/9}},portrait:{width:{ideal:1080},height:{ideal:1920},frameRate:{min:10,ideal:30},aspectRatio:{ideal:9/16}}},mobile:{portrait:{width:{ideal:1080},height:{ideal:1920},aspectRatio:{ideal:9/16},frameRate:{ideal:30}},landscape:{width:{ideal:1920},height:{ideal:1080},aspectRatio:{ideal:16/9},frameRate:{ideal:30}}}},fO=()=>window.screen?.orientation?.type?.includes("portrait")||window.orientation===0||window.orientation===180;function qu(t){const e=fO()?"portrait":"landscape",i=/Mobi|Android/i.test(navigator.userAgent)?"mobile":"desktop",s=hO[i][e];return{facingMode:t,...s}}function pO(){return!!(navigator.mediaDevices&&navigator.mediaDevices.enumerateDevices)}async function gO(){return pO()?(await navigator.mediaDevices.enumerateDevices()).filter(e=>e.kind==="videoinput"):[]}async function mO(){const t=await gO();let e=!1,n=!1;return t.forEach(i=>{const s=i.label.toLowerCase();(s.includes("front")||s.includes("user"))&&(e=!0),(s.includes("back")||s.includes("rear")||s.includes("environment"))&&(n=!0)}),e&&n}async function _O({localStream:t,localVideo:e,currentFacingMode:n,peerConnection:i=null}){if(!t||!e)return console.error("switchCamera: missing localStream or localVideo"),null;const s=n==="user"?"environment":"user";try{const r=await navigator.mediaDevices.getUserMedia({video:qu(s),audio:my()}),o=r.getVideoTracks()[0],a=r.getAudioTracks()[0],c=t.getVideoTracks()[0],l=c?c.enabled:!0,u=t.getAudioTracks()[0],d=u?!u.enabled:!1;if(o&&(o.enabled=l),a&&(a.enabled=!d),t.getTracks().forEach(h=>h.stop()),i){const h=i.getSenders().find(p=>p.track&&p.track.kind==="video");h&&await h.replaceTrack(o);const f=i.getSenders().find(p=>p.track&&p.track.kind==="audio");f&&a&&await f.replaceTrack(a)}return e.srcObject=new MediaStream([o].filter(Boolean)),{newStream:r,facingMode:s}}catch(r){return console.error("Failed to switch camera:",r),null}}let Ya=!1,Cn=null,Tn=null;function yO({getLocalStream:t,getFacingMode:e}){return Cn&&Tn&&Cn.removeEventListener("change",Tn),Cn=window.matchMedia("(orientation: portrait)"),Tn=()=>{try{const n=typeof t=="function"?t():null,i=typeof e=="function"?e():"user";wO({localStream:n,currentFacingMode:i})}catch(n){console.error("Orientation handler failed:",n)}},Cn.addEventListener("change",Tn),()=>{Cn&&Tn&&Cn.removeEventListener("change",Tn),Cn=null,Tn=null}}async function wO({localStream:t,currentFacingMode:e}){if(!(Ya||!t?.getVideoTracks()[0])){Ya=!0;try{const n=t.getVideoTracks()[0],i=qu(e);$("Applying constraints:",i),await n.applyConstraints(i),$("Video constraints updated successfully")}catch(n){console.error("Failed to apply orientation constraints:",n)}finally{Ya=!1}}}let el=[];function vO(t,e){const n=e.querySelector("i");n.className=t?"fa fa-microphone-slash":"fa fa-microphone"}function bO({getLocalStream:t,getLocalVideo:e,getRemoteVideo:n,getPeerConnection:i=()=>null,setLocalStream:s=null,micBtn:r,cameraBtn:o,switchCameraBtn:a,mutePartnerBtn:c,fullscreenPartnerBtn:l,remotePipBtn:u}){r&&(r.onclick=()=>{const h=t();if(!h)return;const f=h.getAudioTracks()[0];f&&(f.enabled=!f.enabled,vO(!f.enabled,r))}),o&&(o.onclick=()=>{const h=t();if(!h)return;const f=h.getVideoTracks()[0];if(f){f.enabled=!f.enabled;const p=o.querySelector("i");p.className=f.enabled?"fa fa-video":"fa fa-video-slash"}});const d=yO({getLocalStream:t,getFacingMode:Kc});el.push(d),a&&(a.onclick=async()=>{const h=await _O({localStream:t(),localVideo:e(),currentFacingMode:Kc(),peerConnection:i()||null});h?(G_(h.facingMode),console.log("Switched camera to facingMode:",h.facingMode),h.newStream&&typeof s=="function"&&s(h.newStream)):console.error("Camera switch failed.")},(async()=>await mO()?M(a):w(a))()),c&&(c.onclick=()=>{const h=n();if(!h)return;h.muted=!h.muted;const f=c.querySelector("i");f.className=h.muted?"fa fa-volume-mute":"fa fa-volume-up"}),l&&(l.onclick=()=>{const h=n();h.requestFullscreen?h.requestFullscreen():h.webkitRequestFullscreen&&h.webkitRequestFullscreen()}),u&&(u.onclick=async()=>{const h=n();if(h)try{document.pictureInPictureElement===h?await document.exitPictureInPicture():h.requestPictureInPicture&&await h.requestPictureInPicture()}catch(f){console.error("Picture-in-Picture failed:",f)}})}function EO(){el.forEach(t=>t()),el=[]}const CO=async()=>{if(J_())return console.debug("Reusing existing local MediaStream."),da();const t=qu("user"),e=my();try{const n=await navigator.mediaDevices.getUserMedia({video:t,audio:e});return _o(n),n}catch(n){if(n.name==="OverconstrainedError"){console.warn(`❌ Constraint failed on property: ${n.constraint}, falling back to basic constraints`);const i=dO(),s=await navigator.mediaDevices.getUserMedia({video:!0,audio:i});return _o(s),s}throw n}};async function TO(t){const e=await CO(),n=new MediaStream(e.getVideoTracks());return t.srcObject=n,!0}function SO(t,e,n){return t.ontrack=i=>{$(`REMOTE TRACK RECEIVED: ${i.track.kind}`);const s=ua()?Fu():null;let r;i.streams&&i.streams[0]&&i.streams[0]instanceof MediaStream?r=i.streams[0]:(console.warn("No stream in track event, using fallback track handling"),s?(s.addTrack(i.track),r=s):r=new MediaStream([i.track])),K_(r),e.srcObject=r,s!==r||$(`Added ${i.track.kind} track to existing remote stream`);try{const o=document.getElementById("remote-video-box")||e.parentElement;o&&(o.classList?.remove("hidden"),e.classList?.remove("hidden"),o.style.visibility="visible",o.style.opacity="1",o.style.position="",o.style.left="",o.style.top="",e.style.visibility="visible",e.style.opacity="1")}catch(o){console.warn("Visibility override failed:",o)}},!0}let Dr=null,pt=null;async function _y(t,e="User"){const n=H(),i=zn();if(!n||!i)throw new Error("Must be logged in to send invites");if(!t)throw new Error("Recipient user ID is required");const s=fo(n,t),r=S(I,`users/${t}/incomingInvites/${n}`),o={fromUserId:n,fromName:i.displayName||"Anonymous",fromEmail:i.email||"",fromPhotoURL:i.photoURL||null,roomId:s,timestamp:Date.now(),status:"pending"};await te(r,o),console.log(`[INVITATIONS] Sent invite to ${e} (${t})`)}function IO(t){const e=H();if(!e)return console.warn("[INVITATIONS] Cannot listen for invites - not logged in"),()=>{};tl();const n=S(I,`users/${e}/incomingInvites`);return Dr=Di(n,i=>{const s=i.key,r=i.val();r&&r.status==="pending"&&(console.log(`[INVITATIONS] New invite from ${r.fromName}`),t(s,r))}),console.log("[INVITATIONS] Listening for incoming invites"),tl}async function kO(t,e){const n=H(),i=zn();if(!n||!i)throw new Error("Must be logged in to accept invites");const s=S(I,`users/${n}/contacts/${t}`);await te(s,{contactId:t,contactName:e.fromName||"User",roomId:e.roomId,savedAt:Date.now()});const r=S(I,`users/${t}/acceptedInvites/${n}`);await te(r,{acceptedByUserId:n,acceptedByName:i.displayName||"User",acceptedByEmail:i.email||"",acceptedByPhotoURL:i.photoURL||null,roomId:e.roomId,timestamp:Date.now()});const o=S(I,`users/${n}/incomingInvites/${t}`);await Ve(o),console.log(`[INVITATIONS] Accepted invite from ${e.fromName} and notified sender`)}async function AO(t){const e=H();if(!e)throw new Error("Must be logged in to decline invites");const n=S(I,`users/${e}/incomingInvites/${t}`);await Ve(n),console.log(`[INVITATIONS] Declined invite from ${t}`)}function RO(t){const e=H();if(!e)return console.warn("[INVITATIONS] Cannot listen for accepted invites - not logged in"),()=>{};pt&&(pt(),pt=null);const n=S(I,`users/${e}/acceptedInvites`);return pt=Di(n,async i=>{const s=i.key,r=i.val();if(r)try{const o=S(I,`users/${e}/contacts/${s}`);await te(o,{contactId:s,contactName:r.acceptedByName||"User",roomId:r.roomId,savedAt:Date.now()}),console.log(`[INVITATIONS] Auto-saved contact: ${r.acceptedByName} (invite accepted)`);const a=S(I,`users/${e}/acceptedInvites/${s}`);await Ve(a),t&&t(s,r)}catch(o){console.error("[INVITATIONS] Failed to auto-save contact from accepted invite:",o)}}),console.log("[INVITATIONS] Listening for accepted invites"),()=>{pt&&(pt(),pt=null)}}function tl(){Dr&&(Dr(),Dr=null),pt&&(pt(),pt=null),console.log("[INVITATIONS] Cleaned up all invite listeners")}function NO(){w(re),w(me),w(Ae),w(Ke)}function PO(t){t.on("memberJoined",oy),t.on("cleanup",()=>{xn(),ay()})}let Ei=null;function ha(t,e={}){return new Promise(n=>{const i=document.createElement("dialog");i.innerHTML=`
      <p>${t}</p>
      <div class="confirm-dialog-actions">
        <button data-action="cancel">Cancel</button>
        <button data-action="confirm" autofocus>Confirm</button>
      </div>
    `,i.classList.add("confirm-dialog");const s=i.querySelector('[data-action="confirm"]'),r=i.querySelector('[data-action="cancel"]');if(!s||!r){console.error("dialog element not found!"),n(!1);return}let o=null;function a(c){o&&clearTimeout(o),i.close(),i.remove(),Ei===a&&(Ei=null),n(c)}s.addEventListener("click",()=>{a(!0)}),r.addEventListener("click",()=>{a(!1)}),i.addEventListener("cancel",()=>a(!1)),document.body.appendChild(i),i.showModal(),Ei=a,e.autoRemoveSeconds&&typeof e.autoRemoveSeconds=="number"&&e.autoRemoveSeconds>0&&(o=setTimeout(()=>{a(!1)},e.autoRemoveSeconds*1e3))})}function OO(){if(typeof Ei=="function"){try{Ei(!1)}catch{}return Ei=null,!0}return!1}const LO=Object.freeze(Object.defineProperty({__proto__:null,default:ha,dismissActiveConfirmDialog:OO},Symbol.toStringTag,{value:"Module"})),Ja=new Map,Xa=new Map,li=new Map,Pf=14;async function nl(t,e,n){const i=H();if(i){const s=S(I,`users/${i}/contacts/${t}`);await te(s,{contactId:t,contactName:e,roomId:n,savedAt:Date.now()});return}try{const s=localStorage.getItem("contacts")||"{}",r=JSON.parse(s);r[t]={contactId:t,contactName:e,roomId:n,savedAt:Date.now()},localStorage.setItem("contacts",JSON.stringify(r))}catch(s){console.warn("Failed to save contact to localStorage",s)}}async function Yn(){const t=H();if(t)try{const e=S(I,`users/${t}/contacts`),n=await Ge(e);return n.exists()?n.val():{}}catch(e){return console.warn("Failed to read contacts from RTDB",e),{}}try{const e=localStorage.getItem("contacts")||"{}";return JSON.parse(e)}catch(e){return console.warn("Failed to read contacts from localStorage",e),{}}}async function DO(t){if(!t)return null;try{const e=await Yn();for(const n of Object.values(e||{}))if(n?.roomId===t)return n}catch(e){console.warn("Failed to get contact by roomId",e)}return null}async function yy(t,e){if(!t)return e||"Unknown";try{const n=await Yn();for(const i of Object.values(n||{}))if(i?.roomId===t)return i.contactName||i.contactId||e}catch(n){console.warn("Failed to resolve caller name",n)}return e||"Unknown"}async function wy(t,e,n){if(!t||!e)return;const s=(await Yn())?.[t];if(s){s.roomId!==e&&(await nl(t,s.contactName,e),await pn(n)),xi(e);return}if(!await ha("Save contact?",{autoRemoveSeconds:15}))return;const o=window.prompt("Enter a name for this contact:",t)||t;await nl(t,o,e),xi(e),await pn(n)}async function pn(t){if(!t)return;const e=await Yn(),n=Object.keys(e);let i=t.querySelector(".contacts-container");if(i||(i=document.createElement("div"),i.className="contacts-container",t.appendChild(i)),n.length===0){i.innerHTML="<p>No saved contacts yet.</p>",w(i);return}M(i),i.innerHTML=`
    <h3>Contacts</h3>
      ...
      ${n.map(s=>{const r=e[s];return`
            <div class="contact-entry">
              ...
              >
                ...
                ${r.contactName&&r.contactName.length>Pf?r.contactName.slice(0,Pf-2)+"..":r.contactName}
              </span>
              <button
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const by=1e4,Ey=`w:${zu}`,Cy="FIS_v2",GO="https://firebaseinstallations.googleapis.com/v1",KO=3600*1e3,YO="installations",JO="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tL({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const i=Sy(t),s=Ay(t),r=e.getImmediate({optional:!0});if(r){const l=await r.getHeartbeatsHeader();l&&s.append("x-firebase-client",l)}const o={fid:n,authVersion:Cy,appId:t.appId,sdkVersion:Ey},a={method:"POST",headers:s,body:JSON.stringify(o)},c=await Ry(()=>fetch(i,a));if(c.ok){const l=await c.json();return{fid:l.fid||n,registrationStatus:2,refreshToken:l.refreshToken,authToken:Iy(l.authToken)}}else throw await ky("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Py=new Map;function Oy(t,e){const n=pa(t);Ly(n,e),oL(n,e)}function Ly(t,e){const n=Py.get(t);if(n)for(const i of n)i(e)}function oL(t,e){const n=aL();n&&n.postMessage({key:t,fid:e}),cL()}let Pn=null;function aL(){return!Pn&&"BroadcastChannel"in self&&(Pn=new BroadcastChannel("[Firebase] FID Change"),Pn.onmessage=t=>{Ly(t.data.key,t.data.fid)}),Pn}function cL(){Py.size===0&&Pn&&(Pn.close(),Pn=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lL="firebase-installations-database",uL=1,Xn="firebase-installations-store";let Za=null;function Gu(){return Za||(Za=Fo(lL,uL,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Xn)}}})),Za}async function Eo(t,e){const n=pa(t),s=(await Gu()).transaction(Xn,"readwrite"),r=s.objectStore(Xn),o=await r.get(n);return await r.put(e,n),await s.done,(!o||o.fid!==e.fid)&&Oy(t,e.fid),e}async function Dy(t){const e=pa(t),i=(await Gu()).transaction(Xn,"readwrite");await i.objectStore(Xn).delete(e),await i.done}async function ga(t,e){const n=pa(t),s=(await Gu()).transaction(Xn,"readwrite"),r=s.objectStore(Xn),o=await r.get(n),a=e(o);return a===void 0?await r.delete(n):await r.put(a,n),await s.done,a&&(!o||o.fid!==a.fid)&&Oy(t,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ku(t){let e;const n=await ga(t.appConfig,i=>{const s=dL(i),r=hL(t,s);return e=r.registrationPromise,r.installationEntry});return n.fid===al?{installationEntry:await e}:{installationEntry:n,registrationPromise:e}}function dL(t){const e=t||{fid:sL(),registrationStatus:0};return My(e)}function hL(t,e){if(e.registrationStatus===0){if(!navigator.onLine){const s=Promise.reject(Jn.create("app-offline"));return{installationEntry:e,registrationPromise:s}}const n={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},i=fL(t,n);return{installationEntry:n,registrationPromise:i}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:pL(t)}:{installationEntry:e}}async function fL(t,e){try{const n=await tL(t,e);return Eo(t.appConfig,n)}catch(n){throw Ty(n)&&n.customData.serverCode===409?await Dy(t.appConfig):await Eo(t.appConfig,{fid:e.fid,registrationStatus:0}),n}}async function pL(t){let e=await xf(t.appConfig);for(;e.registrationStatus===1;)await Ny(100),e=await xf(t.appConfig);if(e.registrationStatus===0){const{installationEntry:n,registrationPromise:i}=await Ku(t);return i||n}return e}function xf(t){return ga(t,e=>{if(!e)throw Jn.create("installation-not-found");return My(e)})}function My(t){return gL(t)?{fid:t.fid,registrationStatus:0}:t}function gL(t){return t.registrationStatus===1&&t.registrationTime+by<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mL({appConfig:t,heartbeatServiceProvider:e},n){const i=_L(t,n),s=QO(t,n),r=e.getImmediate({optional:!0});if(r){const l=await r.getHeartbeatsHeader();l&&s.append("x-firebase-client",l)}const o={installation:{sdkVersion:Ey,appId:t.appId}},a={method:"POST",headers:s,body:JSON.stringify(o)},c=await Ry(()=>fetch(i,a));if(c.ok){const l=await c.json();return Iy(l)}else throw await ky("Generate Auth Token",c)}function _L(t,{fid:e}){return`${Sy(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yu(t,e=!1){let n;const i=await ga(t.appConfig,r=>{if(!xy(r))throw Jn.create("not-registered");const o=r.authToken;if(!e&&vL(o))return r;if(o.requestStatus===1)return n=yL(t,e),r;{if(!navigator.onLine)throw Jn.create("app-offline");const a=EL(r);return n=wL(t,a),a}});return n?await n:i.authToken}async function yL(t,e){let n=await Ff(t.appConfig);for(;n.authToken.requestStatus===1;)await Ny(100),n=await Ff(t.appConfig);const i=n.authToken;return i.requestStatus===0?Yu(t,e):i}function Ff(t){return ga(t,e=>{if(!xy(e))throw Jn.create("not-registered");const n=e.authToken;return CL(n)?{...e,authToken:{requestStatus:0}}:e})}async function wL(t,e){try{const n=await mL(t,e),i={...e,authToken:n};return await Eo(t.appConfig,i),n}catch(n){if(Ty(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await Dy(t.appConfig);else{const i={...e,authToken:{requestStatus:0}};await Eo(t.appConfig,i)}throw n}}function xy(t){return t!==void 0&&t.registrationStatus===2}function vL(t){return t.requestStatus===2&&!bL(t)}function bL(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+KO}function EL(t){const e={requestStatus:1,requestTime:Date.now()};return{...t,authToken:e}}function CL(t){return t.requestStatus===1&&t.requestTime+by<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function TL(t){const e=t,{installationEntry:n,registrationPromise:i}=await Ku(e);return i?i.catch(console.error):Yu(e).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function SL(t,e=!1){const n=t;return await IL(n),(await Yu(n,e)).token}async function IL(t){const{registrationPromise:e}=await Ku(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fy="installations",AL="installations-internal",RL=t=>{const e=t.getProvider("app").getImmediate(),n=kL(e),i=_n(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},NL=t=>{const e=t.getProvider("app").getImmediate(),n=_n(e,Fy).getImmediate();return{getId:()=>TL(n),getToken:s=>SL(n,s)}};function PL(){Je(new He(Fy,RL,"PUBLIC")),Je(new He(AL,NL,"PRIVATE"))}PL();Be(vy,zu);Be(vy,zu,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OL="/firebase-messaging-sw.js",LL="/firebase-cloud-messaging-push-scope",Uy="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",DL="https://fcmregistrations.googleapis.com/v1",$y="google.c.a.c_id",ML="google.c.a.c_l",xL="google.c.a.ts",FL="google.c.a.e",Uf=1e4;var $f;(function(t){t[t.DATA_MESSAGE=1]="DATA_MESSAGE",t[t.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})($f||($f={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const VL="firebase-messaging-database",WL=1,Qn="firebase-messaging-store";let nc=null;function Ju(){return nc||(nc=Fo(VL,WL,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Qn)}}})),nc}async function By(t){const e=Qu(t),i=await(await Ju()).transaction(Qn).objectStore(Qn).get(e);if(i)return i;{const s=await BL(t.appConfig.senderId);if(s)return await Xu(t,s),s}}async function Xu(t,e){const n=Qu(t),s=(await Ju()).transaction(Qn,"readwrite");return await s.objectStore(Qn).put(e,n),await s.done,e}async function jL(t){const e=Qu(t),i=(await Ju()).transaction(Qn,"readwrite");await i.objectStore(Qn).delete(e),await i.done}function Qu({appConfig:t}){return t.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zL(t,e){const n=await ed(t),i=Vy(e),s={method:"POST",headers:n,body:JSON.stringify(i)};let r;try{r=await(await fetch(Zu(t.appConfig),s)).json()}catch(o){throw ve.create("token-subscribe-failed",{errorInfo:o?.toString()})}if(r.error){const o=r.error.message;throw ve.create("token-subscribe-failed",{errorInfo:o})}if(!r.token)throw ve.create("token-subscribe-no-token");return r.token}async function GL(t,e){const n=await ed(t),i=Vy(e.subscriptionOptions),s={method:"PATCH",headers:n,body:JSON.stringify(i)};let r;try{r=await(await fetch(`${Zu(t.appConfig)}/${e.token}`,s)).json()}catch(o){throw ve.create("token-update-failed",{errorInfo:o?.toString()})}if(r.error){const o=r.error.message;throw ve.create("token-update-failed",{errorInfo:o})}if(!r.token)throw ve.create("token-update-no-token");return r.token}async function Hy(t,e){const i={method:"DELETE",headers:await ed(t)};try{const r=await(await fetch(`${Zu(t.appConfig)}/${e}`,i)).json();if(r.error){const o=r.error.message;throw ve.create("token-unsubscribe-failed",{errorInfo:o})}}catch(s){throw ve.create("token-unsubscribe-failed",{errorInfo:s?.toString()})}}function Zu({projectId:t}){return`${DL}/projects/${t}/registrations`}async function ed({appConfig:t,installations:e}){const n=await e.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t.apiKey,"x-goog-firebase-installations-auth":`FIS ${n}`})}function Vy({p256dh:t,auth:e,endpoint:n,vapidKey:i}){const s={web:{endpoint:n,auth:e,p256dh:t}};return i!==Uy&&(s.web.applicationPubKey=i),s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KL=10080*60*1e3;async function YL(t){const e=await QL(t.swRegistration,t.vapidKey),n={vapidKey:t.vapidKey,swScope:t.swRegistration.scope,endpoint:e.endpoint,auth:bt(e.getKey("auth")),p256dh:bt(e.getKey("p256dh"))},i=await By(t.firebaseDependencies);if(i){if(ZL(i.subscriptionOptions,n))return Date.now()>=i.createTime+KL?XL(t,{token:i.token,createTime:Date.now(),subscriptionOptions:n}):i.token;try{await Hy(t.firebaseDependencies,i.token)}catch(s){console.warn(s)}return Hf(t.firebaseDependencies,n)}else return Hf(t.firebaseDependencies,n)}async function JL(t){const e=await By(t.firebaseDependencies);e&&(await Hy(t.firebaseDependencies,e.token),await jL(t.firebaseDependencies));const n=await t.swRegistration.pushManager.getSubscription();return n?n.unsubscribe():!0}async function XL(t,e){try{const n=await GL(t.firebaseDependencies,e),i={...e,token:n,createTime:Date.now()};return await Xu(t.firebaseDependencies,i),n}catch(n){throw n}}async function Hf(t,e){const i={token:await zL(t,e),createTime:Date.now(),subscriptionOptions:e};return await Xu(t,i),i.token}async function QL(t,e){const n=await t.pushManager.getSubscription();return n||t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:UL(e)})}function ZL(t,e){const n=e.vapidKey===t.vapidKey,i=e.endpoint===t.endpoint,s=e.auth===t.auth,r=e.p256dh===t.p256dh;return n&&i&&s&&r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iD(t){return typeof t=="object"&&!!t&&$y in t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function aD(t,e){if(!e&&!t.swRegistration&&await Wy(t),!(!e&&t.swRegistration)){if(!(e instanceof ServiceWorkerRegistration))throw ve.create("invalid-sw-registration");t.swRegistration=e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cD(t,e){e?t.vapidKey=e:t.vapidKey||(t.vapidKey=Uy)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jy(t,e){if(!navigator)throw ve.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw ve.create("permission-blocked");return await cD(t,e?.vapidKey),await aD(t,e?.serviceWorkerRegistration),YL(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lD(t,e,n){const i=uD(e);(await t.firebaseDependencies.analyticsProvider.get()).logEvent(i,{message_id:n[$y],message_name:n[ML],message_time:n[xL],message_device_time:Math.floor(Date.now()/1e3)})}function uD(t){switch(t){case zs.NOTIFICATION_CLICKED:return"notification_open";case zs.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dD(t,e){const n=e.data;if(!n.isFirebaseMessaging)return;t.onMessageHandler&&n.messageType===zs.PUSH_RECEIVED&&(typeof t.onMessageHandler=="function"?t.onMessageHandler(Vf(n)):t.onMessageHandler.next(Vf(n)));const i=n.data;iD(i)&&i[FL]==="1"&&await lD(t,n.messageType,i)}const Wf="@firebase/messaging",jf="0.12.23";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hD=t=>{const e=new rD(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>dD(e,n)),e},fD=t=>{const e=t.getProvider("messaging").getImmediate();return{getToken:i=>jy(e,i)}};function pD(){Je(new He("messaging",hD,"PUBLIC")),Je(new He("messaging-internal",fD,"PRIVATE")),Be(Wf,jf),Be(Wf,jf,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gD(){try{await tg()}catch{return!1}return typeof window<"u"&&Do()&&hT()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mD(t){if(!navigator)throw ve.create("only-available-in-window");return t.swRegistration||await Wy(t),JL(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function yD(t=Uo()){return gD().then(e=>{if(!e)throw ve.create("unsupported-browser")},e=>{throw ve.create("indexed-db-unsupported")}),_n(ne(t),"messaging").getImmediate()}async function wD(t,e){return t=ne(t),jy(t,e)}function qf(t){return t=ne(t),mD(t)}function vD(t,e){return t=ne(t),_D(t,e)}pD();class bD{constructor(){this.messaging=null,this.currentToken=null,this.vapidKey=NR,this.isInitialized=!1,this.messageCallbacks=new Set,this.tokenRefreshCallbacks=new Set}async initialize(){if(this.isInitialized)return!0;try{return!("serviceWorker"in navigator)||!("Notification"in window)?(console.warn("[FCMTransport] FCM not supported in this environment"),!1):this.vapidKey?(this.messaging=yD(ta),vD(this.messaging,e=>{console.log("[FCMTransport] Foreground message received:",e),this.messageCallbacks.forEach(n=>{try{n(e)}catch(i){console.error("[FCMTransport] Error in message callback:",i)}})}),this.isInitialized=!0,console.log("[FCMTransport] Initialized successfully"),!0):(console.warn("[FCMTransport] VAPID key not configured"),!1)}catch(e){return console.error("[FCMTransport] Initialization failed:",e),!1}}async getToken(){if(!this.isInitialized&&!await this.initialize())return null;try{const e=await wD(this.messaging,{vapidKey:this.vapidKey});return e?(this.currentToken=e,console.log("[FCMTransport] Token obtained"),await this.storeUserToken(e),e):(console.warn("[FCMTransport] No registration token available"),null)}catch(e){return console.error("[FCMTransport] Failed to get token:",e),null}}async refreshToken(){if(console.log("[FCMTransport] Refreshing token..."),this.currentToken)try{await qf(this.messaging),await this.removeUserToken(this.currentToken)}catch(n){console.warn("[FCMTransport] Failed to delete old token:",n)}this.currentToken=null;const e=await this.getToken();return e&&this.tokenRefreshCallbacks.forEach(n=>{try{n(e)}catch(i){console.error("[FCMTransport] Error in token refresh callback:",i)}}),e}async deleteToken(){if(!this.messaging||!this.currentToken)return!0;try{return await qf(this.messaging),await this.removeUserToken(this.currentToken),this.currentToken=null,console.log("[FCMTransport] Token deleted successfully"),!0}catch(e){return console.error("[FCMTransport] Failed to delete token:",e),!1}}async storeUserToken(e){const n=H();if(!n){console.warn("[FCMTransport] Cannot store token: user not logged in");return}try{const i=S(I,`users/${n}/fcmTokens/${this.getTokenId(e)}`),s={token:e,deviceInfo:{platform:this.getPlatform(),timestamp:Date.now()},createdAt:Date.now(),lastUsed:Date.now()};await te(i,s),console.log("[FCMTransport] Token stored in RTDB")}catch(i){console.error("[FCMTransport] Failed to store token in RTDB:",i)}}async removeUserToken(e){const n=H();if(n)try{const i=S(I,`users/${n}/fcmTokens/${this.getTokenId(e)}`);await Ve(i),console.log("[FCMTransport] Token removed from RTDB")}catch(i){console.error("[FCMTransport] Failed to remove token from RTDB:",i)}}async getUserTokens(e){try{const n=S(I,`users/${e}/fcmTokens`),i=await Ge(n);if(i.exists()){const s=i.val();return Object.values(s)}return[]}catch(n){return console.error("[FCMTransport] Failed to get user tokens:",n),[]}}async sendCallNotification(e,n){const{roomId:i,callerId:s,callerName:r}=n,o={type:"call",roomId:i,callerId:s,callerName:r,timestamp:Date.now().toString()},a="/HangVidU/",c={notification:{title:`Incoming call from ${r}`,body:"Tap to answer or decline",icon:`${a}icons/play-arrows-v1/icon-192.png`,badge:`${a}icons/play-arrows-v1/icon-192.png`},data:o};return this.sendNotification(e,c)}async sendMissedCallNotification(e,n){const{roomId:i,callerId:s,callerName:r}=n,o={type:"missed_call",roomId:i,callerId:s,callerName:r,timestamp:Date.now().toString()},a="/HangVidU/",c={notification:{title:`Missed call from ${r}`,body:"Tap to call back",icon:`${a}icons/play-arrows-v1/icon-192.png`,badge:`${a}icons/play-arrows-v1/icon-192.png`},data:o};return this.sendNotification(e,c)}async sendMessageNotification(e,n){const{senderId:i,senderName:s,messageText:r}=n,o=typeof r=="string"?r:String(r||""),a=o.length>50?o.substring(0,47)+"...":o,c={type:"message",senderId:i,senderName:s,messagePreview:a,timestamp:Date.now().toString()},l="/HangVidU/",u={notification:{title:`New message from ${s}`,body:a,icon:`${l}icons/play-arrows-v1/icon-192.png`,badge:`${l}icons/play-arrows-v1/icon-192.png`},data:c};return this.sendNotification(e,u)}async sendNotification(e,n){try{{const a=await fetch("https://europe-west1-vidu-aae11.cloudfunctions.net/sendCallNotification",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({targetUserId:e,callData:n.data})});if(a.ok){const c=await a.json();return console.log(`[FCMTransport] FCM notification sent to ${e}:`,c),!0}else return console.error("[FCMTransport] FCM function failed:",a.status),!1}if((await this.getUserTokens(e)).length===0)return console.warn(`[FCMTransport] No tokens found for user ${e}`),!1;const s=S(I,`notifications/${e}`),r=Us(s).key,o={id:r,payload:n,createdAt:Date.now(),delivered:!1};return await te(S(I,`notifications/${e}/${r}`),o),console.log(`[FCMTransport] Notification queued for user ${e} (dev mode)`),!0}catch(i){return console.error("[FCMTransport] Failed to send notification:",i),!1}}onMessage(e){return this.messageCallbacks.add(e),()=>this.messageCallbacks.delete(e)}onTokenRefresh(e){return this.tokenRefreshCallbacks.add(e),()=>this.tokenRefreshCallbacks.delete(e)}getTokenId(e){return btoa(e).replace(/[^a-zA-Z0-9]/g,"").substring(0,20)}getPlatform(){const e=navigator.userAgent;return/iPhone|iPad|iPod/.test(e)?"ios":/Android/.test(e)?"android":/Macintosh/.test(e)?"macos":/Windows/.test(e)?"windows":"unknown"}static isSupported(){return"serviceWorker"in navigator&&"Notification"in window}}class ED{constructor(e=null,n={}){this.transport=e||new bD,this.isEnabled=!1,this.permissionState="default",this.options={enableCallNotifications:!0,enableMessageNotifications:!0,privacyMode:!1,autoHideSuccessMs:6e3,...n},this.activeNotifications=new Map,this.permissionCallbacks=new Set,this.notificationCallbacks=new Set}async initialize(){try{return await this.transport.initialize()?(this.permissionState=this.getPermissionState(),this.transport.onMessage(n=>{this.handleForegroundMessage(n)}),console.log("[NotificationController] Initialized successfully"),!0):(console.warn("[NotificationController] Transport initialization failed"),!1)}catch(e){return console.error("[NotificationController] Initialization failed:",e),!1}}async requestPermission(e={}){const{title:n="Enable notifications",explain:i="Get notified of incoming calls and messages even when the app is closed.",onGranted:s=null,onDenied:r=null,onDismissed:o=null}=e;if(!this.isNotificationSupported())return console.warn("[NotificationController] Notifications not supported"),{state:"denied",reason:"unsupported"};this.detectBrowser();const a=Notification.permission;if(this.permissionState=a,a==="granted")return await this.enable(),s?.(),{state:"granted"};if(a==="denied")return r?.("already-denied"),{state:"denied",reason:"already-denied"};let c;try{c=await Notification.requestPermission()}catch(l){console.error("[NotificationController] Permission request failed:",l),c=Notification.permission}return this.permissionState=c,c==="granted"?(await this.enable(),s?.(),{state:"granted"}):a==="default"&&c==="denied"?(r?.("silent-block"),{state:"denied",reason:"silent-block"}):c==="default"?(o?.(),{state:"dismissed"}):(r?.(),{state:"denied"})}async enable(){if(this.permissionState!=="granted")return console.warn("[NotificationController] Cannot enable: permission not granted"),!1;try{return await this.transport.getToken()?(this.isEnabled=!0,console.log("[NotificationController] Notifications enabled"),this.permissionCallbacks.forEach(n=>{try{n("enabled")}catch(i){console.error("[NotificationController] Error in permission callback:",i)}}),!0):(console.warn("[NotificationController] Failed to get FCM token"),!1)}catch(e){return console.error("[NotificationController] Failed to enable notifications:",e),!1}}async disable(){try{return await this.transport.deleteToken(),this.isEnabled=!1,this.activeNotifications.clear(),console.log("[NotificationController] Notifications disabled"),this.permissionCallbacks.forEach(e=>{try{e("disabled")}catch(n){console.error("[NotificationController] Error in permission callback:",n)}}),!0}catch(e){return console.error("[NotificationController] Failed to disable notifications:",e),!1}}async sendCallNotification(e,n){if(!this.options.enableCallNotifications)return console.log("[NotificationController] Call notifications disabled"),!1;if(!this.shouldSendNotification())return console.log("[NotificationController] Not sending call notification (app in foreground)"),!1;try{const i=await this.transport.sendCallNotification(e,n);if(i){const s=`call_${n.roomId}_${Date.now()}`;this.activeNotifications.set(s,{type:"call",roomId:n.roomId,targetUserId:e,timestamp:Date.now()}),console.log(`[NotificationController] Call notification sent to ${e}`)}return i}catch(i){return console.error("[NotificationController] Failed to send call notification:",i),!1}}async sendMissedCallNotification(e,n){if(!this.options.enableCallNotifications)return console.log("[NotificationController] Call notifications disabled (missed call masked)"),!1;try{const i=await this.transport.sendMissedCallNotification(e,n);return i&&console.log(`[NotificationController] Missed call notification sent to ${e}`),i}catch(i){return console.error("[NotificationController] Failed to send missed call notification:",i),!1}}async sendMessageNotification(e,n){if(!this.options.enableMessageNotifications)return console.log("[NotificationController] Message notifications disabled"),!1;if(!this.shouldSendNotification())return console.log("[NotificationController] Not sending message notification (app in foreground)"),!1;try{const i=await this.transport.sendMessageNotification(e,n);if(i){const s=`message_${e}_${Date.now()}`;this.activeNotifications.set(s,{type:"message",senderId:n.senderId,targetUserId:e,timestamp:Date.now()}),console.log(`[NotificationController] Message notification sent to ${e}`)}return i}catch(i){return console.error("[NotificationController] Failed to send message notification:",i),!1}}async dismissCallNotifications(e){try{const n=[];for(const[i,s]of this.activeNotifications)s.type==="call"&&s.roomId===e&&n.push(i);n.forEach(i=>this.activeNotifications.delete(i)),n.length>0&&console.log(`[NotificationController] Dismissed ${n.length} call notifications for room ${e}`)}catch(n){console.error("[NotificationController] Failed to dismiss call notifications:",n)}}async dismissMessageNotifications(e){try{const n=[];for(const[i,s]of this.activeNotifications)s.type==="message"&&s.senderId===e&&n.push(i);n.forEach(i=>this.activeNotifications.delete(i)),n.length>0&&console.log(`[NotificationController] Dismissed ${n.length} message notifications from ${e}`)}catch(n){console.error("[NotificationController] Failed to dismiss message notifications:",n)}}async cleanupOldNotifications(){const e=Date.now(),n=1440*60*1e3,i=[];for(const[s,r]of this.activeNotifications)e-r.timestamp>n&&i.push(s);i.forEach(s=>this.activeNotifications.delete(s)),i.length>0&&console.log(`[NotificationController] Cleaned up ${i.length} old notifications`)}handleForegroundMessage(e){console.log("[NotificationController] Foreground message received:",e),this.notificationCallbacks.forEach(n=>{try{n(e)}catch(i){console.error("[NotificationController] Error in notification callback:",i)}})}shouldSendNotification(){return document.hidden||!document.hasFocus()}getPermissionState(){return this.isNotificationSupported()?Notification.permission:"unsupported"}isNotificationEnabled(){return this.isEnabled&&this.permissionState==="granted"}isNotificationSupported(){return"Notification"in window&&"serviceWorker"in navigator}updateOptions(e){this.options={...this.options,...e},console.log("[NotificationController] Options updated:",this.options)}onPermissionChange(e){return this.permissionCallbacks.add(e),()=>this.permissionCallbacks.delete(e)}onNotification(e){return this.notificationCallbacks.add(e),()=>this.notificationCallbacks.delete(e)}detectBrowser(){if(navigator.userAgentData&&navigator.userAgentData.brands){const n=navigator.userAgentData.brands.map(i=>i.brand);if(n.some(i=>i.includes("Microsoft Edge")))return"Edge";if(n.some(i=>i.includes("Google Chrome")))return"Chrome";if(n.some(i=>i.includes("Chromium")))return"Chromium"}const e=navigator.userAgent;return e.includes("Edg/")?"Edge":e.includes("Chrome/")?"Chrome":e.includes("Safari/")&&!e.includes("Chrome")?"Safari":e.includes("Firefox/")?"Firefox":"Your browser"}async formatCallNotification(e){const{roomId:n,callerId:i,callerName:s}=e;let r=s;try{const{resolveCallerName:o}=await Pe(async()=>{const{resolveCallerName:a}=await Promise.resolve().then(()=>il);return{resolveCallerName:a}},void 0);r=await o(n,i)}catch(o){console.warn("[NotificationController] Failed to resolve caller name:",o),r=s||i||"Unknown caller"}return this.options.privacyMode&&(r="Someone"),{...e,callerName:r}}async formatMessageNotification(e){const{senderId:n,senderName:i,messageText:s}=e;let r=i,o=s;try{const{getContacts:a}=await Pe(async()=>{const{getContacts:l}=await Promise.resolve().then(()=>il);return{getContacts:l}},void 0),c=await a();c&&c[n]&&(r=c[n].name||i)}catch(a){console.warn("[NotificationController] Failed to resolve sender name:",a),r=i||n||"Unknown sender"}return this.options.privacyMode?(r="Someone",o="New message"):o&&o.length>50&&(o=o.substring(0,47)+"..."),{...e,senderName:r,messageText:o}}}const xe=new ED;let ls=null;const CD=(t,e=null)=>{if(ls)return ls;if(!t)return console.error("Auth UI: Parent element is required"),null;let n=null,i=null,s=10;typeof e=="number"&&(s=e);const r=Tu();return ls=ju({initialProps:{isLoggedIn:r,userName:"Guest User",signingInDisplay:"none",loginBtnMarginRightPx:s},template:`
  ...
  `,document.head.appendChild(t),Kf=!0}function DD(t){t.showModal||(t.showModal=function(){this.setAttribute("open",""),this.style.display="block",this.style.position="fixed",this.style.top="50%",this.style.left="50%",this.style.transform="translate(-50%, -50%)";const e=getComputedStyle(document.documentElement).getPropertyValue("--z-ui-overlay").trim();this.style.zIndex=e||"1000"},t.close=function(){this.removeAttribute("open"),this.style.display="none"})}async function MD(t,e=null){if(navigator.clipboard&&navigator.clipboard.writeText)try{return await navigator.clipboard.writeText(t),!0}catch(n){return console.warn("Clipboard API failed, using fallback:",n),!1}if(!e)return!1;try{return e.select(),e.setSelectionRange(0,99999),document.execCommand("copy")}catch(n){return console.error("Fallback copy failed:",n),!1}}function xD(){const t=window.matchMedia&&window.matchMedia("(display-mode: standalone)").matches||navigator.standalone===!0,e=/iphone|ipad|ipod/i.test(navigator.userAgent||"");if(!t||!e||!window.location.hostname.includes("github.io"))return;const i="https://vidu-aae11.web.app",s=i.replace(/\/$/,"");let r;try{r=new URL(s).hostname}catch(l){console.error("[PWA Redirect] Invalid VITE_APP_HOSTING_URL:",i,l);return}if(window.location.hostname===r)return;const o="/HangVidU/";let a=window.location.pathname;a.startsWith(o)?a="/"+a.slice(o.length):a==="/HangVidU"&&(a="/");let c;try{c=new URL(a+window.location.search+window.location.hash,s).toString()}catch(l){console.error("[PWA Redirect] Failed to construct target URL:",l);return}console.log("[PWA Redirect] iOS standalone PWA on gh-pages → redirecting to Firebase Hosting:",c),window.location.replace(c)}xD();LP(!0);y().disable();let td=[];async function FD(){NO();const t=V_(),n=["localVideoEl","remoteVideoEl","localBoxEl","remoteBoxEl","chatControls","lobbyDiv","titleAuthBar"].filter(i=>!t[i]);if(n.length>0)return console.error("Critical elements missing:",n),!1;try{{const{setupPWA:r}=await Pe(async()=>{const{setupPWA:o}=await import("./PWA-BHwTpDiF.js");return{setupPWA:o}},[]);await r()}HO(),BD(),await P_;const i=CD(ca);i&&td.push(i.dispose);const s=document.querySelector(".top-right-menu");if(s){const r=jO({parent:s,hideWhenAllRead:!0});zO.setToggle(r)}try{await xe.initialize()?console.log("[MAIN] FCM notifications initialized successfully"):console.warn("[MAIN] FCM notifications failed to initialize")}catch(r){console.error("[MAIN] FCM initialization error:",r)}return!0}catch(i){return console.error("Initialization error:",i),!1}}let cl=!1;function qy(){cl=!1}async function zy(){cl||(cl=!0,await TO(je),bO({getLocalStream:da,getLocalVideo:()=>je,getRemoteVideo:()=>se,getPeerConnection:()=>_e.getState().pc,setLocalStream:_o,micBtn:Qi,cameraBtn:Zi,switchCameraBtn:Xi,mutePartnerBtn:lt,fullscreenPartnerBtn:la,remotePipBtn:fn}),je&&(je.addEventListener("enterpictureinpicture",()=>me&&w(me)),je.addEventListener("leavepictureinpicture",()=>{me&&!(Kn()&&ty())&&M(me)})))}function Gy(t){(t?.name==="NotAllowedError"||t?.name==="PermissionDeniedError")&&alert('Camera/microphone access is required for video calls. Please click "Allow" when prompted, or check your browser settings.'),qy()}function xr(t=null){return{localStream:da(),localVideoEl:je,remoteVideoEl:se,mutePartnerBtn:lt,setupRemoteStream:SO,setupWatchSync:v0,targetRoomId:t}}function Fr(t,e=!1){return t.success?(e&&t.roomLink&&OD(t.roomLink,{onCopy:()=>$("Link ready! Share with your partner."),onCancel:()=>$("Link ready! Use the copy button to use it, or create a new one.")}),!0):!1}async function lr(t,{forceInitiator:e=!1}={}){try{await zy()}catch(r){return console.error("Failed to initialize local media stream:",r),Gy(r),!1}const n=Date.now();if(e){y().logRoomCreation(t,!0,{creationTime:n,listenerAttachTime:n,timeDiff:0},{trigger:"force_initiator",reason:"calling_saved_contact"});const r=await _e.createCall(xr(t));return Fr(r,!1)}let i=await ee.checkRoomStatus(t);if(i.exists&&!i.hasMembers){let o=0;for(;o<3&&!i.hasMembers;)await new Promise(a=>setTimeout(a,250*(o+1))),i=await ee.checkRoomStatus(t),o++}if(!i.exists||!i.hasMembers){y().logRoomCreation(t,!0,{creationTime:n,listenerAttachTime:n,timeDiff:0},{trigger:"room_empty_or_nonexistent",roomExists:i.exists,memberCount:i.memberCount||0});const r=await _e.createCall(xr(t));return Fr(r,!0)}y().log("ROOM","JOINING_EXISTING",{roomId:t,memberCount:i.memberCount,roomExists:i.exists});const s=await _e.answerCall({roomId:t,...xr()});return Fr(s,!1)}const Fe=new Set,Ky=new Map;function Yf(t){t&&(na(t),Fe.delete(t),Ky.delete(t),y().log("LISTENER","INCOMING_CLEANUP",{roomId:t,remainingListeners:Fe.size}))}function UD(){$(`[LISTENER] Removing all incoming listeners (${Fe.size} rooms)`);const t=Array.from(Fe);t.forEach(e=>{na(e)}),Fe.clear(),Ky.clear(),y().log("LISTENER","ALL_INCOMING_CLEANUP",{roomsCleared:t.length})}async function $D(t){const e=Date.now(),n=e+1440*60*1e3,i=H();if(i){const s=hu(i,t);await te(s,{roomId:t,savedAt:e,expiresAt:n});return}try{const s=localStorage.getItem("recentCalls")||"{}",r=JSON.parse(s);r[t]={roomId:t,savedAt:e,expiresAt:n},localStorage.setItem("recentCalls",JSON.stringify(r))}catch(s){console.warn("Failed to save recent call to localStorage",s)}}async function sc(t){const e=H();if(e){try{await Ve(hu(e,t))}catch(n){console.warn("Failed to remove recent call from RTDB",n)}return}try{const n=localStorage.getItem("recentCalls")||"{}",i=JSON.parse(n);i[t]&&(delete i[t],localStorage.setItem("recentCalls",JSON.stringify(i)))}catch(n){console.warn("Failed to remove recent call from localStorage",n)}}function xi(t){t&&(Fe.has(t)&&(Fe.delete(t),na(t)),$(`[LISTENER] Attaching listener for room: ${t} (total: ${Fe.size+1})`),Fe.add(t),y().logListenerAttachment(t,"member_join",Fe.size,{action:"incoming_call_listener_attached"}),ee.onMemberJoined(t,async e=>{const n=e.key,i=e.val?e.val():null,s=ge();if(n&&n!==s){y().logMemberJoinEvent(t,n,i||{},{detectedBy:"incoming_call_listener",currentUserId:s});const r=i&&typeof i.joinedAt=="number"?i.joinedAt:null,o=2e4;let a=!1,c="none",l=0;if(r&&(l=Date.now()-r,a=l<o,c="joinedAt"),!a){const N=await U_(n,t),b=await $_(t);a=N||b,c=N?"outgoingState":b?"roomCreatedAt":"failed"}const u={isFresh:a,method:c,age:l,reason:a?"call_is_fresh":"call_is_stale"};if(y().logIncomingCallEvent(n,t,u,{memberData:i,joinedAt:r,CALL_FRESH_MS:o}),!a){y().logNotificationDecision("REJECT","stale_call",t,{age:l,validationMethod:c,joiningUserId:n});return}let d;try{d=await ee.getRoomData(t)}catch{return}if(!d||typeof d!="object")return;const h=!!d.offer,f=!!d.answer,p=d.createdBy;if(!h||f||p===s)return;const _=_e.getState();if(!!_.pc&&_.pc.connectionState==="connected"){y().logNotificationDecision("REJECT","already_in_call",t,{joiningUserId:n,currentCallState:_.pc?.connectionState});return}y().logNotificationDecision("SHOW","fresh_call_detected",t,{joiningUserId:n,freshnessResult:u});const R=await yy(t,n);if(xe.isNotificationEnabled()&&xe.shouldSendNotification())try{const N=await xe.formatCallNotification({roomId:t,callerId:n,callerName:R});console.log("[MAIN] Would send call notification:",N)}catch(N){console.warn("[MAIN] Failed to send call notification:",N)}gi.playIncoming(),Gf.startCallIndicators(R);let B=!1;try{B=await ha(`Incoming call from ${R}.

Accept?`)}finally{gi.stop(),Gf.stopCallIndicators()}if(B)Yf(t),xe.isNotificationEnabled()&&await xe.dismissCallNotifications(t),y().logNotificationDecision("ACCEPT","user_accepted",t,{joiningUserId:n}),lr(t).catch(N=>{console.warn("Failed to answer incoming call:",N),y().logFirebaseOperation("join_room_on_accept",!1,N,{roomId:t,joiningUserId:n})});else{xe.isNotificationEnabled()&&await xe.dismissCallNotifications(t),y().logNotificationDecision("REJECT","user_rejected",t,{joiningUserId:n});try{await ee.rejectCall(t,ge(),"user_rejected")}catch(N){console.warn("Failed to signal rejection via RTDB:",N)}await sc(t).catch(N=>{console.warn("Failed to remove recent call on rejection:",N)})}}}),ee.onCallCancelled(t,async e=>{if(e&&typeof e.val=="function"&&e.val()){try{const{dismissActiveConfirmDialog:i}=await Pe(async()=>{const{dismissActiveConfirmDialog:s}=await Promise.resolve().then(()=>LO);return{dismissActiveConfirmDialog:s}},void 0);typeof i=="function"&&i()}catch{}await sc(t).catch(()=>{})}}),ee.onMemberLeft(t,async e=>{const n=e.key,i=ge();if(!(!n||n===i))try{(await ee.checkRoomStatus(t)).hasMembers||(await sc(t),Yf(t),$(`Removed saved recent call and listeners for room ${t} because it is now empty`))}catch(s){console.warn("Failed to evaluate room status on member leave",s)}}))}async function Jf(){const t=Date.now();y().log("LISTENER","STARTUP_BEGIN",{timestamp:t,currentListenerCount:Fe.size});try{if(typeof window<"u"){const{getCurrentUserAsync:n}=await Pe(async()=>{const{getCurrentUserAsync:i}=await Promise.resolve().then(()=>F_);return{getCurrentUserAsync:i}},void 0);await n()}}catch{}const e=H();if(y().log("LISTENER","AUTH_STATE_DETERMINED",{isLoggedIn:!!e,userId:e||"guest"}),e){const n=DR(e);try{const i=await Ge(n),s=i.exists()?i.val():null,r=new Set;if(s)for(const[o,a]of Object.entries(s)){if(!a||a.expiresAt&&a.expiresAt<Date.now()){await Ve(hu(e,o)).catch(()=>{});continue}r.add(o)}try{const o=await Yn();Object.entries(o||{}).forEach(([a,c])=>{if(c?.roomId)r.add(c.roomId);else if(a&&e)try{const l=fo(e,a);r.add(l)}catch{}})}catch{}r.forEach(o=>xi(o)),y().log("LISTENER","STARTUP_COMPLETE",{storage:"rtdb",roomsToListen:Array.from(r),totalListeners:Fe.size,duration:Date.now()-t})}catch(i){console.warn("Failed to read recent calls from RTDB",i),y().logFirebaseOperation("read_recent_calls",!1,i,{storage:"rtdb",userId:e})}return}try{const n=localStorage.getItem("recentCalls")||"{}",i=JSON.parse(n),s={},r=new Set;for(const[o,a]of Object.entries(i||{}))!a||a.expiresAt&&a.expiresAt<Date.now()||(s[o]=a,r.add(o));try{const o=await Yn(),a=ge();Object.entries(o||{}).forEach(([c,l])=>{if(l?.roomId)r.add(l.roomId);else if(c&&a)try{const u=fo(a,c);r.add(u)}catch{}})}catch{}r.forEach(o=>xi(o)),localStorage.setItem("recentCalls",JSON.stringify(s)),y().log("LISTENER","STARTUP_COMPLETE",{storage:"localStorage",roomsToListen:Array.from(r),totalListeners:Fe.size,duration:Date.now()-t,expiredRoomsRemoved:Object.keys(i||{}).length-r.size})}catch(n){console.warn("Failed to read recent calls from localStorage",n),y().logFirebaseOperation("read_recent_calls",!1,n,{storage:"localStorage"})}}function Cr(){return x&&Ae&&!Ae.classList.contains("hidden")&&x.src&&x.src.trim()!==""}let Xf=!1;function BD(){if(Xf)return;const t=()=>{const e=document.activeElement;return e&&(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)};document.addEventListener("keydown",e=>{t()||(e.key==="w"||e.key==="W")&&(console.log("=== W KEY PRESSED ==="),console.log("lastWatched:",ft()),console.log("isYTVisible():",qa()),console.log("isSharedVideoVisible():",Cr()),console.log("isWatchModeActive():",Kn()),ft()==="yt"?qa()?(yo(),Es()):(Z_(),vo()):(ft()==="url"||ft()==="file")&&(Cr()?(w(Ae),Es()):(M(Ae),vo()))),e.key==="Escape"&&Kn()&&(ft()==="yt"&&qa()?(cr(),yo()):(ft()==="url"&&Cr()||ft()==="file"&&Cr())&&(x.pause(),w(Ae)),Es())}),Xf=!0}const Yy=async()=>{try{await zy();const t=await _e.createCall(xr());Fr(t,!0)}catch(t){console.error("Failed to start call:",t),Gy(t)}};Me.onclick=Yy;yn.onclick=Yy;_i&&(navigator.clipboard&&navigator.clipboard.readText?_i.onclick=async()=>{try{const t=await navigator.clipboard.readText(),e=HD(t);if(!e){alert("No valid room link found in clipboard.");return}await lr(e)}catch(t){t.name==="NotAllowedError"?alert("Clipboard access denied. Please allow clipboard access or paste the link manually."):(console.error("Paste & Join failed:",t),alert("Failed to read clipboard. Please try again."))}}:(_i.style.display="none",console.warn("Paste & Join button hidden: Clipboard API not available in this context (requires HTTPS).")));Ws&&(Ws.onclick=async()=>{await kD()});Gn&&(Gn.onclick=()=>{ft()==="yt"?(cr(),yo()):(ft()==="url"||ft()==="file")&&(x.pause(),x.src.startsWith("blob:")&&URL.revokeObjectURL(x.src),w(Ae)),Es()});ct.onclick=async()=>{console.debug("Hanging up..."),await _e.hangUp({emitCancel:!0,reason:"user_hung_up"})};function HD(t){let e=t.trim();if(!e)return"";try{const n=new URL(e,window.location.origin),i=n.searchParams.get("room");if(i)return i;const s=n.hash.match(/room=([^&]+)/);return s?decodeURIComponent(s[1]):n.pathname.replace(/^\//,"")||e}catch{return e}}async function VD(){const e=new URLSearchParams(window.location.search).get("room");if(!e)return!1;const n=await lr(e);return n||(aa(),ay()),n}const ll=[];let rc=!1;async function Jy(){if(rc||ll.length===0)return;rc=!0;const{fromUserId:t,inviteData:e}=ll.shift();try{if(await ha(`${e.fromName||"Someone"} wants to connect.

Accept contact invitation?`))try{await kO(t,e),console.log("[INVITATIONS] Contact added:",e.fromName),await pn(Qe).catch(()=>{}),alert(`Added ${e.fromName} to your contacts!`)}catch(i){console.error("[INVITATIONS] Failed to accept invite:",i),alert("Failed to add contact. Please try again.")}else try{await AO(t),console.log("[INVITATIONS] Invite declined")}catch(i){console.error("[INVITATIONS] Failed to decline invite:",i)}}finally{rc=!1,Jy()}}function Qf(){IO((t,e)=>{ll.push({fromUserId:t,inviteData:e}),Jy()}),RO(async(t,e)=>{console.log("[INVITATIONS] Your invite was accepted by:",e.acceptedByName),await pn(Qe).catch(()=>{}),alert(`${e.acceptedByName} accepted your invitation!`)})}window.onload=async()=>{if(!await FD()){Me&&(Me.disabled=!0,Me.title="Initialization failed. Please reload the page or check your camera/microphone permissions."),console.error("Initialization failed. Call functionality disabled. Please reload the page."),alert(`Hangvidu could not initialize properly.

Please check your camera/microphone permissions and reload the page.`);return}PO(_e),await Jf().catch(s=>console.warn("Failed to start saved-room listeners",s)),pn(Qe).catch(s=>{console.warn("Failed to render contacts list:",s)});let e=null;const n=Su(async({isLoggedIn:s,user:r})=>{try{const o=e===null,a=e===!0&&!s,c=e===!1&&s;e=s,await pn(Qe),a?($("[AUTH] User logged out - cleaning up messaging and listeners"),Se.reset(),sn.closeAllSessions(),xe.isNotificationEnabled()&&await xe.disable().catch(l=>{console.warn("[AUTH] Failed to disable notifications on logout:",l)}),UD(),tl()):c?($("[AUTH] User logged in - re-attaching incoming listeners"),await Jf().catch(l=>console.warn("Failed to re-attach saved-room listeners on login",l)),Qf()):o&&s&&($("[AUTH] Initial load with logged-in user"),Qf())}catch(o){console.warn("Failed to handle auth change:",o)}});td.push(()=>{try{typeof n=="function"&&n()}catch{}}),await VD()};window.addEventListener("beforeunload",async t=>{const e=_e.getState();if(e.pc&&e.pc.connectionState==="connected")return t.preventDefault(),t.returnValue="You are in an active call. Are you sure you want to leave?",t.returnValue;await WD()});_e.on("memberJoined",({memberId:t,roomId:e})=>{console.debug("CallController memberJoined event",{memberId:t,roomId:e}),_e.setPartnerId(t),Se.showMessagesToggle(),fa(t,t),Au().catch(n=>console.warn("Failed to clear calling state:",n)),$D(e).catch(n=>console.warn("Failed to save recent call:",n))});_e.on("memberLeft",({memberId:t})=>{console.info("Partner has left the call")});_e.on("cleanup",async({roomId:t,partnerId:e,reason:n,role:i,wasConnected:s})=>{if(i==="initiator"&&!e&&!s&&t){console.log("[MAIN] Potential missed call detected for room:",t);try{const{getContactByRoomId:a}=await Pe(async()=>{const{getContactByRoomId:l}=await Promise.resolve().then(()=>il);return{getContactByRoomId:l}},void 0),c=await a(t);if(c&&c.contactId){const{getLoggedInUser:l}=await Pe(async()=>{const{getLoggedInUser:h}=await Promise.resolve().then(()=>F_);return{getLoggedInUser:h}},void 0),d=l()?.displayName||"Friend";console.log(`[MAIN] Sending missed call notification to ${c.contactName} (${c.contactId})`),await xe.sendMissedCallNotification(c.contactId,{roomId:t,callerId:ge(),callerName:d})}else console.log("[MAIN] No saved contact found for room, skipping missed call notification")}catch(a){console.warn("[MAIN] Failed to handle missed call:",a)}}t&&xe.isNotificationEnabled()&&xe.dismissCallNotifications(t).catch(a=>{console.warn("[MAIN] Failed to dismiss call notifications:",a)});const o=_e.getState();o.messagesUI&&typeof o.messagesUI.cleanup=="function"&&(o.messagesUI.cleanup(),o.messagesUI=null),Y_(),aa(),e&&t&&setTimeout(()=>{wy(e,t,Qe).catch(a=>{console.warn("Failed to save contact after cleanup:",a)})},500)});async function WD(){await _e.hangUp({emitCancel:!0,reason:"page_unload"}),EO(),PR(),document.pictureInPictureElement&&document.exitPictureInPicture().catch(e=>console.error(e));const t=_e.getState();t.messagesUI&&t.messagesUI.cleanup&&t.messagesUI.cleanup(),window.history.replaceState({},document.title,window.location.pathname),x.src="",X_(),je&&je.srcObject&&(je.srcObject=null),se&&se.srcObject&&(se.srcObject=null),Es(),w0("none"),Uu(),VO(),aa(),Q_(!1),td.forEach(e=>e())}const jD=Object.freeze(Object.defineProperty({__proto__:null,joinOrCreateRoomWithId:lr,listenForIncomingOnRoom:xi,resetLocalStreamInitFlag:qy},Symbol.toStringTag,{value:"Module"}));export{Pe as _,ju as c,$ as d,w as h,qD as i,zO as n,M as s};
