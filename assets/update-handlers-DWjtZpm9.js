const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/virtual_pwa-register-YpSy9bDB.js","assets/main-Bd5Kjr5S.js","assets/main-DSoswIDm.css"])))=>i.map(i=>d[i]);
import{n as a,c as n,_ as o}from"./main-Bd5Kjr5S.js";const i="pwa-update";function r(e){if(a.has(i))return a.notifications.get(i);const t=n({template:`
