 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ji=bS;function rg(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i={name:Tc,automaticDataCollectionEnabled:!0,...e},s=i.name;if(typeof s!="string"||!s)throw en.create("bad-app-name",{appName:String(s)});if(n||(n=Jp()),!n)throw en.create("no-options");const r=qr.get(s);if(r){if($n(n,r.options)&&$n(i,r.config))return r;throw en.create("duplicate-app",{appName:s})}const o=new OT(s);for(const c of Sc.values())o.addComponent(c);const a=new SS(n,i,o);return qr.set(s,a),a}function Uo(t=Tc){const e=qr.get(t);if(!e&&t===Tc&&Jp())return rg();if(!e)throw en.create("no-app",{appName:t});return e}function Be(t,e,n){let i=ES[t]??t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),r=e.match(/\s|\//);if(s||r){const o=[`Unable to register library "${i}" with version "${e}":`];s&&o.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&r&&o.push("and"),r&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Dt.warn(o.join(" "));return}Je(new He(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MS(t){Je(new He("platform-logger",e=>new GT(e),"PRIVATE")),Je(new He("heartbeat",e=>new PS(e),"PRIVATE")),Be(Cc,uh,t),Be(Cc,uh,"esm2020"),Be("fire-js","")}MS("");var gh={};const mh="@firebase/database",_h="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XS{constructor(e,n){this.appCheckProvider=n,this.appName=e.name,et(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=n?.getImmediate({optional:!0}),this.appCheck||n?.get().then(i=>this.appCheck=i)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((n,i)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(n,i):n(null)},0)})}addTokenChangeListener(e){this.appCheckProvider?.get().then(n=>n.addTokenListener(e))}notifyForInvalidToken(){Re(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const VI=!0;function Z(t,e=null){if(t===null)return v.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),g(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new he(n,Z(e))}if(!(t instanceof Array)&&VI){const n=[];let i=!1;if(ye(t,(o,a)=>{if(o.substring(0,1)!=="."){const c=Z(a);c.isEmpty()||(i=i||!c.getPriority().isEmpty(),n.push(new L(o,c)))}}),n.length===0)return v.EMPTY_NODE;const r=Kr(n,DI,o=>o.name,Dl);if(i){const o=Kr(n,Q.getCompare());return new v(r,Z(e),new Ct({".priority":o},{".priority":Q}))}else return new v(r,Z(e),Ct.Default)}else{let n=v.EMPTY_NODE;return ye(t,(i,s)=>{if(wt(t,i)&&i.substring(0,1)!=="."){const r=Z(s);(r.isLeafNode()||!r.isEmpty())&&(n=n.updateImmediateChild(i,r))}}),n.updatePriority(Z(e))}}xI(Z);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var nt;(function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(nt||(nt={}));function xl(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Fl(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Ul(t){return{fromUser:!1,fromServer:!0,queryId:t,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xr{constructor(e,n,i){this.path=e,this.affectedTree=n,this.revert=i,this.type=nt.ACK_USER_WRITE,this.source=xl()}operationForChild(e){if(O(this.path)){if(this.affectedTree.value!=null)return g(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new W(e));return new Xr(U(),n,this.revert)}}else return g(P(this.path)===e,"operationForChild called for unrelated child."),new Xr(z(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bk{getCompleteChild(e){return null}getChildAfterChild(e,n,i){return null}}const zg=new bk;class Hl{constructor(e,n,i=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=i}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new un(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Bl(this.writes_,e,i)}}getChildAfterChild(e,n,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Vn(this.viewCache_),r=wk(this.writes_,s,n,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function BA(t){lg(ji),Je(new He("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return km(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),Be(mh,_h,t),Be(mh,_h,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HA={".sv":"timestamp"};function Dn(){return HA}Pt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Pt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};BA();const VA=Object.freeze(Object.defineProperty({__proto__:null,DataSnapshot:Wn,Database:Am,OnDisconnect:Cm,_QueryImpl:Xo,_QueryParams:Ho,_ReferenceImpl:dt,_repoManagerDatabaseFromApp:km,_setSDKVersion:lg,_validatePathString:Zl,_validateWritablePath:Jt,child:jn,connectDatabaseEmulator:Nm,get:Ge,getDatabase:Rm,off:Ot,onChildAdded:Di,onChildChanged:Sm,onChildRemoved:Im,onDisconnect:Tm,onValue:ru,push:Us,ref:S,remove:Ve,serverTimestamp:Dn,set:te,update:Ln},Symbol.toStringTag,{value:"Module"}));var WA="firebase",jA="12.8.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function IR(t=Uo(),e){t=ne(t);const n=_n(t,"app-check");if(ea().initialized||cR(),cu()&&lu().then(s=>console.log(`App Check debug token: ${s}. You will need to add it to your app's App Check settings in the Firebase console for it to work.`)),n.isInitialized()){const s=n.getImmediate(),r=n.getOptions();if(r.isTokenAutoRefreshEnabled===e.isTokenAutoRefreshEnabled&&r.provider.isEqual(e.provider))return s;throw Le.create("already-initialized",{appName:t.name})}const i=n.initialize({options:e});return kR(t,e.provider,e.isTokenAutoRefreshEnabled),le(t).isTokenAutoRefreshEnabled&&Bm(i,"INTERNAL",()=>{}),i}function kR(t,e,n=!1){const i=zA(t,{...Pm});i.activated=!0,i.provider=e,i.cachedTokenPromise=oR(t).then(s=>(s&&ci(s)&&(i.token=s,Vm(t,{token:s.token})),s)),i.isTokenAutoRefreshEnabled=n&&t.automaticDataCollectionEnabled,!t.automaticDataCollectionEnabled&&n&&Xt.warn("`isTokenAutoRefreshEnabled` is true but `automaticDataCollectionEnabled` was set to false during `initializeApp()`. This blocks automatic token refresh."),i.provider.initialize(t)}const AR="app-check",ef="app-check-internal";function RR(){Je(new He(AR,t=>{const e=t.getProvider("app").getImmediate(),n=t.getProvider("heartbeat");return pR(e,n)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,e,n)=>{t.getProvider(ef).initialize()})),Je(new He(ef,t=>{const e=t.getProvider("app-check").getImmediate();return gR(e)},"PUBLIC").setInstantiationMode("EXPLICIT")),Be(mR,_R)}RR();const NR={apiKey:"AIzaSyA-fvCaKCjyEFX__YAVr1oPGdVsUEhFehA",authDomain:"vidu-aae11.web.app",projectId:"vidu-aae11",databaseURL:"https://vidu-aae11-default-rtdb.europe-west1.firebasedatabase.app",storageBucket:"vidu-aae11.firebasestorage.app",messagingSenderId:"765724787439",appId:"1:765724787439:web:61a3b5dd538149564c911a",measurementId:"G-EGJ53HLGY4"},ta=rg(NR),PR="BIk-HpbCt3Vn7GtQtnFfv0h-hvj_2moy04xGYbmXoqH-AsfQVtiTyxl-QZG1plpYHUysu3yaK7jm1wE0OC6Byys",tf="6LdBIBgsAAAAAB4zIcXaZI-FD4kt21TWs9Zx9_fp";let Hc;if(tf.trim()!=="")Hc=new uu(tf),console.info("[Firebase App Check: PROD] Initializing with ReCAPTCHA Enterprise (invisible mode).");else throw console.error("[Firebase App Check: PROD] VITE_RECAPTCHA_ENTERPRISE_SITE_KEY is missing or empty. App Check will NOT be initialized, leaving Firebase services unprotected!"),new Error("Firebase App Check configuration missing in production.");if(Hc)try{IR(ta,{provider:Hc,isTokenAutoRefreshEnabled:!0})}catch(t){console.error("[Firebase App Check] initializeAppCheck call failed:",t)}const I=Rm(ta),it=[];function An(t,e,n,i=null,s=null,r=null){e==="value"?ru(t,n):e==="child_added"?Di(t,n):e==="child_removed"?Im(t,n):console.warn(`Unknown listener type: ${e}`),it.push({ref:t,type:e,callback:n,roomId:i,userId:s,category:r})}function OR(){it.forEach(({ref:t,type:e,callback:n})=>{try{Ot(t,e,n)}catch(i){console.warn("Failed to remove firebase rtdb listener",i)}}),it.length=0}function na(t){if(!t)return;it.filter(i=>i.roomId===t).forEach(({ref:i,type:s,callback:r})=>{try{Ot(i,s,r)}catch(o){console.warn(`Failed to remove listener for room ${t}`,o)}});const n=it.filter(i=>i.roomId!==t);it.length=0,it.push(...n)}function LR(t,e){if(!t||!e)return;const n=r=>r.userId===t&&r.roomId===e;it.filter(n).forEach(({ref:r,type:o,callback:a})=>{try{Ot(r,o,a)}catch(c){console.warn(`Failed to remove listener for user ${t} in room ${e}`,c)}});const s=it.filter(r=>!n(r));it.length=0,it.push(...s)}function ys(t,e,n=null){An(t,"value",e,n)}const En=t=>S(I,`rooms/${t}`),yr=t=>S(I,`rooms/${t}/members`),nf=(t,e)=>S(I,`rooms/${t}/members/${e}`),DR=t=>S(I,`rooms/${t}/cancellation`),ia=t=>S(I,`rooms/${t}/watch`),sa=t=>S(I,`rooms/${t}/watch/fileRequest`),MR=t=>S(I,`users/${t}/recentCalls`),du=(t,e)=>S(I,`users/${t}/recentCalls/${e}`),hu=t=>S(I,`users/${t}/outgoingCall`),Wm=t=>S(I,`rooms/${t}/offerCandidates`),jm=t=>S(I,`rooms/${t}/answerCandidates`);function qm(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const xR=qm,zm=new mn("auth","Firebase",qm());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const WR=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],jR=new rr(3e4,6e4);function mu(t,e){return t.tenantId&&!e.tenantId?{...e,tenantId:t.tenantId}:e}async function Yi(t,e,n,i,s={}){return Km(t,s,async()=>{let r={},o={};i&&(e==="GET"?o=i:r={body:JSON.stringify(i)});const a=Wi({key:t.config.apiKey,...o}).slice(1),c=await t._getAdditionalHeaders();c["Content-Type"]="application/json",t.languageCode&&(c["X-Firebase-Locale"]=t.languageCode);const l={method:e,headers:c,...r};return lT()||(l.referrerPolicy="no-referrer"),t.emulatorConfig&&Vi(t.emulatorConfig.host)&&(l.credentials="include"),Gm.fetch()(await Ym(t,t.config.apiHost,n,a),l)})}async function Km(t,e,n){t._canInitEmulator=!1;const i={...VR,...e};try{const s=new zR(t),r=await Promise.race([n(),s.promise]);s.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw wr(t,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw wr(t,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw wr(t,"email-already-in-use",o);if(c==="USER_DISABLED")throw wr(t,"user-disabled",o);const u=i[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw fu(t,u,l);yt(t,u)}}catch(s){if(s instanceof $t)throw s;yt(t,"network-request-failed",{message:String(s)})}}async function qR(t,e,n,i,s={}){const r=await Yi(t,e,n,i,s);return"mfaPendingCredential"in r&&yt(t,"multi-factor-auth-required",{_serverResponse:r}),r}async function Ym(t,e,n,i){const s=`${e}${n}?${i}`,r=t,o=r.config.emulator?gu(t.config,s):`${t.config.apiScheme}://${s}`;return WR.includes(n)&&(await r._persistenceManagerAvailable,r._getPersistenceType()==="COOKIE")?r._getPersistence()._getFinalTarget(o).toString():o}class zR{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,i)=>{this.timer=setTimeout(()=>i(at(this.auth,"network-request-failed")),jR.get())})}}function wr(t,e,n){const i={appName:t.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const s=at(t,e,i);return s.customData._tokenResponse=n,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function u_(t,e,n=!1){if(et(t.app))return Promise.reject(Mn(t));const i="signIn",s=await l_(t,i,e),r=await Mi._fromIdTokenResponse(t,i,s);return n||await t._updateCurrentUser(r.user),r}async function vN(t,e){return u_(Ji(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Va(t,e){return ne(t).setPersistence(e)}function bN(t,e,n,i){return ne(t).onIdTokenChanged(e,n,i)}function EN(t,e,n){return ne(t).beforeAuthStateChanged(e,n)}function d_(t,e,n,i){return ne(t).onAuthStateChanged(e,n,i)}function CN(t){return ne(t).signOut()}const uo="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const VN="pendingRedirect",Or=new Map;class WN extends C_{constructor(e,n,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,i),this.eventId=null}async execute(){let e=Or.get(this.auth._key());if(!e){try{const i=await jN(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(n){e=()=>Promise.reject(n)}Or.set(this.auth._key(),e)}return this.bypassAuthState||Or.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function jN(t,e){const n=GN(e),i=zN(t);if(!await i._isAvailable())return!1;const s=await i._get(n)==="true";return await i._remove(n),s}function qN(t,e){Or.set(t._key(),e)}function zN(t){return St(t._redirectPersistence)}function GN(t){return Pr(VN,t.config.apiKey,t.name)}async function KN(t,e){return await Ji(t)._initializationPromise,T_(t,e,!1)}async function T_(t,e,n=!1){if(et(t.app))return Promise.reject(Mn(t));const i=Ji(t),s=E_(i,e),o=await new WN(i,s,n).execute();return o&&!n&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iP=new rr(3e4,6e4);function pf(){const t=_t().___jsl;if(t?.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function sP(t){return new Promise((e,n)=>{function i(){pf(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{pf(),n(at(t,"network-request-failed"))},timeout:iP.get()})}if(_t().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(_t().gapi?.load)i();else{const s=dN("iframefcb");return _t()[s]=()=>{gapi.load?i():n(at(t,"network-request-failed"))},lN(`${uN()}?onload=${s}`).catch(r=>n(r))}}).catch(e=>{throw Lr=null,e})}let Lr=null;function rP(t){return Lr=Lr||sP(t),Lr}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vP="__/auth/handler",bP="emulator/auth/handler",EP=encodeURIComponent("fac");async function mf(t,e,n,i,s,r){T(t.config.authDomain,t,"auth-domain-config-required"),T(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:i,v:ji,eventId:s};if(e instanceof vu){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",Wr(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,d]of Object.entries({}))o[u]=d}if(e instanceof or){const u=e.getScopes().filter(d=>d!=="");u.length>0&&(o.scopes=u.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const c=await t._getAppCheckToken(),l=c?`#${EP}=${encodeURIComponent(c)}`:"";return`${CP(t)}?${Wi(a).slice(1)}${l}`}function CP({config:t}){return t.emulator?gu(t,bP):`https://${t.authDomain}/${vP}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KL=10080*60*1e3;async function YL(t){const e=await QL(t.swRegistration,t.vapidKey),n={vapidKey:t.vapidKey,swScope:t.swRegistration.scope,endpoint:e.endpoint,auth:bt(e.getKey("auth")),p256dh:bt(e.getKey("p256dh"))},i=await Hy(t.firebaseDependencies);if(i){if(ZL(i.subscriptionOptions,n))return Date.now()>=i.createTime+KL?XL(t,{token:i.token,createTime:Date.now(),subscriptionOptions:n}):i.token;try{await Vy(t.firebaseDependencies,i.token)}catch(s){console.warn(s)}return Hf(t.firebaseDependencies,n)}else return Hf(t.firebaseDependencies,n)}async function JL(t){const e=await Hy(t.firebaseDependencies);e&&(await Vy(t.firebaseDependencies,e.token),await jL(t.firebaseDependencies));const n=await t.swRegistration.pushManager.getSubscription();return n?n.unsubscribe():!0}async function XL(t,e){try{const n=await GL(t.firebaseDependencies,e),i={...e,token:n,createTime:Date.now()};return await Ju(t.firebaseDependencies,i),n}catch(n){throw n}}async function Hf(t,e){const i={token:await zL(t,e),createTime:Date.now(),subscriptionOptions:e};return await Ju(t,i),i.token}async function QL(t,e){const n=await t.pushManager.getSubscription();return n||t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:UL(e)})}function ZL(t,e){const n=e.vapidKey===t.vapidKey,i=e.endpoint===t.endpoint,s=e.auth===t.auth,r=e.p256dh===t.p256dh;return n&&i&&s&&r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hD=t=>{const e=new rD(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>dD(e,n)),e},fD=t=>{const e=t.getProvider("messaging").getImmediate();return{getToken:i=>qy(e,i)}};function pD(){Je(new He("messaging",hD,"PUBLIC")),Je(new He("messaging-internal",fD,"PRIVATE")),Be(Wf,jf),Be(Wf,jf,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
