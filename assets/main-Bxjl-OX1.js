 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tf=function(t){let e={},n={},i={},r="";try{const s=t.split(".");e=Fi(qr(s[0])||""),n=Fi(qr(s[1])||""),r=s[2],i=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:i,signature:r}},pw=function(t){const e=tf(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},gw=function(t){const e=tf(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function le(t){return t&&t._delegate?t._delegate:t}class pt{constructor(e,n,i){this.name=e,this.instanceFactory=n,this.type=i,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ni=Eb;function sf(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i={name:Qo,automaticDataCollectionEnabled:!0,...e},r=i.name;if(typeof r!="string"||!r)throw Nt.create("bad-app-name",{appName:String(r)});if(n||(n=Jh()),!n)throw Nt.create("no-options");const s=Kr.get(r);if(s){if(cn(n,s.options)&&cn(i,s.config))return s;throw Nt.create("duplicate-app",{appName:r})}const o=new Aw(r);for(const c of Zo.values())o.addComponent(c);const a=new Sb(n,i,o);return Kr.set(r,a),a}function Xa(t=Qo){const e=Kr.get(t);if(!e&&t===Qo&&Jh())return sf();if(!e)throw Nt.create("no-app",{appName:t});return e}function ut(t,e,n){let i=vb[t]??t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),s=e.match(/\s|\//);if(r||s){const o=[`Unable to register library "${i}" with version "${e}":`];r&&o.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&s&&o.push("and"),s&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),gt.warn(o.join(" "));return}Ft(new pt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xb{constructor(e,n,i){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=i,this.auth_=null,this.auth_=i.getImmediate({optional:!0}),this.auth_||i.onInit(r=>this.auth_=r)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(se("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,i)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,i):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',me(e)}}class Or{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}Or.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fS=16384,pS=45e3;let Jr=null;typeof MozWebSocket<"u"?Jr=MozWebSocket:typeof WebSocket<"u"&&(Jr=WebSocket);class De{constructor(e,n,i,r,s,o,a){this.connId=e,this.applicationId=i,this.appCheckToken=r,this.authToken=s,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=sr(this.connId),this.stats_=tc(n),this.connURL=De.connectionURL_(n,o,a,r,i),this.nodeAdmin=n.nodeAdmin}static connectionURL_(e,n,i,r,s){const o={};return o[ff]=ec,typeof location<"u"&&location.hostname&&_f.test(location.hostname)&&(o[gf]=mf),n&&(o[pf]=n),i&&(o[yf]=i),r&&(o[ta]=r),s&&(o[Ef]=s),Sf(e,vf,o)}open(e,n){this.onDisconnect=n,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Zt.set("previous_websocket_failure",!0);try{let i;lw(),this.mySock=new Jr(this.connURL,[],i)}catch(i){this.log_("Error instantiating WebSocket.");const r=i.message||i.data;r&&this.log_(r),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=i=>{this.handleIncomingFrame(i)},this.mySock.onerror=i=>{this.log_("WebSocket error.  Closing connection.");const r=i.message||i.data;r&&this.log_(r),this.onClosed_()}}start(){}static forceDisallow(){De.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator<"u"&&navigator.userAgent){const n=/Android ([0-9]{0,}\.[0-9]{0,})/,i=navigator.userAgent.match(n);i&&i.length>1&&parseFloat(i[1])<4.4&&(e=!0)}return!e&&Jr!==null&&!De.forceDisallow_}static previouslyFailed(){return Zt.isInMemoryStorage||Zt.get("previous_websocket_failure")===!0}markConnectionHealthy(){Zt.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const n=this.frames.join("");this.frames=null;const i=Fi(n);this.onMessage(i)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(g(this.frames===null,"We already have a frame buffer"),e.length<=6){const n=Number(e);if(!isNaN(n))return this.handleNewFrameCount_(n),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const n=e.data;if(this.bytesReceived+=n.length,this.stats_.incrementCounter("bytes_received",n.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(n);else{const i=this.extractFrameCount_(n);i!==null&&this.appendFrame_(i)}}send(e){this.resetKeepAlive();const n=ee(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const i=df(n,fS);i.length>1&&this.sendString_(String(i.length));for(let r=0;r<i.length;r++)this.sendString_(i[r])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(pS))}sendString_(e){try{this.mySock.send(e)}catch(n){this.log_("Exception thrown from WebSocket.send():",n.message||n.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}De.responsesRequiredToBeHealthy=2;De.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xr extends Pf{static getInstance(){return new Xr}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Ya()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return g(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let wr;class Of extends Ls{static get __EMPTY_NODE(){return wr}static set __EMPTY_NODE(e){wr=e}compare(e,n){return mn(e.name,n.name)}isDefinedOn(e){throw Qn("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,n){return!1}minPost(){return k.MIN}maxPost(){return new k(ln,wr)}makePost(e,n){return g(typeof e=="string","KeyIndex indexValue must always be a string."),new k(e,wr)}toString(){return".key"}}const Sn=new Of;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Gu;class ne{static set __childrenNodeConstructor(e){Gu=e}static get __childrenNodeConstructor(){return Gu}constructor(e,n=ne.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=n,this.lazyHash_=null,g(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),Mf(this.priorityNode_)}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new ne(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:ne.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return A(e)?this:I(e)===".priority"?this.priorityNode_:ne.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,n){return null}updateImmediateChild(e,n){return e===".priority"?this.updatePriority(n):n.isEmpty()&&e!==".priority"?this:ne.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,n).updatePriority(this.priorityNode_)}updateChild(e,n){const i=I(e);return i===null?n:n.isEmpty()&&i!==".priority"?this:(g(i!==".priority"||Ut(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(i,ne.__childrenNodeConstructor.EMPTY_NODE.updateChild(U(e),n)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,n){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+Df(this.priorityNode_.val())+":");const n=typeof this.value_;e+=n+":",n==="number"?e+=hf(this.value_):e+=this.value_,this.lazyHash_=uf(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===ne.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof ne.__childrenNodeConstructor?-1:(g(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const n=typeof e.value_,i=typeof this.value_,r=ne.VALUE_TYPE_ORDER.indexOf(n),s=ne.VALUE_TYPE_ORDER.indexOf(i);return g(r>=0,"Unknown leaf type: "+n),g(s>=0,"Unknown leaf type: "+i),r===s?i==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:s-r}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const n=e;return this.value_===n.value_&&this.priorityNode_.equals(n.priorityNode_)}else return!1}}ne.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const US=Math.log(2);class $S{constructor(e){const n=s=>parseInt(Math.log(s)/US,10),i=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const r=i(this.count);this.bits_=e+1&r}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Qr=function(t,e,n,i){t.sort(e);const r=function(c,l){const u=l-c;let d,h;if(u===0)return null;if(u===1)return d=t[c],h=n?n(d):d,new ie(h,d.node,ie.BLACK,null,null);{const f=parseInt(u/2,10)+c,p=r(c,f),y=r(f+1,l);return d=t[f],h=n?n(d):d,new ie(h,d.node,ie.BLACK,p,y)}},s=function(c){let l=null,u=null,d=t.length;const h=function(p,y){const m=d-p,T=d;d-=p;const $=r(m+1,T),W=t[m],w=n?n(W):W;f(new ie(w,W.node,y,null,$))},f=function(p){l?(l.left=p,l=p):(u=p,l=p)};for(let p=0;p<c.count;++p){const y=c.nextBitIsOne(),m=Math.pow(2,c.count-(p+1));y?h(m,ie.BLACK):(h(m,ie.BLACK),h(m,ie.RED))}return u},o=new $S(t.length),a=s(o);return new Ee(i||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let yo;const yn={};class nt{static get Default(){return g(yn&&K,"ChildrenNode.ts has not been loaded"),yo=yo||new nt({".priority":yn},{".priority":K}),yo}constructor(e,n){this.indexes_=e,this.indexSet_=n}get(e){const n=Fn(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof Ee?n:null}hasIndex(e){return Je(this.indexSet_,e.toString())}addIndex(e,n){g(e!==Sn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let r=!1;const s=n.getIterator(k.Wrap);let o=s.getNext();for(;o;)r=r||e.isDefinedOn(o.node),i.push(o),o=s.getNext();let a;r?a=Qr(i,e.getCompare()):a=yn;const c=e.toString(),l={...this.indexSet_};l[c]=e;const u={...this.indexes_};return u[c]=a,new nt(u,l)}addToIndexes(e,n){const i=Yr(this.indexes_,(r,s)=>{const o=Fn(this.indexSet_,s);if(g(o,"Missing index implementation for "+s),r===yn)if(o.isDefinedOn(e.node)){const a=[],c=n.getIterator(k.Wrap);let l=c.getNext();for(;l;)l.name!==e.name&&a.push(l),l=c.getNext();return a.push(e),Qr(a,o.getCompare())}else return yn;else{const a=n.get(e.name);let c=r;return a&&(c=c.remove(new k(e.name,a))),c.insert(e,e.node)}});return new nt(i,this.indexSet_)}removeFromIndexes(e,n){const i=Yr(this.indexes_,r=>{if(r===yn)return r;{const s=n.get(e.name);return s?r.remove(new k(e.name,s)):r}});return new nt(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HS=!0;function Z(t,e=null){if(t===null)return v.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),g(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new ne(n,Z(e))}if(!(t instanceof Array)&&HS){const n=[];let i=!1;if(ce(t,(o,a)=>{if(o.substring(0,1)!=="."){const c=Z(a);c.isEmpty()||(i=i||!c.getPriority().isEmpty(),n.push(new k(o,c)))}}),n.length===0)return v.EMPTY_NODE;const s=Qr(n,OS,o=>o.name,oc);if(i){const o=Qr(n,K.getCompare());return new v(s,Z(e),new nt({".priority":o},{".priority":K}))}else return new v(s,Z(e),nt.Default)}else{let n=v.EMPTY_NODE;return ce(t,(i,r)=>{if(Je(t,i)&&i.substring(0,1)!=="."){const s=Z(r);(s.isLeafNode()||!s.isEmpty())&&(n=n.updateImmediateChild(i,s))}}),n.updatePriority(Z(e))}}MS(Z);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class WS extends Ls{constructor(e){super(),this.indexPath_=e,g(!A(e)&&I(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,n){const i=this.extractChild(e.node),r=this.extractChild(n.node),s=i.compareTo(r);return s===0?mn(e.name,n.name):s}makePost(e,n){const i=Z(e),r=v.EMPTY_NODE.updateChild(this.indexPath_,i);return new k(n,r)}maxPost(){const e=v.EMPTY_NODE.updateChild(this.indexPath_,or);return new k(ln,e)}toString(){return Bi(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VS extends Ls{compare(e,n){const i=e.node.compareTo(n.node);return i===0?mn(e.name,n.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return k.MIN}maxPost(){return k.MAX}makePost(e,n){const i=Z(e);return new k(n,i)}toString(){return".value"}}const jS=new VS;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ac{constructor(e){this.index_=e}updateChild(e,n,i,r,s,o){g(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(n);return a.getChild(r).equals(i.getChild(r))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(n)?o.trackChildChange(Hi(n,a)):g(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange($n(n,i)):o.trackChildChange(Wi(n,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(n,i).withIndex(this.index_)}updateFullNode(e,n,i){return i!=null&&(e.isLeafNode()||e.forEachChild(K,(r,s)=>{n.hasChild(r)||i.trackChildChange(Hi(r,s))}),n.isLeafNode()||n.forEachChild(K,(r,s)=>{if(e.hasChild(r)){const o=e.getImmediateChild(r);o.equals(s)||i.trackChildChange(Wi(r,s,o))}else i.trackChildChange($n(r,s))})),n.withIndex(this.index_)}updatePriority(e,n){return e.isEmpty()?v.EMPTY_NODE:e.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cc{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=K}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return g(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return g(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:Un}hasEnd(){return this.endSet_}getIndexEndValue(){return g(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return g(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:ln}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return g(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===K}copy(){const e=new cc;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function qS(t){return t.loadsAllData()?new ac(t.getIndex()):t.hasLimit()?new GS(t):new Vi(t)}function qu(t){const e={};if(t.isDefault())return e;let n;if(t.index_===K?n="$priority":t.index_===jS?n="$value":t.index_===Sn?n="$key":(g(t.index_ instanceof WS,"Unrecognized index type!"),n=t.index_.toString()),e.orderBy=ee(n),t.startSet_){const i=t.startAfterSet_?"startAfter":"startAt";e[i]=ee(t.indexStartValue_),t.startNameSet_&&(e[i]+=","+ee(t.indexStartName_))}if(t.endSet_){const i=t.endBeforeSet_?"endBefore":"endAt";e[i]=ee(t.indexEndValue_),t.endNameSet_&&(e[i]+=","+ee(t.indexEndName_))}return t.limitSet_&&(t.isViewFromLeft()?e.limitToFirst=t.limit_:e.limitToLast=t.limit_),e}function Yu(t){const e={};if(t.startSet_&&(e.sp=t.indexStartValue_,t.startNameSet_&&(e.sn=t.indexStartName_),e.sin=!t.startAfterSet_),t.endSet_&&(e.ep=t.indexEndValue_,t.endNameSet_&&(e.en=t.indexEndName_),e.ein=!t.endBeforeSet_),t.limitSet_){e.l=t.limit_;let n=t.viewFrom_;n===""&&(t.isViewFromLeft()?n="l":n="r"),e.vf=n}return t.index_!==K&&(e.i=t.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function es(){return{value:null,children:new Map}}function $f(t,e,n){if(A(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const i=I(e);t.children.has(i)||t.children.set(i,es());const r=t.children.get(i);e=U(e),$f(r,e,n)}}function ia(t,e,n){t.value!==null?n(e,t.value):KS(t,(i,r)=>{const s=new D(e.toString()+"/"+i);ia(r,s,n)})}function KS(t,e){t.children.forEach((n,i)=>{e(i,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class JS{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n={...e};return this.last_&&ce(this.last_,(i,r)=>{n[i]=n[i]-r}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ts{constructor(e,n,i){this.path=e,this.affectedTree=n,this.revert=i,this.type=Me.ACK_USER_WRITE,this.source=lc()}operationForChild(e){if(A(this.path)){if(this.affectedTree.value!=null)return g(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new D(e));return new ts(N(),n,this.revert)}}else return g(I(this.path)===e,"operationForChild called for unrelated child."),new ts(U(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ji{constructor(e,n){this.source=e,this.path=n,this.type=Me.LISTEN_COMPLETE}operationForChild(e){return A(this.path)?new ji(this.source,N()):new ji(this.source,U(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class un{constructor(e,n,i){this.source=e,this.path=n,this.snap=i,this.type=Me.OVERWRITE}operationForChild(e){return A(this.path)?new un(this.source,N(),this.snap.getImmediateChild(e)):new un(this.source,U(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bn{constructor(e,n,i){this.source=e,this.path=n,this.children=i,this.type=Me.MERGE}operationForChild(e){if(A(this.path)){const n=this.children.subtree(new D(e));return n.isEmpty()?null:n.value?new un(this.source,N(),n.value):new Bn(this.source,N(),n)}else return g(I(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Bn(this.source,U(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Os(t,e){return{eventCache:t,serverCache:e}}function Ci(t,e,n,i){return Os(new $t(e,n,i),t.serverCache)}function Bf(t,e,n,i){return Os(t.eventCache,new $t(e,n,i))}function ns(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function dn(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Eo;const rC=()=>(Eo||(Eo=new Ee(Wb)),Eo);class x{static fromObject(e){let n=new x(null);return ce(e,(i,r)=>{n=n.set(new D(i),r)}),n}constructor(e,n=rC()){this.value=e,this.children=n}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,n){if(this.value!=null&&n(this.value))return{path:N(),value:this.value};if(A(e))return null;{const i=I(e),r=this.children.get(i);if(r!==null){const s=r.findRootMostMatchingPathAndValue(U(e),n);return s!=null?{path:Y(new D(i),s.path),value:s.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(A(e))return this;{const n=I(e),i=this.children.get(n);return i!==null?i.subtree(U(e)):new x(null)}}set(e,n){if(A(e))return new x(n,this.children);{const i=I(e),s=(this.children.get(i)||new x(null)).set(U(e),n),o=this.children.insert(i,s);return new x(this.value,o)}}remove(e){if(A(e))return this.children.isEmpty()?new x(null):new x(null,this.children);{const n=I(e),i=this.children.get(n);if(i){const r=i.remove(U(e));let s;return r.isEmpty()?s=this.children.remove(n):s=this.children.insert(n,r),this.value===null&&s.isEmpty()?new x(null):new x(this.value,s)}else return this}}get(e){if(A(e))return this.value;{const n=I(e),i=this.children.get(n);return i?i.get(U(e)):null}}setTree(e,n){if(A(e))return n;{const i=I(e),s=(this.children.get(i)||new x(null)).setTree(U(e),n);let o;return s.isEmpty()?o=this.children.remove(i):o=this.children.insert(i,s),new x(this.value,o)}}fold(e){return this.fold_(N(),e)}fold_(e,n){const i={};return this.children.inorderTraversal((r,s)=>{i[r]=s.fold_(Y(e,r),n)}),n(e,this.value,i)}findOnPath(e,n){return this.findOnPath_(e,N(),n)}findOnPath_(e,n,i){const r=this.value?i(n,this.value):!1;if(r)return r;if(A(e))return null;{const s=I(e),o=this.children.get(s);return o?o.findOnPath_(U(e),Y(n,s),i):null}}foreachOnPath(e,n){return this.foreachOnPath_(e,N(),n)}foreachOnPath_(e,n,i){if(A(e))return this;{this.value&&i(n,this.value);const r=I(e),s=this.children.get(r);return s?s.foreachOnPath_(U(e),Y(n,r),i):new x(null)}}foreach(e){this.foreach_(N(),e)}foreach_(e,n){this.children.inorderTraversal((i,r)=>{r.foreach_(Y(e,i),n)}),this.value&&n(e,this.value)}foreachChild(e){this.children.inorderTraversal((n,i)=>{i.value&&e(n,i.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $e{constructor(e){this.writeTree_=e}static empty(){return new $e(new x(null))}}function Ti(t,e,n){if(A(e))return new $e(new x(n));{const i=t.writeTree_.findRootMostValueAndPath(e);if(i!=null){const r=i.path;let s=i.value;const o=ge(r,e);return s=s.updateChild(o,n),new $e(t.writeTree_.set(r,s))}else{const r=new x(n),s=t.writeTree_.setTree(e,r);return new $e(s)}}}function ra(t,e,n){let i=t;return ce(n,(r,s)=>{i=Ti(i,Y(e,r),s)}),i}function Ju(t,e){if(A(e))return $e.empty();{const n=t.writeTree_.setTree(e,new x(null));return new $e(n)}}function sa(t,e){return _n(t,e)!=null}function _n(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(ge(n.path,e)):null}function Xu(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(K,(i,r)=>{e.push(new k(i,r))}):t.writeTree_.children.inorderTraversal((i,r)=>{r.value!=null&&e.push(new k(i,r.value))}),e}function Lt(t,e){if(A(e))return t;{const n=_n(t,e);return n!=null?new $e(new x(n)):new $e(t.writeTree_.subtree(e))}}function oa(t){return t.writeTree_.isEmpty()}function Hn(t,e){return Hf(N(),t.writeTree_,e)}function Hf(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let i=null;return e.children.inorderTraversal((r,s)=>{r===".priority"?(g(s.value!==null,"Priority writes must always be leaf nodes"),i=s.value):n=Hf(Y(t,r),s,n)}),!n.getChild(t).isEmpty()&&i!==null&&(n=n.updateChild(Y(t,".priority"),i)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ds(t,e){return zf(e,t)}function sC(t,e,n,i,r){g(i>t.lastWriteId,"Stacking an older write on top of newer ones"),r===void 0&&(r=!0),t.allWrites.push({path:e,snap:n,writeId:i,visible:r}),r&&(t.visibleWrites=Ti(t.visibleWrites,e,n)),t.lastWriteId=i}function oC(t,e,n,i){g(i>t.lastWriteId,"Stacking an older merge on top of newer ones"),t.allWrites.push({path:e,children:n,writeId:i,visible:!0}),t.visibleWrites=ra(t.visibleWrites,e,n),t.lastWriteId=i}function aC(t,e){for(let n=0;n<t.allWrites.length;n++){const i=t.allWrites[n];if(i.writeId===e)return i}return null}function cC(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);g(n>=0,"removeWrite called with nonexistent writeId.");const i=t.allWrites[n];t.allWrites.splice(n,1);let r=i.visible,s=!1,o=t.allWrites.length-1;for(;r&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&lC(a,i.path)?r=!1:Ie(i.path,a.path)&&(s=!0)),o--}if(r){if(s)return uC(t),!0;if(i.snap)t.visibleWrites=Ju(t.visibleWrites,i.path);else{const a=i.children;ce(a,c=>{t.visibleWrites=Ju(t.visibleWrites,Y(i.path,c))})}return!0}else return!1}function lC(t,e){if(t.snap)return Ie(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Ie(Y(t.path,n),e))return!0;return!1}function uC(t){t.visibleWrites=Wf(t.allWrites,dC,N()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function dC(t){return t.visible}function Wf(t,e,n){let i=$e.empty();for(let r=0;r<t.length;++r){const s=t[r];if(e(s)){const o=s.path;let a;if(s.snap)Ie(n,o)?(a=ge(n,o),i=Ti(i,a,s.snap)):Ie(o,n)&&(a=ge(o,n),i=Ti(i,N(),s.snap.getChild(a)));else if(s.children){if(Ie(n,o))a=ge(n,o),i=ra(i,a,s.children);else if(Ie(o,n))if(a=ge(o,n),A(a))i=ra(i,N(),s.children);else{const c=Fn(s.children,I(a));if(c){const l=c.getChild(U(a));i=Ti(i,N(),l)}}}else throw Qn("WriteRecord should have .snap or .children")}}return i}function Vf(t,e,n,i,r){if(!i&&!r){const s=_n(t.visibleWrites,e);if(s!=null)return s;{const o=Lt(t.visibleWrites,e);if(oa(o))return n;if(n==null&&!sa(o,N()))return null;{const a=n||v.EMPTY_NODE;return Hn(o,a)}}}else{const s=Lt(t.visibleWrites,e);if(!r&&oa(s))return n;if(!r&&n==null&&!sa(s,N()))return null;{const o=function(l){return(l.visible||r)&&(!i||!~i.indexOf(l.writeId))&&(Ie(l.path,e)||Ie(e,l.path))},a=Wf(t.allWrites,o,e),c=n||v.EMPTY_NODE;return Hn(a,c)}}}function hC(t,e,n){let i=v.EMPTY_NODE;const r=_n(t.visibleWrites,e);if(r)return r.isLeafNode()||r.forEachChild(K,(s,o)=>{i=i.updateImmediateChild(s,o)}),i;if(n){const s=Lt(t.visibleWrites,e);return n.forEachChild(K,(o,a)=>{const c=Hn(Lt(s,new D(o)),a);i=i.updateImmediateChild(o,c)}),Xu(s).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const s=Lt(t.visibleWrites,e);return Xu(s).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function fC(t,e,n,i,r){g(i||r,"Either existingEventSnap or existingServerSnap must exist");const s=Y(e,n);if(sa(t.visibleWrites,s))return null;{const o=Lt(t.visibleWrites,s);return oa(o)?r.getChild(n):Hn(o,r.getChild(n))}}function pC(t,e,n,i){const r=Y(e,n),s=_n(t.visibleWrites,r);if(s!=null)return s;if(i.isCompleteForChild(n)){const o=Lt(t.visibleWrites,r);return Hn(o,i.getNode().getImmediateChild(n))}else return null}function gC(t,e){return _n(t.visibleWrites,e)}function mC(t,e,n,i,r,s,o){let a;const c=Lt(t.visibleWrites,e),l=_n(c,N());if(l!=null)a=l;else if(n!=null)a=Hn(c,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],d=o.getCompare(),h=s?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let f=h.getNext();for(;f&&u.length<r;)d(f,i)!==0&&u.push(f),f=h.getNext();return u}else return[]}function _C(){return{visibleWrites:$e.empty(),allWrites:[],lastWriteId:-1}}function is(t,e,n,i){return Vf(t.writeTree,t.treePath,e,n,i)}function hc(t,e){return hC(t.writeTree,t.treePath,e)}function Qu(t,e,n,i){return fC(t.writeTree,t.treePath,e,n,i)}function rs(t,e){return gC(t.writeTree,Y(t.treePath,e))}function yC(t,e,n,i,r,s){return mC(t.writeTree,t.treePath,e,n,i,r,s)}function fc(t,e,n){return pC(t.writeTree,t.treePath,e,n)}function jf(t,e){return zf(Y(t.treePath,e),t.writeTree)}function zf(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wC(t){return{filter:t}}function bC(t,e){g(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),g(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function SC(t,e,n,i,r){const s=new EC;let o,a;if(n.type===Me.OVERWRITE){const l=n;l.source.fromUser?o=aa(t,e,l.path,l.snap,i,r,s):(g(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered()&&!A(l.path),o=ss(t,e,l.path,l.snap,i,r,a,s))}else if(n.type===Me.MERGE){const l=n;l.source.fromUser?o=TC(t,e,l.path,l.children,i,r,s):(g(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered(),o=ca(t,e,l.path,l.children,i,r,a,s))}else if(n.type===Me.ACK_USER_WRITE){const l=n;l.revert?o=RC(t,e,l.path,i,r,s):o=IC(t,e,l.path,l.affectedTree,i,r,s)}else if(n.type===Me.LISTEN_COMPLETE)o=kC(t,e,n.path,i,s);else throw Qn("Unknown operation type: "+n.type);const c=s.getChanges();return CC(e,o,c),{viewCache:o,changes:c}}function CC(t,e,n){const i=e.eventCache;if(i.isFullyInitialized()){const r=i.getNode().isLeafNode()||i.getNode().isEmpty(),s=ns(t);(n.length>0||!t.eventCache.isFullyInitialized()||r&&!i.getNode().equals(s)||!i.getNode().getPriority().equals(s.getPriority()))&&n.push(Uf(ns(e)))}}function qf(t,e,n,i,r,s){const o=e.eventCache;if(rs(i,n)!=null)return e;{let a,c;if(A(n))if(g(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const l=dn(e),u=l instanceof v?l:v.EMPTY_NODE,d=hc(i,u);a=t.filter.updateFullNode(e.eventCache.getNode(),d,s)}else{const l=is(i,dn(e));a=t.filter.updateFullNode(e.eventCache.getNode(),l,s)}else{const l=I(n);if(l===".priority"){g(Ut(n)===1,"Can't have a priority with additional path components");const u=o.getNode();c=e.serverCache.getNode();const d=Qu(i,n,u,c);d!=null?a=t.filter.updatePriority(u,d):a=o.getNode()}else{const u=U(n);let d;if(o.isCompleteForChild(l)){c=e.serverCache.getNode();const h=Qu(i,n,o.getNode(),c);h!=null?d=o.getNode().getImmediateChild(l).updateChild(u,h):d=o.getNode().getImmediateChild(l)}else d=fc(i,l,e.serverCache);d!=null?a=t.filter.updateChild(o.getNode(),l,d,u,r,s):a=o.getNode()}}return Ci(e,a,o.isFullyInitialized()||A(n),t.filter.filtersNodes())}}function ss(t,e,n,i,r,s,o,a){const c=e.serverCache;let l;const u=o?t.filter:t.filter.getIndexedFilter();if(A(n))l=u.updateFullNode(c.getNode(),i,null);else if(u.filtersNodes()&&!c.isFiltered()){const f=c.getNode().updateChild(n,i);l=u.updateFullNode(c.getNode(),f,null)}else{const f=I(n);if(!c.isCompleteForPath(n)&&Ut(n)>1)return e;const p=U(n),m=c.getNode().getImmediateChild(f).updateChild(p,i);f===".priority"?l=u.updatePriority(c.getNode(),m):l=u.updateChild(c.getNode(),f,m,p,Gf,null)}const d=Bf(e,l,c.isFullyInitialized()||A(n),u.filtersNodes()),h=new pc(r,d,s);return qf(t,d,n,r,h,a)}function aa(t,e,n,i,r,s,o){const a=e.eventCache;let c,l;const u=new pc(r,e,s);if(A(n))l=t.filter.updateFullNode(e.eventCache.getNode(),i,o),c=Ci(e,l,!0,t.filter.filtersNodes());else{const d=I(n);if(d===".priority")l=t.filter.updatePriority(e.eventCache.getNode(),i),c=Ci(e,l,a.isFullyInitialized(),a.isFiltered());else{const h=U(n),f=a.getNode().getImmediateChild(d);let p;if(A(h))p=i;else{const y=u.getCompleteChild(d);y!=null?ic(h)===".priority"&&y.getChild(Nf(h)).isEmpty()?p=y:p=y.updateChild(h,i):p=v.EMPTY_NODE}if(f.equals(p))c=e;else{const y=t.filter.updateChild(a.getNode(),d,p,h,u,o);c=Ci(e,y,a.isFullyInitialized(),t.filter.filtersNodes())}}}return c}function Zu(t,e){return t.eventCache.isCompleteForChild(e)}function TC(t,e,n,i,r,s,o){let a=e;return i.foreach((c,l)=>{const u=Y(n,c);Zu(e,I(u))&&(a=aa(t,a,u,l,r,s,o))}),i.foreach((c,l)=>{const u=Y(n,c);Zu(e,I(u))||(a=aa(t,a,u,l,r,s,o))}),a}function ed(t,e,n){return n.foreach((i,r)=>{e=e.updateChild(i,r)}),e}function ca(t,e,n,i,r,s,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let c=e,l;A(n)?l=i:l=new x(null).setTree(n,i);const u=e.serverCache.getNode();return l.children.inorderTraversal((d,h)=>{if(u.hasChild(d)){const f=e.serverCache.getNode().getImmediateChild(d),p=ed(t,f,h);c=ss(t,c,new D(d),p,r,s,o,a)}}),l.children.inorderTraversal((d,h)=>{const f=!e.serverCache.isCompleteForChild(d)&&h.value===null;if(!u.hasChild(d)&&!f){const p=e.serverCache.getNode().getImmediateChild(d),y=ed(t,p,h);c=ss(t,c,new D(d),y,r,s,o,a)}}),c}function IC(t,e,n,i,r,s,o){if(rs(r,n)!=null)return e;const a=e.serverCache.isFiltered(),c=e.serverCache;if(i.value!=null){if(A(n)&&c.isFullyInitialized()||c.isCompleteForPath(n))return ss(t,e,n,c.getNode().getChild(n),r,s,a,o);if(A(n)){let l=new x(null);return c.getNode().forEachChild(Sn,(u,d)=>{l=l.set(new D(u),d)}),ca(t,e,n,l,r,s,a,o)}else return e}else{let l=new x(null);return i.foreach((u,d)=>{const h=Y(n,u);c.isCompleteForPath(h)&&(l=l.set(u,c.getNode().getChild(h)))}),ca(t,e,n,l,r,s,a,o)}}function kC(t,e,n,i,r){const s=e.serverCache,o=Bf(e,s.getNode(),s.isFullyInitialized()||A(n),s.isFiltered());return qf(t,o,n,i,Gf,r)}function RC(t,e,n,i,r,s){let o;if(rs(i,n)!=null)return e;{const a=new pc(i,e,r),c=e.eventCache.getNode();let l;if(A(n)||I(n)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=is(i,dn(e));else{const d=e.serverCache.getNode();g(d instanceof v,"serverChildren would be complete if leaf node"),u=hc(i,d)}u=u,l=t.filter.updateFullNode(c,u,s)}else{const u=I(n);let d=fc(i,u,e.serverCache);d==null&&e.serverCache.isCompleteForChild(u)&&(d=c.getImmediateChild(u)),d!=null?l=t.filter.updateChild(c,u,d,U(n),a,s):e.eventCache.getNode().hasChild(u)?l=t.filter.updateChild(c,u,v.EMPTY_NODE,U(n),a,s):l=c,l.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=is(i,dn(e)),o.isLeafNode()&&(l=t.filter.updateFullNode(l,o,s)))}return o=e.serverCache.isFullyInitialized()||rs(i,N())!=null,Ci(e,l,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let as;function BC(t){g(!as,"__referenceConstructor has already been defined"),as=t}function HC(){return g(as,"Reference.ts has not been loaded"),as}let WC=1;class rd{constructor(e){this.listenProvider_=e,this.syncPointTree_=new x(null),this.pendingWriteTree_=_C(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ep(t,e,n,i,r){return sC(t.pendingWriteTree_,e,n,i,r),r?ri(t,new un(lc(),e,n)):[]}function VC(t,e,n,i){oC(t.pendingWriteTree_,e,n,i);const r=x.fromObject(n);return ri(t,new Bn(lc(),e,r))}function It(t,e,n=!1){const i=aC(t.pendingWriteTree_,e);if(cC(t.pendingWriteTree_,e)){let s=new x(null);return i.snap!=null?s=s.set(N(),!0):ce(i.children,o=>{s=s.set(new D(o),!0)}),ri(t,new ts(i.path,s,n))}else return[]}function ar(t,e,n){return ri(t,new un(uc(),e,n))}function jC(t,e,n){const i=x.fromObject(n);return ri(t,new Bn(uc(),e,i))}function zC(t,e){return ri(t,new ji(uc(),e))}function GC(t,e,n){const i=_c(t,n);if(i){const r=yc(i),s=r.path,o=r.queryId,a=ge(s,e),c=new ji(dc(o),a);return Ec(t,s,c)}else return[]}function cs(t,e,n,i,r=!1){const s=e._path,o=t.syncPointTree_.get(s);let a=[];if(o&&(e._queryIdentifier==="default"||Zf(o,e))){const c=$C(o,e,n,i);FC(o)&&(t.syncPointTree_=t.syncPointTree_.remove(s));const l=c.removed;if(a=c.events,!r){const u=l.findIndex(h=>h._queryParams.loadsAllData())!==-1,d=t.syncPointTree_.findOnPath(s,(h,f)=>Bt(f));if(u&&!d){const h=t.syncPointTree_.subtree(s);if(!h.isEmpty()){const f=KC(h);for(let p=0;p<f.length;++p){const y=f[p],m=y.query,T=rp(t,y);t.listenProvider_.startListening(Ii(m),zi(t,m),T.hashFn,T.onComplete)}}}!d&&l.length>0&&!i&&(u?t.listenProvider_.stopListening(Ii(e),null):l.forEach(h=>{const f=t.queryToTagMap.get(xs(h));t.listenProvider_.stopListening(Ii(h),f)}))}JC(t,l)}return a}function tp(t,e,n,i){const r=_c(t,i);if(r!=null){const s=yc(r),o=s.path,a=s.queryId,c=ge(o,e),l=new un(dc(a),c,n);return Ec(t,o,l)}else return[]}function qC(t,e,n,i){const r=_c(t,i);if(r){const s=yc(r),o=s.path,a=s.queryId,c=ge(o,e),l=x.fromObject(n),u=new Bn(dc(a),c,l);return Ec(t,o,u)}else return[]}function la(t,e,n,i=!1){const r=e._path;let s=null,o=!1;t.syncPointTree_.foreachOnPath(r,(h,f)=>{const p=ge(h,r);s=s||Ot(f,p),o=o||Bt(f)});let a=t.syncPointTree_.get(r);a?(o=o||Bt(a),s=s||Ot(a,N())):(a=new Kf,t.syncPointTree_=t.syncPointTree_.set(r,a));let c;s!=null?c=!0:(c=!1,s=v.EMPTY_NODE,t.syncPointTree_.subtree(r).foreachChild((f,p)=>{const y=Ot(p,N());y&&(s=s.updateImmediateChild(f,y))}));const l=Zf(a,e);if(!l&&!e._queryParams.loadsAllData()){const h=xs(e);g(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const f=XC();t.queryToTagMap.set(h,f),t.tagToQueryMap.set(f,h)}const u=Ds(t.pendingWriteTree_,r);let d=UC(a,e,n,u,s,c);if(!l&&!o&&!i){const h=Qf(a,e);d=d.concat(QC(t,e,h))}return d}function mc(t,e,n){const r=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,a)=>{const c=ge(o,e),l=Ot(a,c);if(l)return l});return Vf(r,e,s,n,!0)}function YC(t,e){const n=e._path;let i=null;t.syncPointTree_.foreachOnPath(n,(l,u)=>{const d=ge(l,n);i=i||Ot(u,d)});let r=t.syncPointTree_.get(n);r?i=i||Ot(r,N()):(r=new Kf,t.syncPointTree_=t.syncPointTree_.set(n,r));const s=i!=null,o=s?new $t(i,!0,!1):null,a=Ds(t.pendingWriteTree_,e._path),c=Jf(r,e,a,s?o.getNode():v.EMPTY_NODE,s);return NC(c)}function ri(t,e){return np(e,t.syncPointTree_,null,Ds(t.pendingWriteTree_,N()))}function np(t,e,n,i){if(A(t.path))return ip(t,e,n,i);{const r=e.get(N());n==null&&r!=null&&(n=Ot(r,N()));let s=[];const o=I(t.path),a=t.operationForChild(o),c=e.children.get(o);if(c&&a){const l=n?n.getImmediateChild(o):null,u=jf(i,o);s=s.concat(np(a,c,l,u))}return r&&(s=s.concat(gc(r,t,i,n))),s}}function ip(t,e,n,i){const r=e.get(N());n==null&&r!=null&&(n=Ot(r,N()));let s=[];return e.children.inorderTraversal((o,a)=>{const c=n?n.getImmediateChild(o):null,l=jf(i,o),u=t.operationForChild(o);u&&(s=s.concat(ip(u,a,c,l)))}),r&&(s=s.concat(gc(r,t,i,n))),s}function rp(t,e){const n=e.query,i=zi(t,n);return{hashFn:()=>(PC(e)||v.EMPTY_NODE).hash(),onComplete:r=>{if(r==="ok")return i?GC(t,n._path,i):zC(t,n._path);{const s=zb(r,n);return cs(t,n,null,s)}}}}function zi(t,e){const n=xs(e);return t.queryToTagMap.get(n)}function xs(t){return t._path.toString()+"$"+t._queryIdentifier}function _c(t,e){return t.tagToQueryMap.get(e)}function yc(t){const e=t.indexOf("$");return g(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new D(t.substr(0,e))}}function Ec(t,e,n){const i=t.syncPointTree_.get(e);g(i,"Missing sync point for query tag that we're tracking");const r=Ds(t.pendingWriteTree_,e);return gc(i,n,r,null)}function KC(t){return t.fold((e,n,i)=>{if(n&&Bt(n))return[Ms(n)];{let r=[];return n&&(r=Xf(n)),ce(i,(s,o)=>{r=r.concat(o)}),r}})}function Ii(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(HC())(t._repo,t._path):t}function JC(t,e){for(let n=0;n<e.length;++n){const i=e[n];if(!i._queryParams.loadsAllData()){const r=xs(i),s=t.queryToTagMap.get(r);t.queryToTagMap.delete(r),t.tagToQueryMap.delete(s)}}}function XC(){return WC++}function QC(t,e,n){const i=e._path,r=zi(t,e),s=rp(t,n),o=t.listenProvider_.startListening(Ii(e),r,s.hashFn,s.onComplete),a=t.syncPointTree_.subtree(i);if(r)g(!Bt(a.value),"If we're adding a query, it shouldn't be shadowed");else{const c=a.fold((l,u,d)=>{if(!A(l)&&u&&Bt(u))return[Ms(u).query];{let h=[];return u&&(h=h.concat(Xf(u).map(f=>f.query))),ce(d,(f,p)=>{h=h.concat(p)}),h}});for(let l=0;l<c.length;++l){const u=c[l];t.listenProvider_.stopListening(Ii(u),zi(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sc{constructor(e="",n=null,i={children:{},childCount:0}){this.name=e,this.parent=n,this.node=i}}function Cc(t,e){let n=e instanceof D?e:new D(e),i=t,r=I(n);for(;r!==null;){const s=Fn(i.node.children,r)||{children:{},childCount:0};i=new Sc(r,i,s),n=U(n),r=I(n)}return i}function si(t){return t.node.value}function ap(t,e){t.node.value=e,ua(t)}function cp(t){return t.node.childCount>0}function nT(t){return si(t)===void 0&&!cp(t)}function Fs(t,e){ce(t.node.children,(n,i)=>{e(new Sc(n,t,i))})}function lp(t,e,n,i){n&&e(t),Fs(t,r=>{lp(r,e,!0)})}function iT(t,e,n){let i=t.parent;for(;i!==null;){if(e(i))return!0;i=i.parent}return!1}function cr(t){return new D(t.parent===null?t.name:cr(t.parent)+"/"+t.name)}function ua(t){t.parent!==null&&rT(t.parent,t.name,t)}function rT(t,e,n){const i=nT(n),r=Je(t.node.children,e);i&&r?(delete t.node.children[e],t.node.childCount--,ua(t)):!i&&!r&&(t.node.children[e]=n.node,t.node.childCount++,ua(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gT="repo_interrupt",mT=25;class _T{constructor(e,n,i,r){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new fT,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=es(),this.transactionQueueTree_=new Sc,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function yT(t,e,n){if(t.stats_=tc(t.repoInfo_),t.forceRestClient_||Kb())t.server_=new Zr(t.repoInfo_,(i,r,s,o)=>{od(t,i,r,s,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>ad(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ee(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}t.persistentConnection_=new dt(t.repoInfo_,e,(i,r,s,o)=>{od(t,i,r,s,o)},i=>{ad(t,i)},i=>{ET(t,i)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(i=>{t.server_.refreshAuthToken(i)}),t.appCheckProvider_.addTokenChangeListener(i=>{t.server_.refreshAppCheckToken(i.token)}),t.statsReporter_=eS(t.repoInfo_,()=>new ZS(t.stats_,t.server_)),t.infoData_=new YS,t.infoSyncTree_=new rd({startListening:(i,r,s,o)=>{let a=[];const c=t.infoData_.getNode(i._path);return c.isEmpty()||(a=ar(t.infoSyncTree_,i._path,c),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),kc(t,"connected",!1),t.serverSyncTree_=new rd({startListening:(i,r,s,o)=>(t.server_.listen(i,s,r,(a,c)=>{const l=o(a,c);Ne(t.eventQueue_,i._path,l)}),[]),stopListening:(i,r)=>{t.server_.unlisten(i,r)}})}function gp(t){const n=t.infoData_.getNode(new D(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Bs(t){return ZC({timestamp:gp(t)})}function od(t,e,n,i,r){t.dataUpdateCount++;const s=new D(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(r)if(i){const c=Yr(n,l=>Z(l));o=qC(t.serverSyncTree_,s,c,r)}else{const c=Z(n);o=tp(t.serverSyncTree_,s,c,r)}else if(i){const c=Yr(n,l=>Z(l));o=jC(t.serverSyncTree_,s,c)}else{const c=Z(n);o=ar(t.serverSyncTree_,s,c)}let a=s;o.length>0&&(a=Wn(t,s)),Ne(t.eventQueue_,a,o)}function ad(t,e){kc(t,"connected",e),e===!1&&ST(t)}function ET(t,e){ce(e,(n,i)=>{kc(t,n,i)})}function kc(t,e,n){const i=new D("/.info/"+e),r=Z(n);t.infoData_.updateSnapshot(i,r);const s=ar(t.infoSyncTree_,i,r);Ne(t.eventQueue_,i,s)}function Rc(t){return t.nextWriteId_++}function vT(t,e,n){const i=YC(t.serverSyncTree_,e);return i!=null?Promise.resolve(i):t.server_.get(e).then(r=>{const s=Z(r).withIndex(e._queryParams.getIndex());la(t.serverSyncTree_,e,n,!0);let o;if(e._queryParams.loadsAllData())o=ar(t.serverSyncTree_,e._path,s);else{const a=zi(t.serverSyncTree_,e);o=tp(t.serverSyncTree_,e._path,s,a)}return Ne(t.eventQueue_,e._path,o),cs(t.serverSyncTree_,e,n,null,!0),s},r=>(lr(t,"get for query "+ee(e)+" failed: "+r),Promise.reject(new Error(r))))}function wT(t,e,n,i,r){lr(t,"set",{path:e.toString(),value:n,priority:i});const s=Bs(t),o=Z(n,i),a=mc(t.serverSyncTree_,e),c=op(o,a,s),l=Rc(t),u=ep(t.serverSyncTree_,e,c,l,!0);$s(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(h,f)=>{const p=h==="ok";p||me("set at "+e+" failed: "+h);const y=It(t.serverSyncTree_,l,!p);Ne(t.eventQueue_,e,y),da(t,r,h,f)});const d=Pc(t,e);Wn(t,d),Ne(t.eventQueue_,d,[])}function bT(t,e,n,i){lr(t,"update",{path:e.toString(),value:n});let r=!0;const s=Bs(t),o={};if(ce(n,(a,c)=>{r=!1,o[a]=sp(Y(e,a),Z(c),t.serverSyncTree_,s)}),r)se("update() called with empty data.  Don't do anything."),da(t,i,"ok",void 0);else{const a=Rc(t),c=VC(t.serverSyncTree_,e,o,a);$s(t.eventQueue_,c),t.server_.merge(e.toString(),n,(l,u)=>{const d=l==="ok";d||me("update at "+e+" failed: "+l);const h=It(t.serverSyncTree_,a,!d),f=h.length>0?Wn(t,e):e;Ne(t.eventQueue_,f,h),da(t,i,l,u)}),ce(n,l=>{const u=Pc(t,Y(e,l));Wn(t,u)}),Ne(t.eventQueue_,e,[])}}function ST(t){lr(t,"onDisconnectEvents");const e=Bs(t),n=es();ia(t.onDisconnect_,N(),(r,s)=>{const o=sp(r,s,t.serverSyncTree_,e);$f(n,r,o)});let i=[];ia(n,N(),(r,s)=>{i=i.concat(ar(t.serverSyncTree_,r,s));const o=Pc(t,r);Wn(t,o)}),t.onDisconnect_=es(),Ne(t.eventQueue_,N(),i)}function CT(t,e,n){let i;I(e._path)===".info"?i=la(t.infoSyncTree_,e,n):i=la(t.serverSyncTree_,e,n),fp(t.eventQueue_,e._path,i)}function mp(t,e,n){let i;I(e._path)===".info"?i=cs(t.infoSyncTree_,e,n):i=cs(t.serverSyncTree_,e,n),fp(t.eventQueue_,e._path,i)}function TT(t){t.persistentConnection_&&t.persistentConnection_.interrupt(gT)}function lr(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),se(n,...e)}function da(t,e,n,i){e&&ii(()=>{if(n==="ok")e(null);else{const r=(n||"error").toUpperCase();let s=r;i&&(s+=": "+i);const o=new Error(s);o.code=r,e(o)}})}function _p(t,e,n){return mc(t.serverSyncTree_,e,n)||v.EMPTY_NODE}function Ac(t,e=t.transactionQueueTree_){if(e||Hs(t,e),si(e)){const n=Ep(t,e);g(n.length>0,"Sending zero length transaction queue"),n.every(r=>r.status===0)&&IT(t,cr(e),n)}else cp(e)&&Fs(e,n=>{Ac(t,n)})}function IT(t,e,n){const i=n.map(l=>l.currentWriteId),r=_p(t,e,i);let s=r;const o=r.hash();for(let l=0;l<n.length;l++){const u=n[l];g(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const d=ge(e,u.path);s=s.updateChild(d,u.currentOutputSnapshotRaw)}const a=s.val(!0),c=e;t.server_.put(c.toString(),a,l=>{lr(t,"transaction put response",{path:c.toString(),status:l});let u=[];if(l==="ok"){const d=[];for(let h=0;h<n.length;h++)n[h].status=2,u=u.concat(It(t.serverSyncTree_,n[h].currentWriteId)),n[h].onComplete&&d.push(()=>n[h].onComplete(null,!0,n[h].currentOutputSnapshotResolved)),n[h].unwatcher();Hs(t,Cc(t.transactionQueueTree_,e)),Ac(t,t.transactionQueueTree_),Ne(t.eventQueue_,e,u);for(let h=0;h<d.length;h++)ii(d[h])}else{if(l==="datastale")for(let d=0;d<n.length;d++)n[d].status===3?n[d].status=4:n[d].status=0;else{me("transaction at "+c.toString()+" failed: "+l);for(let d=0;d<n.length;d++)n[d].status=4,n[d].abortReason=l}Wn(t,e)}},o)}function Wn(t,e){const n=yp(t,e),i=cr(n),r=Ep(t,n);return kT(t,r,i),i}function kT(t,e,n){if(e.length===0)return;const i=[];let r=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const c=e[a],l=ge(n,c.path);let u=!1,d;if(g(l!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)u=!0,d=c.abortReason,r=r.concat(It(t.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=mT)u=!0,d="maxretry",r=r.concat(It(t.serverSyncTree_,c.currentWriteId,!0));else{const h=_p(t,c.path,o);c.currentInputSnapshot=h;const f=e[a].update(h.val());if(f!==void 0){Us("transaction failed: Data returned ",f,c.path);let p=Z(f);typeof f=="object"&&f!=null&&Je(f,".priority")||(p=p.updatePriority(h.getPriority()));const m=c.currentWriteId,T=Bs(t),$=op(p,h,T);c.currentOutputSnapshotRaw=p,c.currentOutputSnapshotResolved=$,c.currentWriteId=Rc(t),o.splice(o.indexOf(m),1),r=r.concat(ep(t.serverSyncTree_,c.path,$,c.currentWriteId,c.applyLocally)),r=r.concat(It(t.serverSyncTree_,m,!0))}else u=!0,d="nodata",r=r.concat(It(t.serverSyncTree_,c.currentWriteId,!0))}Ne(t.eventQueue_,n,r),r=[],u&&(e[a].status=2,(function(h){setTimeout(h,Math.floor(0))})(e[a].unwatcher),e[a].onComplete&&(d==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(d),!1,null))))}Hs(t,t.transactionQueueTree_);for(let a=0;a<i.length;a++)ii(i[a]);Ac(t,t.transactionQueueTree_)}function yp(t,e){let n,i=t.transactionQueueTree_;for(n=I(e);n!==null&&si(i)===void 0;)i=Cc(i,n),e=U(e),n=I(e);return i}function Ep(t,e){const n=[];return vp(t,e,n),n.sort((i,r)=>i.order-r.order),n}function vp(t,e,n){const i=si(e);if(i)for(let r=0;r<i.length;r++)n.push(i[r]);Fs(e,r=>{vp(t,r,n)})}function Hs(t,e){const n=si(e);if(n){let i=0;for(let r=0;r<n.length;r++)n[r].status!==2&&(n[i]=n[r],i++);n.length=i,ap(e,n.length>0?n:void 0)}Fs(e,i=>{Hs(t,i)})}function Pc(t,e){const n=cr(yp(t,e)),i=Cc(t.transactionQueueTree_,e);return iT(i,r=>{wo(t,r)}),wo(t,i),lp(i,r=>{wo(t,r)}),n}function wo(t,e){const n=si(e);if(n){const i=[];let r=[],s=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(g(s===o-1,"All SENT items should be at beginning of queue."),s=o,n[o].status=3,n[o].abortReason="set"):(g(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),r=r.concat(It(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&i.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));s===-1?ap(e,void 0):n.length=s+1,Ne(t.eventQueue_,cr(e),r);for(let o=0;o<i.length;o++)ii(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wp{constructor(e,n,i,r){this.eventType=e,this.eventRegistration=n,this.snapshot=i,this.prevName=r}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+ee(this.snapshot.exportVal())}}class bp{constructor(e,n,i){this.eventRegistration=e,this.error=n,this.path=i}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lc{constructor(e,n,i,r){this._repo=e,this._path=n,this._queryParams=i,this._orderByCalled=r}get key(){return A(this._path)?null:ic(this._path)}get ref(){return new Xe(this._repo,this._path)}get _queryIdentifier(){const e=Yu(this._queryParams),n=Za(e);return n==="{}"?"default":n}get _queryObject(){return Yu(this._queryParams)}isEqual(e){if(e=le(e),!(e instanceof Lc))return!1;const n=this._repo===e._repo,i=rc(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return n&&i&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+SS(this._path)}}class Xe extends Lc{constructor(e,n){super(e,n,new cc,!1)}get parent(){const e=Nf(this._path);return e===null?null:new Xe(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Vn{constructor(e,n,i){this._node=e,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new D(e),i=jn(this.ref,e);return new Vn(this._node.getChild(n),i,K)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,r)=>e(new Vn(r,jn(this.ref,i),K)))}hasChild(e){const n=new D(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function oe(t,e){return t=le(t),t._checkNotDeleted("ref"),e!==void 0?jn(t._root,e):t._root}function jn(t,e){return t=le(t),I(t._path)===null?dT("child","path",e):hp("child","path",e),new Xe(t._repo,Y(t._path,e))}function ud(t,e){t=le(t),Ic("push",t._path),dp("push",e,t._path,!0);const n=gp(t._repo),i=NT(n),r=jn(t,i),s=jn(t,i);let o;return o=Promise.resolve(s),r.then=o.then.bind(o),r.catch=o.then.bind(o,void 0),r}function zn(t){return Ic("remove",t._path),_t(t,null)}function _t(t,e){t=le(t),Ic("set",t._path),dp("set",e,t._path,!1);const n=new ft;return wT(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function Dr(t,e){uT("update",e,t._path);const n=new ft;return bT(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function nn(t){t=le(t);const e=new Nc(()=>{}),n=new ur(e);return vT(t._repo,t,n).then(i=>new Vn(i,new Xe(t._repo,t._path),t._queryParams.getIndex()))}class ur{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const i=n._queryParams.getIndex();return new wp("value",this,new Vn(e.snapshotNode,new Xe(n._repo,n._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new bp(this,e,n):null}matches(e){return e instanceof ur?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class Ws{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new bp(this,e,n):null}createEvent(e,n){g(e.childName!=null,"Child events should have a childName.");const i=jn(new Xe(n._repo,n._path),e.childName),r=n._queryParams.getIndex();return new wp(e.type,this,new Vn(e.snapshotNode,i,r),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Ws?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function Oc(t,e,n,i,r){const s=new Nc(n,void 0),o=e==="value"?new ur(s):new Ws(e,s);return CT(t._repo,t,o),()=>mp(t._repo,t,o)}function LT(t,e,n,i){return Oc(t,"value",e)}function OT(t,e,n,i){return Oc(t,"child_added",e)}function DT(t,e,n,i){return Oc(t,"child_removed",e)}function Vs(t,e,n){let i=null;const r=n?new Nc(n):null;e==="value"?i=new ur(r):e&&(i=new Ws(e,r)),mp(t._repo,t,i)}MC(Xe);BC(Xe);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const MT="FIREBASE_DATABASE_EMULATOR_HOST",ha={};let xT=!1;function FT(t,e,n,i){const r=e.lastIndexOf(":"),s=e.substring(0,r),o=Zn(s);t.repoInfo_=new bf(e,o,t.repoInfo_.namespace,t.repoInfo_.webSocketOnly,t.repoInfo_.nodeAdmin,t.repoInfo_.persistenceKey,t.repoInfo_.includeNamespaceInQueryParams,!0,n),i&&(t.authTokenProvider_=i)}function UT(t,e,n,i,r){let s=i||t.options.databaseURL;s===void 0&&(t.options.projectId||mt("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),se("Using default host for project ",t.options.projectId),s=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=cd(s,r),a=o.repoInfo,c;typeof process<"u"&&Pu&&(c=Pu[MT]),c?(s=`http://${c}?ns=${a.namespace}`,o=cd(s,r),a=o.repoInfo):o.repoInfo.secure;const l=new Xb(t.name,t.options,e);hT("Invalid Firebase Database URL",o),A(o.path)||mt("Database URL must point to the root of a Firebase Database (not including a child path).");const u=BT(a,t,l,new Jb(t,n));return new HT(u,t)}function $T(t,e){const n=ha[e];(!n||n[t.key]!==t)&&mt(`Database ${e}(${t.repoInfo_}) has already been deleted.`),TT(t),delete n[t.key]}function BT(t,e,n,i){let r=ha[e.name];r||(r={},ha[e.name]=r);let s=r[t.toURLString()];return s&&mt("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new _T(t,xT,n,i),r[t.toURLString()]=s,s}class HT{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(yT(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Xe(this._repo,N())),this._rootInternal}_delete(){return this._rootInternal!==null&&($T(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&mt("Cannot call "+e+" on a deleted database.")}}function WT(t=Xa(),e){const n=ir(t,"database").getImmediate({identifier:e});if(!n._instanceStarted){const i=nw("database");i&&VT(n,...i)}return n}function VT(t,e,n,i={}){t=le(t),t._checkNotDeleted("useEmulator");const r=`${e}:${n}`,s=t._repoInternal;if(t._instanceStarted){if(r===t._repoInternal.repoInfo_.host&&cn(i,s.repoInfo_.emulatorOptions))return;mt("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(s.repoInfo_.nodeAdmin)i.mockUserToken&&mt('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Or(Or.OWNER);else if(i.mockUserToken){const a=typeof i.mockUserToken=="string"?i.mockUserToken:iw(i.mockUserToken,t.app.options.projectId);o=new Or(a)}Zn(e)&&(Qh(e),Zh("Database",!0)),FT(s,r,i,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fa=new Map,Sp={activated:!1,tokenObservers:[]},qT={initialized:!1,enabled:!1};function te(t){return fa.get(t)||{...Sp}}function YT(t,e){return fa.set(t,e),fa.get(t)}function js(){return qT}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dI={error:"UNKNOWN_ERROR"};function hI(t){return Rs.encodeString(JSON.stringify(t),!1)}async function pa(t,e=!1,n=!1){const i=t.app;Dc(i);const r=te(i);let s=r.token,o;if(s&&!wn(s)&&(r.token=void 0,s=void 0),!s){const l=await r.cachedTokenPromise;l&&(wn(l)?s=l:await bo(i,void 0))}if(!e&&s&&wn(s))return{token:s.token};let a=!1;if(xc())try{r.exchangeTokenPromise||(r.exchangeTokenPromise=Mc(Ip(i,await Fc()),t.heartbeatServiceProvider).finally(()=>{r.exchangeTokenPromise=void 0}),a=!0);const l=await r.exchangeTokenPromise;return await bo(i,l),r.token=l,{token:l.token}}catch(l){return l.code==="appCheck/throttled"||l.code==="appCheck/initial-throttle"?kt.warn(l.message):n&&kt.error(l),So(l)}try{r.exchangeTokenPromise||(r.exchangeTokenPromise=r.provider.getToken().finally(()=>{r.exchangeTokenPromise=void 0}),a=!0),s=await te(i).exchangeTokenPromise}catch(l){l.code==="appCheck/throttled"||l.code==="appCheck/initial-throttle"?kt.warn(l.message):n&&kt.error(l),o=l}let c;return s?o?wn(s)?c={token:s.token,internalError:o}:c=So(o):(c={token:s.token},r.token=s,await bo(i,s)):c=So(o),a&&Dp(i,c),c}async function fI(t){const e=t.app;Dc(e);const{provider:n}=te(e);if(xc()){const i=await Fc(),{token:r}=await Mc(Ip(e,i),t.heartbeatServiceProvider);return{token:r}}else{const{token:i}=await n.getToken();return{token:i}}}function Lp(t,e,n,i){const{app:r}=t,s=te(r),o={next:n,error:i,type:e};if(s.tokenObservers=[...s.tokenObservers,o],s.token&&wn(s.token)){const a=s.token;Promise.resolve().then(()=>{n({token:a.token}),fd(t)}).catch(()=>{})}s.cachedTokenPromise.then(()=>fd(t))}function Op(t,e){const n=te(t),i=n.tokenObservers.filter(r=>r.next!==e);i.length===0&&n.tokenRefresher&&n.tokenRefresher.isRunning()&&n.tokenRefresher.stop(),n.tokenObservers=i}function fd(t){const{app:e}=t,n=te(e);let i=n.tokenRefresher;i||(i=pI(t),n.tokenRefresher=i),!i.isRunning()&&n.isTokenAutoRefreshEnabled&&i.start()}function pI(t){const{app:e}=t;return new QT(async()=>{const n=te(e);let i;if(n.token?i=await pa(t,!0):i=await pa(t),i.error)throw i.error;if(i.internalError)throw i.internalError},()=>!0,()=>{const n=te(e);if(n.token){let i=n.token.issuedAtTimeMillis+(n.token.expireTimeMillis-n.token.issuedAtTimeMillis)*.5+3e5;const r=n.token.expireTimeMillis-300*1e3;return i=Math.min(i,r),Math.max(0,i-Date.now())}else return 0},dd.RETRIAL_MIN_WAIT,dd.RETRIAL_MAX_WAIT)}function Dp(t,e){const n=te(t).tokenObservers;for(const i of n)try{i.type==="EXTERNAL"&&e.error!=null?i.error(e.error):i.next(e)}catch{}}function wn(t){return t.expireTimeMillis-Date.now()>0}function So(t){return{token:hI(dI),error:t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gI{constructor(e,n){this.app=e,this.heartbeatServiceProvider=n}_delete(){const{tokenObservers:e}=te(this.app);for(const n of e)Op(this.app,n.next);return Promise.resolve()}}function mI(t,e){return new gI(t,e)}function _I(t){return{getToken:e=>pa(t,e),getLimitedUseToken:()=>fI(t),addTokenListener:e=>Lp(t,"INTERNAL",e),removeTokenListener:e=>Op(t.app,e)}}const yI="@firebase/app-check",EI="0.11.0",vI="https://www.google.com/recaptcha/enterprise.js";function wI(t,e){const n=new ft,i=te(t);i.reCAPTCHAState={initialized:n};const r=bI(t),s=hd(!0);return s?pd(t,e,s,r,n):TI(()=>{const o=hd(!0);if(!o)throw new Error("no recaptcha");pd(t,e,o,r,n)}),n.promise}function pd(t,e,n,i,r){n.ready(()=>{CI(t,e,n,i),r.resolve(n)})}function bI(t){const e=`fire_app_check_${t.name}`,n=document.createElement("div");return n.id=e,n.style.display="none",document.body.appendChild(n),e}async function SI(t){Dc(t);const n=await te(t).reCAPTCHAState.initialized.promise;return new Promise((i,r)=>{const s=te(t).reCAPTCHAState;n.ready(()=>{i(n.execute(s.widgetId,{action:"fire_app_check"}))})})}function CI(t,e,n,i){const r=n.render(i,{sitekey:e,size:"invisible",callback:()=>{te(t).reCAPTCHAState.succeeded=!0},"error-callback":()=>{te(t).reCAPTCHAState.succeeded=!1}}),s=te(t);s.reCAPTCHAState={...s.reCAPTCHAState,widgetId:r}}function TI(t){const e=document.createElement("script");e.src=vI,e.onload=t,document.head.appendChild(e)}class Uc{constructor(e){this._siteKey=e,this._throttleData=null}async getToken(){kI(this._throttleData);const e=await SI(this._app).catch(i=>{throw ve.create("recaptcha-error")});if(!te(this._app).reCAPTCHAState?.succeeded)throw ve.create("recaptcha-error");let n;try{n=await Mc(tI(this._app,e),this._heartbeatServiceProvider)}catch(i){throw i.code?.includes("fetch-status-error")?(this._throttleData=II(Number(i.customData?.httpStatus),this._throttleData),ve.create("initial-throttle",{time:Tp(this._throttleData.allowRequestsAfter-Date.now()),httpStatus:this._throttleData.httpStatus})):i}return this._throttleData=null,n}initialize(e){this._app=e,this._heartbeatServiceProvider=ir(e,"heartbeat"),wI(e,this._siteKey).catch(()=>{})}isEqual(e){return e instanceof Uc?this._siteKey===e._siteKey:!1}}function II(t,e){if(t===404||t===403)return{backoffCount:1,allowRequestsAfter:Date.now()+XT,httpStatus:t};{const n=e?e.backoffCount:0,i=Tw(n,1e3,2);return{backoffCount:n+1,allowRequestsAfter:Date.now()+i,httpStatus:t}}}function kI(t){if(t&&Date.now()-t.allowRequestsAfter<=0)throw ve.create("throttled",{time:Tp(t.allowRequestsAfter-Date.now()),httpStatus:t.httpStatus})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ls=new Ns("@firebase/auth");function UI(t,...e){ls.logLevel<=L.WARN&&ls.warn(`Auth (${ni}): ${t}`,...e)}function xr(t,...e){ls.logLevel<=L.ERROR&&ls.error(`Auth (${ni}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dr{constructor(e,n){this.shortDelay=e,this.longDelay=n,yt(n>e,"Short delay should be less than long delay!"),this.isMobile=Ya()||ef()}get(){return HI()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jI=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],zI=new dr(3e4,6e4);function zc(t,e){return t.tenantId&&!e.tenantId?{...e,tenantId:t.tenantId}:e}async function oi(t,e,n,i,r={}){return Bp(t,r,async()=>{let s={},o={};i&&(e==="GET"?o=i:s={body:JSON.stringify(i)});const a=ti({key:t.config.apiKey,...o}).slice(1),c=await t._getAdditionalHeaders();c["Content-Type"]="application/json",t.languageCode&&(c["X-Firebase-Locale"]=t.languageCode);const l={method:e,headers:c,...s};return ow()||(l.referrerPolicy="no-referrer"),t.emulatorConfig&&Zn(t.emulatorConfig.host)&&(l.credentials="include"),$p.fetch()(await Hp(t,t.config.apiHost,n,a),l)})}async function Bp(t,e,n){t._canInitEmulator=!1;const i={...VI,...e};try{const r=new qI(t),s=await Promise.race([n(),r.promise]);r.clearNetworkTimeout();const o=await s.json();if("needConfirmation"in o)throw Ir(t,"account-exists-with-different-credential",o);if(s.ok&&!("errorMessage"in o))return o;{const a=s.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw Ir(t,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw Ir(t,"email-already-in-use",o);if(c==="USER_DISABLED")throw Ir(t,"user-disabled",o);const u=i[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw Wc(t,u,l);Ye(t,u)}}catch(r){if(r instanceof Wt)throw r;Ye(t,"network-request-failed",{message:String(r)})}}async function GI(t,e,n,i,r={}){const s=await oi(t,e,n,i,r);return"mfaPendingCredential"in s&&Ye(t,"multi-factor-auth-required",{_serverResponse:s}),s}async function Hp(t,e,n,i){const r=`${e}${n}?${i}`,s=t,o=s.config.emulator?jc(t.config,r):`${t.config.apiScheme}://${r}`;return jI.includes(n)&&(await s._persistenceManagerAvailable,s._getPersistenceType()==="COOKIE")?s._getPersistence()._getFinalTarget(o).toString():o}class qI{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,i)=>{this.timer=setTimeout(()=>i(Be(this.auth,"network-request-failed")),zI.get())})}}function Ir(t,e,n){const i={appName:t.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const r=Be(t,e,i);return r.customData._tokenResponse=n,r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function YI(t,e){return oi(t,"POST","/v1/accounts:delete",e)}async function us(t,e){return oi(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ki(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function KI(t,e=!1){const n=le(t),i=await n.getIdToken(e),r=Gc(i);S(r&&r.exp&&r.auth_time&&r.iat,n.auth,"internal-error");const s=typeof r.firebase=="object"?r.firebase:void 0,o=s?.sign_in_provider;return{claims:r,token:i,authTime:ki(Co(r.auth_time)),issuedAtTime:ki(Co(r.iat)),expirationTime:ki(Co(r.exp)),signInProvider:o||null,signInSecondFactor:s?.sign_in_second_factor||null}}function Co(t){return Number(t)*1e3}function Gc(t){const[e,n,i]=t.split(".");if(e===void 0||n===void 0||i===void 0)return xr("JWT malformed, contained fewer than 3 sections"),null;try{const r=qr(n);return r?JSON.parse(r):(xr("Failed to decode base64 JWT payload"),null)}catch(r){return xr("Caught error parsing JWT payload as JSON",r?.toString()),null}}function Ed(t){const e=Gc(t);return S(e,"internal-error"),S(typeof e.exp<"u","internal-error"),S(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fr(t,e,n){return`firebase:${t}:${e}:${n}`}class Tn{constructor(e,n,i){this.persistence=e,this.auth=n,this.userKey=i;const{config:r,name:s}=this.auth;this.fullUserKey=Fr(this.userKey,r.apiKey,s),this.fullPersistenceKey=Fr("persistence",r.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const n=await us(this.auth,{idToken:e}).catch(()=>{});return n?Fe._fromGetAccountInfoResponse(this.auth,n,e):null}return Fe._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,i="authUser"){if(!n.length)return new Tn(rt(ya),e,i);const r=(await Promise.all(n.map(async l=>{if(await l._isAvailable())return l}))).filter(l=>l);let s=r[0]||rt(ya);const o=Fr(i,e.config.apiKey,e.name);let a=null;for(const l of n)try{const u=await l._get(o);if(u){let d;if(typeof u=="string"){const h=await us(e,{idToken:u}).catch(()=>{});if(!h)break;d=await Fe._fromGetAccountInfoResponse(e,h,u)}else d=Fe._fromJSON(e,u);l!==s&&(a=d),s=l;break}}catch{}const c=r.filter(l=>l._shouldAllowMigration);return!s._shouldAllowMigration||!c.length?new Tn(s,e,i):(s=c[0],a&&await s._set(o,a.toJSON()),await Promise.all(n.map(async l=>{if(l!==s)try{await l._remove(o)}catch{}})),new Tn(s,e,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hr extends Kc{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt extends hr{constructor(){super("facebook.com")}static credential(e){return hn._fromParams({providerId:bt.PROVIDER_ID,signInMethod:bt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return bt.credentialFromTaggedObject(e)}static credentialFromError(e){return bt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return bt.credential(e.oauthAccessToken)}catch{return null}}}bt.FACEBOOK_SIGN_IN_METHOD="facebook.com";bt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class St extends hr{constructor(){super("github.com")}static credential(e){return hn._fromParams({providerId:St.PROVIDER_ID,signInMethod:St.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return St.credentialFromTaggedObject(e)}static credentialFromError(e){return St.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return St.credential(e.oauthAccessToken)}catch{return null}}}St.GITHUB_SIGN_IN_METHOD="github.com";St.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hs extends Wt{constructor(e,n,i,r){super(n.code,n.message),this.operationType=i,this.user=r,Object.setPrototypeOf(this,hs.prototype),this.customData={appName:e.name,tenantId:e.tenantId??void 0,_serverResponse:n.customData._serverResponse,operationType:i}}static _fromErrorAndOperation(e,n,i,r){return new hs(e,n,i,r)}}function tg(t,e,n,i){return(e==="reauthenticate"?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch(s=>{throw s.code==="auth/multi-factor-auth-required"?hs._fromErrorAndOperation(t,s,e,i):s})}async function Ek(t,e,n=!1){const i=await qi(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return Gn._forOperation(t,"link",i)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function To(t,e){return le(t).setPersistence(e)}function bk(t,e,n,i){return le(t).onIdTokenChanged(e,n,i)}function Sk(t,e,n){return le(t).beforeAuthStateChanged(e,n)}function ig(t,e,n,i){return le(t).onAuthStateChanged(e,n,i)}function Ck(t){return le(t).signOut()}const fs="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rg{constructor(e,n){this.storageRetriever=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(fs,"1"),this.storage.removeItem(fs),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pg(t,e){return e?rt(e):(S(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vk="pendingRedirect",Ur=new Map;class jk extends gg{constructor(e,n,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,i),this.eventId=null}async execute(){let e=Ur.get(this.auth._key());if(!e){try{const i=await zk(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(n){e=()=>Promise.reject(n)}Ur.set(this.auth._key(),e)}return this.bypassAuthState||Ur.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function zk(t,e){const n=Yk(e),i=qk(t);if(!await i._isAvailable())return!1;const r=await i._get(n)==="true";return await i._remove(n),r}function Gk(t,e){Ur.set(t._key(),e)}function qk(t){return rt(t._redirectPersistence)}function Yk(t){return Fr(Vk,t.config.apiKey,t.name)}async function Kk(t,e){return await ai(t)._initializationPromise,mg(t,e,!1)}async function mg(t,e,n=!1){if(Oe(t.app))return Promise.reject(rn(t));const i=ai(t),r=pg(i,e),o=await new jk(i,r,n).execute();return o&&!n&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rR=new dr(3e4,6e4);function Rd(){const t=qe().___jsl;if(t?.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function sR(t){return new Promise((e,n)=>{function i(){Rd(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Rd(),n(Be(t,"network-request-failed"))},timeout:rR.get()})}if(qe().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(qe().gapi?.load)i();else{const r=hk("iframefcb");return qe()[r]=()=>{gapi.load?i():n(Be(t,"network-request-failed"))},uk(`${dk()}?onload=${r}`).catch(s=>n(s))}}).catch(e=>{throw $r=null,e})}let $r=null;function oR(t){return $r=$r||sR(t),$r}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wR="__/auth/handler",bR="emulator/auth/handler",SR=encodeURIComponent("fac");async function Pd(t,e,n,i,r,s){S(t.config.authDomain,t,"auth-domain-config-required"),S(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:i,v:ni,eventId:r};if(e instanceof Kc){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",Yo(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,d]of Object.entries({}))o[u]=d}if(e instanceof hr){const u=e.getScopes().filter(d=>d!=="");u.length>0&&(o.scopes=u.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const c=await t._getAppCheckToken(),l=c?`#${SR}=${encodeURIComponent(c)}`:"";return`${CR(t)}?${ti(a).slice(1)}${l}`}function CR({config:t}){return t.emulator?jc(t,bR):`https://${t.authDomain}/${wR}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
- diagnosticLogger.getLogsSince(Date.now() - 60000) // Last minute
  ...
  `;const l=document.createElement("button");l.textContent="Cancel",l.style.cssText=`
    ...
    font-size: 16px;
    font-weight: 500;
  `;const u=async()=>{i.logCallingUILifecycle("CANCEL",t,{contactName:e,reason:"user_cancelled",duration:Date.now()-r});try{await Promise.all([Es(),q.cancelCall(t,de(),"caller_cancelled"),q.leaveRoom(de(),t)])}catch(d){i.log("ROOM","CALLER_CANCELLED_CLEANUP_FAIL",{roomId:t,error:String(d)})}Nn.stop(),Dt()};l.onclick=u,o.appendChild(a),o.appendChild(c),o.appendChild(l),s.appendChild(o),document.body.appendChild(s),s.dataset.roomId=t,tt=s,Nn.playOutgoing(),vi=setTimeout(async()=>{i.logCallingUILifecycle("TIMEOUT",t,{contactName:e,reason:"auto_timeout",duration:Date.now()-r,timeoutMs:ys});try{await Promise.all([Es(),q.cancelCall(t,de(),"auto_timeout"),q.leaveRoom(de(),t)])}catch(d){i.log("ROOM","CALLER_TIMEOUT_CLEANUP_FAIL",{roomId:t,error:String(d)})}Nn.stop(),Dt()},ys)}function Dt(){if(Nn.stop(),tt){const t=tt.dataset?.roomId||"unknown";_().logCallingUILifecycle("HIDE",t,{reason:"hide_called",hadTimeout:!!vi,timestamp:Date.now()})}vi&&(clearTimeout(vi),vi=null),tt&&(tt.remove(),tt=null)}async function gl(){if(tt){const t=tt.dataset?.roomId||"unknown";_().logCallingUILifecycle("ANSWERED",t,{reason:"call_answered",timestamp:Date.now()})}await Es(),Dt()}async function NA(t="user_rejected"){const e=_(),n=tt?.dataset?.roomId||"unknown";e.logCallingUILifecycle("REJECTED",n,{reason:t,timestamp:Date.now()}),await Es(),Dt()}const LA=Object.freeze(Object.defineProperty({__proto__:null,hideCallingUI:Dt,isOutgoingCallFresh:Vg,isRoomCallFresh:jg,onCallAnswered:gl,onCallRejected:NA,showCallingUI:zg},Symbol.toStringTag,{value:"Module"}));let Ln=null;function ml(t,e={}){return new Promise(n=>{const i=document.createElement("dialog");i.innerHTML=`
      <p>${t}</p>
      <div class="confirm-dialog-actions">
        <button data-action="cancel">Cancel</button>
        <button data-action="confirm" autofocus>Confirm</button>
      </div>
    `,i.classList.add("confirm-dialog");const r=i.querySelector('[data-action="confirm"]'),s=i.querySelector('[data-action="cancel"]');if(!r||!s){console.error("dialog element not found!"),n(!1);return}let o=null;function a(c){o&&clearTimeout(o),i.close(),i.remove(),Ln===a&&(Ln=null),n(c)}r.addEventListener("click",()=>{a(!0)}),s.addEventListener("click",()=>{a(!1)}),i.addEventListener("cancel",()=>a(!1)),document.body.appendChild(i),i.showModal(),Ln=a,e.autoRemoveSeconds&&typeof e.autoRemoveSeconds=="number"&&e.autoRemoveSeconds>0&&(o=setTimeout(()=>{a(!1)},e.autoRemoveSeconds*1e3))})}function OA(){if(typeof Ln=="function"){try{Ln(!1)}catch{}return Ln=null,!0}return!1}const DA=Object.freeze(Object.defineProperty({__proto__:null,default:ml,dismissActiveConfirmDialog:OA},Symbol.toStringTag,{value:"Module"}));async function Ud(t,e,n){const i=Qe();if(i){const r=oe(ae,`users/${i}/contacts/${t}`);await _t(r,{contactId:t,contactName:e,roomId:n,savedAt:Date.now()});return}try{const r=localStorage.getItem("contacts")||"{}",s=JSON.parse(r);s[t]={contactId:t,contactName:e,roomId:n,savedAt:Date.now()},localStorage.setItem("contacts",JSON.stringify(s))}catch(r){console.warn("Failed to save contact to localStorage",r)}}async function Ki(){const t=Qe();if(t)try{const e=oe(ae,`users/${t}/contacts`),n=await nn(e);return n.exists()?n.val():{}}catch(e){return console.warn("Failed to read contacts from RTDB",e),{}}try{const e=localStorage.getItem("contacts")||"{}";return JSON.parse(e)}catch(e){return console.warn("Failed to read contacts from localStorage",e),{}}}async function MA(t,e){if(!t)return e||"Unknown";try{const n=await Ki();for(const i of Object.values(n||{}))if(i?.roomId===t)return i.contactName||i.contactId||e}catch(n){console.warn("Failed to resolve caller name",n)}return e||"Unknown"}async function xA(t,e,n){if(!t||!e)return;const r=(await Ki())?.[t];if(r){r.roomId!==e&&(await Ud(t,r.contactName,e),await Ji(n)),console.log(`[CONTACT SAVE] Re-attaching listener for existing contact room: ${e}`),qn(e);return}if(!await ml("Save contact?",{autoRemoveSeconds:15}))return;const o=window.prompt("Enter a name for this contact:",t)||t;await Ud(t,o,e),console.log(`[CONTACT SAVE] Attaching listener for saved contact room: ${e}`),qn(e),await Ji(n)}async function Ji(t){if(!t)return;const e=await Ki(),n=Object.keys(e);let i=t.querySelector(".contacts-container");if(i||(i=document.createElement("div"),i.className="contacts-container",t.appendChild(i)),n.length===0){i.innerHTML="<p>No saved contacts yet.</p>",E(i);return}R(i),i.innerHTML=`
  ...
  `,FA(i,t)}function FA(t,e){t.querySelectorAll(".contact-name").forEach(n=>{n.onclick=async()=>{const i=n.getAttribute("data-room-id"),r=n.getAttribute("data-contact-name");i&&(console.log(`[CONTACT CALL] Ensuring listener is active for room: ${i}`),qn(i),await zg(i,r),eo(i,{forceInitiator:!0}).catch(s=>{console.warn("Failed to call contact:",s),Dt()}))}}),t.querySelectorAll(".contact-delete-btn").forEach(n=>{n.onclick=async()=>{const i=n.getAttribute("data-contact-id");!i||!window.confirm("Delete this contact?")||(await UA(i),await Ji(e))}})}async function UA(t){const e=Qe();if(e){try{await zn(oe(ae,`users/${e}/contacts/${t}`))}catch(n){console.warn("Failed to delete contact from RTDB",n)}return}try{const n=localStorage.getItem("contacts")||"{}",i=JSON.parse(n);i[t]&&(delete i[t],localStorage.setItem("contacts",JSON.stringify(i)))}catch(n){console.warn("Failed to delete contact from localStorage",n)}}function $A(){const t=document.querySelector("link[rel~='icon']");return t?t.href:"/favicon.ico"}class BA{constructor(){this.originalTitle=document.title,this.originalFavicon=$A(),this.titleFlashInterval=null,this.isFlashing=!1,this.wakeLock=null,this.setupVisibilityListener()}setupVisibilityListener(){document.addEventListener("visibilitychange",()=>{!document.hidden&&this.isFlashing&&this.stopTitleFlashing()})}startCallIndicators(e){console.log(`[VisibilityManager] Starting call indicators for: ${e}`),this.startTitleFlashing(e),this.setFavicon("/icons/phone-ringing.svg"),this.setBadge(1),this.requestWakeLock()}stopCallIndicators(){console.log("[VisibilityManager] Stopping call indicators"),this.stopTitleFlashing(),this.restoreFavicon(),this.clearBadge(),this.releaseWakeLock()}startTitleFlashing(e){this.stopTitleFlashing();let n=!0;this.isFlashing=!0,document.title=`📞 Call from ${e}!`,this.titleFlashInterval=setInterval(()=>{this.isFlashing&&(document.title=n?`📞 Call from ${e}!`:this.originalTitle,n=!n)},1e3)}stopTitleFlashing(){this.titleFlashInterval&&(clearInterval(this.titleFlashInterval),this.titleFlashInterval=null),this.isFlashing=!1,document.title=this.originalTitle}setFavicon(e){const n=document.querySelector("link[rel~='icon']");n&&(n.href=e,console.log(`[VisibilityManager] Favicon changed to: ${e}`))}restoreFavicon(){this.setFavicon(this.originalFavicon)}setBadge(e){"setAppBadge"in navigator&&navigator.setAppBadge(e).then(()=>{console.log(`[VisibilityManager] Badge set to: ${e}`)}).catch(n=>{console.warn("[VisibilityManager] Badge not supported:",n)})}clearBadge(){"clearAppBadge"in navigator&&navigator.clearAppBadge().then(()=>{console.log("[VisibilityManager] Badge cleared")}).catch(e=>{console.warn("[VisibilityManager] Badge clear failed:",e)})}async requestWakeLock(){if("wakeLock"in navigator)try{this.wakeLock=await navigator.wakeLock.request("screen"),console.log("[VisibilityManager] Wake lock active"),this.wakeLock.addEventListener("release",()=>{console.log("[VisibilityManager] Wake lock released"),this.wakeLock=null},{once:!0})}catch(e){console.warn("[VisibilityManager] Wake lock failed:",e)}}releaseWakeLock(){if(this.wakeLock){const e=this.wakeLock;this.wakeLock=null,e.release().then(()=>{console.log("[VisibilityManager] Wake lock released manually")}).catch(n=>{console.warn("[VisibilityManager] Wake lock release failed:",n)})}}}const $d=new BA,Xi=new WeakMap;function _l(t,e,n){if(!t||!n)throw new Error("setupIceCandidates: pc and roomId are required");if(Xi.has(t)||Xi.set(t,[]),e==="initiator")Bd(t,"offerCandidates",n),Hd(t,"answerCandidates",n);else if(e==="joiner")Bd(t,"answerCandidates",n),Hd(t,"offerCandidates",n);else throw new Error(`Invalid role: ${e} specified for ICE candidate setup.`)}function Bd(t,e,n){t.onicecandidate=i=>{if(i.candidate){const r=ud(e==="offerCandidates"?Mp(n):xp(n));_t(r,i.candidate.toJSON())}}}function Hd(t,e,n){const i=e==="offerCandidates"?Mp(n):xp(n);let r=!1;const s=()=>{if(r)return;r=!0;const a=()=>{t.remoteDescription&&(yl(t),t.removeEventListener("signalingstatechange",a))};t.addEventListener("signalingstatechange",a)};Xt(i,"child_added",a=>{const c=a.val();if(!(!t||t.signalingState==="closed")&&c)if(t.remoteDescription)try{t.addIceCandidate(new RTCIceCandidate(c))}catch{}else{const l=Xi.get(t);l&&(l.push(c),l.length===1&&s())}},n)}function yl(t){if(!t||!Xi.has(t))return;const e=Xi.get(t);if(e.length!==0){B(`🔄 Draining ${e.length} queued ICE candidate(s)`);for(const n of e)try{t.addIceCandidate(new RTCIceCandidate(n)).catch(i=>{B("Error adding queued ICE candidate:",i)})}catch{}e.length=0}}const HA=Object.freeze(Object.defineProperty({__proto__:null,drainIceCandidateQueue:yl,setupIceCandidates:_l},Symbol.toStringTag,{value:"Module"}));let ze=null,Wd=null;function Gg(t){Wd=t,t.onconnectionstatechange=()=>{B("onconnectionstatechange:",t.connectionState),t.connectionState==="connected"?(fl(),gl().catch(e=>console.warn("Failed to clear calling state on connect:",e)),ze&&(clearTimeout(ze),ze=null)):t.connectionState==="disconnected"?(ze&&clearTimeout(ze),ze=setTimeout(()=>{t===Wd&&t.connectionState==="disconnected"&&re.cleanupCall({reason:"connection_lost"}),ze=null},3e3)):t.connectionState==="failed"&&(Ks(),ze&&(clearTimeout(ze),ze=null),re.cleanupCall({reason:"connection_failed"}))},t.addEventListener("iceconnectionstatechange",e=>{B("ICE iceconnectionstatechange:",t.iceConnectionState),t.iceConnectionState==="failed"&&(console.warn("ICE connection failed, restarting ICE..."),t.restartIce())})}function vs(t,e,n={}){if(!t||typeof e!="function")throw new Error("closeOnClickOutside: valid element and onClose callback required");const{ignore:i=[],esc:r=!0,events:s=["mousedown","touchstart"]}=n,o=Array.isArray(i)?i.filter(Boolean):[],a=l=>{try{const u=l.target;if(t.contains(u))return;for(const d of o)if(d&&d.contains&&d.contains(u)||d===u)return;e(l)}catch(u){console.error("closeOnClickOutside handler error:",u)}},c=l=>{r&&l.key==="Escape"&&e(l)};return s.forEach(l=>document.addEventListener(l,a,{passive:!0})),r&&document.addEventListener("keydown",c),function(){s.forEach(u=>document.removeEventListener(u,a,{passive:!0})),r&&document.removeEventListener("keydown",c)}}const WA=CSS.supports?.("position-anchor: --msg-toggle")&&CSS.supports?.("right: anchor(right)")&&CSS.supports?.("bottom: anchor(top)");function VA(t){const e=t.getBoundingClientRect();return e.top>=0&&e.left>=0&&e.bottom<=window.innerHeight&&e.right<=window.innerWidth}function Vd(t){let e=null,n=null,i=null,r=null,s=null,o=!1;const a=el({initialProps:{unreadCount:0},template:`
    ...
    `,handlers:{handleToggle:P=>{P.preventDefault(),P.stopPropagation(),y()}},className:"messages-toggle-container",autoAppend:!1});let c=a.querySelector(".notification-badge");c&&(c.style.display="none"),a.onPropUpdated("unreadCount",P=>{const M=a.querySelector(".notification-badge");if(M&&(M.style.display=P>0?"flex":"none"),P>0){const he=a.querySelector("#messages-toggle-btn");he&&(he.classList.add("new-message"),setTimeout(()=>{he.classList.remove("new-message")},4e3))}});const l=document.createElement("div");if(l.innerHTML=`
  ...
  `,document.body.appendChild(l),e=a.querySelector("#messages-toggle-btn"),n=l.querySelector("#messages-box"),i=l.querySelector("#messages"),r=l.querySelector("#messages-form"),s=l.querySelector("#messages-input"),!e||!n||!i||!r||!s)return console.error("Messages UI elements not found."),null;function u(){if(!e||!n||n.classList.contains("hidden"))return;const P=e.getBoundingClientRect(),M=n.getBoundingClientRect(),he=8;let fe=P.top-M.height-he;fe<8&&(fe=P.bottom+he);let je=P.left+P.width/2-M.width/2;const di=window.innerWidth-M.width-8;je<8&&(je=8),je>di&&(je=di),n.style.top=`${Math.round(fe)}px`,n.style.left=`${Math.round(je)}px`}function d(){o||(o=!0,window.addEventListener("resize",u,{passive:!0}),window.addEventListener("scroll",u,{passive:!0}),window.addEventListener("orientationchange",u,{passive:!0}))}function h(){o&&(o=!1,window.removeEventListener("resize",u),window.removeEventListener("scroll",u),window.removeEventListener("orientationchange",u))}const f=document.querySelector(".top-bar .top-right-menu")||document.querySelector(".top-right-menu");a&&f&&f.appendChild(a);const p=new MutationObserver(P=>{P.forEach(M=>{M.type==="attributes"&&M.attributeName==="class"&&(n.classList.contains("hidden")||(a.unreadCount=0))})});p.observe(n,{attributes:!0});function y(){n.classList.toggle("hidden"),n.classList.contains("hidden")?(s.blur(),h(),n.style.top="",n.style.left="",n.style.bottom="",n.style.right=""):(s.focus(),WA?requestAnimationFrame(()=>{VA(n)||(u(),d())}):(u(),d()))}vs(n,()=>{E(n),h(),n.style.top="",n.style.left="",n.style.bottom="",n.style.right=""},{ignore:[a],esc:!0});function m(){R(a)}function T(){E(a)}function $(P){const M=document.createElement("p");M.textContent=P,P.startsWith("You:")?M.style.textAlign="right":P.startsWith("Partner:")&&(M.style.textAlign="left"),i.appendChild(M),i.scrollTop=i.scrollHeight}function W(P){$(`Partner: ${P}`),nl(n)&&a.unreadCount++}r.addEventListener("submit",P=>{P.preventDefault();const M=s.value.trim();M&&(t(M),$(`You: ${M}`),s.value="")});function w(){a&&a.parentNode&&a.parentNode.removeChild(a),h(),p.disconnect(),a.dispose(),l&&l.parentNode&&l.parentNode.removeChild(l)}return{appendChatMessage:$,receiveMessage:W,toggleMessages:y,showMessagesToggle:m,hideMessagesToggle:T,cleanup:w}}function qg(t,e,n=null){let i,r;return e==="initiator"?(i=t.createDataChannel("chat"),r=Vd(o=>{i.readyState==="open"&&i.send(o)}),i.onopen=()=>{r.showMessagesToggle(),r.appendChatMessage("💬 Chat connected")},i.onmessage=o=>r.receiveMessage(o.data)):e==="joiner"&&(t.ondatachannel=s=>{i=s.channel,r=Vd(o=>i.send(o)),n&&n(r),i.onopen=()=>{r.showMessagesToggle(),r.appendChatMessage("💬 Chat connected")},i.onmessage=o=>r.receiveMessage(o.data)}),{dataChannel:i,messagesUI:r}}const El={iceServers:[{urls:"stun:stun.l.google.com:19302"}]},Ao=new WeakMap;function Yg(t,e,n){Ao.has(t)||Ao.set(t,{});const i=Ao.get(t),r=e==="offer"?"lastOffer":"lastAnswer";return i[r]===n?!0:(i[r]=n,!1)}function Kg(t,e){return t?e==="offer"?t.signalingState==="stable":t.signalingState==="have-local-offer"||t.signalingState==="stable":!1}function vl(t,e){e.getTracks().forEach(n=>{t.addTrack(n,e)})}async function Jg(t){const e=await t.createOffer();return await t.setLocalDescription(e),e}async function Xg(t){const e=await t.createAnswer();return await t.setLocalDescription(e),e}async function Qg(t,e,n){if(Yg(t,e.type,e.sdp))return console.debug(`Ignoring duplicate ${e.type} - already processed`),!1;if(!Kg(t,e.type))return console.warn(`Ignoring ${e.type} - unexpected signaling state:`,t.signalingState),!1;try{return await t.setRemoteDescription(new RTCSessionDescription(e)),n(t),console.debug(`Remote description set (${e.type})`),!0}catch(i){return console.error(`Failed to set remote description (${e.type}):`,i),!1}}function Zg(){return Math.random().toString(36).substring(2,9)}const jA=Object.freeze(Object.defineProperty({__proto__:null,addLocalTracks:vl,createAnswer:Xg,createOffer:Jg,generateRoomId:Zg,isDuplicateSdp:Yg,isValidSignalingState:Kg,rtcConfig:El,setRemoteDescription:Qg},Symbol.toStringTag,{value:"Module"}));async function zA({localStream:t,remoteVideoEl:e,mutePartnerBtn:n,setupRemoteStream:i,setupWatchSync:r,targetRoomId:s=null}){if(!t)return{success:!1};const o=new RTCPeerConnection(El),a="initiator",c=s||Zg(),l=de();vl(o,t);const{dataChannel:u,messagesUI:d}=qg(o,a);if(!i(o,e,n))return console.error("Error setting up remote stream"),o.close(),{success:!1};_l(o,a,c),Gg(o);const f=await Jg(o);await q.createNewRoom(f,l,c),r(c,a,l);const p=`${window.location.origin}${window.location.pathname}?room=${c}`;return{success:!0,pc:o,roomId:c,roomLink:p,dataChannel:u,messagesUI:d,role:a}}async function GA({roomId:t,localStream:e,remoteVideoEl:n,mutePartnerBtn:i,setupRemoteStream:r,setupWatchSync:s,onMessagesUIReady:o=null}){if(!e)return{success:!1};if(!t)return{success:!1};const a=await q.checkRoomStatus(t);if(!a.exists)return{success:!1};if(!a.hasMembers)return{success:!1};let c;try{c=await q.getRoomData(t)}catch(T){return B("Error: "+T.message),{success:!1}}const l=c.offer;if(!l)return{success:!1};const u=new RTCPeerConnection(El),d="joiner",h=de();vl(u,e);const{dataChannel:f,messagesUI:p}=qg(u,d,o);if(!r(u,n,i))return console.error("Error setting up remote stream for joiner"),u.close(),{success:!1};_l(u,d,t),Gg(u),await Qg(u,l,yl);const m=await Xg(u);try{await q.saveAnswer(t,m)}catch(T){return console.error("Failed to save answer to Firebase:",T),u.close(),{success:!1}}return s(t,d,h),await q.joinRoom(t,h),{success:!0,pc:u,roomId:t,dataChannel:f,messagesUI:p,role:d}}class qA{constructor(){this.listeners=new Map}on(e,n){this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(n)}off(e,n){this.listeners.has(e)&&this.listeners.get(e).delete(n)}emit(e,n){if(this.listeners.has(e))for(const i of Array.from(this.listeners.get(e)))try{i(n)}catch(r){console.warn("CallController listener error",r)}}}class YA{constructor(){this.emitter=new qA,this.resetState()}resetState(){this.state="idle",this.roomId=null,this.roomLink=null,this.role=null,this.partnerId=null,this.pc=null,this.dataChannel=null,this.messagesUI=null,this.localVideoEl=null,this.remoteVideoEl=null,this.isHangingUp=!1,this.isCleaningUp=!1,this.listeners=new Map}getState(){return{state:this.state,roomId:this.roomId,roomLink:this.roomLink,role:this.role,partnerId:this.partnerId,hasPc:!!this.pc,isHangingUp:this.isHangingUp,isCleaningUp:this.isCleaningUp}}on(e,n){this.emitter.on(e,n)}off(e,n){this.emitter.off(e,n)}setPartnerId(e){this.partnerId=e}setupCancellationListener(e){if(!e)return;const n=oe(ae,`rooms/${e}/cancellation`);let i=!1;const r=async s=>{const o=s.val();if(o&&!i){i=!0;try{this.remoteVideoEl&&(this.remoteVideoEl.srcObject=null)}catch(a){console.warn("Failed to clear remote video after cancellation",a)}try{this.pc&&this.pc.close()}catch{}try{await this.cleanupCall({reason:o.reason||"remote_cancelled"})}catch(a){console.warn("Failed to trigger CallController cleanup",a)}}};Mr(n,r,e),this.listeners.has("cancellation")||this.listeners.set("cancellation",[]),this.listeners.get("cancellation").push({ref:n,callback:r,roomId:e})}setupAnswerListener(e,n,i){if(!e||!n)return;const r=oe(ae,`rooms/${e}/answer`),s=async o=>{const a=o.val();if(a){const{setRemoteDescription:c}=await et(async()=>{const{setRemoteDescription:l}=await Promise.resolve().then(()=>jA);return{setRemoteDescription:l}},void 0);await c(n,a,i)}};Mr(r,s,e),this.listeners.has("answer")||this.listeners.set("answer",[]),this.listeners.get("answer").push({ref:r,callback:s,roomId:e})}setupRejectionListener(e){if(!e)return;const n=oe(ae,`rooms/${e}/rejection`);let i=!1;const r=async s=>{const o=s.val();if(o&&!i&&(i=!0,this.pc?.connectionState!=="connected")){try{const{onCallRejected:a}=await et(async()=>{const{onCallRejected:c}=await Promise.resolve().then(()=>LA);return{onCallRejected:c}},void 0);await a(o.reason||"user_rejected")}catch{}try{await q.leaveRoom(de(),e)}catch{}try{this.pc&&this.pc.close()}catch{}}};Mr(n,r,e),this.listeners.has("rejection")||this.listeners.set("rejection",[]),this.listeners.get("rejection").push({ref:n,callback:r,roomId:e})}setupMemberJoinedListener(e){if(!e)return;const n=de(),i=r=>{r.key!==n&&(this.setPartnerId(r.key),this.emitter.emit("memberJoined",{memberId:r.key,roomId:e}))};q.onMemberJoined(e,i),this.listeners.has("member-joined")||this.listeners.set("member-joined",[]),this.listeners.get("member-joined").push({callback:i,roomId:e})}setupMemberLeftListener(e){if(!e)return;const n=de(),i=r=>{r.key!==n&&this.pc?.connectionState==="connected"&&this.emitter.emit("memberLeft",{memberId:r.key,roomId:e})};q.onMemberLeft(e,i),this.listeners.has("member-left")||this.listeners.set("member-left",[]),this.listeners.get("member-left").push({callback:i,roomId:e})}removeTrackedListeners(){try{for(const[e,n]of this.listeners.entries())for(const i of n)try{i.ref&&Vs(i.ref,"value",i.callback)}catch(r){console.warn(`Failed to remove ${e} listener`,r)}}catch(e){console.warn("Failed to remove tracked listeners",e)}finally{this.listeners.clear()}if(this.roomId)try{zs(this.roomId)}catch(e){console.warn("Failed to remove RTDB listeners for room",e)}}async createCall(e={}){this.state="creating";try{e.localVideoEl&&(this.localVideoEl=e.localVideoEl),e.remoteVideoEl&&(this.remoteVideoEl=e.remoteVideoEl);const n=await zA(e);if(!n||!n.success)return this.state="idle",this.emitter.emit("error",{phase:"createCall",detail:n}),this.emitCallFailed("createCall",n),n;this.pc=n.pc,this.roomId=n.roomId,this.roomLink=n.roomLink||null,this.role=n.role||"initiator",this.dataChannel=n.dataChannel||null,this.messagesUI=n.messagesUI||null,this.state="waiting";const{drainIceCandidateQueue:i}=await et(async()=>{const{drainIceCandidateQueue:r}=await Promise.resolve().then(()=>HA);return{drainIceCandidateQueue:r}},void 0);return this.setupAnswerListener(this.roomId,this.pc,i),this.setupCancellationListener(this.roomId),this.setupRejectionListener(this.roomId),this.setupMemberJoinedListener(this.roomId),this.setupMemberLeftListener(this.roomId),this.emitter.emit("created",{roomId:this.roomId,roomLink:this.roomLink,role:this.role}),n}catch(n){throw this.state="idle",this.emitter.emit("error",{phase:"createCall",error:n}),this.emitCallFailed("createCall",n),n}}async answerCall(e={}){this.state="joining";try{e.localVideoEl&&(this.localVideoEl=e.localVideoEl),e.remoteVideoEl&&(this.remoteVideoEl=e.remoteVideoEl);const i=await GA({...e,onMessagesUIReady:r=>{this.messagesUI=r}});return!i||!i.success?(this.state="idle",this.emitter.emit("error",{phase:"answerCall",detail:i}),this.emitCallFailed("answerCall",i),i):(this.pc=i.pc,this.roomId=i.roomId,this.role=i.role||"joiner",this.dataChannel=i.dataChannel||null,!this.messagesUI&&i.messagesUI&&(this.messagesUI=i.messagesUI),this.state="connected",this.setupCancellationListener(this.roomId),this.setupMemberJoinedListener(this.roomId),this.setupMemberLeftListener(this.roomId),this.emitter.emit("answered",{roomId:this.roomId,role:this.role}),i)}catch(n){throw this.state="idle",this.emitter.emit("error",{phase:"answerCall",error:n}),this.emitCallFailed("answerCall",n),n}}async hangUp({emitCancel:e=!0,reason:n="user_hung_up"}={}){if(!this.isHangingUp){this.isHangingUp=!0;try{if(e&&this.roomId)try{await q.cancelCall(this.roomId,de(),n)}catch(i){console.warn("CallController: cancelCall failed (non-fatal)",i)}await this.cleanupCall({reason:n}),this.emitter.emit("hangup",{roomId:this.roomId,reason:n})}catch(i){throw this.emitter.emit("error",{phase:"hangUp",error:i}),i}finally{this.isHangingUp=!1}}}isRemoteHangup(e){return e?["remote","cancelled","partner_disconnected","connection_failed"].some(i=>e.includes(i)):!1}emitCallFailed(e,n){this.emitter.emit("callFailed",{phase:e,error:n?.message||n?.error||n||"Unknown error"})}async cleanupCall({reason:e}={}){if(!this.isCleaningUp){this.isCleaningUp=!0;try{const n=this.roomId,i=this.partnerId;this.removeTrackedListeners();try{await q.leaveRoom(de(),this.roomId)}catch{}try{if(this.pc){try{this.pc.close()}catch{}this.pc=null}}catch{}try{this.remoteVideoEl&&(this.remoteVideoEl.srcObject=null)}catch(r){console.warn("CallController: failed to clear remote video",r)}try{this.localVideoEl&&(this.localVideoEl.srcObject=null)}catch(r){console.warn("CallController: failed to clear local video",r)}try{const{cleanupLocalStream:r}=await et(async()=>{const{cleanupLocalStream:s}=await Promise.resolve().then(()=>TA);return{cleanupLocalStream:s}},void 0);r()}catch(r){console.warn("CallController: failed to cleanup local stream",r)}try{const{resetLocalStreamInitFlag:r}=await et(async()=>{const{resetLocalStreamInitFlag:s}=await Promise.resolve().then(()=>NP);return{resetLocalStreamInitFlag:s}},void 0);r()}catch{}if(this.isRemoteHangup(e)&&this.emitter.emit("remoteHangup",{roomId:n,partnerId:i,reason:e}),this.messagesUI&&this.messagesUI.cleanup)try{this.messagesUI.cleanup()}catch(r){console.warn("CallController: failed to cleanup messages UI",r)}this.resetState(),this.emitter.emit("cleanup",{roomId:n,partnerId:i,reason:e})}catch(n){throw this.emitter.emit("error",{phase:"cleanupCall",error:n}),n}finally{this.isCleaningUp=!1}}}}const re=new YA,ka={default:{echoCancellation:!0,noiseSuppression:!0,autoGainControl:!0},withVoiceIsolationIfSupported:{echoCancellation:!0,noiseSuppression:!0,autoGainControl:!0,voiceIsolation:!0,restrictOwnAudio:!0,googHighpassFilter:!0,googTypingNoiseDetection:!0,highpassFilter:!0,typingNoiseDetection:!0}};function em(){const t=navigator.mediaDevices.getSupportedConstraints();return["voiceIsolation","highpassFilter","typingNoiseDetection"].every(i=>t[i])?ka.withVoiceIsolationIfSupported:ka.default}const KA=()=>ka.default,JA={desktop:{landscape:{width:{ideal:1920},height:{ideal:1080},frameRate:{min:10,ideal:30},aspectRatio:{ideal:16/9}},portrait:{width:{ideal:1080},height:{ideal:1920},frameRate:{min:10,ideal:30},aspectRatio:{ideal:9/16}}},mobile:{portrait:{width:{ideal:1080},height:{ideal:1920},aspectRatio:{ideal:9/16},frameRate:{ideal:30}},landscape:{width:{ideal:1920},height:{ideal:1080},aspectRatio:{ideal:16/9},frameRate:{ideal:30}}}},XA=()=>window.screen?.orientation?.type?.includes("portrait")||window.orientation===0||window.orientation===180;function wl(t){const e=XA()?"portrait":"landscape",i=/Mobi|Android/i.test(navigator.userAgent)?"mobile":"desktop",r=JA[i][e];return{facingMode:t,...r}}function QA(){return!!(navigator.mediaDevices&&navigator.mediaDevices.enumerateDevices)}async function ZA(){return QA()?(await navigator.mediaDevices.enumerateDevices()).filter(e=>e.kind==="videoinput"):[]}async function eP(){const t=await ZA();let e=!1,n=!1;return t.forEach(i=>{const r=i.label.toLowerCase();(r.includes("front")||r.includes("user"))&&(e=!0),(r.includes("back")||r.includes("rear")||r.includes("environment"))&&(n=!0)}),e&&n}async function tP({localStream:t,localVideo:e,currentFacingMode:n,peerConnection:i=null}){if(!t||!e)return console.error("switchCamera: missing localStream or localVideo"),null;const r=n==="user"?"environment":"user";try{const s=await navigator.mediaDevices.getUserMedia({video:wl(r),audio:em()}),o=s.getVideoTracks()[0],a=s.getAudioTracks()[0],c=t.getVideoTracks()[0],l=c?c.enabled:!0,u=t.getAudioTracks()[0],d=u?!u.enabled:!1;if(o&&(o.enabled=l),a&&(a.enabled=!d),t.getTracks().forEach(h=>h.stop()),i){const h=i.getSenders().find(p=>p.track&&p.track.kind==="video");h&&await h.replaceTrack(o);const f=i.getSenders().find(p=>p.track&&p.track.kind==="audio");f&&a&&await f.replaceTrack(a)}return e.srcObject=new MediaStream([o].filter(Boolean)),{newStream:s,facingMode:r}}catch(s){return console.error("Failed to switch camera:",s),null}}let Po=!1,Gt=null,qt=null;function nP({getLocalStream:t,getFacingMode:e}){return Gt&&qt&&Gt.removeEventListener("change",qt),Gt=window.matchMedia("(orientation: portrait)"),qt=()=>{try{const n=typeof t=="function"?t():null,i=typeof e=="function"?e():"user";iP({localStream:n,currentFacingMode:i})}catch(n){console.error("Orientation handler failed:",n)}},Gt.addEventListener("change",qt),()=>{Gt&&qt&&Gt.removeEventListener("change",qt),Gt=null,qt=null}}async function iP({localStream:t,currentFacingMode:e}){if(!(Po||!t?.getVideoTracks()[0])){Po=!0;try{const n=t.getVideoTracks()[0],i=wl(e);B("Applying constraints:",i),await n.applyConstraints(i),B("Video constraints updated successfully")}catch(n){console.error("Failed to apply orientation constraints:",n)}finally{Po=!1}}}let Ra=[];function rP(t,e){const n=e.querySelector("i");n.className=t?"fa fa-microphone-slash":"fa fa-microphone"}function sP({getLocalStream:t,getLocalVideo:e,getRemoteVideo:n,getPeerConnection:i=()=>null,setLocalStream:r=null,micBtn:s,cameraBtn:o,switchCameraBtn:a,mutePartnerBtn:c,fullscreenPartnerBtn:l}){s&&(s.onclick=()=>{const d=t();if(!d)return;const h=d.getAudioTracks()[0];h&&(h.enabled=!h.enabled,rP(!h.enabled,s))}),o&&(o.onclick=()=>{const d=t();if(!d)return;const h=d.getVideoTracks()[0];if(h){h.enabled=!h.enabled;const f=o.querySelector("i");f.className=h.enabled?"fa fa-video":"fa fa-video-slash"}});const u=nP({getLocalStream:t,getFacingMode:Ta});Ra.push(u),a&&(a.onclick=async()=>{const d=await tP({localStream:t(),localVideo:e(),currentFacingMode:Ta(),peerConnection:i()||null});d?(xg(d.facingMode),console.log("Switched camera to facingMode:",d.facingMode),d.newStream&&typeof r=="function"&&r(d.newStream)):console.error("Camera switch failed.")},(async()=>await eP()?R(a):E(a))()),c&&(c.onclick=()=>{const d=n();if(!d)return;d.muted=!d.muted;const h=c.querySelector("i");h.className=d.muted?"fa fa-volume-mute":"fa fa-volume-up"}),l&&(l.onclick=()=>{const d=n();d.requestFullscreen?d.requestFullscreen():d.webkitRequestFullscreen&&d.webkitRequestFullscreen()})}function oP(){Ra.forEach(t=>t()),Ra=[]}let No=null,Tt=null,j=null,F=null,jd=!1,Rr=!1,Ge=[],Aa="",ue=-1,Pa=[];const aP="AIzaSyBPUjW7ac277WIYTbN4M8dUomK39qRQjhA",cP="https://www.googleapis.com/youtube/v3";async function lP(){if(jd||Rr)return!1;Rr=!0;const{initializeYouTubeElements:t}=await et(async()=>{const{initializeYouTubeElements:o}=await Promise.resolve().then(()=>cA);return{initializeYouTubeElements:o}},void 0),e=await t();if(No=e.searchContainer,Tt=e.searchBtn,j=e.searchQuery,F=e.searchResults,!No||!Tt||!j||!F)return console.error("YouTube search elements not found in DOM"),Rr=!1,!1;const n=o=>/^https?:\/\//i.test(o),i=o=>{(F?.querySelectorAll(".search-result-item")||[]).forEach((c,l)=>{l===o?(c.classList.add("focused"),c.scrollIntoView({block:"nearest"})):c.classList.remove("focused")}),ue=o??-1};Tt.onclick=async()=>{const o=j.value.trim();if(nl(j)){R(j),j.focus();return}if(!o){Br(),E(j);return}if(qd()&&o===Aa)Na(Ge);else if(!n(o))await zd(o);else{await Ca({url:o}),E(F),j.value="",E(j),ue=-1;return}},No.addEventListener("keydown",async o=>{const a=F.querySelectorAll(".search-result-item");if(a.length>0&&(o.key==="ArrowDown"||o.key==="ArrowUp")){if(o.key==="ArrowDown"){let c=ue+1;c>=a.length&&(c=0),i(c)}else if(o.key==="ArrowUp"){let c=ue-1;c<0&&(c=ue===-1?0:a.length-1),i(c)}return}if(o.key==="Enter"){if(a.length>0&&ue>=0){a[ue].click(),E(j),E(F),ue=-1;return}const c=j.value.trim();if(c)if(qd()&&c===Aa)Na(Ge);else if(!n(c))await zd(c);else{await Ca({url:c}),E(F),ue=-1,j.value="",E(j);return}}else o.key==="Escape"&&(dP()?Br():j.value?j.value="":E(j))}),j.addEventListener("input",()=>{j.value.trim()===""&&Br(),ue=-1});const r=vs(j,()=>E(j),{ignore:[Tt],esc:!1});Pa.push(r);const s=vs(F,()=>E(F),{ignore:[Tt],esc:!1});return Pa.push(s),Rr=!1,jd=!0,!0}async function zd(t){if(!Tt||!F){console.error("Search elements not initialized");return}Ge=[],Aa=t,Tt.disabled=!0,F.innerHTML='<div class="search-loading">Searching YouTube...</div>',R(F);try{const e=await fetch(`${cP}/search?part=snippet&maxResults=10&q=${encodeURIComponent(t)}&type=video&key=${aP}`);if(!e.ok)throw e.status===403?new Error("YouTube API quota exceeded. Please try again later."):e.status===400?new Error("Invalid API key or request."):new Error(`YouTube API error: ${e.status}`);const n=await e.json();if(!n.items||n.items.length===0){Gd("No videos found"),Ge=[];return}Ge=n.items.map(i=>({id:i.id.videoId,title:i.snippet.title,thumbnail:i.snippet.thumbnails.medium.url,channel:i.snippet.channelTitle,url:`https://www.youtube.com/watch?v=${i.id.videoId}`})),Na(Ge)}catch(e){console.error("YouTube search failed:",e),Gd(e.message||"Search failed. Please try again.")}finally{Tt.disabled=!1}}function Na(t){if(!F){console.error("Search results element not initialized");return}if(!t||t.length===0){F.innerHTML='<div class="search-no-results">No results found</div>',Ge=[],ue=-1;return}F.innerHTML="",t.forEach(n=>{const i=document.createElement("div");i.className="search-result-item",i.innerHTML=`
      <img src="${n.thumbnail}" alt="${n.title}" class="result-thumbnail">
      <div class="search-result-info">
        <div class="search-result-title">${n.title}</div>
        <div class="search-result-channel">${n.channel}</div>
      </div>
    `,i.onclick=async()=>{if(await Ca(n),E(F),ue=-1,!j){console.error("Search query element not initialized");return}j.value="",E(j)},F.appendChild(i)}),R(F),ue=0,F.querySelectorAll(".search-result-item").forEach((n,i)=>{i===ue?(n.classList.add("focused"),n.scrollIntoView({block:"nearest"})):n.classList.remove("focused")})}function Gd(t){if(Ge=[],ue=-1,!F){console.error("Search results element not initialized");return}F.innerHTML=`<div class="search-error">${t}</div>`,R(F)}function Br(){Ge=[],ue=-1,F&&(F.innerHTML="",E(F))}function uP(){Br(),Pa.forEach(t=>t())}function dP(){return!nl(F)}function qd(){return Ge.length>0}function hP({parent:t,manager:e=null,onClick:n=null,hideWhenAllRead:i=!1}={}){let r=e;const s=el({initialProps:{unreadCount:0,isHidden:!0},template:`
      <button
  ...
  `,document.head.appendChild(t),Yd=!0}function wP(t){t.showModal||(t.showModal=function(){this.setAttribute("open",""),this.style.display="block",this.style.position="fixed",this.style.top="50%",this.style.left="50%",this.style.transform="translate(-50%, -50%)";const e=getComputedStyle(document.documentElement).getPropertyValue("--z-ui-overlay").trim();this.style.zIndex=e||"1000"},t.close=function(){this.removeAttribute("open"),this.style.display="none"})}async function bP(t,e=null){if(navigator.clipboard&&navigator.clipboard.writeText)try{return await navigator.clipboard.writeText(t),!0}catch(n){return console.warn("Clipboard API failed, using fallback:",n),!1}if(!e)return!1;try{return e.select(),e.setSelectionRange(0,99999),document.execCommand("copy")}catch(n){return console.error("Fallback copy failed:",n),!1}}function SP(){const t=window.matchMedia&&window.matchMedia("(display-mode: standalone)").matches||navigator.standalone===!0,e=/iphone|ipad|ipod/i.test(navigator.userAgent||"");if(!t||!e||!window.location.hostname.includes("github.io"))return;const i="https://vidu-aae11.web.app",r=i.replace(/\/$/,"");let s;try{s=new URL(r).hostname}catch(l){console.error("[PWA Redirect] Invalid VITE_APP_HOSTING_URL:",i,l);return}if(window.location.hostname===s)return;const o="/HangVidU/";let a=window.location.pathname;a.startsWith(o)?a="/"+a.slice(o.length):a==="/HangVidU"&&(a="/");let c;try{c=new URL(a+window.location.search+window.location.hash,r).toString()}catch(l){console.error("[PWA Redirect] Failed to construct target URL:",l);return}console.log("[PWA Redirect] iOS standalone PWA on gh-pages → redirecting to Firebase Hosting:",c),window.location.replace(c)}MR(!0);_().disable();let bl=[];async function CP(){TP();const t=Ig(),n=["localVideoEl","remoteVideoEl","localBoxEl","remoteBoxEl","chatControls","lobbyDiv","titleAuthBar"].filter(i=>!t[i]);if(n.length>0)return console.error("Critical elements missing:",n),!1;try{{const{setupPWA:s}=await et(async()=>{const{setupPWA:o}=await import("./PWA-BySiUv7R.js");return{setupPWA:o}},[]);await s()}lP(),RP(),await vg;const i=oA(Js);i&&bl.push(i.dispose);const r=document.querySelector(".top-right-menu");if(r){const s=hP({parent:r,hideWhenAllRead:!0});pP.setToggle(s)}return!0}catch(i){return console.error("Initialization error:",i),!1}}let La=!1;function tm(){La=!1}async function Hr(){La||(La=!0,await mP(be),sP({getLocalStream:Zs,getLocalVideo:()=>be,getRemoteVideo:()=>Q,getPeerConnection:()=>re.getState().pc,setLocalStream:_s,micBtn:li,cameraBtn:ui,switchCameraBtn:ci,mutePartnerBtn:Ve,fullscreenPartnerBtn:Xs}),be&&(be.addEventListener("enterpictureinpicture",()=>X&&E(X)),be.addEventListener("leavepictureinpicture",()=>{X&&!(mr()&&pl())&&R(X)})))}function TP(){E(z),E(X),E(we),E(Ae)}function nm(t){(t?.name==="NotAllowedError"||t?.name==="PermissionDeniedError")&&alert('Camera/microphone access is required for video calls. Please click "Allow" when prompted, or check your browser settings.'),tm()}function Wr(t=null){return{localStream:Zs(),localVideoEl:be,remoteVideoEl:Q,mutePartnerBtn:Ve,setupRemoteStream:_P,setupWatchSync:pA,targetRoomId:t}}function Vr(t,e=!1){return t.success?(e&&t.roomLink&&EP(t.roomLink,{onCopy:()=>B("Link ready! Share with your partner."),onCancel:()=>B("Link ready! Use the copy button to use it, or create a new one.")}),!0):!1}async function eo(t,{forceInitiator:e=!1}={}){try{await Hr()}catch(s){return console.error("Failed to initialize local media stream:",s),nm(s),!1}const n=Date.now();if(e){_().logRoomCreation(t,!0,{creationTime:n,listenerAttachTime:n,timeDiff:0},{trigger:"force_initiator",reason:"calling_saved_contact"}),await Hr();const s=await re.createCall(Wr(t));return Vr(s,!1)}let i=await q.checkRoomStatus(t);if(i.exists&&!i.hasMembers){let o=0;for(;o<3&&!i.hasMembers;)await new Promise(a=>setTimeout(a,250*(o+1))),i=await q.checkRoomStatus(t),o++}if(!i.exists||!i.hasMembers){_().logRoomCreation(t,!0,{creationTime:n,listenerAttachTime:n,timeDiff:0},{trigger:"room_empty_or_nonexistent",roomExists:i.exists,memberCount:i.memberCount||0}),await Hr();const s=await re.createCall(Wr(t));return Vr(s,!0)}_().log("ROOM","JOINING_EXISTING",{roomId:t,memberCount:i.memberCount,roomExists:i.exists});const r=await re.answerCall({roomId:t,...Wr()});return Vr(r,!1)}const Se=new Set,im=new Map;function Kd(t){t&&(zs(t),Se.delete(t),im.delete(t),_().log("LISTENER","INCOMING_CLEANUP",{roomId:t,remainingListeners:Se.size}))}function IP(){B(`[LISTENER] Removing all incoming listeners (${Se.size} rooms)`);const t=Array.from(Se);t.forEach(e=>{zs(e)}),Se.clear(),im.clear(),_().log("LISTENER","ALL_INCOMING_CLEANUP",{roomsCleared:t.length})}async function kP(t){const e=Date.now(),n=e+1440*60*1e3,i=Qe();if(i){const r=Bc(i,t);await _t(r,{roomId:t,savedAt:e,expiresAt:n});return}try{const r=localStorage.getItem("recentCalls")||"{}",s=JSON.parse(r);s[t]={roomId:t,savedAt:e,expiresAt:n},localStorage.setItem("recentCalls",JSON.stringify(s))}catch(r){console.warn("Failed to save recent call to localStorage",r)}}async function Lo(t){const e=Qe();if(e){try{await zn(Bc(e,t))}catch(n){console.warn("Failed to remove recent call from RTDB",n)}return}try{const n=localStorage.getItem("recentCalls")||"{}",i=JSON.parse(n);i[t]&&(delete i[t],localStorage.setItem("recentCalls",JSON.stringify(i)))}catch(n){console.warn("Failed to remove recent call from localStorage",n)}}function qn(t){t&&(Se.has(t)&&(Se.delete(t),zs(t)),B(`[LISTENER] Attaching listener for room: ${t} (total: ${Se.size+1})`),Se.add(t),_().logListenerAttachment(t,"member_join",Se.size,{action:"incoming_call_listener_attached"}),q.onMemberJoined(t,async e=>{const n=e.key,i=e.val?e.val():null,r=de();if(n&&n!==r){_().logMemberJoinEvent(t,n,i||{},{detectedBy:"incoming_call_listener",currentUserId:r});const s=i&&typeof i.joinedAt=="number"?i.joinedAt:null,o=2e4;let a=!1,c="none",l=0;if(s&&(l=Date.now()-s,a=l<o,c="joinedAt"),!a){const W=await Vg(n,t),w=await jg(t);a=W||w,c=W?"outgoingState":w?"roomCreatedAt":"failed"}const u={isFresh:a,method:c,age:l,reason:a?"call_is_fresh":"call_is_stale"};if(_().logIncomingCallEvent(n,t,u,{memberData:i,joinedAt:s,CALL_FRESH_MS:o}),!a){_().logNotificationDecision("REJECT","stale_call",t,{age:l,validationMethod:c,joiningUserId:n});return}let d;try{d=await q.getRoomData(t)}catch{return}if(!d||typeof d!="object")return;const h=!!d.offer,f=!!d.answer,p=d.createdBy;if(!h||f||p===r)return;const y=re.getState();if(!!y.pc&&y.pc.connectionState==="connected"){_().logNotificationDecision("REJECT","already_in_call",t,{joiningUserId:n,currentCallState:y.pc?.connectionState});return}_().logNotificationDecision("SHOW","fresh_call_detected",t,{joiningUserId:n,freshnessResult:u});const T=await MA(t,n);Nn.playIncoming(),$d.startCallIndicators(T);let $=!1;try{$=await ml(`Incoming call from ${T}.

Accept?`)}finally{Nn.stop(),$d.stopCallIndicators()}if($)Kd(t),_().logNotificationDecision("ACCEPT","user_accepted",t,{joiningUserId:n}),eo(t).catch(W=>{console.warn("Failed to answer incoming call:",W),_().logFirebaseOperation("join_room_on_accept",!1,W,{roomId:t,joiningUserId:n})});else{_().logNotificationDecision("REJECT","user_rejected",t,{joiningUserId:n});try{await q.rejectCall(t,de(),"user_rejected")}catch(W){console.warn("Failed to signal rejection via RTDB:",W)}await Lo(t).catch(W=>{console.warn("Failed to remove recent call on rejection:",W)})}}}),q.onCallCancelled(t,async e=>{if(e&&typeof e.val=="function"&&e.val()){try{const{dismissActiveConfirmDialog:i}=await et(async()=>{const{dismissActiveConfirmDialog:r}=await Promise.resolve().then(()=>DA);return{dismissActiveConfirmDialog:r}},void 0);typeof i=="function"&&i()}catch{}await Lo(t).catch(()=>{})}}),q.onMemberLeft(t,async e=>{const n=e.key,i=de();if(!(!n||n===i))try{(await q.checkRoomStatus(t)).hasMembers||(await Lo(t),Kd(t),B(`Removed saved recent call and listeners for room ${t} because it is now empty`))}catch(r){console.warn("Failed to evaluate room status on member leave",r)}}))}async function Jd(){const t=Date.now();_().log("LISTENER","STARTUP_BEGIN",{timestamp:t,currentListenerCount:Se.size});try{if(typeof window<"u"){const{getCurrentUserAsync:n}=await et(async()=>{const{getCurrentUserAsync:i}=await Promise.resolve().then(()=>qR);return{getCurrentUserAsync:i}},void 0);await n()}}catch{}const e=Qe();if(_().log("LISTENER","AUTH_STATE_DETERMINED",{isLoggedIn:!!e,userId:e||"guest"}),e){const n=xI(e);try{const i=await nn(n),r=i.exists()?i.val():null,s=new Set;if(r)for(const[o,a]of Object.entries(r)){if(!a||a.expiresAt&&a.expiresAt<Date.now()){await zn(Bc(e,o)).catch(()=>{});continue}s.add(o)}try{const o=await Ki();Object.values(o||{}).forEach(a=>{a?.roomId&&s.add(a.roomId)})}catch{}s.forEach(o=>qn(o)),_().log("LISTENER","STARTUP_COMPLETE",{storage:"rtdb",roomsToListen:Array.from(s),totalListeners:Se.size,duration:Date.now()-t})}catch(i){console.warn("Failed to read recent calls from RTDB",i),_().logFirebaseOperation("read_recent_calls",!1,i,{storage:"rtdb",userId:e})}return}try{const n=localStorage.getItem("recentCalls")||"{}",i=JSON.parse(n),r={},s=new Set;for(const[o,a]of Object.entries(i||{}))!a||a.expiresAt&&a.expiresAt<Date.now()||(r[o]=a,s.add(o));try{const o=await Ki();Object.values(o||{}).forEach(a=>{a?.roomId&&s.add(a.roomId)})}catch{}s.forEach(o=>qn(o)),localStorage.setItem("recentCalls",JSON.stringify(r)),_().log("LISTENER","STARTUP_COMPLETE",{storage:"localStorage",roomsToListen:Array.from(s),totalListeners:Se.size,duration:Date.now()-t,expiredRoomsRemoved:Object.keys(i||{}).length-s.size})}catch(n){console.warn("Failed to read recent calls from localStorage",n),_().logFirebaseOperation("read_recent_calls",!1,n,{storage:"localStorage"})}}function Oo(){return H&&we&&!we.classList.contains("hidden")&&H.src&&H.src.trim()!==""}let Xd=!1;function RP(){if(Xd)return;const t=()=>{const e=document.activeElement;return e&&(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)};document.addEventListener("keydown",e=>{if(!t()&&((e.key==="w"||e.key==="W")&&(console.log("=== W KEY PRESSED ==="),console.log("lastWatched:",Qt()),console.log("isYTVisible():",ko()),console.log("isSharedVideoVisible():",Oo()),console.log("isWatchModeActive():",mr()),Qt()==="yt"?ko()?(gs(),Oi()):(Pg(),Ia()):Qt()==="url"&&(Oo()?(E(we),Oi()):(R(we),Ia()))),e.key==="m"||e.key==="M")){const n=re.getState();n.messagesUI&&n.messagesUI.toggleMessages()}e.key==="Escape"&&(Qt()==="yt"&&ko()?(pr(),gs()):Qt()==="url"&&Oo()&&(H.pause(),E(we)),Oi())}),Xd=!0}const rm=async()=>{try{await Hr();const t=await re.createCall(Wr());Vr(t,!0)}catch(t){console.error("Failed to start call:",t),nm(t)}};Le.onclick=rm;Vt.onclick=rm;fn&&(fn.onclick=()=>{Qt()==="yt"?(pr(),gs()):Qt()==="url"&&(H.pause(),E(we)),Oi()});We.onclick=async()=>{console.debug("Hanging up..."),await re.hangUp({emitCancel:!0,reason:"user_hung_up"})};async function AP(){const e=new URLSearchParams(window.location.search).get("room");if(!e)return!1;const n=await eo(e);return n||(Ks(),Wg()),n}SP();window.onload=async()=>{if(!await CP()){Le.disabled=!0,console.error("Initialization failed. Cannot start chat.");return}await Jd().catch(r=>console.warn("Failed to start saved-room listeners",r)),Ji(Ke).catch(r=>{console.warn("Failed to render contacts list:",r)});let e=null;const n=Zc(async({isLoggedIn:r,user:s})=>{try{const o=e===null,a=e===!0&&!r,c=e===!1&&r;e=r,await Ji(Ke),a?(B("[AUTH] User logged out - cleaning up incoming listeners"),IP()):c?(B("[AUTH] User logged in - re-attaching incoming listeners"),await Jd().catch(l=>console.warn("Failed to re-attach saved-room listeners on login",l))):o&&r&&B("[AUTH] Initial load with logged-in user")}catch(o){console.warn("Failed to handle auth change:",o)}});bl.push(()=>{try{typeof n=="function"&&n()}catch{}}),await AP()};window.addEventListener("beforeunload",async t=>{const e=re.getState();if(e.pc&&e.pc.connectionState==="connected")return t.preventDefault(),t.returnValue="You are in an active call. Are you sure you want to leave?",t.returnValue;await PP()});re.on("memberJoined",({memberId:t,roomId:e})=>{console.debug("CallController memberJoined event",{memberId:t,roomId:e}),re.setPartnerId(t),fl(),gl().catch(n=>console.warn("Failed to clear calling state:",n)),kP(e).catch(n=>console.warn("Failed to save recent call:",n))});re.on("memberLeft",({memberId:t})=>{console.info("Partner has left the call")});re.on("cleanup",({roomId:t,partnerId:e,reason:n})=>{Dt(),Ug(),Wg(),Ks();const i=re.getState();i.messagesUI&&typeof i.messagesUI.cleanup=="function"&&(i.messagesUI.cleanup(),i.messagesUI=null),e&&t&&setTimeout(()=>{xA(e,t,Ke).catch(r=>{console.warn("Failed to save contact after cleanup:",r)})},500)});async function PP(){await re.hangUp({emitCancel:!0,reason:"page_unload"}),oP(),OI(),document.pictureInPictureElement&&document.exitPictureInPicture().catch(e=>console.error(e));const t=re.getState();t.messagesUI&&t.messagesUI.cleanup&&t.messagesUI.cleanup(),window.history.replaceState({},document.title,window.location.pathname),H.src="",Bg(),be&&be.srcObject&&(be.srcObject=null),Q&&Q.srcObject&&(Q.srcObject=null),Oi(),Ks(),fA("none"),cl(),Ag(!1),uP(),bl.forEach(e=>e())}const NP=Object.freeze(Object.defineProperty({__proto__:null,joinOrCreateRoomWithId:eo,listenForIncomingOnRoom:qn,resetLocalStreamInitFlag:tm},Symbol.toStringTag,{value:"Module"}));export{et as _,el as c,B as d,E as h,LP as i,pP as n,R as s};
