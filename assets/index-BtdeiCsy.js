 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zc(n){const e={},t={__esModule:!0,initializeApp:r,app:s,registerVersion:ve,setLogLevel:uo,onLog:co,apps:null,SDK_VERSION:Ki,INTERNAL:{registerComponent:a,removeApp:i,useAsService:l,modularAPIs:Kc}};t.default=t,Object.defineProperty(t,"apps",{get:o});function i(c){delete e[c]}function s(c){if(c=c||Ne,!X(e,c))throw Js.create("no-app",{appName:c});return e[c]}s.App=n;function r(c,u={}){const d=Ji(c,u);if(X(e,d.name))return e[d.name];const h=new n(d,t);return e[d.name]=h,h}function o(){return Object.keys(e).map(c=>e[c])}function a(c){const u=c.name,d=u.replace("-compat","");if(rt(c)&&c.type==="PUBLIC"){const h=(m=s())=>{if(typeof m[d]!="function")throw Js.create("invalid-app-argument",{appName:u});return m[d]()};c.serviceProps!==void 0&&kt(h,c.serviceProps),t[d]=h,n.prototype[d]=function(...m){return this._getService.bind(this,u).apply(this,c.multipleInstances?m:[])}}return c.type==="PUBLIC"?t[d]:null}function l(c,u){return u==="serverAuth"?null:u}return t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const od=Math.log(2);class ad{constructor(e){const t=r=>parseInt(Math.log(r)/od,10),i=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const s=i(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const mn=function(n,e,t,i){n.sort(e);const s=function(l,c){const u=c-l;let d,h;if(u===0)return null;if(u===1)return d=n[l],h=t?t(d):d,new V(h,d.node,V.BLACK,null,null);{const m=parseInt(u/2,10)+l,_=s(l,m),E=s(m+1,c);return d=n[m],h=t?t(d):d,new V(h,d.node,V.BLACK,_,E)}},r=function(l){let c=null,u=null,d=n.length;const h=function(_,E){const L=d-_,me=d;d-=_;const _e=s(L+1,me),Ve=n[L],Xn=t?t(Ve):Ve;m(new V(Xn,Ve.node,E,null,_e))},m=function(_){c?(c.left=_,c=_):(u=_,c=_)};for(let _=0;_<l.count;++_){const E=l.nextBitIsOne(),L=Math.pow(2,l.count-(_+1));E?h(L,V.BLACK):(h(L,V.BLACK),h(L,V.RED))}return u},o=new ad(n.length),a=r(o);return new q(i||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ai;const et={};class ge{static get Default(){return p(et&&k,"ChildrenNode.ts has not been loaded"),ai=ai||new ge({".priority":et},{".priority":k}),ai}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=qe(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof q?t:null}hasIndex(e){return X(this.indexSet_,e.toString())}addIndex(e,t){p(e!==he,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(b.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=mn(i,e.getCompare()):a=et;const l=e.toString(),c={...this.indexSet_};c[l]=e;const u={...this.indexes_};return u[l]=a,new ge(u,c)}addToIndexes(e,t){const i=un(this.indexes_,(s,r)=>{const o=qe(this.indexSet_,r);if(p(o,"Missing index implementation for "+r),s===et)if(o.isDefinedOn(e.node)){const a=[],l=t.getIterator(b.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),mn(a,o.getCompare())}else return et;else{const a=t.get(e.name);let l=s;return a&&(l=l.remove(new b(e.name,a))),l.insert(e,e.node)}});return new ge(i,this.indexSet_)}removeFromIndexes(e,t){const i=un(this.indexes_,s=>{if(s===et)return s;{const r=t.get(e.name);return r?s.remove(new b(e.name,r)):s}});return new ge(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jd(n){return{filter:n}}function qd(n,e){p(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),p(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function Gd(n,e,t,i,s){const r=new Hd;let o,a;if(t.type===ce.OVERWRITE){const c=t;c.source.fromUser?o=Ai(n,e,c.path,c.snap,i,s,r):(p(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!w(c.path),o=bn(n,e,c.path,c.snap,i,s,a,r))}else if(t.type===ce.MERGE){const c=t;c.source.fromUser?o=Qd(n,e,c.path,c.children,i,s,r):(p(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=Ni(n,e,c.path,c.children,i,s,a,r))}else if(t.type===ce.ACK_USER_WRITE){const c=t;c.revert?o=Xd(n,e,c.path,i,s,r):o=Kd(n,e,c.path,c.affectedTree,i,s,r)}else if(t.type===ce.LISTEN_COMPLETE)o=Jd(n,e,t.path,i,r);else throw ht("Unknown operation type: "+t.type);const l=r.getChanges();return Yd(e,o,l),{viewCache:o,changes:l}}function Yd(n,e,t){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=vn(n);(t.length>0||!n.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&t.push(Yo(vn(e)))}}function na(n,e,t,i,s,r){const o=e.eventCache;if(wn(i,t)!=null)return e;{let a,l;if(w(t))if(p(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=Ye(e),u=c instanceof y?c:y.EMPTY_NODE,d=fs(i,u);a=n.filter.updateFullNode(e.eventCache.getNode(),d,r)}else{const c=Cn(i,Ye(e));a=n.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=C(t);if(c===".priority"){p(Oe(t)===1,"Can't have a priority with additional path components");const u=o.getNode();l=e.serverCache.getNode();const d=wr(i,t,u,l);d!=null?a=n.filter.updatePriority(u,d):a=o.getNode()}else{const u=R(t);let d;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const h=wr(i,t,o.getNode(),l);h!=null?d=o.getNode().getImmediateChild(c).updateChild(u,h):d=o.getNode().getImmediateChild(c)}else d=ps(i,c,e.serverCache);d!=null?a=n.filter.updateChild(o.getNode(),c,d,u,s,r):a=o.getNode()}}return It(e,a,o.isFullyInitialized()||w(t),n.filter.filtersNodes())}}function bn(n,e,t,i,s,r,o,a){const l=e.serverCache;let c;const u=o?n.filter:n.filter.getIndexedFilter();if(w(t))c=u.updateFullNode(l.getNode(),i,null);else if(u.filtersNodes()&&!l.isFiltered()){const m=l.getNode().updateChild(t,i);c=u.updateFullNode(l.getNode(),m,null)}else{const m=C(t);if(!l.isCompleteForPath(t)&&Oe(t)>1)return e;const _=R(t),L=l.getNode().getImmediateChild(m).updateChild(_,i);m===".priority"?c=u.updatePriority(l.getNode(),L):c=u.updateChild(l.getNode(),m,L,_,ta,null)}const d=Qo(e,c,l.isFullyInitialized()||w(t),u.filtersNodes()),h=new ms(s,d,r);return na(n,d,t,s,h,a)}function Ai(n,e,t,i,s,r,o){const a=e.eventCache;let l,c;const u=new ms(s,e,r);if(w(t))c=n.filter.updateFullNode(e.eventCache.getNode(),i,o),l=It(e,c,!0,n.filter.filtersNodes());else{const d=C(t);if(d===".priority")c=n.filter.updatePriority(e.eventCache.getNode(),i),l=It(e,c,a.isFullyInitialized(),a.isFiltered());else{const h=R(t),m=a.getNode().getImmediateChild(d);let _;if(w(h))_=i;else{const E=u.getCompleteChild(d);E!=null?is(h)===".priority"&&E.getChild(Uo(h)).isEmpty()?_=E:_=E.updateChild(h,i):_=y.EMPTY_NODE}if(m.equals(_))l=e;else{const E=n.filter.updateChild(a.getNode(),d,_,h,u,o);l=It(e,E,a.isFullyInitialized(),n.filter.filtersNodes())}}}return l}function br(n,e){return n.eventCache.isCompleteForChild(e)}function Qd(n,e,t,i,s,r,o){let a=e;return i.foreach((l,c)=>{const u=N(t,l);br(e,C(u))&&(a=Ai(n,a,u,c,s,r,o))}),i.foreach((l,c)=>{const u=N(t,l);br(e,C(u))||(a=Ai(n,a,u,c,s,r,o))}),a}function Er(n,e,t){return t.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function Ni(n,e,t,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;w(t)?c=i:c=new P(null).setTree(t,i);const u=e.serverCache.getNode();return c.children.inorderTraversal((d,h)=>{if(u.hasChild(d)){const m=e.serverCache.getNode().getImmediateChild(d),_=Er(n,m,h);l=bn(n,l,new I(d),_,s,r,o,a)}}),c.children.inorderTraversal((d,h)=>{const m=!e.serverCache.isCompleteForChild(d)&&h.value===null;if(!u.hasChild(d)&&!m){const _=e.serverCache.getNode().getImmediateChild(d),E=Er(n,_,h);l=bn(n,l,new I(d),E,s,r,o,a)}}),l}function Kd(n,e,t,i,s,r,o){if(wn(s,t)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(w(t)&&l.isFullyInitialized()||l.isCompleteForPath(t))return bn(n,e,t,l.getNode().getChild(t),s,r,a,o);if(w(t)){let c=new P(null);return l.getNode().forEachChild(he,(u,d)=>{c=c.set(new I(u),d)}),Ni(n,e,t,c,s,r,a,o)}else return e}else{let c=new P(null);return i.foreach((u,d)=>{const h=N(t,u);l.isCompleteForPath(h)&&(c=c.set(u,l.getNode().getChild(h)))}),Ni(n,e,t,c,s,r,a,o)}}function Jd(n,e,t,i,s){const r=e.serverCache,o=Qo(e,r.getNode(),r.isFullyInitialized()||w(t),r.isFiltered());return na(n,o,t,i,ta,s)}function Xd(n,e,t,i,s,r){let o;if(wn(i,t)!=null)return e;{const a=new ms(i,e,s),l=e.eventCache.getNode();let c;if(w(t)||C(t)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Cn(i,Ye(e));else{const d=e.serverCache.getNode();p(d instanceof y,"serverChildren would be complete if leaf node"),u=fs(i,d)}u=u,c=n.filter.updateFullNode(l,u,r)}else{const u=C(t);let d=ps(i,u,e.serverCache);d==null&&e.serverCache.isCompleteForChild(u)&&(d=l.getImmediateChild(u)),d!=null?c=n.filter.updateChild(l,u,d,R(t),a,r):e.eventCache.getNode().hasChild(u)?c=n.filter.updateChild(l,u,y.EMPTY_NODE,R(t),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Cn(i,Ye(e)),o.isLeafNode()&&(c=n.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||wn(i,S())!=null,It(e,c,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
