const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/virtual_pwa-register-BkTo2shC.js","assets/main-CcY0foHy.js","assets/main-nkgRg9bR.css"])))=>i.map(i=>d[i]);
import{n as a,c as n,_ as o}from"./main-CcY0foHy.js";const i="pwa-update";function r(e){if(a.has(i))return a.notifications.get(i);const t=n({template:`
