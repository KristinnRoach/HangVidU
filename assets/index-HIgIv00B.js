 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ya(t,e){if(t.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const n={alg:"none",type:"JWT"},i=e||"demo-project",s=t.iat||0,r=t.sub||t.user_id;if(!r)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o={iss:`https://securetoken.google.com/${i}`,aud:i,iat:s,exp:s+3600,auth_time:s,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}},...t};return[Jt(JSON.stringify(n)),Jt(JSON.stringify(o)),""].join(".")}const pt={};function Ga(){const t={prod:[],emulator:[]};for(const e of Object.keys(pt))pt[e]?t.emulator.push(e):t.prod.push(e);return t}function za(t){let e=document.getElementById(t),n=!1;return e||(e=document.createElement("div"),e.setAttribute("id",t),n=!0),{created:n,element:e}}let Rs=!1;function qa(t,e){if(typeof window>"u"||typeof document>"u"||!xi(window.location.host)||pt[t]===e||pt[t]||Rs)return;pt[t]=e;function n(h){return`__firebase__banner__${h}`}const i="__firebase__banner",r=Ga().prod.length>0;function o(){const h=document.getElementById(i);h&&h.remove()}function a(h){h.style.display="flex",h.style.background="#7faaf0",h.style.position="fixed",h.style.bottom="5px",h.style.left="5px",h.style.padding=".5em",h.style.borderRadius="5px",h.style.alignItems="center"}function l(h,f){h.setAttribute("width","24"),h.setAttribute("id",f),h.setAttribute("height","24"),h.setAttribute("viewBox","0 0 24 24"),h.setAttribute("fill","none"),h.style.marginLeft="-6px"}function c(){const h=document.createElement("span");return h.style.cursor="pointer",h.style.marginLeft="16px",h.style.fontSize="24px",h.innerHTML=" &times;",h.onclick=()=>{Rs=!0,o()},h}function d(h,f){h.setAttribute("id",f),h.innerText="Learn more",h.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",h.setAttribute("target","__blank"),h.style.paddingLeft="5px",h.style.textDecoration="underline"}function u(){const h=za(i),f=n("text"),m=document.getElementById(f)||document.createElement("span"),_=n("learnmore"),g=document.getElementById(_)||document.createElement("a"),O=n("preprendIcon"),J=document.getElementById(O)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(h.created){const xe=h.element;a(xe),d(g,_);const Un=c();l(J,O),xe.append(J,m,g,Un),document.body.appendChild(xe)}r?(m.innerText="Preview backend disconnected.",J.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kt{static get ALL_TRANSPORTS(){return[Ge,se]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const n=se&&se.isAvailable();let i=n&&!se.previouslyFailed();if(e.webSocketOnly&&(n||K("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),i=!0),i)this.transports_=[se];else{const s=this.transports_=[];for(const r of kt.ALL_TRANSPORTS)r&&r.isAvailable()&&s.push(r);kt.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}kt.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Iu=Math.log(2);class Su{constructor(e){const n=r=>parseInt(Math.log(r)/Iu,10),i=r=>parseInt(Array(r+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const s=i(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const on=function(t,e,n,i){t.sort(e);const s=function(l,c){const d=c-l;let u,h;if(d===0)return null;if(d===1)return u=t[l],h=n?n(u):u,new W(h,u.node,W.BLACK,null,null);{const f=parseInt(d/2,10)+l,m=s(l,f),_=s(f+1,c);return u=t[f],h=n?n(u):u,new W(h,u.node,W.BLACK,m,_)}},r=function(l){let c=null,d=null,u=t.length;const h=function(m,_){const g=u-m,O=u;u-=m;const J=s(g+1,O),xe=t[g],Un=n?n(xe):xe;f(new W(Un,xe.node,_,null,J))},f=function(m){c?(c.left=m,c=m):(d=m,c=m)};for(let m=0;m<l.count;++m){const _=l.nextBitIsOne(),g=Math.pow(2,l.count-(m+1));_?h(g,W.BLACK):(h(g,W.BLACK),h(g,W.RED))}return d},o=new Su(t.length),a=r(o);return new Q(i||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qn;const Ye={};class de{static get Default(){return p(Ye&&L,"ChildrenNode.ts has not been loaded"),qn=qn||new de({".priority":Ye},{".priority":L}),qn}constructor(e,n){this.indexes_=e,this.indexSet_=n}get(e){const n=Qe(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof Q?n:null}hasIndex(e){return le(this.indexSet_,e.toString())}addIndex(e,n){p(e!==je,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=n.getIterator(C.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=on(i,e.getCompare()):a=Ye;const l=e.toString(),c={...this.indexSet_};c[l]=e;const d={...this.indexes_};return d[l]=a,new de(d,c)}addToIndexes(e,n){const i=Zt(this.indexes_,(s,r)=>{const o=Qe(this.indexSet_,r);if(p(o,"Missing index implementation for "+r),s===Ye)if(o.isDefinedOn(e.node)){const a=[],l=n.getIterator(C.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),on(a,o.getCompare())}else return Ye;else{const a=n.get(e.name);let l=s;return a&&(l=l.remove(new C(e.name,a))),l.insert(e,e.node)}});return new de(i,this.indexSet_)}removeFromIndexes(e,n){const i=Zt(this.indexes_,s=>{if(s===Ye)return s;{const r=n.get(e.name);return r?s.remove(new C(e.name,r)):s}});return new de(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $i{constructor(e){this.index_=e}updateChild(e,n,i,s,r,o){p(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(n);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(n)?o.trackChildChange(Rt(n,a)):p(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Je(n,i)):o.trackChildChange(At(n,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(n,i).withIndex(this.index_)}updateFullNode(e,n,i){return i!=null&&(e.isLeafNode()||e.forEachChild(L,(s,r)=>{n.hasChild(s)||i.trackChildChange(Rt(s,r))}),n.isLeafNode()||n.forEachChild(L,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(At(s,r,o))}else i.trackChildChange(Je(s,r))})),n.withIndex(this.index_)}updatePriority(e,n){return e.isEmpty()?y.EMPTY_NODE:e.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yi{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=L}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return p(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return p(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:Xe}hasEnd(){return this.endSet_}getIndexEndValue(){return p(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return p(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:Be}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return p(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===L}copy(){const e=new Yi;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function Du(t){return t.loadsAllData()?new $i(t.getIndex()):t.hasLimit()?new xu(t):new Pt(t)}function ir(t){const e={};if(t.isDefault())return e;let n;if(t.index_===L?n="$priority":t.index_===Au?n="$value":t.index_===je?n="$key":(p(t.index_ instanceof Nu,"Unrecognized index type!"),n=t.index_.toString()),e.orderBy=B(n),t.startSet_){const i=t.startAfterSet_?"startAfter":"startAt";e[i]=B(t.indexStartValue_),t.startNameSet_&&(e[i]+=","+B(t.indexStartName_))}if(t.endSet_){const i=t.endBeforeSet_?"endBefore":"endAt";e[i]=B(t.indexEndValue_),t.endNameSet_&&(e[i]+=","+B(t.indexEndName_))}return t.limitSet_&&(t.isViewFromLeft()?e.limitToFirst=t.limit_:e.limitToLast=t.limit_),e}function sr(t){const e={};if(t.startSet_&&(e.sp=t.indexStartValue_,t.startNameSet_&&(e.sn=t.indexStartName_),e.sin=!t.startAfterSet_),t.endSet_&&(e.ep=t.indexEndValue_,t.endNameSet_&&(e.en=t.indexEndName_),e.ein=!t.endBeforeSet_),t.limitSet_){e.l=t.limit_;let n=t.viewFrom_;n===""&&(t.isViewFromLeft()?n="l":n="r"),e.vf=n}return t.index_!==L&&(e.i=t.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class an extends go{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,n){return n!==void 0?"tag$"+n:(p(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,n,i,s){super(),this.repoInfo_=e,this.onDataUpdate_=n,this.authTokenProvider_=i,this.appCheckTokenProvider_=s,this.log_=Bt("p:rest:"),this.listens_={}}listen(e,n,i,s){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=an.getListenId_(e,i),a={};this.listens_[o]=a;const l=ir(e._queryParams);this.restRequest_(r+".json",l,(c,d)=>{let u=d;if(c===404&&(u=null,c=null),c===null&&this.onDataUpdate_(r,u,!1,i),Qe(this.listens_,o)===a){let h;c?c===401?h="permission_denied":h="rest_error:"+c:h="ok",s(h,null)}})}unlisten(e,n){const i=an.getListenId_(e,n);delete this.listens_[i]}get(e){const n=ir(e._queryParams),i=e._path.toString(),s=new Lt;return this.restRequest_(i+".json",n,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(i,a,!1,null),s.resolve(a)):s.reject(new Error(a))}),s.promise}refreshAuthToken(e){}restRequest_(e,n={},i){return n.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([s,r])=>{s&&s.accessToken&&(n.auth=s.accessToken),r&&r.token&&(n.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+sl(n);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(i&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=It(a.responseText)}catch{K("Failed to parse JSON response for "+o+": "+a.responseText)}i(null,l)}else a.status!==401&&a.status!==404&&K("Got unsuccessful REST response for "+o+" Status: "+a.status),i(a.status);i=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xt{constructor(e,n){this.source=e,this.path=n,this.type=re.LISTEN_COMPLETE}operationForChild(e){return E(this.path)?new xt(this.source,w()):new xt(this.source,A(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ue{constructor(e,n,i){this.source=e,this.path=n,this.snap=i,this.type=re.OVERWRITE}operationForChild(e){return E(this.path)?new Ue(this.source,w(),this.snap.getImmediateChild(e)):new Ue(this.source,A(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ze{constructor(e,n,i){this.source=e,this.path=n,this.children=i,this.type=re.MERGE}operationForChild(e){if(E(this.path)){const n=this.children.subtree(new S(e));return n.isEmpty()?null:n.value?new Ue(this.source,w(),n.value):new Ze(this.source,w(),n)}else return p(v(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Ze(this.source,A(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tn(t,e){return Do(e,t)}function Gu(t,e,n,i,s){p(i>t.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),t.allWrites.push({path:e,snap:n,writeId:i,visible:s}),s&&(t.visibleWrites=yt(t.visibleWrites,e,n)),t.lastWriteId=i}function zu(t,e,n,i){p(i>t.lastWriteId,"Stacking an older merge on top of newer ones"),t.allWrites.push({path:e,children:n,writeId:i,visible:!0}),t.visibleWrites=di(t.visibleWrites,e,n),t.lastWriteId=i}function qu(t,e){for(let n=0;n<t.allWrites.length;n++){const i=t.allWrites[n];if(i.writeId===e)return i}return null}function ju(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);p(n>=0,"removeWrite called with nonexistent writeId.");const i=t.allWrites[n];t.allWrites.splice(n,1);let s=i.visible,r=!1,o=t.allWrites.length-1;for(;s&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&Ku(a,i.path)?s=!1:Z(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return Qu(t),!0;if(i.snap)t.visibleWrites=or(t.visibleWrites,i.path);else{const a=i.children;Y(a,l=>{t.visibleWrites=or(t.visibleWrites,M(i.path,l))})}return!0}else return!1}function Ku(t,e){if(t.snap)return Z(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Z(M(t.path,n),e))return!0;return!1}function Qu(t){t.visibleWrites=Ao(t.allWrites,Xu,w()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function Xu(t){return t.visible}function Ao(t,e,n){let i=oe.empty();for(let s=0;s<t.length;++s){const r=t[s];if(e(r)){const o=r.path;let a;if(r.snap)Z(n,o)?(a=j(n,o),i=yt(i,a,r.snap)):Z(o,n)&&(a=j(o,n),i=yt(i,w(),r.snap.getChild(a)));else if(r.children){if(Z(n,o))a=j(n,o),i=di(i,a,r.children);else if(Z(o,n))if(a=j(o,n),E(a))i=di(i,w(),r.children);else{const l=Qe(r.children,v(a));if(l){const c=l.getChild(A(a));i=yt(i,w(),c)}}}else throw st("WriteRecord should have .snap or .children")}}return i}function Po(t,e,n,i,s){if(!i&&!s){const r=$e(t.visibleWrites,e);if(r!=null)return r;{const o=Se(t.visibleWrites,e);if(fi(o))return n;if(n==null&&!hi(o,w()))return null;{const a=n||y.EMPTY_NODE;return et(o,a)}}}else{const r=Se(t.visibleWrites,e);if(!s&&fi(r))return n;if(!s&&n==null&&!hi(r,w()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(Z(c.path,e)||Z(e,c.path))},a=Ao(t.allWrites,o,e),l=n||y.EMPTY_NODE;return et(a,l)}}}function Ju(t,e,n){let i=y.EMPTY_NODE;const s=$e(t.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(L,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(n){const r=Se(t.visibleWrites,e);return n.forEachChild(L,(o,a)=>{const l=et(Se(r,new S(o)),a);i=i.updateImmediateChild(o,l)}),ar(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=Se(t.visibleWrites,e);return ar(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function Zu(t,e,n,i,s){p(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=M(e,n);if(hi(t.visibleWrites,r))return null;{const o=Se(t.visibleWrites,r);return fi(o)?s.getChild(n):et(o,s.getChild(n))}}function ed(t,e,n,i){const s=M(e,n),r=$e(t.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(n)){const o=Se(t.visibleWrites,s);return et(o,i.getNode().getImmediateChild(n))}else return null}function td(t,e){return $e(t.visibleWrites,e)}function nd(t,e,n,i,s,r,o){let a;const l=Se(t.visibleWrites,e),c=$e(l,w());if(c!=null)a=c;else if(n!=null)a=et(l,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const d=[],u=o.getCompare(),h=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let f=h.getNext();for(;f&&d.length<s;)u(f,i)!==0&&d.push(f),f=h.getNext();return d}else return[]}function id(){return{visibleWrites:oe.empty(),allWrites:[],lastWriteId:-1}}function dn(t,e,n,i){return Po(t.writeTree,t.treePath,e,n,i)}function ji(t,e){return Ju(t.writeTree,t.treePath,e)}function lr(t,e,n,i){return Zu(t.writeTree,t.treePath,e,n,i)}function hn(t,e){return td(t.writeTree,M(t.treePath,e))}function sd(t,e,n,i,s,r){return nd(t.writeTree,t.treePath,e,n,i,s,r)}function Ki(t,e,n){return ed(t.writeTree,t.treePath,e,n)}function xo(t,e){return Do(M(t.treePath,e),t.writeTree)}function Do(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ad(t){return{filter:t}}function ld(t,e){p(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),p(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function cd(t,e,n,i,s){const r=new rd;let o,a;if(n.type===re.OVERWRITE){const c=n;c.source.fromUser?o=pi(t,e,c.path,c.snap,i,s,r):(p(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!E(c.path),o=fn(t,e,c.path,c.snap,i,s,a,r))}else if(n.type===re.MERGE){const c=n;c.source.fromUser?o=dd(t,e,c.path,c.children,i,s,r):(p(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=_i(t,e,c.path,c.children,i,s,a,r))}else if(n.type===re.ACK_USER_WRITE){const c=n;c.revert?o=pd(t,e,c.path,i,s,r):o=hd(t,e,c.path,c.affectedTree,i,s,r)}else if(n.type===re.LISTEN_COMPLETE)o=fd(t,e,n.path,i,r);else throw st("Unknown operation type: "+n.type);const l=r.getChanges();return ud(e,o,l),{viewCache:o,changes:l}}function ud(t,e,n){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=un(t);(n.length>0||!t.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(To(un(e)))}}function Lo(t,e,n,i,s,r){const o=e.eventCache;if(hn(i,n)!=null)return e;{let a,l;if(E(n))if(p(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=We(e),d=c instanceof y?c:y.EMPTY_NODE,u=ji(i,d);a=t.filter.updateFullNode(e.eventCache.getNode(),u,r)}else{const c=dn(i,We(e));a=t.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=v(n);if(c===".priority"){p(Ne(n)===1,"Can't have a priority with additional path components");const d=o.getNode();l=e.serverCache.getNode();const u=lr(i,n,d,l);u!=null?a=t.filter.updatePriority(d,u):a=o.getNode()}else{const d=A(n);let u;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const h=lr(i,n,o.getNode(),l);h!=null?u=o.getNode().getImmediateChild(c).updateChild(d,h):u=o.getNode().getImmediateChild(c)}else u=Ki(i,c,e.serverCache);u!=null?a=t.filter.updateChild(o.getNode(),c,u,d,s,r):a=o.getNode()}}return gt(e,a,o.isFullyInitialized()||E(n),t.filter.filtersNodes())}}function fn(t,e,n,i,s,r,o,a){const l=e.serverCache;let c;const d=o?t.filter:t.filter.getIndexedFilter();if(E(n))c=d.updateFullNode(l.getNode(),i,null);else if(d.filtersNodes()&&!l.isFiltered()){const f=l.getNode().updateChild(n,i);c=d.updateFullNode(l.getNode(),f,null)}else{const f=v(n);if(!l.isCompleteForPath(n)&&Ne(n)>1)return e;const m=A(n),g=l.getNode().getImmediateChild(f).updateChild(m,i);f===".priority"?c=d.updatePriority(l.getNode(),g):c=d.updateChild(l.getNode(),f,g,m,Mo,null)}const u=No(e,c,l.isFullyInitialized()||E(n),d.filtersNodes()),h=new Qi(s,u,r);return Lo(t,u,n,s,h,a)}function pi(t,e,n,i,s,r,o){const a=e.eventCache;let l,c;const d=new Qi(s,e,r);if(E(n))c=t.filter.updateFullNode(e.eventCache.getNode(),i,o),l=gt(e,c,!0,t.filter.filtersNodes());else{const u=v(n);if(u===".priority")c=t.filter.updatePriority(e.eventCache.getNode(),i),l=gt(e,c,a.isFullyInitialized(),a.isFiltered());else{const h=A(n),f=a.getNode().getImmediateChild(u);let m;if(E(h))m=i;else{const _=d.getCompleteChild(u);_!=null?Ui(h)===".priority"&&_.getChild(vo(h)).isEmpty()?m=_:m=_.updateChild(h,i):m=y.EMPTY_NODE}if(f.equals(m))l=e;else{const _=t.filter.updateChild(a.getNode(),u,m,h,d,o);l=gt(e,_,a.isFullyInitialized(),t.filter.filtersNodes())}}}return l}function cr(t,e){return t.eventCache.isCompleteForChild(e)}function dd(t,e,n,i,s,r,o){let a=e;return i.foreach((l,c)=>{const d=M(n,l);cr(e,v(d))&&(a=pi(t,a,d,c,s,r,o))}),i.foreach((l,c)=>{const d=M(n,l);cr(e,v(d))||(a=pi(t,a,d,c,s,r,o))}),a}function ur(t,e,n){return n.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function _i(t,e,n,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;E(n)?c=i:c=new k(null).setTree(n,i);const d=e.serverCache.getNode();return c.children.inorderTraversal((u,h)=>{if(d.hasChild(u)){const f=e.serverCache.getNode().getImmediateChild(u),m=ur(t,f,h);l=fn(t,l,new S(u),m,s,r,o,a)}}),c.children.inorderTraversal((u,h)=>{const f=!e.serverCache.isCompleteForChild(u)&&h.value===null;if(!d.hasChild(u)&&!f){const m=e.serverCache.getNode().getImmediateChild(u),_=ur(t,m,h);l=fn(t,l,new S(u),_,s,r,o,a)}}),l}function hd(t,e,n,i,s,r,o){if(hn(s,n)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(E(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return fn(t,e,n,l.getNode().getChild(n),s,r,a,o);if(E(n)){let c=new k(null);return l.getNode().forEachChild(je,(d,u)=>{c=c.set(new S(d),u)}),_i(t,e,n,c,s,r,a,o)}else return e}else{let c=new k(null);return i.foreach((d,u)=>{const h=M(n,d);l.isCompleteForPath(h)&&(c=c.set(d,l.getNode().getChild(h)))}),_i(t,e,n,c,s,r,a,o)}}function fd(t,e,n,i,s){const r=e.serverCache,o=No(e,r.getNode(),r.isFullyInitialized()||E(n),r.isFiltered());return Lo(t,o,n,i,Mo,s)}function pd(t,e,n,i,s,r){let o;if(hn(i,n)!=null)return e;{const a=new Qi(i,e,s),l=e.eventCache.getNode();let c;if(E(n)||v(n)===".priority"){let d;if(e.serverCache.isFullyInitialized())d=dn(i,We(e));else{const u=e.serverCache.getNode();p(u instanceof y,"serverChildren would be complete if leaf node"),d=ji(i,u)}d=d,c=t.filter.updateFullNode(l,d,r)}else{const d=v(n);let u=Ki(i,d,e.serverCache);u==null&&e.serverCache.isCompleteForChild(d)&&(u=l.getImmediateChild(d)),u!=null?c=t.filter.updateChild(l,d,u,A(n),a,r):e.eventCache.getNode().hasChild(d)?c=t.filter.updateChild(l,d,y.EMPTY_NODE,A(n),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=dn(i,We(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||hn(i,w())!=null,gt(e,c,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ph(t){let e="";const n=t.split("/");for(let i=0;i<n.length;i++)if(n[i].length>0){let s=n[i];try{s=decodeURIComponent(s.replace(/\+/g," "))}catch{}e+="/"+s}return e}function _h(t){const e={};t.charAt(0)==="?"&&(t=t.substring(1));for(const n of t.split("&")){if(n.length===0)continue;const i=n.split("=");i.length===2?e[decodeURIComponent(i[0])]=decodeURIComponent(i[1]):K(`Invalid query segment '${n}' in query '${t}'`)}return e}const yr=function(t,e){const n=mh(t),i=n.namespace;n.domain==="firebase.com"&&me(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!i||i==="undefined")&&n.domain!=="localhost"&&me("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||Tc();const s=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new co(n.host,n.secure,i,s,e,"",i!==n.subdomain),path:new S(n.pathString)}},mh=function(t){let e="",n="",i="",s="",r="",o=!0,a="https",l=443;if(typeof t=="string"){let c=t.indexOf("//");c>=0&&(a=t.substring(0,c-1),t=t.substring(c+2));let d=t.indexOf("/");d===-1&&(d=t.length);let u=t.indexOf("?");u===-1&&(u=t.length),e=t.substring(0,Math.min(d,u)),d<u&&(s=ph(t.substring(d,u)));const h=_h(t.substring(Math.min(t.length,u)));c=e.indexOf(":"),c>=0?(o=a==="https"||a==="wss",l=parseInt(e.substring(c+1),10)):c=e.length;const f=e.slice(0,c);if(f.toLowerCase()==="localhost")n="localhost";else if(f.split(".").length<=2)n=f;else{const m=e.indexOf(".");i=e.substring(0,m).toLowerCase(),n=e.substring(m+1),r=i}"ns"in h&&(r=h.ns)}return{host:e,port:l,domain:n,subdomain:i,secure:o,scheme:a,pathString:s,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ze(Ph,xh,"app");const Dh={apiKey:"AIzaSyA-fvCaKCjyEFX__YAVr1oPGdVsUEhFehA",authDomain:"vidu-aae11.firebaseapp.com",projectId:"vidu-aae11",databaseURL:"https://vidu-aae11-default-rtdb.europe-west1.firebasedatabase.app",storageBucket:"vidu-aae11.firebasestorage.app",messagingSenderId:"765724787439",appId:"1:765724787439:web:61a3b5dd538149564c911a",measurementId:"G-EGJ53HLGY4"},Mh=zr(Dh),ie=Nh(Mh),Ci=[];function ms(t,e,n){Ci.push({ref:t,type:e,callback:n})}function Lh(){Ci.forEach(({ref:t,type:e,callback:n})=>{pa(t,e,n)}),Ci.length=0}function Ei(t,e,n={}){if(!t||typeof e!="function")throw new Error("closeOnClickOutside: valid element and onClose callback required");const{ignore:i=[],esc:s=!0,events:r=["mousedown","touchstart"]}=n,o=Array.isArray(i)?i.filter(Boolean):[],a=c=>{try{const d=c.target;if(t.contains(d))return;for(const u of o)if(u&&u.contains&&u.contains(d)||u===d)return;e(c)}catch(d){console.error("closeOnClickOutside handler error:",d)}},l=c=>{s&&c.key==="Escape"&&e(c)};return r.forEach(c=>document.addEventListener(c,a,{passive:!0})),s&&document.addEventListener("keydown",l),function(){r.forEach(d=>document.removeEventListener(d,a,{passive:!0})),s&&document.removeEventListener("keydown",l)}}function Oh(t,e,n={}){return Ei(t,e,{...n,events:["dblclick"]})}const gs=t=>t?!0:(console.warn("Element not found."),!1),ys=t=>{if(gs(t))return t.classList.contains("hidden")},V=t=>{gs(t)&&t.classList.remove("hidden")},b=t=>{gs(t)&&t.classList.add("hidden")},_a=t=>t.classList.contains("smallFrame"),vs=t=>{if(!_a(t)){t.classList.add("smallFrame");const e=document.createElement("button");e.classList.add("smallFrame-toggle-btn"),e.textContent="❮",document.body.appendChild(e),e.addEventListener("click",()=>{t.classList.contains("closed")?(t.classList.remove("closed"),e.classList.remove("closed")):(t.classList.add("closed"),e.classList.add("closed"))})}},Fh=t=>{if(_a(t)){t.classList.remove("smallFrame");const e=document.querySelector(".smallFrame-close");e&&e.remove()}};function Bh(t){return document.pictureInPictureElement===t}const Uh=document.getElementById("installBtn"),Pe=document.getElementById("localVideo"),z=document.getElementById("remoteVideo"),I=document.getElementById("sharedVideo"),Mt=document.getElementById("chat-controls"),ge=document.getElementById("call-btn"),lt=document.getElementById("hang-up-btn");document.getElementById("copyLink");document.getElementById("pipBtn");const Er=document.getElementById("switchCameraSelfBtn"),wr=document.getElementById("status"),Wh=document.getElementById("linkContainer");document.getElementById("watchContainer");document.getElementById("videos");const Hh=document.getElementById("syncStatus"),ma=document.getElementById("shareLink");document.getElementById("streamUrl");const Gt=document.getElementById("mute-btn"),Vh=document.getElementById("fullscreenPartnerBtn"),$h=document.getElementById("mic-btn"),Yh=document.getElementById("camera-btn"),Gh=document.getElementById("fullscreenSelfBtn");document.getElementById("titleHeader");document.getElementById("titleLink");document.getElementById("titleText");function H(t){wr?wr.textContent=t:console.warn("Status div not found in the DOM.")}function zh(t,{inactivityMs:e=2500,listenTarget:n=document,onShow:i=null,onHide:s=null,hideOnEsc:r=!1,excludeEvents:o=["keydown"]}={}){if(!t)return()=>{};let a=null;const c=["pointermove","pointerdown","pointerup","touchstart","touchmove","mousemove","mousedown","keydown"].filter(g=>!Array.isArray(o)||!o.includes(g));function d(){V(t);try{typeof i=="function"&&i()}catch(g){console.warn("showHideOnInactivity onShow callback error:",g)}a&&clearTimeout(a),a=setTimeout(()=>{b(t);try{typeof s=="function"&&s()}catch(g){console.warn("showHideOnInactivity onHide callback error:",g)}a=null},e)}c.forEach(g=>n.addEventListener(g,d,{passive:!0}));function u(){if(document.hidden){a&&(clearTimeout(a),a=null);try{b(t)}catch(g){console.warn("showHideOnInactivity onHide (visibilitychange) callback error:",g)}}else d()}document.addEventListener("visibilitychange",u);function h(g){if(!g.relatedTarget){a&&(clearTimeout(a),a=null),b(t);try{typeof s=="function"&&s()}catch(O){console.warn("showHideOnInactivity onHide (visibilitychange) callback error:",O)}}}n.addEventListener("mouseout",h);function f(g){if(r&&(g.key==="Escape"||g.key==="Esc")){a&&(clearTimeout(a),a=null),b(t);try{typeof s=="function"&&s()}catch(O){console.warn("showHideOnInactivity onHide (esc) callback error:",O)}}}document.addEventListener("keydown",f);function m(){a||d()}n.addEventListener("touchend",m,{passive:!0}),b(t);function _(){c.forEach(g=>n.removeEventListener(g,d)),document.removeEventListener("visibilitychange",u),n.removeEventListener("mouseout",h),n.removeEventListener("touchend",m),document.removeEventListener("keydown",f),a&&(clearTimeout(a),a=null)}return _}const Ln={echoCancellation:!0,noiseSuppression:!0,autoGainControl:!0,voiceIsolation:!0,restrictOwnAudio:!0};function qh(){return!!(navigator.mediaDevices&&navigator.mediaDevices.enumerateDevices)}async function jh(){return qh()?(await navigator.mediaDevices.enumerateDevices()).filter(e=>e.kind==="videoinput"):[]}async function Kh(){const t=await jh();let e=!1,n=!1;return t.forEach(i=>{const s=i.label.toLowerCase();s.includes("front")&&(e=!0),(s.includes("back")||s.includes("rear")||s.includes("environment"))&&(n=!0)}),e&&n}async function Qh({localStream:t,localVideo:e,peerConnection:n,currentFacingMode:i}){const s=i==="user"?"environment":"user",r=Cs(s);try{const o=await navigator.mediaDevices.getUserMedia({video:r,audio:Ln}),a=o.getVideoTracks()[0],l=o.getAudioTracks()[0],c=t.getVideoTracks()[0],d=c?c.enabled:!0,u=t.getAudioTracks()[0],h=u?!u.enabled:!1;if(n){const f=n.getSenders().find(_=>_.track&&_.track.kind==="video");f&&f.replaceTrack(a);const m=n.getSenders().find(_=>_.track&&_.track.kind==="audio");m&&l&&m.replaceTrack(l)}return a&&(a.enabled=d),l&&(l.enabled=!h),t.getTracks().forEach(f=>f.stop()),e.srcObject=new MediaStream([a].filter(Boolean)),{newStream:o,facingMode:s}}catch(o){return console.error("Failed to switch camera:",o),null}}function Xh(){return window.screen?.orientation?.type?.includes("portrait")||window.orientation===0||window.orientation===180}function Cs(t){return Xh()?{facingMode:t,aspectRatio:{ideal:9/16},width:{ideal:1080},height:{ideal:1920}}:{facingMode:t,aspectRatio:{ideal:16/9},width:{ideal:1920},height:{ideal:1080}}}async function Jh({localStream:t,localVideo:e,peerConnection:n,currentFacingMode:i}){const s=Cs(i);try{const r=await navigator.mediaDevices.getUserMedia({video:s,audio:Ln}),o=r.getVideoTracks()[0],a=r.getAudioTracks()[0],l=t.getAudioTracks()[0],c=l?!l.enabled:!1,d=e.muted;if(n){const u=n.getSenders().find(f=>f.track&&f.track.kind==="video");u&&u.replaceTrack(o);const h=n.getSenders().find(f=>f.track&&f.track.kind==="audio");h&&a&&h.replaceTrack(a)}return a&&(a.enabled=!c),t.getTracks().forEach(u=>u.stop()),e.srcObject=r,e.muted=d,console.log("Updated video constraints for orientation change."),{newStream:r}}catch(r){return console.error("Failed to update video constraints for orientation:",r),null}}let wi=!1,gn=[];function Zh(t,e){if(!e)return;const n=e.getAudioTracks()[0];n&&(n.enabled=t)}function ef(t,e,n){n&&(n.muted=!t,n.volume=e)}function tf(t,e){const n=e.querySelector("i");n.className=t?"fa fa-microphone-slash":"fa fa-microphone"}function nf(t,e){if(!t)return;const n=()=>{if(t.muted!==wi){const i=e.querySelector("i");i.className=t.muted?"fa fa-volume-mute":"fa fa-volume-up",wi=t.muted}};t.addEventListener("volumechange",n),gn.push(()=>{t&&t.removeEventListener("volumechange",n)})}function sf({getLocalStream:t,getLocalVideo:e,getRemoteVideo:n,getPeerConnection:i=()=>null,setLocalStream:s=null,muteSelfBtn:r,videoSelfBtn:o,switchCameraSelfBtn:a,fullscreenSelfBtn:l,mutePartnerBtn:c,fullscreenPartnerBtn:d}){r&&(r.onclick=()=>{const _=t(),g=e();if(!g||!_)return;const O=!g.muted;Zh(!O,_),ef(!O,0,g),tf(O,r)}),o&&(o.onclick=()=>{const _=t();if(!_)return;const g=_.getVideoTracks()[0];if(g){g.enabled=!g.enabled;const O=o.querySelector("i");O.className=g.enabled?"fa fa-video":"fa fa-video-slash"}});let u="user",h=!1;const f=async()=>{if(h)return;h=!0;const _=t(),g=e(),O=i?.();if(!_||!g){h=!1;return}const J=await Jh({localStream:_,localVideo:g,peerConnection:O,currentFacingMode:u});J?.newStream&&typeof s=="function"&&s(J.newStream),h=!1},m=(()=>{window.addEventListener("orientationchange",f);let _=!1;return window.screen?.orientation&&(window.screen.orientation.addEventListener("change",f),_=!0),()=>{window.removeEventListener("orientationchange",f),_&&window.screen.orientation.removeEventListener("change",f)}})();gn.push(()=>{m()}),a&&(a.onclick=async()=>{const _=await Qh({localStream:t(),localVideo:e(),peerConnection:pc,currentFacingMode:u});_?(u=_.facingMode,console.log("Switched camera to facingMode:",u)):console.error("Camera switch failed.")}),l&&(l.onclick=()=>{const _=e();_.requestFullscreen?_.requestFullscreen():_.webkitRequestFullscreen&&_.webkitRequestFullscreen()}),c&&(c.onclick=()=>{const _=n();_&&(_.muted=!_.muted)}),d&&(d.onclick=()=>{const _=n();_.requestFullscreen?_.requestFullscreen():_.webkitRequestFullscreen&&_.webkitRequestFullscreen()})}function rf(){gn.forEach(t=>t()),gn=[],wi=!1}const br="yt-player-div",bi="yt-player-root";let x=null,ye=!1;const Ct=()=>x,of=()=>ye,ga=t=>ye=t,Fe=()=>{const t=document.getElementById(br);if(!t)throw new Error(`Container #${br} not found`);return t};function af(){return new Promise(t=>{window.YT&&window.YT.Player?t():window.onYouTubeIframeAPIReady=()=>{t()}})}function ya(){const t=Fe();if(!document.getElementById(bi)){const e=document.createElement("div");e.id=bi,t.appendChild(e)}V(t)}function Ii(){const t=Fe();b(t)}function Xn(){const t=Fe();return t&&!t.classList.contains("hidden")}function Si(t){return t?t.includes("youtube.com")||t.includes("youtu.be"):!1}function va(t){if(!t)return null;const e=[/(?:youtube\.com\/watch\?v=)([\w-]+)/,/(?:youtu\.be\/)([\w-]+)/,/(?:youtube\.com\/embed\/)([\w-]+)/,/(?:youtube\.com\/shorts\/)([\w-]+)/];for(const n of e){const i=t.match(n);if(i&&i[1])return i[1]}return null}async function lf({url:t,onReady:e,onStateChange:n}){const i=va(t);if(!i)throw new Error("Invalid YouTube URL");if(await af(),x){try{x.destroy()}catch(o){console.warn("Error destroying previous YouTube player:",o)}x=null}const s=(o=!0)=>{const a=Fe(),l=x.getIframe();if(l&&a){try{a.tabIndex=-1,a.focus({preventScroll:!0})}catch{if(document.activeElement===l)try{l.blur()}catch{}}if(o){const c=d=>{if(d.code==="Space"){const u=Fe(),h=x.getIframe();if(document.activeElement===h||document.activeElement===u)return;d.preventDefault(),console.debug("Space pressed, refocusing iframe"),x.getPlayerState()!==window.YT.PlayerState.PLAYING?ws():On()}};document.addEventListener("keydown",c,{once:!0})}}},r=()=>{const o=Fe(),a=x.getIframe();if(o&&a&&document.activeElement!==a)try{a.focus()}catch{}};return ya(),new Promise((o,a)=>{try{x=new window.YT.Player(bi,{videoId:i,playerVars:{autoplay:1,mute:0,controls:1,fs:1,rel:0,modestbranding:1,disablekb:0,origin:window.location.origin},events:{onReady:l=>{ye=!0,e&&e(l),o(x)},onStateChange:l=>{l.data===window.YT.PlayerState.ENDED&&s(!1),l.data===window.YT.PlayerState.PAUSED&&s(),l.data===window.YT.PlayerState.PLAYING&&r(),n&&n(l)},onError:l=>{console.error("YouTube player error:",l.data),a(new Error(`YouTube error: ${l.data}`))}}})}catch(l){a(l)}})}function Es(){if(x){try{Ii(),x.destroy()}catch(t){console.warn("Error destroying YouTube player:",t)}x=null,ye=!1}}function ws(){x&&ye&&x.playVideo()}function On(){x&&ye&&x.pauseVideo()}function cf(t){x&&ye&&x.seekTo(t,!0)}function yn(){return x&&ye?x.getCurrentTime():0}function bs(){return x&&ye?x.getPlayerState():-1}const Ee={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5};let pe=null,Fn=null,Ca=!1,ee="none",Is=null;const Ss=()=>Ca,Ea=t=>Ca=t,ft=()=>ee,uf=t=>{["yt","url","none"].includes(t)?ee=t:console.warn("Invalid lastWatched platform:",t)};let we=!1,Et=null,wt=0;async function Ke(t){if(!pe)return;console.debug("Updating watch sync state, roomId:",pe);const e=ne(ie,`rooms/${pe}/watch`);try{await da(e,{...t,updatedBy:Fn})}catch(n){console.error("Failed to update watch state:",n)}}function wa(t,e,n){if(!t)return;pe=t,Fn=n;const i=ne(ie,`rooms/${t}/watch`);ha(i,Ir),ms(i,"value",Ir),gf()}function Ir(t){const e=t.val();e&&e.updatedBy!==Fn&&(Date.now()-wt<500||(e.url&&e.url!==Is&&df(e.url),e.isYouTube?hf(e):mf(e)))}function df(t){Is=t,Si(t)?(b(I),ba(t),ee="yt"):(Es(),V(I),I.src=t,ee="url")}function hf(t){!Ct()||!of()||(ff(t),pf(t))}function ff(t){const e=bs(),n=e===Ee.PLAYING;if([Ee.BUFFERING,Ee.UNSTARTED].includes(e)){_f();return}we||(t.playing&&!n?(ws(),ee="yt"):!t.playing&&n&&(On(),ee="yt"))}function pf(t){if(t.currentTime===void 0)return;const e=yn();Math.abs(e-t.currentTime)>.3&&!we&&(cf(t.currentTime),setTimeout(()=>{t.playing?ws():On(),ee="yt"},500))}function _f(){we=!0,clearTimeout(Et),Et=setTimeout(async()=>{we=!1;const t=bs()===Ee.PLAYING;await Ke({playing:t,currentTime:yn()})},700)}function mf(t){t.playing!==void 0&&(t.playing&&I.paused?I.play().catch(e=>console.warn("Play failed:",e)):!t.playing&&!I.paused&&I.pause()),t.currentTime!==void 0&&Math.abs(I.currentTime-t.currentTime)>1&&(I.currentTime=t.currentTime,t.playing?I.play().catch(n=>console.warn("Play failed:",n)):I.pause())}function gf(){I.addEventListener("play",async()=>{!Ct()&&pe&&(wt=Date.now(),await Ke({playing:!0,isYouTube:!1})),ee="url"}),I.addEventListener("pause",async()=>{!Ct()&&pe&&(wt=Date.now(),await Ke({playing:!1,isYouTube:!1})),ee="url"}),I.addEventListener("seeked",async()=>{!Ct()&&pe&&(wt=Date.now(),await Ke({currentTime:I.currentTime,playing:!I.paused,isYouTube:!1})),ee="url"})}async function yf(t){if(!t)return!1;if(wt=Date.now(),Si(t)){if(b(I),!await ba(t))return!1;Cn(),ee="yt"}else Es(),V(I),I.src=t,Cn(),ee="url";if(pe){const e=ne(ie,`rooms/${pe}/watch`);$t(e,{url:t,playing:!1,currentTime:0,isYouTube:Si(t),updatedBy:Fn})}return!0}async function vf(t){return!t||!t.url?(console.warn("Non-existing or invalid video."),!1):(Is=t.url,await yf(t.url))}async function ba(t,e,n){if(!va(t))return console.error("Invalid YouTube URL:",t),!1;try{return await lf({url:t,onReady:s=>{ga(!0)},onStateChange:async s=>{if(!Ct())return;const o=s.data===Ee.PLAYING,a=s.data===Ee.PAUSED;if(s.data===Ee.BUFFERING){we=!0,Et&&clearTimeout(Et),Et=setTimeout(async()=>{we=!1;const d=bs()===Ee.PLAYING;await Ke({playing:d,currentTime:yn()})},700);return}a&&we||!we&&(o||a)&&await Ke({playing:o,currentTime:yn()})}}),!0}catch(s){return console.error("Failed to load YouTube video:",s),!1}}let Jn=null,ve=null,P=null,R=null,Sr=!1,jt=!1,ae=[],Le=null,Ti="",G=-1,ki=[];const Cf="AIzaSyBq18HUW_U9E3AhSKVP58LZFK_GfzNHIGQ",Ef="https://www.googleapis.com/youtube/v3";function wf(){if(Sr||jt)return!1;if(jt=!0,Le=vf,Jn=document.querySelector(".search-section"),ve=document.getElementById("searchBtn"),P=document.getElementById("searchQuery"),R=document.getElementById("searchResults"),!Jn||!ve||!P||!R)return console.error("YouTube search elements not found in DOM"),jt=!1,!1;const t=s=>/^https?:\/\//i.test(s),e=s=>{R.querySelectorAll(".search-result-item").forEach((o,a)=>{a===s?(o.classList.add("focused"),o.scrollIntoView({block:"nearest"})):o.classList.remove("focused")}),G=s};ve.onclick=async()=>{const s=P.value.trim();if(ys(P)){V(P),P.focus();return}if(!s){Qt(),b(P);return}if(Nr()&&s===Ti)Ni(ae);else if(!t(s))await Tr(s);else{Le&&await Le({url:s,title:s,channel:"",thumbnail:"",id:s}),b(R),P.value="",b(P),G=-1;return}},Jn.addEventListener("keydown",async s=>{const r=R.querySelectorAll(".search-result-item");if(r.length>0&&(s.key==="ArrowDown"||s.key==="ArrowUp")){if(s.key==="ArrowDown"){let o=G+1;o>=r.length&&(o=0),e(o)}else if(s.key==="ArrowUp"){let o=G-1;o<0&&(o=G===-1?0:r.length-1),e(o)}return}if(s.key==="Enter"){if(r.length>0&&G>=0){r[G].click(),b(P),b(R),G=-1;return}const o=P.value.trim();if(o)if(Nr()&&o===Ti)Ni(ae);else if(!t(o))await Tr(o);else{Le&&await Le({url:o,title:o,channel:"",thumbnail:"",id:o}),b(R),G=-1,P.value="",b(P);return}}else s.key==="Escape"&&(If()?Qt():P.value?P.value="":b(P))}),P.addEventListener("input",()=>{P.value.trim()===""&&Qt(),G=-1});const n=Ei(P,()=>b(P),{ignore:[ve],esc:!1});ki.push(n);const i=Ei(R,()=>b(R),{ignore:[ve],esc:!1});return ki.push(i),jt=!1,Sr=!0,!0}async function Tr(t){if(!ve||!R){console.error("Search elements not initialized");return}ae=[],Ti=t,ve.disabled=!0,R.innerHTML='<div class="search-loading">Searching YouTube...</div>',V(R);try{const e=await fetch(`${Ef}/search?part=snippet&maxResults=10&q=${encodeURIComponent(t)}&type=video&key=${Cf}`);if(!e.ok)throw e.status===403?new Error("YouTube API quota exceeded. Please try again later."):e.status===400?new Error("Invalid API key or request."):new Error(`YouTube API error: ${e.status}`);const n=await e.json();if(!n.items||n.items.length===0){kr("No videos found"),ae=[];return}ae=n.items.map(i=>({id:i.id.videoId,title:i.snippet.title,thumbnail:i.snippet.thumbnails.medium.url,channel:i.snippet.channelTitle,url:`https://www.youtube.com/watch?v=${i.id.videoId}`})),Ni(ae)}catch(e){console.error("YouTube search failed:",e),kr(e.message||"Search failed. Please try again.")}finally{ve.disabled=!1}}function Ni(t){if(!R){console.error("Search results element not initialized");return}if(!t||t.length===0){R.innerHTML='<div class="no-results">No results found</div>',ae=[],G=-1;return}R.innerHTML="",t.forEach(n=>{const i=document.createElement("div");i.className="search-result-item",i.innerHTML=`
    ...
    `,i.onclick=async()=>{if(Le){if(await Le(n),b(R),G=-1,!P){console.error("Search query element not initialized");return}P.value="",b(P)}},R.appendChild(i)}),V(R),G=0,R.querySelectorAll(".search-result-item").forEach((n,i)=>{i===G?(n.classList.add("focused"),n.scrollIntoView({block:"nearest"})):n.classList.remove("focused")})}function kr(t){if(ae=[],G=-1,!R){console.error("Search results element not initialized");return}R.innerHTML=`<div class="search-error">${t}</div>`,V(R)}function Qt(){ae=[],G=-1,R&&(R.innerHTML="",b(R))}function bf(){Qt(),ki.forEach(t=>t())}function If(){return!ys(R)}function Nr(){return ae.length>0}function Sf(t){if(!t){console.warn("setupPWA: install button not found");return}let e;window.addEventListener("beforeinstallprompt",n=>{n.preventDefault(),e=n,V(t)}),t.addEventListener("click",async()=>{if(e){e.prompt();const{outcome:n}=await e.userChoice;n==="accepted"?b(t):console.log("User dismissed the install prompt"),e=null}}),window.addEventListener("appinstalled",()=>{b(t)})}function Ia(t,e,n){if(!t||!n)throw new Error("setupIceCandidates: pc and roomId are required");if(e==="initiator")Rr(t,"offerCandidates",n),Ar(t,"answerCandidates",n);else if(e==="joiner")Rr(t,"answerCandidates",n),Ar(t,"offerCandidates",n);else throw new Error(`Invalid role: ${e} specified for ICE candidate setup.`)}function Rr(t,e,n){t.onicecandidate=i=>{if(i.candidate){const s=yh(ne(ie,`rooms/${n}/${e}`));$t(s,i.candidate.toJSON())}}}function Ar(t,e,n){const i=ne(ie,`rooms/${n}/${e}`),s=r=>{const o=r.val();o&&t.remoteDescription&&t.addIceCandidate(new RTCIceCandidate(o)).catch(a=>{console.error("Error adding ICE candidate:",a)})};fa(i,s),ms(i,"child_added",s)}let q=null,Pr=null;function Ts(){return!q||!(q instanceof MediaStream)?(console.error("Invalid local MediaStream accessed:",q),console.error("Call createLocalStream() before accessing local stream."),null):q}function Tf(t){q=t}const kf=async()=>{if(q&&q instanceof MediaStream)return console.debug("Reusing existing local MediaStream."),q;const t=Cs("user");return q=await navigator.mediaDevices.getUserMedia({video:t,audio:Ln}),q};async function Nf(t){return q=await kf(),Pr=new MediaStream(q.getVideoTracks()),t.srcObject=Pr,!0}function Sa(t,e,n){return t.ontrack=i=>{if(!i.streams||!i.streams[0]||!(i.streams[0]instanceof MediaStream))return console.error("No valid remote MediaStream found in event.streams:",i.streams),!1;e.srcObject!==i.streams[0]&&(e.srcObject=i.streams[0],nf(e,n),H("Connected!"))},!0}const Rf=()=>{q&&(q.getTracks().forEach(t=>t.stop()),q=null)};function Ta(t){const e=document.createElement("div");e.innerHTML=`
  ...
  `,document.body.appendChild(e);const n=e.querySelector("#messages-toggle-btn"),i=e.querySelector("#messages-box"),s=e.querySelector("#messages-messages"),r=e.querySelector("#messages-form"),o=e.querySelector("#messages-input");if(!n||!i||!s||!r||!o)return console.error("Messages UI elements not found."),null;const a=new MutationObserver(_=>{_.forEach(g=>{g.type==="attributes"&&g.attributeName==="class"&&i.classList.contains("hidden")})});a.observe(i,{attributes:!0});function l(){i.classList.toggle("hidden"),i.classList.contains("hidden")?o.blur():o.focus()}n.addEventListener("click",l),Oh(i,()=>{b(i)},{ignore:[n],esc:!0});function c(){V(n)}function d(){b(n)}function u(_){const g=document.createElement("p");g.textContent=_,_.startsWith("You:")?g.style.textAlign="right":_.startsWith("Partner:")&&(g.style.textAlign="left"),s.appendChild(g),s.scrollTop=s.scrollHeight}function h(_){u(`Partner: ${_}`),ys(i)&&f()}function f(){n.classList.add("new-message"),setTimeout(()=>{n.classList.remove("new-message")},4e3)}r.addEventListener("submit",_=>{_.preventDefault();const g=o.value.trim();g&&(t(g),u(`You: ${g}`),o.value="")});function m(){a.disconnect(),n&&d(),e&&e.parentNode&&e.parentNode.removeChild(e)}return{appendChatMessage:u,receiveMessage:h,toggleMessages:l,showMessagesToggle:c,hideMessagesToggle:d,cleanup:m}}let xr=!1;function Af(t,e){const n=document.createElement("dialog");n.className="copy-link-dialog";const i=document.createElement("div");i.className="copy-link-dialog__content";const s=document.createElement("h2");s.className="copy-link-dialog__title",s.textContent=e.title,i.appendChild(s);const r=document.createElement("div");r.className="copy-link-dialog__input-container";const o=document.createElement("input");o.type="text",o.className="copy-link-dialog__input",o.value=t,o.readOnly=!0,o.setAttribute("aria-label","Link to copy"),r.appendChild(o),i.appendChild(r);const a=document.createElement("div");a.className="copy-link-dialog__buttons";const l=document.createElement("button");l.className="copy-link-dialog__button copy-link-dialog__button--primary",l.textContent=e.buttonText,l.autofocus=!0;const c=document.createElement("button");c.className="copy-link-dialog__button copy-link-dialog__button--secondary",c.textContent=e.cancelText,a.appendChild(l),a.appendChild(c),i.appendChild(a);const d=document.createElement("p");return d.className="copy-link-dialog__feedback",d.setAttribute("aria-live","polite"),i.appendChild(d),n.appendChild(i),{dialog:n,input:o,copyButton:l,cancelButton:c,feedback:d}}function Pf(t,e={}){const n={title:"Share this link",buttonText:"Copy",cancelText:"Cancel",successMessage:"✓ Copied to clipboard!",errorMessage:"Failed to copy. Click the link to select it manually.",autoClose:!0,autoCloseDelay:1200,onCopy:null,onError:null,onCancel:null,onClose:null,...e};xf();const{dialog:i,input:s,copyButton:r,cancelButton:o,feedback:a}=Af(t,n);Df(i);let l=!1;const c=async()=>{await Mf(t,s)?(l=!0,a.textContent=n.successMessage,a.classList.remove("copy-link-dialog__feedback--error"),n.onCopy&&n.onCopy(t),n.autoClose&&setTimeout(()=>{i.close()},n.autoCloseDelay)):(a.textContent=n.errorMessage,a.classList.add("copy-link-dialog__feedback--error"),s.readOnly=!1,s.addEventListener("click",()=>{s.select()}),n.onError&&n.onError())};return r.addEventListener("click",c),o.addEventListener("click",()=>{n.onCancel&&n.onCancel(),i.close()}),i.addEventListener("keydown",d=>{d.key==="Enter"&&!d.shiftKey&&!d.ctrlKey&&!d.altKey&&!d.metaKey&&(d.preventDefault(),c())}),i.addEventListener("close",()=>{!l&&n.onCancel&&n.onCancel(),n.onClose&&n.onClose(),setTimeout(()=>{i.remove()},300)}),document.body.appendChild(i),i.showModal(),i}function xf(){if(xr)return;const t=document.createElement("style");t.textContent=`
    .copy-link-dialog {
      border: none;
      border-radius: 12px;
      padding: 0;
  ...
  `,document.head.appendChild(t),xr=!0}function Df(t){t.showModal||(t.showModal=function(){this.setAttribute("open",""),this.style.display="block",this.style.position="fixed",this.style.top="50%",this.style.left="50%",this.style.transform="translate(-50%, -50%)",this.style.zIndex="1000"},t.close=function(){this.removeAttribute("open"),this.style.display="none"})}async function Mf(t,e){if(navigator.clipboard&&navigator.clipboard.writeText)try{return await navigator.clipboard.writeText(t),!0}catch(n){console.warn("Clipboard API failed, using fallback:",n)}try{return e.select(),e.setSelectionRange(0,99999),document.execCommand("copy")}catch(n){return console.error("Fallback copy failed:",n),!1}}let T=null,ue=null,D=null,he=null,ke=null,X,Lf=[],Ri=null;const ka=()=>z.srcObject&&z.srcObject.getVideoTracks().some(t=>t.enabled);async function Na(){he=Math.random().toString(36).substring(2,15);try{const t=Fe();b(t)}catch{}try{return await Nf(Pe),await Kh()&&V(Er),sf({getLocalStream:Ts,getLocalVideo:()=>Pe,getRemoteVideo:()=>z,getPeerConnection:()=>T,setLocalStream:Tf,muteSelfBtn:$h,videoSelfBtn:Yh,switchCameraSelfBtn:Er,fullscreenSelfBtn:Gh,mutePartnerBtn:Gt,fullscreenPartnerBtn:Vh,audioConstraints:Ln}),Sf(Uh),wf(),Uf(),En(),!0}catch(t){return console.error("Failed to get user media:",t),H("Error: Please allow camera and microphone access."),!1}}function Of(){ue=T.createDataChannel("chat"),X=Ta(e=>{ue.readyState==="open"&&ue.send(e)}),ue.onopen=()=>{X.showMessagesToggle(),X.appendChatMessage("💬 Chat connected")},ue.onmessage=e=>X.receiveMessage(e.data)}function Ai(){window.history.replaceState({},document.title,window.location.pathname)}let vn=[];function Ra(){if(!D||!he)return;const t=ne(ie,`rooms/${D}/members`),e=ne(ie,`rooms/${D}/members/${he}`);$t(e,{joinedAt:Date.now()});const n=s=>{s.key!==he&&ks()};fa(t,n),vn.push({ref:t,type:"child_added",callback:n});const i=s=>{s.key!==he&&console.info("Partner has left the call"),Bn()};Ch(t,i),vn.push({ref:t,type:"child_removed",callback:i})}const Aa={iceServers:[{urls:"stun:stun.l.google.com:19302"}]};function Pa(t){t.onconnectionstatechange=()=>{t.connectionState==="connected"?(H("Connected!"),ks()):t.connectionState==="disconnected"?(H("Partner disconnected"),En(),Ai()):t.connectionState==="failed"&&(H("Connection failed"),Ai())}}async function Ff(){const t=Ts();if(!t)return H("Error: Camera not initialized"),!1;D=Math.random().toString(36).substring(2,15),ke="initiator",T=new RTCPeerConnection(Aa),Of(),t.getTracks().forEach(o=>{T.addTrack(o,t)}),Sa(T,z,Gt)&&(Ia(T,ke,D),Pa(T),console.debug("Peer connection created as initiator with room ID:",D));const e=await T.createOffer();await T.setLocalDescription(e);const n=ne(ie,`rooms/${D}`);await $t(n,{offer:{type:e.type,sdp:e.sdp}});const i=ne(ie,`rooms/${D}/answer`),s=async o=>{const a=o.val();if(a&&a.sdp!==Ri){if(Ri=a.sdp,T.signalingState!=="have-local-offer"&&T.signalingState!=="stable")return!0;try{return await T.setRemoteDescription(new RTCSessionDescription(a)),!0}catch(l){return console.error("Failed to set remote description:",l),!1}}};ha(i,s),ms(i,"value",s),wa(D,ke,he),Ra();const r=`${window.location.origin}${window.location.pathname}?room=${D}`;return ma.value=r,ge.disabled=!0,lt.disabled=!1,Pf(r,{onCopy:()=>H("Link ready! Share with your partner."),onCancel:()=>{H('Call cancelled. Click "Start New Chat" to try again.'),Bn()}}),H("Waiting for partner to join..."),!0}async function Bf(){const t=Ts();if(!t)return H("Error: Camera not initialized"),!1;if(!D)return H("Error: No room ID"),!1;ke="joiner";const e=ne(ie,`rooms/${D}`),n=await vh(e);if(!n.exists())return H("Error: Invalid room link"),!1;const s=n.val().offer;if(!s)return H("Error: No offer found"),!1;T=new RTCPeerConnection(Aa),T.ondatachannel=o=>{ue=o.channel,X=Ta(a=>ue.send(a)),ue.onopen=()=>{X.showMessagesToggle(),X.appendChatMessage("💬 Chat connected")},ue.onmessage=a=>X.receiveMessage(a.data)},t.getTracks().forEach(o=>{T.addTrack(o,t)}),Sa(T,z,Gt)&&(Ia(T,ke,D),Pa(T),console.debug("Peer connection created as joiner for room ID:",D)),await T.setRemoteDescription(new RTCSessionDescription(s));const r=await T.createAnswer();await T.setLocalDescription(r);try{await da(e,{answer:{type:r.type,sdp:r.sdp}})}catch(o){return console.error("Failed to update answer in Firebase:",o),H("Failed to send answer to partner."),!1}return wa(D,ke,he),Ra(),ks(),H("Connecting..."),!0}let bt=null;function Cn(){Ss()||(ka()?(vs(z),b(Pe),z.requestPictureInPicture().then(()=>{b(z)}).catch(t=>{console.error("Failed to enter Picture-in-Picture:",t)})):V(Pe),Mt.classList.remove("bottom"),Mt.classList.add("watch-mode"),Ea(!0))}function Xt(){Ss()&&(V(Pe),ka()&&(Fh(z),V(z),Bh(z)&&document.exitPictureInPicture().catch(t=>{console.error("Failed to exit Picture-in-Picture:",t)})),Mt.classList.remove("watch-mode"),Mt.classList.add("bottom"),Ea(!1))}let ks=()=>{V(z),vs(Pe),ge.disabled=!0,Gt.disabled=!1,lt.disabled=!1,bt||(bt=zh(Mt,{inactivityMs:2500,hideOnEsc:!0}))},En=()=>{b(z),vs(Pe),ge.disabled=!1,lt.disabled=!0,Gt.disabled=!0,bt&&(bt(),bt=null)};function Zn(){return I&&!I.classList.contains("hidden")&&I.src&&I.src.trim()!==""}let Dr=!1;function Uf(){if(Dr)return;const t=()=>{const e=document.activeElement;return e&&(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)};document.addEventListener("keydown",e=>{t()||((e.key==="w"||e.key==="W")&&(console.log("=== W KEY PRESSED ==="),console.log("lastWatched:",ft()),console.log("isYTVisible():",Xn()),console.log("isSharedVideoVisible():",Zn()),console.log("isWatchModeActive():",Ss()),ft()==="yt"?(console.log("Processing YouTube case"),Xn()?(console.log("Hiding YouTube player"),Ii(),Xt()):(console.log("Showing YouTube player"),ya(),Cn())):ft()==="url"&&(console.log("Processing URL case"),Zn()?(console.log("Hiding shared video"),b(I),Xt()):(console.log("Showing shared video"),V(I),Cn()))),(e.key==="m"||e.key==="M")&&X&&X.toggleMessages()),e.key==="Escape"&&(ft()==="yt"&&Xn()?(On(),Ii(),Xt()):ft()==="url"&&Zn()&&(I.pause(),b(I)))}),Dr=!0}ge.onclick=async()=>{await Ff()};lt.onclick=Bn;async function Wf(){const e=new URLSearchParams(window.location.search).get("room");if(!e)return H('Ready. Click "Start New Chat" to begin.'),!1;D=e,H("Connecting to room...");const n=await Na();let i=!1;return n&&(i=await Bf()),i?!0:(V(ge),lt.disabled=!0,ge.disabled=!1,Ai(),!1)}window.onload=async()=>{if(await Wf())return;if(!await Na()){ge.disabled=!0,console.error("Initialization failed. Cannot start chat.");return}};window.addEventListener("beforeunload",t=>{if(T&&T.connectionState==="connected")return t.preventDefault(),t.returnValue="You are in an active call. Are you sure you want to leave?",t.returnValue;Hf()});let ei=!1;async function Bn(){if(!ei){if(ei=!0,console.debug("Hanging up..."),En(),z.srcObject&&(z.srcObject.getTracks().forEach(t=>t.stop()),z.srcObject=null),rf(),T&&(T.close(),T=null),Lh(),D&&ke==="initiator"){const t=ne(ie,`rooms/${D}`);Cr(t).catch(e=>{console.warn("Failed to remove room:",e)})}if(En(),V(ge),lt.disabled=!0,ge.disabled=!1,Wh.style.display="none",vn.forEach(({ref:t,type:e,callback:n})=>pa(t,e,n)),vn.length=0,D&&he){const t=ne(ie,`rooms/${D}/members/${he}`);Cr(t).catch(()=>{})}document.pictureInPictureElement&&document.exitPictureInPicture().catch(t=>console.error(t)),X&&X.cleanup&&(X.cleanup(),X=null),D=null,ke=null,Ri=null,window.history.replaceState({},document.title,window.location.pathname),H('Disconnected. Click "Start New Chat" to begin.'),ei=!1}}function Hf(){(T||D)&&Bn(),ma.value="",I.src="",Hh.textContent="",Rf(),Pe.srcObject=null,Xt(),uf("none"),Es(),ga(!1),bf(),Lf.forEach(t=>t())}
