const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/virtual_pwa-register-B9hemr6f.js","assets/main-CAo3pG9Y.js","assets/main-BI7ISyrY.css"])))=>i.map(i=>d[i]);
import{c as s,n as a,_ as c}from"./main-CAo3pG9Y.js";function l({template:e,handlers:t={},className:o="notification",parent:i=document.body,initialProps:r={},...d}){return s({template:e,handlers:t,className:o,parent:i,initialProps:r,containerTag:"div",autoAppend:!1,...d})}const n="pwa-update";function u(e){if(a.has(n))return a.notifications.get(n);const t=l({template:`
