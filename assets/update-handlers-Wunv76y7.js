const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/virtual_pwa-register-CJM_wGm4.js","assets/main-BxIQ9NAj.js","assets/main-C2LEXGg2.css"])))=>i.map(i=>d[i]);
import{c as s,n as a,_ as c}from"./main-BxIQ9NAj.js";function l({template:e,handlers:t={},className:o="notification",parent:i=document.body,initialProps:r={},...d}){return s({template:e,handlers:t,className:o,parent:i,initialProps:r,containerTag:"div",autoAppend:!1,...d})}const n="pwa-update";function u(e){if(a.has(n))return a.notifications.get(n);const t=l({template:`
