 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qo{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const i=new L(Oi,e),s=new L(Oi,n);return this.compare(i,s)!==0}minPost(){return L.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Lc;function xI(t){Lc=t}const Hg=function(t){return typeof t=="number"?"number:"+wg(t):"string:"+t},Vg=function(t){if(t.isLeafNode()){const e=t.val();g(typeof e=="string"||typeof e=="number"||typeof e=="object"&&vt(e,".sv"),"Priority must be a string or number.")}else g(t===Lc||t.isEmpty(),"priority of unexpected type.");g(t===Lc||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jI extends qo{constructor(e){super(),this.indexPath_=e,g(!O(e)&&P(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,n){const i=this.extractChild(e.node),s=this.extractChild(n.node),r=i.compareTo(s);return r===0?Qn(e.name,n.name):r}makePost(e,n){const i=ie(e),s=C.EMPTY_NODE.updateChild(this.indexPath_,i);return new L(n,s)}maxPost(){const e=C.EMPTY_NODE.updateChild(this.indexPath_,sr);return new L($n,e)}toString(){return xs(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qI extends qo{compare(e,n){const i=e.node.compareTo(n.node);return i===0?Qn(e.name,n.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return L.MIN}maxPost(){return L.MAX}makePost(e,n){const i=ie(e);return new L(n,i)}toString(){return".value"}}const zI=new qI;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class to{constructor(e,n,i){this.path=e,this.affectedTree=n,this.revert=i,this.type=it.ACK_USER_WRITE,this.source=jl()}operationForChild(e){if(O(this.path)){if(this.affectedTree.value!=null)return g(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new j(e));return new to(B(),n,this.revert)}}else return g(P(this.path)===e,"operationForChild called for unrelated child."),new to(G(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bs{constructor(e,n){this.source=e,this.path=n,this.type=it.LISTEN_COMPLETE}operationForChild(e){return O(this.path)?new Bs(this.source,B()):new Bs(this.source,G(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bn{constructor(e,n,i){this.source=e,this.path=n,this.snap=i,this.type=it.OVERWRITE}operationForChild(e){return O(this.path)?new Bn(this.source,B(),this.snap.getImmediateChild(e)):new Bn(this.source,G(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Di{constructor(e,n,i){this.source=e,this.path=n,this.children=i,this.type=it.MERGE}operationForChild(e){if(O(this.path)){const n=this.children.subtree(new j(e));return n.isEmpty()?null:n.value?new Bn(this.source,B(),n.value):new Di(this.source,B(),n)}else return g(P(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Di(this.source,G(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xR{constructor(e,n){this._repo=e,this._path=n}cancel(){const e=new Oe;return SR(this._repo,this._path,e.wrapCallback(()=>{})),e.promise}remove(){Nn("OnDisconnect.remove",this._path);const e=new Oe;return Zh(this._repo,this._path,null,e.wrapCallback(()=>{})),e.promise}set(e){Nn("OnDisconnect.set",this._path),lo("OnDisconnect.set",e,this._path,!1);const n=new Oe;return Zh(this._repo,this._path,e,n.wrapCallback(()=>{})),n.promise}setWithPriority(e,n){Nn("OnDisconnect.setWithPriority",this._path),lo("OnDisconnect.setWithPriority",e,this._path,!1),dR("OnDisconnect.setWithPriority",n);const i=new Oe;return IR(this._repo,this._path,e,n,i.wrapCallback(()=>{})),i.promise}update(e){Nn("OnDisconnect.update",this._path),ym("OnDisconnect.update",e,this._path);const n=new Oe;return kR(this._repo,this._path,e,n.wrapCallback(()=>{})),n.promise}}/**
 * @license
 ...
 */function gu(){return ia().enabled}async function mu(){const t=ia();if(t.enabled&&t.token)return t.token.promise;throw Error(`
        ...
        `)}function gA(){const t=tg(),e=ia();if(e.initialized=!0,typeof t.FIREBASE_APPCHECK_DEBUG_TOKEN!="string"&&t.FIREBASE_APPCHECK_DEBUG_TOKEN!==!0)return;e.enabled=!0;const n=new Oe;e.token=n,typeof t.FIREBASE_APPCHECK_DEBUG_TOKEN=="string"?n.resolve(t.FIREBASE_APPCHECK_DEBUG_TOKEN):n.resolve(pA())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ca{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const n=this.receivers.find(s=>s.isListeningto(e));if(n)return n;const i=new ca(e);return this.receivers.push(i),i}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const n=e,{eventId:i,eventType:s,data:r}=n.data,o=this.handlersMap[s];if(!o?.size)return;n.ports[0].postMessage({status:"ack",eventId:i,eventType:s});const a=Array.from(o).map(async l=>l(n.origin,r)),c=await LN(a);n.ports[0].postMessage({status:"done",eventId:i,eventType:s,response:c})}_subscribe(e,n){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(n)}_unsubscribe(e,n){this.handlersMap[e]&&n&&this.handlersMap[e].delete(n),(!n||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}ca.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vy=1e4,by=`w:${Zu}`,Ey="FIS_v2",rL="https://firebaseinstallations.googleapis.com/v1",oL=3600*1e3,aL="installations",cL="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pL(t){return btoa(String.fromCharCode(...t)).replace(/\+/g,"-").replace(/\//g,"_")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gL=/^[cdef][\w-]{21}$/,fl="";function mL(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const n=_L(t);return gL.test(n)?n:fl}catch{return fl}}function _L(t){return pL(t).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ny=new Map;function Py(t,e){const n=_a(t);Oy(n,e),yL(n,e)}function Oy(t,e){const n=Ny.get(t);if(n)for(const i of n)i(e)}function yL(t,e){const n=wL();n&&n.postMessage({key:t,fid:e}),vL()}let On=null;function wL(){return!On&&"BroadcastChannel"in self&&(On=new BroadcastChannel("[Firebase] FID Change"),On.onmessage=t=>{Oy(t.data.key,t.data.fid)}),On}function vL(){Ny.size===0&&On&&(On.close(),On=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bL="firebase-installations-database",EL=1,Kn="firebase-installations-store";let sc=null;function ed(){return sc||(sc=Vo(bL,EL,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Kn)}}})),sc}async function ko(t,e){const n=_a(t),s=(await ed()).transaction(Kn,"readwrite"),r=s.objectStore(Kn),o=await r.get(n);return await r.put(e,n),await s.done,(!o||o.fid!==e.fid)&&Py(t,e.fid),e}async function Ly(t){const e=_a(t),i=(await ed()).transaction(Kn,"readwrite");await i.objectStore(Kn).delete(e),await i.done}async function ya(t,e){const n=_a(t),s=(await ed()).transaction(Kn,"readwrite"),r=s.objectStore(Kn),o=await r.get(n),a=e(o);return a===void 0?await r.delete(n):await r.put(a,n),await s.done,a&&(!o||o.fid!==a.fid)&&Py(t,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function td(t){let e;const n=await ya(t.appConfig,i=>{const s=CL(i),r=TL(t,s);return e=r.registrationPromise,r.installationEntry});return n.fid===fl?{installationEntry:await e}:{installationEntry:n,registrationPromise:e}}function CL(t){const e=t||{fid:mL(),registrationStatus:0};return Dy(e)}function TL(t,e){if(e.registrationStatus===0){if(!navigator.onLine){const s=Promise.reject(Gn.create("app-offline"));return{installationEntry:e,registrationPromise:s}}const n={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},i=SL(t,n);return{installationEntry:n,registrationPromise:i}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:IL(t)}:{installationEntry:e}}async function SL(t,e){try{const n=await fL(t,e);return ko(t.appConfig,n)}catch(n){throw Cy(n)&&n.customData.serverCode===409?await Ly(t.appConfig):await ko(t.appConfig,{fid:e.fid,registrationStatus:0}),n}}async function IL(t){let e=await Wf(t.appConfig);for(;e.registrationStatus===1;)await Ay(100),e=await Wf(t.appConfig);if(e.registrationStatus===0){const{installationEntry:n,registrationPromise:i}=await td(t);return i||n}return e}function Wf(t){return ya(t,e=>{if(!e)throw Gn.create("installation-not-found");return Dy(e)})}function Dy(t){return kL(t)?{fid:t.fid,registrationStatus:0}:t}function kL(t){return t.registrationStatus===1&&t.registrationTime+vy<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function RL({appConfig:t,heartbeatServiceProvider:e},n){const i=AL(t,n),s=uL(t,n),r=e.getImmediate({optional:!0});if(r){const l=await r.getHeartbeatsHeader();l&&s.append("x-firebase-client",l)}const o={installation:{sdkVersion:by,appId:t.appId}},a={method:"POST",headers:s,body:JSON.stringify(o)},c=await Ry(()=>fetch(i,a));if(c.ok){const l=await c.json();return Sy(l)}else throw await Iy("Generate Auth Token",c)}function AL(t,{fid:e}){return`${Ty(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nd(t,e=!1){let n;const i=await ya(t.appConfig,r=>{if(!My(r))throw Gn.create("not-registered");const o=r.authToken;if(!e&&OL(o))return r;if(o.requestStatus===1)return n=NL(t,e),r;{if(!navigator.onLine)throw Gn.create("app-offline");const a=DL(r);return n=PL(t,a),a}});return n?await n:i.authToken}async function NL(t,e){let n=await jf(t.appConfig);for(;n.authToken.requestStatus===1;)await Ay(100),n=await jf(t.appConfig);const i=n.authToken;return i.requestStatus===0?nd(t,e):i}function jf(t){return ya(t,e=>{if(!My(e))throw Gn.create("not-registered");const n=e.authToken;return ML(n)?{...e,authToken:{requestStatus:0}}:e})}async function PL(t,e){try{const n=await RL(t,e),i={...e,authToken:n};return await ko(t.appConfig,i),n}catch(n){if(Cy(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await Ly(t.appConfig);else{const i={...e,authToken:{requestStatus:0}};await ko(t.appConfig,i)}throw n}}function My(t){return t!==void 0&&t.registrationStatus===2}function OL(t){return t.requestStatus===2&&!LL(t)}function LL(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+oL}function DL(t){const e={requestStatus:1,requestTime:Date.now()};return{...t,authToken:e}}function ML(t){return t.requestStatus===1&&t.requestTime+vy<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xL(t){const e=t,{installationEntry:n,registrationPromise:i}=await td(e);return i?i.catch(console.error):nd(e).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function FL(t,e=!1){const n=t;return await UL(n),(await nd(n,e)).token}async function UL(t){const{registrationPromise:e}=await td(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $L(t){if(!t||!t.options)throw rc("App Configuration");if(!t.name)throw rc("App Name");const e=["projectId","apiKey","appId"];for(const n of e)if(!t.options[n])throw rc(n);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}function rc(t){return Gn.create("missing-app-config-values",{valueName:t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xy="installations",BL="installations-internal",HL=t=>{const e=t.getProvider("app").getImmediate(),n=$L(e),i=_n(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},VL=t=>{const e=t.getProvider("app").getImmediate(),n=_n(e,xy).getImmediate();return{getId:()=>xL(n),getToken:s=>FL(n,s)}};function WL(){Ye(new We(xy,HL,"PUBLIC")),Ye(new We(BL,VL,"PRIVATE"))}WL();Ve(wy,Zu);Ve(wy,Zu,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jL="/firebase-messaging-sw.js",qL="/firebase-cloud-messaging-push-scope",Fy="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",zL="https://fcmregistrations.googleapis.com/v1",Uy="google.c.a.c_id",GL="google.c.a.c_l",KL="google.c.a.ts",YL="google.c.a.e",qf=1e4;var zf;(function(t){t[t.DATA_MESSAGE=1]="DATA_MESSAGE",t[t.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(zf||(zf={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tt(t){const e=new Uint8Array(t);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function JL(t){const e="=".repeat((4-t.length%4)%4),n=(t+e).replace(/\-/g,"+").replace(/_/g,"/"),i=atob(n),s=new Uint8Array(i.length);for(let r=0;r<i.length;++r)s[r]=i.charCodeAt(r);return s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oc="fcm_token_details_db",XL=5,Gf="fcm_token_object_Store";async function QL(t){if("databases"in indexedDB&&!(await indexedDB.databases()).map(r=>r.name).includes(oc))return null;let e=null;return(await Vo(oc,XL,{upgrade:async(i,s,r,o)=>{if(s<2||!i.objectStoreNames.contains(Gf))return;const a=o.objectStore(Gf),c=await a.index("fcmSenderId").get(t);if(await a.clear(),!!c){if(s===2){const l=c;if(!l.auth||!l.p256dh||!l.endpoint)return;e={token:l.fcmToken,createTime:l.createTime??Date.now(),subscriptionOptions:{auth:l.auth,p256dh:l.p256dh,endpoint:l.endpoint,swScope:l.swScope,vapidKey:typeof l.vapidKey=="string"?l.vapidKey:Tt(l.vapidKey)}}}else if(s===3){const l=c;e={token:l.fcmToken,createTime:l.createTime,subscriptionOptions:{auth:Tt(l.auth),p256dh:Tt(l.p256dh),endpoint:l.endpoint,swScope:l.swScope,vapidKey:Tt(l.vapidKey)}}}else if(s===4){const l=c;e={token:l.fcmToken,createTime:l.createTime,subscriptionOptions:{auth:Tt(l.auth),p256dh:Tt(l.p256dh),endpoint:l.endpoint,swScope:l.swScope,vapidKey:Tt(l.vapidKey)}}}}}})).close(),await Da(oc),await Da("fcm_vapid_details_db"),await Da("undefined"),ZL(e)?e:null}function ZL(t){if(!t||!t.subscriptionOptions)return!1;const{subscriptionOptions:e}=t;return typeof t.createTime=="number"&&t.createTime>0&&typeof t.token=="string"&&t.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bD(t,e,n){const i=ED(e);(await t.firebaseDependencies.analyticsProvider.get()).logEvent(i,{message_id:n[Uy],message_name:n[GL],message_time:n[KL],message_device_time:Math.floor(Date.now()/1e3)})}function ED(t){switch(t){case Js.NOTIFICATION_CLICKED:return"notification_open";case Js.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function CD(t,e){const n=e.data;if(!n.isFirebaseMessaging)return;t.onMessageHandler&&n.messageType===Js.PUSH_RECEIVED&&(typeof t.onMessageHandler=="function"?t.onMessageHandler(Yf(n)):t.onMessageHandler.next(Yf(n)));const i=n.data;gD(i)&&i[YL]==="1"&&await bD(t,n.messageType,i)}const Jf="@firebase/messaging",Xf="0.12.23";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
