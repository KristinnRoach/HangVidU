 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ns=Dc;function is(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i={name:De,automaticDataCollectionEnabled:!0,...e},s=i.name;if(typeof s!="string"||!s)throw X.create("bad-app-name",{appName:String(s)});if(t||(t=Ki()),!t)throw X.create("no-options");const r=xe.get(s);if(r){if(gn(t,r.options)&&gn(i,r.config))return r;throw X.create("duplicate-app",{appName:s})}const o=new Xi(s);for(const l of lt.values())o.addComponent(l);const a=new _o(t,i,o);return xe.set(s,a),a}function Bc(n,e={}){if(Sl()&&!oo())throw X.create("invalid-server-app-environment");let t,i=e||{};if(n&&(ts(n)?t=n.options:po(n)?i=n:t=n),i.automaticDataCollectionEnabled===void 0&&(i.automaticDataCollectionEnabled=!0),t||(t=Ki()),!t)throw X.create("no-options");const s={...i,...t};s.releaseOnDeref!==void 0&&delete s.releaseOnDeref;const r=u=>[...u].reduce((d,h)=>Math.imul(31,d)+h.charCodeAt(0)|0,0);if(i.releaseOnDeref!==void 0&&typeof FinalizationRegistry>"u")throw X.create("finalization-registry-not-supported",{});const o=""+r(JSON.stringify(s)),a=at.get(o);if(a)return a.incRefCount(i.releaseOnDeref),a;const l=new Xi(o);for(const u of lt.values())l.addComponent(u);const c=new Fc(t,i,o,l);return at.set(o,c),c}function Vc(n=De){const e=xe.get(n);if(!e&&n===De&&Ki())return is();if(!e)throw X.create("no-app",{appName:n});return e}function Wc(){return Array.from(xe.values())}async function ss(n){let e=!1;const t=n.name;xe.has(t)?(e=!0,xe.delete(t)):at.has(t)&&n.decRefCount()<=0&&(at.delete(t),e=!0),e&&(await Promise.all(n.container.getProviders().map(i=>i.delete())),n.isDeleted=!0)}function ye(n,e,t){let i=xc[n]??n;t&&(i+=`-${t}`);const s=i.match(/\s|\//),r=e.match(/\s|\//);if(s||r){const o=[`Unable to register library "${i}" with version "${e}":`];s&&o.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&r&&o.push("and"),r&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ee.warn(o.join(" "));return}ct(new we(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}function go(n,e){if(n!==null&&typeof n!="function")throw X.create("invalid-log-argument");zl(n,e)}function yo(n){Gl(n)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xc{constructor(e,t){this._delegate=e,this.firebase=t,Ft(e,new we("app-compat",()=>this,"PUBLIC")),this.container=e.container}get automaticDataCollectionEnabled(){return this._delegate.automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this._delegate.automaticDataCollectionEnabled=e}get name(){return this._delegate.name}get options(){return this._delegate.options}delete(){return new Promise(e=>{this._delegate.checkDestroyed(),e()}).then(()=>(this.firebase.INTERNAL.removeApp(this.name),ss(this._delegate)))}_getService(e,t=De){this._delegate.checkDestroyed();const i=this._delegate.container.getProvider(e);return!i.isInitialized()&&i.getComponent()?.instantiationMode==="EXPLICIT"&&i.initialize(),i.getImmediate({identifier:t})}_removeServiceInstance(e,t=De){this._delegate.container.getProvider(e).clearInstance(t)}_addComponent(e){Ft(this._delegate,e)}_addOrOverwriteComponent(e){ho(this._delegate,e)}toJSON(){return{name:this.name,automaticDataCollectionEnabled:this.automaticDataCollectionEnabled,options:this.options}}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const So=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new au(e)}}catch{}return new lu},He=So("localStorage"),Ii=So("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wn{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new w(Oe,e),s=new w(Oe,t);return this.compare(i,s)!==0}minPost(){return w.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hn(n,e){return{eventCache:n,serverCache:e}}function Pt(n,e,t,i){return Hn(new Le(e,t,i),n.serverCache)}function na(n,e,t,i){return Hn(n.eventCache,new Le(e,t,i))}function In(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Qe(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gd{getCompleteChild(e){return null}getChildAfterChild(e,t,i){return null}}const la=new Gd;class ws{constructor(e,t,i=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=i}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new Le(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return vs(this.writes_,e,i)}}getChildAfterChild(e,t,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Qe(this.viewCache_),r=Hd(this.writes_,s,t,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let kn;class da{constructor(){this.views=new Map}}function oh(n){p(!kn,"__referenceConstructor has already been defined"),kn=n}function ah(){return p(kn,"Reference.ts has not been loaded"),kn}function lh(n){return n.views.size===0}function Es(n,e,t,i){const s=e.source.queryId;if(s!==null){const r=n.views.get(s);return p(r!=null,"SyncTree gave us an op for an invalid query."),Dr(r,e,t,i)}else{let r=[];for(const o of n.views.values())r=r.concat(Dr(o,e,t,i));return r}}function ha(n,e,t,i,s){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=Tn(t,s?i:null),l=!1;a?l=!0:i instanceof g?(a=Cs(t,i),l=!1):(a=g.EMPTY_NODE,l=!1);const c=Hn(new Le(a,l,!1),new Le(i,s,!1));return new eh(e,c)}return o}function ch(n,e,t,i,s,r){const o=ha(n,e,i,s,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),sh(o,t),rh(o,t)}function uh(n,e,t,i){const s=e._queryIdentifier,r=[];let o=[];const a=Fe(n);if(s==="default")for(const[l,c]of n.views.entries())o=o.concat(Nr(c,t,i)),Ar(c)&&(n.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=n.views.get(s);l&&(o=o.concat(Nr(l,t,i)),Ar(l)&&(n.views.delete(s),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!Fe(n)&&r.push(new(ah())(e._repo,e._path)),{removed:r,events:o}}function fa(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function ke(n,e){let t=null;for(const i of n.views.values())t=t||ih(i,e);return t}function pa(n,e){if(e._queryParams.loadsAllData())return Gn(n);{const i=e._queryIdentifier;return n.views.get(i)}}function ma(n,e){return pa(n,e)!=null}function Fe(n){return Gn(n)!=null}function Gn(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
