const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/virtual_pwa-register-D7sSgFdG.js","assets/main-DpA34pUK.js","assets/main-VIMQ__z4.css"])))=>i.map(i=>d[i]);
import{c as d,n as a,_ as c}from"./main-DpA34pUK.js";function l({template:e,handlers:t={},className:i="notification",parent:o=document.body,initialProps:r={},...s}){return d({template:e,handlers:t,className:i,parent:o,initialProps:r,containerTag:"div",autoAppend:!1,...s})}const n="pwa-update";function u(e){if(a.has(n))return a.notifications.get(n);const t=l({template:`
