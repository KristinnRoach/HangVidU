 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nl=function(n){let e={},t={},i={},s="";try{const r=n.split(".");e=qn(Hi(r[0])||""),t=qn(Hi(r[1])||""),s=r[2],i=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:i,signature:s}},uh=function(n){const e=nl(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},dh=function(n){const e=nl(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var P;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(P||(P={}));const Ch={debug:P.DEBUG,verbose:P.VERBOSE,info:P.INFO,warn:P.WARN,error:P.ERROR,silent:P.SILENT},Eh=P.INFO,bh={[P.DEBUG]:"log",[P.VERBOSE]:"log",[P.INFO]:"info",[P.WARN]:"warn",[P.ERROR]:"error"},Ih=(n,e,...t)=>{if(e<n.logLevel)return;const i=new Date().toISOString(),s=bh[e];if(s)console[s](`[${i}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Kr{constructor(e){this.name=e,this._logLevel=Eh,this._logHandler=Ih,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in P))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Ch[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,P.DEBUG,...e),this._logHandler(this,P.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,P.VERBOSE,...e),this._logHandler(this,P.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,P.INFO,...e),this._logHandler(this,P.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,P.WARN,...e),this._logHandler(this,P.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,P.ERROR,...e),this._logHandler(this,P.ERROR,...e)}}const Sh=(n,e)=>e.some(t=>n instanceof t);let Ea,ba;function Th(){return Ea||(Ea=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Rh(){return ba||(ba=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const il=new WeakMap,dr=new WeakMap,sl=new WeakMap,Hs=new WeakMap,Jr=new WeakMap;function kh(n){const e=new Promise((t,i)=>{const s=()=>{n.removeEventListener("success",r),n.removeEventListener("error",o)},r=()=>{t(ht(n.result)),s()},o=()=>{i(n.error),s()};n.addEventListener("success",r),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&il.set(t,n)}).catch(()=>{}),Jr.set(e,n),e}function Ah(n){if(dr.has(n))return;const e=new Promise((t,i)=>{const s=()=>{n.removeEventListener("complete",r),n.removeEventListener("error",o),n.removeEventListener("abort",o)},r=()=>{t(),s()},o=()=>{i(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",r),n.addEventListener("error",o),n.addEventListener("abort",o)});dr.set(n,e)}let hr={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return dr.get(n);if(e==="objectStoreNames")return n.objectStoreNames||sl.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return ht(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Nh(n){hr=n(hr)}function Ph(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const i=n.call($s(this),e,...t);return sl.set(i,e.sort?e.sort():[e]),ht(i)}:Rh().includes(n)?function(...e){return n.apply($s(this),e),ht(il.get(this))}:function(...e){return ht(n.apply($s(this),e))}}function Lh(n){return typeof n=="function"?Ph(n):(n instanceof IDBTransaction&&Ah(n),Sh(n,Th())?new Proxy(n,hr):n)}function ht(n){if(n instanceof IDBRequest)return kh(n);if(Hs.has(n))return Hs.get(n);const e=Lh(n);return e!==n&&(Hs.set(n,e),Jr.set(e,n)),e}const $s=n=>Jr.get(n);function Oh(n,e,{blocked:t,upgrade:i,blocking:s,terminated:r}={}){const o=indexedDB.open(n,e),a=ht(o);return i&&o.addEventListener("upgradeneeded",c=>{i(ht(o.result),c.oldVersion,c.newVersion,ht(o.transaction),c)}),t&&o.addEventListener("blocked",c=>t(c.oldVersion,c.newVersion,c)),a.then(c=>{r&&c.addEventListener("close",()=>r()),s&&c.addEventListener("versionchange",l=>s(l.oldVersion,l.newVersion,l))}).catch(()=>{}),a}const Dh=["get","getKey","getAll","getAllKeys","count"],Mh=["put","add","delete","clear"],Vs=new Map;function Ia(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Vs.get(e))return Vs.get(e);const t=e.replace(/FromIndex$/,""),i=e!==t,s=Mh.includes(t);if(!(t in(i?IDBIndex:IDBObjectStore).prototype)||!(s||Dh.includes(t)))return;const r=async function(o,...a){const c=this.transaction(o,s?"readwrite":"readonly");let l=c.store;return i&&(l=l.index(a.shift())),(await Promise.all([l[t](...a),s&&c.done]))[0]};return Vs.set(e,r),r}Nh(n=>({...n,get:(e,t,i)=>Ia(e,t)||n.get(e,t,i),has:(e,t)=>!!Ia(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pr="[DEFAULT]",hf={[fr]:"fire-core",[Uh]:"fire-core-compat",[Wh]:"fire-analytics",[Bh]:"fire-analytics-compat",[$h]:"fire-app-check",[Hh]:"fire-app-check-compat",[Vh]:"fire-auth",[jh]:"fire-auth-compat",[Gh]:"fire-rtdb",[zh]:"fire-data-connect",[qh]:"fire-rtdb-compat",[Yh]:"fire-fn",[Kh]:"fire-fn-compat",[Jh]:"fire-iid",[Qh]:"fire-iid-compat",[Xh]:"fire-fcm",[Zh]:"fire-fcm-compat",[ef]:"fire-perf",[tf]:"fire-perf-compat",[nf]:"fire-rc",[sf]:"fire-rc-compat",[rf]:"fire-gcs",[of]:"fire-gcs-compat",[af]:"fire-fst",[lf]:"fire-fst-compat",[cf]:"fire-vertex","fire-js":"fire-js",[uf]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sf(n){on(new Ft("platform-logger",e=>new xh(e),"PRIVATE")),on(new Ft("heartbeat",e=>new Cf(e),"PRIVATE")),pt(fr,Sa,n),pt(fr,Sa,"esm2020"),pt("fire-js","")}Sf("");var Na={};const Pa="@firebase/database",La="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ul=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Rf(e)}}catch{}return new kf},Nt=ul("localStorage"),Af=ul("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $f{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,Ie(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t?.getImmediate({optional:!0}),this.appCheck||t?.get().then(i=>this.appCheck=i)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,i)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,i):t(null)},0)})}addTokenChangeListener(e){this.appCheckProvider?.get().then(t=>t.addTokenListener(e))}notifyForInvalidToken(){ue(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gf{constructor(){this.counters_={}}incrementCounter(e,t=1){Ve(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return Gd(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gi extends Pl{static getInstance(){return new Gi}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Yr()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return p(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bi;class Dl extends ys{static get __EMPTY_NODE(){return bi}static set __EMPTY_NODE(e){bi=e}compare(e,t){return $t(e.name,t.name)}isDefinedOn(e){throw mn("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return S.MIN}maxPost(){return new S(Ut,bi)}makePost(e,t){return p(typeof e=="string","KeyIndex indexValue must always be a string."),new S(e,bi)}toString(){return".key"}}const Jt=new Dl;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sp(n,e){return $t(n.name,e.name)}function oo(n,e){return $t(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fl,Ul;function Rp(n){Fl=n}function kp(n){Ul=n}class Ap extends ys{compare(e,t){const i=e.node.getPriority(),s=t.node.getPriority(),r=i.compareTo(s);return r===0?$t(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return S.MIN}maxPost(){return new S(Ut,new q("[PRIORITY-POST]",Ul))}makePost(e,t){const i=Fl(e);return new S(t,new q("[PRIORITY-POST]",i))}toString(){return".priority"}}const V=new Ap;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mp extends ys{compare(e,t){const i=e.node.compareTo(t.node);return i===0?$t(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return S.MIN}maxPost(){return S.MAX}makePost(e,t){const i=G(e);return new S(t,i)}toString(){return".value"}}const xp=new Mp;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ao{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){p(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(Qn(t,a)):p(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(cn(t,i)):o.trackChildChange(Xn(t,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild(V,(s,r)=>{t.hasChild(s)||i.trackChildChange(Qn(s,r))}),t.isLeafNode()||t.forEachChild(V,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(Xn(s,r,o))}else i.trackChildChange(cn(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?w.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ka=10*1e3,Vp=30*1e3,jp=300*1e3;class Gp{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new $p(e);const i=Ka+(Vp-Ka)*Math.random();Bn(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;ne(e,(s,r)=>{r>0&&Ve(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),Bn(this.reportStats_.bind(this),Math.floor(Math.random()*2*jp))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vs(n,e){return{eventCache:n,serverCache:e}}function Wn(n,e,t,i){return vs(new vt(e,t,i),n.serverCache)}function Hl(n,e,t,i){return vs(n.eventCache,new vt(e,t,i))}function Ji(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Wt(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ne{constructor(e){this.writeTree_=e}static empty(){return new Ne(new O(null))}}function Hn(n,e,t){if(T(e))return new Ne(new O(t));{const i=n.writeTree_.findRootMostValueAndPath(e);if(i!=null){const s=i.path;let r=i.value;const o=le(s,e);return r=r.updateChild(o,t),new Ne(n.writeTree_.set(s,r))}else{const s=new O(t),r=n.writeTree_.setTree(e,s);return new Ne(r)}}}function wr(n,e,t){let i=n;return ne(t,(s,r)=>{i=Hn(i,$(e,s),r)}),i}function Ja(n,e){if(T(e))return Ne.empty();{const t=n.writeTree_.setTree(e,new O(null));return new Ne(t)}}function Cr(n,e){return Vt(n,e)!=null}function Vt(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(le(t.path,e)):null}function Qa(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(V,(i,s)=>{e.push(new S(i,s))}):n.writeTree_.children.inorderTraversal((i,s)=>{s.value!=null&&e.push(new S(i,s.value))}),e}function gt(n,e){if(T(e))return n;{const t=Vt(n,e);return t!=null?new Ne(new O(t)):new Ne(n.writeTree_.subtree(e))}}function Er(n){return n.writeTree_.isEmpty()}function un(n,e){return $l(R(),n.writeTree_,e)}function $l(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let i=null;return e.children.inorderTraversal((s,r)=>{s===".priority"?(p(r.value!==null,"Priority writes must always be leaf nodes"),i=r.value):t=$l($(n,s),r,t)}),!t.getChild(n).isEmpty()&&i!==null&&(t=t.updateChild($(n,".priority"),i)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ws(n,e){return zl(e,n)}function Qp(n,e,t,i,s){p(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=Hn(n.visibleWrites,e,t)),n.lastWriteId=i}function Xp(n,e,t,i){p(i>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:i,visible:!0}),n.visibleWrites=wr(n.visibleWrites,e,t),n.lastWriteId=i}function Zp(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function eg(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);p(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&tg(a,i.path)?s=!1:Ce(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return ng(n),!0;if(i.snap)n.visibleWrites=Ja(n.visibleWrites,i.path);else{const a=i.children;ne(a,c=>{n.visibleWrites=Ja(n.visibleWrites,$(i.path,c))})}return!0}else return!1}function tg(n,e){if(n.snap)return Ce(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Ce($(n.path,t),e))return!0;return!1}function ng(n){n.visibleWrites=Vl(n.allWrites,ig,R()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function ig(n){return n.visible}function Vl(n,e,t){let i=Ne.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)Ce(t,o)?(a=le(t,o),i=Hn(i,a,r.snap)):Ce(o,t)&&(a=le(o,t),i=Hn(i,R(),r.snap.getChild(a)));else if(r.children){if(Ce(t,o))a=le(t,o),i=wr(i,a,r.children);else if(Ce(o,t))if(a=le(o,t),T(a))i=wr(i,R(),r.children);else{const c=rn(r.children,I(a));if(c){const l=c.getChild(M(a));i=Hn(i,R(),l)}}}else throw mn("WriteRecord should have .snap or .children")}}return i}function jl(n,e,t,i,s){if(!i&&!s){const r=Vt(n.visibleWrites,e);if(r!=null)return r;{const o=gt(n.visibleWrites,e);if(Er(o))return t;if(t==null&&!Cr(o,R()))return null;{const a=t||w.EMPTY_NODE;return un(o,a)}}}else{const r=gt(n.visibleWrites,e);if(!s&&Er(r))return t;if(!s&&t==null&&!Cr(r,R()))return null;{const o=function(l){return(l.visible||s)&&(!i||!~i.indexOf(l.writeId))&&(Ce(l.path,e)||Ce(e,l.path))},a=Vl(n.allWrites,o,e),c=t||w.EMPTY_NODE;return un(a,c)}}}function sg(n,e,t){let i=w.EMPTY_NODE;const s=Vt(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(V,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=gt(n.visibleWrites,e);return t.forEachChild(V,(o,a)=>{const c=un(gt(r,new L(o)),a);i=i.updateImmediateChild(o,c)}),Qa(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=gt(n.visibleWrites,e);return Qa(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function rg(n,e,t,i,s){p(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=$(e,t);if(Cr(n.visibleWrites,r))return null;{const o=gt(n.visibleWrites,r);return Er(o)?s.getChild(t):un(o,s.getChild(t))}}function og(n,e,t,i){const s=$(e,t),r=Vt(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=gt(n.visibleWrites,s);return un(o,i.getNode().getImmediateChild(t))}else return null}function ag(n,e){return Vt(n.visibleWrites,e)}function cg(n,e,t,i,s,r,o){let a;const c=gt(n.visibleWrites,e),l=Vt(c,R());if(l!=null)a=l;else if(t!=null)a=un(c,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],d=o.getCompare(),h=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let f=h.getNext();for(;f&&u.length<s;)d(f,i)!==0&&u.push(f),f=h.getNext();return u}else return[]}function lg(){return{visibleWrites:Ne.empty(),allWrites:[],lastWriteId:-1}}function Qi(n,e,t,i){return jl(n.writeTree,n.treePath,e,t,i)}function fo(n,e){return sg(n.writeTree,n.treePath,e)}function Xa(n,e,t,i){return rg(n.writeTree,n.treePath,e,t,i)}function Xi(n,e){return ag(n.writeTree,$(n.treePath,e))}function ug(n,e,t,i,s,r){return cg(n.writeTree,n.treePath,e,t,i,s,r)}function po(n,e,t){return og(n.writeTree,n.treePath,e,t)}function Gl(n,e){return zl($(n.treePath,e),n.writeTree)}function zl(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xm(n){Tf(vn),on(new Ft("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Nm(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),pt(Pa,La,n),pt(Pa,La,"esm2020")}Je.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};Je.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};xm();var Fm="firebase",Um="12.4.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const is=new Kr("@firebase/auth");function zm(n,...e){is.logLevel<=P.WARN&&is.warn(`Auth (${vn}): ${n}`,...e)}function Li(n,...e){is.logLevel<=P.ERROR&&is.error(`Auth (${vn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function He(n,...e){throw Uo(n,...e)}function Pe(n,...e){return Uo(n,...e)}function Fo(n,e,t){const i={...Gm(),[e]:t};return new ui("auth","Firebase",i).create(e,{appName:n.name})}function Dt(n){return Fo(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function qm(n,e,t){const i=t;if(!(e instanceof i))throw i.name!==e.constructor.name&&He(n,"argument-error"),Fo(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function Uo(n,...e){if(typeof n!="string"){const t=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=n.name),n._errorFactory.create(t,...i)}return ku.create(n,...e)}function C(n,e,...t){if(!n)throw Uo(e,...t)}function Ye(n){const e="INTERNAL ASSERTION FAILED: "+n;throw Li(e),new Error(e)}function et(n,e){n||Ye(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xm=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Zm=new yi(3e4,6e4);function Wo(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function bn(n,e,t,i,s={}){return Nu(n,s,async()=>{let r={},o={};i&&(e==="GET"?o=i:r={body:JSON.stringify(i)});const a=yn({key:n.config.apiKey,...o}).slice(1),c=await n._getAdditionalHeaders();c["Content-Type"]="application/json",n.languageCode&&(c["X-Firebase-Locale"]=n.languageCode);const l={method:e,headers:c,...r};return th()||(l.referrerPolicy="no-referrer"),n.emulatorConfig&&_n(n.emulatorConfig.host)&&(l.credentials="include"),Au.fetch()(await Pu(n,n.config.apiHost,t,a),l)})}async function Nu(n,e,t){n._canInitEmulator=!1;const i={...Qm,...e};try{const s=new t_(n),r=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw Ti(n,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw Ti(n,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw Ti(n,"email-already-in-use",o);if(c==="USER_DISABLED")throw Ti(n,"user-disabled",o);const u=i[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw Fo(n,u,l);He(n,u)}}catch(s){if(s instanceof Ct)throw s;He(n,"network-request-failed",{message:String(s)})}}async function e_(n,e,t,i,s={}){const r=await bn(n,e,t,i,s);return"mfaPendingCredential"in r&&He(n,"multi-factor-auth-required",{_serverResponse:r}),r}async function Pu(n,e,t,i){const s=`${e}${t}?${i}`,r=n,o=r.config.emulator?Bo(n.config,s):`${n.config.apiScheme}://${s}`;return Xm.includes(t)&&(await r._persistenceManagerAvailable,r._getPersistenceType()==="COOKIE")?r._getPersistence()._getFinalTarget(o).toString():o}class t_{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,i)=>{this.timer=setTimeout(()=>i(Pe(this.auth,"network-request-failed")),Zm.get())})}}function Ti(n,e,t){const i={appName:n.name};t.email&&(i.email=t.email),t.phoneNumber&&(i.phoneNumber=t.phoneNumber);const s=Pe(n,e,i);return s.customData._tokenResponse=t,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vn(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function i_(n,e=!1){const t=he(n),i=await t.getIdToken(e),s=Ho(i);C(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,o=r?.sign_in_provider;return{claims:s,token:i,authTime:Vn(Xs(s.auth_time)),issuedAtTime:Vn(Xs(s.iat)),expirationTime:Vn(Xs(s.exp)),signInProvider:o||null,signInSecondFactor:r?.sign_in_second_factor||null}}function Xs(n){return Number(n)*1e3}function Ho(n){const[e,t,i]=n.split(".");if(e===void 0||t===void 0||i===void 0)return Li("JWT malformed, contained fewer than 3 sections"),null;try{const s=Hi(t);return s?JSON.parse(s):(Li("Failed to decode base64 JWT payload"),null)}catch(s){return Li("Caught error parsing JWT payload as JSON",s?.toString()),null}}function fc(n){const e=Ho(n);return C(e,"internal-error"),C(typeof e.exp<"u","internal-error"),C(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function c_(n,e){const t=await Nu(n,{},async()=>{const i=yn({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=n.config,o=await Pu(n,s,"/v1/token",`key=${r}`),a=await n._getAdditionalHeaders();a["Content-Type"]="application/x-www-form-urlencoded";const c={method:"POST",headers:a,body:i};return n.emulatorConfig&&_n(n.emulatorConfig.host)&&(c.credentials="include"),Au.fetch()(o,c)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function l_(n,e){return bn(n,"POST","/v2/accounts:revokeToken",Wo(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ou{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Ou.type="NONE";const Pr=Ou;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gc(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Fu(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Du(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Bu(e))return"Blackberry";if(Wu(e))return"Webos";if(Mu(e))return"Safari";if((e.includes("chrome/")||xu(e))&&!e.includes("edge/"))return"Chrome";if(Uu(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if(i?.length===2)return i[1]}return"Other"}function Du(n=de()){return/firefox\//i.test(n)}function Mu(n=de()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function xu(n=de()){return/crios\//i.test(n)}function Fu(n=de()){return/iemobile/i.test(n)}function Uu(n=de()){return/android/i.test(n)}function Bu(n=de()){return/blackberry/i.test(n)}function Wu(n=de()){return/webos/i.test(n)}function $o(n=de()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function u_(n=de()){return $o(n)&&!!window.navigator?.standalone}function d_(){return ih()&&document.documentMode===10}function Hu(n=de()){return $o(n)||Uu(n)||Wu(n)||Bu(n)||/windows phone/i.test(n)||Fu(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $u(n,e=[]){let t;switch(n){case"Browser":t=gc(de());break;case"Worker":t=`${gc(de())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${vn}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vo={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function __(n){Vo=n}function y_(n){return Vo.loadJS(n)}function v_(){return Vo.gapiScript}function w_(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function C_(n,e){const t=Qr(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),r=t.getOptions();if(xt(r,e??{}))return s;He(s,"already-initialized")}return t.initialize({options:e})}function E_(n,e){const t=e?.persistence||[],i=(Array.isArray(t)?t:[t]).map(Ke);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(i,e?.popupRedirectResolver)}function b_(n,e,t){const i=vi(n);C(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const s=!1,r=Vu(e),{host:o,port:a}=I_(e),c=a===null?"":`:${a}`,l={url:`${r}//${o}${c}/`},u=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!i._canInitEmulator){C(i.config.emulator&&i.emulatorConfig,i,"emulator-config-failed"),C(xt(l,i.config.emulator)&&xt(u,i.emulatorConfig),i,"emulator-config-failed");return}i.config.emulator=l,i.emulatorConfig=u,i.settings.appVerificationDisabledForTesting=!0,_n(o)?(Zc(`${r}//${o}${c}`),el("Auth",!0)):S_()}function Vu(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function I_(n){const e=Vu(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const i=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(i);if(s){const r=s[1];return{host:r,port:_c(i.substr(r.length+1))}}else{const[r,o]=i.split(":");return{host:r,port:_c(o)}}}function _c(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function S_(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zs(n,e){return he(n).setPersistence(e)}function N_(n,e,t,i){return he(n).onIdTokenChanged(e,t,i)}function P_(n,e,t){return he(n).beforeAuthStateChanged(e,t)}function zu(n,e,t,i){return he(n).onAuthStateChanged(e,t,i)}const as="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xu(){return typeof Be().WorkerGlobalScope<"u"&&typeof Be().importScripts=="function"}async function F_(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function U_(){return navigator?.serviceWorker?.controller||null}function B_(){return Xu()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sd{constructor(e,t,i,s,r=!1){this.auth=e,this.resolver=i,this.user=s,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:i,postBody:s,tenantId:r,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:t,sessionId:i,tenantId:r||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return G_;case"linkViaPopup":case"linkViaRedirect":return q_;case"reauthViaPopup":case"reauthViaRedirect":return z_;default:He(this.auth,"internal-error")}}resolve(e){et(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){et(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dy=new yi(3e4,6e4);function Ec(){const n=Be().___jsl;if(n?.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function hy(n){return new Promise((e,t)=>{function i(){Ec(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Ec(),t(Pe(n,"network-request-failed"))},timeout:dy.get()})}if(Be().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(Be().gapi?.load)i();else{const s=w_("iframefcb");return Be()[s]=()=>{gapi.load?i():t(Pe(n,"network-request-failed"))},y_(`${v_()}?onload=${s}`).catch(r=>t(r))}}).catch(e=>{throw Mi=null,e})}let Mi=null;function fy(n){return Mi=Mi||hy(n),Mi}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
- diagnosticLogger.getLogsSince(Date.now() - 60000) // Last minute
  ...
  `,cv(i,n)}function cv(n,e){n.querySelectorAll(".contact-call-btn").forEach(t=>{t.onclick=async()=>{const i=t.getAttribute("data-room-id"),s=t.getAttribute("data-contact-name");i&&(console.log(`[CONTACT CALL] Ensuring listener is active for room: ${i}`),ai(i),await vd(i,s),pa(i,{forceInitiator:!0}).catch(r=>{console.warn("Failed to call contact:",r),_t()}))}}),n.querySelectorAll(".contact-delete-btn").forEach(t=>{t.onclick=async()=>{const i=t.getAttribute("data-contact-id");!i||!window.confirm("Delete this contact?")||(await lv(i),await si(e))}})}async function lv(n){const e=Ge();if(e){try{await pn(ee(te,`users/${e}/contacts/${n}`))}catch(t){console.warn("Failed to delete contact from RTDB",t)}return}try{const t=localStorage.getItem("contacts")||"{}",i=JSON.parse(t);i[n]&&(delete i[n],localStorage.setItem("contacts",JSON.stringify(i)))}catch(t){console.warn("Failed to delete contact from localStorage",t)}}const ri=new WeakMap;function ia(n,e,t){if(!n||!t)throw new Error("setupIceCandidates: pc and roomId are required");if(ri.has(n)||ri.set(n,[]),e==="initiator")Nc(n,"offerCandidates",t),Pc(n,"answerCandidates",t);else if(e==="joiner")Nc(n,"answerCandidates",t),Pc(n,"offerCandidates",t);else throw new Error(`Invalid role: ${e} specified for ICE candidate setup.`)}function Nc(n,e,t){n.onicecandidate=i=>{if(i.candidate){const s=uc(e==="offerCandidates"?Su(t):Tu(t));Ze(s,i.candidate.toJSON())}}}function Pc(n,e,t){const i=e==="offerCandidates"?Su(t):Tu(t);let s=!1;const r=()=>{if(s)return;s=!0;const a=()=>{n.remoteDescription&&(sa(n),n.removeEventListener("signalingstatechange",a))};n.addEventListener("signalingstatechange",a)};At(i,"child_added",a=>{const c=a.val();if(!(!n||n.signalingState==="closed")&&c)if(n.remoteDescription)try{n.addIceCandidate(new RTCIceCandidate(c))}catch{}else{const l=ri.get(n);l&&(l.push(c),l.length===1&&r())}},t)}function sa(n){if(!n||!ri.has(n))return;const e=ri.get(n);if(e.length!==0){oe(`🔄 Draining ${e.length} queued ICE candidate(s)`);for(const t of e)try{n.addIceCandidate(new RTCIceCandidate(t)).catch(i=>{oe("Error adding queued ICE candidate:",i)})}catch{}e.length=0}}const uv=Object.freeze(Object.defineProperty({__proto__:null,drainIceCandidateQueue:sa,setupIceCandidates:ia},Symbol.toStringTag,{value:"Module"}));let Fe=null,Lc=null;function wd(n){Lc=n,n.onconnectionstatechange=()=>{oe("onconnectionstatechange:",n.connectionState),n.connectionState==="connected"?(A("Connected!"),ga(),ta().catch(e=>console.warn("Failed to clear calling state on connect:",e)),Fe&&(clearTimeout(Fe),Fe=null)):n.connectionState==="disconnected"?(A("Partner disconnected (reconnecting...)"),Fe&&clearTimeout(Fe),Fe=setTimeout(()=>{n===Lc&&n.connectionState==="disconnected"&&(A("Partner disconnected"),Q.cleanupCall({reason:"connection_lost"})),Fe=null},3e3)):n.connectionState==="failed"&&(A("Connection failed"),Us(),Fe&&(clearTimeout(Fe),Fe=null),Q.cleanupCall({reason:"connection_failed"}))},n.addEventListener("iceconnectionstatechange",e=>{oe("ICE iceconnectionstatechange:",n.iceConnectionState),n.iceConnectionState==="failed"&&(console.warn("ICE connection failed, restarting ICE..."),n.restartIce())})}function Mr(n,e,t={}){if(!n||typeof e!="function")throw new Error("closeOnClickOutside: valid element and onClose callback required");const{ignore:i=[],esc:s=!0,events:r=["mousedown","touchstart"]}=t,o=Array.isArray(i)?i.filter(Boolean):[],a=l=>{try{const u=l.target;if(n.contains(u))return;for(const d of o)if(d&&d.contains&&d.contains(u)||d===u)return;e(l)}catch(u){console.error("closeOnClickOutside handler error:",u)}},c=l=>{s&&l.key==="Escape"&&e(l)};return r.forEach(l=>document.addEventListener(l,a,{passive:!0})),s&&document.addEventListener("keydown",c),function(){r.forEach(u=>document.removeEventListener(u,a,{passive:!0})),s&&document.removeEventListener("keydown",c)}}const dv=CSS.supports?.("position-anchor: --msg-toggle")&&CSS.supports?.("right: anchor(right)")&&CSS.supports?.("bottom: anchor(top)");function hv(n){const e=n.getBoundingClientRect();return e.top>=0&&e.left>=0&&e.bottom<=window.innerHeight&&e.right<=window.innerWidth}function Oc(n){const e=document.createElement("div");e.innerHTML=`
  ...
  `,document.head.appendChild(n),Hc=!0}function Iw(n){n.showModal||(n.showModal=function(){this.setAttribute("open",""),this.style.display="block",this.style.position="fixed",this.style.top="50%",this.style.left="50%",this.style.transform="translate(-50%, -50%)";const e=getComputedStyle(document.documentElement).getPropertyValue("--z-ui-overlay").trim();this.style.zIndex=e||"1000"},n.close=function(){this.removeAttribute("open"),this.style.display="none"})}async function Sw(n,e=null){if(navigator.clipboard&&navigator.clipboard.writeText)try{return await navigator.clipboard.writeText(n),!0}catch(t){return console.warn("Clipboard API failed, using fallback:",t),!1}if(!e)return!1;try{return e.select(),e.setSelectionRange(0,99999),document.execCommand("copy")}catch(t){return console.error("Fallback copy failed:",t),!1}}let Mn=null;const Tw=(n,e=null)=>{if(Mn)return Mn;if(!n)return console.error("Auth UI: Parent element is required"),null;let t=null,i=10;return typeof e=="number"&&(i=e),Mn=xd({initialProps:{isLoggedIn:!1,userName:"Guest User",loginDisabledAttr:"",logoutDisabledAttr:"disabled",loginBtnMarginRightPx:i},template:`
    ...
    `,handlers:{handleLogin:cd,handleLogout:ud},onMount:s=>{t=qo(({isLoggedIn:r,userName:o})=>{console.debug("[AuthComponent] Auth state changed:",{isLoggedIn:r,userName:o}),s.update({isLoggedIn:r,userName:o,loginDisabledAttr:r?"disabled":"",logoutDisabledAttr:r?"":"disabled"})})},onCleanup:()=>{t&&(t(),t=null),Mn=null},className:"auth-component",parent:n}),Mn};Vy(!0);m().disable();let oi=[];const ps=()=>{const n=ca(!1);return n&&n.getVideoTracks().some(e=>e.enabled)};async function Rw(){kw();const n=fd(),t=["localVideoEl","remoteVideoEl","localBoxEl","remoteBoxEl","chatControls","lobbyDiv","titleAuthBar"].filter(i=>!n[i]);if(t.length>0)return console.error("Critical elements missing:",t),A("Error: Required UI elements not found."),!1;try{_w(),ew(),Lw(),await ad;const i=Tw(Ds);return i&&oi.push(i.dispose),await gs(),!0}catch(i){return console.error("Failed to get user media:",i),A("Error: Please allow camera and microphone access."),!1}}function Us(){window.history.replaceState({},document.title,window.location.pathname)}let $c=!1;async function gs(){$c||($c=!0,await vw(Te),Mv({getLocalStream:la,getLocalVideo:()=>Te,getRemoteVideo:()=>K,getPeerConnection:()=>Q.getState().pc,setLocalStream:Fr,micBtn:Sn,cameraBtn:Tn,switchCameraBtn:In,mutePartnerBtn:Me,fullscreenPartnerBtn:xs}),Te&&(Te.addEventListener("enterpictureinpicture",()=>J&&_(J)),Te.addEventListener("leavepictureinpicture",()=>{J&&!(Rn()&&ps())&&b(J)})))}function kw(){_(U),_(J),_(ye),_(_e)}function Fi(n=null){return{localStream:la(),remoteVideoEl:K,mutePartnerBtn:Me,setupRemoteStream:ww,setupWatchSync:$v,targetRoomId:n}}function Ui(n,e=!1){return n.success?(e&&n.roomLink&&Ew(n.roomLink,{onCopy:()=>A("Link ready! Share with your partner."),onCancel:()=>A("Link ready! Use the copy button to use it, or create a new one.")}),!0):!1}async function pa(n,{forceInitiator:e=!1}={}){const t=Date.now();if(e){m().logRoomCreation(n,!0,{creationTime:t,listenerAttachTime:t,timeDiff:0},{trigger:"force_initiator",reason:"calling_saved_contact"}),await gs();const r=await Q.createCall(Fi(n));return Ui(r,!1)}let i=await H.checkRoomStatus(n);if(i.exists&&!i.hasMembers){let o=0;for(;o<3&&!i.hasMembers;)await new Promise(a=>setTimeout(a,250*(o+1))),i=await H.checkRoomStatus(n),o++}if(!i.exists||!i.hasMembers){m().logRoomCreation(n,!0,{creationTime:t,listenerAttachTime:t,timeDiff:0},{trigger:"room_empty_or_nonexistent",roomExists:i.exists,memberCount:i.memberCount||0}),await gs();const r=await Q.createCall(Fi(n));return Ui(r,!0)}A("Joining room..."),m().log("ROOM","JOINING_EXISTING",{roomId:n,memberCount:i.memberCount,roomExists:i.exists});const s=await Q.answerCall({roomId:n,...Fi()});return Ui(s,!1)}const me=new Set,Fd=new Map;function Vc(n){n&&(Ns(n),me.delete(n),Fd.delete(n),m().log("LISTENER","INCOMING_CLEANUP",{roomId:n,remainingListeners:me.size}))}function Aw(){oe(`[LISTENER] Removing all incoming listeners (${me.size} rooms)`);const n=Array.from(me);n.forEach(e=>{Ns(e)}),me.clear(),Fd.clear(),m().log("LISTENER","ALL_INCOMING_CLEANUP",{roomsCleared:n.length})}async function Nw(n){const e=Date.now(),t=e+1440*60*1e3,i=Ge();if(i){const s=Mo(i,n);await Ze(s,{roomId:n,savedAt:e,expiresAt:t});return}try{const s=localStorage.getItem("recentCalls")||"{}",r=JSON.parse(s);r[n]={roomId:n,savedAt:e,expiresAt:t},localStorage.setItem("recentCalls",JSON.stringify(r))}catch(s){console.warn("Failed to save recent call to localStorage",s)}}async function or(n){const e=Ge();if(e){try{await pn(Mo(e,n))}catch(t){console.warn("Failed to remove recent call from RTDB",t)}return}try{const t=localStorage.getItem("recentCalls")||"{}",i=JSON.parse(t);i[n]&&(delete i[n],localStorage.setItem("recentCalls",JSON.stringify(i)))}catch(t){console.warn("Failed to remove recent call from localStorage",t)}}function ai(n){n&&(me.has(n)&&(me.delete(n),Ns(n)),oe(`[LISTENER] Attaching listener for room: ${n} (total: ${me.size+1})`),me.add(n),m().logListenerAttachment(n,"member_join",me.size,{action:"incoming_call_listener_attached"}),H.onMemberJoined(n,async e=>{const t=e.key,i=e.val?e.val():null,s=re();if(t&&t!==s){m().logMemberJoinEvent(n,t,i||{},{detectedBy:"incoming_call_listener",currentUserId:s});const r=i&&typeof i.joinedAt=="number"?i.joinedAt:null,o=2e4;let a=!1,c="none",l=0;if(r&&(l=Date.now()-r,a=l<o,c="joinedAt"),!a){const N=await _d(t,n),ie=await yd(n);a=N||ie,c=N?"outgoingState":ie?"roomCreatedAt":"failed"}const u={isFresh:a,method:c,age:l,reason:a?"call_is_fresh":"call_is_stale"};if(m().logIncomingCallEvent(t,n,u,{memberData:i,joinedAt:r,CALL_FRESH_MS:o}),!a){m().logNotificationDecision("REJECT","stale_call",n,{age:l,validationMethod:c,joiningUserId:t});return}let d;try{d=await H.getRoomData(n)}catch{return}if(!d||typeof d!="object")return;const h=!!d.offer,f=!!d.answer,g=d.createdBy;if(!h||f||g===s)return;const v=Q.getState();if(!!v.pc&&v.pc.connectionState==="connected"){m().logNotificationDecision("REJECT","already_in_call",n,{joiningUserId:t,currentCallState:v.pc?.connectionState});return}if(m().logNotificationDecision("SHOW","fresh_call_detected",n,{joiningUserId:t,freshnessResult:u}),await na(`Incoming call from ${t} for room ${n}.

Accept?`))Vc(n),m().logNotificationDecision("ACCEPT","user_accepted",n,{joiningUserId:t}),pa(n).catch(N=>{console.warn("Failed to answer incoming call:",N),A("Failed to answer incoming call."),m().logFirebaseOperation("join_room_on_accept",!1,N,{roomId:n,joiningUserId:t})});else{m().logNotificationDecision("REJECT","user_rejected",n,{joiningUserId:t});try{await H.rejectCall(n,re(),"user_rejected")}catch(N){console.warn("Failed to signal rejection via RTDB:",N)}await or(n).catch(N=>{console.warn("Failed to remove recent call on rejection:",N)})}}}),H.onCallCancelled(n,async e=>{if(e&&typeof e.val=="function"&&e.val()){try{const{dismissActiveConfirmDialog:i}=await Yt(async()=>{const{dismissActiveConfirmDialog:s}=await Promise.resolve().then(()=>ov);return{dismissActiveConfirmDialog:s}},void 0);typeof i=="function"&&i()}catch{}await or(n).catch(()=>{})}}),H.onMemberLeft(n,async e=>{const t=e.key,i=re();if(!(!t||t===i))try{(await H.checkRoomStatus(n)).hasMembers||(await or(n),Vc(n),oe(`Removed saved recent call and listeners for room ${n} because it is now empty`))}catch(s){console.warn("Failed to evaluate room status on member leave",s)}}))}async function jc(){const n=Date.now();m().log("LISTENER","STARTUP_BEGIN",{timestamp:n,currentListenerCount:me.size});try{if(typeof window<"u"){const{getCurrentUserAsync:t}=await Yt(async()=>{const{getCurrentUserAsync:i}=await Promise.resolve().then(()=>Xy);return{getCurrentUserAsync:i}},void 0);await t()}}catch{}const e=Ge();if(m().log("LISTENER","AUTH_STATE_DETERMINED",{isLoggedIn:!!e,userId:e||"guest"}),e){const t=jm(e);try{const i=await Ot(t),s=i.exists()?i.val():null,r=new Set;if(s)for(const[o,a]of Object.entries(s)){if(!a||a.expiresAt&&a.expiresAt<Date.now()){await pn(Mo(e,o)).catch(()=>{});continue}r.add(o)}try{const o=await ds();Object.values(o||{}).forEach(a=>{a?.roomId&&r.add(a.roomId)})}catch{}r.forEach(o=>ai(o)),m().log("LISTENER","STARTUP_COMPLETE",{storage:"rtdb",roomsToListen:Array.from(r),totalListeners:me.size,duration:Date.now()-n})}catch(i){console.warn("Failed to read recent calls from RTDB",i),m().logFirebaseOperation("read_recent_calls",!1,i,{storage:"rtdb",userId:e})}return}try{const t=localStorage.getItem("recentCalls")||"{}",i=JSON.parse(t),s={},r=new Set;for(const[o,a]of Object.entries(i||{}))!a||a.expiresAt&&a.expiresAt<Date.now()||(s[o]=a,r.add(o));try{const o=await ds();Object.values(o||{}).forEach(a=>{a?.roomId&&r.add(a.roomId)})}catch{}r.forEach(o=>ai(o)),localStorage.setItem("recentCalls",JSON.stringify(s)),m().log("LISTENER","STARTUP_COMPLETE",{storage:"localStorage",roomsToListen:Array.from(r),totalListeners:me.size,duration:Date.now()-n,expiredRoomsRemoved:Object.keys(i||{}).length-r.size})}catch(t){console.warn("Failed to read recent calls from localStorage",t),m().logFirebaseOperation("read_recent_calls",!1,t,{storage:"localStorage"})}}let ci=!1,We=null,ar=null,cr=null;function Pw(){return"pictureInPictureEnabled"in document&&typeof document.pictureInPictureEnabled=="boolean"&&document.pictureInPictureEnabled}let ki=!1,ga=()=>{if(ci)return;const n=ca(!1);if(!K||!n||K.paused||K.readyState<2){ki||(ki=!0,K.addEventListener("playing",()=>{ki=!1,ga()},{once:!0}));return}if(ki=!1,ci=!0,b(U),b(J),Mt(J),_($e),_(Et),ve.disabled=!0,ve.classList.add("disabled"),De.disabled=!1,De.classList.remove("disabled"),Me.disabled=!1,Me.classList.remove("disabled"),We||(We=md(_e,{inactivityMs:2500,hideOnEsc:!0})),!ar){const e=()=>{Rn()?Mt(U):Lt(U),b(U)};K.addEventListener("leavepictureinpicture",e),ar=()=>K.removeEventListener("leavepictureinpicture",e),oi.push(ar)}if(!cr){const e=()=>_(U);K.addEventListener("enterpictureinpicture",e),cr=()=>K.removeEventListener("enterpictureinpicture",e),oi.push(cr)}},Ud=(n=!1)=>{!ci&&!n||(ci=!1,Lt(U),_(U),ve.disabled=!1,ve.classList.remove("disabled"),b(Et),De.disabled=!0,De.classList.add("disabled"),Me.disabled=!0,Me.classList.add("disabled"),We&&(We(),We=null),b($e),Rn()||(Mt(J),b(J),b(_e)))};function Gr(){if(!Rn()){if(Dd(!0),_($e),_e.classList.remove("bottom"),_e.classList.add("watch-mode"),ci?(_(ve),b(De)):(_(De),_(Sn),_(Me),b(ve)),_(Et),_(Tn),_(In),b(_e),We&&(We(),We=null),!ps()){_(U),Lt(U),Dr(Te)||(b(J),Mt(J));return}_(J),Lt(J),Dr(K)?(_(U),Lt(U)):Pw()?K.requestPictureInPicture().then(()=>{_(U),Lt(U)}).catch(n=>{console.warn("Failed to enter Picture-in-Picture:",n),Mt(U),b(U)}):(Mt(U),b(U))}}function Bi(){Rn()&&(b(ve),b(De),b(Sn),b(Me),b(ve),b(Tn),b(In),_e.classList.remove("watch-mode"),_e.classList.add("bottom"),b(_e),We||(We=md(_e,{inactivityMs:3e3,hideOnEsc:!0})),ps()&&(Dr(K)&&document.exitPictureInPicture().catch(n=>{console.error("Failed to exit Picture-in-Picture:",n)}),Lt(U),b(U)),Mt(J),b(J),ps()||(b($e),b(Et)),Dd(!1))}function lr(){return W&&ye&&!ye.classList.contains("hidden")&&W.src&&W.src.trim()!==""}let Gc=!1;function Lw(){if(Gc)return;const n=()=>{const e=document.activeElement;return e&&(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)};document.addEventListener("keydown",e=>{if(!n()&&((e.key==="w"||e.key==="W")&&(console.log("=== W KEY PRESSED ==="),console.log("lastWatched:",Dn()),console.log("isYTVisible():",sr()),console.log("isSharedVideoVisible():",lr()),console.log("isWatchModeActive():",Rn()),Dn()==="yt"?sr()?(Wr(),Bi()):(Pd(),Gr()):Dn()==="url"&&(lr()?(_(ye),Bi()):(b(ye),Gr()))),e.key==="m"||e.key==="M")){const t=Q.getState();t.messagesUI&&t.messagesUI.toggleMessages()}e.key==="Escape"&&(Dn()==="yt"&&sr()?(Fs(),Wr()):Dn()==="url"&&lr()&&(W.pause(),_(ye)),Bi())}),Gc=!0}const Bd=async()=>{await gs();const n=await Q.createCall(Fi());Ui(n,!0)};ve.onclick=Bd;Et.onclick=Bd;De.onclick=async()=>{console.debug("Hanging up..."),await Q.hangUp({emitCancel:!0,reason:"user_hung_up"})};async function Ow(){const e=new URLSearchParams(window.location.search).get("room");if(!e)return!1;const t=await pa(e);return t||(Us(),Ud()),A("Auto-joined room from URL"),t}window.onload=async()=>{if(!await Rw()){ve.disabled=!0,console.error("Initialization failed. Cannot start chat.");return}await jc().catch(s=>console.warn("Failed to start saved-room listeners",s)),si($e).catch(s=>{console.warn("Failed to render contacts list:",s)});let e=null;const t=qo(async({isLoggedIn:s,user:r})=>{try{const o=e===null,a=e===!0&&!s,c=e===!1&&s;e=s,await si($e),a?(oe("[AUTH] User logged out - cleaning up incoming listeners"),Aw()):c?(oe("[AUTH] User logged in - re-attaching incoming listeners"),await jc().catch(l=>console.warn("Failed to re-attach saved-room listeners on login",l))):o&&s&&oe("[AUTH] Initial load with logged-in user")}catch(o){console.warn("Failed to handle auth change:",o)}});oi.push(()=>{try{typeof t=="function"&&t()}catch{}}),!await Ow()&&A('Ready. Click "Start New Chat" to begin.')};window.addEventListener("beforeunload",async n=>{const e=Q.getState();if(e.pc&&e.pc.connectionState==="connected")return n.preventDefault(),n.returnValue="You are in an active call. Are you sure you want to leave?",n.returnValue;await Dw()});Q.on("memberJoined",({memberId:n,roomId:e})=>{console.debug("CallController memberJoined event",{memberId:n,roomId:e}),Q.setPartnerId(n),ga(),ta().catch(t=>console.warn("Failed to clear calling state:",t)),Nw(e).catch(t=>console.warn("Failed to save recent call:",t))});Q.on("memberLeft",({memberId:n})=>{console.debug("CallController memberLeft event",{memberId:n}),console.info("Partner has left the call")});Q.on("cleanup",({roomId:n,reason:e})=>{console.debug("CallController cleanup event",{roomId:n,reason:e}),_t(),Av(),Ud(),A('Disconnected. Click "Start New Chat" to begin.'),Us()});Q.on("cleanup",({roomId:n,partnerId:e,reason:t})=>{console.debug("CallController cleanup event",{roomId:n,partnerId:e,reason:t}),e&&n&&setTimeout(()=>{av(e,n,$e).catch(i=>{console.warn("Failed to save contact after cleanup:",i)})},500)});async function Dw(){await Q.hangUp({emitCancel:!0,reason:"page_unload"}),xv(),Hm(),document.pictureInPictureElement&&document.exitPictureInPicture().catch(e=>console.error(e));const n=Q.getState();n.messagesUI&&n.messagesUI.cleanup&&n.messagesUI.cleanup(),window.history.replaceState({},document.title,window.location.pathname),W.src="",Ms.textContent="",Nv(),Te&&(Te.srcObject=null),K&&(K.srcObject=null),Bi(),Us(),Hv("none"),ua(),Nd(!1),tw(),oi.forEach(e=>e())}
