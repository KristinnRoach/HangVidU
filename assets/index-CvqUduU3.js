 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xo(n){return Ji(void 0,n)}function Ji(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!Jo(t)||(n[t]=Ji(n[t],e[t]));return n}function Jo(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ea=()=>Zo().__FIREBASE_DEFAULTS__,ta=()=>{if(typeof process>"u"||typeof Ks>"u")return;const n=Ks.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},na=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&Mn(n[1]);return e&&JSON.parse(e)},Zi=()=>{try{return jo()||ea()||ta()||na()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},sa=n=>Zi()?.emulatorHosts?.[n],ia=n=>{const e=sa(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const s=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),s]:[e.substring(0,t),s]},er=()=>Zi()?.config;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function us(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function ra(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ha(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function tr(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(ha())}function ua(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function da(){return Ki.NODE_ADMIN===!0}function fa(){try{return typeof indexedDB=="object"}catch{return!1}}function pa(){return new Promise((n,e)=>{try{let t=!0;const s="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(s);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(s),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{e(i.error?.message||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _a="FirebaseError";class Nt extends Error{constructor(e,t,s){super(t),this.code=e,this.customData=s,this.name=_a,Object.setPrototypeOf(this,Nt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,nr.prototype.create)}}class nr{constructor(e,t,s){this.service=e,this.serviceName=t,this.errors=s}create(e,...t){const s=t[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?ma(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new Nt(i,a,s)}}function ma(n,e){return n.replace(ga,(t,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const ga=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sr=function(n){let e={},t={},s={},i="";try{const r=n.split(".");e=ft(Mn(r[0])||""),t=ft(Mn(r[1])||""),i=r[2],s=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:s,signature:i}},ya=function(n){const e=sr(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},va=function(n){const e=sr(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ca(n){const e=[];for(const[t,s]of Object.entries(n))Array.isArray(s)?s.forEach(i=>{e.push(encodeURIComponent(t)+"="+encodeURIComponent(i))}):e.push(encodeURIComponent(t)+"="+encodeURIComponent(s));return e.length?"&"+e.join("&"):""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var S;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(S||(S={}));const Na={debug:S.DEBUG,verbose:S.VERBOSE,info:S.INFO,warn:S.WARN,error:S.ERROR,silent:S.SILENT},Ra=S.INFO,ka={[S.DEBUG]:"log",[S.VERBOSE]:"log",[S.INFO]:"info",[S.WARN]:"warn",[S.ERROR]:"error"},Aa=(n,e,...t)=>{if(e<n.logLevel)return;const s=new Date().toISOString(),i=ka[e];if(i)console[i](`[${s}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class ir{constructor(e){this.name=e,this._logLevel=Ra,this._logHandler=Aa,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in S))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Na[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,S.DEBUG,...e),this._logHandler(this,S.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,S.VERBOSE,...e),this._logHandler(this,S.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,S.INFO,...e),this._logHandler(this,S.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,S.WARN,...e),this._logHandler(this,S.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,S.ERROR,...e),this._logHandler(this,S.ERROR,...e)}}const Pa=(n,e)=>e.some(t=>n instanceof t);let Zs,ei;function Da(){return Zs||(Zs=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function xa(){return ei||(ei=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const rr=new WeakMap,Ln=new WeakMap,or=new WeakMap,In=new WeakMap,ds=new WeakMap;function Oa(n){const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("success",r),n.removeEventListener("error",o)},r=()=>{t(fe(n.result)),i()},o=()=>{s(n.error),i()};n.addEventListener("success",r),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&rr.set(t,n)}).catch(()=>{}),ds.set(e,n),e}function Ma(n){if(Ln.has(n))return;const e=new Promise((t,s)=>{const i=()=>{n.removeEventListener("complete",r),n.removeEventListener("error",o),n.removeEventListener("abort",o)},r=()=>{t(),i()},o=()=>{s(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",r),n.addEventListener("error",o),n.addEventListener("abort",o)});Ln.set(n,e)}let Fn={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Ln.get(n);if(e==="objectStoreNames")return n.objectStoreNames||or.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return fe(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function La(n){Fn=n(Fn)}function Fa(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const s=n.call(Sn(this),e,...t);return or.set(s,e.sort?e.sort():[e]),fe(s)}:xa().includes(n)?function(...e){return n.apply(Sn(this),e),fe(rr.get(this))}:function(...e){return fe(n.apply(Sn(this),e))}}function Ba(n){return typeof n=="function"?Fa(n):(n instanceof IDBTransaction&&Ma(n),Pa(n,Da())?new Proxy(n,Fn):n)}function fe(n){if(n instanceof IDBRequest)return Oa(n);if(In.has(n))return In.get(n);const e=Ba(n);return e!==n&&(In.set(n,e),ds.set(e,n)),e}const Sn=n=>ds.get(n);function Ua(n,e,{blocked:t,upgrade:s,blocking:i,terminated:r}={}){const o=indexedDB.open(n,e),a=fe(o);return s&&o.addEventListener("upgradeneeded",l=>{s(fe(o.result),l.oldVersion,l.newVersion,fe(o.transaction),l)}),t&&o.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),a.then(l=>{r&&l.addEventListener("close",()=>r()),i&&l.addEventListener("versionchange",c=>i(c.oldVersion,c.newVersion,c))}).catch(()=>{}),a}const Wa=["get","getKey","getAll","getAllKeys","count"],Va=["put","add","delete","clear"],Tn=new Map;function ti(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Tn.get(e))return Tn.get(e);const t=e.replace(/FromIndex$/,""),s=e!==t,i=Va.includes(t);if(!(t in(s?IDBIndex:IDBObjectStore).prototype)||!(i||Wa.includes(t)))return;const r=async function(o,...a){const l=this.transaction(o,i?"readwrite":"readonly");let c=l.store;return s&&(c=c.index(a.shift())),(await Promise.all([c[t](...a),i&&l.done]))[0]};return Tn.set(e,r),r}La(n=>({...n,get:(e,t,s)=>ti(e,t)||n.get(e,t,s),has:(e,t)=>!!ti(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ha{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if($a(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function $a(n){return n.getComponent()?.type==="VERSION"}const Bn="@firebase/app",ni="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ce=new ir("@firebase/app"),Ya="@firebase/app-compat",Ga="@firebase/analytics-compat",qa="@firebase/analytics",za="@firebase/app-check-compat",ja="@firebase/app-check",Ka="@firebase/auth",Qa="@firebase/auth-compat",Xa="@firebase/database",Ja="@firebase/data-connect",Za="@firebase/database-compat",el="@firebase/functions",tl="@firebase/functions-compat",nl="@firebase/installations",sl="@firebase/installations-compat",il="@firebase/messaging",rl="@firebase/messaging-compat",ol="@firebase/performance",al="@firebase/performance-compat",ll="@firebase/remote-config",cl="@firebase/remote-config-compat",hl="@firebase/storage",ul="@firebase/storage-compat",dl="@firebase/firestore",fl="@firebase/ai",pl="@firebase/firestore-compat",_l="firebase",ml="12.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Un="[DEFAULT]",gl={[Bn]:"fire-core",[Ya]:"fire-core-compat",[qa]:"fire-analytics",[Ga]:"fire-analytics-compat",[ja]:"fire-app-check",[za]:"fire-app-check-compat",[Ka]:"fire-auth",[Qa]:"fire-auth-compat",[Xa]:"fire-rtdb",[Ja]:"fire-data-connect",[Za]:"fire-rtdb-compat",[el]:"fire-fn",[tl]:"fire-fn-compat",[nl]:"fire-iid",[sl]:"fire-iid-compat",[il]:"fire-fcm",[rl]:"fire-fcm-compat",[ol]:"fire-perf",[al]:"fire-perf-compat",[ll]:"fire-rc",[cl]:"fire-rc-compat",[hl]:"fire-gcs",[ul]:"fire-gcs-compat",[dl]:"fire-fst",[pl]:"fire-fst-compat",[fl]:"fire-vertex","fire-js":"fire-js",[_l]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ht=new Map,yl=new Map,Wn=new Map;function si(n,e){try{n.container.addComponent(e)}catch(t){ce.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function $t(n){const e=n.name;if(Wn.has(e))return ce.debug(`There were multiple attempts to register component ${e}.`),!1;Wn.set(e,n);for(const t of Ht.values())si(t,n);for(const t of yl.values())si(t,n);return!0}function vl(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function Cl(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bl=ml;function ar(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const s={name:Un,automaticDataCollectionEnabled:!0,...e},i=s.name;if(typeof i!="string"||!i)throw pe.create("bad-app-name",{appName:String(i)});if(t||(t=er()),!t)throw pe.create("no-options");const r=Ht.get(i);if(r){if(Vt(t,r.options)&&Vt(s,r.config))return r;throw pe.create("duplicate-app",{appName:i})}const o=new Ta(i);for(const l of Wn.values())o.addComponent(l);const a=new wl(t,s,o);return Ht.set(i,a),a}function Il(n=Un){const e=Ht.get(n);if(!e&&n===Un&&er())return ar();if(!e)throw pe.create("no-app",{appName:n});return e}function Le(n,e,t){let s=gl[n]??n;t&&(s+=`-${t}`);const i=s.match(/\s|\//),r=e.match(/\s|\//);if(i||r){const o=[`Unable to register library "${s}" with version "${e}":`];i&&o.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&r&&o.push("and"),r&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ce.warn(o.join(" "));return}$t(new pt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rl=1024,kl=30;class Al{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Dl(t),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){try{const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=ri();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(i=>i.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:t}),this._heartbeatsCache.heartbeats.length>kl){const i=xl(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(i,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){ce.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=ri(),{heartbeatsToSend:t,unsentEntries:s}=Pl(this._heartbeatsCache.heartbeats),i=Ut(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}catch(e){return ce.warn(e),""}}}function ri(){return new Date().toISOString().substring(0,10)}function Pl(n,e=Rl){const t=[];let s=n.slice();for(const i of n){const r=t.find(o=>o.agent===i.agent);if(r){if(r.dates.push(i.date),oi(t)>e){r.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),oi(t)>e){t.pop();break}s=s.slice(1)}return{heartbeatsToSend:t,unsentEntries:s}}class Dl{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return fa()?pa().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Nl(this.app);return t?.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return ii(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return ii(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function oi(n){return Ut(JSON.stringify({version:2,heartbeats:n})).length}function xl(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let s=1;s<n.length;s++)n[s].date<t&&(t=n[s].date,e=s);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ol(n){$t(new pt("platform-logger",e=>new Ha(e),"PRIVATE")),$t(new pt("heartbeat",e=>new Al(e),"PRIVATE")),Le(Bn,ni,n),Le(Bn,ni,"esm2020"),Le("fire-js","")}Ol("");var Ml="firebase",Ll="12.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Le(Ml,Ll,"app");var ai={};const li="@firebase/database",ci="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ul{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return ee(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ur=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Bl(e)}}catch{}return new Ul},Ie=ur("localStorage"),Wl=ur("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fe=new ir("@firebase/database"),Vl=(function(){let n=1;return function(){return n++}})(),dr=function(n){const e=wa(n),t=new Ea;t.update(e);const s=t.digest();return hs.encodeByteArray(s)},Rt=function(...n){let e="";for(let t=0;t<n.length;t++){const s=n[t];Array.isArray(s)||s&&typeof s=="object"&&typeof s.length=="number"?e+=Rt.apply(null,s):typeof s=="object"?e+=M(s):e+=s,e+=" "}return e};let at=null,hi=!0;const Hl=function(n,e){f(!0,"Can't turn on custom loggers persistently."),Fe.logLevel=S.VERBOSE,at=Fe.log.bind(Fe)},V=function(...n){if(hi===!0&&(hi=!1,at===null&&Wl.get("logging_enabled")===!0&&Hl()),at){const e=Rt.apply(null,n);at(e)}},kt=function(n){return function(...e){V(n,...e)}},Vn=function(...n){const e="FIREBASE INTERNAL ERROR: "+Rt(...n);Fe.error(e)},he=function(...n){const e=`FIREBASE FATAL ERROR: ${Rt(...n)}`;throw Fe.error(e),new Error(e)},Y=function(...n){const e="FIREBASE WARNING: "+Rt(...n);Fe.warn(e)},$l=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&Y("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},fs=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},Yl=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},Ve="[MIN_NAME]",Se="[MAX_NAME]",ke=function(n,e){if(n===e)return 0;if(n===Ve||e===Se)return-1;if(e===Ve||n===Se)return 1;{const t=ui(n),s=ui(e);return t!==null?s!==null?t-s===0?n.length-e.length:t-s:-1:s!==null?1:n<e?-1:1}},Gl=function(n,e){return n===e?0:n<e?-1:1},et=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+M(e))},ps=function(n){if(typeof n!="object"||n===null)return M(n);const e=[];for(const s in n)e.push(s);e.sort();let t="{";for(let s=0;s<e.length;s++)s!==0&&(t+=","),t+=M(e[s]),t+=":",t+=ps(n[e[s]]);return t+="}",t},fr=function(n,e){const t=n.length;if(t<=e)return[n];const s=[];for(let i=0;i<t;i+=e)i+e>t?s.push(n.substring(i,t)):s.push(n.substring(i,i+e));return s};function H(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const pr=function(n){f(!fs(n),"Invalid JSON number");const e=11,t=52,s=(1<<e-1)-1;let i,r,o,a,l;n===0?(r=0,o=0,i=1/n===-1/0?1:0):(i=n<0,n=Math.abs(n),n>=Math.pow(2,1-s)?(a=Math.min(Math.floor(Math.log(n)/Math.LN2),s),r=a+s,o=Math.round(n*Math.pow(2,t-a)-Math.pow(2,t))):(r=0,o=Math.round(n/Math.pow(2,1-s-t))));const c=[];for(l=t;l;l-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)c.push(r%2?1:0),r=Math.floor(r/2);c.push(i?1:0),c.reverse();const d=c.join("");let u="";for(l=0;l<64;l+=8){let h=parseInt(d.substr(l,8),2).toString(16);h.length===1&&(h="0"+h),u=u+h}return u.toLowerCase()},ql=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},zl=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function jl(n,e){let t="Unknown Error";n==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":n==="permission_denied"?t="Client doesn't have permission to access the desired data.":n==="unavailable"&&(t="The service is unavailable");const s=new Error(n+" at "+e._path.toString()+": "+t);return s.code=n.toUpperCase(),s}const Kl=new RegExp("^-?(0*)\\d{1,10}$"),Ql=-2147483648,Xl=2147483647,ui=function(n){if(Kl.test(n)){const e=Number(n);if(e>=Ql&&e<=Xl)return e}return null},Xe=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw Y("Exception was thrown by user callback.",t),e},Math.floor(0))}},Jl=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},lt=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zl{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,Cl(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t?.getImmediate({optional:!0}),this.appCheck||t?.get().then(s=>this.appCheck=s)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,s)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){this.appCheckProvider?.get().then(t=>t.addTokenListener(e))}notifyForInvalidToken(){Y(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ec{constructor(e,t,s){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=s,this.auth_=null,this.auth_=s.getImmediate({optional:!0}),this.auth_||s.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(V("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,s)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Y(e)}}class Bt{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}Bt.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nc{constructor(){this.counters_={}}incrementCounter(e,t=1){ee(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return Xo(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rn={},kn={};function ms(n){const e=n.toString();return Rn[e]||(Rn[e]=new nc),Rn[e]}function sc(n,e){const t=n.toString();return kn[t]||(kn[t]=e()),kn[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ic{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const s=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<s.length;++i)s[i]&&Xe(()=>{this.onMessage_(s[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const di="start",rc="close",oc="pLPCommand",ac="pRTLPCB",Tr="id",Nr="pw",Rr="ser",lc="cb",cc="seg",hc="ts",uc="d",dc="dframe",kr=1870,Ar=30,fc=kr-Ar,pc=25e3,_c=3e4;class xe{constructor(e,t,s,i,r,o,a){this.connId=e,this.repoInfo=t,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=kt(e),this.stats_=ms(t),this.urlFn=l=>(this.appCheckToken&&(l[Hn]=this.appCheckToken),Sr(t,br,l))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new ic(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(_c)),Yl(()=>{if(this.isClosed_)return;this.scriptTagHolder=new gs((...r)=>{const[o,a,l,c,d]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===di)this.id=a,this.password=l;else if(o===rc)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,a]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const s={};s[di]="t",s[Rr]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(s[lc]=this.scriptTagHolder.uniqueCallbackIdentifier),s[_r]=_s,this.transportSessionId&&(s[mr]=this.transportSessionId),this.lastSessionId&&(s[Cr]=this.lastSessionId),this.applicationId&&(s[Er]=this.applicationId),this.appCheckToken&&(s[Hn]=this.appCheckToken),typeof location<"u"&&location.hostname&&vr.test(location.hostname)&&(s[gr]=yr);const i=this.urlFn(s);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){xe.forceAllow_=!0}static forceDisallow(){xe.forceDisallow_=!0}static isAvailable(){return xe.forceAllow_?!0:!xe.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!ql()&&!zl()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=M(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const s=Xi(t),i=fr(s,fc);for(let r=0;r<i.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[r]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const s={};s[dc]="t",s[Tr]=e,s[Nr]=t,this.myDisconnFrame.src=this.urlFn(s),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=M(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class gs{constructor(e,t,s,i){this.onDisconnect=s,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=Vl(),window[oc+this.uniqueCallbackIdentifier]=e,window[ac+this.uniqueCallbackIdentifier]=t,this.myIFrame=gs.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){V("frame writing exception"),a.stack&&V(a.stack),V(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||V("No IE domain setting required")}catch{const s=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+s+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Tr]=this.myID,e[Nr]=this.myPW,e[Rr]=this.currentSerial;let t=this.urlFn(e),s="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Ar+s.length<=kr;){const o=this.pendingSegs.shift();s=s+"&"+cc+i+"="+o.seg+"&"+hc+i+"="+o.ts+"&"+uc+i+"="+o.d,i++}return t=t+s,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,s){this.pendingSegs.push({seg:e,ts:t,d:s}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const s=()=>{this.outstandingRequests.delete(t),this.newRequest_()},i=setTimeout(s,Math.floor(pc)),r=()=>{clearTimeout(i),s()};this.addTag(e,r)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const s=this.myIFrame.doc.createElement("script");s.type="text/javascript",s.async=!0,s.src=e,s.onload=s.onreadystatechange=function(){const i=s.readyState;(!i||i==="loaded"||i==="complete")&&(s.onload=s.onreadystatechange=null,s.parentNode&&s.parentNode.removeChild(s),t())},s.onerror=()=>{V("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(s)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lc(n,e){return ke(n.name,e.name)}function Es(n,e){return ke(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bi;class U{static set __childrenNodeConstructor(e){bi=e}static get __childrenNodeConstructor(){return bi}constructor(e,t=U.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,f(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),Fr(this.priorityNode_)}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new U(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:U.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return v(e)?this:g(e)===".priority"?this.priorityNode_:U.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return e===".priority"?this.updatePriority(t):t.isEmpty()&&e!==".priority"?this:U.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const s=g(e);return s===null?t:t.isEmpty()&&s!==".priority"?this:(f(s!==".priority"||ge(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(s,U.__childrenNodeConstructor.EMPTY_NODE.updateChild(T(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+Lr(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",t==="number"?e+=pr(this.value_):e+=this.value_,this.lazyHash_=dr(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===U.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof U.__childrenNodeConstructor?-1:(f(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,s=typeof this.value_,i=U.VALUE_TYPE_ORDER.indexOf(t),r=U.VALUE_TYPE_ORDER.indexOf(s);return f(i>=0,"Unknown leaf type: "+t),f(r>=0,"Unknown leaf type: "+s),i===r?s==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:r-i}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}else return!1}}U.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Br,Ur;function Bc(n){Br=n}function Uc(n){Ur=n}class Wc extends un{compare(e,t){const s=e.node.getPriority(),i=t.node.getPriority(),r=s.compareTo(i);return r===0?ke(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return y.MIN}maxPost(){return new y(Se,new U("[PRIORITY-POST]",Ur))}makePost(e,t){const s=Br(e);return new y(t,new U("[PRIORITY-POST]",s))}toString(){return".priority"}}const P=new Wc;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vc=Math.log(2);class Hc{constructor(e){const t=r=>parseInt(Math.log(r)/Vc,10),s=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=s(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const qt=function(n,e,t,s){n.sort(e);const i=function(l,c){const d=c-l;let u,h;if(d===0)return null;if(d===1)return u=n[l],h=t?t(u):u,new W(h,u.node,W.BLACK,null,null);{const p=parseInt(d/2,10)+l,_=i(l,p),w=i(p+1,c);return u=n[p],h=t?t(u):u,new W(h,u.node,W.BLACK,_,w)}},r=function(l){let c=null,d=null,u=n.length;const h=function(_,w){const x=u-_,ne=u;u-=_;const se=i(x+1,ne),Ce=n[x],bn=t?t(Ce):Ce;p(new W(bn,Ce.node,w,null,se))},p=function(_){c?(c.left=_,c=_):(d=_,c=_)};for(let _=0;_<l.count;++_){const w=l.nextBitIsOne(),x=Math.pow(2,l.count-(_+1));w?h(x,W.BLACK):(h(x,W.BLACK),h(x,W.RED))}return d},o=new Hc(n.length),a=r(o);return new G(s||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yc=!0;function O(n,e=null){if(n===null)return m.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),f(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new U(t,O(e))}if(!(n instanceof Array)&&Yc){const t=[];let s=!1;if(H(n,(o,a)=>{if(o.substring(0,1)!=="."){const l=O(a);l.isEmpty()||(s=s||!l.getPriority().isEmpty(),t.push(new y(o,l)))}}),t.length===0)return m.EMPTY_NODE;const r=qt(t,Lc,o=>o.name,Es);if(s){const o=qt(t,P.getCompare());return new m(r,O(e),new re({".priority":o},{".priority":P}))}else return new m(r,O(e),re.Default)}else{let t=m.EMPTY_NODE;return H(n,(s,i)=>{if(ee(n,s)&&s.substring(0,1)!=="."){const r=O(i);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(s,r))}}),t.updatePriority(O(e))}}Bc(O);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qc extends un{compare(e,t){const s=e.node.compareTo(t.node);return s===0?ke(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return y.MIN}maxPost(){return y.MAX}makePost(e,t){const s=O(e);return new y(t,s)}toString(){return".value"}}const zc=new qc;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wr(n){return{type:"value",snapshotNode:n}}function He(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function yt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function vt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function jc(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xc{constructor(){this.rootNode_=m.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zc{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t={...e};return this.last_&&H(this.last_,(s,i)=>{t[s]=t[s]-i}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ti=10*1e3,eh=30*1e3,th=300*1e3;class nh{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Zc(e);const s=Ti+(eh-Ti)*Math.random();lt(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;H(e,(i,r)=>{r>0&&ee(this.statsToReport_,i)&&(t[i]=r,s=!0)}),s&&this.server_.reportStats(t),lt(this.reportStats_.bind(this),Math.floor(Math.random()*2*th))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sh{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function ih(n,e,t,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(jc(o.childName,o.snapshotNode))}),st(n,i,"child_removed",e,s,t),st(n,i,"child_added",e,s,t),st(n,i,"child_moved",r,s,t),st(n,i,"child_changed",e,s,t),st(n,i,"value",e,s,t),i}function st(n,e,t,s,i,r){const o=s.filter(a=>a.type===t);o.sort((a,l)=>oh(n,a,l)),o.forEach(a=>{const l=rh(n,a,r);i.forEach(c=>{c.respondsTo(a.type)&&e.push(c.createEvent(l,n.query_))})})}function rh(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function oh(n,e,t){if(e.childName==null||t.childName==null)throw Qe("Should only compare child_ events.");const s=new y(e.childName,e.snapshotNode),i=new y(t.childName,t.snapshotNode);return n.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fn(n,e){return zr(e,n)}function lh(n,e,t,s,i){f(s>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:s,visible:i}),i&&(n.visibleWrites=ht(n.visibleWrites,e,t)),n.lastWriteId=s}function ch(n,e,t,s){f(s>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:s,visible:!0}),n.visibleWrites=Gn(n.visibleWrites,e,t),n.lastWriteId=s}function hh(n,e){for(let t=0;t<n.allWrites.length;t++){const s=n.allWrites[t];if(s.writeId===e)return s}return null}function uh(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);f(t>=0,"removeWrite called with nonexistent writeId.");const s=n.allWrites[t];n.allWrites.splice(t,1);let i=s.visible,r=!1,o=n.allWrites.length-1;for(;i&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&dh(a,s.path)?i=!1:q(s.path,a.path)&&(r=!0)),o--}if(i){if(r)return fh(n),!0;if(s.snap)n.visibleWrites=Ni(n.visibleWrites,s.path);else{const a=s.children;H(a,l=>{n.visibleWrites=Ni(n.visibleWrites,A(s.path,l))})}return!0}else return!1}function dh(n,e){if(n.snap)return q(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&q(A(n.path,t),e))return!0;return!1}function fh(n){n.visibleWrites=Yr(n.allWrites,ph,E()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function ph(n){return n.visible}function Yr(n,e,t){let s=Z.empty();for(let i=0;i<n.length;++i){const r=n[i];if(e(r)){const o=r.path;let a;if(r.snap)q(t,o)?(a=$(t,o),s=ht(s,a,r.snap)):q(o,t)&&(a=$(o,t),s=ht(s,E(),r.snap.getChild(a)));else if(r.children){if(q(t,o))a=$(t,o),s=Gn(s,a,r.children);else if(q(o,t))if(a=$(o,t),v(a))s=Gn(s,E(),r.children);else{const l=We(r.children,g(a));if(l){const c=l.getChild(T(a));s=ht(s,E(),c)}}}else throw Qe("WriteRecord should have .snap or .children")}}return s}function Gr(n,e,t,s,i){if(!s&&!i){const r=Ae(n.visibleWrites,e);if(r!=null)return r;{const o=_e(n.visibleWrites,e);if(zn(o))return t;if(t==null&&!qn(o,E()))return null;{const a=t||m.EMPTY_NODE;return Ye(o,a)}}}else{const r=_e(n.visibleWrites,e);if(!i&&zn(r))return t;if(!i&&t==null&&!qn(r,E()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(q(c.path,e)||q(e,c.path))},a=Yr(n.allWrites,o,e),l=t||m.EMPTY_NODE;return Ye(a,l)}}}function _h(n,e,t){let s=m.EMPTY_NODE;const i=Ae(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(P,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(t){const r=_e(n.visibleWrites,e);return t.forEachChild(P,(o,a)=>{const l=Ye(_e(r,new b(o)),a);s=s.updateImmediateChild(o,l)}),Ri(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=_e(n.visibleWrites,e);return Ri(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function mh(n,e,t,s,i){f(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=A(e,t);if(qn(n.visibleWrites,r))return null;{const o=_e(n.visibleWrites,r);return zn(o)?i.getChild(t):Ye(o,i.getChild(t))}}function gh(n,e,t,s){const i=A(e,t),r=Ae(n.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(t)){const o=_e(n.visibleWrites,i);return Ye(o,s.getNode().getImmediateChild(t))}else return null}function yh(n,e){return Ae(n.visibleWrites,e)}function vh(n,e,t,s,i,r,o){let a;const l=_e(n.visibleWrites,e),c=Ae(l,E());if(c!=null)a=c;else if(t!=null)a=Ye(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const d=[],u=o.getCompare(),h=r?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let p=h.getNext();for(;p&&d.length<i;)u(p,s)!==0&&d.push(p),p=h.getNext();return d}else return[]}function Ch(){return{visibleWrites:Z.empty(),allWrites:[],lastWriteId:-1}}function Xt(n,e,t,s){return Gr(n.writeTree,n.treePath,e,t,s)}function Ns(n,e){return _h(n.writeTree,n.treePath,e)}function ki(n,e,t,s){return mh(n.writeTree,n.treePath,e,t,s)}function Jt(n,e){return yh(n.writeTree,A(n.treePath,e))}function Eh(n,e,t,s,i,r){return vh(n.writeTree,n.treePath,e,t,s,i,r)}function Rs(n,e,t){return gh(n.writeTree,n.treePath,e,t)}function qr(n,e){return zr(A(n.treePath,e),n.writeTree)}function zr(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bh{getCompleteChild(e){return null}getChildAfterChild(e,t,s){return null}}const jr=new bh;class ks{constructor(e,t,s=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=s}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new ye(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Rs(this.writes_,e,s)}}getChildAfterChild(e,t,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Ne(this.viewCache_),r=Eh(this.writes_,i,t,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dh{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const s=this.query_._queryParams,i=new ws(s.getIndex()),r=Qc(s);this.processor_=Ih(r);const o=t.serverCache,a=t.eventCache,l=i.updateFullNode(m.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(m.EMPTY_NODE,a.getNode(),null),d=new ye(l,o.isFullyInitialized(),i.filtersNodes()),u=new ye(c,a.isFullyInitialized(),r.filtersNodes());this.viewCache_=dn(u,d),this.eventGenerator_=new sh(this.query_)}get query(){return this.query_}}function xh(n){return n.viewCache_.serverCache.getNode()}function Oh(n){return Qt(n.viewCache_)}function Mh(n,e){const t=Ne(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!v(e)&&!t.getImmediateChild(g(e)).isEmpty())?t.getChild(e):null}function Di(n){return n.eventRegistrations_.length===0}function Lh(n,e){n.eventRegistrations_.push(e)}function xi(n,e,t){const s=[];if(t){f(e==null,"A cancel should cancel all event registrations.");const i=n.query._path;n.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(t,i);o&&s.push(o)})}if(e){let i=[];for(let r=0;r<n.eventRegistrations_.length;++r){const o=n.eventRegistrations_[r];if(!o.matches(e))i.push(o);else if(e.hasAnyCallback()){i=i.concat(n.eventRegistrations_.slice(r+1));break}}n.eventRegistrations_=i}else n.eventRegistrations_=[];return s}function Oi(n,e,t,s){e.type===J.MERGE&&e.source.queryId!==null&&(f(Ne(n.viewCache_),"We should always have a full cache before handling merges"),f(Qt(n.viewCache_),"Missing event cache, even though we have a server cache"));const i=n.viewCache_,r=Th(n.processor_,i,e,t,s);return Sh(n.processor_,r.viewCache),f(r.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=r.viewCache,Qr(n,r.changes,r.viewCache.eventCache.getNode(),null)}function Fh(n,e){const t=n.viewCache_.eventCache,s=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(P,(r,o)=>{s.push(He(r,o))}),t.isFullyInitialized()&&s.push(Wr(t.getNode())),Qr(n,s,t.getNode(),e)}function Qr(n,e,t,s){const i=s?[s]:n.eventRegistrations_;return ih(n.eventGenerator_,e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let en;class Xr{constructor(){this.views=new Map}}function Bh(n){f(!en,"__referenceConstructor has already been defined"),en=n}function Uh(){return f(en,"Reference.ts has not been loaded"),en}function Wh(n){return n.views.size===0}function As(n,e,t,s){const i=e.source.queryId;if(i!==null){const r=n.views.get(i);return f(r!=null,"SyncTree gave us an op for an invalid query."),Oi(r,e,t,s)}else{let r=[];for(const o of n.views.values())r=r.concat(Oi(o,e,t,s));return r}}function Jr(n,e,t,s,i){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=Xt(t,i?s:null),l=!1;a?l=!0:s instanceof m?(a=Ns(t,s),l=!1):(a=m.EMPTY_NODE,l=!1);const c=dn(new ye(a,l,!1),new ye(s,i,!1));return new Dh(e,c)}return o}function Vh(n,e,t,s,i,r){const o=Jr(n,e,s,i,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),Lh(o,t),Fh(o,t)}function Hh(n,e,t,s){const i=e._queryIdentifier,r=[];let o=[];const a=ve(n);if(i==="default")for(const[l,c]of n.views.entries())o=o.concat(xi(c,t,s)),Di(c)&&(n.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=n.views.get(i);l&&(o=o.concat(xi(l,t,s)),Di(l)&&(n.views.delete(i),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!ve(n)&&r.push(new(Uh())(e._repo,e._path)),{removed:r,events:o}}function Zr(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function me(n,e){let t=null;for(const s of n.views.values())t=t||Mh(s,e);return t}function eo(n,e){if(e._queryParams.loadsAllData())return pn(n);{const s=e._queryIdentifier;return n.views.get(s)}}function to(n,e){return eo(n,e)!=null}function ve(n){return pn(n)!=null}function pn(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tn;function $h(n){f(!tn,"__referenceConstructor has already been defined"),tn=n}function Yh(){return f(tn,"Reference.ts has not been loaded"),tn}let Gh=1;class Mi{constructor(e){this.listenProvider_=e,this.syncPointTree_=new I(null),this.pendingWriteTree_=Ch(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function no(n,e,t,s,i){return lh(n.pendingWriteTree_,e,t,s,i),i?Je(n,new Te(Is(),e,t)):[]}function qh(n,e,t,s){ch(n.pendingWriteTree_,e,t,s);const i=I.fromObject(t);return Je(n,new $e(Is(),e,i))}function ue(n,e,t=!1){const s=hh(n.pendingWriteTree_,e);if(uh(n.pendingWriteTree_,e)){let r=new I(null);return s.snap!=null?r=r.set(E(),!0):H(s.children,o=>{r=r.set(new b(o),!0)}),Je(n,new Kt(s.path,r,t))}else return[]}function Pt(n,e,t){return Je(n,new Te(Ss(),e,t))}function zh(n,e,t){const s=I.fromObject(t);return Je(n,new $e(Ss(),e,s))}function jh(n,e){return Je(n,new Et(Ss(),e))}function Kh(n,e,t){const s=Ds(n,t);if(s){const i=xs(s),r=i.path,o=i.queryId,a=$(r,e),l=new Et(Ts(o),a);return Os(n,r,l)}else return[]}function nn(n,e,t,s,i=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||to(o,e))){const l=Hh(o,e,t,s);Wh(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!i){const d=c.findIndex(h=>h._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(h,p)=>ve(p));if(d&&!u){const h=n.syncPointTree_.subtree(r);if(!h.isEmpty()){const p=Jh(h);for(let _=0;_<p.length;++_){const w=p[_],x=w.query,ne=oo(n,w);n.listenProvider_.startListening(ut(x),wt(n,x),ne.hashFn,ne.onComplete)}}}!u&&c.length>0&&!s&&(d?n.listenProvider_.stopListening(ut(e),null):c.forEach(h=>{const p=n.queryToTagMap.get(_n(h));n.listenProvider_.stopListening(ut(h),p)}))}Zh(n,c)}return a}function so(n,e,t,s){const i=Ds(n,s);if(i!=null){const r=xs(i),o=r.path,a=r.queryId,l=$(o,e),c=new Te(Ts(a),l,t);return Os(n,o,c)}else return[]}function Qh(n,e,t,s){const i=Ds(n,s);if(i){const r=xs(i),o=r.path,a=r.queryId,l=$(o,e),c=I.fromObject(t),d=new $e(Ts(a),l,c);return Os(n,o,d)}else return[]}function Qn(n,e,t,s=!1){const i=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(i,(h,p)=>{const _=$(h,i);r=r||me(p,_),o=o||ve(p)});let a=n.syncPointTree_.get(i);a?(o=o||ve(a),r=r||me(a,E())):(a=new Xr,n.syncPointTree_=n.syncPointTree_.set(i,a));let l;r!=null?l=!0:(l=!1,r=m.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((p,_)=>{const w=me(_,E());w&&(r=r.updateImmediateChild(p,w))}));const c=to(a,e);if(!c&&!e._queryParams.loadsAllData()){const h=_n(e);f(!n.queryToTagMap.has(h),"View does not exist, but we have a tag");const p=eu();n.queryToTagMap.set(h,p),n.tagToQueryMap.set(p,h)}const d=fn(n.pendingWriteTree_,i);let u=Vh(a,e,t,d,r,l);if(!c&&!o&&!s){const h=eo(a,e);u=u.concat(tu(n,e,h))}return u}function Ps(n,e,t){const i=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=$(o,e),c=me(a,l);if(c)return c});return Gr(i,e,r,t,!0)}function Xh(n,e){const t=e._path;let s=null;n.syncPointTree_.foreachOnPath(t,(c,d)=>{const u=$(c,t);s=s||me(d,u)});let i=n.syncPointTree_.get(t);i?s=s||me(i,E()):(i=new Xr,n.syncPointTree_=n.syncPointTree_.set(t,i));const r=s!=null,o=r?new ye(s,!0,!1):null,a=fn(n.pendingWriteTree_,e._path),l=Jr(i,e,a,r?o.getNode():m.EMPTY_NODE,r);return Oh(l)}function Je(n,e){return io(e,n.syncPointTree_,null,fn(n.pendingWriteTree_,E()))}function io(n,e,t,s){if(v(n.path))return ro(n,e,t,s);{const i=e.get(E());t==null&&i!=null&&(t=me(i,E()));let r=[];const o=g(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,d=qr(s,o);r=r.concat(io(a,l,c,d))}return i&&(r=r.concat(As(i,n,s,t))),r}}function ro(n,e,t,s){const i=e.get(E());t==null&&i!=null&&(t=me(i,E()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=qr(s,o),d=n.operationForChild(o);d&&(r=r.concat(ro(d,a,l,c)))}),i&&(r=r.concat(As(i,n,s,t))),r}function oo(n,e){const t=e.query,s=wt(n,t);return{hashFn:()=>(xh(e)||m.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?Kh(n,t._path,s):jh(n,t._path);{const r=jl(i,t);return nn(n,t,null,r)}}}}function wt(n,e){const t=_n(e);return n.queryToTagMap.get(t)}function _n(n){return n._path.toString()+"$"+n._queryIdentifier}function Ds(n,e){return n.tagToQueryMap.get(e)}function xs(n){const e=n.indexOf("$");return f(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new b(n.substr(0,e))}}function Os(n,e,t){const s=n.syncPointTree_.get(e);f(s,"Missing sync point for query tag that we're tracking");const i=fn(n.pendingWriteTree_,e);return As(s,t,i,null)}function Jh(n){return n.fold((e,t,s)=>{if(t&&ve(t))return[pn(t)];{let i=[];return t&&(i=Zr(t)),H(s,(r,o)=>{i=i.concat(o)}),i}})}function ut(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Yh())(n._repo,n._path):n}function Zh(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const i=_n(s),r=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(r)}}}function eu(){return Gh++}function tu(n,e,t){const s=e._path,i=wt(n,e),r=oo(n,t),o=n.listenProvider_.startListening(ut(e),i,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(s);if(i)f(!ve(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,d,u)=>{if(!v(c)&&d&&ve(d))return[pn(d).query];{let h=[];return d&&(h=h.concat(Zr(d).map(p=>p.query))),H(u,(p,_)=>{h=h.concat(_)}),h}});for(let c=0;c<l.length;++c){const d=l[c];n.listenProvider_.stopListening(ut(d),wt(n,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ms{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Ms(t)}node(){return this.node_}}class Ls{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=A(this.path_,e);return new Ls(this.syncTree_,t)}node(){return Ps(this.syncTree_,this.path_)}}const nu=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},Li=function(n,e,t){if(!n||typeof n!="object")return n;if(f(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return su(n[".sv"],e,t);if(typeof n[".sv"]=="object")return iu(n[".sv"],e);f(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},su=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:f(!1,"Unexpected server value: "+n)}},iu=function(n,e,t){n.hasOwnProperty("increment")||f(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const s=n.increment;typeof s!="number"&&f(!1,"Unexpected increment value: "+s);const i=e.node();if(f(i!==null&&typeof i<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return s;const o=i.getValue();return typeof o!="number"?s:o+s},ao=function(n,e,t,s){return Fs(e,new Ls(t,n),s)},lo=function(n,e,t){return Fs(n,new Ms(e),t)};function Fs(n,e,t){const s=n.getPriority().val(),i=Li(s,e.getImmediateChild(".priority"),t);let r;if(n.isLeafNode()){const o=n,a=Li(o.getValue(),e,t);return a!==o.getValue()||i!==o.getPriority().val()?new U(a,O(i)):n}else{const o=n;return r=o,i!==o.getPriority().val()&&(r=r.updatePriority(new U(i))),o.forEachChild(P,(a,l)=>{const c=Fs(l,e.getImmediateChild(a),t);c!==l&&(r=r.updateImmediateChild(a,c))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lu=/[\[\].#$\/\u0000-\u001F\u007F]/,cu=/[\[\].#$\u0000-\u001F\u007F]/,xn=10*1024*1024,Ws=function(n){return typeof n=="string"&&n.length!==0&&!lu.test(n)},fo=function(n){return typeof n=="string"&&n.length!==0&&!cu.test(n)},hu=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),fo(n)},uu=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!fs(n)||n&&typeof n=="object"&&ee(n,".sv")},po=function(n,e,t,s){s&&e===void 0||gn(cn(n,"value"),e,t)},gn=function(n,e,t){const s=t instanceof b?new Rc(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+we(s));if(typeof e=="function")throw new Error(n+"contains a function "+we(s)+" with contents = "+e.toString());if(fs(e))throw new Error(n+"contains "+e.toString()+" "+we(s));if(typeof e=="string"&&e.length>xn/3&&hn(e)>xn)throw new Error(n+"contains a string greater than "+xn+" utf8 bytes "+we(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(H(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Ws(o)))throw new Error(n+" contains an invalid key ("+o+") "+we(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);kc(s,o),gn(n,a,s),Ac(s)}),i&&r)throw new Error(n+' contains ".value" child '+we(s)+" in addition to actual children.")}},du=function(n,e){let t,s;for(t=0;t<e.length;t++){s=e[t];const r=gt(s);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!Ws(r[o]))throw new Error(n+"contains an invalid key ("+r[o]+") in path "+s.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(Nc);let i=null;for(t=0;t<e.length;t++){if(s=e[t],i!==null&&q(i,s))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+s.toString());i=s}},fu=function(n,e,t,s){const i=cn(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const r=[];H(e,(o,a)=>{const l=new b(o);if(gn(i,a,A(t,l)),ys(l)===".priority"&&!uu(a))throw new Error(i+"contains an invalid value for '"+l.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(l)}),du(i,r)},_o=function(n,e,t,s){if(!fo(t))throw new Error(cn(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},pu=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),_o(n,e,t)},Vs=function(n,e){if(g(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},_u=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Ws(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!hu(t))throw new Error(cn(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mu{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function yn(n,e){let t=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();t!==null&&!vs(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&n.eventLists_.push(t)}function mo(n,e,t){yn(n,t),go(n,s=>vs(s,e))}function K(n,e,t){yn(n,t),go(n,s=>q(s,e)||q(e,s))}function go(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const i=n.eventLists_[s];if(i){const r=i.path;e(r)?(gu(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function gu(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();at&&V("event: "+t.toString()),Xe(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pu(n){let e="";const t=n.split("/");for(let s=0;s<t.length;s++)if(t[s].length>0){let i=t[s];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function Du(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const s=t.split("=");s.length===2?e[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):Y(`Invalid query segment '${t}' in query '${n}'`)}return e}const Ui=function(n,e){const t=xu(n),s=t.namespace;t.domain==="firebase.com"&&he(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!s||s==="undefined")&&t.domain!=="localhost"&&he("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||$l();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new Ir(t.host,t.secure,s,i,e,"",s!==t.subdomain),path:new b(t.pathString)}},xu=function(n){let e="",t="",s="",i="",r="",o=!0,a="https",l=443;if(typeof n=="string"){let c=n.indexOf("//");c>=0&&(a=n.substring(0,c-1),n=n.substring(c+2));let d=n.indexOf("/");d===-1&&(d=n.length);let u=n.indexOf("?");u===-1&&(u=n.length),e=n.substring(0,Math.min(d,u)),d<u&&(i=Pu(n.substring(d,u)));const h=Du(n.substring(Math.min(n.length,u)));c=e.indexOf(":"),c>=0?(o=a==="https"||a==="wss",l=parseInt(e.substring(c+1),10)):c=e.length;const p=e.slice(0,c);if(p.toLowerCase()==="localhost")t="localhost";else if(p.split(".").length<=2)t=p;else{const _=e.indexOf(".");s=e.substring(0,_).toLowerCase(),t=e.substring(_+1),r=s}"ns"in h&&(r=h.ns)}return{host:e,port:l,domain:t,subdomain:s,secure:o,scheme:a,pathString:i,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zs{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return v(this._path)?null:ys(this._path)}get ref(){return new te(this._repo,this._path)}get _queryIdentifier(){const e=Si(this._queryParams),t=ps(e);return t==="{}"?"default":t}get _queryObject(){return Si(this._queryParams)}isEqual(e){if(e=Re(e),!(e instanceof zs))return!1;const t=this._repo===e._repo,s=vs(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+Tc(this._path)}}class te extends zs{constructor(e,t){super(e,t,new bs,!1)}get parent(){const e=xr(this._path);return e===null?null:new te(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class qe{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new b(e),s=ze(this.ref,e);return new qe(this._node.getChild(t),s,P)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new qe(i,ze(this.ref,s),P)))}hasChild(e){const t=new b(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function z(n,e){return n=Re(n),n._checkNotDeleted("ref"),e!==void 0?ze(n._root,e):n._root}function ze(n,e){return n=Re(n),g(n._path)===null?pu("child","path",e):_o("child","path",e),new te(n._repo,A(n._path,e))}function To(n,e){n=Re(n),Vs("push",n._path),po("push",e,n._path,!0);const t=yo(n._repo),s=Ou(t),i=ze(n,s),r=ze(n,s);let o;return o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function Mu(n){return Vs("remove",n._path),je(n,null)}function je(n,e){n=Re(n),Vs("set",n._path),po("set",e,n._path,!1);const t=new Tt;return Iu(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function No(n,e){fu("update",e,n._path);const t=new Tt;return Su(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function Lu(n){n=Re(n);const e=new qs(()=>{}),t=new Ot(e);return bu(n._repo,n,t).then(s=>new qe(s,new te(n._repo,n._path),n._queryParams.getIndex()))}class Ot{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new Io("value",this,new qe(e.snapshotNode,new te(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new So(this,e,t):null}matches(e){return e instanceof Ot?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class En{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t=e==="children_added"?"child_added":e;return t=t==="children_removed"?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new So(this,e,t):null}createEvent(e,t){f(e.childName!=null,"Child events should have a childName.");const s=ze(new te(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new Io(e.type,this,new qe(e.snapshotNode,s,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof En?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function Ro(n,e,t,s,i){const r=new qs(t,void 0),o=e==="value"?new Ot(r):new En(e,r);return Nu(n._repo,n,o),()=>vo(n._repo,n,o)}function ko(n,e,t,s){return Ro(n,"value",e)}function Ao(n,e,t,s){return Ro(n,"child_added",e)}function Fu(n,e,t){let s=null;const i=t?new qs(t):null;e==="value"?s=new Ot(i):e&&(s=new En(e,i)),vo(n._repo,n,s)}Bh(te);$h(te);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bu="FIREBASE_DATABASE_EMULATOR_HOST",Zn={};let Uu=!1;function Wu(n,e,t,s){const i=e.lastIndexOf(":"),r=e.substring(0,i),o=us(r);n.repoInfo_=new Ir(e,o,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),s&&(n.authTokenProvider_=s)}function Vu(n,e,t,s,i){let r=s||n.options.databaseURL;r===void 0&&(n.options.projectId||he("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),V("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=Ui(r,i),a=o.repoInfo,l;typeof process<"u"&&ai&&(l=ai[Bu]),l?(r=`http://${l}?ns=${a.namespace}`,o=Ui(r,i),a=o.repoInfo):o.repoInfo.secure;const c=new ec(n.name,n.options,e);_u("Invalid Firebase Database URL",o),v(o.path)||he("Database URL must point to the root of a Firebase Database (not including a child path).");const d=$u(a,n,c,new Zl(n,t));return new Yu(d,n)}function Hu(n,e){const t=Zn[e];(!t||t[n.key]!==n)&&he(`Database ${e}(${n.repoInfo_}) has already been deleted.`),Ru(n),delete t[n.key]}function $u(n,e,t,s){let i=Zn[e.name];i||(i={},Zn[e.name]=i);let r=i[n.toURLString()];return r&&he("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new Cu(n,Uu,t,s),i[n.toURLString()]=r,r}class Yu{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Eu(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new te(this._repo,E())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Hu(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&he("Cannot call "+e+" on a deleted database.")}}function Gu(n=Il(),e){const t=vl(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const s=ia("database");s&&qu(t,...s)}return t}function qu(n,e,t,s={}){n=Re(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,r=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&Vt(s,r.repoInfo_.emulatorOptions))return;he("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)s.mockUserToken&&he('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Bt(Bt.OWNER);else if(s.mockUserToken){const a=typeof s.mockUserToken=="string"?s.mockUserToken:oa(s.mockUserToken,n.app.options.projectId);o=new Bt(a)}us(e)&&(ra(e),ca("Database",!0)),Wu(r,i,s,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zu(n){Fl(bl),$t(new pt("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Vu(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),Le(li,ci,n),Le(li,ci,"esm2020")}ae.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};ae.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};zu();const F=document.getElementById("localVideo"),D=document.getElementById("remoteVideo"),R=document.getElementById("sharedVideo"),bt=document.getElementById("startChat"),wn=document.getElementById("hangUp"),ju=document.getElementById("copyLink"),Ue=document.getElementById("pipBtn"),Vi=document.getElementById("switchCameraSelfBtn"),es=document.getElementById("toggleMode"),Ku=document.getElementById("loadStream"),Qu=document.getElementById("status"),Po=document.getElementById("linkContainer"),ts=document.getElementById("watchContainer"),Ke=document.getElementById("yt-player-div"),ns=document.querySelector(".video-container"),X=document.getElementById("syncStatus"),sn=document.getElementById("shareLink"),It=document.getElementById("streamUrl"),Do=document.getElementById("mutePartnerBtn"),Xu=document.getElementById("fullscreenPartnerBtn"),xo=document.getElementById("muteSelfBtn"),Hi=document.getElementById("videoSelfBtn"),Ju=document.getElementById("fullscreenSelfBtn");document.getElementById("titleHeader");const rn=document.getElementById("titleLink");document.getElementById("titleText");let L=null,Pe=!1;function Zu(){return new Promise(n=>{window.YT&&window.YT.Player?n():window.onYouTubeIframeAPIReady=()=>{n()}})}function ss(n){return n?n.includes("youtube.com")||n.includes("youtu.be"):!1}function Oo(n){if(!n)return null;const e=[/(?:youtube\.com\/watch\?v=)([\w-]+)/,/(?:youtu\.be\/)([\w-]+)/,/(?:youtube\.com\/embed\/)([\w-]+)/,/(?:youtube\.com\/shorts\/)([\w-]+)/];for(const t of e){const s=n.match(t);if(s&&s[1])return s[1]}return null}async function ed({url:n,containerId:e,onReady:t,onStateChange:s}){const i=Oo(n);if(!i)throw new Error("Invalid YouTube URL");if(await Zu(),!document.getElementById(e))throw new Error(`Container #${e} not found`);if(L){try{L.destroy()}catch(o){console.warn("Error destroying previous YouTube player:",o)}L=null}return new Promise((o,a)=>{try{L=new window.YT.Player(e,{videoId:i,playerVars:{autoplay:0,controls:1,rel:0,modestbranding:1},events:{onReady:l=>{Pe=!0,t&&t(l),o(L)},onStateChange:l=>{s&&s(l)},onError:l=>{console.error("YouTube player error:",l.data),a(new Error(`YouTube error: ${l.data}`))}}})}catch(l){a(l)}})}function $i(){return L}function Mo(){if(L){try{L.destroy()}catch(n){console.warn("Error destroying YouTube player:",n)}L=null,Pe=!1}}function Yi(){L&&Pe&&L.playVideo()}function Gi(){L&&Pe&&L.pauseVideo()}function td(n){L&&Pe&&L.seekTo(n,!0)}function on(){return L&&Pe?L.getCurrentTime():0}function is(){return L&&Pe?L.getPlayerState():-1}const de={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5};let St=[],be=null,dt=!1,Lo=!1,rs="",ie=-1;const nd="AIzaSyBq18HUW_U9E3AhSKVP58LZFK_GfzNHIGQ",sd="https://www.googleapis.com/youtube/v3";function id(n){be=n;const e=document.querySelector(".search-section"),t=document.getElementById("searchBtn"),s=document.getElementById("searchQuery"),i=document.getElementById("searchResults");if(!t||!s||!i){console.error("YouTube search elements not found in DOM");return}const r=a=>/^https?:\/\//i.test(a),o=a=>{i.querySelectorAll(".search-result-item").forEach((c,d)=>{d===a?(c.classList.add("focused"),c.scrollIntoView({block:"nearest"})):c.classList.remove("focused")}),ie=a};t.onclick=async()=>{const a=s.value.trim();if(!a){as("Please enter a search term");return}if(dt&&a===rs)os(St);else if(!r(a))await qi(a);else{be&&be({url:a,title:a,channel:"",thumbnail:"",id:a}),i.style.display="none",s.value="";return}},e.addEventListener("keydown",async a=>{const l=i.querySelectorAll(".search-result-item");if(l.length>0&&(a.key==="ArrowDown"||a.key==="ArrowUp")){if(a.preventDefault(),a.key==="ArrowDown"){let c=ie+1;c>=l.length&&(c=0),o(c)}else if(a.key==="ArrowUp"){let c=ie-1;c<0&&(c=l.length-1),o(c)}return}if(a.key==="Enter"){if(l.length>0&&ie>=0){l[ie].click();return}const c=s.value.trim();if(c)if(dt&&c===rs)os(St);else if(!r(c))await qi(c);else{be&&be({url:c,title:c,channel:"",thumbnail:"",id:c}),i.style.display="none",s.value="";return}}else a.key==="Escape"&&Lo&&(i.style.display="none")})}async function qi(n){rs=n;const e=document.getElementById("searchBtn"),t=document.getElementById("searchResults");e.disabled=!0,e.textContent="Searching...",t.innerHTML='<div class="search-loading">Searching YouTube...</div>',t.style.display="block",dt=!1;try{const s=await fetch(`${sd}/search?part=snippet&maxResults=10&q=${encodeURIComponent(n)}&type=video&key=${nd}`);if(!s.ok)throw s.status===403?new Error("YouTube API quota exceeded. Please try again later."):s.status===400?new Error("Invalid API key or request."):new Error(`YouTube API error: ${s.status}`);const i=await s.json();if(!i.items||i.items.length===0){as("No videos found"),dt=!1;return}St=i.items.map(r=>({id:r.id.videoId,title:r.snippet.title,thumbnail:r.snippet.thumbnails.medium.url,channel:r.snippet.channelTitle,url:`https://www.youtube.com/watch?v=${r.id.videoId}`})),os(St),dt=!0}catch(s){console.error("YouTube search failed:",s),as(s.message||"Search failed. Please try again.")}finally{e.disabled=!1,e.textContent="Search"}}function os(n){const e=document.getElementById("searchResults");if(!n||n.length===0){e.innerHTML='<div class="no-results">No results found</div>',ie=-1;return}e.innerHTML="",n.forEach(s=>{const i=document.createElement("div");i.className="search-result-item",i.innerHTML=`
      ...
      `,i.onclick=()=>{if(be){be(s),e.style.display="none";const r=document.getElementById("searchQuery");r&&(r.value=""),ie=-1}},e.appendChild(i)}),e.style.display="block",Lo=!0,ie=0,e.querySelectorAll(".search-result-item").forEach((s,i)=>{i===ie?(s.classList.add("focused"),s.scrollIntoView({block:"nearest"})):s.classList.remove("focused")})}function as(n){const e=document.getElementById("searchResults");e.innerHTML=`<div class="search-error">${n}</div>`,e.style.display="block"}function rd(){const n=document.getElementById("searchResults");n&&(n.innerHTML="",n.style.display="none"),St=[]}const od={apiKey:"AIzaSyA-fvCaKCjyEFX__YAVr1oPGdVsUEhFehA",authDomain:"vidu-aae11.firebaseapp.com",projectId:"vidu-aae11",databaseURL:"https://vidu-aae11-default-rtdb.europe-west1.firebasedatabase.app",storageBucket:"vidu-aae11.firebasestorage.app",messagingSenderId:"765724787439",appId:"1:765724787439:web:61a3b5dd538149564c911a",measurementId:"G-EGJ53HLGY4"},ad=ar(od),j=Gu(ad),Fo={iceServers:[{urls:"stun:stun.l.google.com:19302"}]};let C=null,B=null,N=null,Mt=null,an=null,it=!1,Oe=null,js=!1;const ls=[];let cs=null,rt=0;async function Bo(){Mt=Math.random().toString(36).substring(2,15);try{return B=await navigator.mediaDevices.getUserMedia({video:!0,audio:!0}),F.srcObject=B,F.volume=0,$o(),!0}catch(n){return console.error("Failed to get user media:",n),k("Error: Please allow camera and microphone access."),!1}}async function ld(){if(!B){k("Error: Camera not initialized");return}N=Math.random().toString(36).substring(2,15),an="initiator",C=new RTCPeerConnection(Fo),B.getTracks().forEach(a=>{C.addTrack(a,B)}),C.ontrack=a=>{D.srcObject!==a.streams[0]&&(D.srcObject=a.streams[0],Ue.style.display="block",Go(),k("Connected!"))},C.onicecandidate=a=>{if(a.candidate){const l=To(z(j,`rooms/${N}/callerCandidates`));je(l,a.candidate.toJSON())}},C.onconnectionstatechange=()=>{C.connectionState==="connected"?k("Connected!"):C.connectionState==="disconnected"?k("Partner disconnected"):C.connectionState==="failed"&&k("Connection failed")};const n=await C.createOffer();await C.setLocalDescription(n);const e=z(j,`rooms/${N}`);await je(e,{offer:{type:n.type,sdp:n.sdp}});const t=z(j,`rooms/${N}/answer`),s=async a=>{const l=a.val();if(l&&l.sdp!==cs){if(cs=l.sdp,C.signalingState!=="have-local-offer"&&C.signalingState!=="stable")return;try{await C.setRemoteDescription(new RTCSessionDescription(l))}catch(c){console.error("Failed to set remote description:",c)}}};ko(t,s),ln(t,"value",s);const i=z(j,`rooms/${N}/calleeCandidates`),r=a=>{const l=a.val();l&&C.remoteDescription&&C.addIceCandidate(new RTCIceCandidate(l)).catch(c=>{console.error("Error adding ICE candidate:",c)})};Ao(i,r),ln(i,"child_added",r),Uo();const o=`${window.location.origin}${window.location.pathname}?room=${N}`;sn.value=o,Po.style.display="block",bt.disabled=!0,wn.disabled=!1,k("Link ready! Share with your partner."),zo()}async function cd(){if(!B){k("Error: Camera not initialized");return}if(!N){k("Error: No room ID");return}an="joiner";const n=z(j,`rooms/${N}`),e=await Lu(n);if(!e.exists()){k("Error: Invalid room link");return}const s=e.val().offer;if(!s){k("Error: No offer found");return}C=new RTCPeerConnection(Fo),B.getTracks().forEach(a=>{C.addTrack(a,B)}),C.ontrack=a=>{D.srcObject!==a.streams[0]&&(D.srcObject=a.streams[0],Ue.style.display="block",Go(),k("Connected!"))},C.onicecandidate=a=>{if(a.candidate){const l=To(z(j,`rooms/${N}/calleeCandidates`));je(l,a.candidate.toJSON())}},C.onconnectionstatechange=()=>{C.connectionState==="connected"?k("Connected!"):C.connectionState==="disconnected"?k("Partner disconnected"):C.connectionState==="failed"&&k("Connection failed")};const i=z(j,`rooms/${N}/callerCandidates`),r=a=>{const l=a.val();l&&C.remoteDescription&&C.addIceCandidate(new RTCIceCandidate(l)).catch(c=>{console.error("Error adding ICE candidate:",c)})};Ao(i,r),ln(i,"child_added",r),await C.setRemoteDescription(new RTCSessionDescription(s));const o=await C.createAnswer();await C.setLocalDescription(o),await No(n,{answer:{type:o.type,sdp:o.sdp}}),Uo(),wn.disabled=!1,k("Connecting..."),zo()}let oe=!1,le=null;function Me(n){if(!N)return;const e=z(j,`rooms/${N}/watch`);No(e,{...n,updatedBy:Mt})}function Uo(){if(!N)return;const n=z(j,`rooms/${N}/watch`),e=t=>{const s=t.val();if(s&&s.updatedBy!==Mt&&!(Date.now()-rt<500))if(s.url&&s.url!==It.value&&(It.value=s.url,ss(s.url)?Vo(s.url):(R.style.display="block",R.src=s.url,Ke.style.display="none"),X.textContent="Video loaded"),s.isYouTube&&Oe&&js){if(s.playing!==void 0){const i=is(),r=i===de.PLAYING;if(i===de.BUFFERING||i===de.UNSTARTED)oe=!0,le&&clearTimeout(le),le=setTimeout(()=>{oe=!1;const a=is()===de.PLAYING;Me({playing:a,currentTime:on()})},700);else{if(oe)return;s.playing&&!r?Yi():!s.playing&&r&&Gi()}}if(s.currentTime!==void 0){const i=on();Math.abs(i-s.currentTime)>.3&&!oe&&(td(s.currentTime),setTimeout(()=>{s.playing?Yi():Gi()},500))}}else!s.isYouTube&&R.src&&(s.playing!==void 0&&(s.playing&&R.paused?R.play().catch(i=>console.warn("Play failed:",i)):!s.playing&&!R.paused&&R.pause()),s.currentTime!==void 0&&Math.abs(R.currentTime-s.currentTime)>1&&(R.currentTime=s.currentTime,s.playing?R.play().catch(r=>console.warn("Play failed:",r)):R.pause()))};ko(n,e),ln(n,"value",e),R.addEventListener("play",()=>{!Oe&&N&&(rt=Date.now(),Me({playing:!0,isYouTube:!1}))}),R.addEventListener("pause",()=>{!Oe&&N&&(rt=Date.now(),Me({playing:!1,isYouTube:!1}))}),R.addEventListener("seeked",()=>{!Oe&&N&&(rt=Date.now(),Me({currentTime:R.currentTime,playing:!R.paused,isYouTube:!1}))})}function Wo(){const n=It.value.trim();if(!n){X.textContent="Please enter a video URL";return}if(rt=Date.now(),ss(n)?Vo(n):(Ke.style.display="none",Mo(),R.style.display="block",R.src=n,X.textContent="Video loaded"),N){const e=z(j,`rooms/${N}/watch`);je(e,{url:n,playing:!1,currentTime:0,isYouTube:ss(n),updatedBy:Mt})}}function hd(n){It.value=n.url,Wo(),X.textContent=`Loading "${n.title}"...`}async function Vo(n){if(!Oo(n)){X.textContent="Invalid YouTube URL";return}X.textContent="Loading YouTube video...",R.style.display="none",Ke.style.display="block";try{await ed({url:n,containerId:"yt-player-div",onReady:t=>{if(js=!0,X.textContent="YouTube video ready",N){const s=z(j,`rooms/${N}/watch`);je(s,{url:n,playing:!1,currentTime:0,isYouTube:!0,updatedBy:Mt})}},onStateChange:t=>{if(!$i())return;const i=t.data===de.PLAYING,r=t.data===de.PAUSED;if(t.data===de.BUFFERING){oe=!0,le&&clearTimeout(le),le=setTimeout(()=>{oe=!1;const l=is()===de.PLAYING;Me({playing:l,currentTime:on()})},700);return}r&&oe||!oe&&(i||r)&&Me({playing:i,currentTime:on()})}}),Oe=$i(),X.textContent="YouTube video loaded"}catch(t){console.error("Failed to load YouTube video:",t),X.textContent="Failed to load YouTube video",R.style.display="block",Ke.style.display="none"}}function ud(){it=!it,it?(ns.style.display="none",ts.style.display="block",es.textContent="Switch to Chat Mode",X.textContent=it&&N?"Watch mode ready":"Enter a video URL",id(hd)):(ns.style.display="flex",ts.style.display="none",es.textContent="Switch to Watch Mode",rd(),Ke.style.display="none",R.style.display="none")}let zi=F?.muted||!1,ji=D?.muted||!1;const dd=n=>{if(!B)return;const e=B.getAudioTracks()[0];e&&(e.enabled=n)},Ho=()=>{if(F.muted!==zi){const n=xo.querySelector("i");n.className=F.muted?"fa fa-microphone-slash":"fa fa-microphone",zi=F.muted}dd(!F.muted)};function $o(){F&&F.addEventListener("volumechange",Ho)}xo.onclick=()=>{!F||!B||(F.muted=!F.muted)};const Yo=()=>{if(D.muted!==ji){const n=Do.querySelector("i");n.className=D.muted?"fa fa-volume-mute":"fa fa-volume-up",ji=D.muted}};function Go(){D&&D.addEventListener("volumechange",Yo)}Do.onclick=()=>{D&&(D.muted=!D.muted)};Hi.onclick=()=>{if(!B)return;const n=B.getVideoTracks()[0];if(n){n.enabled=!n.enabled;const e=Hi.querySelector("i");e.className=n.enabled?"fa fa-video":"fa fa-video-slash"}};Vi&&(Vi.onclick=async()=>{if(B)try{const n=B.getVideoTracks()[0],t=n.getSettings().facingMode==="user"?"environment":"user";n.stop();const s=await navigator.mediaDevices.getUserMedia({video:{facingMode:t},audio:!0}),i=s.getVideoTracks()[0];if(C){const r=C.getSenders().find(o=>o.track?.kind==="video");r&&r.replaceTrack(i)}B=s,F.srcObject=s,$o()}catch(n){console.error("Failed to switch camera:",n)}});Ju.onclick=()=>{F.requestFullscreen?F.requestFullscreen():F.webkitRequestFullscreen&&F.webkitRequestFullscreen()};Xu.onclick=()=>{D.requestFullscreen?D.requestFullscreen():D.webkitRequestFullscreen&&D.webkitRequestFullscreen()};Ue.onclick=async()=>{try{document.pictureInPictureElement?(await document.exitPictureInPicture(),Ue.textContent="Float Partner Video"):(await D.requestPictureInPicture(),Ue.textContent="Exit Floating Video")}catch(n){console.error("PiP failed:",n),k("Picture-in-picture not supported")}};async function qo(){if(console.debug("Hanging up..."),B&&(B.getTracks().forEach(n=>n.stop()),F.srcObject=null,B=null,F.removeEventListener("volumechange",Ho)),D.srcObject&&(D.srcObject.getTracks().forEach(n=>n.stop()),D.srcObject=null,D.removeEventListener("volumechange",Yo)),C&&(C.close(),C=null),ls.forEach(({ref:n,type:e,callback:t})=>{Fu(n,e,t)}),ls.length=0,Mo(),Oe=null,js=!1,Ke.style.display="none",le&&(clearTimeout(le),le=null),oe=!1,N&&an==="initiator"){const n=z(j,`rooms/${N}`);Mu(n).catch(e=>{console.warn("Failed to remove room:",e)})}bt.disabled=!1,bt.style.display="block",wn.disabled=!0,Po.style.display="none",ts.style.display="none",ns.style.display="flex",Ue.style.display="none",sn.value="",R.src="",R.style.display="none",It.value="",X.textContent="",document.pictureInPictureElement&&document.exitPictureInPicture().catch(n=>console.error(n)),N=null,an=null,it=!1,cs=null,window.history.replaceState({},document.title,window.location.pathname),k('Disconnected. Click "Start New Chat" to begin.'),fd()}bt.onclick=async()=>{await Bo()&&await ld()};wn.onclick=qo;es.onclick=ud;Ku.onclick=Wo;ju.onclick=async()=>{try{await navigator.clipboard.writeText(sn.value),k("Link copied to clipboard!")}catch{sn.select(),document.execCommand("copy"),k("Link copied!")}};function k(n){Qu.textContent=n}function ln(n,e,t){ls.push({ref:n,type:e,callback:t})}function zo(){rn.href="",rn.style.cursor="default"}function fd(){rn.href="https://kristinnroach.github.io/HangVidU/",rn.style.cursor="pointer"}async function pd(){const e=new URLSearchParams(window.location.search).get("room");e?(N=e,k("Connecting to room..."),bt.style.display="none",await Bo()&&await cd()):k('Ready. Click "Start New Chat" to begin.')}window.addEventListener("beforeunload",n=>{if(C&&C.connectionState==="connected")return n.preventDefault(),n.returnValue="You are in an active call. Are you sure you want to leave?",n.returnValue;qo()});document.querySelectorAll(".video-wrapper").forEach(n=>{let e;const t=n.querySelector(".hover-controls");t&&n.addEventListener("touchstart",()=>{t.style.opacity="1",clearTimeout(e),e=setTimeout(()=>{t.style.opacity="0"},3e3)})});pd();
