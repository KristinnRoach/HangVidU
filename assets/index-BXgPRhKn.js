 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bi(t){try{return(t.startsWith("http://")||t.startsWith("https://")?new URL(t).hostname:t).endsWith(".cloudworkstations.dev")}catch{return!1}}async function el(t){return(await fetch(t,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fl{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Bl(n)){const i=n.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(n=>n).join(" ")}}function Bl(t){return t.getComponent()?.type==="VERSION"}const li="@firebase/app",Hs="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bc=1024,Ic=30;class Sc{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new kc(n),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){try{const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=Ys();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(s=>s.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:n}),this._heartbeatsCache.heartbeats.length>Ic){const s=Nc(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(s,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){ye.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Ys(),{heartbeatsToSend:n,unsentEntries:i}=Tc(this._heartbeatsCache.heartbeats),s=sn(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(e){return ye.warn(e),""}}}function Ys(){return new Date().toISOString().substring(0,10)}function Tc(t,e=bc){const n=[];let i=t.slice();for(const s of t){const r=n.find(o=>o.agent===s.agent);if(r){if(r.dates.push(s.date),Gs(n)>e){r.dates.pop();break}}else if(n.push({agent:s.agent,dates:[s.date]}),Gs(n)>e){n.pop();break}i=i.slice(1)}return{heartbeatsToSend:n,unsentEntries:i}}class kc{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ll()?cl().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await wc(this.app);return n?.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return $s(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return $s(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function Gs(t){return sn(JSON.stringify({version:2,heartbeats:t})).length}function Nc(t){if(t.length===0)return-1;let e=0,n=t[0].date;for(let i=1;i<t.length;i++)t[i].date<n&&(n=t[i].date,e=i);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rc(t){ln(new At("platform-logger",e=>new Fl(e),"PRIVATE")),ln(new At("heartbeat",e=>new Sc(e),"PRIVATE")),Xe(li,Hs,t),Xe(li,Hs,"esm2020"),Xe("fire-js","")}Rc("");var zs={};const qs="@firebase/database",js="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Je=new Xr("@firebase/database"),Mc=(function(){let t=1;return function(){return t++}})(),ro=function(t){const e=gl(t),n=new ml;n.update(e);const i=n.digest();return Fi.encodeByteArray(i)},Ht=function(...t){let e="";for(let n=0;n<t.length;n++){const i=t[n];Array.isArray(i)||i&&typeof i=="object"&&typeof i.length=="number"?e+=Ht.apply(null,i):typeof i=="object"?e+=B(i):e+=i,e+=" "}return e};let Et=null,Ks=!0;const Oc=function(t,e){p(!0,"Can't turn on custom loggers persistently."),Je.logLevel=N.VERBOSE,Et=Je.log.bind(Je)},V=function(...t){if(Ks===!0&&(Ks=!1,Et===null&&Dc.get("logging_enabled")===!0&&Oc()),Et){const e=Ht.apply(null,t);Et(e)}},Vt=function(t){return function(...e){V(t,...e)}},di=function(...t){const e="FIREBASE INTERNAL ERROR: "+Ht(...t);Je.error(e)},ve=function(...t){const e=`FIREBASE FATAL ERROR: ${Ht(...t)}`;throw Je.error(e),new Error(e)},j=function(...t){const e="FIREBASE WARNING: "+Ht(...t);Je.warn(e)},Lc=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&j("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},Wi=function(t){return typeof t=="number"&&(t!==t||t===Number.POSITIVE_INFINITY||t===Number.NEGATIVE_INFINITY)},Fc=function(t){if(document.readyState==="complete")t();else{let e=!1;const n=function(){if(!document.body){setTimeout(n,Math.floor(10));return}e||(e=!0,t())};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&n()}),window.attachEvent("onload",n))}},st="[MIN_NAME]",He="[MAX_NAME]",ze=function(t,e){if(t===e)return 0;if(t===st||e===He)return-1;if(e===st||t===He)return 1;{const n=Qs(t),i=Qs(e);return n!==null?i!==null?n-i===0?t.length-e.length:n-i:-1:i!==null?1:t<e?-1:1}},Bc=function(t,e){return t===e?0:t<e?-1:1},_t=function(t,e){if(e&&t in e)return e[t];throw new Error("Missing required key ("+t+") in object: "+B(e))},Hi=function(t){if(typeof t!="object"||t===null)return B(t);const e=[];for(const i in t)e.push(i);e.sort();let n="{";for(let i=0;i<e.length;i++)i!==0&&(n+=","),n+=B(e[i]),n+=":",n+=Hi(t[e[i]]);return n+="}",n},oo=function(t,e){const n=t.length;if(n<=e)return[t];const i=[];for(let s=0;s<n;s+=e)s+e>n?i.push(t.substring(s,n)):i.push(t.substring(s,s+e));return i};function $(t,e){for(const n in t)t.hasOwnProperty(n)&&e(n,t[n])}const ao=function(t){p(!Wi(t),"Invalid JSON number");const e=11,n=52,i=(1<<e-1)-1;let s,r,o,a,l;t===0?(r=0,o=0,s=1/t===-1/0?1:0):(s=t<0,t=Math.abs(t),t>=Math.pow(2,1-i)?(a=Math.min(Math.floor(Math.log(t)/Math.LN2),i),r=a+i,o=Math.round(t*Math.pow(2,n-a)-Math.pow(2,n))):(r=0,o=Math.round(t/Math.pow(2,1-i-n))));const c=[];for(l=n;l;l-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)c.push(r%2?1:0),r=Math.floor(r/2);c.push(s?1:0),c.reverse();const d=c.join("");let h="";for(l=0;l<64;l+=8){let u=parseInt(d.substr(l,8),2).toString(16);u.length===1&&(u="0"+u),h=h+u}return h.toLowerCase()},Uc=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},Wc=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function Hc(t,e){let n="Unknown Error";t==="too_big"?n="The data requested exceeds the maximum size that can be accessed with a single request.":t==="permission_denied"?n="Client doesn't have permission to access the desired data.":t==="unavailable"&&(n="The service is unavailable");const i=new Error(t+" at "+e._path.toString()+": "+n);return i.code=t.toUpperCase(),i}const Vc=new RegExp("^-?(0*)\\d{1,10}$"),$c=-2147483648,Yc=2147483647,Qs=function(t){if(Vc.test(t)){const e=Number(t);if(e>=$c&&e<=Yc)return e}return null},ht=function(t){try{t()}catch(e){setTimeout(()=>{const n=e.stack||"";throw j("Exception was thrown by user callback.",n),e},Math.floor(0))}},Gc=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},wt=function(t,e){const n=setTimeout(t,e);return typeof n=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(n):typeof n=="object"&&n.unref&&n.unref(),n};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qn={},jn={};function $i(t){const e=t.toString();return qn[e]||(qn[e]=new Kc),qn[e]}function Qc(t,e){const n=t.toString();return jn[n]||(jn[n]=e()),jn[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ru(t,e){return ze(t.name,e.name)}function ji(t,e){return ze(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dr=10*1e3,qu=30*1e3,ju=300*1e3;class Ku{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new zu(e);const i=dr+(qu-dr)*Math.random();wt(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),n={};let i=!1;$(e,(s,r)=>{r>0&&ce(this.statsToReport_,s)&&(n[s]=r,i=!0)}),i&&this.server_.reportStats(n),wt(this.reportStats_.bind(this),Math.floor(Math.random()*2*ju))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class md{getCompleteChild(e){return null}getChildAfterChild(e,n,i){return null}}const Vo=new md;class ns{constructor(e,n,i=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=i}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new Pe(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return ts(this.writes_,e,i)}}getChildAfterChild(e,n,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:$e(this.viewCache_),r=pd(this.writes_,s,n,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let vn;class Go{constructor(){this.views=new Map}}function Pd(t){p(!vn,"__referenceConstructor has already been defined"),vn=t}function xd(){return p(vn,"Reference.ts has not been loaded"),vn}function Dd(t){return t.views.size===0}function is(t,e,n,i){const s=e.source.queryId;if(s!==null){const r=t.views.get(s);return p(r!=null,"SyncTree gave us an op for an invalid query."),vr(r,e,n,i)}else{let r=[];for(const o of t.views.values())r=r.concat(vr(o,e,n,i));return r}}function zo(t,e,n,i,s){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let a=mn(n,s?i:null),l=!1;a?l=!0:i instanceof m?(a=es(n,i),l=!1):(a=m.EMPTY_NODE,l=!1);const c=Rn(new Pe(a,l,!1),new Pe(i,s,!1));return new Sd(e,c)}return o}function Md(t,e,n,i,s,r){const o=zo(t,e,i,s,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),Rd(o,n),Ad(o,n)}function Od(t,e,n,i){const s=e._queryIdentifier,r=[];let o=[];const a=xe(t);if(s==="default")for(const[l,c]of t.views.entries())o=o.concat(yr(c,n,i)),gr(c)&&(t.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=t.views.get(s);l&&(o=o.concat(yr(l,n,i)),gr(l)&&(t.views.delete(s),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!xe(t)&&r.push(new(xd())(e._repo,e._path)),{removed:r,events:o}}function qo(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function Ne(t,e){let n=null;for(const i of t.views.values())n=n||Nd(i,e);return n}function jo(t,e){if(e._queryParams.loadsAllData())return Pn(t);{const i=e._queryIdentifier;return t.views.get(i)}}function Ko(t,e){return jo(t,e)!=null}function xe(t){return Pn(t)!=null}function Pn(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Cn;function Ld(t){p(!Cn,"__referenceConstructor has already been defined"),Cn=t}function Fd(){return p(Cn,"Reference.ts has not been loaded"),Cn}let Bd=1;class Cr{constructor(e){this.listenProvider_=e,this.syncPointTree_=new k(null),this.pendingWriteTree_=fd(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Qo(t,e,n,i,s){return td(t.pendingWriteTree_,e,n,i,s),s?ft(t,new Ve(Xi(),e,n)):[]}function Ud(t,e,n,i){nd(t.pendingWriteTree_,e,n,i);const s=k.fromObject(n);return ft(t,new ot(Xi(),e,s))}function we(t,e,n=!1){const i=id(t.pendingWriteTree_,e);if(sd(t.pendingWriteTree_,e)){let r=new k(null);return i.snap!=null?r=r.set(b(),!0):$(i.children,o=>{r=r.set(new I(o),!0)}),ft(t,new pn(i.path,r,n))}else return[]}function Yt(t,e,n){return ft(t,new Ve(Ji(),e,n))}function Wd(t,e,n){const i=k.fromObject(n);return ft(t,new ot(Ji(),e,i))}function Hd(t,e){return ft(t,new Ft(Ji(),e))}function Vd(t,e,n){const i=rs(t,n);if(i){const s=os(i),r=s.path,o=s.queryId,a=q(r,e),l=new Ft(Zi(o),a);return as(t,r,l)}else return[]}function En(t,e,n,i,s=!1){const r=e._path,o=t.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||Ko(o,e))){const l=Od(o,e,n,i);Dd(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const d=c.findIndex(u=>u._queryParams.loadsAllData())!==-1,h=t.syncPointTree_.findOnPath(r,(u,f)=>xe(f));if(d&&!h){const u=t.syncPointTree_.subtree(r);if(!u.isEmpty()){const f=Gd(u);for(let _=0;_<f.length;++_){const g=f[_],y=g.query,X=ea(t,g);t.listenProvider_.startListening(St(y),Bt(t,y),X.hashFn,X.onComplete)}}}!h&&c.length>0&&!i&&(d?t.listenProvider_.stopListening(St(e),null):c.forEach(u=>{const f=t.queryToTagMap.get(xn(u));t.listenProvider_.stopListening(St(u),f)}))}zd(t,c)}return a}function Xo(t,e,n,i){const s=rs(t,i);if(s!=null){const r=os(s),o=r.path,a=r.queryId,l=q(o,e),c=new Ve(Zi(a),l,n);return as(t,o,c)}else return[]}function $d(t,e,n,i){const s=rs(t,i);if(s){const r=os(s),o=r.path,a=r.queryId,l=q(o,e),c=k.fromObject(n),d=new ot(Zi(a),l,c);return as(t,o,d)}else return[]}function Ci(t,e,n,i=!1){const s=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(s,(u,f)=>{const _=q(u,s);r=r||Ne(f,_),o=o||xe(f)});let a=t.syncPointTree_.get(s);a?(o=o||xe(a),r=r||Ne(a,b())):(a=new Go,t.syncPointTree_=t.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=m.EMPTY_NODE,t.syncPointTree_.subtree(s).foreachChild((f,_)=>{const g=Ne(_,b());g&&(r=r.updateImmediateChild(f,g))}));const c=Ko(a,e);if(!c&&!e._queryParams.loadsAllData()){const u=xn(e);p(!t.queryToTagMap.has(u),"View does not exist, but we have a tag");const f=qd();t.queryToTagMap.set(u,f),t.tagToQueryMap.set(f,u)}const d=An(t.pendingWriteTree_,s);let h=Md(a,e,n,d,r,l);if(!c&&!o&&!i){const u=jo(a,e);h=h.concat(jd(t,e,u))}return h}function ss(t,e,n){const s=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=q(o,e),c=Ne(a,l);if(c)return c});return Uo(s,e,r,n,!0)}function Yd(t,e){const n=e._path;let i=null;t.syncPointTree_.foreachOnPath(n,(c,d)=>{const h=q(c,n);i=i||Ne(d,h)});let s=t.syncPointTree_.get(n);s?i=i||Ne(s,b()):(s=new Go,t.syncPointTree_=t.syncPointTree_.set(n,s));const r=i!=null,o=r?new Pe(i,!0,!1):null,a=An(t.pendingWriteTree_,e._path),l=zo(s,e,a,r?o.getNode():m.EMPTY_NODE,r);return kd(l)}function ft(t,e){return Jo(e,t.syncPointTree_,null,An(t.pendingWriteTree_,b()))}function Jo(t,e,n,i){if(E(t.path))return Zo(t,e,n,i);{const s=e.get(b());n==null&&s!=null&&(n=Ne(s,b()));let r=[];const o=v(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,d=Wo(i,o);r=r.concat(Jo(a,l,c,d))}return s&&(r=r.concat(is(s,t,i,n))),r}}function Zo(t,e,n,i){const s=e.get(b());n==null&&s!=null&&(n=Ne(s,b()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=Wo(i,o),d=t.operationForChild(o);d&&(r=r.concat(Zo(d,a,l,c)))}),s&&(r=r.concat(is(s,t,i,n))),r}function ea(t,e){const n=e.query,i=Bt(t,n);return{hashFn:()=>(Td(e)||m.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?Vd(t,n._path,i):Hd(t,n._path);{const r=Hc(s,n);return En(t,n,null,r)}}}}function Bt(t,e){const n=xn(e);return t.queryToTagMap.get(n)}function xn(t){return t._path.toString()+"$"+t._queryIdentifier}function rs(t,e){return t.tagToQueryMap.get(e)}function os(t){const e=t.indexOf("$");return p(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new I(t.substr(0,e))}}function as(t,e,n){const i=t.syncPointTree_.get(e);p(i,"Missing sync point for query tag that we're tracking");const s=An(t.pendingWriteTree_,e);return is(i,n,s,null)}function Gd(t){return t.fold((e,n,i)=>{if(n&&xe(n))return[Pn(n)];{let s=[];return n&&(s=qo(n)),$(i,(r,o)=>{s=s.concat(o)}),s}})}function St(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(Fd())(t._repo,t._path):t}function zd(t,e){for(let n=0;n<e.length;++n){const i=e[n];if(!i._queryParams.loadsAllData()){const s=xn(i),r=t.queryToTagMap.get(s);t.queryToTagMap.delete(s),t.tagToQueryMap.delete(r)}}}function qd(){return Bd++}function jd(t,e,n){const i=e._path,s=Bt(t,e),r=ea(t,n),o=t.listenProvider_.startListening(St(e),s,r.hashFn,r.onComplete),a=t.syncPointTree_.subtree(i);if(s)p(!xe(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,d,h)=>{if(!E(c)&&d&&xe(d))return[Pn(d).query];{let u=[];return d&&(u=u.concat(qo(d).map(f=>f.query))),$(h,(f,_)=>{u=u.concat(_)}),u}});for(let c=0;c<l.length;++c){const d=l[c];t.listenProvider_.stopListening(St(d),Bt(t,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const th=/[\[\].#$\/\u0000-\u001F\u007F]/,nh=/[\[\].#$\u0000-\u001F\u007F]/,Jn=10*1024*1024,fs=function(t){return typeof t=="string"&&t.length!==0&&!th.test(t)},oa=function(t){return typeof t=="string"&&t.length!==0&&!nh.test(t)},ih=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),oa(t)},sh=function(t){return t===null||typeof t=="string"||typeof t=="number"&&!Wi(t)||t&&typeof t=="object"&&ce(t,".sv")},aa=function(t,e,n,i){i&&e===void 0||Mn(Tn(t,"value"),e,n)},Mn=function(t,e,n){const i=n instanceof I?new Eu(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+Fe(i));if(typeof e=="function")throw new Error(t+"contains a function "+Fe(i)+" with contents = "+e.toString());if(Wi(e))throw new Error(t+"contains "+e.toString()+" "+Fe(i));if(typeof e=="string"&&e.length>Jn/3&&kn(e)>Jn)throw new Error(t+"contains a string greater than "+Jn+" utf8 bytes "+Fe(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if($(e,(o,a)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!fs(o)))throw new Error(t+" contains an invalid key ("+o+") "+Fe(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);wu(i,o),Mn(t,a,i),bu(i)}),s&&r)throw new Error(t+' contains ".value" child '+Fe(i)+" in addition to actual children.")}},rh=function(t,e){let n,i;for(n=0;n<e.length;n++){i=e[n];const r=Dt(i);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!fs(r[o]))throw new Error(t+"contains an invalid key ("+r[o]+") in path "+i.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(Cu);let s=null;for(n=0;n<e.length;n++){if(i=e[n],s!==null&&J(s,i))throw new Error(t+"contains a path "+s.toString()+" that is ancestor of another path "+i.toString());s=i}},oh=function(t,e,n,i){const s=Tn(t,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(s+" must be an object containing the children to replace.");const r=[];$(e,(o,a)=>{const l=new I(o);if(Mn(s,a,M(n,l)),Gi(l)===".priority"&&!sh(a))throw new Error(s+"contains an invalid value for '"+l.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(l)}),rh(s,r)},la=function(t,e,n,i){if(!oa(n))throw new Error(Tn(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},ah=function(t,e,n,i){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),la(t,e,n)},ps=function(t,e){if(v(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},lh=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!fs(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!ih(n))throw new Error(Tn(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ch{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function On(t,e){let n=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();n!==null&&!zi(r,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:r}),n.events.push(s)}n&&t.eventLists_.push(n)}function ca(t,e,n){On(t,n),ua(t,i=>zi(i,e))}function ee(t,e,n){On(t,n),ua(t,i=>J(i,e)||J(e,i))}function ua(t,e){t.recursionDepth_++;let n=!0;for(let i=0;i<t.eventLists_.length;i++){const s=t.eventLists_[i];if(s){const r=s.path;e(r)?(uh(t.eventLists_[i]),t.eventLists_[i]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function uh(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const i=n.getEventRunner();Et&&V("event: "+n.toString()),ht(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wh(t){Ac(yc),ln(new At("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Mh(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),Xe(qs,js,t),Xe(qs,js,"esm2020")}me.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};me.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};Wh();var Hh="firebase",Vh="12.4.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
